 ...
 *
 * @generated from protobuf message prehog.v1.SessionSummariesAccessedRecord
 */
export interface SessionSummariesAccessedRecord {
    /**
...
/**
 * @generated from protobuf message prehog.v1.IdentitySecuritySummariesGeneratedReport
 */
export interface IdentitySecuritySummariesGeneratedReport {
    /**
     * randomly generated UUID for this specific report, 16 bytes (in string order)
     *
     * PostHog property: tp.report_uuid (in 8-4-4-4-12 string form)
     ...
     *
     * @generated from protobuf field: repeated prehog.v1.SessionSummariesGeneratedRecord records = 5;
     */
    records: SessionSummariesGeneratedRecord[];
}
/**
 ...
 *
 * @generated from protobuf message prehog.v1.SessionSummariesGeneratedRecord
 */
export interface SessionSummariesGeneratedRecord {
    /**
     * session_type is type of the session, should be
     * "ssh"/"k8s"/"db"/"desktop" (matching the values for
     * api/types.SessionKind).
     ...
     *
     * @generated from protobuf field: uint64 total_input_tokens = 4;
     */
...
// @generated message type with reflection information, may provide speed optimized methods
class SessionSummariesAccessedRecord$Type extends MessageType<SessionSummariesAccessedRecord> {
    constructor() {
        super("prehog.v1.SessionSummariesAccessedRecord", [
    ...
    create(value?: PartialMessage<SessionSummariesAccessedRecord>): SessionSummariesAccessedRecord {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.sessionType = "";
        message.resourceName = "";
        message.count = 0n;
        if (value !== undefined)
            reflectionMergePartial<SessionSummariesAccessedRecord>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SessionSummariesAccessedRecord): SessionSummariesAccessedRecord {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SessionSummariesAccessedRecord, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message prehog.v1.SessionSummariesAccessedRecord
 */
export const SessionSummariesAccessedRecord = new SessionSummariesAccessedRecord$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class IdentitySecuritySummariesGeneratedReport$Type extends MessageType<IdentitySecuritySummariesGeneratedReport> {
    constructor() {
        super("prehog.v1.IdentitySecuritySummariesGeneratedReport", [
            { no: 1, name: "report_uuid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "cluster_name", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 3, name: "reporter_hostid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 4, name: "start_time", kind: "message", T: () => Timestamp },
            { no: 5, name: "records", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => SessionSummariesGeneratedRecord }
        ]);
    }
    create(value?: PartialMessage<IdentitySecuritySummariesGeneratedReport>): IdentitySecuritySummariesGeneratedReport {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.reportUuid = new Uint8Array(0);
        message.clusterName = new Uint8Array(0);
        message.reporterHostid = new Uint8Array(0);
        message.records = [];
        if (value !== undefined)
            reflectionMergePartial<IdentitySecuritySummariesGeneratedReport>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: IdentitySecuritySummariesGeneratedReport): IdentitySecuritySummariesGeneratedReport {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* google.protobuf.Timestamp start_time */ 4:
                    message.startTime = Timestamp.internalBinaryRead(reader, reader.uint32(), options, message.startTime);
                    break;
                case /* repeated prehog.v1.SessionSummariesGeneratedRecord records */ 5:
                    message.records.push(SessionSummariesGeneratedRecord.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: IdentitySecuritySummariesGeneratedReport, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes report_uuid = 1; */
        if (message.reportUuid.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.reportUuid);
        /* bytes cluster_name = 2; */
        ...
        if (message.startTime)
            Timestamp.internalBinaryWrite(message.startTime, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* repeated prehog.v1.SessionSummariesGeneratedRecord records = 5; */
        for (let i = 0; i < message.records.length; i++)
            SessionSummariesGeneratedRecord.internalBinaryWrite(message.records[i], writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message prehog.v1.IdentitySecuritySummariesGeneratedReport
 */
export const IdentitySecuritySummariesGeneratedReport = new IdentitySecuritySummariesGeneratedReport$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SessionSummariesGeneratedRecord$Type extends MessageType<SessionSummariesGeneratedRecord> {
    constructor() {
        super("prehog.v1.SessionSummariesGeneratedRecord", [
            { no: 1, name: "session_type", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SessionSummariesGeneratedRecord): SessionSummariesGeneratedRecord {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* string resource_name */ 2:
                    message.resourceName = reader.string();
                    break;
                case /* uint64 total_input_tokens */ 4:
    ...
    internalBinaryWrite(message: SessionSummariesGeneratedRecord, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string session_type = 1; */
        if (message.sessionType !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.sessionType);
        ...
        if (message.totalInputTokens !== 0n)
            writer.tag(4, WireType.Varint).uint64(message.totalInputTokens);
...
/**
 * @generated MessageType for protobuf message prehog.v1.SessionSummariesGeneratedRecord
 */
