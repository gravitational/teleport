...
class UIDiscoverDatabaseRDSEnrollEvent$Type extends MessageType<UIDiscoverDatabaseRDSEnrollEvent> {
    constructor() {
        super("prehog.v1alpha.UIDiscoverDatabaseRDSEnrollEvent", [
            ...
            { no: 2, name: "resource", kind: "message", T: () => DiscoverResourceMetadata },
            { no: 3, name: "status", kind: "message", T: () => DiscoverStepStatus },
            { no: 4, name: "selected_resources_count", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
    create(value?: PartialMessage<UIDiscoverDatabaseRDSEnrollEvent>): UIDiscoverDatabaseRDSEnrollEvent {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.selectedResourcesCount = 0;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 selected_resources_count */ 4:
                    message.selectedResourcesCount = reader.int64().toNumber();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: UIDiscoverDatabaseRDSEnrollEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.selectedResourcesCount !== 0)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 resources_count */ 4:
                    message.resourcesCount = reader.int64().toNumber();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class BotCreateEvent$Type extends MessageType<BotCreateEvent> {
    constructor() {
        super("prehog.v1alpha.BotCreateEvent", [
            ...
            { no: 4, name: "role_count", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 role_count */ 4:
                    message.roleCount = reader.int64().toNumber();
                    break;
...
class AssistCompletionEvent$Type extends MessageType<AssistCompletionEvent> {
    constructor() {
        super("prehog.v1alpha.AssistCompletionEvent", [
            ...
            { no: 3, name: "total_tokens", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 4, name: "prompt_tokens", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 5, name: "completion_tokens", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 total_tokens */ 3:
                    message.totalTokens = reader.int64().toNumber();
                    break;
                case /* int64 prompt_tokens */ 4:
                    message.promptTokens = reader.int64().toNumber();
                    break;
                case /* int64 completion_tokens */ 5:
                    message.completionTokens = reader.int64().toNumber();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class AssistExecutionEvent$Type extends MessageType<AssistExecutionEvent> {
    constructor() {
        super("prehog.v1alpha.AssistExecutionEvent", [
            { no: 1, name: "user_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "conversation_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "node_count", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 4, name: "total_tokens", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 5, name: "prompt_tokens", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 6, name: "completion_tokens", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 node_count */ 3:
                    message.nodeCount = reader.int64().toNumber();
                    break;
...
class TAGExecuteQueryEvent$Type extends MessageType<TAGExecuteQueryEvent> {
    constructor() {
        super("prehog.v1alpha.TAGExecuteQueryEvent", [
            { no: 1, name: "user_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "total_nodes", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 3, name: "total_edges", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
    ...
    create(value?: PartialMessage<TAGExecuteQueryEvent>): TAGExecuteQueryEvent {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.userName = "";
        message.totalNodes = 0;
        message.totalEdges = 0;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 total_nodes */ 2:
                    message.totalNodes = reader.int64().toNumber();
                    break;
                case /* int64 total_edges */ 3:
                    message.totalEdges = reader.int64().toNumber();
                    break;
