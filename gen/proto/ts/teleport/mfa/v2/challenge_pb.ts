...
import { CredentialAssertionResponse } from "../../webauthn/v2/webauthn_pb";
import { CredentialAssertion } from "../../webauthn/v2/webauthn_pb";
/**
 * AuthenticateChallenge is a challenge for all MFA devices registered for a user.
 *
 * @generated from protobuf message teleport.mfa.v2.AuthenticateChallenge
 */
export interface AuthenticateChallenge {
     ...
     *
     * @generated from protobuf field: teleport.webauthn.v2.CredentialAssertion webauthn_challenge = 2;
     */
     ...
     *
     * @generated from protobuf field: teleport.mfa.v2.SSOChallenge sso_challenge = 3;
     */
     ...
     *
     * @generated from protobuf field: teleport.mfa.v2.BrowserMFAChallenge browser_challenge = 4;
     */
 ...
 *
 * @generated from protobuf message teleport.mfa.v2.AuthenticateResponse
 */
export interface AuthenticateResponse {
    ...
    response: {
         ...
         *
         * @generated from protobuf field: teleport.webauthn.v2.CredentialAssertionResponse webauthn = 2;
         */
         ...
         *
         * @generated from protobuf field: teleport.mfa.v2.SSOChallengeResponse sso = 3;
         */
         ...
         *
         * @generated from protobuf field: teleport.mfa.v2.BrowserMFAResponse browser = 4;
         */
 ...
 *
 * @generated from protobuf message teleport.mfa.v2.SSOChallenge
 */
export interface SSOChallenge {
     ...
     *
     * @generated from protobuf field: teleport.mfa.v2.SSOMFADevice device = 3;
     */
    device?: SSOMFADevice;
}
/**
 ...
 *
 * @generated from protobuf message teleport.mfa.v2.SSOMFADevice
 */
 ...
 *
 * @generated from protobuf message teleport.mfa.v2.SSOChallengeResponse
 */
...
export interface BrowserMFAResponse {
     ...
     *
     * @generated from protobuf field: teleport.webauthn.v2.CredentialAssertionResponse webauthn_response = 2;
     */
...
class AuthenticateChallenge$Type extends MessageType<AuthenticateChallenge> {
    constructor() {
        super("teleport.mfa.v2.AuthenticateChallenge", [
    ...
    internalBinaryWrite(message: AuthenticateChallenge, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* teleport.mfa.v2.SSOChallenge sso_challenge = 3; */
        ...
        /* teleport.mfa.v2.BrowserMFAChallenge browser_challenge = 4; */
...
/**
 * @generated MessageType for protobuf message teleport.mfa.v2.AuthenticateChallenge
 */
...
class AuthenticateResponse$Type extends MessageType<AuthenticateResponse> {
    constructor() {
        super("teleport.mfa.v2.AuthenticateResponse", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
    ...
    internalBinaryWrite(message: AuthenticateResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* teleport.mfa.v2.SSOChallengeResponse sso = 3; */
        ...
        /* teleport.mfa.v2.BrowserMFAResponse browser = 4; */
...
class SSOChallenge$Type extends MessageType<SSOChallenge> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string redirect_url */ 2:
                    ...
                    break;
                case /* teleport.mfa.v2.SSOMFADevice device */ 3:
    ...
    internalBinaryWrite(message: SSOChallenge, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* teleport.mfa.v2.SSOMFADevice device = 3; */
        if (message.device)
...
/**
 * @generated MessageType for protobuf message teleport.mfa.v2.SSOChallenge
 */
export const SSOChallenge = new SSOChallenge$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SSOMFADevice$Type extends MessageType<SSOMFADevice> {
    constructor() {
        super("teleport.mfa.v2.SSOMFADevice", [
...
/**
 * @generated MessageType for protobuf message teleport.mfa.v2.SSOChallengeResponse
 */
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string request_id */ 1:
                    message.requestId = reader.string();
                    break;
                case /* teleport.webauthn.v2.CredentialAssertionResponse webauthn_response */ 2:
