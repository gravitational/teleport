...
import type { ListAccessListsWithFilterResponse } from "./accesslist_service_pb";
import type { ListAccessListsWithFilterRequest } from "./accesslist_service_pb";
...
export interface IAccessListServiceClient {
     ...
     */
    listAccessListsWithFilter(input: ListAccessListsWithFilterRequest, options?: RpcOptions): UnaryCall<ListAccessListsWithFilterRequest, ListAccessListsWithFilterResponse>;
    /**
...
export class AccessListServiceClient implements IAccessListServiceClient, ServiceInfo {
    ...
    listAccessListsWithFilter(input: ListAccessListsWithFilterRequest, options?: RpcOptions): UnaryCall<ListAccessListsWithFilterRequest, ListAccessListsWithFilterResponse> {
        ...
        return stackIntercept<ListAccessListsWithFilterRequest, ListAccessListsWithFilterResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * GetAccessList returns the specified access list resource.
     *
