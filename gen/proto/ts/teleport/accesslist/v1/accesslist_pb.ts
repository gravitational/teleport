...
export interface AccessListSpec {
     ...
     *
     * @generated from protobuf field: repeated string owner_of = 12;
     */
    ownerOf: string[];
    /**
     * member_of describes Access Lists that this Access List is an explicit member of.
     *
     * @generated from protobuf field: repeated string member_of = 13;
     */
    memberOf: string[];
}
/**
...
class AccessListSpec$Type extends MessageType<AccessListSpec> {
    constructor() {
        super("teleport.accesslist.v1.AccessListSpec", [
            ...
            { no: 12, name: "owner_of", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 13, name: "member_of", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* teleport.accesslist.v1.AccessListGrants owner_grants */ 11:
                    ...
                    break;
                case /* repeated string owner_of */ 12:
                    message.ownerOf.push(reader.string());
                    break;
                case /* repeated string member_of */ 13:
    ...
    internalBinaryWrite(message: AccessListSpec, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.ownerOf.length; i++)
            writer.tag(12, WireType.LengthDelimited).string(message.ownerOf[i]);
        /* repeated string member_of = 13; */
        for (let i = 0; i < message.memberOf.length; i++)
            writer.tag(13, WireType.LengthDelimited).string(message.memberOf[i]);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
