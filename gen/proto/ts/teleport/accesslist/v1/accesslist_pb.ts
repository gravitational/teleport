...
export interface MemberSpec {
     ...
     *
     * @generated from protobuf field: string membership = 8;
     */
    membership: string;
}
/**
...
class AccessListSpec$Type extends MessageType<AccessListSpec> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string title */ 8:
                    ...
                    break;
                case /* string membership */ 9:
                    message.membership = reader.string();
                    break;
                case /* string ownership */ 10:
    ...
    internalBinaryWrite(message: AccessListSpec, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.membership !== "")
            writer.tag(9, WireType.LengthDelimited).string(message.membership);
        /* string ownership = 10; */
        if (message.ownership !== "")
            writer.tag(10, WireType.LengthDelimited).string(message.ownership);
...
class MemberSpec$Type extends MessageType<MemberSpec> {
    constructor() {
        super("teleport.accesslist.v1.MemberSpec", [
            ...
            { no: 8, name: "membership", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: MemberSpec, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string membership = 8; */
        if (message.membership !== "")
            writer.tag(8, WireType.LengthDelimited).string(message.membership);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
