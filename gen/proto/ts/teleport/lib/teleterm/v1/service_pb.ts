...
export interface ListKubernetesServersResponse {
     ...
     *
     * @generated from protobuf field: repeated teleport.lib.teleterm.v1.KubeServer servers = 1;
     */
    servers: KubeServer[];
    /**
...
class ListKubernetesServersResponse$Type extends MessageType<ListKubernetesServersResponse> {
    constructor() {
        super("teleport.lib.teleterm.v1.ListKubernetesServersResponse", [
            { no: 1, name: "servers", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => KubeServer },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListKubernetesServersResponse): ListKubernetesServersResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated teleport.lib.teleterm.v1.KubeServer servers */ 1:
                    message.servers.push(KubeServer.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: ListKubernetesServersResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated teleport.lib.teleterm.v1.KubeServer servers = 1; */
        for (let i = 0; i < message.servers.length; i++)
            KubeServer.internalBinaryWrite(message.servers[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
