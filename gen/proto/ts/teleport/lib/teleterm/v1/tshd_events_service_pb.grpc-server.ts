...
import { PromptHardwareKeyChangePINResponse } from "./tshd_events_service_pb";
import { PromptHardwareKeyChangePINRequest } from "./tshd_events_service_pb";
...
export interface ITshdEventsService extends grpc.UntypedServiceImplementation {
     ...
     */
    promptHardwareKeyChangePIN: grpc.handleUnaryCall<PromptHardwareKeyChangePINRequest, PromptHardwareKeyChangePINResponse>;
    /**
...
export const tshdEventsServiceDefinition: grpc.ServiceDefinition<ITshdEventsService> = {
    ...
    promptHardwareKeyChangePIN: {
        path: "/teleport.lib.teleterm.v1.TshdEventsService/PromptHardwareKeyChangePIN",
        originalName: "PromptHardwareKeyChangePIN",
        requestStream: false,
        responseStream: false,
        responseDeserialize: bytes => PromptHardwareKeyChangePINResponse.fromBinary(bytes),
        requestDeserialize: bytes => PromptHardwareKeyChangePINRequest.fromBinary(bytes),
        responseSerialize: value => Buffer.from(PromptHardwareKeyChangePINResponse.toBinary(value)),
        requestSerialize: value => Buffer.from(PromptHardwareKeyChangePINRequest.toBinary(value))
    },
