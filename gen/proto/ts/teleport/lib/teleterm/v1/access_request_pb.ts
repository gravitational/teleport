...
class AccessRequest$Type extends MessageType<AccessRequest> {
    constructor() {
        super("teleport.lib.teleterm.v1.AccessRequest", [
            ...
            { no: 9, name: "reviews", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => AccessRequestReview },
            ...
            { no: 12, name: "resource_ids", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ResourceID },
            { no: 13, name: "resources", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Resource },
