 ...
 * Request for Start.
 *
 * @generated from protobuf message teleport.lib.teleterm.keyagent.v1.StartRequest
 */
 ...
 * Response for Start.
 *
 * @generated from protobuf message teleport.lib.teleterm.keyagent.v1.StartResponse
 */
 ...
 * Request for Stop.
 *
 * @generated from protobuf message teleport.lib.teleterm.keyagent.v1.StopRequest
 */
 ...
 * Response for Stop.
 *
 * @generated from protobuf message teleport.lib.teleterm.keyagent.v1.StopResponse
 */
...
class StartRequest$Type extends MessageType<StartRequest> {
    constructor() {
        super("teleport.lib.teleterm.keyagent.v1.StartRequest", []);
    }
...
/**
 * @generated MessageType for protobuf message teleport.lib.teleterm.keyagent.v1.StartRequest
 */
export const StartRequest = new StartRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class StartResponse$Type extends MessageType<StartResponse> {
    constructor() {
        super("teleport.lib.teleterm.keyagent.v1.StartResponse", []);
    }
...
/**
 * @generated MessageType for protobuf message teleport.lib.teleterm.keyagent.v1.StartResponse
 */
export const StartResponse = new StartResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class StopRequest$Type extends MessageType<StopRequest> {
    constructor() {
        super("teleport.lib.teleterm.keyagent.v1.StopRequest", []);
    }
...
/**
 * @generated MessageType for protobuf message teleport.lib.teleterm.keyagent.v1.StopRequest
 */
export const StopRequest = new StopRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class StopResponse$Type extends MessageType<StopResponse> {
    constructor() {
        super("teleport.lib.teleterm.keyagent.v1.StopResponse", []);
    }
...
/**
 * @generated MessageType for protobuf message teleport.lib.teleterm.keyagent.v1.StopResponse
 */
export const StopResponse = new StopResponse$Type();
/**
 * @generated ServiceType for protobuf service teleport.lib.teleterm.keyagent.v1.KeyAgentService
 */
export const KeyAgentService = new ServiceType("teleport.lib.teleterm.keyagent.v1.KeyAgentService", [
