...
export interface ResourceConstraints {
    ...
    details: {
        ...
        oneofKind: "identityCenterResource";
        /**
         * awsic_resource constrains which access profiles a user may assume for the
         * target Identity Center Resource
         *
         * @generated from protobuf field: types.IdentityCenterResourceConstraints identity_center_resource = 11;
         */
        identityCenterResource: IdentityCenterResourceConstraints;
    } | {
        oneofKind: undefined;
    };
}
 ...
 *
 * @generated from protobuf message types.IdentityCenterResourceConstraints
 */
export interface IdentityCenterResourceConstraints {
    /**
     * @generated from protobuf field: string version = 1;
     */
    version: string;
    /**
     * @generated from protobuf field: repeated string access_profiles = 2;
     */
...
class ResourceConstraints$Type extends MessageType<ResourceConstraints> {
    constructor() {
        super("types.ResourceConstraints", [
            ...
            { no: 11, name: "identity_center_resource", kind: "message", oneof: "details", T: () => IdentityCenterResourceConstraints }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* types.AWSConsoleResourceConstraints aws_console */ 10:
                    ...
                    break;
                case /* types.IdentityCenterResourceConstraints identity_center_resource */ 11:
                    message.details = {
                        oneofKind: "identityCenterResource",
                        identityCenterResource: IdentityCenterResourceConstraints.internalBinaryRead(reader, reader.uint32(), options, (message.details as any).identityCenterResource)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: ResourceConstraints, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* types.IdentityCenterResourceConstraints identity_center_resource = 11; */
        if (message.details.oneofKind === "identityCenterResource")
            IdentityCenterResourceConstraints.internalBinaryWrite(message.details.identityCenterResource, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class IdentityCenterResourceConstraints$Type extends MessageType<IdentityCenterResourceConstraints> {
    constructor() {
        super("types.IdentityCenterResourceConstraints", [
            { no: 1, name: "version", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "access_profiles", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<IdentityCenterResourceConstraints>): IdentityCenterResourceConstraints {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.version = "";
        message.accessProfiles = [];
        if (value !== undefined)
            reflectionMergePartial<IdentityCenterResourceConstraints>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: IdentityCenterResourceConstraints): IdentityCenterResourceConstraints {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string version */ 1:
                    message.version = reader.string();
                    break;
                case /* repeated string access_profiles */ 2:
                    message.accessProfiles.push(reader.string());
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: IdentityCenterResourceConstraints, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string version = 1; */
        if (message.version !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.version);
        /* repeated string access_profiles = 2; */
        for (let i = 0; i < message.accessProfiles.length; i++)
            writer.tag(2, WireType.LengthDelimited).string(message.accessProfiles[i]);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message types.IdentityCenterResourceConstraints
 */
export const IdentityCenterResourceConstraints = new IdentityCenterResourceConstraints$Type();
