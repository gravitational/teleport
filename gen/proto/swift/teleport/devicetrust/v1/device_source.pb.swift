...
/// Origin of a device.
enum Teleport_Devicetrust_V1_DeviceOrigin: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Teleport_Devicetrust_V1_DeviceOrigin] = [
    .unspecified,
    .api,
    .jamf,
    .intune,
...
/// (for example, MDMs).
struct Teleport_Devicetrust_V1_DeviceSource: Sendable {
  ...
  /// Readonly.
  var origin: Teleport_Devicetrust_V1_DeviceOrigin = .unspecified
...
extension Teleport_Devicetrust_V1_DeviceSource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Teleport_Devicetrust_V1_DeviceSource, rhs: Teleport_Devicetrust_V1_DeviceSource) -> Bool {
