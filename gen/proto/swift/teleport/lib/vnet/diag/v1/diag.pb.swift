...
enum Teleport_Lib_Vnet_Diag_V1_CheckAttemptStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Teleport_Lib_Vnet_Diag_V1_CheckAttemptStatus] = [
    .unspecified,
    .ok,
    .error,
  ]
...
enum Teleport_Lib_Vnet_Diag_V1_CheckReportStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case unspecified // = 0
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Teleport_Lib_Vnet_Diag_V1_CheckReportStatus] = [
    .unspecified,
    .ok,
    .issuesFound,
  ]
...
enum Teleport_Lib_Vnet_Diag_V1_CommandAttemptStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case unspecified // = 0
  case ok // = 1
  case error // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Teleport_Lib_Vnet_Diag_V1_CommandAttemptStatus] = [
    .unspecified,
    .ok,
    .error,
  ]
...
struct Teleport_Lib_Vnet_Diag_V1_Report: Sendable {
  ...
  var networkStackAttempt: Teleport_Lib_Vnet_Diag_V1_NetworkStackAttempt {
  ...
  var hasNetworkStackAttempt: Bool {return self._networkStackAttempt != nil}
  /// Clears the value of `networkStackAttempt`. Subsequent reads from it will return its default value.
  mutating func clearNetworkStackAttempt() {self._networkStackAttempt = nil}

  var checks: [Teleport_Lib_Vnet_Diag_V1_CheckAttempt] = []
...
/// by VNet.
struct Teleport_Lib_Vnet_Diag_V1_NetworkStackAttempt: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var status: Teleport_Lib_Vnet_Diag_V1_CheckAttemptStatus = .unspecified

  /// error is present if status is CHECK_ATTEMPT_STATUS_ERROR.
  var error: String = String()

  var networkStack: Teleport_Lib_Vnet_Diag_V1_NetworkStack {
  ...
  var hasNetworkStack: Bool {return self._networkStack != nil}
  /// Clears the value of `networkStack`. Subsequent reads from it will return its default value.
  mutating func clearNetworkStack() {self._networkStack = nil}
...
struct Teleport_Lib_Vnet_Diag_V1_NetworkStack: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Teleport_Lib_Vnet_Diag_V1_CheckAttempt: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// failed to run.
  var checkReport: Teleport_Lib_Vnet_Diag_V1_CheckReport {
  ...
  var hasCheckReport: Bool {return self._checkReport != nil}
  /// Clears the value of `checkReport`. Subsequent reads from it will return its default value.
  mutating func clearCheckReport() {self._checkReport = nil}
  ...
  var commands: [Teleport_Lib_Vnet_Diag_V1_CommandAttempt] = []
...
struct Teleport_Lib_Vnet_Diag_V1_CheckReport: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var status: Teleport_Lib_Vnet_Diag_V1_CheckReportStatus = .unspecified

  var report: Teleport_Lib_Vnet_Diag_V1_CheckReport.OneOf_Report? = nil

  /// route_conflict reports whether there are routes that might conflict with routes set up by
  /// VNet.
  var routeConflictReport: Teleport_Lib_Vnet_Diag_V1_RouteConflictReport {
    get {
  ...
  enum OneOf_Report: Equatable, Sendable {
    /// route_conflict reports whether there are routes that might conflict with routes set up by
    /// VNet.
...
/// check.
struct Teleport_Lib_Vnet_Diag_V1_CommandAttempt: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var status: Teleport_Lib_Vnet_Diag_V1_CommandAttemptStatus = .unspecified
...
struct Teleport_Lib_Vnet_Diag_V1_RouteConflictReport: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var routeConflicts: [Teleport_Lib_Vnet_Diag_V1_RouteConflict] = []
...
struct Teleport_Lib_Vnet_Diag_V1_RouteConflict: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var interfaceApp: String = String()
...
extension Teleport_Lib_Vnet_Diag_V1_Report: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Teleport_Lib_Vnet_Diag_V1_Report, rhs: Teleport_Lib_Vnet_Diag_V1_Report) -> Bool {
...
extension Teleport_Lib_Vnet_Diag_V1_NetworkStackAttempt: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".NetworkStackAttempt"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "status"),
    2: .same(proto: "error"),
  ...
  static func ==(lhs: Teleport_Lib_Vnet_Diag_V1_NetworkStackAttempt, rhs: Teleport_Lib_Vnet_Diag_V1_NetworkStackAttempt) -> Bool {
...
extension Teleport_Lib_Vnet_Diag_V1_NetworkStack: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".NetworkStack"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Teleport_Lib_Vnet_Diag_V1_NetworkStack, rhs: Teleport_Lib_Vnet_Diag_V1_NetworkStack) -> Bool {
...
extension Teleport_Lib_Vnet_Diag_V1_CheckAttempt: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CheckAttempt"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "status"),
    2: .same(proto: "error"),
  ...
  static func ==(lhs: Teleport_Lib_Vnet_Diag_V1_CheckAttempt, rhs: Teleport_Lib_Vnet_Diag_V1_CheckAttempt) -> Bool {
    if lhs.status != rhs.status {return false}
    if lhs.error != rhs.error {return false}
...
extension Teleport_Lib_Vnet_Diag_V1_CheckReport: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CheckReport"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "status"),
  ...
  static func ==(lhs: Teleport_Lib_Vnet_Diag_V1_CheckReport, rhs: Teleport_Lib_Vnet_Diag_V1_CheckReport) -> Bool {
    if lhs.status != rhs.status {return false}
...
extension Teleport_Lib_Vnet_Diag_V1_CommandAttempt: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CommandAttempt"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "status"),
    2: .same(proto: "error"),
  ...
  static func ==(lhs: Teleport_Lib_Vnet_Diag_V1_CommandAttempt, rhs: Teleport_Lib_Vnet_Diag_V1_CommandAttempt) -> Bool {
    if lhs.status != rhs.status {return false}
    if lhs.error != rhs.error {return false}
...
extension Teleport_Lib_Vnet_Diag_V1_RouteConflictReport: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".RouteConflictReport"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Teleport_Lib_Vnet_Diag_V1_RouteConflictReport, rhs: Teleport_Lib_Vnet_Diag_V1_RouteConflictReport) -> Bool {
...
extension Teleport_Lib_Vnet_Diag_V1_RouteConflict: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".RouteConflict"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "dest"),
  ...
  static func ==(lhs: Teleport_Lib_Vnet_Diag_V1_RouteConflict, rhs: Teleport_Lib_Vnet_Diag_V1_RouteConflict) -> Bool {
