...
struct Teleport_Lib_Teleterm_V1_Kube: Sendable {
...
struct Teleport_Lib_Teleterm_V1_KubeResource: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Teleport_Lib_Teleterm_V1_Kube: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Kube"
  ...
  static func ==(lhs: Teleport_Lib_Teleterm_V1_Kube, rhs: Teleport_Lib_Teleterm_V1_Kube) -> Bool {
...
extension Teleport_Lib_Teleterm_V1_KubeResource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".KubeResource"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "uri"),
    2: .same(proto: "kind"),
    3: .same(proto: "name"),
  ...
  static func ==(lhs: Teleport_Lib_Teleterm_V1_KubeResource, rhs: Teleport_Lib_Teleterm_V1_KubeResource) -> Bool {
    if lhs.uri != rhs.uri {return false}
