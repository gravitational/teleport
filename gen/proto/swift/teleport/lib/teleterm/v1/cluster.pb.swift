...
enum Teleport_Lib_Teleterm_V1_ShowResources: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Teleport_Lib_Teleterm_V1_ShowResources] = [
    .unspecified,
    .requestable,
    .accessibleOnly,
  ]
...
struct Teleport_Lib_Teleterm_V1_Cluster: @unchecked Sendable {
  ...
  var loggedInUser: Teleport_Lib_Teleterm_V1_LoggedInUser {
  ...
  var showResources: Teleport_Lib_Teleterm_V1_ShowResources {
...
struct Teleport_Lib_Teleterm_V1_LoggedInUser: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var acl: Teleport_Lib_Teleterm_V1_ACL {
  ...
  var userType: Teleport_Lib_Teleterm_V1_LoggedInUser.UserType = .unspecified
  ...
  var trustedDeviceRequirement: Types_TrustedDeviceRequirement = .unspecified

  var unknownFields = SwiftProtobuf.UnknownStorage()

  /// UserType indicates whether the user was created through an SSO provider or in Teleport itself.
  /// Only present when detailed information is queried from the auth server.
  enum UserType: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
    case unspecified // = 0
    case local // = 1
    case sso // = 2
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    static let allCases: [Teleport_Lib_Teleterm_V1_LoggedInUser.UserType] = [
      .unspecified,
      .local,
      .sso,
    ]
...
struct Teleport_Lib_Teleterm_V1_ACL: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// auth_connectors defines access to auth.connectors
  var authConnectors: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var hasAuthConnectors: Bool {return _storage._authConnectors != nil}
  /// Clears the value of `authConnectors`. Subsequent reads from it will return its default value.
  mutating func clearAuthConnectors() {_uniqueStorage()._authConnectors = nil}

  /// Roles defines access to roles
  var roles: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var hasRoles: Bool {return _storage._roles != nil}
  /// Clears the value of `roles`. Subsequent reads from it will return its default value.
  mutating func clearRoles() {_uniqueStorage()._roles = nil}

  /// Users defines access to users.
  var users: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var hasUsers: Bool {return _storage._users != nil}
  /// Clears the value of `users`. Subsequent reads from it will return its default value.
  mutating func clearUsers() {_uniqueStorage()._users = nil}

  /// trusted_clusters defines access to trusted clusters
  var trustedClusters: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var hasTrustedClusters: Bool {return _storage._trustedClusters != nil}
  /// Clears the value of `trustedClusters`. Subsequent reads from it will return its default value.
  mutating func clearTrustedClusters() {_uniqueStorage()._trustedClusters = nil}

  /// Events defines access to audit logs
  var events: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var tokens: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var servers: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var hasServers: Bool {return _storage._servers != nil}
  /// Clears the value of `servers`. Subsequent reads from it will return its default value.
  mutating func clearServers() {_uniqueStorage()._servers = nil}

  /// apps defines access to application servers
  var apps: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var hasApps: Bool {return _storage._apps != nil}
  /// Clears the value of `apps`. Subsequent reads from it will return its default value.
  mutating func clearApps() {_uniqueStorage()._apps = nil}

  /// dbs defines access to database servers.
  var dbs: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var hasDbs: Bool {return _storage._dbs != nil}
  /// Clears the value of `dbs`. Subsequent reads from it will return its default value.
  mutating func clearDbs() {_uniqueStorage()._dbs = nil}

  /// kubeservers defines access to kubernetes servers.
  var kubeservers: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var hasKubeservers: Bool {return _storage._kubeservers != nil}
  /// Clears the value of `kubeservers`. Subsequent reads from it will return its default value.
  mutating func clearKubeservers() {_uniqueStorage()._kubeservers = nil}

  /// access_requests defines access to access requests
  var accessRequests: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var recordedSessions: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var hasRecordedSessions: Bool {return _storage._recordedSessions != nil}
  /// Clears the value of `recordedSessions`. Subsequent reads from it will return its default value.
  mutating func clearRecordedSessions() {_uniqueStorage()._recordedSessions = nil}

  /// active_sessions defines access to active sessions.
  var activeSessions: Teleport_Lib_Teleterm_V1_ResourceAccess {
  ...
  var hasActiveSessions: Bool {return _storage._activeSessions != nil}
  /// Clears the value of `activeSessions`. Subsequent reads from it will return its default value.
  mutating func clearActiveSessions() {_uniqueStorage()._activeSessions = nil}
...
struct Teleport_Lib_Teleterm_V1_ResourceAccess: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Teleport_Lib_Teleterm_V1_Cluster: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Teleport_Lib_Teleterm_V1_Cluster, rhs: Teleport_Lib_Teleterm_V1_Cluster) -> Bool {
...
extension Teleport_Lib_Teleterm_V1_LoggedInUser: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LoggedInUser"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "roles"),
  ...
  static func ==(lhs: Teleport_Lib_Teleterm_V1_LoggedInUser, rhs: Teleport_Lib_Teleterm_V1_LoggedInUser) -> Bool {
...
extension Teleport_Lib_Teleterm_V1_ACL: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Teleport_Lib_Teleterm_V1_ACL, rhs: Teleport_Lib_Teleterm_V1_ACL) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Teleport_Lib_Teleterm_V1_ResourceAccess: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ResourceAccess"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "list"),
    2: .same(proto: "read"),
    3: .same(proto: "edit"),
  ...
  static func ==(lhs: Teleport_Lib_Teleterm_V1_ResourceAccess, rhs: Teleport_Lib_Teleterm_V1_ResourceAccess) -> Bool {
...
extension Teleport_Lib_Teleterm_V1_Features: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Teleport_Lib_Teleterm_V1_Features, rhs: Teleport_Lib_Teleterm_V1_Features) -> Bool {
