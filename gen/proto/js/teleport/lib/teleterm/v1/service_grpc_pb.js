...
function serialize_teleport_lib_teleterm_v1_ListDatabasesRequest(arg) {
  if (!(arg instanceof teleport_lib_teleterm_v1_service_pb.ListDatabasesRequest)) {
    throw new Error('Expected argument of type teleport.lib.teleterm.v1.ListDatabasesRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_teleport_lib_teleterm_v1_ListDatabasesRequest(buffer_arg) {
  return teleport_lib_teleterm_v1_service_pb.ListDatabasesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_teleport_lib_teleterm_v1_ListDatabasesResponse(arg) {
  if (!(arg instanceof teleport_lib_teleterm_v1_service_pb.ListDatabasesResponse)) {
    throw new Error('Expected argument of type teleport.lib.teleterm.v1.ListDatabasesResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_teleport_lib_teleterm_v1_ListDatabasesResponse(buffer_arg) {
  return teleport_lib_teleterm_v1_service_pb.ListDatabasesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_teleport_lib_teleterm_v1_ListKubesRequest(arg) {
  if (!(arg instanceof teleport_lib_teleterm_v1_service_pb.ListKubesRequest)) {
    throw new Error('Expected argument of type teleport.lib.teleterm.v1.ListKubesRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_teleport_lib_teleterm_v1_ListKubesRequest(buffer_arg) {
  return teleport_lib_teleterm_v1_service_pb.ListKubesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_teleport_lib_teleterm_v1_ListKubesResponse(arg) {
  if (!(arg instanceof teleport_lib_teleterm_v1_service_pb.ListKubesResponse)) {
    throw new Error('Expected argument of type teleport.lib.teleterm.v1.ListKubesResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_teleport_lib_teleterm_v1_ListKubesResponse(buffer_arg) {
  return teleport_lib_teleterm_v1_service_pb.ListKubesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_teleport_lib_teleterm_v1_ListServersRequest(arg) {
  if (!(arg instanceof teleport_lib_teleterm_v1_service_pb.ListServersRequest)) {
    throw new Error('Expected argument of type teleport.lib.teleterm.v1.ListServersRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_teleport_lib_teleterm_v1_ListServersRequest(buffer_arg) {
  return teleport_lib_teleterm_v1_service_pb.ListServersRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_teleport_lib_teleterm_v1_ListServersResponse(arg) {
  if (!(arg instanceof teleport_lib_teleterm_v1_service_pb.ListServersResponse)) {
    throw new Error('Expected argument of type teleport.lib.teleterm.v1.ListServersResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_teleport_lib_teleterm_v1_ListServersResponse(buffer_arg) {
  return teleport_lib_teleterm_v1_service_pb.ListServersResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
listDatabases: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: teleport_lib_teleterm_v1_service_pb.ListDatabasesRequest,
    responseType: teleport_lib_teleterm_v1_service_pb.ListDatabasesResponse,
    requestSerialize: serialize_teleport_lib_teleterm_v1_ListDatabasesRequest,
    requestDeserialize: deserialize_teleport_lib_teleterm_v1_ListDatabasesRequest,
    responseSerialize: serialize_teleport_lib_teleterm_v1_ListDatabasesResponse,
    responseDeserialize: deserialize_teleport_lib_teleterm_v1_ListDatabasesResponse,
  },
...
listServers: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: teleport_lib_teleterm_v1_service_pb.ListServersRequest,
    responseType: teleport_lib_teleterm_v1_service_pb.ListServersResponse,
    requestSerialize: serialize_teleport_lib_teleterm_v1_ListServersRequest,
    requestDeserialize: deserialize_teleport_lib_teleterm_v1_ListServersRequest,
    responseSerialize: serialize_teleport_lib_teleterm_v1_ListServersResponse,
    responseDeserialize: deserialize_teleport_lib_teleterm_v1_ListServersResponse,
  },
...
listKubes: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: teleport_lib_teleterm_v1_service_pb.ListKubesRequest,
    responseType: teleport_lib_teleterm_v1_service_pb.ListKubesResponse,
    requestSerialize: serialize_teleport_lib_teleterm_v1_ListKubesRequest,
    requestDeserialize: deserialize_teleport_lib_teleterm_v1_ListKubesRequest,
    responseSerialize: serialize_teleport_lib_teleterm_v1_ListKubesResponse,
    responseDeserialize: deserialize_teleport_lib_teleterm_v1_ListKubesResponse,
  },
  // ListApps list apps
listApps: {
