...
goog.object.extend(proto, teleport_lib_prehog_v1alpha_connect_pb);
...
proto.teleport.lib.teleterm.v1.ReportUsageEventRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    prehogReq: (f = msg.getPrehogReq()) && teleport_lib_prehog_v1alpha_connect_pb.SubmitConnectEventRequest.toObject(includeInstance, f)
  };
...
proto.teleport.lib.teleterm.v1.ReportUsageEventRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new teleport_lib_prehog_v1alpha_connect_pb.SubmitConnectEventRequest;
      reader.readMessage(value,teleport_lib_prehog_v1alpha_connect_pb.SubmitConnectEventRequest.deserializeBinaryFromReader);
...
proto.teleport.lib.teleterm.v1.ReportUsageEventRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      teleport_lib_prehog_v1alpha_connect_pb.SubmitConnectEventRequest.serializeBinaryToWriter
    );
  }
};
...
proto.teleport.lib.teleterm.v1.ReportUsageEventRequest.prototype.getPrehogReq = function() {
  return /** @type{?proto.prehog.v1alpha.SubmitConnectEventRequest} */ (
    jspb.Message.getWrapperField(this, teleport_lib_prehog_v1alpha_connect_pb.SubmitConnectEventRequest, 2));
};
