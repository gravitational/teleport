...
goog.exportSymbol('proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest', null, global);
goog.exportSymbol('proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse', null, global);
 ...
 * @constructor
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.displayName = 'proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse.displayName = 'proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse';
}
 ...
 * @return {!Object}
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest}
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest;
  return proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest}
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * optional teleport.devicetrust.v1.DeviceWebToken device_web_token = 1;
 * @return {?proto.teleport.devicetrust.v1.DeviceWebToken}
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.prototype.getDeviceWebToken = function() {
  return /** @type{?proto.teleport.devicetrust.v1.DeviceWebToken} */ (
    jspb.Message.getWrapperField(this, teleport_devicetrust_v1_device_web_token_pb.DeviceWebToken, 1));
};


/**
 * @param {?proto.teleport.devicetrust.v1.DeviceWebToken|undefined} value
 * @return {!proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest} returns this
*/
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.prototype.setDeviceWebToken = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest} returns this
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.prototype.clearDeviceWebToken = function() {
 ...
 * @return {boolean}
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest.prototype.hasDeviceWebToken = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse}
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse;
  return proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse}
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
