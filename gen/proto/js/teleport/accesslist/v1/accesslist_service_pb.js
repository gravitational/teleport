...
goog.exportSymbol('proto.teleport.accesslist.v1.UpdateAccessListMemberRequest', null, global);
goog.exportSymbol('proto.teleport.accesslist.v1.UpdateAccessListRequest', null, global);
 ...
 * @constructor
 */
proto.teleport.accesslist.v1.UpdateAccessListRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.teleport.accesslist.v1.UpdateAccessListRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.accesslist.v1.UpdateAccessListRequest.displayName = 'proto.teleport.accesslist.v1.UpdateAccessListRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.teleport.accesslist.v1.UpdateAccessListMemberRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.teleport.accesslist.v1.UpdateAccessListMemberRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.displayName = 'proto.teleport.accesslist.v1.UpdateAccessListMemberRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.teleport.accesslist.v1.UpdateAccessListRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.accesslist.v1.UpdateAccessListRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.accesslist.v1.UpdateAccessListRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.accesslist.v1.UpdateAccessListRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    accessList: (f = msg.getAccessList()) && teleport_accesslist_v1_accesslist_pb.AccessList.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.teleport.accesslist.v1.UpdateAccessListRequest}
 */
proto.teleport.accesslist.v1.UpdateAccessListRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.accesslist.v1.UpdateAccessListRequest;
  return proto.teleport.accesslist.v1.UpdateAccessListRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.accesslist.v1.UpdateAccessListRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.accesslist.v1.UpdateAccessListRequest}
 */
proto.teleport.accesslist.v1.UpdateAccessListRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.teleport.accesslist.v1.UpdateAccessListRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.accesslist.v1.UpdateAccessListRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.accesslist.v1.UpdateAccessListRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.accesslist.v1.UpdateAccessListRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAccessList();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.teleport.accesslist.v1.AccessList}
 */
proto.teleport.accesslist.v1.UpdateAccessListRequest.prototype.getAccessList = function() {
  return /** @type{?proto.teleport.accesslist.v1.AccessList} */ (
    jspb.Message.getWrapperField(this, teleport_accesslist_v1_accesslist_pb.AccessList, 1));
};
...
/**
 * @param {?proto.teleport.accesslist.v1.AccessList|undefined} value
 * @return {!proto.teleport.accesslist.v1.UpdateAccessListRequest} returns this
*/
proto.teleport.accesslist.v1.UpdateAccessListRequest.prototype.setAccessList = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.teleport.accesslist.v1.UpdateAccessListRequest} returns this
 */
proto.teleport.accesslist.v1.UpdateAccessListRequest.prototype.clearAccessList = function() {
  return this.setAccessList(undefined);
};
 ...
 * @return {boolean}
 */
proto.teleport.accesslist.v1.UpdateAccessListRequest.prototype.hasAccessList = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.accesslist.v1.UpdateAccessListMemberRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    member: (f = msg.getMember()) && teleport_accesslist_v1_accesslist_pb.Member.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.teleport.accesslist.v1.UpdateAccessListMemberRequest}
 */
proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.accesslist.v1.UpdateAccessListMemberRequest;
  return proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.accesslist.v1.UpdateAccessListMemberRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.accesslist.v1.UpdateAccessListMemberRequest}
 */
proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.accesslist.v1.UpdateAccessListMemberRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getMember();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.teleport.accesslist.v1.Member}
 */
proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.prototype.getMember = function() {
  return /** @type{?proto.teleport.accesslist.v1.Member} */ (
    jspb.Message.getWrapperField(this, teleport_accesslist_v1_accesslist_pb.Member, 1));
};


/**
 * @param {?proto.teleport.accesslist.v1.Member|undefined} value
 * @return {!proto.teleport.accesslist.v1.UpdateAccessListMemberRequest} returns this
*/
proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.prototype.setMember = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.teleport.accesslist.v1.UpdateAccessListMemberRequest} returns this
 */
proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.prototype.clearMember = function() {
  return this.setMember(undefined);
};
 ...
 * @return {boolean}
 */
proto.teleport.accesslist.v1.UpdateAccessListMemberRequest.prototype.hasMember = function() {
  return jspb.Message.getField(this, 1) != null;
};
