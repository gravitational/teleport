...
goog.exportSymbol('proto.teleport.accesslist.v1.AccessListStatus', null, global);
 ...
 * @constructor
 */
proto.teleport.accesslist.v1.AccessListStatus = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.teleport.accesslist.v1.AccessListStatus, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.accesslist.v1.AccessListStatus.displayName = 'proto.teleport.accesslist.v1.AccessListStatus';
}
...
proto.teleport.accesslist.v1.AccessList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    status: (f = msg.getStatus()) && proto.teleport.accesslist.v1.AccessListStatus.toObject(includeInstance, f)
  };
...
proto.teleport.accesslist.v1.AccessList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.teleport.accesslist.v1.AccessListStatus;
      reader.readMessage(value,proto.teleport.accesslist.v1.AccessListStatus.deserializeBinaryFromReader);
      msg.setStatus(value);
      break;
    default:
      reader.skipField();
...
proto.teleport.accesslist.v1.AccessList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.teleport.accesslist.v1.AccessListStatus.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional AccessListStatus status = 3;
 * @return {?proto.teleport.accesslist.v1.AccessListStatus}
 */
proto.teleport.accesslist.v1.AccessList.prototype.getStatus = function() {
  return /** @type{?proto.teleport.accesslist.v1.AccessListStatus} */ (
    jspb.Message.getWrapperField(this, proto.teleport.accesslist.v1.AccessListStatus, 3));
};


/**
 * @param {?proto.teleport.accesslist.v1.AccessListStatus|undefined} value
 * @return {!proto.teleport.accesslist.v1.AccessList} returns this
*/
proto.teleport.accesslist.v1.AccessList.prototype.setStatus = function(value) {
 ...
 * @return {!proto.teleport.accesslist.v1.AccessList} returns this
 */
proto.teleport.accesslist.v1.AccessList.prototype.clearStatus = function() {
 ...
 * @return {boolean}
 */
proto.teleport.accesslist.v1.AccessList.prototype.hasStatus = function() {
 ...
 * @return {!Object}
 */
proto.teleport.accesslist.v1.AccessListStatus.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.accesslist.v1.AccessListStatus.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.accesslist.v1.AccessListStatus} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.accesslist.v1.AccessListStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    memberCount: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * @return {!proto.teleport.accesslist.v1.AccessListStatus}
 */
proto.teleport.accesslist.v1.AccessListStatus.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.accesslist.v1.AccessListStatus;
  return proto.teleport.accesslist.v1.AccessListStatus.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.accesslist.v1.AccessListStatus} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.accesslist.v1.AccessListStatus}
 */
proto.teleport.accesslist.v1.AccessListStatus.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.teleport.accesslist.v1.AccessListStatus.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.accesslist.v1.AccessListStatus.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.accesslist.v1.AccessListStatus} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.accesslist.v1.AccessListStatus.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.teleport.accesslist.v1.AccessListStatus.prototype.getMemberCount = function() {
...
/**
 * @param {number} value
 * @return {!proto.teleport.accesslist.v1.AccessListStatus} returns this
 */
proto.teleport.accesslist.v1.AccessListStatus.prototype.setMemberCount = function(value) {
  return jspb.Message.setField(this, 1, value);
};
 ...
 * @return {!proto.teleport.accesslist.v1.AccessListStatus} returns this
 */
proto.teleport.accesslist.v1.AccessListStatus.prototype.clearMemberCount = function() {
 ...
 * @return {boolean}
 */
proto.teleport.accesslist.v1.AccessListStatus.prototype.hasMemberCount = function() {
  return jspb.Message.getField(this, 1) != null;
};
