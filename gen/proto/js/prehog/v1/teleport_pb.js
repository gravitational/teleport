...
goog.exportSymbol('proto.prehog.v1.ResourceActivityRecord', null, global);
goog.exportSymbol('proto.prehog.v1.ResourceActivityReport', null, global);
 ...
 * @constructor
 */
proto.prehog.v1.ResourceActivityReport = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.prehog.v1.ResourceActivityReport.repeatedFields_, null);
};
goog.inherits(proto.prehog.v1.ResourceActivityReport, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.prehog.v1.ResourceActivityReport.displayName = 'proto.prehog.v1.ResourceActivityReport';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.prehog.v1.ResourceActivityRecord = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.prehog.v1.ResourceActivityRecord.repeatedFields_, null);
};
goog.inherits(proto.prehog.v1.ResourceActivityRecord, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.prehog.v1.ResourceActivityRecord.displayName = 'proto.prehog.v1.ResourceActivityRecord';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.prehog.v1.ResourceActivityReport.repeatedFields_ = [5];
 ...
 * @return {!Object}
 */
proto.prehog.v1.ResourceActivityReport.prototype.toObject = function(opt_includeInstance) {
  return proto.prehog.v1.ResourceActivityReport.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.prehog.v1.ResourceActivityReport} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.prehog.v1.ResourceActivityReport.toObject = function(includeInstance, msg) {
  var f, obj = {
    reportUuid: msg.getReportUuid_asB64(),
    clusterName: msg.getClusterName_asB64(),
    reporterHostid: msg.getReporterHostid_asB64(),
    startTime: (f = msg.getStartTime()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f),
    recordsList: jspb.Message.toObjectList(msg.getRecordsList(),
    proto.prehog.v1.ResourceActivityRecord.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.prehog.v1.ResourceActivityReport}
 */
proto.prehog.v1.ResourceActivityReport.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.prehog.v1.ResourceActivityReport;
  return proto.prehog.v1.ResourceActivityReport.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.prehog.v1.ResourceActivityReport} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.prehog.v1.ResourceActivityReport}
 */
proto.prehog.v1.ResourceActivityReport.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.prehog.v1.ResourceActivityRecord;
      reader.readMessage(value,proto.prehog.v1.ResourceActivityRecord.deserializeBinaryFromReader);
      msg.addRecords(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.prehog.v1.ResourceActivityReport.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.prehog.v1.ResourceActivityReport.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.prehog.v1.ResourceActivityReport} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.prehog.v1.ResourceActivityReport.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getReportUuid_asU8();
  if (f.length > 0) {
    writer.writeBytes(
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      5,
      f,
      proto.prehog.v1.ResourceActivityRecord.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.prehog.v1.ResourceActivityReport.prototype.getReportUuid = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.prehog.v1.ResourceActivityReport.prototype.getReportUuid_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getReportUuid()));
};
 ...
 * @return {!Uint8Array}
 */
proto.prehog.v1.ResourceActivityReport.prototype.getReportUuid_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getReportUuid()));
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.prehog.v1.ResourceActivityReport} returns this
 */
proto.prehog.v1.ResourceActivityReport.prototype.setReportUuid = function(value) {
  return jspb.Message.setProto3BytesField(this, 1, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.prehog.v1.ResourceActivityReport.prototype.getClusterName = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {string}
 */
proto.prehog.v1.ResourceActivityReport.prototype.getClusterName_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getClusterName()));
};
 ...
 * @return {!Uint8Array}
 */
proto.prehog.v1.ResourceActivityReport.prototype.getClusterName_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getClusterName()));
};
 ...
 * @return {!proto.prehog.v1.ResourceActivityReport} returns this
 */
proto.prehog.v1.ResourceActivityReport.prototype.setClusterName = function(value) {
  return jspb.Message.setProto3BytesField(this, 2, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.prehog.v1.ResourceActivityReport.prototype.getReporterHostid = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {string}
 */
proto.prehog.v1.ResourceActivityReport.prototype.getReporterHostid_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getReporterHostid()));
};
 ...
 * @return {!Uint8Array}
 */
proto.prehog.v1.ResourceActivityReport.prototype.getReporterHostid_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getReporterHostid()));
};
 ...
 * @return {!proto.prehog.v1.ResourceActivityReport} returns this
 */
proto.prehog.v1.ResourceActivityReport.prototype.setReporterHostid = function(value) {
  return jspb.Message.setProto3BytesField(this, 3, value);
};
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.prehog.v1.ResourceActivityReport.prototype.getStartTime = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
    jspb.Message.getWrapperField(this, google_protobuf_timestamp_pb.Timestamp, 4));
};
 ...
 * @return {!proto.prehog.v1.ResourceActivityReport} returns this
*/
proto.prehog.v1.ResourceActivityReport.prototype.setStartTime = function(value) {
  return jspb.Message.setWrapperField(this, 4, value);
};
 ...
 * @return {!proto.prehog.v1.ResourceActivityReport} returns this
 */
proto.prehog.v1.ResourceActivityReport.prototype.clearStartTime = function() {
  return this.setStartTime(undefined);
};
 ...
 * @return {boolean}
 */
proto.prehog.v1.ResourceActivityReport.prototype.hasStartTime = function() {
  return jspb.Message.getField(this, 4) != null;
};


/**
 * repeated ResourceActivityRecord records = 5;
 * @return {!Array<!proto.prehog.v1.ResourceActivityRecord>}
 */
proto.prehog.v1.ResourceActivityReport.prototype.getRecordsList = function() {
  return /** @type{!Array<!proto.prehog.v1.ResourceActivityRecord>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.prehog.v1.ResourceActivityRecord, 5));
};


/**
 * @param {!Array<!proto.prehog.v1.ResourceActivityRecord>} value
 * @return {!proto.prehog.v1.ResourceActivityReport} returns this
*/
proto.prehog.v1.ResourceActivityReport.prototype.setRecordsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 5, value);
};


/**
 * @param {!proto.prehog.v1.ResourceActivityRecord=} opt_value
 * @param {number=} opt_index
 * @return {!proto.prehog.v1.ResourceActivityRecord}
 */
proto.prehog.v1.ResourceActivityReport.prototype.addRecords = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.prehog.v1.ResourceActivityRecord, opt_index);
};
 ...
 * @return {!proto.prehog.v1.ResourceActivityReport} returns this
 */
proto.prehog.v1.ResourceActivityReport.prototype.clearRecordsList = function() {
  return this.setRecordsList([]);
};
 ...
 * @const
 */
proto.prehog.v1.ResourceActivityRecord.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.prehog.v1.ResourceActivityRecord.prototype.toObject = function(opt_includeInstance) {
  return proto.prehog.v1.ResourceActivityRecord.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.prehog.v1.ResourceActivityRecord} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.prehog.v1.ResourceActivityRecord.toObject = function(includeInstance, msg) {
  var f, obj = {
    resourceKind: jspb.Message.getFieldWithDefault(msg, 1, 0),
    resourceNameList: msg.getResourceNameList_asB64()
  };
 ...
 * @return {!proto.prehog.v1.ResourceActivityRecord}
 */
proto.prehog.v1.ResourceActivityRecord.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.prehog.v1.ResourceActivityRecord;
  return proto.prehog.v1.ResourceActivityRecord.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.prehog.v1.ResourceActivityRecord} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.prehog.v1.ResourceActivityRecord}
 */
proto.prehog.v1.ResourceActivityRecord.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.prehog.v1.ResourceActivityRecord.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.prehog.v1.ResourceActivityRecord.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.prehog.v1.ResourceActivityRecord} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.prehog.v1.ResourceActivityRecord.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  f = message.getResourceNameList_asU8();
  if (f.length > 0) {
 ...
 */
proto.prehog.v1.ResourceActivityRecord.prototype.getResourceKind = function() {
 ...
 * @return {!proto.prehog.v1.ResourceActivityRecord} returns this
 */
proto.prehog.v1.ResourceActivityRecord.prototype.setResourceKind = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};


/**
 * repeated bytes resource_name = 2;
 * @return {!(Array<!Uint8Array>|Array<string>)}
 */
proto.prehog.v1.ResourceActivityRecord.prototype.getResourceNameList = function() {
...
/**
 * repeated bytes resource_name = 2;
 * This is a type-conversion wrapper around `getResourceNameList()`
 * @return {!Array<string>}
 */
proto.prehog.v1.ResourceActivityRecord.prototype.getResourceNameList_asB64 = function() {
 ...
 */
proto.prehog.v1.ResourceActivityRecord.prototype.getResourceNameList_asU8 = function() {
 ...
 * @return {!proto.prehog.v1.ResourceActivityRecord} returns this
 */
proto.prehog.v1.ResourceActivityRecord.prototype.setResourceNameList = function(value) {
 ...
 * @return {!proto.prehog.v1.ResourceActivityRecord} returns this
 */
proto.prehog.v1.ResourceActivityRecord.prototype.addResourceName = function(value, opt_index) {
 ...
 * @return {!proto.prehog.v1.ResourceActivityRecord} returns this
 */
proto.prehog.v1.ResourceActivityRecord.prototype.clearResourceNameList = function() {
  return this.setResourceNameList([]);
};
...
proto.prehog.v1.SubmitUsageReportsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    resourceActivityList: jspb.Message.toObjectList(msg.getResourceActivityList(),
    proto.prehog.v1.ResourceActivityReport.toObject, includeInstance)
  };
...
proto.prehog.v1.SubmitUsageReportsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.prehog.v1.ResourceActivityReport;
      reader.readMessage(value,proto.prehog.v1.ResourceActivityReport.deserializeBinaryFromReader);
      msg.addResourceActivity(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.prehog.v1.SubmitUsageReportsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getResourceActivityList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.prehog.v1.ResourceActivityReport.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated ResourceActivityReport resource_activity = 2;
 * @return {!Array<!proto.prehog.v1.ResourceActivityReport>}
 */
proto.prehog.v1.SubmitUsageReportsRequest.prototype.getResourceActivityList = function() {
  return /** @type{!Array<!proto.prehog.v1.ResourceActivityReport>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.prehog.v1.ResourceActivityReport, 2));
};


/**
 * @param {!Array<!proto.prehog.v1.ResourceActivityReport>} value
 * @return {!proto.prehog.v1.SubmitUsageReportsRequest} returns this
*/
proto.prehog.v1.SubmitUsageReportsRequest.prototype.setResourceActivityList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.prehog.v1.ResourceActivityReport=} opt_value
 * @param {number=} opt_index
 * @return {!proto.prehog.v1.ResourceActivityReport}
 */
proto.prehog.v1.SubmitUsageReportsRequest.prototype.addResourceActivity = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.prehog.v1.ResourceActivityReport, opt_index);
};
 ...
 * @return {!proto.prehog.v1.SubmitUsageReportsRequest} returns this
 */
proto.prehog.v1.SubmitUsageReportsRequest.prototype.clearResourceActivityList = function() {
  return this.setResourceActivityList([]);
};
