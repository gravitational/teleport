...
type GitlabResourceList struct {
	state                protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Resources *[]*GitlabResource     `protobuf:"bytes,1,rep,name=resources,proto3"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type GitlabResource struct {
	state               protoimpl.MessageState    `protogen:"opaque.v1"`
	xxx_hidden_Resource isGitlabResource_Resource `protobuf_oneof:"resource"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *GitlabResource) GetGroup() *GitlabGroup {
	if x != nil {
		if x, ok := x.xxx_hidden_Resource.(*gitlabResource_Group); ok {
			return x.Group
		}
	}
	return nil
...
func (x *GitlabResource) GetProject() *GitlabProject {
	if x != nil {
		if x, ok := x.xxx_hidden_Resource.(*gitlabResource_Project); ok {
			return x.Project
		}
	}
	return nil
...
func (x *GitlabResource) GetProjectMember() *GitlabProjectMember {
	if x != nil {
		if x, ok := x.xxx_hidden_Resource.(*gitlabResource_ProjectMember); ok {
...
func (x *GitlabResource) GetGroupMember() *GitlabGroupMember {
	if x != nil {
		if x, ok := x.xxx_hidden_Resource.(*gitlabResource_GroupMember); ok {
...
func (x *GitlabResource) GetUser() *GitlabUser {
	if x != nil {
		if x, ok := x.xxx_hidden_Resource.(*gitlabResource_User); ok {
			return x.User
		}
	}
	return nil
...
func (x *GitlabResource) SetGroup(v *GitlabGroup) {
	...
	x.xxx_hidden_Resource = &gitlabResource_Group{v}
}
...
func (x *GitlabResource) SetProject(v *GitlabProject) {
	...
	x.xxx_hidden_Resource = &gitlabResource_Project{v}
}
...
func (x *GitlabResource) SetProjectMember(v *GitlabProjectMember) {
	...
	x.xxx_hidden_Resource = &gitlabResource_ProjectMember{v}
}
...
func (x *GitlabResource) SetGroupMember(v *GitlabGroupMember) {
	...
	x.xxx_hidden_Resource = &gitlabResource_GroupMember{v}
}
...
func (x *GitlabResource) SetUser(v *GitlabUser) {
	...
	x.xxx_hidden_Resource = &gitlabResource_User{v}
}
...
func (x *GitlabResource) HasGroup() bool {
	...
	_, ok := x.xxx_hidden_Resource.(*gitlabResource_Group)
	return ok
}
...
func (x *GitlabResource) HasProject() bool {
	...
	_, ok := x.xxx_hidden_Resource.(*gitlabResource_Project)
	return ok
}
...
func (x *GitlabResource) HasProjectMember() bool {
	...
	_, ok := x.xxx_hidden_Resource.(*gitlabResource_ProjectMember)
	return ok
}
...
func (x *GitlabResource) HasGroupMember() bool {
	...
	_, ok := x.xxx_hidden_Resource.(*gitlabResource_GroupMember)
	return ok
}
...
func (x *GitlabResource) HasUser() bool {
	...
	_, ok := x.xxx_hidden_Resource.(*gitlabResource_User)
	return ok
}
...
func (x *GitlabResource) ClearGroup() {
	if _, ok := x.xxx_hidden_Resource.(*gitlabResource_Group); ok {
		x.xxx_hidden_Resource = nil
	}
}

func (x *GitlabResource) ClearProject() {
	if _, ok := x.xxx_hidden_Resource.(*gitlabResource_Project); ok {
		x.xxx_hidden_Resource = nil
	}
}

func (x *GitlabResource) ClearProjectMember() {
	if _, ok := x.xxx_hidden_Resource.(*gitlabResource_ProjectMember); ok {
		x.xxx_hidden_Resource = nil
	}
}

func (x *GitlabResource) ClearGroupMember() {
	if _, ok := x.xxx_hidden_Resource.(*gitlabResource_GroupMember); ok {
		x.xxx_hidden_Resource = nil
	}
}

func (x *GitlabResource) ClearUser() {
	if _, ok := x.xxx_hidden_Resource.(*gitlabResource_User); ok {
		x.xxx_hidden_Resource = nil
	}
}
...
func (b0 GitlabResource_builder) Build() *GitlabResource {
	...
	_, _ = b, x
	if b.Group != nil {
		x.xxx_hidden_Resource = &gitlabResource_Group{b.Group}
	}
	if b.Project != nil {
		x.xxx_hidden_Resource = &gitlabResource_Project{b.Project}
	}
	if b.ProjectMember != nil {
		x.xxx_hidden_Resource = &gitlabResource_ProjectMember{b.ProjectMember}
	}
	if b.GroupMember != nil {
		x.xxx_hidden_Resource = &gitlabResource_GroupMember{b.GroupMember}
	}
	if b.User != nil {
		x.xxx_hidden_Resource = &gitlabResource_User{b.User}
	}
	return m0
}
...
type GitlabProjectMember struct {
	...
	xxx_hidden_AccessLevel AccessLevelType        `protobuf:"varint,2,opt,name=access_level,json=accessLevel,proto3,enum=accessgraph.v1alpha.AccessLevelType"`
	xxx_hidden_Project     *GitlabProject         `protobuf:"bytes,3,opt,name=project,proto3"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type GitlabGroupMember struct {
	...
	xxx_hidden_Username    string                 `protobuf:"bytes,1,opt,name=username,proto3"`
	xxx_hidden_AccessLevel AccessLevelType        `protobuf:"varint,2,opt,name=access_level,json=accessLevel,proto3,enum=accessgraph.v1alpha.AccessLevelType"`
	xxx_hidden_Group       *GitlabGroup           `protobuf:"bytes,3,opt,name=group,proto3"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type GitlabUser struct {
	...
	xxx_hidden_IsAdmin          bool                   `protobuf:"varint,4,opt,name=is_admin,json=isAdmin,proto3"`
	xxx_hidden_Organization     string                 `protobuf:"bytes,5,opt,name=organization,proto3"`
	xxx_hidden_LastSignInAt     *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=last_sign_in_at,json=lastSignInAt,proto3"`
	xxx_hidden_CanCreateGroup   bool                   `protobuf:"varint,7,opt,name=can_create_group,json=canCreateGroup,proto3"`
	xxx_hidden_CanCreateProject bool                   `protobuf:"varint,8,opt,name=can_create_project,json=canCreateProject,proto3"`
	xxx_hidden_TwoFactorEnabled bool                   `protobuf:"varint,9,opt,name=two_factor_enabled,json=twoFactorEnabled,proto3"`
	xxx_hidden_Identities       *[]*GitlabUserIdentity `protobuf:"bytes,10,rep,name=identities,proto3"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *GitlabUser) GetLastSignInAt() *timestamppb.Timestamp {
	if x != nil {
		return x.xxx_hidden_LastSignInAt
	}
	return nil
}
...
func (x *GitlabUser) GetCanCreateGroup() bool {
	if x != nil {
		return x.xxx_hidden_CanCreateGroup
	}
	return false
}
...
func (x *GitlabUser) GetCanCreateProject() bool {
	if x != nil {
		return x.xxx_hidden_CanCreateProject
	}
	return false
}
...
func (x *GitlabUser) SetLastSignInAt(v *timestamppb.Timestamp) {
	x.xxx_hidden_LastSignInAt = v
}

func (x *GitlabUser) SetCanCreateGroup(v bool) {
	x.xxx_hidden_CanCreateGroup = v
}

func (x *GitlabUser) SetCanCreateProject(v bool) {
	x.xxx_hidden_CanCreateProject = v
}
...
func (x *GitlabUser) HasLastSignInAt() bool {
	...
	return x.xxx_hidden_LastSignInAt != nil
}

func (x *GitlabUser) ClearLastSignInAt() {
	x.xxx_hidden_LastSignInAt = nil
}
...
func (b0 GitlabUser_builder) Build() *GitlabUser {
	...
	x.xxx_hidden_Name = b.Name
	x.xxx_hidden_IsAdmin = b.IsAdmin
	x.xxx_hidden_Organization = b.Organization
	x.xxx_hidden_LastSignInAt = b.LastSignInAt
	x.xxx_hidden_CanCreateGroup = b.CanCreateGroup
	x.xxx_hidden_CanCreateProject = b.CanCreateProject
...
type GitlabUserIdentity struct {
	...
	xxx_hidden_ExternUid string                 `protobuf:"bytes,2,opt,name=extern_uid,json=externUid,proto3"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (b0 GitlabUserIdentity_builder) Build() *GitlabUserIdentity {
	...
	x.xxx_hidden_ExternUid = b.ExternUid
	return m0
}
