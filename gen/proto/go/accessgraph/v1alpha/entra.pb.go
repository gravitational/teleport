...
type EntraApplication struct {
	...
	// sso_application contains payload from the /ApplicationSso/{servicePrincipalId}/SsoApplication endpoint.
	// It is exposed from the internal plugin cache as an opaque JSON blob.
	SsoApplication string `protobuf:"bytes,6,opt,name=sso_application,json=ssoApplication,proto3" json:"sso_application,omitempty"`
	// federated_sso_v2 contains payload from the /ApplicationSso/{servicePrincipalId}/FederatedSSOV2 endpoint.
	// It is exposed from the internal plugin cache as an opaque JSON blob.
	FederatedSsoV2 string `protobuf:"bytes,7,opt,name=federated_sso_v2,json=federatedSsoV2,proto3" json:"federated_sso_v2,omitempty"`
}
...
func (x *EntraApplication) GetSsoApplication() string {
	if x != nil {
		return x.SsoApplication
	}
	return ""
}
...
var file_accessgraph_v1alpha_entra_proto_rawDesc = []byte{
	...
	0x0a, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xff, 0x01, 0x0a, 0x10,
	0x45, 0x6e, 0x74, 0x72, 0x61, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x73,
	0x6f, 0x5f, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0e, 0x73, 0x73, 0x6f, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x28, 0x0a, 0x10, 0x66, 0x65, 0x64, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64,
	0x5f, 0x73, 0x73, 0x6f, 0x5f, 0x76, 0x32, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x66,
	0x65, 0x64, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x53, 0x73, 0x6f, 0x56, 0x32, 0x42, 0x57, 0x5a,
...
var file_accessgraph_v1alpha_entra_proto_goTypes = []interface{}{
...
func file_accessgraph_v1alpha_entra_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_accessgraph_v1alpha_entra_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EntraSyncOperation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_accessgraph_v1alpha_entra_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EntraResourceList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_accessgraph_v1alpha_entra_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EntraResource); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_accessgraph_v1alpha_entra_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EntraApplication); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_accessgraph_v1alpha_entra_proto_msgTypes[2].OneofWrappers = []interface{}{
