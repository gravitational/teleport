...
type AzureEventStreamRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to Operation:
	//
	//	*AzureEventStreamRequest_Sync
	//	*AzureEventStreamRequest_Upsert
	//	*AzureEventStreamRequest_Delete
	Operation isAzureEventStreamRequest_Operation `protobuf_oneof:"operation"`
}

func (x *AzureEventStreamRequest) Reset() {
	*x = AzureEventStreamRequest{}
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AzureEventStreamRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AzureEventStreamRequest) ProtoMessage() {}

func (x *AzureEventStreamRequest) ProtoReflect() protoreflect.Message {
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AzureEventStreamRequest.ProtoReflect.Descriptor instead.
func (*AzureEventStreamRequest) Descriptor() ([]byte, []int) {
	return file_accessgraph_v1alpha_access_graph_service_proto_rawDescGZIP(), []int{21}
}

func (m *AzureEventStreamRequest) GetOperation() isAzureEventStreamRequest_Operation {
	if m != nil {
		return m.Operation
	}
	return nil
...
func (x *AzureEventStreamRequest) GetSync() *AzureSyncOperation {
	if x, ok := x.GetOperation().(*AzureEventStreamRequest_Sync); ok {
		return x.Sync
	}
	return nil
}

func (x *AzureEventStreamRequest) GetUpsert() *AzureResourceList {
	if x, ok := x.GetOperation().(*AzureEventStreamRequest_Upsert); ok {
		return x.Upsert
	}
	return nil
}

func (x *AzureEventStreamRequest) GetDelete() *AzureResourceList {
	if x, ok := x.GetOperation().(*AzureEventStreamRequest_Delete); ok {
		return x.Delete
	}
	return nil
}

type isAzureEventStreamRequest_Operation interface {
	isAzureEventStreamRequest_Operation()
}

type AzureEventStreamRequest_Sync struct {
	Sync *AzureSyncOperation `protobuf:"bytes,1,opt,name=sync,proto3,oneof"`
}

type AzureEventStreamRequest_Upsert struct {
	Upsert *AzureResourceList `protobuf:"bytes,2,opt,name=upsert,proto3,oneof"`
}

type AzureEventStreamRequest_Delete struct {
	Delete *AzureResourceList `protobuf:"bytes,3,opt,name=delete,proto3,oneof"`
}

func (*AzureEventStreamRequest_Sync) isAzureEventStreamRequest_Operation() {}

func (*AzureEventStreamRequest_Upsert) isAzureEventStreamRequest_Operation() {}

func (*AzureEventStreamRequest_Delete) isAzureEventStreamRequest_Operation() {}
...
var file_accessgraph_v1alpha_access_graph_service_proto_rawDesc = []byte{
	...
	0x76, 0x65, 0x6e, 0x74, 0x73, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0xe9, 0x01, 0x0a, 0x17, 0x41, 0x7a, 0x75, 0x72, 0x65, 0x45, 0x76, 0x65,
	...
	0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x67, 0x72, 0x61, 0x70, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c,
	0x70, 0x68, 0x61, 0x2e, 0x41, 0x7a, 0x75, 0x72, 0x65, 0x53, 0x79, 0x6e, 0x63, 0x4f, 0x70, 0x65,
	...
	0x14, 0x0a, 0x12, 0x41, 0x7a, 0x75, 0x72, 0x65, 0x53, 0x79, 0x6e, 0x63, 0x4f, 0x70, 0x65, 0x72,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x1b, 0x0a, 0x19, 0x41, 0x7a, 0x75, 0x72, 0x65, 0x45, 0x76,
...
var file_accessgraph_v1alpha_access_graph_service_proto_goTypes = []any{
	...
	(*AzureEventStreamRequest)(nil),    // 21: accessgraph.v1alpha.AzureEventStreamRequest
...
var file_accessgraph_v1alpha_access_graph_service_proto_depIdxs = []int32{
	...
	22, // 23: accessgraph.v1alpha.AzureEventStreamRequest.sync:type_name -> accessgraph.v1alpha.AzureSyncOperation
	36, // 24: accessgraph.v1alpha.AzureEventStreamRequest.upsert:type_name -> accessgraph.v1alpha.AzureResourceList
	36, // 25: accessgraph.v1alpha.AzureEventStreamRequest.delete:type_name -> accessgraph.v1alpha.AzureResourceList
	...
	1,  // 35: accessgraph.v1alpha.AccessGraphService.Query:output_type -> accessgraph.v1alpha.QueryResponse
	3,  // 36: accessgraph.v1alpha.AccessGraphService.GetFile:output_type -> accessgraph.v1alpha.GetFileResponse
	7,  // 37: accessgraph.v1alpha.AccessGraphService.EventsStream:output_type -> accessgraph.v1alpha.EventsStreamResponse
	8,  // 38: accessgraph.v1alpha.AccessGraphService.EventsStreamV2:output_type -> accessgraph.v1alpha.EventsStreamV2Response
	11, // 39: accessgraph.v1alpha.AccessGraphService.Register:output_type -> accessgraph.v1alpha.RegisterResponse
	13, // 40: accessgraph.v1alpha.AccessGraphService.ReplaceCAs:output_type -> accessgraph.v1alpha.ReplaceCAsResponse
	16, // 41: accessgraph.v1alpha.AccessGraphService.AWSEventsStream:output_type -> accessgraph.v1alpha.AWSEventsStreamResponse
	18, // 42: accessgraph.v1alpha.AccessGraphService.GitlabEventsStream:output_type -> accessgraph.v1alpha.GitlabEventsStreamResponse
	20, // 43: accessgraph.v1alpha.AccessGraphService.EntraEventsStream:output_type -> accessgraph.v1alpha.EntraEventsStreamResponse
...
func file_accessgraph_v1alpha_access_graph_service_proto_init() {
	...
	file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[21].OneofWrappers = []any{
		(*AzureEventStreamRequest_Sync)(nil),
		(*AzureEventStreamRequest_Upsert)(nil),
		(*AzureEventStreamRequest_Delete)(nil),
	}
	type x struct{}
