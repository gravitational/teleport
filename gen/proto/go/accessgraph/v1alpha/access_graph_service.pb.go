...
var file_accessgraph_v1alpha_access_graph_service_proto_goTypes = []interface{}{
	...
	(*AccessListsMembers)(nil),        // 11: accessgraph.v1alpha.AccessListsMembers
	(*ExcludeAccessListsMembers)(nil), // 12: accessgraph.v1alpha.ExcludeAccessListsMembers
}
var file_accessgraph_v1alpha_access_graph_service_proto_depIdxs = []int32{
	...
	11, // 5: accessgraph.v1alpha.EventsStreamRequest.access_lists_members:type_name -> accessgraph.v1alpha.AccessListsMembers
	12, // 6: accessgraph.v1alpha.EventsStreamRequest.exclude_access_list_members:type_name -> accessgraph.v1alpha.ExcludeAccessListsMembers
	...
	1,  // 10: accessgraph.v1alpha.AccessGraphService.Query:output_type -> accessgraph.v1alpha.QueryResponse
	3,  // 11: accessgraph.v1alpha.AccessGraphService.GetFile:output_type -> accessgraph.v1alpha.GetFileResponse
	6,  // 12: accessgraph.v1alpha.AccessGraphService.EventsStream:output_type -> accessgraph.v1alpha.EventsStreamResponse
