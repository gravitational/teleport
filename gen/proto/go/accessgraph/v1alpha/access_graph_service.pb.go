...
type AWSCloudWatchStreamRequest struct {
	...
	//	*AWSCloudWatchStreamRequest_Events
...
func (x *AWSCloudWatchStreamRequest) GetEvents() *AWSCloudWatchEvents {
	if x != nil {
		if x, ok := x.Action.(*AWSCloudWatchStreamRequest_Events); ok {
			return x.Events
		}
	}
	return nil
...
type AWSCloudWatchStreamRequest_Events struct {
	// CloudWatch event data, sent once Access Graph has returned the required
	// configuration
	Events *AWSCloudWatchEvents `protobuf:"bytes,2,opt,name=events,proto3,oneof"`
}

func (*AWSCloudWatchStreamRequest_Config) isAWSCloudWatchStreamRequest_Action() {}

func (*AWSCloudWatchStreamRequest_Events) isAWSCloudWatchStreamRequest_Action() {}
...
// and paging
type AWSCloudWatchEvents struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *AWSCloudWatchEvents) Reset() {
	*x = AWSCloudWatchEvents{}
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AWSCloudWatchEvents) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AWSCloudWatchEvents) ProtoMessage() {}

func (x *AWSCloudWatchEvents) ProtoReflect() protoreflect.Message {
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[45]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AWSCloudWatchEvents.ProtoReflect.Descriptor instead.
func (*AWSCloudWatchEvents) Descriptor() ([]byte, []int) {
	return file_accessgraph_v1alpha_access_graph_service_proto_rawDescGZIP(), []int{45}
}

func (x *AWSCloudWatchEvents) GetEvents() []*AWSCloudWatchEvent {
	if x != nil {
		return x.Events
	}
	return nil
...
func (x *AWSCloudWatchEvents) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
const file_accessgraph_v1alpha_access_graph_service_proto_rawDesc = "" +
	...
	"\x06events\x18\x02 \x01(\v2(.accessgraph.v1alpha.AWSCloudWatchEventsH\x00R\x06eventsB\b\n" +
	"\x06action\"\xae\x01\n" +
	...
	"\n" +
	"next_token\x18\x02 \x01(\tR\tnextToken\x129\n" +
	"\n" +
	"start_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\"\xaf\x01\n" +
...
var file_accessgraph_v1alpha_access_graph_service_proto_goTypes = []any{
	...
	(*AWSCloudWatchEvents)(nil),          // 45: accessgraph.v1alpha.AWSCloudWatchEvents
	(*AWSCloudWatchEvent)(nil),           // 46: accessgraph.v1alpha.AWSCloudWatchEvent
	(*AWSCloudWatchCursor)(nil),          // 47: accessgraph.v1alpha.AWSCloudWatchCursor
	(*GitHubAuditLogStreamRequest)(nil),  // 48: accessgraph.v1alpha.GitHubAuditLogStreamRequest
	(*GitHubAuditLogStreamResponse)(nil), // 49: accessgraph.v1alpha.GitHubAuditLogStreamResponse
	(*GitHubEventsStreamRequest)(nil),    // 50: accessgraph.v1alpha.GitHubEventsStreamRequest
	(*GitHubEventsStreamResponse)(nil),   // 51: accessgraph.v1alpha.GitHubEventsStreamResponse
	(*OktaAuditLogStreamRequest)(nil),    // 52: accessgraph.v1alpha.OktaAuditLogStreamRequest
	(*OktaAuditLogStreamResponse)(nil),   // 53: accessgraph.v1alpha.OktaAuditLogStreamResponse
	(*OktaEventsStreamRequest)(nil),      // 54: accessgraph.v1alpha.OktaEventsStreamRequest
	(*OktaEventsStreamResponse)(nil),     // 55: accessgraph.v1alpha.OktaEventsStreamResponse
	nil,                                  // 56: accessgraph.v1alpha.BulkResumeDate.ChunkCursorsEntry
	(*Node)(nil),                         // 57: accessgraph.v1alpha.Node
	(*Edge)(nil),                         // 58: accessgraph.v1alpha.Edge
	(*ResourceList)(nil),                 // 59: accessgraph.v1alpha.ResourceList
	(*ResourceHeaderList)(nil),           // 60: accessgraph.v1alpha.ResourceHeaderList
	(*AccessListsMembers)(nil),           // 61: accessgraph.v1alpha.AccessListsMembers
	(*ExcludeAccessListsMembers)(nil),    // 62: accessgraph.v1alpha.ExcludeAccessListsMembers
	(*AccessPathChanged)(nil),            // 63: accessgraph.v1alpha.AccessPathChanged
	(*timestamppb.Timestamp)(nil),        // 64: google.protobuf.Timestamp
	(*v1.EventUnstructured)(nil),         // 65: teleport.auditlog.v1.EventUnstructured
	(*emptypb.Empty)(nil),                // 66: google.protobuf.Empty
	(*AWSResourceList)(nil),              // 67: accessgraph.v1alpha.AWSResourceList
	(*GitlabSyncOperation)(nil),          // 68: accessgraph.v1alpha.GitlabSyncOperation
	(*GitlabResourceList)(nil),           // 69: accessgraph.v1alpha.GitlabResourceList
	(*EntraSyncOperation)(nil),           // 70: accessgraph.v1alpha.EntraSyncOperation
	(*EntraResourceList)(nil),            // 71: accessgraph.v1alpha.EntraResourceList
	(*AzureResourceList)(nil),            // 72: accessgraph.v1alpha.AzureResourceList
	(*NetIQResourceList)(nil),            // 73: accessgraph.v1alpha.NetIQResourceList
	...
	(*OktaAuditLogV1)(nil),               // 80: accessgraph.v1alpha.OktaAuditLogV1
	(*OktaAuditLogV1Cursor)(nil),         // 81: accessgraph.v1alpha.OktaAuditLogV1Cursor
	(*OktaResourceList)(nil),             // 82: accessgraph.v1alpha.OktaResourceList
	(*OktaSync)(nil),                     // 83: accessgraph.v1alpha.OktaSync
}
var file_accessgraph_v1alpha_access_graph_service_proto_depIdxs = []int32{
	57, // 0: accessgraph.v1alpha.QueryResponse.nodes:type_name -> accessgraph.v1alpha.Node
	58, // 1: accessgraph.v1alpha.QueryResponse.edges:type_name -> accessgraph.v1alpha.Edge
	6,  // 2: accessgraph.v1alpha.EventsStreamRequest.sync:type_name -> accessgraph.v1alpha.SyncOperation
	59, // 3: accessgraph.v1alpha.EventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.ResourceList
	60, // 4: accessgraph.v1alpha.EventsStreamRequest.delete:type_name -> accessgraph.v1alpha.ResourceHeaderList
	61, // 5: accessgraph.v1alpha.EventsStreamRequest.access_lists_members:type_name -> accessgraph.v1alpha.AccessListsMembers
	62, // 6: accessgraph.v1alpha.EventsStreamRequest.exclude_access_list_members:type_name -> accessgraph.v1alpha.ExcludeAccessListsMembers
	6,  // 7: accessgraph.v1alpha.EventsStreamV2Request.sync:type_name -> accessgraph.v1alpha.SyncOperation
	59, // 8: accessgraph.v1alpha.EventsStreamV2Request.upsert:type_name -> accessgraph.v1alpha.ResourceList
	60, // 9: accessgraph.v1alpha.EventsStreamV2Request.delete:type_name -> accessgraph.v1alpha.ResourceHeaderList
	61, // 10: accessgraph.v1alpha.EventsStreamV2Request.access_lists_members:type_name -> accessgraph.v1alpha.AccessListsMembers
	62, // 11: accessgraph.v1alpha.EventsStreamV2Request.exclude_access_list_members:type_name -> accessgraph.v1alpha.ExcludeAccessListsMembers
	9,  // 12: accessgraph.v1alpha.EventsStreamV2Response.event:type_name -> accessgraph.v1alpha.AuditEvent
	63, // 13: accessgraph.v1alpha.AuditEvent.access_path_changed:type_name -> accessgraph.v1alpha.AccessPathChanged
	...
	64, // 17: accessgraph.v1alpha.AuditLogConfig.start_date:type_name -> google.protobuf.Timestamp
	65, // 18: accessgraph.v1alpha.AuditLogEvents.events:type_name -> teleport.auditlog.v1.EventUnstructured
	...
	64, // 21: accessgraph.v1alpha.SearchResumeState.last_event_time:type_name -> google.protobuf.Timestamp
	64, // 22: accessgraph.v1alpha.BulkResumeStateUpdate.date:type_name -> google.protobuf.Timestamp
	64, // 23: accessgraph.v1alpha.BulkResumeStateSync.active_dates:type_name -> google.protobuf.Timestamp
	11, // 24: accessgraph.v1alpha.AuditLogStreamResponse.audit_log_config:type_name -> accessgraph.v1alpha.AuditLogConfig
	66, // 25: accessgraph.v1alpha.AuditLogStreamResponse.no_resume_state:type_name -> google.protobuf.Empty
	...
	64, // 29: accessgraph.v1alpha.BulkResumeDate.date:type_name -> google.protobuf.Timestamp
	56, // 30: accessgraph.v1alpha.BulkResumeDate.chunk_cursors:type_name -> accessgraph.v1alpha.BulkResumeDate.ChunkCursorsEntry
	24, // 31: accessgraph.v1alpha.AWSEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.AWSSyncOperation
	67, // 32: accessgraph.v1alpha.AWSEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.AWSResourceList
	67, // 33: accessgraph.v1alpha.AWSEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.AWSResourceList
	68, // 34: accessgraph.v1alpha.GitlabEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.GitlabSyncOperation
	69, // 35: accessgraph.v1alpha.GitlabEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.GitlabResourceList
	69, // 36: accessgraph.v1alpha.GitlabEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.GitlabResourceList
	70, // 37: accessgraph.v1alpha.EntraEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.EntraSyncOperation
	71, // 38: accessgraph.v1alpha.EntraEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.EntraResourceList
	71, // 39: accessgraph.v1alpha.EntraEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.EntraResourceList
	31, // 40: accessgraph.v1alpha.AzureEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.AzureSyncOperation
	72, // 41: accessgraph.v1alpha.AzureEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.AzureResourceList
	72, // 42: accessgraph.v1alpha.AzureEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.AzureResourceList
	34, // 43: accessgraph.v1alpha.NetIQEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.NetIQSyncOperation
	73, // 44: accessgraph.v1alpha.NetIQEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.NetIQResourceList
	73, // 45: accessgraph.v1alpha.NetIQEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.NetIQResourceList
	...
	45, // 51: accessgraph.v1alpha.AWSCloudWatchStreamRequest.events:type_name -> accessgraph.v1alpha.AWSCloudWatchEvents
	...
	75, // 60: accessgraph.v1alpha.GitHubAuditLogStreamRequest.audit_log:type_name -> accessgraph.v1alpha.GitHubAuditLogV1
	74, // 61: accessgraph.v1alpha.GitHubAuditLogStreamResponse.github_config:type_name -> accessgraph.v1alpha.GitHubConfigV1
	76, // 62: accessgraph.v1alpha.GitHubAuditLogStreamResponse.audit_log_resume_state:type_name -> accessgraph.v1alpha.GitHubAuditLogV1Cursor
	77, // 63: accessgraph.v1alpha.GitHubEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.GithubResourceList
	77, // 64: accessgraph.v1alpha.GitHubEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.GithubResourceList
	78, // 65: accessgraph.v1alpha.GitHubEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.GithubSync
	79, // 66: accessgraph.v1alpha.OktaAuditLogStreamRequest.config:type_name -> accessgraph.v1alpha.OktaConfigV1
	80, // 67: accessgraph.v1alpha.OktaAuditLogStreamRequest.audit_log:type_name -> accessgraph.v1alpha.OktaAuditLogV1
	79, // 68: accessgraph.v1alpha.OktaAuditLogStreamResponse.config:type_name -> accessgraph.v1alpha.OktaConfigV1
	81, // 69: accessgraph.v1alpha.OktaAuditLogStreamResponse.audit_log_resume_state:type_name -> accessgraph.v1alpha.OktaAuditLogV1Cursor
	82, // 70: accessgraph.v1alpha.OktaEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.OktaResourceList
	82, // 71: accessgraph.v1alpha.OktaEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.OktaResourceList
	83, // 72: accessgraph.v1alpha.OktaEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.OktaSync
	0,  // 73: accessgraph.v1alpha.AccessGraphService.Query:input_type -> accessgraph.v1alpha.QueryRequest
	2,  // 74: accessgraph.v1alpha.AccessGraphService.GetFile:input_type -> accessgraph.v1alpha.GetFileRequest
	4,  // 75: accessgraph.v1alpha.AccessGraphService.EventsStream:input_type -> accessgraph.v1alpha.EventsStreamRequest
	5,  // 76: accessgraph.v1alpha.AccessGraphService.EventsStreamV2:input_type -> accessgraph.v1alpha.EventsStreamV2Request
	10, // 77: accessgraph.v1alpha.AccessGraphService.AuditLogStream:input_type -> accessgraph.v1alpha.AuditLogStreamRequest
	36, // 78: accessgraph.v1alpha.AccessGraphService.AWSCloudTrailStream:input_type -> accessgraph.v1alpha.AWSCloudTrailStreamRequest
	42, // 79: accessgraph.v1alpha.AccessGraphService.AWSCloudWatchStream:input_type -> accessgraph.v1alpha.AWSCloudWatchStreamRequest
	19, // 80: accessgraph.v1alpha.AccessGraphService.Register:input_type -> accessgraph.v1alpha.RegisterRequest
	21, // 81: accessgraph.v1alpha.AccessGraphService.ReplaceCAs:input_type -> accessgraph.v1alpha.ReplaceCAsRequest
	23, // 82: accessgraph.v1alpha.AccessGraphService.AWSEventsStream:input_type -> accessgraph.v1alpha.AWSEventsStreamRequest
	26, // 83: accessgraph.v1alpha.AccessGraphService.GitlabEventsStream:input_type -> accessgraph.v1alpha.GitlabEventsStreamRequest
	28, // 84: accessgraph.v1alpha.AccessGraphService.EntraEventsStream:input_type -> accessgraph.v1alpha.EntraEventsStreamRequest
	30, // 85: accessgraph.v1alpha.AccessGraphService.AzureEventsStream:input_type -> accessgraph.v1alpha.AzureEventsStreamRequest
	33, // 86: accessgraph.v1alpha.AccessGraphService.NetIQEventsStream:input_type -> accessgraph.v1alpha.NetIQEventsStreamRequest
	48, // 87: accessgraph.v1alpha.AccessGraphService.GitHubAuditLogStream:input_type -> accessgraph.v1alpha.GitHubAuditLogStreamRequest
	50, // 88: accessgraph.v1alpha.AccessGraphService.GitHubEventsStream:input_type -> accessgraph.v1alpha.GitHubEventsStreamRequest
	52, // 89: accessgraph.v1alpha.AccessGraphService.OktaAuditLogStream:input_type -> accessgraph.v1alpha.OktaAuditLogStreamRequest
	54, // 90: accessgraph.v1alpha.AccessGraphService.OktaEventsStream:input_type -> accessgraph.v1alpha.OktaEventsStreamRequest
	1,  // 91: accessgraph.v1alpha.AccessGraphService.Query:output_type -> accessgraph.v1alpha.QueryResponse
	3,  // 92: accessgraph.v1alpha.AccessGraphService.GetFile:output_type -> accessgraph.v1alpha.GetFileResponse
	7,  // 93: accessgraph.v1alpha.AccessGraphService.EventsStream:output_type -> accessgraph.v1alpha.EventsStreamResponse
	8,  // 94: accessgraph.v1alpha.AccessGraphService.EventsStreamV2:output_type -> accessgraph.v1alpha.EventsStreamV2Response
	16, // 95: accessgraph.v1alpha.AccessGraphService.AuditLogStream:output_type -> accessgraph.v1alpha.AuditLogStreamResponse
	39, // 96: accessgraph.v1alpha.AccessGraphService.AWSCloudTrailStream:output_type -> accessgraph.v1alpha.AWSCloudTrailStreamResponse
	43, // 97: accessgraph.v1alpha.AccessGraphService.AWSCloudWatchStream:output_type -> accessgraph.v1alpha.AWSCloudWatchStreamResponse
	...
	49, // 105: accessgraph.v1alpha.AccessGraphService.GitHubAuditLogStream:output_type -> accessgraph.v1alpha.GitHubAuditLogStreamResponse
	51, // 106: accessgraph.v1alpha.AccessGraphService.GitHubEventsStream:output_type -> accessgraph.v1alpha.GitHubEventsStreamResponse
	53, // 107: accessgraph.v1alpha.AccessGraphService.OktaAuditLogStream:output_type -> accessgraph.v1alpha.OktaAuditLogStreamResponse
	55, // 108: accessgraph.v1alpha.AccessGraphService.OktaEventsStream:output_type -> accessgraph.v1alpha.OktaEventsStreamResponse
...
func file_accessgraph_v1alpha_access_graph_service_proto_init() {
	...
	file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[42].OneofWrappers = []any{
		...
		(*AWSCloudWatchStreamRequest_Events)(nil),
	}
