...
// AuditLogStreamRequest contains audit log events, encoded in
// auditlog.EventUstructured. It also contains the necessary information to
// update the legacy or bulk exports current state in order to resume exporting
// in case of lost grpc connection. .
type AuditLogStreamRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Action:
	//
	//	*AuditLogStreamRequest_SearchedEvents
	//	*AuditLogStreamRequest_BulkEvent
	//	*AuditLogStreamRequest_BulkStateSync
...
func (x *AuditLogStreamRequest) GetSearchedEvents() *AuditLogEvents {
	if x != nil {
		if x, ok := x.Action.(*AuditLogStreamRequest_SearchedEvents); ok {
			return x.SearchedEvents
		}
	}
	return nil
}

func (x *AuditLogStreamRequest) GetBulkEvent() *AuditLogBulkEvent {
	if x != nil {
		if x, ok := x.Action.(*AuditLogStreamRequest_BulkEvent); ok {
			return x.BulkEvent
		}
	}
	return nil
...
func (x *AuditLogStreamRequest) GetBulkStateSync() *AuditLogBulkStateSync {
	if x != nil {
		if x, ok := x.Action.(*AuditLogStreamRequest_BulkStateSync); ok {
			return x.BulkStateSync
		}
	}
	return nil
}
...
type AuditLogStreamRequest_SearchedEvents struct {
	// TODO(juliaogris): tweak naming, reads poorly in go: req.GetEvents().GetEvent(). Look for consistency with other proto naming.
	SearchedEvents *AuditLogEvents `protobuf:"bytes,1,opt,name=searched_events,json=searchedEvents,proto3,oneof"` // unstructured event list + cursor if updated queried via Search API
}

type AuditLogStreamRequest_BulkEvent struct {
	BulkEvent *AuditLogBulkEvent `protobuf:"bytes,2,opt,name=bulk_event,json=bulkEvent,proto3,oneof"` // unstructured event + bulk_state delta
}

type AuditLogStreamRequest_BulkStateSync struct {
	BulkStateSync *AuditLogBulkStateSync `protobuf:"bytes,3,opt,name=bulk_state_sync,json=bulkStateSync,proto3,oneof"` // bulk_prune requests to prune old open dates.
}

func (*AuditLogStreamRequest_SearchedEvents) isAuditLogStreamRequest_Action() {}

func (*AuditLogStreamRequest_BulkEvent) isAuditLogStreamRequest_Action() {}

func (*AuditLogStreamRequest_BulkStateSync) isAuditLogStreamRequest_Action() {}

// AuditLogEvents .
type AuditLogEvents struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	Events        []*v1.EventUnstructured `protobuf:"bytes,1,rep,name=events,proto3" json:"events,omitempty"`
	StartKey      string                  `protobuf:"bytes,2,opt,name=start_key,json=startKey,proto3" json:"start_key,omitempty"` // legacy, only transmit if changed from last cursor.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AuditLogEvents) GetStartKey() string {
	if x != nil {
		return x.StartKey
	}
	return ""
...
// AuditLogBulkEvent .
type AuditLogBulkEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Event         *v1.EventUnstructured  `protobuf:"bytes,1,opt,name=event,proto3" json:"event,omitempty"`
	Chunk         string                 `protobuf:"bytes,2,opt,name=chunk,proto3" json:"chunk,omitempty"`
	Cursor        string                 `protobuf:"bytes,3,opt,name=cursor,proto3" json:"cursor,omitempty"` // empty cursor means we move chunk from chunk_cursors map to completed_chunks
	Date          *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=date,proto3" json:"date,omitempty"`     // used int exporter state and normalized to UTC 00:00:00.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AuditLogBulkEvent) Reset() {
	*x = AuditLogBulkEvent{}
...
func (x *AuditLogBulkEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuditLogBulkEvent) ProtoMessage() {}

func (x *AuditLogBulkEvent) ProtoReflect() protoreflect.Message {
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuditLogBulkEvent.ProtoReflect.Descriptor instead.
func (*AuditLogBulkEvent) Descriptor() ([]byte, []int) {
	return file_accessgraph_v1alpha_access_graph_service_proto_rawDescGZIP(), []int{12}
}

func (x *AuditLogBulkEvent) GetEvent() *v1.EventUnstructured {
	if x != nil {
		return x.Event
	}
	return nil
...
func (x *AuditLogBulkEvent) GetChunk() string {
	if x != nil {
		return x.Chunk
	}
	return ""
...
func (x *AuditLogBulkEvent) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
func (x *AuditLogBulkEvent) GetDate() *timestamppb.Timestamp {
	if x != nil {
		return x.Date
	}
	return nil
...
// AuditLogBulkDateSync is a request to sync the bulk export state and prune
// days that are not active_days in the exporter state.
type AuditLogBulkStateSync struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	ActiveDates   []*AuditLogBulkDateSync `protobuf:"bytes,1,rep,name=active_dates,json=activeDates,proto3" json:"active_dates,omitempty"` // never delete dates more recent than the most recent date in active dates.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AuditLogBulkStateSync) Reset() {
	*x = AuditLogBulkStateSync{}
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AuditLogBulkStateSync) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuditLogBulkStateSync) ProtoMessage() {}

func (x *AuditLogBulkStateSync) ProtoReflect() protoreflect.Message {
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuditLogBulkStateSync.ProtoReflect.Descriptor instead.
func (*AuditLogBulkStateSync) Descriptor() ([]byte, []int) {
	return file_accessgraph_v1alpha_access_graph_service_proto_rawDescGZIP(), []int{13}
}

func (x *AuditLogBulkStateSync) GetActiveDates() []*AuditLogBulkDateSync {
	if x != nil {
...
// AuditLogBulkDateSync represents the state of the bulk export for a given date
// and its list of completed dates.
type AuditLogBulkDateSync struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Date           *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=date,proto3" json:"date,omitempty"`
	CompletdChunks []string               `protobuf:"bytes,2,rep,name=completd_chunks,json=completdChunks,proto3" json:"completd_chunks,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *AuditLogBulkDateSync) Reset() {
	*x = AuditLogBulkDateSync{}
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AuditLogBulkDateSync) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuditLogBulkDateSync) ProtoMessage() {}

func (x *AuditLogBulkDateSync) ProtoReflect() protoreflect.Message {
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuditLogBulkDateSync.ProtoReflect.Descriptor instead.
func (*AuditLogBulkDateSync) Descriptor() ([]byte, []int) {
	return file_accessgraph_v1alpha_access_graph_service_proto_rawDescGZIP(), []int{14}
}

func (x *AuditLogBulkDateSync) GetDate() *timestamppb.Timestamp {
	if x != nil {
		return x.Date
	}
	return nil
...
func (x *AuditLogBulkDateSync) GetCompletdChunks() []string {
	if x != nil {
		return x.CompletdChunks
	}
	return nil
}

// AuditLogStreamResponse is a TODO(juliaogris). If no resume state we start afresh from start date.
type AuditLogStreamResponse struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	StartDate *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=start_date,json=startDate,proto3" json:"start_date,omitempty"`
	// Types that are valid to be assigned to ResumeState:
	//
	//	*AuditLogStreamResponse_ExportState
	//	*AuditLogStreamResponse_BulkExportState
...
func (x *AuditLogStreamResponse) GetExportState() *AuditLogExportState {
	if x != nil {
		if x, ok := x.ResumeState.(*AuditLogStreamResponse_ExportState); ok {
...
func (x *AuditLogStreamResponse) GetBulkExportState() *AuditLogBulkExportState {
	if x != nil {
		if x, ok := x.ResumeState.(*AuditLogStreamResponse_BulkExportState); ok {
			return x.BulkExportState
		}
	}
	return nil
}
...
type AuditLogStreamResponse_ExportState struct {
	ExportState *AuditLogExportState `protobuf:"bytes,2,opt,name=export_state,json=exportState,proto3,oneof"` // legacy
}

type AuditLogStreamResponse_BulkExportState struct {
	BulkExportState *AuditLogBulkExportState `protobuf:"bytes,3,opt,name=bulk_export_state,json=bulkExportState,proto3,oneof"` // bulk
}

func (*AuditLogStreamResponse_ExportState) isAuditLogStreamResponse_ResumeState() {}

func (*AuditLogStreamResponse_BulkExportState) isAuditLogStreamResponse_ResumeState() {}

// AuditLogExportState is the state of the non-performance-optimized, legacy
// event exporting to resume exporting.
type AuditLogExportState struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// start_date is the original start date for the export query
	StartKey      string                 `protobuf:"bytes,1,opt,name=start_key,json=startKey,proto3" json:"start_key,omitempty"`                  // never empty
	LastEventId   string                 `protobuf:"bytes,2,opt,name=last_event_id,json=lastEventId,proto3" json:"last_event_id,omitempty"`       // empty if no events have been processed for last_cursor
	LastEventTime *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=last_event_time,json=lastEventTime,proto3" json:"last_event_time,omitempty"` // only needed if we upgrade to bulk exporting
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AuditLogExportState) Reset() {
	*x = AuditLogExportState{}
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AuditLogExportState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuditLogExportState) ProtoMessage() {}

func (x *AuditLogExportState) ProtoReflect() protoreflect.Message {
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuditLogExportState.ProtoReflect.Descriptor instead.
func (*AuditLogExportState) Descriptor() ([]byte, []int) {
	return file_accessgraph_v1alpha_access_graph_service_proto_rawDescGZIP(), []int{16}
}

func (x *AuditLogExportState) GetStartKey() string {
	if x != nil {
		return x.StartKey
	}
	return ""
...
func (x *AuditLogExportState) GetLastEventId() string {
	if x != nil {
...
func (x *AuditLogExportState) GetLastEventTime() *timestamppb.Timestamp {
	if x != nil {
...
// AuditLogBulkExportState is the state of the bulk export in process useful for resuming.
type AuditLogBulkExportState struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// dates is the state of all dates with exports in progress.
	// dates after start date but further in the past (older than now - backlog_size)
	// are considered been completed.
	Dates         []*AuditLogBulkExportDateState `protobuf:"bytes,1,rep,name=dates,proto3" json:"dates,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AuditLogBulkExportState) Reset() {
	*x = AuditLogBulkExportState{}
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AuditLogBulkExportState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuditLogBulkExportState) ProtoMessage() {}

func (x *AuditLogBulkExportState) ProtoReflect() protoreflect.Message {
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuditLogBulkExportState.ProtoReflect.Descriptor instead.
func (*AuditLogBulkExportState) Descriptor() ([]byte, []int) {
	return file_accessgraph_v1alpha_access_graph_service_proto_rawDescGZIP(), []int{17}
}

func (x *AuditLogBulkExportState) GetDates() []*AuditLogBulkExportDateState {
	if x != nil {
		return x.Dates
	}
	return nil
...
// AuditLogBulkExportDateState is the state of the export for a given date in
// UTC used to resume exporting.
type AuditLogBulkExportDateState struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// date is the date for which the export state is stored. It's normalized to UTC 00:00:00.
	Date *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=date,proto3" json:"date,omitempty"`
	// completed_chunks is the list of completed chunks for the given date.
	CompletedChunks []string `protobuf:"bytes,2,rep,name=completed_chunks,json=completedChunks,proto3" json:"completed_chunks,omitempty"`
	// chunk_cursors is a map of chunk to cursor to resume the export for a given
	// chunk.
	ChunkCursors  map[string]string `protobuf:"bytes,3,rep,name=chunk_cursors,json=chunkCursors,proto3" json:"chunk_cursors,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AuditLogBulkExportDateState) Reset() {
	*x = AuditLogBulkExportDateState{}
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AuditLogBulkExportDateState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuditLogBulkExportDateState) ProtoMessage() {}

func (x *AuditLogBulkExportDateState) ProtoReflect() protoreflect.Message {
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuditLogBulkExportDateState.ProtoReflect.Descriptor instead.
func (*AuditLogBulkExportDateState) Descriptor() ([]byte, []int) {
	return file_accessgraph_v1alpha_access_graph_service_proto_rawDescGZIP(), []int{18}
}

func (x *AuditLogBulkExportDateState) GetDate() *timestamppb.Timestamp {
	if x != nil {
		return x.Date
	}
	return nil
...
func (x *AuditLogBulkExportDateState) GetCompletedChunks() []string {
	if x != nil {
...
func (x *AuditLogBulkExportDateState) GetChunkCursors() map[string]string {
	if x != nil {
...
var file_accessgraph_v1alpha_access_graph_service_proto_rawDesc = string([]byte{
	...
	,
	...
	0x74, 0x6f, 0x1a, 0x23, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2f, 0x61, 0x75, 0x64,
	0x69, 0x74, 0x6c, 0x6f, 0x67, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x75, 0x64, 0x69, 0x74, 0x6c, 0x6f,
	0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x24, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x72, 0x79,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0x71, 0x0a,
	...
	0x70, 0x68, 0x61, 0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x05, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x12,
	0x2f, 0x0a, 0x05, 0x65, 0x64, 0x67, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19,
	0x2e, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x67, 0x72, 0x61, 0x70, 0x68, 0x2e, 0x76, 0x31, 0x61,
	0x6c, 0x70, 0x68, 0x61, 0x2e, 0x45, 0x64, 0x67, 0x65, 0x52, 0x05, 0x65, 0x64, 0x67, 0x65, 0x73,
	0x22, 0x2c, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x70, 0x61, 0x74, 0x68, 0x22, 0x25,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x68, 0x6f, 0x73, 0x74, 0x43, 0x61, 0x50, 0x65, 0x6d, 0x12,
	...
	,
	...
	,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x12, 0x79, 0x0a, 0x12, 0x47, 0x69, 0x74, 0x6c,
	0x61, 0x62, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x2e,
	0x2e, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x67, 0x72, 0x61, 0x70, 0x68, 0x2e, 0x76, 0x31, 0x61,
	0x6c, 0x70, 0x68, 0x61, 0x2e, 0x47, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	,
	...
	,
...
var file_accessgraph_v1alpha_access_graph_service_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_accessgraph_v1alpha_access_graph_service_proto_goTypes = []any{
	...
	(*AuditLogBulkEvent)(nil),           // 12: accessgraph.v1alpha.AuditLogBulkEvent
	(*AuditLogBulkStateSync)(nil),       // 13: accessgraph.v1alpha.AuditLogBulkStateSync
	(*AuditLogBulkDateSync)(nil),        // 14: accessgraph.v1alpha.AuditLogBulkDateSync
	(*AuditLogStreamResponse)(nil),      // 15: accessgraph.v1alpha.AuditLogStreamResponse
	(*AuditLogExportState)(nil),         // 16: accessgraph.v1alpha.AuditLogExportState
	(*AuditLogBulkExportState)(nil),     // 17: accessgraph.v1alpha.AuditLogBulkExportState
	(*AuditLogBulkExportDateState)(nil), // 18: accessgraph.v1alpha.AuditLogBulkExportDateState
	...
	nil,                                 // 36: accessgraph.v1alpha.AuditLogBulkExportDateState.ChunkCursorsEntry
	(*Node)(nil),                        // 37: accessgraph.v1alpha.Node
	(*Edge)(nil),                        // 38: accessgraph.v1alpha.Edge
	(*ResourceList)(nil),                // 39: accessgraph.v1alpha.ResourceList
	(*ResourceHeaderList)(nil),          // 40: accessgraph.v1alpha.ResourceHeaderList
	(*AccessListsMembers)(nil),          // 41: accessgraph.v1alpha.AccessListsMembers
	(*ExcludeAccessListsMembers)(nil),   // 42: accessgraph.v1alpha.ExcludeAccessListsMembers
	(*AccessPathChanged)(nil),           // 43: accessgraph.v1alpha.AccessPathChanged
	(*v1.EventUnstructured)(nil),        // 44: teleport.auditlog.v1.EventUnstructured
	(*timestamppb.Timestamp)(nil),       // 45: google.protobuf.Timestamp
	(*AWSResourceList)(nil),             // 46: accessgraph.v1alpha.AWSResourceList
	(*GitlabSyncOperation)(nil),         // 47: accessgraph.v1alpha.GitlabSyncOperation
	(*GitlabResourceList)(nil),          // 48: accessgraph.v1alpha.GitlabResourceList
	(*EntraSyncOperation)(nil),          // 49: accessgraph.v1alpha.EntraSyncOperation
	(*EntraResourceList)(nil),           // 50: accessgraph.v1alpha.EntraResourceList
	(*AzureResourceList)(nil),           // 51: accessgraph.v1alpha.AzureResourceList
	(*NetIQResourceList)(nil),           // 52: accessgraph.v1alpha.NetIQResourceList
}
var file_accessgraph_v1alpha_access_graph_service_proto_depIdxs = []int32{
	37, // 0: accessgraph.v1alpha.QueryResponse.nodes:type_name -> accessgraph.v1alpha.Node
	38, // 1: accessgraph.v1alpha.QueryResponse.edges:type_name -> accessgraph.v1alpha.Edge
	6,  // 2: accessgraph.v1alpha.EventsStreamRequest.sync:type_name -> accessgraph.v1alpha.SyncOperation
	39, // 3: accessgraph.v1alpha.EventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.ResourceList
	40, // 4: accessgraph.v1alpha.EventsStreamRequest.delete:type_name -> accessgraph.v1alpha.ResourceHeaderList
	41, // 5: accessgraph.v1alpha.EventsStreamRequest.access_lists_members:type_name -> accessgraph.v1alpha.AccessListsMembers
	42, // 6: accessgraph.v1alpha.EventsStreamRequest.exclude_access_list_members:type_name -> accessgraph.v1alpha.ExcludeAccessListsMembers
	6,  // 7: accessgraph.v1alpha.EventsStreamV2Request.sync:type_name -> accessgraph.v1alpha.SyncOperation
	39, // 8: accessgraph.v1alpha.EventsStreamV2Request.upsert:type_name -> accessgraph.v1alpha.ResourceList
	40, // 9: accessgraph.v1alpha.EventsStreamV2Request.delete:type_name -> accessgraph.v1alpha.ResourceHeaderList
	41, // 10: accessgraph.v1alpha.EventsStreamV2Request.access_lists_members:type_name -> accessgraph.v1alpha.AccessListsMembers
	42, // 11: accessgraph.v1alpha.EventsStreamV2Request.exclude_access_list_members:type_name -> accessgraph.v1alpha.ExcludeAccessListsMembers
	9,  // 12: accessgraph.v1alpha.EventsStreamV2Response.event:type_name -> accessgraph.v1alpha.AuditEvent
	43, // 13: accessgraph.v1alpha.AuditEvent.access_path_changed:type_name -> accessgraph.v1alpha.AccessPathChanged
	11, // 14: accessgraph.v1alpha.AuditLogStreamRequest.searched_events:type_name -> accessgraph.v1alpha.AuditLogEvents
	12, // 15: accessgraph.v1alpha.AuditLogStreamRequest.bulk_event:type_name -> accessgraph.v1alpha.AuditLogBulkEvent
	13, // 16: accessgraph.v1alpha.AuditLogStreamRequest.bulk_state_sync:type_name -> accessgraph.v1alpha.AuditLogBulkStateSync
	44, // 17: accessgraph.v1alpha.AuditLogEvents.events:type_name -> teleport.auditlog.v1.EventUnstructured
	44, // 18: accessgraph.v1alpha.AuditLogBulkEvent.event:type_name -> teleport.auditlog.v1.EventUnstructured
	45, // 19: accessgraph.v1alpha.AuditLogBulkEvent.date:type_name -> google.protobuf.Timestamp
	14, // 20: accessgraph.v1alpha.AuditLogBulkStateSync.active_dates:type_name -> accessgraph.v1alpha.AuditLogBulkDateSync
	45, // 21: accessgraph.v1alpha.AuditLogBulkDateSync.date:type_name -> google.protobuf.Timestamp
	45, // 22: accessgraph.v1alpha.AuditLogStreamResponse.start_date:type_name -> google.protobuf.Timestamp
	16, // 23: accessgraph.v1alpha.AuditLogStreamResponse.export_state:type_name -> accessgraph.v1alpha.AuditLogExportState
	17, // 24: accessgraph.v1alpha.AuditLogStreamResponse.bulk_export_state:type_name -> accessgraph.v1alpha.AuditLogBulkExportState
	45, // 25: accessgraph.v1alpha.AuditLogExportState.last_event_time:type_name -> google.protobuf.Timestamp
	18, // 26: accessgraph.v1alpha.AuditLogBulkExportState.dates:type_name -> accessgraph.v1alpha.AuditLogBulkExportDateState
	45, // 27: accessgraph.v1alpha.AuditLogBulkExportDateState.date:type_name -> google.protobuf.Timestamp
	36, // 28: accessgraph.v1alpha.AuditLogBulkExportDateState.chunk_cursors:type_name -> accessgraph.v1alpha.AuditLogBulkExportDateState.ChunkCursorsEntry
	24, // 29: accessgraph.v1alpha.AWSEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.AWSSyncOperation
	46, // 30: accessgraph.v1alpha.AWSEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.AWSResourceList
	46, // 31: accessgraph.v1alpha.AWSEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.AWSResourceList
	47, // 32: accessgraph.v1alpha.GitlabEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.GitlabSyncOperation
	48, // 33: accessgraph.v1alpha.GitlabEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.GitlabResourceList
	48, // 34: accessgraph.v1alpha.GitlabEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.GitlabResourceList
	49, // 35: accessgraph.v1alpha.EntraEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.EntraSyncOperation
	50, // 36: accessgraph.v1alpha.EntraEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.EntraResourceList
	50, // 37: accessgraph.v1alpha.EntraEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.EntraResourceList
	31, // 38: accessgraph.v1alpha.AzureEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.AzureSyncOperation
	51, // 39: accessgraph.v1alpha.AzureEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.AzureResourceList
	51, // 40: accessgraph.v1alpha.AzureEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.AzureResourceList
	34, // 41: accessgraph.v1alpha.NetIQEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.NetIQSyncOperation
	52, // 42: accessgraph.v1alpha.NetIQEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.NetIQResourceList
	52, // 43: accessgraph.v1alpha.NetIQEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.NetIQResourceList
	0,  // 44: accessgraph.v1alpha.AccessGraphService.Query:input_type -> accessgraph.v1alpha.QueryRequest
	2,  // 45: accessgraph.v1alpha.AccessGraphService.GetFile:input_type -> accessgraph.v1alpha.GetFileRequest
	4,  // 46: accessgraph.v1alpha.AccessGraphService.EventsStream:input_type -> accessgraph.v1alpha.EventsStreamRequest
	5,  // 47: accessgraph.v1alpha.AccessGraphService.EventsStreamV2:input_type -> accessgraph.v1alpha.EventsStreamV2Request
	10, // 48: accessgraph.v1alpha.AccessGraphService.AuditLogStream:input_type -> accessgraph.v1alpha.AuditLogStreamRequest
	19, // 49: accessgraph.v1alpha.AccessGraphService.Register:input_type -> accessgraph.v1alpha.RegisterRequest
	21, // 50: accessgraph.v1alpha.AccessGraphService.ReplaceCAs:input_type -> accessgraph.v1alpha.ReplaceCAsRequest
	23, // 51: accessgraph.v1alpha.AccessGraphService.AWSEventsStream:input_type -> accessgraph.v1alpha.AWSEventsStreamRequest
	26, // 52: accessgraph.v1alpha.AccessGraphService.GitlabEventsStream:input_type -> accessgraph.v1alpha.GitlabEventsStreamRequest
	28, // 53: accessgraph.v1alpha.AccessGraphService.EntraEventsStream:input_type -> accessgraph.v1alpha.EntraEventsStreamRequest
	30, // 54: accessgraph.v1alpha.AccessGraphService.AzureEventsStream:input_type -> accessgraph.v1alpha.AzureEventsStreamRequest
	33, // 55: accessgraph.v1alpha.AccessGraphService.NetIQEventsStream:input_type -> accessgraph.v1alpha.NetIQEventsStreamRequest
	1,  // 56: accessgraph.v1alpha.AccessGraphService.Query:output_type -> accessgraph.v1alpha.QueryResponse
	3,  // 57: accessgraph.v1alpha.AccessGraphService.GetFile:output_type -> accessgraph.v1alpha.GetFileResponse
	7,  // 58: accessgraph.v1alpha.AccessGraphService.EventsStream:output_type -> accessgraph.v1alpha.EventsStreamResponse
	8,  // 59: accessgraph.v1alpha.AccessGraphService.EventsStreamV2:output_type -> accessgraph.v1alpha.EventsStreamV2Response
	15, // 60: accessgraph.v1alpha.AccessGraphService.AuditLogStream:output_type -> accessgraph.v1alpha.AuditLogStreamResponse
	20, // 61: accessgraph.v1alpha.AccessGraphService.Register:output_type -> accessgraph.v1alpha.RegisterResponse
	22, // 62: accessgraph.v1alpha.AccessGraphService.ReplaceCAs:output_type -> accessgraph.v1alpha.ReplaceCAsResponse
	25, // 63: accessgraph.v1alpha.AccessGraphService.AWSEventsStream:output_type -> accessgraph.v1alpha.AWSEventsStreamResponse
	27, // 64: accessgraph.v1alpha.AccessGraphService.GitlabEventsStream:output_type -> accessgraph.v1alpha.GitlabEventsStreamResponse
	29, // 65: accessgraph.v1alpha.AccessGraphService.EntraEventsStream:output_type -> accessgraph.v1alpha.EntraEventsStreamResponse
	32, // 66: accessgraph.v1alpha.AccessGraphService.AzureEventsStream:output_type -> accessgraph.v1alpha.AzureEventsStreamResponse
	35, // 67: accessgraph.v1alpha.AccessGraphService.NetIQEventsStream:output_type -> accessgraph.v1alpha.NetIQEventsStreamResponse
...
func file_accessgraph_v1alpha_access_graph_service_proto_init() {
	...
	file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[10].OneofWrappers = []any{
		(*AuditLogStreamRequest_SearchedEvents)(nil),
		(*AuditLogStreamRequest_BulkEvent)(nil),
		(*AuditLogStreamRequest_BulkStateSync)(nil),
	}
	file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[15].OneofWrappers = []any{
		(*AuditLogStreamResponse_ExportState)(nil),
		(*AuditLogStreamResponse_BulkExportState)(nil),
	}
