...
type SessionSummariesStorageRequest struct {
	...
	Embeddings       []float32              `protobuf:"fixed32,7,rep,packed,name=embeddings,proto3" json:"embeddings,omitempty"`
...
func (x *SessionSummariesStorageRequest) GetEmbeddings() []float32 {
	if x != nil {
		return x.Embeddings
	}
	return nil
