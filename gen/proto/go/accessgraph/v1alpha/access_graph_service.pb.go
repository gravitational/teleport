...
type AWSCloudWatchStreamResponse struct {
	...
	// Types that are valid to be assigned to State:
	//
	//	*AWSCloudWatchStreamResponse_Configs
	//	*AWSCloudWatchStreamResponse_Cursors
...
func (x *AWSCloudWatchStreamResponse) GetConfigs() *AWSCloudWatchConfigs {
	if x != nil {
		if x, ok := x.State.(*AWSCloudWatchStreamResponse_Configs); ok {
			return x.Configs
		}
	}
	return nil
...
func (x *AWSCloudWatchStreamResponse) GetCursors() *AWSCloudWatchCursors {
	if x != nil {
		if x, ok := x.State.(*AWSCloudWatchStreamResponse_Cursors); ok {
			return x.Cursors
		}
	}
	return nil
...
type AWSCloudWatchStreamResponse_Configs struct {
	// The configuration received from the Access Graph
	Configs *AWSCloudWatchConfigs `protobuf:"bytes,1,opt,name=configs,proto3,oneof"`
}

type AWSCloudWatchStreamResponse_Cursors struct {
	// The cursor received from the Access Graph
	Cursors *AWSCloudWatchCursors `protobuf:"bytes,2,opt,name=cursors,proto3,oneof"`
}

func (*AWSCloudWatchStreamResponse_Configs) isAWSCloudWatchStreamResponse_State() {}

func (*AWSCloudWatchStreamResponse_Cursors) isAWSCloudWatchStreamResponse_State() {}
...
func (x *AWSCloudWatchConfigs) Reset() {
	*x = AWSCloudWatchConfigs{}
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AWSCloudWatchConfigs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AWSCloudWatchConfigs) ProtoMessage() {}

func (x *AWSCloudWatchConfigs) ProtoReflect() protoreflect.Message {
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[44]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// The CloudWatch cursors received from the Access Graph which provides
// parameters for each discovery integration
type AWSCloudWatchCursors struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The CloudWatch cursors
	Cursors       []*AWSCloudWatchCursor `protobuf:"bytes,1,rep,name=cursors,proto3" json:"cursors,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AWSCloudWatchCursors) Reset() {
	*x = AWSCloudWatchCursors{}
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AWSCloudWatchCursors) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AWSCloudWatchCursors) ProtoMessage() {}

func (x *AWSCloudWatchCursors) ProtoReflect() protoreflect.Message {
	mi := &file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[45]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AWSCloudWatchCursors.ProtoReflect.Descriptor instead.
func (*AWSCloudWatchCursors) Descriptor() ([]byte, []int) {
	return file_accessgraph_v1alpha_access_graph_service_proto_rawDescGZIP(), []int{45}
}

func (x *AWSCloudWatchCursors) GetCursors() []*AWSCloudWatchCursor {
	if x != nil {
		return x.Cursors
	}
	return nil
...
var file_accessgraph_v1alpha_access_graph_service_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_accessgraph_v1alpha_access_graph_service_proto_goTypes = []any{
	...
	(*AWSCloudWatchConfigs)(nil),         // 44: accessgraph.v1alpha.AWSCloudWatchConfigs
	(*AWSCloudWatchCursors)(nil),         // 45: accessgraph.v1alpha.AWSCloudWatchCursors
	(*AWSCloudWatchConfig)(nil),          // 46: accessgraph.v1alpha.AWSCloudWatchConfig
	(*AWSCloudWatchResults)(nil),         // 47: accessgraph.v1alpha.AWSCloudWatchResults
	(*AWSCloudWatchLogGroup)(nil),        // 48: accessgraph.v1alpha.AWSCloudWatchLogGroup
	(*AWSCloudWatchEvent)(nil),           // 49: accessgraph.v1alpha.AWSCloudWatchEvent
	(*AWSCloudWatchCursor)(nil),          // 50: accessgraph.v1alpha.AWSCloudWatchCursor
	...
	(*v1.EventUnstructured)(nil),         // 68: teleport.auditlog.v1.EventUnstructured
	(*emptypb.Empty)(nil),                // 69: google.protobuf.Empty
	(*AWSResourceList)(nil),              // 70: accessgraph.v1alpha.AWSResourceList
	(*GitlabSyncOperation)(nil),          // 71: accessgraph.v1alpha.GitlabSyncOperation
	(*GitlabResourceList)(nil),           // 72: accessgraph.v1alpha.GitlabResourceList
	(*EntraSyncOperation)(nil),           // 73: accessgraph.v1alpha.EntraSyncOperation
	(*EntraResourceList)(nil),            // 74: accessgraph.v1alpha.EntraResourceList
	(*AzureResourceList)(nil),            // 75: accessgraph.v1alpha.AzureResourceList
	(*NetIQResourceList)(nil),            // 76: accessgraph.v1alpha.NetIQResourceList
...
var file_accessgraph_v1alpha_access_graph_service_proto_depIdxs = []int32{
	...
	66, // 13: accessgraph.v1alpha.AuditEvent.access_path_changed:type_name -> accessgraph.v1alpha.AccessPathChanged
	...
	67, // 17: accessgraph.v1alpha.AuditLogConfig.start_date:type_name -> google.protobuf.Timestamp
	68, // 18: accessgraph.v1alpha.AuditLogEvents.events:type_name -> teleport.auditlog.v1.EventUnstructured
	...
	67, // 21: accessgraph.v1alpha.SearchResumeState.last_event_time:type_name -> google.protobuf.Timestamp
	67, // 22: accessgraph.v1alpha.BulkResumeStateUpdate.date:type_name -> google.protobuf.Timestamp
	67, // 23: accessgraph.v1alpha.BulkResumeStateSync.active_dates:type_name -> google.protobuf.Timestamp
	11, // 24: accessgraph.v1alpha.AuditLogStreamResponse.audit_log_config:type_name -> accessgraph.v1alpha.AuditLogConfig
	69, // 25: accessgraph.v1alpha.AuditLogStreamResponse.no_resume_state:type_name -> google.protobuf.Empty
	...
	67, // 29: accessgraph.v1alpha.BulkResumeDate.date:type_name -> google.protobuf.Timestamp
	59, // 30: accessgraph.v1alpha.BulkResumeDate.chunk_cursors:type_name -> accessgraph.v1alpha.BulkResumeDate.ChunkCursorsEntry
	24, // 31: accessgraph.v1alpha.AWSEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.AWSSyncOperation
	70, // 32: accessgraph.v1alpha.AWSEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.AWSResourceList
	70, // 33: accessgraph.v1alpha.AWSEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.AWSResourceList
	71, // 34: accessgraph.v1alpha.GitlabEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.GitlabSyncOperation
	72, // 35: accessgraph.v1alpha.GitlabEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.GitlabResourceList
	72, // 36: accessgraph.v1alpha.GitlabEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.GitlabResourceList
	73, // 37: accessgraph.v1alpha.EntraEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.EntraSyncOperation
	74, // 38: accessgraph.v1alpha.EntraEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.EntraResourceList
	74, // 39: accessgraph.v1alpha.EntraEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.EntraResourceList
	31, // 40: accessgraph.v1alpha.AzureEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.AzureSyncOperation
	75, // 41: accessgraph.v1alpha.AzureEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.AzureResourceList
	75, // 42: accessgraph.v1alpha.AzureEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.AzureResourceList
	34, // 43: accessgraph.v1alpha.NetIQEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.NetIQSyncOperation
	76, // 44: accessgraph.v1alpha.NetIQEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.NetIQResourceList
	76, // 45: accessgraph.v1alpha.NetIQEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.NetIQResourceList
	...
	46, // 54: accessgraph.v1alpha.AWSCloudWatchConfigs.configs:type_name -> accessgraph.v1alpha.AWSCloudWatchConfig
	50, // 55: accessgraph.v1alpha.AWSCloudWatchCursors.cursors:type_name -> accessgraph.v1alpha.AWSCloudWatchCursor
	67, // 56: accessgraph.v1alpha.AWSCloudWatchConfig.start_date:type_name -> google.protobuf.Timestamp
	48, // 57: accessgraph.v1alpha.AWSCloudWatchResults.log_groups:type_name -> accessgraph.v1alpha.AWSCloudWatchLogGroup
	49, // 58: accessgraph.v1alpha.AWSCloudWatchLogGroup.events:type_name -> accessgraph.v1alpha.AWSCloudWatchEvent
	50, // 59: accessgraph.v1alpha.AWSCloudWatchLogGroup.cursor:type_name -> accessgraph.v1alpha.AWSCloudWatchCursor
	67, // 60: accessgraph.v1alpha.AWSCloudWatchEvent.timestamp:type_name -> google.protobuf.Timestamp
	67, // 61: accessgraph.v1alpha.AWSCloudWatchCursor.start_time:type_name -> google.protobuf.Timestamp
	77, // 62: accessgraph.v1alpha.GitHubAuditLogStreamRequest.config:type_name -> accessgraph.v1alpha.GitHubConfigV1
	78, // 63: accessgraph.v1alpha.GitHubAuditLogStreamRequest.audit_log:type_name -> accessgraph.v1alpha.GitHubAuditLogV1
	77, // 64: accessgraph.v1alpha.GitHubAuditLogStreamResponse.github_config:type_name -> accessgraph.v1alpha.GitHubConfigV1
	79, // 65: accessgraph.v1alpha.GitHubAuditLogStreamResponse.audit_log_resume_state:type_name -> accessgraph.v1alpha.GitHubAuditLogV1Cursor
	80, // 66: accessgraph.v1alpha.GitHubEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.GithubResourceList
	80, // 67: accessgraph.v1alpha.GitHubEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.GithubResourceList
	81, // 68: accessgraph.v1alpha.GitHubEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.GithubSync
	82, // 69: accessgraph.v1alpha.OktaAuditLogStreamRequest.config:type_name -> accessgraph.v1alpha.OktaConfigV1
	83, // 70: accessgraph.v1alpha.OktaAuditLogStreamRequest.audit_log:type_name -> accessgraph.v1alpha.OktaAuditLogV1
	82, // 71: accessgraph.v1alpha.OktaAuditLogStreamResponse.config:type_name -> accessgraph.v1alpha.OktaConfigV1
	84, // 72: accessgraph.v1alpha.OktaAuditLogStreamResponse.audit_log_resume_state:type_name -> accessgraph.v1alpha.OktaAuditLogV1Cursor
	85, // 73: accessgraph.v1alpha.OktaEventsStreamRequest.upsert:type_name -> accessgraph.v1alpha.OktaResourceList
	85, // 74: accessgraph.v1alpha.OktaEventsStreamRequest.delete:type_name -> accessgraph.v1alpha.OktaResourceList
	86, // 75: accessgraph.v1alpha.OktaEventsStreamRequest.sync:type_name -> accessgraph.v1alpha.OktaSync
	0,  // 76: accessgraph.v1alpha.AccessGraphService.Query:input_type -> accessgraph.v1alpha.QueryRequest
	2,  // 77: accessgraph.v1alpha.AccessGraphService.GetFile:input_type -> accessgraph.v1alpha.GetFileRequest
	4,  // 78: accessgraph.v1alpha.AccessGraphService.EventsStream:input_type -> accessgraph.v1alpha.EventsStreamRequest
	5,  // 79: accessgraph.v1alpha.AccessGraphService.EventsStreamV2:input_type -> accessgraph.v1alpha.EventsStreamV2Request
	10, // 80: accessgraph.v1alpha.AccessGraphService.AuditLogStream:input_type -> accessgraph.v1alpha.AuditLogStreamRequest
	36, // 81: accessgraph.v1alpha.AccessGraphService.AWSCloudTrailStream:input_type -> accessgraph.v1alpha.AWSCloudTrailStreamRequest
	42, // 82: accessgraph.v1alpha.AccessGraphService.AWSCloudWatchStream:input_type -> accessgraph.v1alpha.AWSCloudWatchStreamRequest
	19, // 83: accessgraph.v1alpha.AccessGraphService.Register:input_type -> accessgraph.v1alpha.RegisterRequest
	21, // 84: accessgraph.v1alpha.AccessGraphService.ReplaceCAs:input_type -> accessgraph.v1alpha.ReplaceCAsRequest
	23, // 85: accessgraph.v1alpha.AccessGraphService.AWSEventsStream:input_type -> accessgraph.v1alpha.AWSEventsStreamRequest
	26, // 86: accessgraph.v1alpha.AccessGraphService.GitlabEventsStream:input_type -> accessgraph.v1alpha.GitlabEventsStreamRequest
	28, // 87: accessgraph.v1alpha.AccessGraphService.EntraEventsStream:input_type -> accessgraph.v1alpha.EntraEventsStreamRequest
	30, // 88: accessgraph.v1alpha.AccessGraphService.AzureEventsStream:input_type -> accessgraph.v1alpha.AzureEventsStreamRequest
	33, // 89: accessgraph.v1alpha.AccessGraphService.NetIQEventsStream:input_type -> accessgraph.v1alpha.NetIQEventsStreamRequest
	51, // 90: accessgraph.v1alpha.AccessGraphService.GitHubAuditLogStream:input_type -> accessgraph.v1alpha.GitHubAuditLogStreamRequest
	53, // 91: accessgraph.v1alpha.AccessGraphService.GitHubEventsStream:input_type -> accessgraph.v1alpha.GitHubEventsStreamRequest
	55, // 92: accessgraph.v1alpha.AccessGraphService.OktaAuditLogStream:input_type -> accessgraph.v1alpha.OktaAuditLogStreamRequest
	57, // 93: accessgraph.v1alpha.AccessGraphService.OktaEventsStream:input_type -> accessgraph.v1alpha.OktaEventsStreamRequest
	1,  // 94: accessgraph.v1alpha.AccessGraphService.Query:output_type -> accessgraph.v1alpha.QueryResponse
	3,  // 95: accessgraph.v1alpha.AccessGraphService.GetFile:output_type -> accessgraph.v1alpha.GetFileResponse
	7,  // 96: accessgraph.v1alpha.AccessGraphService.EventsStream:output_type -> accessgraph.v1alpha.EventsStreamResponse
	8,  // 97: accessgraph.v1alpha.AccessGraphService.EventsStreamV2:output_type -> accessgraph.v1alpha.EventsStreamV2Response
	16, // 98: accessgraph.v1alpha.AccessGraphService.AuditLogStream:output_type -> accessgraph.v1alpha.AuditLogStreamResponse
	39, // 99: accessgraph.v1alpha.AccessGraphService.AWSCloudTrailStream:output_type -> accessgraph.v1alpha.AWSCloudTrailStreamResponse
	43, // 100: accessgraph.v1alpha.AccessGraphService.AWSCloudWatchStream:output_type -> accessgraph.v1alpha.AWSCloudWatchStreamResponse
	20, // 101: accessgraph.v1alpha.AccessGraphService.Register:output_type -> accessgraph.v1alpha.RegisterResponse
	22, // 102: accessgraph.v1alpha.AccessGraphService.ReplaceCAs:output_type -> accessgraph.v1alpha.ReplaceCAsResponse
	25, // 103: accessgraph.v1alpha.AccessGraphService.AWSEventsStream:output_type -> accessgraph.v1alpha.AWSEventsStreamResponse
	27, // 104: accessgraph.v1alpha.AccessGraphService.GitlabEventsStream:output_type -> accessgraph.v1alpha.GitlabEventsStreamResponse
	29, // 105: accessgraph.v1alpha.AccessGraphService.EntraEventsStream:output_type -> accessgraph.v1alpha.EntraEventsStreamResponse
	32, // 106: accessgraph.v1alpha.AccessGraphService.AzureEventsStream:output_type -> accessgraph.v1alpha.AzureEventsStreamResponse
	35, // 107: accessgraph.v1alpha.AccessGraphService.NetIQEventsStream:output_type -> accessgraph.v1alpha.NetIQEventsStreamResponse
	52, // 108: accessgraph.v1alpha.AccessGraphService.GitHubAuditLogStream:output_type -> accessgraph.v1alpha.GitHubAuditLogStreamResponse
	54, // 109: accessgraph.v1alpha.AccessGraphService.GitHubEventsStream:output_type -> accessgraph.v1alpha.GitHubEventsStreamResponse
	56, // 110: accessgraph.v1alpha.AccessGraphService.OktaAuditLogStream:output_type -> accessgraph.v1alpha.OktaAuditLogStreamResponse
	58, // 111: accessgraph.v1alpha.AccessGraphService.OktaEventsStream:output_type -> accessgraph.v1alpha.OktaEventsStreamResponse
...
func file_accessgraph_v1alpha_access_graph_service_proto_init() {
	...
	file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[43].OneofWrappers = []any{
		(*AWSCloudWatchStreamResponse_Configs)(nil),
		(*AWSCloudWatchStreamResponse_Cursors)(nil),
	}
	...
	file_accessgraph_v1alpha_access_graph_service_proto_msgTypes[57].OneofWrappers = []any{
