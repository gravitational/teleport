...
type AccessGraphService_GitlabEventsStreamClient interface {
	...
	CloseAndRecv() (*GitlabEventsStreamResponse, error)
	grpc.ClientStream
}
...
func (x *accessGraphServiceGitlabEventsStreamClient) CloseAndRecv() (*GitlabEventsStreamResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
type AccessGraphService_GitlabEventsStreamServer interface {
	SendAndClose(*GitlabEventsStreamResponse) error
...
func (x *accessGraphServiceGitlabEventsStreamServer) SendAndClose(m *GitlabEventsStreamResponse) error {
	return x.ServerStream.SendMsg(m)
}
