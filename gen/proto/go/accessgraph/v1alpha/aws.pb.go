...
type AWSKMSKeyV1 struct {
	...
	Tags []*AWSTag `protobuf:"bytes,3,rep,name=tags,proto3" json:"tags,omitempty"` // TODO(juliaogris): Remove?
	...
	Aliases []string `protobuf:"bytes,6,rep,name=aliases,proto3" json:"aliases,omitempty"` // TODO(juliaogris): Message with alias ARN? ARN could be constructed from string + account + region or key arn.
	// policy_document is the JSON document that defines the policy.
