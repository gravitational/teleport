...
type Node struct {
	...
	xxx_hidden_Properties map[string]string      `protobuf:"bytes,7,rep,name=properties,proto3" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type Edge struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_From       string                 `protobuf:"bytes,1,opt,name=from,proto3"`
	xxx_hidden_To         string                 `protobuf:"bytes,2,opt,name=to,proto3"`
	xxx_hidden_EdgeType   string                 `protobuf:"bytes,3,opt,name=edge_type,json=edgeType,proto3"`
...
func (b0 Edge_builder) Build() *Edge {
	...
	x.xxx_hidden_EdgeType = b.EdgeType
	x.xxx_hidden_Properties = b.Properties
	return m0
}
