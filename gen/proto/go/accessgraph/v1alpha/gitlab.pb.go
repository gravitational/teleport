...
type GitlabUser struct {
	...
	// identities repsents the idenity source for the user.
...
type GitlabUserIdentity struct {
	...
	// extern_uid identities the external uid of the identity.
...
func file_accessgraph_v1alpha_gitlab_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_accessgraph_v1alpha_gitlab_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_accessgraph_v1alpha_gitlab_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
