...
var file_accessgraph_v1alpha_resources_proto_rawDesc = []byte{
	...
	0xd1, 0x01, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x45, 0x6e, 0x74, 0x72,
	...
	0x72, 0x63, 0x65, 0x42, 0x57, 0x5a, 0x55, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_accessgraph_v1alpha_resources_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_accessgraph_v1alpha_resources_proto_goTypes = []interface{}{
	(*ResourceList)(nil),          // 0: accessgraph.v1alpha.ResourceList
	(*ResourceEntry)(nil),         // 1: accessgraph.v1alpha.ResourceEntry
	(*types.UserV2)(nil),          // 2: types.UserV2
	(*types.RoleV6)(nil),          // 3: types.RoleV6
	(*types.ServerV2)(nil),        // 4: types.ServerV2
	(*types.AccessRequestV3)(nil), // 5: types.AccessRequestV3
}
var file_accessgraph_v1alpha_resources_proto_depIdxs = []int32{
	1, // 0: accessgraph.v1alpha.ResourceList.resources:type_name -> accessgraph.v1alpha.ResourceEntry
	2, // 1: accessgraph.v1alpha.ResourceEntry.user:type_name -> types.UserV2
	3, // 2: accessgraph.v1alpha.ResourceEntry.role:type_name -> types.RoleV6
	4, // 3: accessgraph.v1alpha.ResourceEntry.server:type_name -> types.ServerV2
	5, // 4: accessgraph.v1alpha.ResourceEntry.access_request:type_name -> types.AccessRequestV3
...
func file_accessgraph_v1alpha_resources_proto_init() {
	...
	file_accessgraph_v1alpha_resources_proto_msgTypes[1].OneofWrappers = []interface{}{
