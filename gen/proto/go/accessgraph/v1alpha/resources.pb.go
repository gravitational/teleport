...
var file_accessgraph_v1alpha_resources_proto_rawDesc = []byte{
	...
	0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x22, 0xd8, 0x03, 0x0a, 0x0d, 0x52,
	...
	0x77, 0x73, 0x44, 0x65, 0x73, 0x6b, 0x74, 0x6f, 0x70, 0x42, 0x0a, 0x0a, 0x08, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x57, 0x5a, 0x55, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_accessgraph_v1alpha_resources_proto_goTypes = []interface{}{
	...
	(*types.KubernetesServerV3)(nil), // 8: types.KubernetesServerV3
	(*types.AppServerV3)(nil),        // 9: types.AppServerV3
	(*types.DatabaseServerV3)(nil),   // 10: types.DatabaseServerV3
	(*types.WindowsDesktopV3)(nil),   // 11: types.WindowsDesktopV3
}
var file_accessgraph_v1alpha_resources_proto_depIdxs = []int32{
	...
	8,  // 6: accessgraph.v1alpha.ResourceEntry.kubernetes_server:type_name -> types.KubernetesServerV3
	9,  // 7: accessgraph.v1alpha.ResourceEntry.app_server:type_name -> types.AppServerV3
	10, // 8: accessgraph.v1alpha.ResourceEntry.database_server:type_name -> types.DatabaseServerV3
	11, // 9: accessgraph.v1alpha.ResourceEntry.windows_desktop:type_name -> types.WindowsDesktopV3
