...
func file_accessgraph_v1alpha_graph_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_accessgraph_v1alpha_graph_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Node); i {
			case 0:
				return &v.state
			case 1:
		...
		file_accessgraph_v1alpha_graph_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Edge); i {
			case 0:
				return &v.state
			case 1:
