...
func (UnimplementedSessionRecordingServiceServer) SearchSessionSummaries(grpc.BidiStreamingServer[SearchSessionSummariesRequest, SearchSessionSummariesResponse]) error {
	return status.Error(codes.Unimplemented, "method SearchSessionSummaries not implemented")
}
func (UnimplementedSessionRecordingServiceServer) StoreSessionSummary(context.Context, *StoreSessionSummaryRequest) (*StoreSessionSummaryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StoreSessionSummary not implemented")
}
func (UnimplementedSessionRecordingServiceServer) IsSessionSearchEnabled(context.Context, *IsSessionSearchEnabledRequest) (*IsSessionSearchEnabledResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IsSessionSearchEnabled not implemented")
}
