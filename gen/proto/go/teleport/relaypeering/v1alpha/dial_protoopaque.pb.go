...
type DialRequest struct {
	...
	xxx_hidden_TargetHostId   string                 `protobuf:"bytes,1,opt,name=target_host_id,json=targetHostId,proto3"`
	xxx_hidden_ConnectionType string                 `protobuf:"bytes,2,opt,name=connection_type,json=connectionType,proto3"`
	xxx_hidden_Source         *Addr                  `protobuf:"bytes,3,opt,name=source,proto3"`
	xxx_hidden_Destination    *Addr                  `protobuf:"bytes,4,opt,name=destination,proto3"`
...
func (x *DialRequest) GetTargetHostId() string {
	if x != nil {
		return x.xxx_hidden_TargetHostId
	}
	return ""
}
...
func (b0 DialRequest_builder) Build() *DialRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_TargetHostId = b.TargetHostId
