...
type DiscoverResponse struct {
	state                            protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_RelayGroup            string                 `protobuf:"bytes,1,opt,name=relay_group,json=relayGroup,proto3"`
	xxx_hidden_TargetConnectionCount int32                  `protobuf:"varint,2,opt,name=target_connection_count,json=targetConnectionCount,proto3"`
	xxx_hidden_SupportedTunnelTypes  []string               `protobuf:"bytes,3,rep,name=supported_tunnel_types,json=supportedTunnelTypes,proto3"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
func (x *DiscoverResponse) GetSupportedTunnelTypes() []string {
	if x != nil {
		return x.xxx_hidden_SupportedTunnelTypes
	}
	return nil
}
...
func (x *DiscoverResponse) SetSupportedTunnelTypes(v []string) {
	x.xxx_hidden_SupportedTunnelTypes = v
}
...
func (b0 DiscoverResponse_builder) Build() *DiscoverResponse {
	...
	x.xxx_hidden_SupportedTunnelTypes = b.SupportedTunnelTypes
	return m0
}
