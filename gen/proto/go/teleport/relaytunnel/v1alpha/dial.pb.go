...
// after the first stream, which is a control stream)
...
const file_teleport_relaytunnel_v1alpha_dial_proto_rawDesc = "" +
	"\n" +
	"'teleport/relaytunnel/v1alpha/dial.proto\x12\x1cteleport.relaytunnel.v1alpha\x1a\x17google/rpc/status.proto\"4\n" +
	"\x04Addr\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\"\x8f\x01\n" +
	"\vDialRequest\x12:\n" +
	...
	"\fDialResponse\x12*\n" +
	"\x06status\x18\x01 \x01(\v2\x12.google.rpc.StatusR\x06statusB`Z^github.com/gravitational/teleport/gen/proto/go/teleport/relaytunnel/v1alpha;relaytunnelv1alphab\x06proto3"
...
var file_teleport_relaytunnel_v1alpha_dial_proto_goTypes = []any{
	(*Addr)(nil),          // 0: teleport.relaytunnel.v1alpha.Addr
	(*DialRequest)(nil),   // 1: teleport.relaytunnel.v1alpha.DialRequest
	(*DialResponse)(nil),  // 2: teleport.relaytunnel.v1alpha.DialResponse
	(*status.Status)(nil), // 3: google.rpc.Status
}
var file_teleport_relaytunnel_v1alpha_dial_proto_depIdxs = []int32{
	0, // 0: teleport.relaytunnel.v1alpha.DialRequest.source:type_name -> teleport.relaytunnel.v1alpha.Addr
	0, // 1: teleport.relaytunnel.v1alpha.DialRequest.destination:type_name -> teleport.relaytunnel.v1alpha.Addr
