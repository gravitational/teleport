...
func (x *ServerStream) GetKnownRelays() []*v1.RelayServer {
	if x != nil {
...
func (x *ServerStream) GetTerminating() bool {
	if x != nil {
...
const file_teleport_relaytunnel_v1alpha_control_proto_rawDesc = "" +
	...
	"tunnelType\"9\n" +
	"\vServerHello\x12*\n" +
	"\x06status\x18\x01 \x01(\v2\x12.google.rpc.StatusR\x06status\"v\n" +
	"\fServerStream\x12D\n" +
	"\fknown_relays\x18\x01 \x03(\v2!.teleport.presence.v1.RelayServerR\vknownRelays\x12 \n" +
	"\vterminating\x18\x02 \x01(\bR\vterminating\"\x0e\n" +
...
var file_teleport_relaytunnel_v1alpha_control_proto_depIdxs = []int32{
	...
	5, // 1: teleport.relaytunnel.v1alpha.ServerStream.known_relays:type_name -> teleport.presence.v1.RelayServer
