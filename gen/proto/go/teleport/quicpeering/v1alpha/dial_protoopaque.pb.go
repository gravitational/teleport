...
type DialRequest struct {
	...
	xxx_hidden_Nonce          uint64                 `protobuf:"fixed64,6,opt,name=nonce,proto3"`
	xxx_hidden_Ping           bool                   `protobuf:"varint,7,opt,name=ping,proto3"`
	xxx_hidden_TargetScope    string                 `protobuf:"bytes,8,opt,name=target_scope,json=targetScope,proto3"`
...
func (x *DialRequest) GetTargetScope() string {
	if x != nil {
		return x.xxx_hidden_TargetScope
	}
	return ""
}
...
func (b0 DialRequest_builder) Build() *DialRequest {
	...
	x.xxx_hidden_TargetScope = b.TargetScope
	return m0
}
