...
func file_teleport_lib_teleterm_v1_app_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_lib_teleterm_v1_app_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*App); i {
			case 0:
				return &v.state
			case 1:
		...
		file_teleport_lib_teleterm_v1_app_proto_msgTypes[1].Exporter = func(v any, i int) any {
