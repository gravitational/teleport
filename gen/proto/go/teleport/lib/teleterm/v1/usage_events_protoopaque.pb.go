...
type ReportUsageEventRequest struct {
	...
	xxx_hidden_AuthClusterId string                             `protobuf:"bytes,1,opt,name=auth_cluster_id,json=authClusterId,proto3"`
	xxx_hidden_PrehogReq     *v1alpha.SubmitConnectEventRequest `protobuf:"bytes,2,opt,name=prehog_req,json=prehogReq,proto3"`
...
func (x *ReportUsageEventRequest) HasPrehogReq() bool {
	...
	return x.xxx_hidden_PrehogReq != nil
}

func (x *ReportUsageEventRequest) ClearPrehogReq() {
	x.xxx_hidden_PrehogReq = nil
}
...
func (b0 ReportUsageEventRequest_builder) Build() *ReportUsageEventRequest {
	...
	x.xxx_hidden_PrehogReq = b.PrehogReq
	return m0
}
