...
type AuthSettings struct {
	...
	xxx_hidden_LocalAuthEnabled    bool                   `protobuf:"varint,1,opt,name=local_auth_enabled,json=localAuthEnabled,proto3"`
	xxx_hidden_AuthProviders       *[]*AuthProvider       `protobuf:"bytes,4,rep,name=auth_providers,json=authProviders,proto3"`
	xxx_hidden_AuthType            string                 `protobuf:"bytes,6,opt,name=auth_type,json=authType,proto3"`
	xxx_hidden_AllowPasswordless   bool                   `protobuf:"varint,7,opt,name=allow_passwordless,json=allowPasswordless,proto3"`
	xxx_hidden_LocalConnectorName  string                 `protobuf:"bytes,8,opt,name=local_connector_name,json=localConnectorName,proto3"`
	xxx_hidden_ClientVersionStatus ClientVersionStatus    `protobuf:"varint,9,opt,name=client_version_status,json=clientVersionStatus,proto3,enum=teleport.lib.teleterm.v1.ClientVersionStatus"`
	xxx_hidden_Versions            *Versions              `protobuf:"bytes,10,opt,name=versions,proto3"`
	xxx_hidden_MessageOfTheDay     string                 `protobuf:"bytes,11,opt,name=message_of_the_day,json=messageOfTheDay,proto3"`
...
func (x *AuthSettings) GetLocalAuthEnabled() bool {
	if x != nil {
		return x.xxx_hidden_LocalAuthEnabled
	}
	return false
}
...
func (x *AuthSettings) GetAllowPasswordless() bool {
	if x != nil {
		return x.xxx_hidden_AllowPasswordless
	}
	return false
}
...
func (x *AuthSettings) GetLocalConnectorName() string {
	if x != nil {
		return x.xxx_hidden_LocalConnectorName
	}
	return ""
}
...
func (x *AuthSettings) GetClientVersionStatus() ClientVersionStatus {
	if x != nil {
		return x.xxx_hidden_ClientVersionStatus
	}
...
func (x *AuthSettings) GetMessageOfTheDay() string {
	if x != nil {
		return x.xxx_hidden_MessageOfTheDay
	}
	return ""
}

func (x *AuthSettings) SetLocalAuthEnabled(v bool) {
	x.xxx_hidden_LocalAuthEnabled = v
}
...
func (x *AuthSettings) SetMessageOfTheDay(v string) {
	x.xxx_hidden_MessageOfTheDay = v
}
...
func (b0 AuthSettings_builder) Build() *AuthSettings {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_LocalAuthEnabled = b.LocalAuthEnabled
	x.xxx_hidden_AuthProviders = &b.AuthProviders
	x.xxx_hidden_AuthType = b.AuthType
	x.xxx_hidden_AllowPasswordless = b.AllowPasswordless
	x.xxx_hidden_LocalConnectorName = b.LocalConnectorName
	x.xxx_hidden_ClientVersionStatus = b.ClientVersionStatus
	x.xxx_hidden_Versions = b.Versions
	x.xxx_hidden_MessageOfTheDay = b.MessageOfTheDay
	return m0
}
...
type Versions struct {
	state                protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_MinClient string                 `protobuf:"bytes,1,opt,name=min_client,json=minClient,proto3"`
	xxx_hidden_Client    string                 `protobuf:"bytes,2,opt,name=client,proto3"`
	xxx_hidden_Server    string                 `protobuf:"bytes,3,opt,name=server,proto3"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (b0 Versions_builder) Build() *Versions {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_MinClient = b.MinClient
