...
const file_teleport_lib_teleterm_v1_tshd_events_service_proto_rawDesc = "" +
	...
	")SendPendingHeadlessAuthenticationResponse\"\xcd\x01\n" +
	...
	"clusterUri\x128\n" +
	"\x03sso\x18\x06 \x01(\v2&.teleport.lib.teleterm.v1.SSOChallengeR\x03ssoJ\x04\b\x01\x10\x02R\x10root_cluster_uri\"\x9e\x01\n" +
	"\fSSOChallenge\x12!\n" +
