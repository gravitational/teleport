...
type Gateway struct {
	...
	xxx_hidden_TargetName            string                 `protobuf:"bytes,2,opt,name=target_name,json=targetName,proto3"`
	xxx_hidden_TargetUri             string                 `protobuf:"bytes,3,opt,name=target_uri,json=targetUri,proto3"`
	xxx_hidden_TargetUser            string                 `protobuf:"bytes,4,opt,name=target_user,json=targetUser,proto3"`
	xxx_hidden_LocalAddress          string                 `protobuf:"bytes,5,opt,name=local_address,json=localAddress,proto3"`
	xxx_hidden_LocalPort             string                 `protobuf:"bytes,6,opt,name=local_port,json=localPort,proto3"`
	xxx_hidden_Protocol              string                 `protobuf:"bytes,7,opt,name=protocol,proto3"`
	xxx_hidden_TargetSubresourceName string                 `protobuf:"bytes,9,opt,name=target_subresource_name,json=targetSubresourceName,proto3"`
	xxx_hidden_GatewayCliCommand     *GatewayCLICommand     `protobuf:"bytes,10,opt,name=gateway_cli_command,json=gatewayCliCommand,proto3"`
	xxx_hidden_LlmFormat             string                 `protobuf:"bytes,11,opt,name=llm_format,json=llmFormat,proto3"`
	xxx_hidden_LlmProvider           string                 `protobuf:"bytes,12,opt,name=llm_provider,json=llmProvider,proto3"`
...
func (x *Gateway) GetGatewayCliCommand() *GatewayCLICommand {
	if x != nil {
		return x.xxx_hidden_GatewayCliCommand
	}
	return nil
}
...
func (x *Gateway) SetGatewayCliCommand(v *GatewayCLICommand) {
	x.xxx_hidden_GatewayCliCommand = v
}
...
func (x *Gateway) HasGatewayCliCommand() bool {
	...
	return x.xxx_hidden_GatewayCliCommand != nil
}

func (x *Gateway) ClearGatewayCliCommand() {
	x.xxx_hidden_GatewayCliCommand = nil
}
...
func (b0 Gateway_builder) Build() *Gateway {
	...
	x.xxx_hidden_GatewayCliCommand = b.GatewayCliCommand
...
type GatewayCLICommand struct {
	...
	xxx_hidden_Env     []string               `protobuf:"bytes,3,rep,name=env,proto3"`
	xxx_hidden_Preview string                 `protobuf:"bytes,4,opt,name=preview,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
