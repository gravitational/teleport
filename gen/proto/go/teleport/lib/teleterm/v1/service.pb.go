...
const file_teleport_lib_teleterm_v1_service_proto_rawDesc = "" +
	"\n" +
	"&teleport/lib/teleterm/v1/service.proto\x12\x18teleport.lib.teleterm.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a'teleport/accesslist/v1/accesslist.proto\x1a7teleport/devicetrust/v1/device_confirmation_token.proto\x1a.teleport/devicetrust/v1/device_web_token.proto\x1a-teleport/lib/teleterm/v1/access_request.proto\x1a\"teleport/lib/teleterm/v1/app.proto\x1a,teleport/lib/teleterm/v1/auth_settings.proto\x1a&teleport/lib/teleterm/v1/cluster.proto\x1a'teleport/lib/teleterm/v1/database.proto\x1a&teleport/lib/teleterm/v1/gateway.proto\x1a#teleport/lib/teleterm/v1/kube.proto\x1a%teleport/lib/teleterm/v1/server.proto\x1a+teleport/lib/teleterm/v1/usage_events.proto\x1a5teleport/userpreferences/v1/cluster_preferences.proto\x1a>teleport/userpreferences/v1/unified_resource_preferences.proto\"\x0f\n" +
	"\rEmptyResponse\"7\n" +
	...
	"\bclusters\x18\x01 \x03(\v2!.teleport.lib.teleterm.v1.ClusterR\bclusters\"\xd8\x01\n" +
	"\x13GetDatabasesRequest\x12\x1f\n" +
	"\vcluster_uri\x18\x01 \x01(\tR\n" +
	"clusterUri\x12\x14\n" +
	...
	"\x0fsearch_as_roles\x18\a \x01(\tR\rsearchAsRoles\":\n" +
	...
	"totalCount\x12\x1b\n" +
	"\tstart_key\x18\x03 \x01(\tR\bstartKey\"\x90\x01\n" +
	"\x14GetDatabasesResponse\x12:\n" +
	"\x06agents\x18\x01 \x03(\v2\".teleport.lib.teleterm.v1.DatabaseR\x06agents\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\x12\x1b\n" +
	"\tstart_key\x18\x03 \x01(\tR\bstartKey\"\xd4\x01\n" +
	"\x0fGetKubesRequest\x12\x1f\n" +
	"\vcluster_uri\x18\x01 \x01(\tR\n" +
	"clusterUri\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\x12\x1b\n" +
	"\tstart_key\x18\x03 \x01(\tR\bstartKey\x12\x16\n" +
	...
	"\x05query\x18\x05 \x01(\tR\x05query\x12\x17\n" +
	"\asort_by\x18\x06 \x01(\tR\x06sortBy\x12&\n" +
	"\x0fsearch_as_roles\x18\a \x01(\tR\rsearchAsRoles\"\x88\x01\n" +
	"\x10GetKubesResponse\x126\n" +
	"\x06agents\x18\x01 \x03(\v2\x1e.teleport.lib.teleterm.v1.KubeR\x06agents\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\x12\x1b\n" +
	"\tstart_key\x18\x03 \x01(\tR\bstartKey\"\xd3\x01\n" +
	"\x0eGetAppsRequest\x12\x1f\n" +
	"\vcluster_uri\x18\x01 \x01(\tR\n" +
	"clusterUri\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\x12\x1b\n" +
	"\tstart_key\x18\x03 \x01(\tR\bstartKey\x12\x16\n" +
	...
	"\x05query\x18\x05 \x01(\tR\x05query\x12\x17\n" +
	"\asort_by\x18\x06 \x01(\tR\x06sortBy\x12&\n" +
	"\x0fsearch_as_roles\x18\a \x01(\tR\rsearchAsRoles\"\x86\x01\n" +
	"\x0fGetAppsResponse\x125\n" +
	"\x06agents\x18\x01 \x03(\v2\x1d.teleport.lib.teleterm.v1.AppR\x06agents\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\x12\x1b\n" +
	...
	"\bnext_key\x18\x02 \x01(\tR\anextKey\"\xb1\x02\n" +
	...
	"\x03app\x18\x04 \x01(\v2\x1d.teleport.lib.teleterm.v1.AppH\x00R\x03app\x12)\n" +
	...
	"\x12confirmation_token\x18\x01 \x01(\v20.teleport.devicetrust.v1.DeviceConfirmationTokenR\x11confirmationToken*\x97\x01\n" +
	...
	"&HEADLESS_AUTHENTICATION_STATE_APPROVED\x10\x032\xae*\n" +
	...
	"\x14StartHeadlessWatcher\x125.teleport.lib.teleterm.v1.StartHeadlessWatcherRequest\x1a6.teleport.lib.teleterm.v1.StartHeadlessWatcherResponse\x12m\n" +
	"\fGetDatabases\x12-.teleport.lib.teleterm.v1.GetDatabasesRequest\x1a..teleport.lib.teleterm.v1.GetDatabasesResponse\x12|\n" +
	"\x11ListDatabaseUsers\x122.teleport.lib.teleterm.v1.ListDatabaseUsersRequest\x1a3.teleport.lib.teleterm.v1.ListDatabaseUsersResponse\x12g\n" +
	"\n" +
	"GetServers\x12+.teleport.lib.teleterm.v1.GetServersRequest\x1a,.teleport.lib.teleterm.v1.GetServersResponse\x12|\n" +
	...
	"\x17ListKubernetesResources\x128.teleport.lib.teleterm.v1.ListKubernetesResourcesRequest\x1a9.teleport.lib.teleterm.v1.ListKubernetesResourcesResponse\x12a\n" +
	"\bGetKubes\x12).teleport.lib.teleterm.v1.GetKubesRequest\x1a*.teleport.lib.teleterm.v1.GetKubesResponse\x12^\n" +
	"\aGetApps\x12(.teleport.lib.teleterm.v1.GetAppsRequest\x1a).teleport.lib.teleterm.v1.GetAppsResponse\x12\\\n" +
	"\n" +
	...
	"\x15AuthenticateWebDevice\x126.teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest\x1a7.teleport.lib.teleterm.v1.AuthenticateWebDeviceResponseBTZRgithub.com/gravitational/teleport/gen/proto/go/teleport/lib/teleterm/v1;teletermv1b\x06proto3"
