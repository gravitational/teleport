...
type ListKubernetesServersResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Servers in this page of results.
	Servers []*KubeServer `protobuf:"bytes,1,rep,name=servers,proto3" json:"servers,omitempty"`
...
func (x *ListKubernetesServersResponse) GetServers() []*KubeServer {
	if x != nil {
		return x.Servers
	}
	return nil
...
const file_teleport_lib_teleterm_v1_service_proto_rawDesc = "" +
	...
	"clusterUri\x12E\n" +
	"\x06params\x18\x04 \x01(\v2-.teleport.lib.teleterm.v1.ListResourcesParamsR\x06params\"\x87\x01\n" +
	"\x1dListKubernetesServersResponse\x12>\n" +
	"\aservers\x18\x01 \x03(\v2$.teleport.lib.teleterm.v1.KubeServerR\aservers\x12&\n" +
...
var file_teleport_lib_teleterm_v1_service_proto_depIdxs = []int32{
	...
	93,  // 14: teleport.lib.teleterm.v1.ListKubernetesServersResponse.servers:type_name -> teleport.lib.teleterm.v1.KubeServer
