...
type Kube struct {
	...
	xxx_hidden_Labels       *[]*Label              `protobuf:"bytes,3,rep,name=labels,proto3"`
...
type KubeResource struct {
	...
	xxx_hidden_Labels    *[]*Label              `protobuf:"bytes,4,rep,name=labels,proto3"`
	xxx_hidden_Cluster   string                 `protobuf:"bytes,5,opt,name=cluster,proto3"`
	xxx_hidden_Namespace string                 `protobuf:"bytes,6,opt,name=namespace,proto3"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
