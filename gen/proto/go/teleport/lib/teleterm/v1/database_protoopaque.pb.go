...
type Database struct {
	...
	xxx_hidden_AutoUserProvisioning *AutoUserProvisioning  `protobuf:"bytes,11,opt,name=auto_user_provisioning,json=autoUserProvisioning,proto3"`
	xxx_hidden_DatabaseUsers        []string               `protobuf:"bytes,12,rep,name=database_users,json=databaseUsers,proto3"`
	xxx_hidden_WildcardUserAllowed  bool                   `protobuf:"varint,13,opt,name=wildcard_user_allowed,json=wildcardUserAllowed,proto3"`
...
func (x *Database) GetAutoUserProvisioning() *AutoUserProvisioning {
	if x != nil {
		return x.xxx_hidden_AutoUserProvisioning
	}
	return nil
}
...
func (x *Database) GetWildcardUserAllowed() bool {
	if x != nil {
		return x.xxx_hidden_WildcardUserAllowed
	}
	return false
}
...
func (x *Database) SetAutoUserProvisioning(v *AutoUserProvisioning) {
	x.xxx_hidden_AutoUserProvisioning = v
}
...
func (x *Database) SetWildcardUserAllowed(v bool) {
	x.xxx_hidden_WildcardUserAllowed = v
}
...
func (x *Database) HasAutoUserProvisioning() bool {
	...
	return x.xxx_hidden_AutoUserProvisioning != nil
}
...
func (x *Database) ClearAutoUserProvisioning() {
	x.xxx_hidden_AutoUserProvisioning = nil
}
...
func (b0 Database_builder) Build() *Database {
	...
	x.xxx_hidden_AutoUserProvisioning = b.AutoUserProvisioning
	x.xxx_hidden_DatabaseUsers = b.DatabaseUsers
	x.xxx_hidden_WildcardUserAllowed = b.WildcardUserAllowed
	return m0
}
...
type AutoUserProvisioning struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_DatabaseRoles []string               `protobuf:"bytes,2,rep,name=database_roles,json=databaseRoles,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *AutoUserProvisioning) GetDatabaseRoles() []string {
	if x != nil {
		return x.xxx_hidden_DatabaseRoles
	}
	return nil
}

func (x *AutoUserProvisioning) SetDatabaseRoles(v []string) {
	x.xxx_hidden_DatabaseRoles = v
}
...
func (b0 AutoUserProvisioning_builder) Build() *AutoUserProvisioning {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_DatabaseRoles = b.DatabaseRoles
	return m0
}
