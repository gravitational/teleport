...
const file_teleport_lib_teleterm_v1_cluster_proto_rawDesc = "" +
	"\n" +
	"&teleport/lib/teleterm/v1/cluster.proto\x12\x18teleport.lib.teleterm.v1\x1a6teleport/legacy/types/trusted_device_requirement.proto\"\xdd\x03\n" +
	"\aCluster\x12\x10\n" +
	...
	"\x14profile_status_error\x18\f \x01(\tR\x12profileStatusError\"\xb7\x04\n" +
