...
type Cluster struct {
	...
	FileServerPort string `protobuf:"bytes,11,opt,name=file_server_port,json=fileServerPort,proto3" json:"file_server_port,omitempty"`
}
...
func (x *Cluster) GetFileServerPort() string {
	if x != nil {
...
var file_teleport_lib_teleterm_v1_cluster_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x72, 0x74, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x66, 0x69, 0x6c, 0x65,
