...
type ConnectionRecord struct {
	...
	xxx_hidden_Kind              RecentConnectionKind   `protobuf:"varint,2,opt,name=kind,proto3,enum=teleport.lib.teleterm.vnet.v1.RecentConnectionKind"`
	...
	xxx_hidden_State             ConnectionRecordState  `protobuf:"varint,13,opt,name=state,proto3,enum=teleport.lib.teleterm.vnet.v1.ConnectionRecordState"`
