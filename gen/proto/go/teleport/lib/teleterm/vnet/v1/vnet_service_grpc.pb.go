...
const (
	...
	VnetService_GetSystemService_FullMethodName        = "/teleport.lib.teleterm.vnet.v1.VnetService/GetSystemService"
...
func (c *vnetServiceClient) GetSystemService(ctx context.Context, in *GetSystemServiceRequest, opts ...grpc.CallOption) (*GetSystemServiceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSystemServiceResponse)
	err := c.cc.Invoke(ctx, VnetService_GetSystemService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedVnetServiceServer) GetSystemService(context.Context, *GetSystemServiceRequest) (*GetSystemServiceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSystemService not implemented")
}
...
func _VnetService_GetSystemService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSystemServiceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VnetServiceServer).GetSystemService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VnetService_GetSystemService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VnetServiceServer).GetSystemService(ctx, req.(*GetSystemServiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VnetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _VnetService_GetSystemService_Handler,
		},
		{
