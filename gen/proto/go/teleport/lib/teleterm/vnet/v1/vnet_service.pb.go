...
// Request for GetBackgroundItemStatus.
type GetWindowsServiceStatusRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetWindowsServiceStatusRequest) Reset() {
	*x = GetWindowsServiceStatusRequest{}
	mi := &file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetWindowsServiceStatusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetWindowsServiceStatusRequest) ProtoMessage() {}

func (x *GetWindowsServiceStatusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetWindowsServiceStatusRequest.ProtoReflect.Descriptor instead.
func (*GetWindowsServiceStatusRequest) Descriptor() ([]byte, []int) {
	return file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_rawDescGZIP(), []int{8}
}

// Response for GetBackgroundItemStatus.
type GetWindowsServiceStatusResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetWindowsServiceStatusResponse) Reset() {
	*x = GetWindowsServiceStatusResponse{}
	mi := &file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetWindowsServiceStatusResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetWindowsServiceStatusResponse) ProtoMessage() {}

func (x *GetWindowsServiceStatusResponse) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetWindowsServiceStatusResponse.ProtoReflect.Descriptor instead.
func (*GetWindowsServiceStatusResponse) Descriptor() ([]byte, []int) {
	return file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_rawDescGZIP(), []int{9}
}

func (x *GetWindowsServiceStatusResponse) GetInstalled() bool {
	if x != nil {
		return x.Installed
	}
	return false
...
func (x *GetWindowsServiceStatusResponse) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
const file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_rawDesc = "" +
	...
	"\x1eGetWindowsServiceStatusRequest\"Y\n" +
	"\x1fGetWindowsServiceStatusResponse\x12\x1c\n" +
	...
	"$BACKGROUND_ITEM_STATUS_NOT_SUPPORTED\x10\x052\x8c\a\n" +
	"\vVnetService\x12b\n" +
	...
	"\x17GetWindowsServiceStatus\x12=.teleport.lib.teleterm.vnet.v1.GetWindowsServiceStatusRequest\x1a>.teleport.lib.teleterm.vnet.v1.GetWindowsServiceStatusResponse\x12}\n" +
...
var file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_goTypes = []any{
	...
	(*GetWindowsServiceStatusRequest)(nil),  // 9: teleport.lib.teleterm.vnet.v1.GetWindowsServiceStatusRequest
	(*GetWindowsServiceStatusResponse)(nil), // 10: teleport.lib.teleterm.vnet.v1.GetWindowsServiceStatusResponse
...
var file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_depIdxs = []int32{
	...
	9,  // 6: teleport.lib.teleterm.vnet.v1.VnetService.GetWindowsServiceStatus:input_type -> teleport.lib.teleterm.vnet.v1.GetWindowsServiceStatusRequest
	...
	10, // 13: teleport.lib.teleterm.vnet.v1.VnetService.GetWindowsServiceStatus:output_type -> teleport.lib.teleterm.vnet.v1.GetWindowsServiceStatusResponse
