...
func (x *StatusResponse) GetAppDnsZones() []string {
	if x != nil {
...
func (x *StatusResponse) GetClusters() []string {
	if x != nil {
		return x.Clusters
	}
	return nil
...
func (x *StatusResponse) GetSshConfigured() bool {
	if x != nil {
...
const file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_rawDesc = "" +
	...
	"$BACKGROUND_ITEM_STATUS_NOT_SUPPORTED\x10\x052\xd3\x04\n" +
	"\vVnetService\x12b\n" +
	"\x05Start\x12+.teleport.lib.teleterm.vnet.v1.StartRequest\x1a,.teleport.lib.teleterm.vnet.v1.StartResponse\x12_\n" +
	"\x04Stop\x12*.teleport.lib.teleterm.vnet.v1.StopRequest\x1a+.teleport.lib.teleterm.vnet.v1.StopResponse\x12e\n" +
	"\x06Status\x12,.teleport.lib.teleterm.vnet.v1.StatusRequest\x1a-.teleport.lib.teleterm.vnet.v1.StatusResponse\x12\x98\x01\n" +
...
var file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_goTypes = []any{
	...
	(*StatusRequest)(nil),                   // 5: teleport.lib.teleterm.vnet.v1.StatusRequest
	(*StatusResponse)(nil),                  // 6: teleport.lib.teleterm.vnet.v1.StatusResponse
...
var file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_depIdxs = []int32{
	...
	5,  // 4: teleport.lib.teleterm.vnet.v1.VnetService.Status:input_type -> teleport.lib.teleterm.vnet.v1.StatusRequest
	...
	6,  // 9: teleport.lib.teleterm.vnet.v1.VnetService.Status:output_type -> teleport.lib.teleterm.vnet.v1.StatusResponse
