...
const file_teleport_lib_teleterm_vnet_v1_vnet_service_proto_rawDesc = "" +
	"\n" +
	"0teleport/lib/teleterm/vnet/v1/vnet_service.proto\x12\x1dteleport.lib.teleterm.vnet.v1\"\x0e\n" +
	"\fStartRequest\"\x0f\n" +
	"\rStartResponse\"\r\n" +
	"\vStopRequest\"\x0e\n" +
	"\fStopResponse\"\x15\n" +
	...
	"\x06status\x18\x01 \x01(\x0e23.teleport.lib.teleterm.vnet.v1.BackgroundItemStatusR\x06status*\x8b\x02\n" +
	...
	"$BACKGROUND_ITEM_STATUS_NOT_SUPPORTED\x10\x052\xe6\x03\n" +
	"\vVnetService\x12b\n" +
	...
	"\x17GetBackgroundItemStatus\x12=.teleport.lib.teleterm.vnet.v1.GetBackgroundItemStatusRequest\x1a>.teleport.lib.teleterm.vnet.v1.GetBackgroundItemStatusResponseBUZSgithub.com/gravitational/teleport/gen/proto/go/teleport/lib/teleterm/vnet/v1;vnetv1b\x06proto3"
