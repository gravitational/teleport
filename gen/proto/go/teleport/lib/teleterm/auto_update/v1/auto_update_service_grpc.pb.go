...
func (UnimplementedAutoUpdateServiceServer) GetClusterVersions(context.Context, *GetClusterVersionsRequest) (*GetClusterVersionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetClusterVersions not implemented")
}
...
func (UnimplementedAutoUpdateServiceServer) GetInstallationMetadata(context.Context, *GetInstallationMetadataRequest) (*GetInstallationMetadataResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetInstallationMetadata not implemented")
}
...
func RegisterAutoUpdateServiceServer(s grpc.ServiceRegistrar, srv AutoUpdateServiceServer) {
	// If the following call panics, it indicates UnimplementedAutoUpdateServiceServer was
