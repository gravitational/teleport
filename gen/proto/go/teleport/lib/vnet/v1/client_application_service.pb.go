...
type ResolveFQDNResponse_MatchedHttpsTunnelApp struct {
	// MatchedHTTPSTunnelApp will be set when the query matched an HTTP or LLM
	// app that should be tunneled via the HTTPS-in-mTLS ALPN protocol.
...
// MatchedWebApp is a placeholder to signify that the query matched a web app.
...
// MatchedHTTPSTunnelApp holds info about an HTTP or LLM app that should be
// proxied through the HTTPS-in-mTLS tunnel.
...
// Deprecated: Use MatchedHTTPSTunnelApp.ProtoReflect.Descriptor instead.
func (*MatchedHTTPSTunnelApp) Descriptor() ([]byte, []int) {
