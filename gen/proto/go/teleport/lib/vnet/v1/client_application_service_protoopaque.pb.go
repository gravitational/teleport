...
// client application uses this mode to choose the corresponding credential path.
type SessionSSHConfigCredentialMode int32

const (
	SessionSSHConfigCredentialMode_SESSION_SSH_CONFIG_CREDENTIAL_MODE_UNSPECIFIED SessionSSHConfigCredentialMode = 0
	// SESSION_SSH_CONFIG_CREDENTIAL_MODE_MFA_CERT retries after the direct attempt failed and falls back to issuing a
	// legacy per-session MFA cert.
	SessionSSHConfigCredentialMode_SESSION_SSH_CONFIG_CREDENTIAL_MODE_MFA_CERT SessionSSHConfigCredentialMode = 1
	// SESSION_SSH_CONFIG_CREDENTIAL_MODE_DIRECT uses the user's existing SSH cert so in-band MFA can happen during the
	// SSH handshake if needed.
	SessionSSHConfigCredentialMode_SESSION_SSH_CONFIG_CREDENTIAL_MODE_DIRECT SessionSSHConfigCredentialMode = 2
)

// Enum value maps for SessionSSHConfigCredentialMode.
var (
	SessionSSHConfigCredentialMode_name = map[int32]string{
		0: "SESSION_SSH_CONFIG_CREDENTIAL_MODE_UNSPECIFIED",
		1: "SESSION_SSH_CONFIG_CREDENTIAL_MODE_MFA_CERT",
		2: "SESSION_SSH_CONFIG_CREDENTIAL_MODE_DIRECT",
	}
	SessionSSHConfigCredentialMode_value = map[string]int32{
		"SESSION_SSH_CONFIG_CREDENTIAL_MODE_UNSPECIFIED": 0,
		"SESSION_SSH_CONFIG_CREDENTIAL_MODE_MFA_CERT":    1,
		"SESSION_SSH_CONFIG_CREDENTIAL_MODE_DIRECT":      2,
	}
)

func (x SessionSSHConfigCredentialMode) Enum() *SessionSSHConfigCredentialMode {
	p := new(SessionSSHConfigCredentialMode)
	*p = x
	return p
}

func (x SessionSSHConfigCredentialMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SessionSSHConfigCredentialMode) Descriptor() protoreflect.EnumDescriptor {
	return file_teleport_lib_vnet_v1_client_application_service_proto_enumTypes[1].Descriptor()
}

func (SessionSSHConfigCredentialMode) Type() protoreflect.EnumType {
	return &file_teleport_lib_vnet_v1_client_application_service_proto_enumTypes[1]
}

func (x SessionSSHConfigCredentialMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// ConnectionKind is the kind of target a connection was made to.
type ConnectionKind int32

const (
	ConnectionKind_CONNECTION_KIND_UNSPECIFIED ConnectionKind = 0
	ConnectionKind_CONNECTION_KIND_APP         ConnectionKind = 1
	ConnectionKind_CONNECTION_KIND_SSH         ConnectionKind = 2
	ConnectionKind_CONNECTION_KIND_DATABASE    ConnectionKind = 3
)

// Enum value maps for ConnectionKind.
var (
	ConnectionKind_name = map[int32]string{
		0: "CONNECTION_KIND_UNSPECIFIED",
		1: "CONNECTION_KIND_APP",
		2: "CONNECTION_KIND_SSH",
		3: "CONNECTION_KIND_DATABASE",
	}
	ConnectionKind_value = map[string]int32{
		"CONNECTION_KIND_UNSPECIFIED": 0,
		"CONNECTION_KIND_APP":         1,
		"CONNECTION_KIND_SSH":         2,
		"CONNECTION_KIND_DATABASE":    3,
	}
)
...
func (ConnectionKind) Descriptor() protoreflect.EnumDescriptor {
	return file_teleport_lib_vnet_v1_client_application_service_proto_enumTypes[2].Descriptor()
}

func (ConnectionKind) Type() protoreflect.EnumType {
	return &file_teleport_lib_vnet_v1_client_application_service_proto_enumTypes[2]
}
...
func (ConnectionRecordState) Descriptor() protoreflect.EnumDescriptor {
	return file_teleport_lib_vnet_v1_client_application_service_proto_enumTypes[3].Descriptor()
}

func (ConnectionRecordState) Type() protoreflect.EnumType {
	return &file_teleport_lib_vnet_v1_client_application_service_proto_enumTypes[3]
}
...
type AuthenticateProcessRequest struct {
	...
	xxx_hidden_PipePath string                 `protobuf:"bytes,2,opt,name=pipe_path,json=pipePath,proto3"`
...
func (b0 AuthenticateProcessRequest_builder) Build() *AuthenticateProcessRequest {
	...
	x.xxx_hidden_PipePath = b.PipePath
	return m0
}
...
type ReportNetworkStackInfoRequest struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_NetworkStackInfo *NetworkStackInfo      `protobuf:"bytes,1,opt,name=network_stack_info,json=networkStackInfo,proto3"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *ReportNetworkStackInfoRequest) HasNetworkStackInfo() bool {
	...
	return x.xxx_hidden_NetworkStackInfo != nil
}

func (x *ReportNetworkStackInfoRequest) ClearNetworkStackInfo() {
	x.xxx_hidden_NetworkStackInfo = nil
}
...
func (b0 ReportNetworkStackInfoRequest_builder) Build() *ReportNetworkStackInfoRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_NetworkStackInfo = b.NetworkStackInfo
	return m0
}
...
type NetworkStackInfo struct {
	...
	xxx_hidden_Ipv6Prefix    string                 `protobuf:"bytes,2,opt,name=ipv6_prefix,json=ipv6Prefix,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
type ResolveFQDNRequest struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Fqdn string                 `protobuf:"bytes,1,opt,name=fqdn,proto3"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type ResolveFQDNResponse struct {
	state            protoimpl.MessageState      `protogen:"opaque.v1"`
	xxx_hidden_Match isResolveFQDNResponse_Match `protobuf_oneof:"match"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *ResolveFQDNResponse) GetMatchedTcpApp() *MatchedTCPApp {
	if x != nil {
		if x, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedTcpApp); ok {
...
func (x *ResolveFQDNResponse) GetMatchedWebApp() *MatchedWebApp {
	if x != nil {
		if x, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedWebApp); ok {
...
func (x *ResolveFQDNResponse) GetMatchedCluster() *MatchedCluster {
	if x != nil {
		if x, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedCluster); ok {
...
func (x *ResolveFQDNResponse) GetMatchedDatabase() *MatchedDatabase {
	if x != nil {
		if x, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedDatabase); ok {
...
func (x *ResolveFQDNResponse) GetMatchedHttpsTunnelApp() *MatchedHTTPSTunnelApp {
	if x != nil {
		if x, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedHttpsTunnelApp); ok {
...
func (x *ResolveFQDNResponse) SetMatchedTcpApp(v *MatchedTCPApp) {
	...
	x.xxx_hidden_Match = &resolveFQDNResponse_MatchedTcpApp{v}
}
...
func (x *ResolveFQDNResponse) SetMatchedWebApp(v *MatchedWebApp) {
	...
	x.xxx_hidden_Match = &resolveFQDNResponse_MatchedWebApp{v}
}
...
func (x *ResolveFQDNResponse) SetMatchedCluster(v *MatchedCluster) {
	...
	x.xxx_hidden_Match = &resolveFQDNResponse_MatchedCluster{v}
}
...
func (x *ResolveFQDNResponse) SetMatchedDatabase(v *MatchedDatabase) {
	...
	x.xxx_hidden_Match = &resolveFQDNResponse_MatchedDatabase{v}
}
...
func (x *ResolveFQDNResponse) SetMatchedHttpsTunnelApp(v *MatchedHTTPSTunnelApp) {
	...
	x.xxx_hidden_Match = &resolveFQDNResponse_MatchedHttpsTunnelApp{v}
}
...
func (x *ResolveFQDNResponse) HasMatchedTcpApp() bool {
	...
	_, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedTcpApp)
	return ok
}
...
func (x *ResolveFQDNResponse) HasMatchedWebApp() bool {
	...
	_, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedWebApp)
	return ok
}
...
func (x *ResolveFQDNResponse) HasMatchedCluster() bool {
	...
	_, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedCluster)
	return ok
}
...
func (x *ResolveFQDNResponse) HasMatchedDatabase() bool {
	...
	_, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedDatabase)
	return ok
}
...
func (x *ResolveFQDNResponse) HasMatchedHttpsTunnelApp() bool {
	...
	_, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedHttpsTunnelApp)
	return ok
}
...
func (x *ResolveFQDNResponse) ClearMatchedTcpApp() {
	if _, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedTcpApp); ok {
		x.xxx_hidden_Match = nil
	}
}

func (x *ResolveFQDNResponse) ClearMatchedWebApp() {
	if _, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedWebApp); ok {
		x.xxx_hidden_Match = nil
	}
}

func (x *ResolveFQDNResponse) ClearMatchedCluster() {
	if _, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedCluster); ok {
		x.xxx_hidden_Match = nil
	}
}

func (x *ResolveFQDNResponse) ClearMatchedDatabase() {
	if _, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedDatabase); ok {
		x.xxx_hidden_Match = nil
	}
}

func (x *ResolveFQDNResponse) ClearMatchedHttpsTunnelApp() {
	if _, ok := x.xxx_hidden_Match.(*resolveFQDNResponse_MatchedHttpsTunnelApp); ok {
		x.xxx_hidden_Match = nil
	}
}
...
func (b0 ResolveFQDNResponse_builder) Build() *ResolveFQDNResponse {
	...
	if b.MatchedTcpApp != nil {
		x.xxx_hidden_Match = &resolveFQDNResponse_MatchedTcpApp{b.MatchedTcpApp}
	}
	if b.MatchedWebApp != nil {
		x.xxx_hidden_Match = &resolveFQDNResponse_MatchedWebApp{b.MatchedWebApp}
	}
	if b.MatchedCluster != nil {
		x.xxx_hidden_Match = &resolveFQDNResponse_MatchedCluster{b.MatchedCluster}
	}
	if b.MatchedDatabase != nil {
		x.xxx_hidden_Match = &resolveFQDNResponse_MatchedDatabase{b.MatchedDatabase}
	}
	if b.MatchedHttpsTunnelApp != nil {
		x.xxx_hidden_Match = &resolveFQDNResponse_MatchedHttpsTunnelApp{b.MatchedHttpsTunnelApp}
	}
	return m0
}
...
type MatchedTCPApp struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_AppInfo *AppInfo               `protobuf:"bytes,1,opt,name=app_info,json=appInfo,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type MatchedCluster struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Ipv4CidrRange string                 `protobuf:"bytes,1,opt,name=ipv4_cidr_range,json=ipv4CidrRange,proto3"`
	xxx_hidden_WebProxyAddr  string                 `protobuf:"bytes,2,opt,name=web_proxy_addr,json=webProxyAddr,proto3"`
	xxx_hidden_Profile       string                 `protobuf:"bytes,3,opt,name=profile,proto3"`
	xxx_hidden_RootCluster   string                 `protobuf:"bytes,4,opt,name=root_cluster,json=rootCluster,proto3"`
	xxx_hidden_LeafCluster   string                 `protobuf:"bytes,5,opt,name=leaf_cluster,json=leafCluster,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *MatchedCluster) GetIpv4CidrRange() string {
	if x != nil {
		return x.xxx_hidden_Ipv4CidrRange
	}
	return ""
}
...
func (x *MatchedCluster) GetWebProxyAddr() string {
	if x != nil {
		return x.xxx_hidden_WebProxyAddr
	}
	return ""
}
...
func (x *MatchedCluster) GetRootCluster() string {
	if x != nil {
		return x.xxx_hidden_RootCluster
	}
	return ""
}
...
func (x *MatchedCluster) SetIpv4CidrRange(v string) {
	x.xxx_hidden_Ipv4CidrRange = v
}

func (x *MatchedCluster) SetWebProxyAddr(v string) {
	x.xxx_hidden_WebProxyAddr = v
}
...
func (b0 MatchedCluster_builder) Build() *MatchedCluster {
	...
	x.xxx_hidden_WebProxyAddr = b.WebProxyAddr
	x.xxx_hidden_Profile = b.Profile
	x.xxx_hidden_RootCluster = b.RootCluster
...
type AppInfo struct {
	...
	xxx_hidden_App           *types.AppV3           `protobuf:"bytes,3,opt,name=app,proto3"`
...
func (x *AppInfo) GetDialOptions() *DialOptions {
	if x != nil {
		return x.xxx_hidden_DialOptions
	}
	return nil
}
...
func (x *AppInfo) HasDialOptions() bool {
	...
	return x.xxx_hidden_DialOptions != nil
}
...
type AppKey struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Profile     string                 `protobuf:"bytes,1,opt,name=profile,proto3"`
	xxx_hidden_LeafCluster string                 `protobuf:"bytes,2,opt,name=leaf_cluster,json=leafCluster,proto3"`
...
type DialOptions struct {
	state                              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_WebProxyAddr            string                 `protobuf:"bytes,1,opt,name=web_proxy_addr,json=webProxyAddr,proto3"`
	xxx_hidden_AlpnConnUpgradeRequired bool                   `protobuf:"varint,2,opt,name=alpn_conn_upgrade_required,json=alpnConnUpgradeRequired,proto3"`
	xxx_hidden_Sni                     string                 `protobuf:"bytes,3,opt,name=sni,proto3"`
	xxx_hidden_InsecureSkipVerify      bool                   `protobuf:"varint,4,opt,name=insecure_skip_verify,json=insecureSkipVerify,proto3"`
	xxx_hidden_RootClusterCaCertPool   []byte                 `protobuf:"bytes,5,opt,name=root_cluster_ca_cert_pool,json=rootClusterCaCertPool,proto3"`
	unknownFields                      protoimpl.UnknownFields
	sizeCache                          protoimpl.SizeCache
}
...
func (x *DialOptions) GetAlpnConnUpgradeRequired() bool {
	if x != nil {
		return x.xxx_hidden_AlpnConnUpgradeRequired
	}
	return false
}
...
func (x *DialOptions) GetRootClusterCaCertPool() []byte {
	if x != nil {
		return x.xxx_hidden_RootClusterCaCertPool
	}
	return nil
}
...
func (x *DialOptions) SetAlpnConnUpgradeRequired(v bool) {
	x.xxx_hidden_AlpnConnUpgradeRequired = v
}
...
func (x *DialOptions) SetRootClusterCaCertPool(v []byte) {
	...
	x.xxx_hidden_RootClusterCaCertPool = v
}
...
func (b0 DialOptions_builder) Build() *DialOptions {
	...
	_, _ = b, x
	x.xxx_hidden_WebProxyAddr = b.WebProxyAddr
	x.xxx_hidden_AlpnConnUpgradeRequired = b.AlpnConnUpgradeRequired
	x.xxx_hidden_Sni = b.Sni
	x.xxx_hidden_InsecureSkipVerify = b.InsecureSkipVerify
	x.xxx_hidden_RootClusterCaCertPool = b.RootClusterCaCertPool
	return m0
}
...
type ReissueAppCertRequest struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_AppInfo    *AppInfo               `protobuf:"bytes,1,opt,name=app_info,json=appInfo,proto3"`
	xxx_hidden_TargetPort uint32                 `protobuf:"varint,2,opt,name=target_port,json=targetPort,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type SignForAppRequest struct {
	...
	xxx_hidden_AppKey     *AppKey                `protobuf:"bytes,1,opt,name=app_key,json=appKey,proto3"`
	xxx_hidden_TargetPort uint32                 `protobuf:"varint,2,opt,name=target_port,json=targetPort,proto3"`
	xxx_hidden_Sign       *SignRequest           `protobuf:"bytes,6,opt,name=sign,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type SignRequest struct {
	...
	xxx_hidden_Hash          Hash                   `protobuf:"varint,2,opt,name=hash,proto3,enum=teleport.lib.vnet.v1.Hash"`
	xxx_hidden_PssSaltLength int32                  `protobuf:"varint,3,opt,name=pss_salt_length,json=pssSaltLength,proto3,oneof"`
...
func (x *SignRequest) GetPssSaltLength() int32 {
	if x != nil {
		return x.xxx_hidden_PssSaltLength
	}
	return 0
}
...
func (b0 SignRequest_builder) Build() *SignRequest {
	...
	if b.PssSaltLength != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 2, 3)
		x.xxx_hidden_PssSaltLength = *b.PssSaltLength
	}
	return m0
}
...
type OnNewAppConnectionRequest struct {
	...
	xxx_hidden_ClientProcessPath string                 `protobuf:"bytes,3,opt,name=client_process_path,json=clientProcessPath,proto3"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (x *OnNewAppConnectionRequest) GetClientProcessPath() string {
	if x != nil {
		return x.xxx_hidden_ClientProcessPath
	}
	return ""
}
...
func (x *OnNewAppConnectionRequest) SetClientProcessPath(v string) {
	x.xxx_hidden_ClientProcessPath = v
}
...
func (b0 OnNewAppConnectionRequest_builder) Build() *OnNewAppConnectionRequest {
	...
	x.xxx_hidden_ClientProcessPath = b.ClientProcessPath
	return m0
}
...
type GetTargetOSConfigurationResponse struct {
	state                            protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_TargetOsConfiguration *TargetOSConfiguration `protobuf:"bytes,1,opt,name=target_os_configuration,json=targetOsConfiguration,proto3"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
func (x *GetTargetOSConfigurationResponse) HasTargetOsConfiguration() bool {
	...
	return x.xxx_hidden_TargetOsConfiguration != nil
}

func (x *GetTargetOSConfigurationResponse) ClearTargetOsConfiguration() {
	x.xxx_hidden_TargetOsConfiguration = nil
}
...
func (b0 GetTargetOSConfigurationResponse_builder) Build() *GetTargetOSConfigurationResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_TargetOsConfiguration = b.TargetOsConfiguration
	return m0
}
...
type TargetOSConfiguration struct {
	state                     protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_DnsZones       []string               `protobuf:"bytes,1,rep,name=dns_zones,json=dnsZones,proto3"`
...
type UserTLSCertResponse struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Cert        []byte                 `protobuf:"bytes,1,opt,name=cert,proto3"`
	xxx_hidden_DialOptions *DialOptions           `protobuf:"bytes,2,opt,name=dial_options,json=dialOptions,proto3"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type SignForUserTLSRequest struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Profile string                 `protobuf:"bytes,1,opt,name=profile,proto3"`
	xxx_hidden_Sign    *SignRequest           `protobuf:"bytes,2,opt,name=sign,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type SessionSSHConfigRequest struct {
	state                        protoimpl.MessageState         `protogen:"opaque.v1"`
	xxx_hidden_Profile           string                         `protobuf:"bytes,1,opt,name=profile,proto3"`
	xxx_hidden_RootCluster       string                         `protobuf:"bytes,2,opt,name=root_cluster,json=rootCluster,proto3"`
	...
	xxx_hidden_CredentialMode    SessionSSHConfigCredentialMode `protobuf:"varint,6,opt,name=credential_mode,json=credentialMode,proto3,enum=teleport.lib.vnet.v1.SessionSSHConfigCredentialMode"`
	xxx_hidden_ClientProcessPath string                         `protobuf:"bytes,7,opt,name=client_process_path,json=clientProcessPath,proto3"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (x *SessionSSHConfigRequest) GetCredentialMode() SessionSSHConfigCredentialMode {
	if x != nil {
		return x.xxx_hidden_CredentialMode
	}
...
func (b0 SessionSSHConfigRequest_builder) Build() *SessionSSHConfigRequest {
	...
	x.xxx_hidden_CredentialMode = b.CredentialMode
	x.xxx_hidden_ClientProcessPath = b.ClientProcessPath
	return m0
}
...
type SessionSSHConfigResponse struct {
	...
	xxx_hidden_Cert       []byte                 `protobuf:"bytes,2,opt,name=cert,proto3"`
	xxx_hidden_TrustedCas [][]byte               `protobuf:"bytes,3,rep,name=trusted_cas,json=trustedCas,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *SessionSSHConfigResponse) GetTrustedCas() [][]byte {
	if x != nil {
		return x.xxx_hidden_TrustedCas
	}
	return nil
}
...
func (b0 SessionSSHConfigResponse_builder) Build() *SessionSSHConfigResponse {
	...
	x.xxx_hidden_Cert = b.Cert
	x.xxx_hidden_TrustedCas = b.TrustedCas
	return m0
}
...
type ExchangeSSHKeysRequest struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_HostPublicKey []byte                 `protobuf:"bytes,1,opt,name=host_public_key,json=hostPublicKey,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *ExchangeSSHKeysRequest) GetHostPublicKey() []byte {
	if x != nil {
		return x.xxx_hidden_HostPublicKey
	}
	return nil
}
...
func (b0 ExchangeSSHKeysRequest_builder) Build() *ExchangeSSHKeysRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_HostPublicKey = b.HostPublicKey
	return m0
}
...
type ExchangeSSHKeysResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_UserPublicKey []byte                 `protobuf:"bytes,1,opt,name=user_public_key,json=userPublicKey,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *ExchangeSSHKeysResponse) GetUserPublicKey() []byte {
	if x != nil {
		return x.xxx_hidden_UserPublicKey
	}
	return nil
}
...
func (b0 ExchangeSSHKeysResponse_builder) Build() *ExchangeSSHKeysResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_UserPublicKey = b.UserPublicKey
	return m0
}
...
type PerformSessionMFACeremonyRequest struct {
	...
	xxx_hidden_Profile      string                 `protobuf:"bytes,1,opt,name=profile,proto3"`
	xxx_hidden_LeafCluster  string                 `protobuf:"bytes,2,opt,name=leaf_cluster,json=leafCluster,proto3"`
	xxx_hidden_SshSessionId []byte                 `protobuf:"bytes,3,opt,name=ssh_session_id,json=sshSessionId,proto3"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *PerformSessionMFACeremonyRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PerformSessionMFACeremonyRequest) GetLeafCluster() string {
	if x != nil {
		return x.xxx_hidden_LeafCluster
	}
	return ""
...
func (x *PerformSessionMFACeremonyRequest) GetSshSessionId() []byte {
	if x != nil {
		return x.xxx_hidden_SshSessionId
	}
	return nil
}
...
func (b0 PerformSessionMFACeremonyRequest_builder) Build() *PerformSessionMFACeremonyRequest {
	...
	x.xxx_hidden_Profile = b.Profile
	x.xxx_hidden_LeafCluster = b.LeafCluster
	x.xxx_hidden_SshSessionId = b.SshSessionId
	return m0
}
...
func (x *PerformSessionMFACeremonyResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type MatchedDatabase struct {
	state                   protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_DatabaseInfo *DatabaseInfo          `protobuf:"bytes,1,opt,name=database_info,json=databaseInfo,proto3"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *MatchedDatabase) GetDatabaseInfo() *DatabaseInfo {
	if x != nil {
		return x.xxx_hidden_DatabaseInfo
	}
	return nil
}

func (x *MatchedDatabase) SetDatabaseInfo(v *DatabaseInfo) {
	x.xxx_hidden_DatabaseInfo = v
}
...
func (x *MatchedDatabase) HasDatabaseInfo() bool {
	...
	return x.xxx_hidden_DatabaseInfo != nil
}

func (x *MatchedDatabase) ClearDatabaseInfo() {
	x.xxx_hidden_DatabaseInfo = nil
}
...
func (x *DatabaseInfo) GetDatabaseKey() *DatabaseKey {
	if x != nil {
		return x.xxx_hidden_DatabaseKey
	}
	return nil
}
...
func (x *DatabaseInfo) HasDatabaseKey() bool {
	...
	return x.xxx_hidden_DatabaseKey != nil
}
...
type ConnectionStat struct {
	state                            protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Kind                  ConnectionKind         `protobuf:"varint,1,opt,name=kind,proto3,enum=teleport.lib.vnet.v1.ConnectionKind"`
	xxx_hidden_Profile               string                 `protobuf:"bytes,2,opt,name=profile,proto3"`
	xxx_hidden_LeafCluster           string                 `protobuf:"bytes,3,opt,name=leaf_cluster,json=leafCluster,proto3"`
...
func (x *ConnectionStat) GetKind() ConnectionKind {
	if x != nil {
		return x.xxx_hidden_Kind
	}
	return ConnectionKind_CONNECTION_KIND_UNSPECIFIED
}

func (x *ConnectionStat) GetProfile() string {
	if x != nil {
		return x.xxx_hidden_Profile
	}
	return ""
...
func (x *ConnectionStat) SetKind(v ConnectionKind) {
	x.xxx_hidden_Kind = v
}

func (x *ConnectionStat) SetProfile(v string) {
	x.xxx_hidden_Profile = v
}
...
type ConnectionStat_builder struct {
	...
	Kind ConnectionKind
	// Profile is the profile (root cluster) the target is found in.
	Profile string
	// LeafCluster is the leaf cluster the target is found in. Empty if the
	// target is in the root cluster.
	LeafCluster string
	// DisplayName is the address shown to the user, e.g. the app public address,
	// the database FQDN, or the SSH host address.
	DisplayName string
	// Port is the target port of the connection. Only set for multi-port TCP
	// apps, zero otherwise.
	Port uint32
	// SuccessfulConnections is the number of connections to the target that were
	// successfully established.
	SuccessfulConnections uint64
	// FailedConnections is the number of connections to the target that failed
	// to be established.
	FailedConnections uint64
	// BytesTx is the total number of bytes transmitted to the target, as
	// measured on the connection between the client application and VNet.
	BytesTx uint64
	// BytesRx is the total number of bytes received from the target, as measured
	// on the connection between the client application and VNet.
	BytesRx uint64
	// BytesTxPerSec is the transmit throughput to the target measured over the
	// most recent sampling interval.
	BytesTxPerSec uint64
	// BytesRxPerSec is the receive throughput from the target measured over the
	// most recent sampling interval.
...
// ConnectionRecord describes a single connection made through VNet. Records are
// kept in a capped window, oldest finished records are evicted first.
type ConnectionRecord struct {
	state                        protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Id                uint64                 `protobuf:"varint,1,opt,name=id,proto3"`
	xxx_hidden_Kind              ConnectionKind         `protobuf:"varint,2,opt,name=kind,proto3,enum=teleport.lib.vnet.v1.ConnectionKind"`
	xxx_hidden_Profile           string                 `protobuf:"bytes,3,opt,name=profile,proto3"`
	xxx_hidden_LeafCluster       string                 `protobuf:"bytes,4,opt,name=leaf_cluster,json=leafCluster,proto3"`
	xxx_hidden_DisplayName       string                 `protobuf:"bytes,5,opt,name=display_name,json=displayName,proto3"`
	xxx_hidden_Port              uint32                 `protobuf:"varint,6,opt,name=port,proto3"`
	xxx_hidden_LocalPort         uint32                 `protobuf:"varint,7,opt,name=local_port,json=localPort,proto3"`
	xxx_hidden_ClientProcessPath string                 `protobuf:"bytes,8,opt,name=client_process_path,json=clientProcessPath,proto3"`
	xxx_hidden_StartedAt         *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=started_at,json=startedAt,proto3"`
	xxx_hidden_EndedAt           *timestamppb.Timestamp `protobuf:"bytes,10,opt,name=ended_at,json=endedAt,proto3"`
	xxx_hidden_BytesTx           uint64                 `protobuf:"varint,11,opt,name=bytes_tx,json=bytesTx,proto3"`
	xxx_hidden_BytesRx           uint64                 `protobuf:"varint,12,opt,name=bytes_rx,json=bytesRx,proto3"`
	xxx_hidden_State             ConnectionRecordState  `protobuf:"varint,13,opt,name=state,proto3,enum=teleport.lib.vnet.v1.ConnectionRecordState"`
...
func (x *ConnectionRecord) GetKind() ConnectionKind {
	if x != nil {
		return x.xxx_hidden_Kind
	}
	return ConnectionKind_CONNECTION_KIND_UNSPECIFIED
...
func (x *ConnectionRecord) GetProfile() string {
	if x != nil {
		return x.xxx_hidden_Profile
	}
	return ""
...
func (x *ConnectionRecord) SetKind(v ConnectionKind) {
	x.xxx_hidden_Kind = v
}

func (x *ConnectionRecord) SetProfile(v string) {
	x.xxx_hidden_Profile = v
}
...
type ConnectionRecord_builder struct {
	...
	Port uint32
	// LocalPort is the port the client application actually dialed. Unlike port
	...
	LocalPort uint32
	// ClientProcessPath is the executable path of the local program that opened
	// the connection, best-effort and possibly empty.
	ClientProcessPath string
	// StartedAt is the time the connection was opened at.
	StartedAt *timestamppb.Timestamp
	// EndedAt is the time the connection ended at. Unset while the connection is
	// still active.
	EndedAt *timestamppb.Timestamp
	// BytesTx is the number of bytes transmitted to the target over this
	// connection. Updated while the connection is active, final once it ended.
	BytesTx uint64
	// BytesRx is the number of bytes received from the target over this
	// connection. Updated while the connection is active, final once it ended.
	BytesRx uint64
	// State is the state of the connection.
	State ConnectionRecordState
	// ErrorMessage is the reason a FAILED connection could not be established, or
...
// ConnectionsReport is a complete snapshot of VNet connection activity.
type ConnectionsReport struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Stats       *[]*ConnectionStat     `protobuf:"bytes,1,rep,name=stats,proto3"`
	xxx_hidden_Connections *[]*ConnectionRecord   `protobuf:"bytes,2,rep,name=connections,proto3"`
	xxx_hidden_CollectedAt *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=collected_at,json=collectedAt,proto3"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *ConnectionsReport) GetStats() []*ConnectionStat {
	if x != nil {
...
func (x *ConnectionsReport) GetConnections() []*ConnectionRecord {
	if x != nil {
...
func (x *ConnectionsReport) GetCollectedAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ConnectionsReport) SetStats(v []*ConnectionStat) {
	x.xxx_hidden_Stats = &v
}

func (x *ConnectionsReport) SetConnections(v []*ConnectionRecord) {
	x.xxx_hidden_Connections = &v
}

func (x *ConnectionsReport) SetCollectedAt(v *timestamppb.Timestamp) {
	x.xxx_hidden_CollectedAt = v
}

func (x *ConnectionsReport) HasCollectedAt() bool {
	if x == nil {
		return false
	}
...
func (x *ConnectionsReport) ClearCollectedAt() {
	x.xxx_hidden_CollectedAt = nil
}

type ConnectionsReport_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
	...
	// CollectedAt is the time the snapshot was collected at.
	CollectedAt *timestamppb.Timestamp
}

func (b0 ConnectionsReport_builder) Build() *ConnectionsReport {
	m0 := &ConnectionsReport{}
	b, x := &b0, m0
	_, _ = b, x
...
// ReportConnectionsRequest is a request for ReportConnections.
type ReportConnectionsRequest struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Report *ConnectionsReport     `protobuf:"bytes,1,opt,name=report,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ReportConnectionsRequest) GetReport() *ConnectionsReport {
	if x != nil {
...
func (x *ReportConnectionsRequest) SetReport(v *ConnectionsReport) {
	x.xxx_hidden_Report = v
}

func (x *ReportConnectionsRequest) HasReport() bool {
	if x == nil {
		return false
	}
...
func (x *ReportConnectionsRequest) ClearReport() {
	x.xxx_hidden_Report = nil
}

type ReportConnectionsRequest_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// Report is the complete snapshot of VNet connection activity.
	Report *ConnectionsReport
}

func (b0 ReportConnectionsRequest_builder) Build() *ReportConnectionsRequest {
	m0 := &ReportConnectionsRequest{}
	b, x := &b0, m0
	_, _ = b, x
...
// ReportConnectionsResponse is a response for ReportConnections.
...
type ReportConnectionsResponse_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

}

func (b0 ReportConnectionsResponse_builder) Build() *ReportConnectionsResponse {
	m0 := &ReportConnectionsResponse{}
	b, x := &b0, m0
	_, _ = b, x
	return m0
}
...
const file_teleport_lib_vnet_v1_client_application_service_proto_rawDesc = "" +
	"\n" +
	"5teleport/lib/vnet/v1/client_application_service.proto\x12\x14teleport.lib.vnet.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a!teleport/legacy/types/types.proto\"S\n" +
	...
	"\x0fuser_public_key\x18\x01 \x01(\fR\ruserPublicKey\"\x85\x01\n" +
	" PerformSessionMFACeremonyRequest\x12\x18\n" +
	"\aprofile\x18\x01 \x01(\tR\aprofile\x12!\n" +
	"\fleaf_cluster\x18\x02 \x01(\tR\vleafCluster\x12$\n" +
	"\x0essh_session_id\x18\x03 \x01(\fR\fsshSessionId\"J\n" +
	...
	"\x19OnNewDBConnectionResponse\"\xac\x03\n" +
	"\x0eConnectionStat\x128\n" +
	"\x04kind\x18\x01 \x01(\x0e2$.teleport.lib.vnet.v1.ConnectionKindR\x04kind\x12\x18\n" +
	...
	"\x10bytes_rx_per_sec\x18\v \x01(\x04R\rbytesRxPerSec\"\xaf\x04\n" +
	"\x10ConnectionRecord\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x128\n" +
	"\x04kind\x18\x02 \x01(\x0e2$.teleport.lib.vnet.v1.ConnectionKindR\x04kind\x12\x18\n" +
	"\aprofile\x18\x03 \x01(\tR\aprofile\x12!\n" +
	...
	"\bbytes_rx\x18\f \x01(\x04R\abytesRx\x12A\n" +
	"\x05state\x18\r \x01(\x0e2+.teleport.lib.vnet.v1.ConnectionRecordStateR\x05state\x12#\n" +
	"\rerror_message\x18\x0e \x01(\tR\ferrorMessage\"\xd8\x01\n" +
	"\x11ConnectionsReport\x12:\n" +
	"\x05stats\x18\x01 \x03(\v2$.teleport.lib.vnet.v1.ConnectionStatR\x05stats\x12H\n" +
	"\vconnections\x18\x02 \x03(\v2&.teleport.lib.vnet.v1.ConnectionRecordR\vconnections\x12=\n" +
	"\fcollected_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\vcollectedAt\"[\n" +
	"\x18ReportConnectionsRequest\x12?\n" +
	"\x06report\x18\x01 \x01(\v2'.teleport.lib.vnet.v1.ConnectionsReportR\x06report\"\x1b\n" +
	"\x19ReportConnectionsResponse*<\n" +
	"\x04Hash\x12\x14\n" +
	"\x10HASH_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tHASH_NONE\x10\x01\x12\x0f\n" +
	"\vHASH_SHA256\x10\x02*\xb4\x01\n" +
	...
	")SESSION_SSH_CONFIG_CREDENTIAL_MODE_DIRECT\x10\x02*\x81\x01\n" +
	"\x0eConnectionKind\x12\x1f\n" +
	"\x1bCONNECTION_KIND_UNSPECIFIED\x10\x00\x12\x17\n" +
	"\x13CONNECTION_KIND_APP\x10\x01\x12\x17\n" +
	"\x13CONNECTION_KIND_SSH\x10\x02\x12\x1c\n" +
	"\x18CONNECTION_KIND_DATABASE\x10\x03*\xaa\x01\n" +
	...
	"\x1eCONNECTION_RECORD_STATE_FAILED\x10\x032\x88\x11\n" +
	...
	"\x0fExchangeSSHKeys\x12,.teleport.lib.vnet.v1.ExchangeSSHKeysRequest\x1a-.teleport.lib.vnet.v1.ExchangeSSHKeysResponse\x12\x8c\x01\n" +
	...
	"\x11OnNewDBConnection\x12..teleport.lib.vnet.v1.OnNewDBConnectionRequest\x1a/.teleport.lib.vnet.v1.OnNewDBConnectionResponse\x12t\n" +
	"\x11ReportConnections\x12..teleport.lib.vnet.v1.ReportConnectionsRequest\x1a/.teleport.lib.vnet.v1.ReportConnectionsResponseBLZJgithub.com/gravitational/teleport/gen/proto/go/teleport/lib/vnet/v1;vnetv1b\x06proto3"

var file_teleport_lib_vnet_v1_client_application_service_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_teleport_lib_vnet_v1_client_application_service_proto_msgTypes = make([]protoimpl.MessageInfo, 54)
var file_teleport_lib_vnet_v1_client_application_service_proto_goTypes = []any{
	...
	(ConnectionKind)(0),                       // 2: teleport.lib.vnet.v1.ConnectionKind
	(ConnectionRecordState)(0),                // 3: teleport.lib.vnet.v1.ConnectionRecordState
	(*AuthenticateProcessRequest)(nil),        // 4: teleport.lib.vnet.v1.AuthenticateProcessRequest
	(*AuthenticateProcessResponse)(nil),       // 5: teleport.lib.vnet.v1.AuthenticateProcessResponse
	(*ReportNetworkStackInfoRequest)(nil),     // 6: teleport.lib.vnet.v1.ReportNetworkStackInfoRequest
	(*NetworkStackInfo)(nil),                  // 7: teleport.lib.vnet.v1.NetworkStackInfo
	(*ReportNetworkStackInfoResponse)(nil),    // 8: teleport.lib.vnet.v1.ReportNetworkStackInfoResponse
	(*PingRequest)(nil),                       // 9: teleport.lib.vnet.v1.PingRequest
	(*PingResponse)(nil),                      // 10: teleport.lib.vnet.v1.PingResponse
	(*ResolveFQDNRequest)(nil),                // 11: teleport.lib.vnet.v1.ResolveFQDNRequest
	(*ResolveFQDNResponse)(nil),               // 12: teleport.lib.vnet.v1.ResolveFQDNResponse
	(*MatchedTCPApp)(nil),                     // 13: teleport.lib.vnet.v1.MatchedTCPApp
	(*MatchedWebApp)(nil),                     // 14: teleport.lib.vnet.v1.MatchedWebApp
	(*MatchedHTTPSTunnelApp)(nil),             // 15: teleport.lib.vnet.v1.MatchedHTTPSTunnelApp
	(*MatchedCluster)(nil),                    // 16: teleport.lib.vnet.v1.MatchedCluster
	(*AppInfo)(nil),                           // 17: teleport.lib.vnet.v1.AppInfo
	(*AppKey)(nil),                            // 18: teleport.lib.vnet.v1.AppKey
	(*DialOptions)(nil),                       // 19: teleport.lib.vnet.v1.DialOptions
	(*ReissueAppCertRequest)(nil),             // 20: teleport.lib.vnet.v1.ReissueAppCertRequest
	(*ReissueAppCertResponse)(nil),            // 21: teleport.lib.vnet.v1.ReissueAppCertResponse
	(*SignForAppRequest)(nil),                 // 22: teleport.lib.vnet.v1.SignForAppRequest
	(*SignRequest)(nil),                       // 23: teleport.lib.vnet.v1.SignRequest
	(*SignForAppResponse)(nil),                // 24: teleport.lib.vnet.v1.SignForAppResponse
	(*OnNewAppConnectionRequest)(nil),         // 25: teleport.lib.vnet.v1.OnNewAppConnectionRequest
	(*OnNewAppConnectionResponse)(nil),        // 26: teleport.lib.vnet.v1.OnNewAppConnectionResponse
	(*OnInvalidLocalPortRequest)(nil),         // 27: teleport.lib.vnet.v1.OnInvalidLocalPortRequest
	(*OnInvalidLocalPortResponse)(nil),        // 28: teleport.lib.vnet.v1.OnInvalidLocalPortResponse
	(*GetTargetOSConfigurationRequest)(nil),   // 29: teleport.lib.vnet.v1.GetTargetOSConfigurationRequest
	(*GetTargetOSConfigurationResponse)(nil),  // 30: teleport.lib.vnet.v1.GetTargetOSConfigurationResponse
	(*TargetOSConfiguration)(nil),             // 31: teleport.lib.vnet.v1.TargetOSConfiguration
	(*UserTLSCertRequest)(nil),                // 32: teleport.lib.vnet.v1.UserTLSCertRequest
	(*UserTLSCertResponse)(nil),               // 33: teleport.lib.vnet.v1.UserTLSCertResponse
	(*SignForUserTLSRequest)(nil),             // 34: teleport.lib.vnet.v1.SignForUserTLSRequest
	(*SignForUserTLSResponse)(nil),            // 35: teleport.lib.vnet.v1.SignForUserTLSResponse
	(*SessionSSHConfigRequest)(nil),           // 36: teleport.lib.vnet.v1.SessionSSHConfigRequest
	(*SessionSSHConfigResponse)(nil),          // 37: teleport.lib.vnet.v1.SessionSSHConfigResponse
	(*SignForSSHSessionRequest)(nil),          // 38: teleport.lib.vnet.v1.SignForSSHSessionRequest
	(*SignForSSHSessionResponse)(nil),         // 39: teleport.lib.vnet.v1.SignForSSHSessionResponse
	(*ExchangeSSHKeysRequest)(nil),            // 40: teleport.lib.vnet.v1.ExchangeSSHKeysRequest
	(*ExchangeSSHKeysResponse)(nil),           // 41: teleport.lib.vnet.v1.ExchangeSSHKeysResponse
	(*PerformSessionMFACeremonyRequest)(nil),  // 42: teleport.lib.vnet.v1.PerformSessionMFACeremonyRequest
	(*PerformSessionMFACeremonyResponse)(nil), // 43: teleport.lib.vnet.v1.PerformSessionMFACeremonyResponse
	(*MatchedDatabase)(nil),                   // 44: teleport.lib.vnet.v1.MatchedDatabase
	(*DatabaseInfo)(nil),                      // 45: teleport.lib.vnet.v1.DatabaseInfo
	(*DatabaseKey)(nil),                       // 46: teleport.lib.vnet.v1.DatabaseKey
	(*ReissueDBCertRequest)(nil),              // 47: teleport.lib.vnet.v1.ReissueDBCertRequest
	(*ReissueDBCertResponse)(nil),             // 48: teleport.lib.vnet.v1.ReissueDBCertResponse
	(*SignForDBRequest)(nil),                  // 49: teleport.lib.vnet.v1.SignForDBRequest
	(*SignForDBResponse)(nil),                 // 50: teleport.lib.vnet.v1.SignForDBResponse
	(*OnNewDBConnectionRequest)(nil),          // 51: teleport.lib.vnet.v1.OnNewDBConnectionRequest
	(*OnNewDBConnectionResponse)(nil),         // 52: teleport.lib.vnet.v1.OnNewDBConnectionResponse
	(*ConnectionStat)(nil),                    // 53: teleport.lib.vnet.v1.ConnectionStat
	(*ConnectionRecord)(nil),                  // 54: teleport.lib.vnet.v1.ConnectionRecord
	(*ConnectionsReport)(nil),                 // 55: teleport.lib.vnet.v1.ConnectionsReport
	(*ReportConnectionsRequest)(nil),          // 56: teleport.lib.vnet.v1.ReportConnectionsRequest
	(*ReportConnectionsResponse)(nil),         // 57: teleport.lib.vnet.v1.ReportConnectionsResponse
	(*types.AppV3)(nil),                       // 58: types.AppV3
	(*timestamppb.Timestamp)(nil),             // 59: google.protobuf.Timestamp
}
var file_teleport_lib_vnet_v1_client_application_service_proto_depIdxs = []int32{
	7,  // 0: teleport.lib.vnet.v1.ReportNetworkStackInfoRequest.network_stack_info:type_name -> teleport.lib.vnet.v1.NetworkStackInfo
	13, // 1: teleport.lib.vnet.v1.ResolveFQDNResponse.matched_tcp_app:type_name -> teleport.lib.vnet.v1.MatchedTCPApp
	14, // 2: teleport.lib.vnet.v1.ResolveFQDNResponse.matched_web_app:type_name -> teleport.lib.vnet.v1.MatchedWebApp
	16, // 3: teleport.lib.vnet.v1.ResolveFQDNResponse.matched_cluster:type_name -> teleport.lib.vnet.v1.MatchedCluster
	44, // 4: teleport.lib.vnet.v1.ResolveFQDNResponse.matched_database:type_name -> teleport.lib.vnet.v1.MatchedDatabase
	15, // 5: teleport.lib.vnet.v1.ResolveFQDNResponse.matched_https_tunnel_app:type_name -> teleport.lib.vnet.v1.MatchedHTTPSTunnelApp
	17, // 6: teleport.lib.vnet.v1.MatchedTCPApp.app_info:type_name -> teleport.lib.vnet.v1.AppInfo
	17, // 7: teleport.lib.vnet.v1.MatchedHTTPSTunnelApp.app_info:type_name -> teleport.lib.vnet.v1.AppInfo
	18, // 8: teleport.lib.vnet.v1.AppInfo.app_key:type_name -> teleport.lib.vnet.v1.AppKey
	58, // 9: teleport.lib.vnet.v1.AppInfo.app:type_name -> types.AppV3
	19, // 10: teleport.lib.vnet.v1.AppInfo.dial_options:type_name -> teleport.lib.vnet.v1.DialOptions
	17, // 11: teleport.lib.vnet.v1.ReissueAppCertRequest.app_info:type_name -> teleport.lib.vnet.v1.AppInfo
	18, // 12: teleport.lib.vnet.v1.SignForAppRequest.app_key:type_name -> teleport.lib.vnet.v1.AppKey
	23, // 13: teleport.lib.vnet.v1.SignForAppRequest.sign:type_name -> teleport.lib.vnet.v1.SignRequest
	0,  // 14: teleport.lib.vnet.v1.SignRequest.hash:type_name -> teleport.lib.vnet.v1.Hash
	18, // 15: teleport.lib.vnet.v1.OnNewAppConnectionRequest.app_key:type_name -> teleport.lib.vnet.v1.AppKey
	17, // 16: teleport.lib.vnet.v1.OnInvalidLocalPortRequest.app_info:type_name -> teleport.lib.vnet.v1.AppInfo
	31, // 17: teleport.lib.vnet.v1.GetTargetOSConfigurationResponse.target_os_configuration:type_name -> teleport.lib.vnet.v1.TargetOSConfiguration
	19, // 18: teleport.lib.vnet.v1.UserTLSCertResponse.dial_options:type_name -> teleport.lib.vnet.v1.DialOptions
	23, // 19: teleport.lib.vnet.v1.SignForUserTLSRequest.sign:type_name -> teleport.lib.vnet.v1.SignRequest
	...
	23, // 21: teleport.lib.vnet.v1.SignForSSHSessionRequest.sign:type_name -> teleport.lib.vnet.v1.SignRequest
	45, // 22: teleport.lib.vnet.v1.MatchedDatabase.database_info:type_name -> teleport.lib.vnet.v1.DatabaseInfo
	46, // 23: teleport.lib.vnet.v1.DatabaseInfo.database_key:type_name -> teleport.lib.vnet.v1.DatabaseKey
	19, // 24: teleport.lib.vnet.v1.DatabaseInfo.dial_options:type_name -> teleport.lib.vnet.v1.DialOptions
	45, // 25: teleport.lib.vnet.v1.ReissueDBCertRequest.database_info:type_name -> teleport.lib.vnet.v1.DatabaseInfo
	46, // 26: teleport.lib.vnet.v1.SignForDBRequest.database_key:type_name -> teleport.lib.vnet.v1.DatabaseKey
	23, // 27: teleport.lib.vnet.v1.SignForDBRequest.sign:type_name -> teleport.lib.vnet.v1.SignRequest
	46, // 28: teleport.lib.vnet.v1.OnNewDBConnectionRequest.database_key:type_name -> teleport.lib.vnet.v1.DatabaseKey
	2,  // 29: teleport.lib.vnet.v1.ConnectionStat.kind:type_name -> teleport.lib.vnet.v1.ConnectionKind
	2,  // 30: teleport.lib.vnet.v1.ConnectionRecord.kind:type_name -> teleport.lib.vnet.v1.ConnectionKind
	59, // 31: teleport.lib.vnet.v1.ConnectionRecord.started_at:type_name -> google.protobuf.Timestamp
	59, // 32: teleport.lib.vnet.v1.ConnectionRecord.ended_at:type_name -> google.protobuf.Timestamp
	3,  // 33: teleport.lib.vnet.v1.ConnectionRecord.state:type_name -> teleport.lib.vnet.v1.ConnectionRecordState
	53, // 34: teleport.lib.vnet.v1.ConnectionsReport.stats:type_name -> teleport.lib.vnet.v1.ConnectionStat
	54, // 35: teleport.lib.vnet.v1.ConnectionsReport.connections:type_name -> teleport.lib.vnet.v1.ConnectionRecord
	59, // 36: teleport.lib.vnet.v1.ConnectionsReport.collected_at:type_name -> google.protobuf.Timestamp
	55, // 37: teleport.lib.vnet.v1.ReportConnectionsRequest.report:type_name -> teleport.lib.vnet.v1.ConnectionsReport
	4,  // 38: teleport.lib.vnet.v1.ClientApplicationService.AuthenticateProcess:input_type -> teleport.lib.vnet.v1.AuthenticateProcessRequest
	6,  // 39: teleport.lib.vnet.v1.ClientApplicationService.ReportNetworkStackInfo:input_type -> teleport.lib.vnet.v1.ReportNetworkStackInfoRequest
	9,  // 40: teleport.lib.vnet.v1.ClientApplicationService.Ping:input_type -> teleport.lib.vnet.v1.PingRequest
	11, // 41: teleport.lib.vnet.v1.ClientApplicationService.ResolveFQDN:input_type -> teleport.lib.vnet.v1.ResolveFQDNRequest
	20, // 42: teleport.lib.vnet.v1.ClientApplicationService.ReissueAppCert:input_type -> teleport.lib.vnet.v1.ReissueAppCertRequest
	22, // 43: teleport.lib.vnet.v1.ClientApplicationService.SignForApp:input_type -> teleport.lib.vnet.v1.SignForAppRequest
	25, // 44: teleport.lib.vnet.v1.ClientApplicationService.OnNewAppConnection:input_type -> teleport.lib.vnet.v1.OnNewAppConnectionRequest
	27, // 45: teleport.lib.vnet.v1.ClientApplicationService.OnInvalidLocalPort:input_type -> teleport.lib.vnet.v1.OnInvalidLocalPortRequest
	29, // 46: teleport.lib.vnet.v1.ClientApplicationService.GetTargetOSConfiguration:input_type -> teleport.lib.vnet.v1.GetTargetOSConfigurationRequest
	32, // 47: teleport.lib.vnet.v1.ClientApplicationService.UserTLSCert:input_type -> teleport.lib.vnet.v1.UserTLSCertRequest
	34, // 48: teleport.lib.vnet.v1.ClientApplicationService.SignForUserTLS:input_type -> teleport.lib.vnet.v1.SignForUserTLSRequest
	36, // 49: teleport.lib.vnet.v1.ClientApplicationService.SessionSSHConfig:input_type -> teleport.lib.vnet.v1.SessionSSHConfigRequest
	38, // 50: teleport.lib.vnet.v1.ClientApplicationService.SignForSSHSession:input_type -> teleport.lib.vnet.v1.SignForSSHSessionRequest
	40, // 51: teleport.lib.vnet.v1.ClientApplicationService.ExchangeSSHKeys:input_type -> teleport.lib.vnet.v1.ExchangeSSHKeysRequest
	42, // 52: teleport.lib.vnet.v1.ClientApplicationService.PerformSessionMFACeremony:input_type -> teleport.lib.vnet.v1.PerformSessionMFACeremonyRequest
	47, // 53: teleport.lib.vnet.v1.ClientApplicationService.ReissueDBCert:input_type -> teleport.lib.vnet.v1.ReissueDBCertRequest
	49, // 54: teleport.lib.vnet.v1.ClientApplicationService.SignForDB:input_type -> teleport.lib.vnet.v1.SignForDBRequest
	51, // 55: teleport.lib.vnet.v1.ClientApplicationService.OnNewDBConnection:input_type -> teleport.lib.vnet.v1.OnNewDBConnectionRequest
	56, // 56: teleport.lib.vnet.v1.ClientApplicationService.ReportConnections:input_type -> teleport.lib.vnet.v1.ReportConnectionsRequest
	5,  // 57: teleport.lib.vnet.v1.ClientApplicationService.AuthenticateProcess:output_type -> teleport.lib.vnet.v1.AuthenticateProcessResponse
	8,  // 58: teleport.lib.vnet.v1.ClientApplicationService.ReportNetworkStackInfo:output_type -> teleport.lib.vnet.v1.ReportNetworkStackInfoResponse
	10, // 59: teleport.lib.vnet.v1.ClientApplicationService.Ping:output_type -> teleport.lib.vnet.v1.PingResponse
	12, // 60: teleport.lib.vnet.v1.ClientApplicationService.ResolveFQDN:output_type -> teleport.lib.vnet.v1.ResolveFQDNResponse
	21, // 61: teleport.lib.vnet.v1.ClientApplicationService.ReissueAppCert:output_type -> teleport.lib.vnet.v1.ReissueAppCertResponse
	24, // 62: teleport.lib.vnet.v1.ClientApplicationService.SignForApp:output_type -> teleport.lib.vnet.v1.SignForAppResponse
	26, // 63: teleport.lib.vnet.v1.ClientApplicationService.OnNewAppConnection:output_type -> teleport.lib.vnet.v1.OnNewAppConnectionResponse
	28, // 64: teleport.lib.vnet.v1.ClientApplicationService.OnInvalidLocalPort:output_type -> teleport.lib.vnet.v1.OnInvalidLocalPortResponse
	30, // 65: teleport.lib.vnet.v1.ClientApplicationService.GetTargetOSConfiguration:output_type -> teleport.lib.vnet.v1.GetTargetOSConfigurationResponse
	33, // 66: teleport.lib.vnet.v1.ClientApplicationService.UserTLSCert:output_type -> teleport.lib.vnet.v1.UserTLSCertResponse
	35, // 67: teleport.lib.vnet.v1.ClientApplicationService.SignForUserTLS:output_type -> teleport.lib.vnet.v1.SignForUserTLSResponse
	37, // 68: teleport.lib.vnet.v1.ClientApplicationService.SessionSSHConfig:output_type -> teleport.lib.vnet.v1.SessionSSHConfigResponse
	39, // 69: teleport.lib.vnet.v1.ClientApplicationService.SignForSSHSession:output_type -> teleport.lib.vnet.v1.SignForSSHSessionResponse
	41, // 70: teleport.lib.vnet.v1.ClientApplicationService.ExchangeSSHKeys:output_type -> teleport.lib.vnet.v1.ExchangeSSHKeysResponse
	43, // 71: teleport.lib.vnet.v1.ClientApplicationService.PerformSessionMFACeremony:output_type -> teleport.lib.vnet.v1.PerformSessionMFACeremonyResponse
	48, // 72: teleport.lib.vnet.v1.ClientApplicationService.ReissueDBCert:output_type -> teleport.lib.vnet.v1.ReissueDBCertResponse
	50, // 73: teleport.lib.vnet.v1.ClientApplicationService.SignForDB:output_type -> teleport.lib.vnet.v1.SignForDBResponse
	52, // 74: teleport.lib.vnet.v1.ClientApplicationService.OnNewDBConnection:output_type -> teleport.lib.vnet.v1.OnNewDBConnectionResponse
	57, // 75: teleport.lib.vnet.v1.ClientApplicationService.ReportConnections:output_type -> teleport.lib.vnet.v1.ReportConnectionsResponse
