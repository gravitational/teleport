...
const (
	...
	ClientApplicationService_ReportConnections_FullMethodName         = "/teleport.lib.vnet.v1.ClientApplicationService/ReportConnections"
)
...
type ClientApplicationServiceClient interface {
	...
	// ReportConnections reports a snapshot of VNet connection activity: the
	// aggregated statistics for all targets connected to through VNet, plus a
	// capped window of individual connection records. The admin process pushes a
	// fresh snapshot periodically while VNet is running. Every snapshot is
	// complete and self-contained, so a lost snapshot does not lose any data.
...
func (c *clientApplicationServiceClient) ReportConnections(ctx context.Context, in *ReportConnectionsRequest, opts ...grpc.CallOption) (*ReportConnectionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportConnectionsResponse)
	err := c.cc.Invoke(ctx, ClientApplicationService_ReportConnections_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedClientApplicationServiceServer) AuthenticateProcess(context.Context, *AuthenticateProcessRequest) (*AuthenticateProcessResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AuthenticateProcess not implemented")
}
func (UnimplementedClientApplicationServiceServer) ReportNetworkStackInfo(context.Context, *ReportNetworkStackInfoRequest) (*ReportNetworkStackInfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReportNetworkStackInfo not implemented")
}
...
func (UnimplementedClientApplicationServiceServer) ResolveFQDN(context.Context, *ResolveFQDNRequest) (*ResolveFQDNResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolveFQDN not implemented")
}
func (UnimplementedClientApplicationServiceServer) ReissueAppCert(context.Context, *ReissueAppCertRequest) (*ReissueAppCertResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReissueAppCert not implemented")
}
func (UnimplementedClientApplicationServiceServer) SignForApp(context.Context, *SignForAppRequest) (*SignForAppResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SignForApp not implemented")
}
func (UnimplementedClientApplicationServiceServer) OnNewAppConnection(context.Context, *OnNewAppConnectionRequest) (*OnNewAppConnectionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method OnNewAppConnection not implemented")
}
func (UnimplementedClientApplicationServiceServer) OnInvalidLocalPort(context.Context, *OnInvalidLocalPortRequest) (*OnInvalidLocalPortResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method OnInvalidLocalPort not implemented")
}
func (UnimplementedClientApplicationServiceServer) GetTargetOSConfiguration(context.Context, *GetTargetOSConfigurationRequest) (*GetTargetOSConfigurationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTargetOSConfiguration not implemented")
}
func (UnimplementedClientApplicationServiceServer) UserTLSCert(context.Context, *UserTLSCertRequest) (*UserTLSCertResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UserTLSCert not implemented")
}
func (UnimplementedClientApplicationServiceServer) SignForUserTLS(context.Context, *SignForUserTLSRequest) (*SignForUserTLSResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SignForUserTLS not implemented")
}
func (UnimplementedClientApplicationServiceServer) SessionSSHConfig(context.Context, *SessionSSHConfigRequest) (*SessionSSHConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SessionSSHConfig not implemented")
}
func (UnimplementedClientApplicationServiceServer) SignForSSHSession(context.Context, *SignForSSHSessionRequest) (*SignForSSHSessionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SignForSSHSession not implemented")
}
...
func (UnimplementedClientApplicationServiceServer) SignForDB(context.Context, *SignForDBRequest) (*SignForDBResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SignForDB not implemented")
}
...
func (UnimplementedClientApplicationServiceServer) ReportConnections(context.Context, *ReportConnectionsRequest) (*ReportConnectionsResponse, error) {
...
func RegisterClientApplicationServiceServer(s grpc.ServiceRegistrar, srv ClientApplicationServiceServer) {
	// If the following call panics, it indicates UnimplementedClientApplicationServiceServer was
...
func _ClientApplicationService_ReportConnections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportConnectionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientApplicationServiceServer).ReportConnections(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClientApplicationService_ReportConnections_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientApplicationServiceServer).ReportConnections(ctx, req.(*ReportConnectionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ClientApplicationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ClientApplicationService_ReportConnections_Handler,
		},
	},
