...
type SSHConfigurationReport struct {
	...
	VnetSshConfigured bool `protobuf:"varint,1,opt,name=vnet_ssh_configured,json=vnetSshConfigured,proto3" json:"vnet_ssh_configured,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *SSHConfigurationReport) GetVnetSshConfigured() bool {
	if x != nil {
		return x.VnetSshConfigured
	}
	return false
}
...
const file_teleport_lib_vnet_diag_v1_diag_proto_rawDesc = "" +
	...
	"\rinterface_app\x18\x04 \x01(\tR\finterfaceApp\"H\n" +
	"\x16SSHConfigurationReport\x12.\n" +
	"\x13vnet_ssh_configured\x18\x01 \x01(\bR\x11vnetSshConfigured*w\n" +
