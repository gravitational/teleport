...
func (UIDiscoverDeployServiceEvent_DeployType) EnumDescriptor() ([]byte, []int) {
	return file_prehog_v1alpha_teleport_proto_rawDescGZIP(), []int{36, 1}
}
...
func (AccessRequestReviewEvent_ProposedState) EnumDescriptor() ([]byte, []int) {
	return file_prehog_v1alpha_teleport_proto_rawDescGZIP(), []int{114, 0}
}
...
type SessionStartEvent struct {
	...
	Beam          *SessionStartBeamMetadata `protobuf:"bytes,9,opt,name=beam,proto3" json:"beam,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SessionStartEvent) GetBeam() *SessionStartBeamMetadata {
	if x != nil {
		return x.Beam
	}
	return nil
...
type SessionStartBeamMetadata struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// anonymized beam ID
	//
...
func (x *SessionStartBeamMetadata) Reset() {
	*x = SessionStartBeamMetadata{}
	mi := &file_prehog_v1alpha_teleport_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SessionStartBeamMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionStartBeamMetadata) ProtoMessage() {}

func (x *SessionStartBeamMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_prehog_v1alpha_teleport_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SessionStartBeamMetadata.ProtoReflect.Descriptor instead.
func (*SessionStartBeamMetadata) Descriptor() ([]byte, []int) {
	return file_prehog_v1alpha_teleport_proto_rawDescGZIP(), []int{12}
}

func (x *SessionStartBeamMetadata) GetBeamId() string {
	if x != nil {
		return x.BeamId
	}
	return ""
...
type BeamsInferenceRequestEvent struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// anonymized beam ID
	//
	// PostHog property: tp.beam.beam_id
	...
	InputTokenCount int64 `protobuf:"varint,4,opt,name=input_token_count,json=inputTokenCount,proto3" json:"input_token_count,omitempty"`
	// number of tokens generated by the provider
	//
	// PostHog property: tp.beam.inference.output_token_count
	OutputTokenCount int64 `protobuf:"varint,5,opt,name=output_token_count,json=outputTokenCount,proto3" json:"output_token_count,omitempty"`
...
func (x *BeamsInferenceRequestEvent) Reset() {
	*x = BeamsInferenceRequestEvent{}
	mi := &file_prehog_v1alpha_teleport_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BeamsInferenceRequestEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BeamsInferenceRequestEvent) ProtoMessage() {}

func (x *BeamsInferenceRequestEvent) ProtoReflect() protoreflect.Message {
	mi := &file_prehog_v1alpha_teleport_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BeamsInferenceRequestEvent.ProtoReflect.Descriptor instead.
func (*BeamsInferenceRequestEvent) Descriptor() ([]byte, []int) {
	return file_prehog_v1alpha_teleport_proto_rawDescGZIP(), []int{15}
}

func (x *BeamsInferenceRequestEvent) GetBeamId() string {
	if x != nil {
		return x.BeamId
	}
	return ""
...
func (x *BeamsInferenceRequestEvent) GetProvider() string {
	if x != nil {
		return x.Provider
	}
	return ""
...
func (x *BeamsInferenceRequestEvent) GetModel() string {
	if x != nil {
		return x.Model
	}
	return ""
...
func (x *BeamsInferenceRequestEvent) GetInputTokenCount() int64 {
	if x != nil {
...
func (x *BeamsInferenceRequestEvent) GetOutputTokenCount() int64 {
	if x != nil {
...
func (x *BeamsInferenceRequestEvent) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
type SubmitEventRequest struct {
	...
	//	*SubmitEventRequest_BeamsInferenceRequest
...
func (x *SubmitEventRequest) GetBeamsInferenceRequest() *BeamsInferenceRequestEvent {
	if x != nil {
		if x, ok := x.Event.(*SubmitEventRequest_BeamsInferenceRequest); ok {
			return x.BeamsInferenceRequest
		}
	}
	return nil
}
...
type SubmitEventRequest_BeamsInferenceRequest struct {
	BeamsInferenceRequest *BeamsInferenceRequestEvent `protobuf:"bytes,127,opt,name=beams_inference_request,json=beamsInferenceRequest,proto3,oneof"`
}
...
func (*SubmitEventRequest_BeamsInferenceRequest) isSubmitEventRequest_Event() {}
...
const file_prehog_v1alpha_teleport_proto_rawDesc = "" +
	...
	"\x06static\x18\x03 \x01(\bR\x06static\"\x8a\x04\n" +
	...
	"\x03mcp\x18\b \x01(\v2'.prehog.v1alpha.SessionStartMCPMetadataR\x03mcp\x12<\n" +
	"\x04beam\x18\t \x01(\v2(.prehog.v1alpha.SessionStartBeamMetadataR\x04beam\"\x94\x01\n" +
	...
	"\x10egress_auth_type\x18\x06 \x01(\tR\x0eegressAuthType\"3\n" +
	"\x18SessionStartBeamMetadata\x12\x17\n" +
	"\abeam_id\x18\x01 \x01(\tR\x06beamId\"t\n" +
	...
	"\x06region\x18\x03 \x01(\tR\x06region\"\xdb\x01\n" +
	"\x1aBeamsInferenceRequestEvent\x12\x17\n" +
	"\abeam_id\x18\x01 \x01(\tR\x06beamId\x12\x1a\n" +
	"\bprovider\x18\x02 \x01(\tR\bprovider\x12\x14\n" +
	"\x05model\x18\x03 \x01(\tR\x05model\x12*\n" +
	"\x11input_token_count\x18\x04 \x01(\x03R\x0finputTokenCount\x12,\n" +
	"\x12output_token_count\x18\x05 \x01(\x03R\x10outputTokenCount\x12\x18\n" +
	"\asuccess\x18\x06 \x01(\bR\asuccess\"\xe7\x02\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xddh\n" +
	...
	"\x0fbeams_destroyed\x18| \x01(\v2#.prehog.v1alpha.BeamsDestroyedEventH\x00R\x0ebeamsDestroyed\x12d\n" +
	"\x17beams_inference_request\x18\x7f \x01(\v2*.prehog.v1alpha.BeamsInferenceRequestEventH\x00R\x15beamsInferenceRequestB\a\n" +
...
var file_prehog_v1alpha_teleport_proto_msgTypes = make([]protoimpl.MessageInfo, 139)
var file_prehog_v1alpha_teleport_proto_goTypes = []any{
	...
	(*BeamsInferenceRequestEvent)(nil),                        // 40: prehog.v1alpha.BeamsInferenceRequestEvent
	(*UserCertificateIssuedEvent)(nil),                        // 41: prehog.v1alpha.UserCertificateIssuedEvent
	(*SPIFFESVIDIssuedEvent)(nil),                             // 42: prehog.v1alpha.SPIFFESVIDIssuedEvent
	(*UIBannerClickEvent)(nil),                                // 43: prehog.v1alpha.UIBannerClickEvent
	(*UIOnboardCompleteGoToDashboardClickEvent)(nil),          // 44: prehog.v1alpha.UIOnboardCompleteGoToDashboardClickEvent
	(*UIOnboardAddFirstResourceClickEvent)(nil),               // 45: prehog.v1alpha.UIOnboardAddFirstResourceClickEvent
	(*UIOnboardAddFirstResourceLaterClickEvent)(nil),          // 46: prehog.v1alpha.UIOnboardAddFirstResourceLaterClickEvent
	(*UIOnboardSetCredentialSubmitEvent)(nil),                 // 47: prehog.v1alpha.UIOnboardSetCredentialSubmitEvent
	(*UIOnboardRegisterChallengeSubmitEvent)(nil),             // 48: prehog.v1alpha.UIOnboardRegisterChallengeSubmitEvent
	(*UIOnboardQuestionnaireSubmitEvent)(nil),                 // 49: prehog.v1alpha.UIOnboardQuestionnaireSubmitEvent
	(*UIRecoveryCodesContinueClickEvent)(nil),                 // 50: prehog.v1alpha.UIRecoveryCodesContinueClickEvent
	(*UIRecoveryCodesCopyClickEvent)(nil),                     // 51: prehog.v1alpha.UIRecoveryCodesCopyClickEvent
	(*UIRecoveryCodesPrintClickEvent)(nil),                    // 52: prehog.v1alpha.UIRecoveryCodesPrintClickEvent
	(*DiscoverMetadata)(nil),                                  // 53: prehog.v1alpha.DiscoverMetadata
	(*DiscoverResourceMetadata)(nil),                          // 54: prehog.v1alpha.DiscoverResourceMetadata
	(*DiscoverStepStatus)(nil),                                // 55: prehog.v1alpha.DiscoverStepStatus
	(*UIDiscoverStartedEvent)(nil),                            // 56: prehog.v1alpha.UIDiscoverStartedEvent
	(*UIDiscoverResourceSelectionEvent)(nil),                  // 57: prehog.v1alpha.UIDiscoverResourceSelectionEvent
	(*UIDiscoverIntegrationAWSOIDCConnectEvent)(nil),          // 58: prehog.v1alpha.UIDiscoverIntegrationAWSOIDCConnectEvent
	(*UIDiscoverDatabaseRDSEnrollEvent)(nil),                  // 59: prehog.v1alpha.UIDiscoverDatabaseRDSEnrollEvent
	(*UIDiscoverKubeEKSEnrollEvent)(nil),                      // 60: prehog.v1alpha.UIDiscoverKubeEKSEnrollEvent
	(*UIDiscoverDeployServiceEvent)(nil),                      // 61: prehog.v1alpha.UIDiscoverDeployServiceEvent
	(*UIDiscoverCreateDiscoveryConfigEvent)(nil),              // 62: prehog.v1alpha.UIDiscoverCreateDiscoveryConfigEvent
	(*UIDiscoverDatabaseRegisterEvent)(nil),                   // 63: prehog.v1alpha.UIDiscoverDatabaseRegisterEvent
	(*UIDiscoverDatabaseConfigureMTLSEvent)(nil),              // 64: prehog.v1alpha.UIDiscoverDatabaseConfigureMTLSEvent
	(*UIDiscoverDesktopActiveDirectoryToolsInstallEvent)(nil), // 65: prehog.v1alpha.UIDiscoverDesktopActiveDirectoryToolsInstallEvent
	(*UIDiscoverDesktopActiveDirectoryConfigureEvent)(nil),    // 66: prehog.v1alpha.UIDiscoverDesktopActiveDirectoryConfigureEvent
	(*UIDiscoverAutoDiscoveredResourcesEvent)(nil),            // 67: prehog.v1alpha.UIDiscoverAutoDiscoveredResourcesEvent
	(*UIDiscoverEC2InstanceSelectionEvent)(nil),               // 68: prehog.v1alpha.UIDiscoverEC2InstanceSelectionEvent
	(*UIDiscoverDeployEICEEvent)(nil),                         // 69: prehog.v1alpha.UIDiscoverDeployEICEEvent
	(*UIDiscoverCreateNodeEvent)(nil),                         // 70: prehog.v1alpha.UIDiscoverCreateNodeEvent
	(*UIDiscoverCreateAppServerEvent)(nil),                    // 71: prehog.v1alpha.UIDiscoverCreateAppServerEvent
	(*UIDiscoverDatabaseConfigureIAMPolicyEvent)(nil),         // 72: prehog.v1alpha.UIDiscoverDatabaseConfigureIAMPolicyEvent
	(*UIDiscoverPrincipalsConfigureEvent)(nil),                // 73: prehog.v1alpha.UIDiscoverPrincipalsConfigureEvent
	(*UIDiscoverTestConnectionEvent)(nil),                     // 74: prehog.v1alpha.UIDiscoverTestConnectionEvent
	(*UIDiscoverCompletedEvent)(nil),                          // 75: prehog.v1alpha.UIDiscoverCompletedEvent
	(*RoleCreateEvent)(nil),                                   // 76: prehog.v1alpha.RoleCreateEvent
	(*BotCreateEvent)(nil),                                    // 77: prehog.v1alpha.BotCreateEvent
	(*BotJoinEvent)(nil),                                      // 78: prehog.v1alpha.BotJoinEvent
	(*UICreateNewRoleClickEvent)(nil),                         // 79: prehog.v1alpha.UICreateNewRoleClickEvent
	(*UICreateNewRoleSaveClickEvent)(nil),                     // 80: prehog.v1alpha.UICreateNewRoleSaveClickEvent
	(*UICreateNewRoleCancelClickEvent)(nil),                   // 81: prehog.v1alpha.UICreateNewRoleCancelClickEvent
	(*UICreateNewRoleViewDocumentationClickEvent)(nil),        // 82: prehog.v1alpha.UICreateNewRoleViewDocumentationClickEvent
	(*UICallToActionClickEvent)(nil),                          // 83: prehog.v1alpha.UICallToActionClickEvent
	(*KubeRequestEvent)(nil),                                  // 84: prehog.v1alpha.KubeRequestEvent
	(*SFTPEvent)(nil),                                         // 85: prehog.v1alpha.SFTPEvent
	(*AgentMetadataEvent)(nil),                                // 86: prehog.v1alpha.AgentMetadataEvent
	(*AssistCompletionEvent)(nil),                             // 87: prehog.v1alpha.AssistCompletionEvent
	(*AssistExecutionEvent)(nil),                              // 88: prehog.v1alpha.AssistExecutionEvent
	(*AssistNewConversationEvent)(nil),                        // 89: prehog.v1alpha.AssistNewConversationEvent
	(*AssistAccessRequestEvent)(nil),                          // 90: prehog.v1alpha.AssistAccessRequestEvent
	(*AssistActionEvent)(nil),                                 // 91: prehog.v1alpha.AssistActionEvent
	(*AccessListMetadata)(nil),                                // 92: prehog.v1alpha.AccessListMetadata
	(*AccessListCreateEvent)(nil),                             // 93: prehog.v1alpha.AccessListCreateEvent
	(*AccessListUpdateEvent)(nil),                             // 94: prehog.v1alpha.AccessListUpdateEvent
	(*AccessListDeleteEvent)(nil),                             // 95: prehog.v1alpha.AccessListDeleteEvent
	(*AccessListMemberCreateEvent)(nil),                       // 96: prehog.v1alpha.AccessListMemberCreateEvent
	(*AccessListMemberUpdateEvent)(nil),                       // 97: prehog.v1alpha.AccessListMemberUpdateEvent
	(*AccessListMemberDeleteEvent)(nil),                       // 98: prehog.v1alpha.AccessListMemberDeleteEvent
	(*AccessListGrantsToUserEvent)(nil),                       // 99: prehog.v1alpha.AccessListGrantsToUserEvent
	(*AccessListReviewCreateEvent)(nil),                       // 100: prehog.v1alpha.AccessListReviewCreateEvent
	(*AccessListReviewDeleteEvent)(nil),                       // 101: prehog.v1alpha.AccessListReviewDeleteEvent
	(*AccessListReviewComplianceEvent)(nil),                   // 102: prehog.v1alpha.AccessListReviewComplianceEvent
	(*IntegrationEnrollMetadata)(nil),                         // 103: prehog.v1alpha.IntegrationEnrollMetadata
	(*UIIntegrationEnrollStartEvent)(nil),                     // 104: prehog.v1alpha.UIIntegrationEnrollStartEvent
	(*UIIntegrationEnrollCompleteEvent)(nil),                  // 105: prehog.v1alpha.UIIntegrationEnrollCompleteEvent
	(*IntegrationEnrollStepStatus)(nil),                       // 106: prehog.v1alpha.IntegrationEnrollStepStatus
	(*UIIntegrationEnrollStepEvent)(nil),                      // 107: prehog.v1alpha.UIIntegrationEnrollStepEvent
	(*UIIntegrationEnrollSectionOpenEvent)(nil),               // 108: prehog.v1alpha.UIIntegrationEnrollSectionOpenEvent
	(*UIIntegrationEnrollFieldCompleteEvent)(nil),             // 109: prehog.v1alpha.UIIntegrationEnrollFieldCompleteEvent
	(*UIIntegrationEnrollCodeCopyEvent)(nil),                  // 110: prehog.v1alpha.UIIntegrationEnrollCodeCopyEvent
	(*UIIntegrationEnrollLinkClickEvent)(nil),                 // 111: prehog.v1alpha.UIIntegrationEnrollLinkClickEvent
	(*EditorChangeEvent)(nil),                                 // 112: prehog.v1alpha.EditorChangeEvent
	(*DeviceAuthenticateEvent)(nil),                           // 113: prehog.v1alpha.DeviceAuthenticateEvent
	(*DeviceEnrollEvent)(nil),                                 // 114: prehog.v1alpha.DeviceEnrollEvent
	(*FeatureRecommendationEvent)(nil),                        // 115: prehog.v1alpha.FeatureRecommendationEvent
	(*LicenseLimitEvent)(nil),                                 // 116: prehog.v1alpha.LicenseLimitEvent
	(*DesktopDirectoryShareEvent)(nil),                        // 117: prehog.v1alpha.DesktopDirectoryShareEvent
	(*DesktopClipboardEvent)(nil),                             // 118: prehog.v1alpha.DesktopClipboardEvent
	(*TAGExecuteQueryEvent)(nil),                              // 119: prehog.v1alpha.TAGExecuteQueryEvent
	(*AccessGraphSecretsScanAuthorizedKeysEvent)(nil),         // 120: prehog.v1alpha.AccessGraphSecretsScanAuthorizedKeysEvent
	(*AccessGraphSecretsScanSSHPrivateKeysEvent)(nil),         // 121: prehog.v1alpha.AccessGraphSecretsScanSSHPrivateKeysEvent
	(*AccessGraphGitlabScanEvent)(nil),                        // 122: prehog.v1alpha.AccessGraphGitlabScanEvent
	(*AccessGraphAWSScanEvent)(nil),                           // 123: prehog.v1alpha.AccessGraphAWSScanEvent
	(*AccessGraphAccessPathChangedEvent)(nil),                 // 124: prehog.v1alpha.AccessGraphAccessPathChangedEvent
	(*UIAccessGraphCrownJewelDiffViewEvent)(nil),              // 125: prehog.v1alpha.UIAccessGraphCrownJewelDiffViewEvent
	(*UIPageViewEvent)(nil),                                   // 126: prehog.v1alpha.UIPageViewEvent
	(*UIUsageReportingAlertCtaClickEvent)(nil),                // 127: prehog.v1alpha.UIUsageReportingAlertCtaClickEvent
	(*AccessGraphCrownJewelCreateEvent)(nil),                  // 128: prehog.v1alpha.AccessGraphCrownJewelCreateEvent
	(*ExternalAuditStorageAuthenticateEvent)(nil),             // 129: prehog.v1alpha.ExternalAuditStorageAuthenticateEvent
	(*SecurityReportGetResultEvent)(nil),                      // 130: prehog.v1alpha.SecurityReportGetResultEvent
	(*AuditQueryRunEvent)(nil),                                // 131: prehog.v1alpha.AuditQueryRunEvent
	(*DiscoveryFetchEvent)(nil),                               // 132: prehog.v1alpha.DiscoveryFetchEvent
	(*OktaAccessListSyncEvent)(nil),                           // 133: prehog.v1alpha.OktaAccessListSyncEvent
	(*DatabaseUserCreatedEvent)(nil),                          // 134: prehog.v1alpha.DatabaseUserCreatedEvent
	(*DatabaseUserPermissionsUpdateEvent)(nil),                // 135: prehog.v1alpha.DatabaseUserPermissionsUpdateEvent
	(*SessionRecordingAccessEvent)(nil),                       // 136: prehog.v1alpha.SessionRecordingAccessEvent
	(*UserTaskStateEvent)(nil),                                // 137: prehog.v1alpha.UserTaskStateEvent
	(*AccessRequestCreateEvent)(nil),                          // 138: prehog.v1alpha.AccessRequestCreateEvent
	(*AccessRequestReviewEvent)(nil),                          // 139: prehog.v1alpha.AccessRequestReviewEvent
	(*SessionSummaryAccessEvent)(nil),                         // 140: prehog.v1alpha.SessionSummaryAccessEvent
	(*SessionSummaryCreateEvent)(nil),                         // 141: prehog.v1alpha.SessionSummaryCreateEvent
	(*SessionSummarySearchEvent)(nil),                         // 142: prehog.v1alpha.SessionSummarySearchEvent
	(*DiscoveryConfigEvent)(nil),                              // 143: prehog.v1alpha.DiscoveryConfigEvent
	(*IdentitySecurityGraphSizeEvent)(nil),                    // 144: prehog.v1alpha.IdentitySecurityGraphSizeEvent
	(*IdentitySecurityAuditLogsIngestedEvent)(nil),            // 145: prehog.v1alpha.IdentitySecurityAuditLogsIngestedEvent
	(*AccessListStepStatus)(nil),                              // 146: prehog.v1alpha.AccessListStepStatus
	(*UIAccessListDefineAccessEvent)(nil),                     // 147: prehog.v1alpha.UIAccessListDefineAccessEvent
	(*UIAccessListDefineIdentitiesEvent)(nil),                 // 148: prehog.v1alpha.UIAccessListDefineIdentitiesEvent
	(*UIAccessListDefineBasicInfoEvent)(nil),                  // 149: prehog.v1alpha.UIAccessListDefineBasicInfoEvent
	(*UIAccessListDefineMembersEvent)(nil),                    // 150: prehog.v1alpha.UIAccessListDefineMembersEvent
	(*UIAccessListDefineOwnersEvent)(nil),                     // 151: prehog.v1alpha.UIAccessListDefineOwnersEvent
	(*UIAccessListStartEvent)(nil),                            // 152: prehog.v1alpha.UIAccessListStartEvent
	(*UIAccessListCustomEvent)(nil),                           // 153: prehog.v1alpha.UIAccessListCustomEvent
	(*UIAccessListCompleteEvent)(nil),                         // 154: prehog.v1alpha.UIAccessListCompleteEvent
	(*UIAccessListIntegrateEvent)(nil),                        // 155: prehog.v1alpha.UIAccessListIntegrateEvent
	(*UIInteractionEvent)(nil),                                // 156: prehog.v1alpha.UIInteractionEvent
	(*SubmitEventRequest)(nil),                                // 157: prehog.v1alpha.SubmitEventRequest
	(*SubmitEventResponse)(nil),                               // 158: prehog.v1alpha.SubmitEventResponse
	(*SubmitEventsRequest)(nil),                               // 159: prehog.v1alpha.SubmitEventsRequest
	(*SubmitEventsResponse)(nil),                              // 160: prehog.v1alpha.SubmitEventsResponse
	(*HelloTeleportRequest)(nil),                              // 161: prehog.v1alpha.HelloTeleportRequest
	(*HelloTeleportResponse)(nil),                             // 162: prehog.v1alpha.HelloTeleportResponse
	nil,                                                       // 163: prehog.v1alpha.UIInteractionEvent.ParamsEntry
...
var file_prehog_v1alpha_teleport_proto_depIdxs = []int32{
	...
	164, // 11: prehog.v1alpha.UserCertificateIssuedEvent.ttl:type_name -> google.protobuf.Duration
	...
	53,  // 15: prehog.v1alpha.UIDiscoverStartedEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	55,  // 16: prehog.v1alpha.UIDiscoverStartedEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 17: prehog.v1alpha.UIDiscoverResourceSelectionEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 18: prehog.v1alpha.UIDiscoverResourceSelectionEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 19: prehog.v1alpha.UIDiscoverResourceSelectionEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 20: prehog.v1alpha.UIDiscoverIntegrationAWSOIDCConnectEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 21: prehog.v1alpha.UIDiscoverIntegrationAWSOIDCConnectEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 22: prehog.v1alpha.UIDiscoverIntegrationAWSOIDCConnectEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 23: prehog.v1alpha.UIDiscoverDatabaseRDSEnrollEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 24: prehog.v1alpha.UIDiscoverDatabaseRDSEnrollEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 25: prehog.v1alpha.UIDiscoverDatabaseRDSEnrollEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 26: prehog.v1alpha.UIDiscoverKubeEKSEnrollEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 27: prehog.v1alpha.UIDiscoverKubeEKSEnrollEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 28: prehog.v1alpha.UIDiscoverKubeEKSEnrollEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 29: prehog.v1alpha.UIDiscoverDeployServiceEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 30: prehog.v1alpha.UIDiscoverDeployServiceEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 31: prehog.v1alpha.UIDiscoverDeployServiceEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	...
	53,  // 34: prehog.v1alpha.UIDiscoverCreateDiscoveryConfigEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 35: prehog.v1alpha.UIDiscoverCreateDiscoveryConfigEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 36: prehog.v1alpha.UIDiscoverCreateDiscoveryConfigEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	...
	53,  // 38: prehog.v1alpha.UIDiscoverDatabaseRegisterEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 39: prehog.v1alpha.UIDiscoverDatabaseRegisterEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 40: prehog.v1alpha.UIDiscoverDatabaseRegisterEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 41: prehog.v1alpha.UIDiscoverDatabaseConfigureMTLSEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 42: prehog.v1alpha.UIDiscoverDatabaseConfigureMTLSEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 43: prehog.v1alpha.UIDiscoverDatabaseConfigureMTLSEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 44: prehog.v1alpha.UIDiscoverDesktopActiveDirectoryToolsInstallEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 45: prehog.v1alpha.UIDiscoverDesktopActiveDirectoryToolsInstallEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 46: prehog.v1alpha.UIDiscoverDesktopActiveDirectoryToolsInstallEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 47: prehog.v1alpha.UIDiscoverDesktopActiveDirectoryConfigureEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 48: prehog.v1alpha.UIDiscoverDesktopActiveDirectoryConfigureEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 49: prehog.v1alpha.UIDiscoverDesktopActiveDirectoryConfigureEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 50: prehog.v1alpha.UIDiscoverAutoDiscoveredResourcesEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 51: prehog.v1alpha.UIDiscoverAutoDiscoveredResourcesEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 52: prehog.v1alpha.UIDiscoverAutoDiscoveredResourcesEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 53: prehog.v1alpha.UIDiscoverEC2InstanceSelectionEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 54: prehog.v1alpha.UIDiscoverEC2InstanceSelectionEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 55: prehog.v1alpha.UIDiscoverEC2InstanceSelectionEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 56: prehog.v1alpha.UIDiscoverDeployEICEEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 57: prehog.v1alpha.UIDiscoverDeployEICEEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 58: prehog.v1alpha.UIDiscoverDeployEICEEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 59: prehog.v1alpha.UIDiscoverCreateNodeEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 60: prehog.v1alpha.UIDiscoverCreateNodeEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 61: prehog.v1alpha.UIDiscoverCreateNodeEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 62: prehog.v1alpha.UIDiscoverCreateAppServerEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 63: prehog.v1alpha.UIDiscoverCreateAppServerEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 64: prehog.v1alpha.UIDiscoverCreateAppServerEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 65: prehog.v1alpha.UIDiscoverDatabaseConfigureIAMPolicyEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 66: prehog.v1alpha.UIDiscoverDatabaseConfigureIAMPolicyEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 67: prehog.v1alpha.UIDiscoverDatabaseConfigureIAMPolicyEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 68: prehog.v1alpha.UIDiscoverPrincipalsConfigureEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 69: prehog.v1alpha.UIDiscoverPrincipalsConfigureEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 70: prehog.v1alpha.UIDiscoverPrincipalsConfigureEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 71: prehog.v1alpha.UIDiscoverTestConnectionEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 72: prehog.v1alpha.UIDiscoverTestConnectionEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 73: prehog.v1alpha.UIDiscoverTestConnectionEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	53,  // 74: prehog.v1alpha.UIDiscoverCompletedEvent.metadata:type_name -> prehog.v1alpha.DiscoverMetadata
	54,  // 75: prehog.v1alpha.UIDiscoverCompletedEvent.resource:type_name -> prehog.v1alpha.DiscoverResourceMetadata
	55,  // 76: prehog.v1alpha.UIDiscoverCompletedEvent.status:type_name -> prehog.v1alpha.DiscoverStepStatus
	...
	92,  // 81: prehog.v1alpha.AccessListCreateEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	92,  // 82: prehog.v1alpha.AccessListUpdateEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	92,  // 83: prehog.v1alpha.AccessListDeleteEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	92,  // 84: prehog.v1alpha.AccessListMemberCreateEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	92,  // 85: prehog.v1alpha.AccessListMemberUpdateEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	92,  // 86: prehog.v1alpha.AccessListMemberDeleteEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	92,  // 87: prehog.v1alpha.AccessListReviewCreateEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	92,  // 88: prehog.v1alpha.AccessListReviewDeleteEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	7,   // 89: prehog.v1alpha.IntegrationEnrollMetadata.kind:type_name -> prehog.v1alpha.IntegrationEnrollKind
	103, // 90: prehog.v1alpha.UIIntegrationEnrollStartEvent.metadata:type_name -> prehog.v1alpha.IntegrationEnrollMetadata
	103, // 91: prehog.v1alpha.UIIntegrationEnrollCompleteEvent.metadata:type_name -> prehog.v1alpha.IntegrationEnrollMetadata
	9,   // 92: prehog.v1alpha.IntegrationEnrollStepStatus.code:type_name -> prehog.v1alpha.IntegrationEnrollStatusCode
	103, // 93: prehog.v1alpha.UIIntegrationEnrollStepEvent.metadata:type_name -> prehog.v1alpha.IntegrationEnrollMetadata
	8,   // 94: prehog.v1alpha.UIIntegrationEnrollStepEvent.step:type_name -> prehog.v1alpha.IntegrationEnrollStep
	106, // 95: prehog.v1alpha.UIIntegrationEnrollStepEvent.status:type_name -> prehog.v1alpha.IntegrationEnrollStepStatus
	103, // 96: prehog.v1alpha.UIIntegrationEnrollSectionOpenEvent.metadata:type_name -> prehog.v1alpha.IntegrationEnrollMetadata
	...
	103, // 99: prehog.v1alpha.UIIntegrationEnrollFieldCompleteEvent.metadata:type_name -> prehog.v1alpha.IntegrationEnrollMetadata
	...
	103, // 102: prehog.v1alpha.UIIntegrationEnrollCodeCopyEvent.metadata:type_name -> prehog.v1alpha.IntegrationEnrollMetadata
	...
	103, // 105: prehog.v1alpha.UIIntegrationEnrollLinkClickEvent.metadata:type_name -> prehog.v1alpha.IntegrationEnrollMetadata
	...
	92,  // 118: prehog.v1alpha.UIAccessListDefineAccessEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	146, // 119: prehog.v1alpha.UIAccessListDefineAccessEvent.status:type_name -> prehog.v1alpha.AccessListStepStatus
	92,  // 120: prehog.v1alpha.UIAccessListDefineIdentitiesEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	146, // 121: prehog.v1alpha.UIAccessListDefineIdentitiesEvent.status:type_name -> prehog.v1alpha.AccessListStepStatus
	92,  // 122: prehog.v1alpha.UIAccessListDefineBasicInfoEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	146, // 123: prehog.v1alpha.UIAccessListDefineBasicInfoEvent.status:type_name -> prehog.v1alpha.AccessListStepStatus
	92,  // 124: prehog.v1alpha.UIAccessListDefineMembersEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	146, // 125: prehog.v1alpha.UIAccessListDefineMembersEvent.status:type_name -> prehog.v1alpha.AccessListStepStatus
	92,  // 126: prehog.v1alpha.UIAccessListDefineOwnersEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	146, // 127: prehog.v1alpha.UIAccessListDefineOwnersEvent.status:type_name -> prehog.v1alpha.AccessListStepStatus
	92,  // 128: prehog.v1alpha.UIAccessListStartEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	146, // 129: prehog.v1alpha.UIAccessListStartEvent.status:type_name -> prehog.v1alpha.AccessListStepStatus
	92,  // 130: prehog.v1alpha.UIAccessListCustomEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	146, // 131: prehog.v1alpha.UIAccessListCustomEvent.status:type_name -> prehog.v1alpha.AccessListStepStatus
	92,  // 132: prehog.v1alpha.UIAccessListCompleteEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	146, // 133: prehog.v1alpha.UIAccessListCompleteEvent.status:type_name -> prehog.v1alpha.AccessListStepStatus
	92,  // 134: prehog.v1alpha.UIAccessListIntegrateEvent.metadata:type_name -> prehog.v1alpha.AccessListMetadata
	20,  // 135: prehog.v1alpha.UIAccessListIntegrateEvent.integrate:type_name -> prehog.v1alpha.AccessListIntegrate
	163, // 136: prehog.v1alpha.UIInteractionEvent.params:type_name -> prehog.v1alpha.UIInteractionEvent.ParamsEntry
	165, // 137: prehog.v1alpha.SubmitEventRequest.timestamp:type_name -> google.protobuf.Timestamp
	...
	43,  // 142: prehog.v1alpha.SubmitEventRequest.ui_banner_click:type_name -> prehog.v1alpha.UIBannerClickEvent
	44,  // 143: prehog.v1alpha.SubmitEventRequest.ui_onboard_complete_go_to_dashboard_click:type_name -> prehog.v1alpha.UIOnboardCompleteGoToDashboardClickEvent
	45,  // 144: prehog.v1alpha.SubmitEventRequest.ui_onboard_add_first_resource_click:type_name -> prehog.v1alpha.UIOnboardAddFirstResourceClickEvent
	46,  // 145: prehog.v1alpha.SubmitEventRequest.ui_onboard_add_first_resource_later_click:type_name -> prehog.v1alpha.UIOnboardAddFirstResourceLaterClickEvent
	47,  // 146: prehog.v1alpha.SubmitEventRequest.ui_onboard_set_credential_submit:type_name -> prehog.v1alpha.UIOnboardSetCredentialSubmitEvent
	48,  // 147: prehog.v1alpha.SubmitEventRequest.ui_onboard_register_challenge_submit:type_name -> prehog.v1alpha.UIOnboardRegisterChallengeSubmitEvent
	50,  // 148: prehog.v1alpha.SubmitEventRequest.ui_recovery_codes_continue_click:type_name -> prehog.v1alpha.UIRecoveryCodesContinueClickEvent
	51,  // 149: prehog.v1alpha.SubmitEventRequest.ui_recovery_codes_copy_click:type_name -> prehog.v1alpha.UIRecoveryCodesCopyClickEvent
	52,  // 150: prehog.v1alpha.SubmitEventRequest.ui_recovery_codes_print_click:type_name -> prehog.v1alpha.UIRecoveryCodesPrintClickEvent
	56,  // 151: prehog.v1alpha.SubmitEventRequest.ui_discover_started_event:type_name -> prehog.v1alpha.UIDiscoverStartedEvent
	57,  // 152: prehog.v1alpha.SubmitEventRequest.ui_discover_resource_selection_event:type_name -> prehog.v1alpha.UIDiscoverResourceSelectionEvent
	41,  // 153: prehog.v1alpha.SubmitEventRequest.user_certificate_issued_event:type_name -> prehog.v1alpha.UserCertificateIssuedEvent
	31,  // 154: prehog.v1alpha.SubmitEventRequest.session_start_v2:type_name -> prehog.v1alpha.SessionStartEvent
	61,  // 155: prehog.v1alpha.SubmitEventRequest.ui_discover_deploy_service_event:type_name -> prehog.v1alpha.UIDiscoverDeployServiceEvent
	63,  // 156: prehog.v1alpha.SubmitEventRequest.ui_discover_database_register_event:type_name -> prehog.v1alpha.UIDiscoverDatabaseRegisterEvent
	64,  // 157: prehog.v1alpha.SubmitEventRequest.ui_discover_database_configure_mtls_event:type_name -> prehog.v1alpha.UIDiscoverDatabaseConfigureMTLSEvent
	65,  // 158: prehog.v1alpha.SubmitEventRequest.ui_discover_desktop_active_directory_tools_install_event:type_name -> prehog.v1alpha.UIDiscoverDesktopActiveDirectoryToolsInstallEvent
	66,  // 159: prehog.v1alpha.SubmitEventRequest.ui_discover_desktop_active_directory_configure_event:type_name -> prehog.v1alpha.UIDiscoverDesktopActiveDirectoryConfigureEvent
	67,  // 160: prehog.v1alpha.SubmitEventRequest.ui_discover_auto_discovered_resources_event:type_name -> prehog.v1alpha.UIDiscoverAutoDiscoveredResourcesEvent
	72,  // 161: prehog.v1alpha.SubmitEventRequest.ui_discover_database_configure_iam_policy_event:type_name -> prehog.v1alpha.UIDiscoverDatabaseConfigureIAMPolicyEvent
	73,  // 162: prehog.v1alpha.SubmitEventRequest.ui_discover_principals_configure_event:type_name -> prehog.v1alpha.UIDiscoverPrincipalsConfigureEvent
	74,  // 163: prehog.v1alpha.SubmitEventRequest.ui_discover_test_connection_event:type_name -> prehog.v1alpha.UIDiscoverTestConnectionEvent
	75,  // 164: prehog.v1alpha.SubmitEventRequest.ui_discover_completed_event:type_name -> prehog.v1alpha.UIDiscoverCompletedEvent
	76,  // 165: prehog.v1alpha.SubmitEventRequest.role_create:type_name -> prehog.v1alpha.RoleCreateEvent
	79,  // 166: prehog.v1alpha.SubmitEventRequest.ui_create_new_role_click:type_name -> prehog.v1alpha.UICreateNewRoleClickEvent
	80,  // 167: prehog.v1alpha.SubmitEventRequest.ui_create_new_role_save_click:type_name -> prehog.v1alpha.UICreateNewRoleSaveClickEvent
	81,  // 168: prehog.v1alpha.SubmitEventRequest.ui_create_new_role_cancel_click:type_name -> prehog.v1alpha.UICreateNewRoleCancelClickEvent
	82,  // 169: prehog.v1alpha.SubmitEventRequest.ui_create_new_role_view_documentation_click:type_name -> prehog.v1alpha.UICreateNewRoleViewDocumentationClickEvent
	84,  // 170: prehog.v1alpha.SubmitEventRequest.kube_request:type_name -> prehog.v1alpha.KubeRequestEvent
	85,  // 171: prehog.v1alpha.SubmitEventRequest.sftp:type_name -> prehog.v1alpha.SFTPEvent
	86,  // 172: prehog.v1alpha.SubmitEventRequest.agent_metadata_event:type_name -> prehog.v1alpha.AgentMetadataEvent
	30,  // 173: prehog.v1alpha.SubmitEventRequest.resource_heartbeat:type_name -> prehog.v1alpha.ResourceHeartbeatEvent
	58,  // 174: prehog.v1alpha.SubmitEventRequest.ui_discover_integration_aws_oidc_connect_event:type_name -> prehog.v1alpha.UIDiscoverIntegrationAWSOIDCConnectEvent
	59,  // 175: prehog.v1alpha.SubmitEventRequest.ui_discover_database_rds_enroll_event:type_name -> prehog.v1alpha.UIDiscoverDatabaseRDSEnrollEvent
	83,  // 176: prehog.v1alpha.SubmitEventRequest.ui_call_to_action_click_event:type_name -> prehog.v1alpha.UICallToActionClickEvent
	87,  // 177: prehog.v1alpha.SubmitEventRequest.assist_completion:type_name -> prehog.v1alpha.AssistCompletionEvent
	104, // 178: prehog.v1alpha.SubmitEventRequest.ui_integration_enroll_start_event:type_name -> prehog.v1alpha.UIIntegrationEnrollStartEvent
	105, // 179: prehog.v1alpha.SubmitEventRequest.ui_integration_enroll_complete_event:type_name -> prehog.v1alpha.UIIntegrationEnrollCompleteEvent
	112, // 180: prehog.v1alpha.SubmitEventRequest.editor_change_event:type_name -> prehog.v1alpha.EditorChangeEvent
	77,  // 181: prehog.v1alpha.SubmitEventRequest.bot_create:type_name -> prehog.v1alpha.BotCreateEvent
	49,  // 182: prehog.v1alpha.SubmitEventRequest.ui_onboard_questionnaire_submit:type_name -> prehog.v1alpha.UIOnboardQuestionnaireSubmitEvent
	78,  // 183: prehog.v1alpha.SubmitEventRequest.bot_join:type_name -> prehog.v1alpha.BotJoinEvent
	88,  // 184: prehog.v1alpha.SubmitEventRequest.assist_execution:type_name -> prehog.v1alpha.AssistExecutionEvent
	89,  // 185: prehog.v1alpha.SubmitEventRequest.assist_new_conversation:type_name -> prehog.v1alpha.AssistNewConversationEvent
	113, // 186: prehog.v1alpha.SubmitEventRequest.device_authenticate_event:type_name -> prehog.v1alpha.DeviceAuthenticateEvent
	115, // 187: prehog.v1alpha.SubmitEventRequest.feature_recommendation_event:type_name -> prehog.v1alpha.FeatureRecommendationEvent
	90,  // 188: prehog.v1alpha.SubmitEventRequest.assist_access_request:type_name -> prehog.v1alpha.AssistAccessRequestEvent
	91,  // 189: prehog.v1alpha.SubmitEventRequest.assist_action:type_name -> prehog.v1alpha.AssistActionEvent
	114, // 190: prehog.v1alpha.SubmitEventRequest.device_enroll_event:type_name -> prehog.v1alpha.DeviceEnrollEvent
	116, // 191: prehog.v1alpha.SubmitEventRequest.license_limit_event:type_name -> prehog.v1alpha.LicenseLimitEvent
	93,  // 192: prehog.v1alpha.SubmitEventRequest.access_list_create:type_name -> prehog.v1alpha.AccessListCreateEvent
	94,  // 193: prehog.v1alpha.SubmitEventRequest.access_list_update:type_name -> prehog.v1alpha.AccessListUpdateEvent
	95,  // 194: prehog.v1alpha.SubmitEventRequest.access_list_delete:type_name -> prehog.v1alpha.AccessListDeleteEvent
	96,  // 195: prehog.v1alpha.SubmitEventRequest.access_list_member_create:type_name -> prehog.v1alpha.AccessListMemberCreateEvent
	97,  // 196: prehog.v1alpha.SubmitEventRequest.access_list_member_update:type_name -> prehog.v1alpha.AccessListMemberUpdateEvent
	98,  // 197: prehog.v1alpha.SubmitEventRequest.access_list_member_delete:type_name -> prehog.v1alpha.AccessListMemberDeleteEvent
	99,  // 198: prehog.v1alpha.SubmitEventRequest.access_list_grants_to_user:type_name -> prehog.v1alpha.AccessListGrantsToUserEvent
	68,  // 199: prehog.v1alpha.SubmitEventRequest.ui_discover_ec2_instance_selection:type_name -> prehog.v1alpha.UIDiscoverEC2InstanceSelectionEvent
	69,  // 200: prehog.v1alpha.SubmitEventRequest.ui_discover_deploy_eice:type_name -> prehog.v1alpha.UIDiscoverDeployEICEEvent
	70,  // 201: prehog.v1alpha.SubmitEventRequest.ui_discover_create_node:type_name -> prehog.v1alpha.UIDiscoverCreateNodeEvent
	117, // 202: prehog.v1alpha.SubmitEventRequest.desktop_directory_share:type_name -> prehog.v1alpha.DesktopDirectoryShareEvent
	118, // 203: prehog.v1alpha.SubmitEventRequest.desktop_clipboard_transfer:type_name -> prehog.v1alpha.DesktopClipboardEvent
	119, // 204: prehog.v1alpha.SubmitEventRequest.tag_execute_query:type_name -> prehog.v1alpha.TAGExecuteQueryEvent
	129, // 205: prehog.v1alpha.SubmitEventRequest.external_audit_storage_authenticate:type_name -> prehog.v1alpha.ExternalAuditStorageAuthenticateEvent
	130, // 206: prehog.v1alpha.SubmitEventRequest.security_report_get_result:type_name -> prehog.v1alpha.SecurityReportGetResultEvent
	131, // 207: prehog.v1alpha.SubmitEventRequest.audit_query_run:type_name -> prehog.v1alpha.AuditQueryRunEvent
	132, // 208: prehog.v1alpha.SubmitEventRequest.discovery_fetch_event:type_name -> prehog.v1alpha.DiscoveryFetchEvent
	100, // 209: prehog.v1alpha.SubmitEventRequest.access_list_review_create:type_name -> prehog.v1alpha.AccessListReviewCreateEvent
	101, // 210: prehog.v1alpha.SubmitEventRequest.access_list_review_delete:type_name -> prehog.v1alpha.AccessListReviewDeleteEvent
	102, // 211: prehog.v1alpha.SubmitEventRequest.access_list_review_compliance:type_name -> prehog.v1alpha.AccessListReviewComplianceEvent
	26,  // 212: prehog.v1alpha.SubmitEventRequest.mfa_authentication_event:type_name -> prehog.v1alpha.MFAAuthenticationEvent
	42,  // 213: prehog.v1alpha.SubmitEventRequest.spiffe_svid_issued:type_name -> prehog.v1alpha.SPIFFESVIDIssuedEvent
	133, // 214: prehog.v1alpha.SubmitEventRequest.okta_access_list_sync:type_name -> prehog.v1alpha.OktaAccessListSyncEvent
	134, // 215: prehog.v1alpha.SubmitEventRequest.database_user_created:type_name -> prehog.v1alpha.DatabaseUserCreatedEvent
	135, // 216: prehog.v1alpha.SubmitEventRequest.database_user_permissions_updated:type_name -> prehog.v1alpha.DatabaseUserPermissionsUpdateEvent
	62,  // 217: prehog.v1alpha.SubmitEventRequest.ui_discover_create_discovery_config:type_name -> prehog.v1alpha.UIDiscoverCreateDiscoveryConfigEvent
	60,  // 218: prehog.v1alpha.SubmitEventRequest.ui_discover_kube_eks_enroll_event:type_name -> prehog.v1alpha.UIDiscoverKubeEKSEnrollEvent
	71,  // 219: prehog.v1alpha.SubmitEventRequest.ui_discover_create_app_server_event:type_name -> prehog.v1alpha.UIDiscoverCreateAppServerEvent
	122, // 220: prehog.v1alpha.SubmitEventRequest.access_graph_gitlab_scan:type_name -> prehog.v1alpha.AccessGraphGitlabScanEvent
	120, // 221: prehog.v1alpha.SubmitEventRequest.access_graph_secrets_scan_authorized_keys:type_name -> prehog.v1alpha.AccessGraphSecretsScanAuthorizedKeysEvent
	121, // 222: prehog.v1alpha.SubmitEventRequest.access_graph_secrets_scan_ssh_private_keys:type_name -> prehog.v1alpha.AccessGraphSecretsScanSSHPrivateKeysEvent
	123, // 223: prehog.v1alpha.SubmitEventRequest.access_graph_aws_scan:type_name -> prehog.v1alpha.AccessGraphAWSScanEvent
	124, // 224: prehog.v1alpha.SubmitEventRequest.access_graph_access_path_changed:type_name -> prehog.v1alpha.AccessGraphAccessPathChangedEvent
	128, // 225: prehog.v1alpha.SubmitEventRequest.access_graph_crown_jewel_create:type_name -> prehog.v1alpha.AccessGraphCrownJewelCreateEvent
	125, // 226: prehog.v1alpha.SubmitEventRequest.ui_access_graph_crown_jewel_diff_view:type_name -> prehog.v1alpha.UIAccessGraphCrownJewelDiffViewEvent
	136, // 227: prehog.v1alpha.SubmitEventRequest.session_recording_access:type_name -> prehog.v1alpha.SessionRecordingAccessEvent
	137, // 228: prehog.v1alpha.SubmitEventRequest.user_task_state:type_name -> prehog.v1alpha.UserTaskStateEvent
	107, // 229: prehog.v1alpha.SubmitEventRequest.ui_integration_enroll_step_event:type_name -> prehog.v1alpha.UIIntegrationEnrollStepEvent
	138, // 230: prehog.v1alpha.SubmitEventRequest.access_request_create:type_name -> prehog.v1alpha.AccessRequestCreateEvent
	139, // 231: prehog.v1alpha.SubmitEventRequest.access_request_review:type_name -> prehog.v1alpha.AccessRequestReviewEvent
	108, // 232: prehog.v1alpha.SubmitEventRequest.ui_integration_enroll_section_open_event:type_name -> prehog.v1alpha.UIIntegrationEnrollSectionOpenEvent
	109, // 233: prehog.v1alpha.SubmitEventRequest.ui_integration_enroll_field_complete_event:type_name -> prehog.v1alpha.UIIntegrationEnrollFieldCompleteEvent
	110, // 234: prehog.v1alpha.SubmitEventRequest.ui_integration_enroll_code_copy_event:type_name -> prehog.v1alpha.UIIntegrationEnrollCodeCopyEvent
	111, // 235: prehog.v1alpha.SubmitEventRequest.ui_integration_enroll_link_click_event:type_name -> prehog.v1alpha.UIIntegrationEnrollLinkClickEvent
	141, // 236: prehog.v1alpha.SubmitEventRequest.session_summary_create_event:type_name -> prehog.v1alpha.SessionSummaryCreateEvent
	140, // 237: prehog.v1alpha.SubmitEventRequest.session_summary_access_event:type_name -> prehog.v1alpha.SessionSummaryAccessEvent
	143, // 238: prehog.v1alpha.SubmitEventRequest.discovery_config:type_name -> prehog.v1alpha.DiscoveryConfigEvent
	144, // 239: prehog.v1alpha.SubmitEventRequest.identity_security_graph_size_event:type_name -> prehog.v1alpha.IdentitySecurityGraphSizeEvent
	145, // 240: prehog.v1alpha.SubmitEventRequest.identity_security_audit_logs_ingested_event:type_name -> prehog.v1alpha.IdentitySecurityAuditLogsIngestedEvent
	147, // 241: prehog.v1alpha.SubmitEventRequest.ui_access_list_define_access_event:type_name -> prehog.v1alpha.UIAccessListDefineAccessEvent
	148, // 242: prehog.v1alpha.SubmitEventRequest.ui_access_list_define_identities_event:type_name -> prehog.v1alpha.UIAccessListDefineIdentitiesEvent
	149, // 243: prehog.v1alpha.SubmitEventRequest.ui_access_list_define_basic_info_event:type_name -> prehog.v1alpha.UIAccessListDefineBasicInfoEvent
	150, // 244: prehog.v1alpha.SubmitEventRequest.ui_access_list_define_members_event:type_name -> prehog.v1alpha.UIAccessListDefineMembersEvent
	151, // 245: prehog.v1alpha.SubmitEventRequest.ui_access_list_define_owners_event:type_name -> prehog.v1alpha.UIAccessListDefineOwnersEvent
	152, // 246: prehog.v1alpha.SubmitEventRequest.ui_access_list_start_event:type_name -> prehog.v1alpha.UIAccessListStartEvent
	154, // 247: prehog.v1alpha.SubmitEventRequest.ui_access_list_complete_event:type_name -> prehog.v1alpha.UIAccessListCompleteEvent
	155, // 248: prehog.v1alpha.SubmitEventRequest.ui_access_list_integrate_event:type_name -> prehog.v1alpha.UIAccessListIntegrateEvent
	153, // 249: prehog.v1alpha.SubmitEventRequest.ui_access_list_custom_event:type_name -> prehog.v1alpha.UIAccessListCustomEvent
	126, // 250: prehog.v1alpha.SubmitEventRequest.ui_page_view:type_name -> prehog.v1alpha.UIPageViewEvent
	127, // 251: prehog.v1alpha.SubmitEventRequest.ui_usage_reporting_alert_cta_click:type_name -> prehog.v1alpha.UIUsageReportingAlertCtaClickEvent
	142, // 252: prehog.v1alpha.SubmitEventRequest.session_summary_search_event:type_name -> prehog.v1alpha.SessionSummarySearchEvent
	156, // 253: prehog.v1alpha.SubmitEventRequest.ui_interaction:type_name -> prehog.v1alpha.UIInteractionEvent
	...
	40,  // 256: prehog.v1alpha.SubmitEventRequest.beams_inference_request:type_name -> prehog.v1alpha.BeamsInferenceRequestEvent
	157, // 257: prehog.v1alpha.SubmitEventsRequest.events:type_name -> prehog.v1alpha.SubmitEventRequest
	157, // 258: prehog.v1alpha.TeleportReportingService.SubmitEvent:input_type -> prehog.v1alpha.SubmitEventRequest
	159, // 259: prehog.v1alpha.TeleportReportingService.SubmitEvents:input_type -> prehog.v1alpha.SubmitEventsRequest
	161, // 260: prehog.v1alpha.TeleportReportingService.HelloTeleport:input_type -> prehog.v1alpha.HelloTeleportRequest
	158, // 261: prehog.v1alpha.TeleportReportingService.SubmitEvent:output_type -> prehog.v1alpha.SubmitEventResponse
	160, // 262: prehog.v1alpha.TeleportReportingService.SubmitEvents:output_type -> prehog.v1alpha.SubmitEventsResponse
	162, // 263: prehog.v1alpha.TeleportReportingService.HelloTeleport:output_type -> prehog.v1alpha.HelloTeleportResponse
	261, // [261:264] is the sub-list for method output_type
	258, // [258:261] is the sub-list for method input_type
...
func file_prehog_v1alpha_teleport_proto_init() {
	...
	file_prehog_v1alpha_teleport_proto_msgTypes[132].OneofWrappers = []any{
		...
		(*SubmitEventRequest_BeamsInferenceRequest)(nil),
	}
	type x struct{}
