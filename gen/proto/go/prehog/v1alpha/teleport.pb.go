...
const file_prehog_v1alpha_teleport_proto_rawDesc = "" +
	...
	"\x06static\x18\x03 \x01(\bR\x06static\"\x9b\x02\n" +
	...
	"\tuser_kind\x18\x05 \x01(\x0e2\x18.prehog.v1alpha.UserKindR\buserKind\"u\n" +
	"\x1cSessionStartDatabaseMetadata\x12\x17\n" +
	"\adb_type\x18\x01 \x01(\tR\x06dbType\x12\x1f\n" +
	"\vdb_protocol\x18\x02 \x01(\tR\n" +
	"dbProtocol\x12\x1b\n" +
	"\tdb_origin\x18\x03 \x01(\tR\bdbOrigin\"\xc1\x01\n" +
	...
	"\x03nla\x18\x05 \x01(\bR\x03nla\"\xe7\x02\n" +
	...
	"\tuser_name\x18\x01 \x01(\tR\buserName\x12>\n" +
	"\bmetadata\x18\x02 \x01(\v2\".prehog.v1alpha.AccessListMetadataR\bmetadata\"z\n" +
	...
	"\tuser_name\x18\x01 \x01(\tR\buserName\x12>\n" +
	"\bmetadata\x18\x02 \x01(\v2\".prehog.v1alpha.AccessListMetadataR\bmetadata\"\x9c\x01\n" +
	"\x1bAccessListGrantsToUserEvent\x12\x1b\n" +
	"\tuser_name\x18\x01 \x01(\tR\buserName\x12.\n" +
	"\x13count_roles_granted\x18\x02 \x01(\x05R\x11countRolesGranted\x120\n" +
	"\x14count_traits_granted\x18\x03 \x01(\x05R\x12countTraitsGranted\"\xaf\x03\n" +
	...
	"\bmetadata\x18\x01 \x01(\v2).prehog.v1alpha.IntegrationEnrollMetadataR\bmetadata\"l\n" +
	...
	"\tuser_name\x18\x01 \x01(\tR\buserName\"\xf9P\n" +
	...
	"\x0fuser_task_state\x18^ \x01(\v2\".prehog.v1alpha.UserTaskStateEventH\x00R\ruserTaskState\x12c\n" +
	...
	"\"INTEGRATION_ENROLL_KIND_SERVICENOW\x10\x19*\x88\x01\n" +
