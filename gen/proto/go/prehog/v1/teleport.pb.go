...
type UserActivityRecord struct {
	...
	LinuxDesktopSessions uint64 `protobuf:"varint,26,opt,name=linux_desktop_sessions,json=linuxDesktopSessions,proto3" json:"linux_desktop_sessions,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *UserActivityRecord) GetSessionSummariesAccessed() []*SessionSummariesAccessedRecord {
	if x != nil {
...
// Counts all session summaries that a user accessed during the time window.
type SessionSummariesAccessedRecord struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	// count is the number of accessed session summaries.
	Count         uint64 `protobuf:"varint,4,opt,name=count,proto3" json:"count,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SessionSummariesAccessedRecord) Reset() {
	*x = SessionSummariesAccessedRecord{}
	mi := &file_prehog_v1_teleport_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SessionSummariesAccessedRecord) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionSummariesAccessedRecord) ProtoMessage() {}

func (x *SessionSummariesAccessedRecord) ProtoReflect() protoreflect.Message {
	mi := &file_prehog_v1_teleport_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SessionSummariesAccessedRecord.ProtoReflect.Descriptor instead.
func (*SessionSummariesAccessedRecord) Descriptor() ([]byte, []int) {
	return file_prehog_v1_teleport_proto_rawDescGZIP(), []int{4}
}

func (x *SessionSummariesAccessedRecord) GetSessionType() string {
	if x != nil {
...
func (x *SessionSummariesAccessedRecord) GetResourceName() string {
	if x != nil {
...
func (x *SessionSummariesAccessedRecord) GetCount() uint64 {
	if x != nil {
		return x.Count
	}
	return 0
...
type IdentitySecuritySummariesGeneratedReport struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// randomly generated UUID for this specific report, 16 bytes (in string order)
	//
	// PostHog property: tp.report_uuid (in 8-4-4-4-12 string form)
	...
	// PostHog timestamp (not a property, the ingest time is tp.report_time instead)
	StartTime *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	// one set of counters for each session summary generated by session type, and resource name
	//
	// PostHog property: tp.records (encoded as a map keyed by
	// (anonymized resource name, session type), not as a list)
	Records       []*SessionSummariesGeneratedRecord `protobuf:"bytes,5,rep,name=records,proto3" json:"records,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *IdentitySecuritySummariesGeneratedReport) Reset() {
	*x = IdentitySecuritySummariesGeneratedReport{}
	mi := &file_prehog_v1_teleport_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *IdentitySecuritySummariesGeneratedReport) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IdentitySecuritySummariesGeneratedReport) ProtoMessage() {}

func (x *IdentitySecuritySummariesGeneratedReport) ProtoReflect() protoreflect.Message {
	mi := &file_prehog_v1_teleport_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IdentitySecuritySummariesGeneratedReport.ProtoReflect.Descriptor instead.
func (*IdentitySecuritySummariesGeneratedReport) Descriptor() ([]byte, []int) {
	return file_prehog_v1_teleport_proto_rawDescGZIP(), []int{8}
}

func (x *IdentitySecuritySummariesGeneratedReport) GetReportUuid() []byte {
	if x != nil {
		return x.ReportUuid
	}
	return nil
...
func (x *IdentitySecuritySummariesGeneratedReport) GetClusterName() []byte {
	if x != nil {
		return x.ClusterName
	}
	return nil
...
func (x *IdentitySecuritySummariesGeneratedReport) GetReporterHostid() []byte {
	if x != nil {
		return x.ReporterHostid
	}
	return nil
...
func (x *IdentitySecuritySummariesGeneratedReport) GetStartTime() *timestamppb.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *IdentitySecuritySummariesGeneratedReport) GetRecords() []*SessionSummariesGeneratedRecord {
	if x != nil {
		return x.Records
	}
	return nil
...
// Tracks session summaries generated by AI providers, recording token usage
// and metadata for each session type, and resource combination.
type SessionSummariesGeneratedRecord struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// session_type is type of the session, should be
	// "ssh"/"k8s"/"db"/"desktop" (matching the values for
	// api/types.SessionKind).
...
func (x *SessionSummariesGeneratedRecord) Reset() {
	*x = SessionSummariesGeneratedRecord{}
	mi := &file_prehog_v1_teleport_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SessionSummariesGeneratedRecord) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionSummariesGeneratedRecord) ProtoMessage() {}

func (x *SessionSummariesGeneratedRecord) ProtoReflect() protoreflect.Message {
	mi := &file_prehog_v1_teleport_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SessionSummariesGeneratedRecord.ProtoReflect.Descriptor instead.
func (*SessionSummariesGeneratedRecord) Descriptor() ([]byte, []int) {
	return file_prehog_v1_teleport_proto_rawDescGZIP(), []int{9}
}

func (x *SessionSummariesGeneratedRecord) GetSessionType() string {
	if x != nil {
		return x.SessionType
	}
	return ""
...
func (x *SessionSummariesGeneratedRecord) GetResourceName() string {
	if x != nil {
		return x.ResourceName
	}
	return ""
...
func (x *SessionSummariesGeneratedRecord) GetTotalInputTokens() uint64 {
	if x != nil {
...
func (x *SubmitUsageReportsRequest) GetIdentitySecuritySummariesReport() []*IdentitySecuritySummariesGeneratedReport {
	if x != nil {
		return x.IdentitySecuritySummariesReport
	}
	return nil
}
...
const file_prehog_v1_teleport_proto_rawDesc = "" +
	...
	"\arecords\x18\x05 \x03(\v2\x1d.prehog.v1.UserActivityRecordR\arecords\"\xcf\t\n" +
	...
	"\x1asession_summaries_accessed\x18\x19 \x03(\v2).prehog.v1.SessionSummariesAccessedRecordR\x18sessionSummariesAccessed\x124\n" +
	"\x16linux_desktop_sessions\x18\x1a \x01(\x04R\x14linuxDesktopSessions\"\x9b\x02\n" +
	...
	"\fresource_ids\x18\x02 \x03(\x06R\vresourceIds\"~\n" +
	"\x1eSessionSummariesAccessedRecord\x12!\n" +
	"\fsession_type\x18\x01 \x01(\tR\vsessionType\x12#\n" +
	"\rresource_name\x18\x03 \x01(\tR\fresourceName\x12\x14\n" +
	"\x05count\x18\x04 \x01(\x04R\x05count\"\x83\x02\n" +
	...
	"\fsvids_issued\x18\x02 \x01(\rR\vsvidsIssued\"\x98\x02\n" +
	"(IdentitySecuritySummariesGeneratedReport\x12\x1f\n" +
	"\vreport_uuid\x18\x01 \x01(\fR\n" +
	"reportUuid\x12!\n" +
	"\fcluster_name\x18\x02 \x01(\fR\vclusterName\x12'\n" +
	"\x0freporter_hostid\x18\x03 \x01(\fR\x0ereporterHostid\x129\n" +
...
var file_prehog_v1_teleport_proto_goTypes = []any{
	...
	(*SessionSummariesAccessedRecord)(nil),           // 7: prehog.v1.SessionSummariesAccessedRecord
	(*BotInstanceActivityReport)(nil),                // 8: prehog.v1.BotInstanceActivityReport
	(*BotInstanceActivityRecord)(nil),                // 9: prehog.v1.BotInstanceActivityRecord
