...
var file_prehog_v1_teleport_proto_goTypes = []interface{}{
	...
	(*ResourcePresenceReport)(nil),     // 3: prehog.v1.ResourcePresenceReport
	(*ResourceKindPresenceReport)(nil), // 4: prehog.v1.ResourceKindPresenceReport
...
var file_prehog_v1_teleport_proto_depIdxs = []int32{
	...
	7, // 2: prehog.v1.ResourcePresenceReport.start_time:type_name -> google.protobuf.Timestamp
	4, // 3: prehog.v1.ResourcePresenceReport.resource_kind_reports:type_name -> prehog.v1.ResourceKindPresenceReport
	0, // 4: prehog.v1.ResourceKindPresenceReport.resource_kind:type_name -> prehog.v1.ResourceKind
	1, // 5: prehog.v1.SubmitUsageReportsRequest.user_activity:type_name -> prehog.v1.UserActivityReport
	3, // 6: prehog.v1.SubmitUsageReportsRequest.resource_presence:type_name -> prehog.v1.ResourcePresenceReport
