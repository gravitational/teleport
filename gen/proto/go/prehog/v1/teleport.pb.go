...
func file_prehog_v1_teleport_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_prehog_v1_teleport_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_prehog_v1_teleport_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
