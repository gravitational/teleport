...
- [ ] Access Lists
  ...
  - [ ] For Access Lists of "static" type:
    - [ ] Verify that static Access List and its members (including nested list members) can be [created/modified/deleted with Terraform](../../docs/pages/identity-governance/access-lists/terraform.mdx)
    - [ ] Verify non-static Access List members cannot be imported to Terraform
