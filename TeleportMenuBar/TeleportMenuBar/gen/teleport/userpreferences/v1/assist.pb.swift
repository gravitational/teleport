...
public enum Teleport_Userpreferences_V1_AssistViewMode: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Teleport_Userpreferences_V1_AssistViewMode] = [
    .unspecified,
    .docked,
    .popup,
    .popupExpanded,
...
public struct Teleport_Userpreferences_V1_AssistUserPreferences: Sendable {
  ...
  public var preferredLogins: [String] = []

  /// viewMode is the way the assistant is displayed.
  public var viewMode: Teleport_Userpreferences_V1_AssistViewMode = .unspecified
...
extension Teleport_Userpreferences_V1_AssistUserPreferences: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AssistUserPreferences"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Teleport_Userpreferences_V1_AssistUserPreferences, rhs: Teleport_Userpreferences_V1_AssistUserPreferences) -> Bool {
