...
public struct Teleport_Userpreferences_V1_UserPreferences: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// theme is the theme of the frontend.
  public var theme: Teleport_Userpreferences_V1_Theme = .unspecified

  /// onboard is the preferences from the onboarding questionnaire.
  public var onboard: Teleport_Userpreferences_V1_OnboardUserPreferences {
  ...
  public var hasOnboard: Bool {return self._onboard != nil}
  /// Clears the value of `onboard`. Subsequent reads from it will return its default value.
  public mutating func clearOnboard() {self._onboard = nil}
  ...
  public var accessGraph: Teleport_Userpreferences_V1_AccessGraphUserPreferences {
  ...
  public var hasAccessGraph: Bool {return self._accessGraph != nil}
  /// Clears the value of `accessGraph`. Subsequent reads from it will return its default value.
  public mutating func clearAccessGraph() {self._accessGraph = nil}

  /// side_nav_drawer_mode is the sidenav drawer behavior preference in the frontend.
  public var sideNavDrawerMode: Teleport_Userpreferences_V1_SideNavDrawerMode = .unspecified

  /// discover_resource_preferences are user preferences saved for the discover resource web UI.
  public var discoverResourcePreferences: Teleport_Userpreferences_V1_DiscoverResourcePreferences {
  ...
  public var hasDiscoverResourcePreferences: Bool {return self._discoverResourcePreferences != nil}
  /// Clears the value of `discoverResourcePreferences`. Subsequent reads from it will return its default value.
  public mutating func clearDiscoverResourcePreferences() {self._discoverResourcePreferences = nil}
...
public struct Teleport_Userpreferences_V1_GetUserPreferencesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Teleport_Userpreferences_V1_GetUserPreferencesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// preferences is the user preferences.
  public var preferences: Teleport_Userpreferences_V1_UserPreferences {
...
public struct Teleport_Userpreferences_V1_UpsertUserPreferencesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Teleport_Userpreferences_V1_UserPreferences: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Teleport_Userpreferences_V1_UserPreferences, rhs: Teleport_Userpreferences_V1_UserPreferences) -> Bool {
...
extension Teleport_Userpreferences_V1_GetUserPreferencesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Teleport_Userpreferences_V1_GetUserPreferencesRequest, rhs: Teleport_Userpreferences_V1_GetUserPreferencesRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Teleport_Userpreferences_V1_GetUserPreferencesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Teleport_Userpreferences_V1_GetUserPreferencesResponse, rhs: Teleport_Userpreferences_V1_GetUserPreferencesResponse) -> Bool {
...
extension Teleport_Userpreferences_V1_UpsertUserPreferencesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UpsertUserPreferencesRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "preferences"),
  ]
  ...
  public static func ==(lhs: Teleport_Userpreferences_V1_UpsertUserPreferencesRequest, rhs: Teleport_Userpreferences_V1_UpsertUserPreferencesRequest) -> Bool {
    if lhs._preferences != rhs._preferences {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
