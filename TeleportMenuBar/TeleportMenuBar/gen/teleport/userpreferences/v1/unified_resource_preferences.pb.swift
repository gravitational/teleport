...
public enum Teleport_Userpreferences_V1_DefaultTab: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Teleport_Userpreferences_V1_DefaultTab] = [
    .unspecified,
    .all,
    .pinned,
  ]
...
public enum Teleport_Userpreferences_V1_ViewMode: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unspecified // = 0
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Teleport_Userpreferences_V1_ViewMode] = [
    .unspecified,
    .card,
    .list,
  ]
...
public enum Teleport_Userpreferences_V1_LabelsViewMode: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unspecified // = 0
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Teleport_Userpreferences_V1_LabelsViewMode] = [
    .unspecified,
    .expanded,
    .collapsed,
  ]
...
public enum Teleport_Userpreferences_V1_AvailableResourceMode: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unspecified // = 0
  case all // = 1
  case accessible // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Teleport_Userpreferences_V1_AvailableResourceMode] = [
    .unspecified,
    .all,
    .accessible,
    .requestable,
...
public struct Teleport_Userpreferences_V1_UnifiedResourcePreferences: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// default_tab is the default tab selected in the unified resource web UI
  public var defaultTab: Teleport_Userpreferences_V1_DefaultTab = .unspecified

  /// view_mode is the view mode selected in the unified resource Web UI
  public var viewMode: Teleport_Userpreferences_V1_ViewMode = .unspecified
  ...
  public var labelsViewMode: Teleport_Userpreferences_V1_LabelsViewMode = .unspecified

  /// available_resource_mode specifies which option in the availability filter menu the user has selected, if any
  public var availableResourceMode: Teleport_Userpreferences_V1_AvailableResourceMode = .unspecified
...
extension Teleport_Userpreferences_V1_UnifiedResourcePreferences: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UnifiedResourcePreferences"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Teleport_Userpreferences_V1_UnifiedResourcePreferences, rhs: Teleport_Userpreferences_V1_UnifiedResourcePreferences) -> Bool {
