...
public enum Teleport_Userpreferences_V1_SideNavDrawerMode: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Teleport_Userpreferences_V1_SideNavDrawerMode] = [
    .unspecified,
    .collapsed,
    .sticky,
  ]
