...
public struct Teleport_Header_V1_ResourceHeader: Sendable {
  ...
  public var metadata: Teleport_Header_V1_Metadata {
...
extension Teleport_Header_V1_ResourceHeader: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ResourceHeader"
  ...
  public static func ==(lhs: Teleport_Header_V1_ResourceHeader, rhs: Teleport_Header_V1_ResourceHeader) -> Bool {
