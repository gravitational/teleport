...
public enum Teleport_Accesslist_V1_ReviewFrequency: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Teleport_Accesslist_V1_ReviewFrequency] = [
    .unspecified,
    .oneMonth,
    .threeMonths,
    .sixMonths,
...
public enum Teleport_Accesslist_V1_ReviewDayOfMonth: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unspecified // = 0
  case first // = 1
  case fifteenth // = 15
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Teleport_Accesslist_V1_ReviewDayOfMonth] = [
    .unspecified,
    .first,
    .fifteenth,
    .last,
...
public enum Teleport_Accesslist_V1_MembershipKind: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Teleport_Accesslist_V1_MembershipKind] = [
    .unspecified,
    .user,
    .list,
  ]
...
public enum Teleport_Accesslist_V1_IneligibleStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Teleport_Accesslist_V1_IneligibleStatus] = [
    .unspecified,
    .eligible,
    .userNotExist,
    .missingRequirements,
...
/// regularly audited.
public struct Teleport_Accesslist_V1_AccessList: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// header is the header for the resource.
  public var header: Teleport_Header_V1_ResourceHeader {
  ...
  public var spec: Teleport_Accesslist_V1_AccessListSpec {
  ...
  public var status: Teleport_Accesslist_V1_AccessListStatus {
...
public struct Teleport_Accesslist_V1_AccessListSpec: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var audit: Teleport_Accesslist_V1_AccessListAudit {
  ...
  /// members list.
  public var membershipRequires: Teleport_Accesslist_V1_AccessListRequires {
  ...
  public var hasMembershipRequires: Bool {return _storage._membershipRequires != nil}
  /// Clears the value of `membershipRequires`. Subsequent reads from it will return its default value.
  public mutating func clearMembershipRequires() {_uniqueStorage()._membershipRequires = nil}
  ...
  /// list.
  public var ownershipRequires: Teleport_Accesslist_V1_AccessListRequires {
  ...
  public var hasOwnershipRequires: Bool {return _storage._ownershipRequires != nil}
  /// Clears the value of `ownershipRequires`. Subsequent reads from it will return its default value.
  public mutating func clearOwnershipRequires() {_uniqueStorage()._ownershipRequires = nil}
  ...
  public var hasGrants: Bool {return _storage._grants != nil}
  /// Clears the value of `grants`. Subsequent reads from it will return its default value.
  public mutating func clearGrants() {_uniqueStorage()._grants = nil}
  ...
  public var ownerGrants: Teleport_Accesslist_V1_AccessListGrants {
  ...
  public var hasOwnerGrants: Bool {return _storage._ownerGrants != nil}
  /// Clears the value of `ownerGrants`. Subsequent reads from it will return its default value.
  public mutating func clearOwnerGrants() {_uniqueStorage()._ownerGrants = nil}
...
public struct Teleport_Accesslist_V1_AccessListOwner: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var ineligibleStatus: Teleport_Accesslist_V1_IneligibleStatus = .unspecified

  /// membership_kind describes the type of membership, either
  /// `MEMBERSHIP_KIND_USER` or `MEMBERSHIP_KIND_LIST`.
  public var membershipKind: Teleport_Accesslist_V1_MembershipKind = .unspecified
...
public struct Teleport_Accesslist_V1_AccessListAudit: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var recurrence: Teleport_Accesslist_V1_Recurrence {
  ...
  public var hasRecurrence: Bool {return self._recurrence != nil}
  /// Clears the value of `recurrence`. Subsequent reads from it will return its default value.
  public mutating func clearRecurrence() {self._recurrence = nil}

  /// notifications is the configuration for notifying users.
  public var notifications: Teleport_Accesslist_V1_Notifications {
...
public struct Teleport_Accesslist_V1_Recurrence: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var frequency: Teleport_Accesslist_V1_ReviewFrequency = .unspecified

  /// day_of_month is the day of month that reviews will be scheduled on.
  /// Supported values are 0, 1, 15, and 31.
  public var dayOfMonth: Teleport_Accesslist_V1_ReviewDayOfMonth = .unspecified
...
/// next audit date.
public struct Teleport_Accesslist_V1_Notifications: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// coming up.
  public var start: SwiftProtobuf.Google_Protobuf_Duration {
...
public struct Teleport_Accesslist_V1_AccessListRequires: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var traits: [Teleport_Trait_V1_Trait] = []
...
/// List.
public struct Teleport_Accesslist_V1_AccessListGrants: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Teleport_Accesslist_V1_Member: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var spec: Teleport_Accesslist_V1_MemberSpec {
...
public struct Teleport_Accesslist_V1_MemberSpec: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var joined: SwiftProtobuf.Google_Protobuf_Timestamp {
...
public struct Teleport_Accesslist_V1_Review: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var spec: Teleport_Accesslist_V1_ReviewSpec {
...
public struct Teleport_Accesslist_V1_ReviewSpec: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var reviewDate: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  public var hasReviewDate: Bool {return self._reviewDate != nil}
  /// Clears the value of `reviewDate`. Subsequent reads from it will return its default value.
  public mutating func clearReviewDate() {self._reviewDate = nil}
  ...
  public var changes: Teleport_Accesslist_V1_ReviewChanges {
...
public struct Teleport_Accesslist_V1_ReviewChanges: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var membershipRequirementsChanged: Teleport_Accesslist_V1_AccessListRequires {
  ...
  public var hasMembershipRequirementsChanged: Bool {return self._membershipRequirementsChanged != nil}
  /// Clears the value of `membershipRequirementsChanged`. Subsequent reads from it will return its default value.
  public mutating func clearMembershipRequirementsChanged() {self._membershipRequirementsChanged = nil}
  ...
  public var reviewFrequencyChanged: Teleport_Accesslist_V1_ReviewFrequency = .unspecified

  /// review_day_of_month_changed is populated if the review day of month has
  /// changed.
  public var reviewDayOfMonthChanged: Teleport_Accesslist_V1_ReviewDayOfMonth = .unspecified
...
public struct Teleport_Accesslist_V1_AccessListStatus: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Teleport_Accesslist_V1_AccessList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AccessList"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "header"),
    2: .same(proto: "spec"),
    3: .same(proto: "status"),
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_AccessList, rhs: Teleport_Accesslist_V1_AccessList) -> Bool {
...
extension Teleport_Accesslist_V1_AccessListSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AccessListSpec"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_AccessListSpec, rhs: Teleport_Accesslist_V1_AccessListSpec) -> Bool {
...
extension Teleport_Accesslist_V1_AccessListOwner: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AccessListOwner"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_AccessListOwner, rhs: Teleport_Accesslist_V1_AccessListOwner) -> Bool {
...
extension Teleport_Accesslist_V1_AccessListAudit: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AccessListAudit"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_AccessListAudit, rhs: Teleport_Accesslist_V1_AccessListAudit) -> Bool {
...
extension Teleport_Accesslist_V1_Recurrence: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Recurrence"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_Recurrence, rhs: Teleport_Accesslist_V1_Recurrence) -> Bool {
...
extension Teleport_Accesslist_V1_Notifications: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_Notifications, rhs: Teleport_Accesslist_V1_Notifications) -> Bool {
...
extension Teleport_Accesslist_V1_AccessListRequires: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AccessListRequires"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "roles"),
    2: .same(proto: "traits"),
  ]
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_AccessListRequires, rhs: Teleport_Accesslist_V1_AccessListRequires) -> Bool {
...
extension Teleport_Accesslist_V1_AccessListGrants: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AccessListGrants"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "roles"),
    2: .same(proto: "traits"),
  ]
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_AccessListGrants, rhs: Teleport_Accesslist_V1_AccessListGrants) -> Bool {
    if lhs.roles != rhs.roles {return false}
    if lhs.traits != rhs.traits {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Teleport_Accesslist_V1_Member: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_Member, rhs: Teleport_Accesslist_V1_Member) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Teleport_Accesslist_V1_MemberSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MemberSpec"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_MemberSpec, rhs: Teleport_Accesslist_V1_MemberSpec) -> Bool {
...
extension Teleport_Accesslist_V1_Review: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_Review, rhs: Teleport_Accesslist_V1_Review) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Teleport_Accesslist_V1_ReviewSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ReviewSpec"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "access_list"),
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_ReviewSpec, rhs: Teleport_Accesslist_V1_ReviewSpec) -> Bool {
    if lhs.accessList != rhs.accessList {return false}
...
extension Teleport_Accesslist_V1_ReviewChanges: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ReviewChanges"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_ReviewChanges, rhs: Teleport_Accesslist_V1_ReviewChanges) -> Bool {
...
extension Teleport_Accesslist_V1_AccessListStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AccessListStatus"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Teleport_Accesslist_V1_AccessListStatus, rhs: Teleport_Accesslist_V1_AccessListStatus) -> Bool {
