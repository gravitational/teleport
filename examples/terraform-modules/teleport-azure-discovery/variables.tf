...
variable "token_name_override" {
  type        = string
  description = "Override for Teleport provision token name; empty to derive from prefix."
  default     = ""
}

variable "integration_name_override" {
  type        = string
  description = "Override for Teleport integration name; empty to derive from prefix."
  default     = ""
}
