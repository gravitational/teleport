...
- AWS Teleport Terraform Guide: [Running Teleport Enterprise in High Availability mode on AWS](https://goteleport.com/docs/deploy-a-cluster/deployments/aws-terraform/)
...
export TF_VAR_ami_name="gravitational-teleport-ami-ent-12.0.4"
