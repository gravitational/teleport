// VPC ID you need to create Teleport cluster on
variable "vpc_id" {
  type = string
}

// Is Teleport Cluster internal or publicly available 
variable "is_internal" {
  default = true
  type    = bool
}

// Auth service subnets / Recommended: private
variable "auth_subnets" {
  type = list(string)
}

// Nodes service subnets / Recommended: private
variable "node_subnets" {
  type = list(string)

}

// Proxy service subnets / Recommended: private
variable "proxy_subnets" {
  type = list(string)
}

// Proxy service LB subnets / Recommended: private
variable "proxy_lb_subnets" {
  type = list(string)
}

// Bastion/Jumpserver subnets it can be public or private depends on your case
variable "bastion_subnet" {
  type = string
}

// Monitor service subnet / Grafana
variable "monitor_subnet" {
  type = string
}

// Variable if you want to deploy bastion or not
