## Terraform based provisioning example (Amazon single AMI) with your own VPC
...
This script uses your own VPC, if you already have VPC then this is for you.

This script enhanced vestion of the original Terrafrom script [HA Autoscale Cluster](https://github.com/gravitational/teleport/tree/master/examples/aws/terraform/ha-autoscale-cluster)
...
export TF_VAR_ami_name="gravitational-teleport-ami-ent-12.2.3"
...
# VPC ID that you have and you want to install Teleport cluster on.
export TF_VAR_vpc_id="vpc-xxxxxxx"

# VPC CIDR that you have and you want to install Teleport cluster on.
export TF_VAR_vpc_cidr="x.x.x.x/16"

# If you want to install Teleport cluster internally this is useful if you want only on-prem cidr to reach teleport.
export TF_VAR_is_internal="true"

# Sometimes you won't to have Bastion server / Jumpserver you can create or not create it.
export TF_VAR_create_bastion="false"

# Subnets you want to use to deploy Authentication service on 
export TF_VAR_auth_subnets="[\"subnet-xxxxx\", \"subnet-yyyyy\", \"subnet-zzzzz\"]"

# Subnets you want to use to deploy nodes on.
export TF_VAR_node_subnets="[\"subnet-xxxxx\", \"subnet-yyyyy\", \"subnet-zzzzz\"]"

# Subnets you want to use to deploy proxy service on.
export TF_VAR_proxy_subnets="[\"subnet-xxxxx\", \"subnet-yyyyy\", \"subnet-zzzzz\"]"

# Subnets you want to use for proxy service loadbalancer
export TF_VAR_proxy_lb_subnets="[\"subnet-xxxxx\", \"subnet-yyyyy\", \"subnet-zzzzz\"]"

# One subnet you want to use for monitoring service
export TF_VAR_monitor_subnet="subnet-xxxxxx"

# One subnet you want to use for bastion host.
export TF_VAR_bastion_subnet="subnet-xxxxxx"
