...
replace (
	...
	// will be updated to gravitational's fork when I get push access
	github.com/opencontainers/selinux => github.com/capnspacehook/selinux v0.0.0-20250507173114-85f0239a77df
