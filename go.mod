...
replace (
	...
	// Currently required to use new OpenAI features, will be removed once the API changes are upstreamed.
	github.com/sashabaranov/go-openai => github.com/xacrimon/go-openai v0.0.0-20230614110848-2dd6510d20b4
