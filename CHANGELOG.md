...
guide](docs/pages/zero-trust-access/deploy-a-cluster/helm-deployments/migration-v12.mdx).
...
follow
the [migration guide](docs/pages/zero-trust-access/deploy-a-cluster/helm-deployments/migration-v12.mdx).
