...
Teleport 11 will now refuse to use a GitHub authentication connector if
one of the specified GitHub organizations uses external SSO and Teleport
is not enterprise licensed. SSO is an enterprise feature that requires
