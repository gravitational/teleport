...
const (
	...
	// EnvVarTerraformJoinAudienceTag is the environment variable configuring the Terraform provider's native Machine ID
	...
	EnvVarTerraformJoinAudienceTag = "TF_TELEPORT_JOIN_AUDIENCE_TAG"
)
