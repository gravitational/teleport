...
func (x *Event) GetUserSessionCredentials() *v126.UserSessionCredentials {
	if x != nil {
		if x, ok := x.Resource.(*Event_UserSessionCredentials); ok {
			return x.UserSessionCredentials
		}
	}
	return nil
}
...
type Event_UserSessionCredentials struct {
	// UserSessionCredentials is a per-user per-session credentials resource.
	UserSessionCredentials *v126.UserSessionCredentials `protobuf:"bytes,98,opt,name=UserSessionCredentials,proto3,oneof"`
}
...
func (*Event_UserSessionCredentials) isEvent_Resource() {}
...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\vBeamsConfig\x18a \x01(\v2\x1e.teleport.beams.v1.BeamsConfigH\x00R\vBeamsConfig\x12q\n" +
	"\x16UserSessionCredentials\x18b \x01(\v27.teleport.userexternalsecrets.v1.UserSessionCredentialsH\x00R\x16UserSessionCredentialsB\n" +
	"\n" +
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []any{
	...
	(*v126.UserSessionCredentials)(nil),         // 90: teleport.userexternalsecrets.v1.UserSessionCredentials
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	90, // 92: proto.Event.UserSessionCredentials:type_name -> teleport.userexternalsecrets.v1.UserSessionCredentials
...
func file_teleport_legacy_client_proto_event_proto_init() {
	...
	file_teleport_legacy_client_proto_event_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*Event_UserSessionCredentials)(nil),
	}
	type x struct{}
