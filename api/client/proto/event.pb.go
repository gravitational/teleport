...
import (
	...
	v117 "github.com/gravitational/teleport/api/gen/proto/go/teleport/recordingencryption/v1"
...
func (x *Event) GetRecordingEncryption() *v117.RecordingEncryption {
	if x != nil {
...
type Event_RecordingEncryption struct {
	...
	RecordingEncryption *v117.RecordingEncryption `protobuf:"bytes,80,opt,name=RecordingEncryption,proto3,oneof"`
}
...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\x15AutoUpdateAgentReport\x18O \x01(\v2-.teleport.autoupdate.v1.AutoUpdateAgentReportH\x00R\x15AutoUpdateAgentReport\x12h\n" +
	"\x13RecordingEncryption\x18P \x01(\v24.teleport.recordingencryption.v1.RecordingEncryptionH\x00R\x13RecordingEncryptionB\n" +
	"\n" +
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []any{
	...
	(*v117.RecordingEncryption)(nil),            // 73: teleport.recordingencryption.v1.RecordingEncryption
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	73, // 75: proto.Event.RecordingEncryption:type_name -> teleport.recordingencryption.v1.RecordingEncryption
