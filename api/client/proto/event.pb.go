...
type Event_LinuxDesktop struct {
	...
	LinuxDesktop *v120.LinuxDesktop `protobuf:"bytes,86,opt,name=LinuxDesktop,proto3,oneof"`
}
...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\fLinuxDesktop\x18V \x01(\v2&.teleport.linuxdesktop.v1.LinuxDesktopH\x00R\fLinuxDesktopB\n" +
	"\n" +
