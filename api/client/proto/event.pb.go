...
func (x *Event) GetAutoUpdateBotReport() *v111.AutoUpdateBotReport {
	if x != nil {
		if x, ok := x.Resource.(*Event_AutoUpdateBotReport); ok {
			return x.AutoUpdateBotReport
		}
	}
	return nil
}
...
type Event_AutoUpdateBotReport struct {
	// AutoUpdateAgentReport is a resource for counting connected bot instances.
	AutoUpdateBotReport *v111.AutoUpdateBotReport `protobuf:"bytes,85,opt,name=AutoUpdateBotReport,proto3,oneof"`
}
...
func (*Event_AutoUpdateBotReport) isEvent_Resource() {}
...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\x06plugin\x18T \x01(\v2\x0f.types.PluginV1H\x00R\x06plugin\x12_\n" +
	"\x13AutoUpdateBotReport\x18U \x01(\v2+.teleport.autoupdate.v1.AutoUpdateBotReportH\x00R\x13AutoUpdateBotReportB\n" +
	"\n" +
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []any{
	...
	(*v111.AutoUpdateBotReport)(nil),            // 78: teleport.autoupdate.v1.AutoUpdateBotReport
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	78, // 80: proto.Event.AutoUpdateBotReport:type_name -> teleport.autoupdate.v1.AutoUpdateBotReport
