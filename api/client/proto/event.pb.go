...
import (
	...
	v120 "github.com/gravitational/teleport/api/gen/proto/go/teleport/delegation/v1"
...
func (x *Event) GetDelegationProfile() *v120.DelegationProfile {
	if x != nil {
		if x, ok := x.Resource.(*Event_DelegationProfile); ok {
...
type Event_DelegationProfile struct {
	// DelegationProfile is a resource describing how delegation sessions should
	// be created.
	DelegationProfile *v120.DelegationProfile `protobuf:"bytes,86,opt,name=DelegationProfile,proto3,oneof"`
}
...
func (*Event_DelegationProfile) isEvent_Resource() {}
...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\x1bAutoUpdateBotInstanceReport\x18U \x01(\v23.teleport.autoupdate.v1.AutoUpdateBotInstanceReportH\x00R\x1bAutoUpdateBotInstanceReport\x12Y\n" +
	"\x11DelegationProfile\x18V \x01(\v2).teleport.delegation.v1.DelegationProfileH\x00R\x11DelegationProfileB\n" +
	"\n" +
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []any{
	...
	(*v120.DelegationProfile)(nil),              // 79: teleport.delegation.v1.DelegationProfile
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	79, // 81: proto.Event.DelegationProfile:type_name -> teleport.delegation.v1.DelegationProfile
