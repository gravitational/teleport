...
import (
	...
	v121 "github.com/gravitational/teleport/api/gen/proto/go/teleport/cloudcluster/v1"
...
func (x *Event) GetCloudCluster() *v121.CloudCluster {
	if x != nil {
		if x, ok := x.Resource.(*Event_CloudCluster); ok {
...
type Event_CloudCluster struct {
	// CloudCluster is a Cloud Cluster resource.
	CloudCluster *v121.CloudCluster `protobuf:"bytes,87,opt,name=CloudCluster,proto3,oneof"`
}
...
func (*Event_CloudCluster) isEvent_Resource() {}
...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\fCloudCluster\x18W \x01(\v2&.teleport.cloudcluster.v1.CloudClusterH\x00R\fCloudClusterB\n" +
	"\n" +
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []any{
	...
	(*v121.CloudCluster)(nil),                   // 80: teleport.cloudcluster.v1.CloudCluster
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	80, // 82: proto.Event.CloudCluster:type_name -> teleport.cloudcluster.v1.CloudCluster
