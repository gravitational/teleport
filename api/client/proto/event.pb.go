...
func (x *Event) GetUserTask() *v112.UserTask {
	if x, ok := x.GetResource().(*Event_UserTask); ok {
		return x.UserTask
	}
	return nil
}
...
func (x *Event) GetDynamicWindowsDesktop() *types.DynamicWindowsDesktopV1 {
	if x, ok := x.GetResource().(*Event_DynamicWindowsDesktop); ok {
...
func (x *Event) GetProvisioningPrincipalState() *v113.PrincipalState {
	if x, ok := x.GetResource().(*Event_ProvisioningPrincipalState); ok {
...
func (x *Event) GetAutoUpdateAgentRollout() *v111.AutoUpdateAgentRollout {
	if x, ok := x.GetResource().(*Event_AutoUpdateAgentRollout); ok {
...
func (x *Event) GetIdentityCenterAccount() *v114.Account {
	if x, ok := x.GetResource().(*Event_IdentityCenterAccount); ok {
...
func (x *Event) GetIdentityCenterPrincipalAssignment() *v114.PrincipalAssignment {
	if x, ok := x.GetResource().(*Event_IdentityCenterPrincipalAssignment); ok {
...
func (x *Event) GetIdentityCenterAccountAssignment() *v114.AccountAssignment {
	if x, ok := x.GetResource().(*Event_IdentityCenterAccountAssignment); ok {
...
func (x *Event) GetWorkloadIdentity() *v115.WorkloadIdentity {
	if x, ok := x.GetResource().(*Event_WorkloadIdentity); ok {
...
var file_teleport_legacy_client_proto_event_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xad, 0x29,
	...
	0x6e, 0x74, 0x12, 0x5c, 0x0a, 0x10, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x49, 0x64,
	0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x4c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x74,
	...
	,
	...
	0x70, 0x69, 0x2f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []any{
	...
	(*v115.WorkloadIdentity)(nil),           // 68: teleport.workloadidentity.v1.WorkloadIdentity
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	68, // 70: proto.Event.WorkloadIdentity:type_name -> teleport.workloadidentity.v1.WorkloadIdentity
