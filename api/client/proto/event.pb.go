...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\aWebhook\x18Y \x01(\v2\x1c.teleport.webhook.v1.WebhookH\x00R\aWebhookB\n" +
	"\n" +
