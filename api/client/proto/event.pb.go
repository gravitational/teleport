...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\n" +
	"\bResourceJ\x04\b\a\x10\bJ\x04\b1\x102J\x04\b?\x10@J\x04\bD\x10EJ\x04\bP\x10QJ\x04\bQ\x10RJ\x04\bR\x10SJ\x04\bS\x10TR\x12ExternalCloudAuditR\x0eStaticHostUserR\x13AutoUpdateAgentPlanR\n" +
	"ScopedRoleR\x14ScopedRoleAssignmentR\frelay_serverR\x13RecordingEncryption**\n" +
	"\tOperation\x12\b\n" +
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []any{
	...
	(*types.PluginV1)(nil),                      // 73: types.PluginV1
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	73, // 75: proto.Event.plugin:type_name -> types.PluginV1
