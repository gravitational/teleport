...
import (
	...
	v122 "github.com/gravitational/teleport/api/gen/proto/go/teleport/delegation/v1"
...
func (x *Event) GetDelegationProfile() *v122.DelegationProfile {
	if x != nil {
...
type Event_DelegationProfile struct {
	...
	// be created.
	DelegationProfile *v122.DelegationProfile `protobuf:"bytes,88,opt,name=DelegationProfile,proto3,oneof"`
}
...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\fLinuxDesktop\x18W \x01(\v2&.teleport.linuxdesktop.v1.LinuxDesktopH\x00R\fLinuxDesktop\x12Y\n" +
	"\x11DelegationProfile\x18X \x01(\v2).teleport.delegation.v1.DelegationProfileH\x00R\x11DelegationProfileB\n" +
	"\n" +
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []any{
	...
	(*v122.DelegationProfile)(nil),              // 81: teleport.delegation.v1.DelegationProfile
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	81, // 83: proto.Event.DelegationProfile:type_name -> teleport.delegation.v1.DelegationProfile
