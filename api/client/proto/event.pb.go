...
import (
	...
	v14 "github.com/gravitational/teleport/api/gen/proto/go/teleport/secreports/v1"
...
func (x *Event) GetExternalCloudAudit() *v13.ExternalCloudAudit {
	if x, ok := x.GetResource().(*Event_ExternalCloudAudit); ok {
		return x.ExternalCloudAudit
	}
	return nil
}

func (x *Event) GetAuditQuery() *v14.AuditQuery {
...
func (x *Event) GetReport() *v14.Report {
...
func (x *Event) GetReportState() *v14.ReportState {
...
type Event_ExternalCloudAudit struct {
	// ExternalCloudAudit is an ExternalCloudAudit resource.
	ExternalCloudAudit *v13.ExternalCloudAudit `protobuf:"bytes,49,opt,name=ExternalCloudAudit,proto3,oneof"`
}

type Event_AuditQuery struct {
	// AuditQuery is an audit query resource.
	AuditQuery *v14.AuditQuery `protobuf:"bytes,50,opt,name=AuditQuery,proto3,oneof"`
}

type Event_Report struct {
	// SecurityReport is a security report resource.
	Report *v14.Report `protobuf:"bytes,51,opt,name=Report,proto3,oneof"`
}

type Event_ReportState struct {
	// SecurityReportState is a security report state resource.
	ReportState *v14.ReportState `protobuf:"bytes,52,opt,name=ReportState,proto3,oneof"`
}
...
func (*Event_ExternalCloudAudit) isEvent_Resource() {}
...
var file_teleport_legacy_client_proto_event_proto_rawDesc = []byte{
	...
	0x79, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x37, 0x74,
	0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2f, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	0x63, 0x6c, 0x6f, 0x75, 0x64, 0x61, 0x75, 0x64, 0x69, 0x74, 0x2f, 0x76, 0x31, 0x2f, 0x65, 0x78,
	...
	0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x27, 0x74, 0x65, 0x6c, 0x65, 0x70,
	...
	0x6f, 0x74, 0x6f, 0x22, 0x87, 0x1a, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x24, 0x0a,
	...
	0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x64, 0x0a, 0x12,
	0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x41, 0x75, 0x64,
	0x69, 0x74, 0x18, 0x31, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x74, 0x65, 0x6c, 0x65, 0x70,
	...
	0x61, 0x6c, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x41, 0x75, 0x64, 0x69, 0x74, 0x48, 0x00, 0x52, 0x12,
	0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x41, 0x75, 0x64,
	0x69, 0x74, 0x12, 0x44, 0x0a, 0x0a, 0x41, 0x75, 0x64, 0x69, 0x74, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x0a, 0x0a, 0x08, 0x52,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4a, 0x04, 0x08, 0x07, 0x10, 0x08, 0x2a, 0x2a, 0x0a,
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []interface{}{
	...
	(*v13.ExternalCloudAudit)(nil),          // 45: teleport.externalcloudaudit.v1.ExternalCloudAudit
	(*v14.AuditQuery)(nil),                  // 46: teleport.secreports.v1.AuditQuery
	(*v14.Report)(nil),                      // 47: teleport.secreports.v1.Report
	(*v14.ReportState)(nil),                 // 48: teleport.secreports.v1.ReportState
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	45, // 47: proto.Event.ExternalCloudAudit:type_name -> teleport.externalcloudaudit.v1.ExternalCloudAudit
	46, // 48: proto.Event.AuditQuery:type_name -> teleport.secreports.v1.AuditQuery
	47, // 49: proto.Event.Report:type_name -> teleport.secreports.v1.Report
	48, // 50: proto.Event.ReportState:type_name -> teleport.secreports.v1.ReportState
