...
type Event_RelayServer struct {
	RelayServer *v117.RelayServer `protobuf:"bytes,80,opt,name=relay_server,json=relayServer,proto3,oneof"`
}
...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\frelay_server\x18P \x01(\v2!.teleport.presence.v1.RelayServerH\x00R\vrelayServerB\n" +
	"\n" +
