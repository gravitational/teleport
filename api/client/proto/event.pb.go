...
func (x *Event) GetSAMLConnector() *types.SAMLConnectorV2 {
	if x != nil {
		if x, ok := x.Resource.(*Event_SAMLConnector); ok {
			return x.SAMLConnector
		}
	}
	return nil
}
...
type Event_SAMLConnector struct {
	// SAMLConnector is a resource for defining SAML connectors.
	SAMLConnector *types.SAMLConnectorV2 `protobuf:"bytes,89,opt,name=SAMLConnector,proto3,oneof"`
}
...
func (*Event_SAMLConnector) isEvent_Resource() {}
...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\rSAMLConnector\x18Y \x01(\v2\x16.types.SAMLConnectorV2H\x00R\rSAMLConnectorB\n" +
	"\n" +
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []any{
	...
	(*types.SAMLConnectorV2)(nil),               // 82: types.SAMLConnectorV2
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	82, // 84: proto.Event.SAMLConnector:type_name -> types.SAMLConnectorV2
