...
type RegisterUsingOracleMethodRequest struct {
	...
	PayloadHeaders       map[string]string `protobuf:"bytes,3,rep,name=payload_headers,json=payloadHeaders,proto3" json:"payload_headers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *RegisterUsingOracleMethodRequest) GetPayloadHeaders() map[string]string {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "proto.RegisterUsingOracleMethodRequest.PayloadHeadersEntry")
...
var fileDescriptor_d7e760ce923b836e = []byte{
	...
	,
}
