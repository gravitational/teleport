...
type RegisterUsingIAMMethodRequest struct {
	...
	// OrgDescribeOrganization is a signed HTTP request to the AWS
	// organizations:DescribeOrganization API endpoint used to prove the AWS organization of a
	// joining node. It must include the challenge string as a signed header.
	OrgDescribeOrganization []byte   `protobuf:"bytes,3,opt,name=org_describe_organization,json=orgDescribeOrganization,proto3" json:"org_describe_organization,omitempty"`
...
func (m *RegisterUsingIAMMethodRequest) GetOrgDescribeOrganization() []byte {
	if m != nil {
		return m.OrgDescribeOrganization
	}
	return nil
}
...
var fileDescriptor_d7e760ce923b836e = []byte{
	...
	,
}
...
func (m *RegisterUsingIAMMethodRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OrgDescribeOrganization) > 0 {
		i -= len(m.OrgDescribeOrganization)
		copy(dAtA[i:], m.OrgDescribeOrganization)
		i = encodeVarintJoinservice(dAtA, i, uint64(len(m.OrgDescribeOrganization)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *RegisterUsingIAMMethodRequest) Size() (n int) {
	...
	l = len(m.OrgDescribeOrganization)
	if l > 0 {
		n += 1 + l + sovJoinservice(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *RegisterUsingIAMMethodRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OrgDescribeOrganization", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OrgDescribeOrganization = append(m.OrgDescribeOrganization[:0], dAtA[iNdEx:postIndex]...)
			if m.OrgDescribeOrganization == nil {
				m.OrgDescribeOrganization = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
