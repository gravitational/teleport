...
type RegisterUsingBoundKeypairInitialRequest struct {
	...
	JoinRequest *types.RegisterUsingTokenRequest `protobuf:"bytes,1,opt,name=join_request,json=joinRequest,proto3" json:"join_request,omitempty"`
	// Types that are valid to be assigned to XInitialJoinSecret:
	//	*RegisterUsingBoundKeypairInitialRequest_InitialJoinSecret
	XInitialJoinSecret isRegisterUsingBoundKeypairInitialRequest_XInitialJoinSecret `protobuf_oneof:"_initial_join_secret"`
...
type isRegisterUsingBoundKeypairInitialRequest_XInitialJoinSecret interface {
	isRegisterUsingBoundKeypairInitialRequest_XInitialJoinSecret()
	MarshalTo([]byte) (int, error)
	Size() int
}

type RegisterUsingBoundKeypairInitialRequest_InitialJoinSecret struct {
	InitialJoinSecret string `protobuf:"bytes,2,opt,name=initial_join_secret,json=initialJoinSecret,proto3,oneof" json:"initial_join_secret,omitempty"`
}

func (*RegisterUsingBoundKeypairInitialRequest_InitialJoinSecret) isRegisterUsingBoundKeypairInitialRequest_XInitialJoinSecret() {
}

func (m *RegisterUsingBoundKeypairInitialRequest) GetXInitialJoinSecret() isRegisterUsingBoundKeypairInitialRequest_XInitialJoinSecret {
	if m != nil {
		return m.XInitialJoinSecret
	}
	return nil
}
...
func (m *RegisterUsingBoundKeypairInitialRequest) GetInitialJoinSecret() string {
	if x, ok := m.GetXInitialJoinSecret().(*RegisterUsingBoundKeypairInitialRequest_InitialJoinSecret); ok {
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*RegisterUsingBoundKeypairInitialRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*RegisterUsingBoundKeypairInitialRequest_InitialJoinSecret)(nil),
	}
}
...
var fileDescriptor_d7e760ce923b836e = []byte{
	...
	,
}
...
func (m *RegisterUsingBoundKeypairInitialRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.XInitialJoinSecret != nil {
		{
			size := m.XInitialJoinSecret.Size()
			i -= size
			if _, err := m.XInitialJoinSecret.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *RegisterUsingBoundKeypairInitialRequest_InitialJoinSecret) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RegisterUsingBoundKeypairInitialRequest_InitialJoinSecret) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *RegisterUsingBoundKeypairInitialRequest_InitialJoinSecret) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RegisterUsingBoundKeypairInitialRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.XInitialJoinSecret = &RegisterUsingBoundKeypairInitialRequest_InitialJoinSecret{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
