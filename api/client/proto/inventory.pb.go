...
type DownstreamInventoryHello_SupportedCapabilities struct {
	...
	DatabaseHeartbeatGracefulStop bool `protobuf:"varint,19,opt,name=database_heartbeat_graceful_stop,json=databaseHeartbeatGracefulStop,proto3" json:"database_heartbeat_graceful_stop,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
const file_teleport_legacy_client_proto_inventory_proto_rawDesc = "" +
	...
	" database_heartbeat_graceful_stop\x18\x13 \x01(\bR\x1ddatabaseHeartbeatGracefulStop\"\xea\x01\n" +
