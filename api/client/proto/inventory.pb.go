...
type UpstreamInventoryOneOf_StopHeartbeat struct {
	...
	StopHeartbeat *UpstreamInventoryStopHeartbeat `protobuf:"bytes,6,opt,name=StopHeartbeat,proto3,oneof"`
}
...
func (x *UpstreamInventoryStopHeartbeat) GetHostID() string {
	if x != nil {
		return x.HostID
	}
	return ""
...
type DownstreamInventoryHello_SupportedCapabilities struct {
	...
	DatabaseHeartbeatGracefulStop bool `protobuf:"varint,19,opt,name=DatabaseHeartbeatGracefulStop,proto3" json:"DatabaseHeartbeatGracefulStop,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
const file_teleport_legacy_client_proto_inventory_proto_rawDesc = "" +
	"\n" +
	",teleport/legacy/client/proto/inventory.proto\x12\x05proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a!teleport/legacy/types/types.proto\"\xa0\x03\n" +
	...
	"\aGoodbye\x18\x05 \x01(\v2\x1f.proto.UpstreamInventoryGoodbyeH\x00R\aGoodbye\x12M\n" +
	"\rStopHeartbeat\x18\x06 \x01(\v2%.proto.UpstreamInventoryStopHeartbeatH\x00R\rStopHeartbeatB\x05\n" +
	"\x03Msg\"\xde\x01\n" +
	...
	"\x10CloudEnvironment\x18\b \x01(\tR\x10CloudEnvironment\"\xe5\b\n" +
	"\x18DownstreamInventoryHello\x12\x18\n" +
	"\aVersion\x18\x01 \x01(\tR\aVersion\x12\x1a\n" +
	"\bServerID\x18\x02 \x01(\tR\bServerID\x12Y\n" +
	"\fCapabilities\x18\x03 \x01(\v25.proto.DownstreamInventoryHello.SupportedCapabilitiesR\fCapabilities\x1a\xb7\a\n" +
	...
	"\x11KubernetesCleanup\x18\x12 \x01(\bR\x11KubernetesCleanup\x12D\n" +
	"\x1dDatabaseHeartbeatGracefulStop\x18\x13 \x01(\bR\x1dDatabaseHeartbeatGracefulStop\"\xea\x01\n" +
	...
	"\x04Kind\x18\x01 \x01(\x0e2\x18.proto.StopHeartbeatKindR\x04Kind\x12\x16\n" +
	"\x06HostID\x18\x02 \x01(\tR\x06HostID\x12\x12\n" +
...
var file_teleport_legacy_client_proto_inventory_proto_depIdxs = []int32{
	...
	15, // 5: proto.UpstreamInventoryOneOf.StopHeartbeat:type_name -> proto.UpstreamInventoryStopHeartbeat
