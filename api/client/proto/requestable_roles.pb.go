...
type ListRequestableRolesRequest_Filter struct {
	...
	// filter out system Teleport roles from the response
	SkipSystemRoles bool `protobuf:"varint,2,opt,name=skip_system_roles,json=skipSystemRoles,proto3" json:"skip_system_roles,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ListRequestableRolesRequest_Filter) GetSkipSystemRoles() bool {
	if x != nil {
		return x.SkipSystemRoles
	}
	return false
}
...
const file_teleport_legacy_client_proto_requestable_roles_proto_rawDesc = "" +
	"\n" +
	"4teleport/legacy/client/proto/requestable_roles.proto\x12\x05proto\"\xfb\x01\n" +
	"\x1bListRequestableRolesRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\x12A\n" +
	"\x06filter\x18\x03 \x01(\v2).proto.ListRequestableRolesRequest.FilterR\x06filter\x1a]\n" +
	"\x06Filter\x12'\n" +
	"\x0fsearch_keywords\x18\x01 \x03(\tR\x0esearchKeywords\x12*\n" +
	"\x11skip_system_roles\x18\x02 \x01(\bR\x0fskipSystemRoles\"\xda\x01\n" +
