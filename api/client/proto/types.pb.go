...
var fileDescriptor_d938547f84707355 = []byte{
	...
	,
}
...
func (m *Certs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SSHCACerts) > 0 {
		for iNdEx := len(m.SSHCACerts) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTypes(dAtA, i, uint64(len(m.SSHCACerts[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	if len(m.TLSCACerts) > 0 {
		for iNdEx := len(m.TLSCACerts) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTypes(dAtA, i, uint64(len(m.TLSCACerts[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if len(m.TLS) > 0 {
		i -= len(m.TLS)
		copy(dAtA[i:], m.TLS)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.TLS)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.SSH) > 0 {
