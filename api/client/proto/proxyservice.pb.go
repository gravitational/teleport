...
type DialRequest struct {
	...
	// TargetScope is the scope expected for the node that will receive the connection.
	TargetScope          string   `protobuf:"bytes,5,opt,name=TargetScope,proto3" json:"TargetScope,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *DialRequest) GetTargetScope() string {
	if m != nil {
...
var fileDescriptor_b76fff22d4479739 = []byte{
	...
	,
}
...
func (m *DialRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TargetScope) > 0 {
		...
		i = encodeVarintProxyservice(dAtA, i, uint64(len(m.TargetScope)))
		i--
		dAtA[i] = 0x2a
	}
