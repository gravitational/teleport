...
const (
	...
	AuthService_CreateMobileDeviceEnrollmentUserToken_FullMethodName = "/proto.AuthService/CreateMobileDeviceEnrollmentUserToken"
...
type AuthServiceClient interface {
	...
	// TODO: Comment
	CreateMobileDeviceEnrollmentUserToken(ctx context.Context, in *CreateMobileDeviceEnrollmentUserTokenRequest, opts ...grpc.CallOption) (*types.UserTokenV3, error)
...
func (c *authServiceClient) CreateMobileDeviceEnrollmentUserToken(ctx context.Context, in *CreateMobileDeviceEnrollmentUserTokenRequest, opts ...grpc.CallOption) (*types.UserTokenV3, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(types.UserTokenV3)
	err := c.cc.Invoke(ctx, AuthService_CreateMobileDeviceEnrollmentUserToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	// TODO: Comment
	CreateMobileDeviceEnrollmentUserToken(context.Context, *CreateMobileDeviceEnrollmentUserTokenRequest) (*types.UserTokenV3, error)
	// GetInstaller retrieves the installer script resource
...
func (UnimplementedAuthServiceServer) CreateMobileDeviceEnrollmentUserToken(context.Context, *CreateMobileDeviceEnrollmentUserTokenRequest) (*types.UserTokenV3, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateMobileDeviceEnrollmentUserToken not implemented")
}
...
func _AuthService_CreateMobileDeviceEnrollmentUserToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateMobileDeviceEnrollmentUserTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).CreateMobileDeviceEnrollmentUserToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_CreateMobileDeviceEnrollmentUserToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).CreateMobileDeviceEnrollmentUserToken(ctx, req.(*CreateMobileDeviceEnrollmentUserTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateMobileDeviceEnrollmentUserToken",
			Handler:    _AuthService_CreateMobileDeviceEnrollmentUserToken_Handler,
		},
		{
