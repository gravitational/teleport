...
type ListRequestableRolesRequest struct {
	...
	xxx_hidden_Filter    *ListRequestableRolesRequest_Filter `protobuf:"bytes,3,opt,name=filter,proto3"`
...
type ListRequestableRolesResponse struct {
	state                    protoimpl.MessageState                           `protogen:"opaque.v1"`
	xxx_hidden_Roles         *[]*ListRequestableRolesResponse_RequestableRole `protobuf:"bytes,1,rep,name=roles,proto3"`
...
type ListRequestableRolesRequest_Filter struct {
	state                     protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_SearchKeywords []string               `protobuf:"bytes,1,rep,name=search_keywords,json=searchKeywords,proto3"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
