...
func (x *Event) GetAppAuthConfig() *v120.AppAuthConfig {
	if x != nil {
		if x, ok := x.xxx_hidden_Resource.(*event_AppAuthConfig); ok {
...
func (x *Event) GetClassifier() *v124.Classifier {
	if x != nil {
...
func (x *Event) GetPendingCSRRequest() *v123.PendingCSRRequest {
	if x != nil {
...
func (x *Event) GetFoo() *v126.Foo {
	if x != nil {
		if x, ok := x.xxx_hidden_Resource.(*event_Foo); ok {
			return x.Foo
		}
	}
	return nil
...
func (x *Event) SetAppAuthConfig(v *v120.AppAuthConfig) {
	...
	x.xxx_hidden_Resource = &event_AppAuthConfig{v}
}
...
func (x *Event) SetClassifier(v *v124.Classifier) {
	if v == nil {
		x.xxx_hidden_Resource = nil
		return
	}
...
func (x *Event) SetPendingCSRRequest(v *v123.PendingCSRRequest) {
	if v == nil {
		x.xxx_hidden_Resource = nil
		return
	}
...
func (x *Event) SetFoo(v *v126.Foo) {
	...
	x.xxx_hidden_Resource = &event_Foo{v}
}
...
func (x *Event) HasAppAuthConfig() bool {
	...
	_, ok := x.xxx_hidden_Resource.(*event_AppAuthConfig)
	return ok
}
...
func (x *Event) HasFoo() bool {
	...
	_, ok := x.xxx_hidden_Resource.(*event_Foo)
	return ok
}
...
func (x *Event) ClearAppAuthConfig() {
	if _, ok := x.xxx_hidden_Resource.(*event_AppAuthConfig); ok {
		x.xxx_hidden_Resource = nil
	}
}
...
func (x *Event) ClearFoo() {
	if _, ok := x.xxx_hidden_Resource.(*event_Foo); ok {
		x.xxx_hidden_Resource = nil
	}
}
...
func (b0 Event_builder) Build() *Event {
	...
	if b.AppAuthConfig != nil {
		x.xxx_hidden_Resource = &event_AppAuthConfig{b.AppAuthConfig}
	}
	...
	if b.Foo != nil {
		x.xxx_hidden_Resource = &event_Foo{b.Foo}
	}
	return m0
}
