...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\vBeamsConfig\x18a \x01(\v2\x1e.teleport.beams.v1.BeamsConfigH\x00R\vBeamsConfigB\n" +
	"\n" +
