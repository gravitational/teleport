...
// ListCloudClusters returns a list of Crown Jewels.
...
// CreateCloudCluster creates a new Crown Jewel.
func (c *Client) CreateCloudCluster(ctx context.Context, req *cloudclusterv1.CloudCluster) (*cloudclusterv1.CloudCluster, error) {
	rsp, err := c.grpcClient.CreateCloudCluster(ctx, &cloudclusterv1.CreateCloudClusterRequest{
		Cluster: req,
	})
	if err != nil {
		return nil, trace.Wrap(err)
...
// GetCloudCluster returns a Crown Jewel by name.
func (c *Client) GetCloudCluster(ctx context.Context, name string) (*cloudclusterv1.CloudCluster, error) {
	rsp, err := c.grpcClient.GetCloudCluster(ctx, &cloudclusterv1.GetCloudClusterRequest{
		Name: name,
	})
	if err != nil {
		return nil, trace.Wrap(err)
...
// UpdateCloudCluster updates an existing Crown Jewel.
func (c *Client) UpdateCloudCluster(ctx context.Context, req *cloudclusterv1.CloudCluster) (*cloudclusterv1.CloudCluster, error) {
	rsp, err := c.grpcClient.UpdateCloudCluster(ctx, &cloudclusterv1.UpdateCloudClusterRequest{
		Cluster: req,
	})
	if err != nil {
		return nil, trace.Wrap(err)
...
// UpsertCloudCluster upserts a Crown Jewel.
func (c *Client) UpsertCloudCluster(ctx context.Context, req *cloudclusterv1.CloudCluster) (*cloudclusterv1.CloudCluster, error) {
	rsp, err := c.grpcClient.UpsertCloudCluster(ctx, &cloudclusterv1.UpsertCloudClusterRequest{
		Cluster: req,
	})
	if err != nil {
		return nil, trace.Wrap(err)
...
// DeleteCloudCluster deletes a Crown Jewel.
