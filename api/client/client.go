...
//
// The client connects to a Teleport Cluster's Auth server, either locally or
// over ssh.
//
// A fair amount of Teleport knowledge is expected before getting started. Make
// sure to familiarize yourself with the admin manual and other Teleport documentation
// - https://goteleport.com/docs/admin-guide/
//
//
// Creating a Client
//
// The Client uses Credentials to authenticate and connect the client. There are several
// Credential options, but the simplest to get started with are Profile Credentials.
//
...
// Client is a gRPC Client that connects to a Teleport Auth server.
type Client struct {
