...
// Clients connecting older Teleport versions still get a plugins client when
...
func (c *Client) ListOktaImportRules(ctx context.Context, pageSize int, pageToken string) ([]types.OktaImportRule, string, error) {
	resp, err := c.oktaClient().ListOktaImportRules(ctx, &oktapb.ListOktaImportRulesRequest{
		PageSize:  int32(pageSize),
		PageToken: pageToken,
	}, c.callOpts...)
	if err != nil {
	...
	importRules := make([]types.OktaImportRule, len(resp.GetImportRules()))
	for i, ir := range resp.GetImportRules() {
		importRules[i] = ir
	}
	return importRules, resp.GetNextToken(), nil
}
...
func (c *Client) GetOktaImportRule(ctx context.Context, name string) (types.OktaImportRule, error) {
	ir, err := c.oktaClient().GetOktaImportRule(ctx, &oktapb.GetOktaImportRuleRequest{
		Name: name,
	}, c.callOpts...)
	if err != nil {
		return nil, trail.FromGRPC(err)
...
func (c *Client) CreateOktaImportRule(ctx context.Context, importRule types.OktaImportRule) error {
	...
	if !ok {
		return trace.BadParameter("unsupported Okta import rule type %T", importRule)
	}

	_, err := c.oktaClient().CreateOktaImportRule(ctx, &oktapb.CreateOktaImportRuleRequest{
...
func (c *Client) UpdateOktaImportRule(ctx context.Context, importRule types.OktaImportRule) error {
	...
	_, err := c.oktaClient().UpdateOktaImportRule(ctx, &oktapb.UpdateOktaImportRuleRequest{
		ImportRule: importRuleV1,
	}, c.callOpts...)
	if err != nil {
		return trail.FromGRPC(err)
...
func (c *Client) DeleteOktaImportRule(ctx context.Context, name string) error {
	_, err := c.oktaClient().DeleteOktaImportRule(ctx, &oktapb.DeleteOktaImportRuleRequest{
		Name: name,
	}, c.callOpts...)
	if err != nil {
		return trail.FromGRPC(err)
...
func (c *Client) DeleteAllOktaImportRules(ctx context.Context) error {
	_, err := c.oktaClient().DeleteAllOktaImportRules(ctx, &oktapb.DeleteAllOktaImportRulesRequest{}, c.callOpts...)
	if err != nil {
		return trail.FromGRPC(err)
	}
	return nil
...
func (c *Client) ListOktaAssignments(ctx context.Context, pageSize int, pageToken string) ([]types.OktaAssignment, string, error) {
	resp, err := c.oktaClient().ListOktaAssignments(ctx, &oktapb.ListOktaAssignmentsRequest{
		PageSize:  int32(pageSize),
		PageToken: pageToken,
	}, c.callOpts...)
	if err != nil {
	...
	assignments := make([]types.OktaAssignment, len(resp.GetAssignments()))
	for i, ir := range resp.GetAssignments() {
		assignments[i] = ir
	}
	return assignments, resp.GetNextToken(), nil
}
...
func (c *Client) GetOktaAssignment(ctx context.Context, name string) (types.OktaAssignment, error) {
	assignment, err := c.oktaClient().GetOktaAssignment(ctx, &oktapb.GetOktaAssignmentRequest{
		Name: name,
	}, c.callOpts...)
	if err != nil {
		return nil, trail.FromGRPC(err)
...
func (c *Client) CreateOktaAssignment(ctx context.Context, assignment types.OktaAssignment) error {
	...
	if !ok {
		return trace.BadParameter("unsupported Okta import rule type %T", assignment)
	}

	_, err := c.oktaClient().CreateOktaAssignment(ctx, &oktapb.CreateOktaAssignmentRequest{
...
func (c *Client) UpdateOktaAssignment(ctx context.Context, assignment types.OktaAssignment) error {
	...
	_, err := c.oktaClient().UpdateOktaAssignment(ctx, &oktapb.UpdateOktaAssignmentRequest{
		Assignment: assignmentV1,
	}, c.callOpts...)
	if err != nil {
		return trail.FromGRPC(err)
...
func (c *Client) DeleteOktaAssignment(ctx context.Context, name string) error {
	_, err := c.oktaClient().DeleteOktaAssignment(ctx, &oktapb.DeleteOktaAssignmentRequest{
		Name: name,
	}, c.callOpts...)
	if err != nil {
		return trail.FromGRPC(err)
...
func (c *Client) DeleteAllOktaAssignments(ctx context.Context) error {
	_, err := c.oktaClient().DeleteAllOktaAssignments(ctx, &oktapb.DeleteAllOktaAssignmentsRequest{}, c.callOpts...)
	if err != nil {
		return trail.FromGRPC(err)
	}
	return nil
