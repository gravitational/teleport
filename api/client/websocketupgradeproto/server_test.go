...
func TestServerProtocol(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			clientConn, hs := createClient(t, ctx, server.URL, tc.protocols)
...
func createClient(t *testing.T, ctx context.Context, urlS string, protocols []string) (net.Conn, ws.Handshake) {
	dialer := ws.Dialer{
		Protocols: protocols,
