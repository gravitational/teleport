...
func (g *GRPCServer) SendKeepAlives(stream AuthService_SendKeepAlivesServer) error {
...
func (g *GRPCServer) CreateAuditStream(stream AuthService_CreateAuditStreamServer) error {
	auth, err := g.authenticate(stream.Context())
	if err != nil {
		return trail.ToGRPC(err)
	}
...
func (g *GRPCServer) WatchEvents(watch *Watch, stream AuthService_WatchEventsServer) error {
	auth, err := g.authenticate(stream.Context())
	if err != nil {
		return trail.ToGRPC(err)
	}
	...
	watcher, err := NewWatcher(stream.Context(), servicesWatch)
	if err != nil {
		return trail.ToGRPC(err)
	}
	defer watcher.Close()
...
func (g *GRPCServer) GenerateUserCerts(ctx context.Context, req *UserCertsRequest) (*Certs, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) GetUser(ctx context.Context, req *GetUserRequest) (*services.UserV2, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) GetUsers(req *GetUsersRequest, stream AuthService_GetUsersServer) error {
	auth, err := g.authenticate(stream.Context())
	if err != nil {
		return trail.ToGRPC(err)
	}
...
func (g *GRPCServer) GetAccessRequests(ctx context.Context, f *services.AccessRequestFilter) (*AccessRequests, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) DeleteAccessRequest(ctx context.Context, id *RequestID) (*empty.Empty, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) SetAccessRequestState(ctx context.Context, req *RequestStateSetter) (*empty.Empty, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) CreateResetPasswordToken(ctx context.Context, req *CreateResetPasswordTokenRequest) (*services.ResetPasswordTokenV3, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) RotateResetPasswordTokenSecrets(ctx context.Context, req *RotateResetPasswordTokenSecretsRequest) (*services.ResetPasswordTokenSecretsV3, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) GetResetPasswordToken(ctx context.Context, req *GetResetPasswordTokenRequest) (*services.ResetPasswordTokenV3, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) GetPluginData(ctx context.Context, filter *services.PluginDataFilter) (*PluginDataSeq, error) {
...
func (g *GRPCServer) Ping(ctx context.Context, req *PingRequest) (*PingResponse, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) DeleteUser(ctx context.Context, req *DeleteUserRequest) (*empty.Empty, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) GetSemaphores(ctx context.Context, req *services.SemaphoreFilter) (*Semaphores, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) GetAppServers(ctx context.Context, req *GetAppServersRequest) (*GetAppServersResponse, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
	...
	return &GetAppServersResponse{
		Servers: servers,
	}, nil
}

// UpsertAppServer adds an application server.
func (g *GRPCServer) UpsertAppServer(ctx context.Context, req *UpsertAppServerRequest) (*services.KeepAlive, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) DeleteAppServer(ctx context.Context, req *DeleteAppServerRequest) (*empty.Empty, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) DeleteAllAppServers(ctx context.Context, req *DeleteAllAppServersRequest) (*empty.Empty, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) GetAppSession(ctx context.Context, req *GetAppSessionRequest) (*GetAppSessionResponse, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) GetAppSessions(ctx context.Context, _ *empty.Empty) (*GetAppSessionsResponse, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) CreateAppSession(ctx context.Context, req *CreateAppSessionRequest) (*CreateAppSessionResponse, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g GRPCServer) GenerateAppToken(ctx context.Context, req *GenerateAppTokenRequest) (*GenerateAppTokenResponse, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) GetKubeServices(ctx context.Context, req *GetKubeServicesRequest) (*GetKubeServicesResponse, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
	...
	return &GetKubeServicesResponse{
		Servers: servers,
	}, nil
}

// UpsertKubeService adds a kubernetes service.
func (g *GRPCServer) UpsertKubeService(ctx context.Context, req *UpsertKubeServiceRequest) (*empty.Empty, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) DeleteKubeService(ctx context.Context, req *DeleteKubeServiceRequest) (*empty.Empty, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func (g *GRPCServer) DeleteAllKubeServices(ctx context.Context, req *DeleteAllKubeServicesRequest) (*empty.Empty, error) {
	auth, err := g.authenticate(ctx)
	if err != nil {
		return nil, trail.ToGRPC(err)
	}
...
func NewGRPCServer(cfg GRPCServerConfig) (*GRPCServer, error) {
	...
	RegisterAuthServiceServer(authServer.server, authServer)
	return authServer, nil
}

func eventToGRPC(in services.Event) (*Event, error) {
	...
	case *services.ResourceHeader:
		out.Resource = &Event_ResourceHeader{
			ResourceHeader: r,
		}
	case *services.CertAuthorityV2:
		out.Resource = &Event_CertAuthority{
			CertAuthority: r,
		}
	case *services.StaticTokensV2:
		out.Resource = &Event_StaticTokens{
			StaticTokens: r,
		}
	case *services.ProvisionTokenV2:
		out.Resource = &Event_ProvisionToken{
			ProvisionToken: r,
		}
	case *services.ClusterNameV2:
		out.Resource = &Event_ClusterName{
			ClusterName: r,
		}
	case *services.ClusterConfigV3:
		out.Resource = &Event_ClusterConfig{
			ClusterConfig: r,
		}
	case *services.UserV2:
		out.Resource = &Event_User{
			User: r,
		}
	case *services.RoleV3:
		out.Resource = &Event_Role{
			Role: r,
		}
	case *services.Namespace:
		out.Resource = &Event_Namespace{
			Namespace: r,
		}
	case *services.ServerV2:
		out.Resource = &Event_Server{
			Server: r,
		}
	case *services.ReverseTunnelV2:
		out.Resource = &Event_ReverseTunnel{
			ReverseTunnel: r,
		}
	case *services.TunnelConnectionV2:
		out.Resource = &Event_TunnelConnection{
			TunnelConnection: r,
		}
	case *services.AccessRequestV3:
		out.Resource = &Event_AccessRequest{
			AccessRequest: r,
		}
	case *services.WebSessionV2:
		...
		out.Resource = &Event_AppSession{
			AppSession: r,
		}
	case *services.RemoteClusterV3:
		out.Resource = &Event_RemoteCluster{
			RemoteCluster: r,
		}
	default:
...
func eventTypeToGRPC(in backend.OpType) (Operation, error) {
	switch in {
	case backend.OpInit:
		return Operation_INIT, nil
	case backend.OpPut:
