...
func newPrivateKey(ctx context.Context, config hardwarekey.PrivateKeyConfig, prompt hardwarekey.Prompt, s hardwarekey.Service) (*hardwarekey.PrivateKey, error) {
