...
func getOrGenerateYubiKeyPrivateKey(ctx context.Context, requiredKeyPolicy PrivateKeyPolicy, slot hardwarekey.PIVSlotKeyString, prompt hardwarekey.Prompt) (*PrivateKey, error) {
	if prompt == nil {
...
func parseYubiKeyPrivateKeyData(keyDataBytes []byte, prompt hardwarekey.Prompt) (*PrivateKey, error) {
	if prompt == nil {
		prompt = hardwarekey.NewStdCLIPrompt()
	}
	cachedKeysMu.Lock()
