...
//   - Given any two valid scopes, they will either be equivalent ('/foo' and '/foo'), orthogonal ('/foo' and '/bar'), or have an ancestor/descendant relationship (e.g. '/foo' and '/foo/bar/bin').
