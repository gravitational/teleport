...
type AccessGraphSettings struct {
	...
	xxx_hidden_Spec     *AccessGraphSettingsSpec   `protobuf:"bytes,5,opt,name=spec,proto3"`
	xxx_hidden_Status   *AccessGraphSettingsStatus `protobuf:"bytes,6,opt,name=status,proto3"`
...
type AccessGraphSettingsStatus struct {
	state                          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_InitialSyncComplete bool                   `protobuf:"varint,1,opt,name=initial_sync_complete,json=initialSyncComplete,proto3"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
func (x *AccessGraphSettingsStatus) GetInitialSyncComplete() bool {
	if x != nil {
		return x.xxx_hidden_InitialSyncComplete
	}
	return false
}

func (x *AccessGraphSettingsStatus) SetInitialSyncComplete(v bool) {
	x.xxx_hidden_InitialSyncComplete = v
}
...
func (b0 AccessGraphSettingsStatus_builder) Build() *AccessGraphSettingsStatus {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_InitialSyncComplete = b.InitialSyncComplete
	return m0
}
...
type AccessGraphSettingsSpec struct {
	state                        protoimpl.MessageState       `protogen:"opaque.v1"`
	xxx_hidden_SecretsScanConfig AccessGraphSecretsScanConfig `protobuf:"varint,1,opt,name=secrets_scan_config,json=secretsScanConfig,proto3,enum=teleport.clusterconfig.v1.AccessGraphSecretsScanConfig"`
	xxx_hidden_DemoMode          AccessGraphDemoMode          `protobuf:"varint,2,opt,name=demo_mode,json=demoMode,proto3,enum=teleport.clusterconfig.v1.AccessGraphDemoMode"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (b0 AccessGraphSettingsSpec_builder) Build() *AccessGraphSettingsSpec {
	...
	x.xxx_hidden_DemoMode = b.DemoMode
	return m0
}
