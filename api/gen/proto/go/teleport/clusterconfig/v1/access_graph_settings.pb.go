...
var file_teleport_clusterconfig_v1_access_graph_settings_proto_goTypes = []interface{}{
...
func file_teleport_clusterconfig_v1_access_graph_settings_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_clusterconfig_v1_access_graph_settings_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AccessGraphSettings); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_teleport_clusterconfig_v1_access_graph_settings_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AccessGraphSettingsSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
