...
type ListRelayServersRequest struct {
	...
	PageSize int32 `protobuf:"varint,1,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`
	// A pagination token returned from a previous request. If unspecified, the
	// request will return the first page.
	//
	// When paginating, all other parameters in the request must match the call
...
func (x *ListRelayServersRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
type ListRelayServersResponse struct {
	...
	// field is empty, there are no more pages.
	NextPageToken string `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_teleport_presence_v1_service_proto_rawDesc = "" +
	...
	"\x19DeleteRelayServerResponse2\xcb\a\n" +
	...
	"\x13DeleteReverseTunnel\x120.teleport.presence.v1.DeleteReverseTunnelRequest\x1a\x16.google.protobuf.Empty\x12q\n" +
...
var file_teleport_presence_v1_service_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_teleport_presence_v1_service_proto_goTypes = []any{
	...
	(*ListRelayServersRequest)(nil),    // 9: teleport.presence.v1.ListRelayServersRequest
	(*ListRelayServersResponse)(nil),   // 10: teleport.presence.v1.ListRelayServersResponse
	(*DeleteRelayServerRequest)(nil),   // 11: teleport.presence.v1.DeleteRelayServerRequest
	(*DeleteRelayServerResponse)(nil),  // 12: teleport.presence.v1.DeleteRelayServerResponse
	(*types.RemoteClusterV3)(nil),      // 13: types.RemoteClusterV3
	(*fieldmaskpb.FieldMask)(nil),      // 14: google.protobuf.FieldMask
	(*types.ReverseTunnelV2)(nil),      // 15: types.ReverseTunnelV2
	(*RelayServer)(nil),                // 16: teleport.presence.v1.RelayServer
	(*emptypb.Empty)(nil),              // 17: google.protobuf.Empty
}
var file_teleport_presence_v1_service_proto_depIdxs = []int32{
	13, // 0: teleport.presence.v1.ListRemoteClustersResponse.remote_clusters:type_name -> types.RemoteClusterV3
	13, // 1: teleport.presence.v1.UpdateRemoteClusterRequest.remote_cluster:type_name -> types.RemoteClusterV3
	14, // 2: teleport.presence.v1.UpdateRemoteClusterRequest.update_mask:type_name -> google.protobuf.FieldMask
	15, // 3: teleport.presence.v1.ListReverseTunnelsResponse.reverse_tunnels:type_name -> types.ReverseTunnelV2
	15, // 4: teleport.presence.v1.UpsertReverseTunnelRequest.reverse_tunnel:type_name -> types.ReverseTunnelV2
	16, // 5: teleport.presence.v1.ListRelayServersResponse.relays:type_name -> teleport.presence.v1.RelayServer
	0,  // 6: teleport.presence.v1.PresenceService.GetRemoteCluster:input_type -> teleport.presence.v1.GetRemoteClusterRequest
	1,  // 7: teleport.presence.v1.PresenceService.ListRemoteClusters:input_type -> teleport.presence.v1.ListRemoteClustersRequest
	3,  // 8: teleport.presence.v1.PresenceService.UpdateRemoteCluster:input_type -> teleport.presence.v1.UpdateRemoteClusterRequest
	4,  // 9: teleport.presence.v1.PresenceService.DeleteRemoteCluster:input_type -> teleport.presence.v1.DeleteRemoteClusterRequest
	5,  // 10: teleport.presence.v1.PresenceService.ListReverseTunnels:input_type -> teleport.presence.v1.ListReverseTunnelsRequest
	7,  // 11: teleport.presence.v1.PresenceService.UpsertReverseTunnel:input_type -> teleport.presence.v1.UpsertReverseTunnelRequest
	8,  // 12: teleport.presence.v1.PresenceService.DeleteReverseTunnel:input_type -> teleport.presence.v1.DeleteReverseTunnelRequest
	9,  // 13: teleport.presence.v1.PresenceService.ListRelayServers:input_type -> teleport.presence.v1.ListRelayServersRequest
	11, // 14: teleport.presence.v1.PresenceService.DeleteRelayServer:input_type -> teleport.presence.v1.DeleteRelayServerRequest
	13, // 15: teleport.presence.v1.PresenceService.GetRemoteCluster:output_type -> types.RemoteClusterV3
	2,  // 16: teleport.presence.v1.PresenceService.ListRemoteClusters:output_type -> teleport.presence.v1.ListRemoteClustersResponse
	13, // 17: teleport.presence.v1.PresenceService.UpdateRemoteCluster:output_type -> types.RemoteClusterV3
	17, // 18: teleport.presence.v1.PresenceService.DeleteRemoteCluster:output_type -> google.protobuf.Empty
	6,  // 19: teleport.presence.v1.PresenceService.ListReverseTunnels:output_type -> teleport.presence.v1.ListReverseTunnelsResponse
	15, // 20: teleport.presence.v1.PresenceService.UpsertReverseTunnel:output_type -> types.ReverseTunnelV2
	17, // 21: teleport.presence.v1.PresenceService.DeleteReverseTunnel:output_type -> google.protobuf.Empty
	10, // 22: teleport.presence.v1.PresenceService.ListRelayServers:output_type -> teleport.presence.v1.ListRelayServersResponse
	12, // 23: teleport.presence.v1.PresenceService.DeleteRelayServer:output_type -> teleport.presence.v1.DeleteRelayServerResponse
