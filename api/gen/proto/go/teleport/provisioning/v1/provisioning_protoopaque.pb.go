...
type PrincipalState struct {
	...
	xxx_hidden_Spec     *PrincipalStateSpec    `protobuf:"bytes,5,opt,name=spec,proto3"`
	xxx_hidden_Status   *PrincipalStateStatus  `protobuf:"bytes,6,opt,name=status,proto3"`
...
type PrincipalStateSpec struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_DownstreamId  string                 `protobuf:"bytes,1,opt,name=downstream_id,json=downstreamId,proto3"`
	xxx_hidden_PrincipalType PrincipalType          `protobuf:"varint,2,opt,name=principal_type,json=principalType,proto3,enum=teleport.provisioning.v1.PrincipalType"`
	xxx_hidden_PrincipalId   string                 `protobuf:"bytes,3,opt,name=principal_id,json=principalId,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *PrincipalStateSpec) GetDownstreamId() string {
	if x != nil {
		return x.xxx_hidden_DownstreamId
	}
	return ""
}
...
func (b0 PrincipalStateSpec_builder) Build() *PrincipalStateSpec {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_DownstreamId = b.DownstreamId
...
type PrincipalStateStatus struct {
	state                                   protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ProvisioningState            ProvisioningState      `protobuf:"varint,5,opt,name=provisioning_state,json=provisioningState,proto3,enum=teleport.provisioning.v1.ProvisioningState"`
	xxx_hidden_ExternalId                   string                 `protobuf:"bytes,2,opt,name=external_id,json=externalId,proto3"`
	xxx_hidden_LastProvisioned              *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=last_provisioned,json=lastProvisioned,proto3"`
	xxx_hidden_Error                        string                 `protobuf:"bytes,4,opt,name=error,proto3"`
	xxx_hidden_ProvisionedPrincipalRevision string                 `protobuf:"bytes,6,opt,name=provisioned_principal_revision,json=provisionedPrincipalRevision,proto3"`
	xxx_hidden_ActiveLocks                  []string               `protobuf:"bytes,7,rep,name=active_locks,json=activeLocks,proto3"`
	unknownFields                           protoimpl.UnknownFields
	sizeCache                               protoimpl.SizeCache
}
...
func (x *PrincipalStateStatus) GetLastProvisioned() *timestamppb.Timestamp {
	if x != nil {
		return x.xxx_hidden_LastProvisioned
	}
	return nil
}
...
func (x *PrincipalStateStatus) GetProvisionedPrincipalRevision() string {
	if x != nil {
		return x.xxx_hidden_ProvisionedPrincipalRevision
	}
	return ""
}
...
func (x *PrincipalStateStatus) GetActiveLocks() []string {
	if x != nil {
		return x.xxx_hidden_ActiveLocks
	}
	return nil
}
...
func (x *PrincipalStateStatus) SetLastProvisioned(v *timestamppb.Timestamp) {
	x.xxx_hidden_LastProvisioned = v
}
...
func (x *PrincipalStateStatus) SetProvisionedPrincipalRevision(v string) {
	x.xxx_hidden_ProvisionedPrincipalRevision = v
}

func (x *PrincipalStateStatus) SetActiveLocks(v []string) {
	x.xxx_hidden_ActiveLocks = v
}
...
func (x *PrincipalStateStatus) HasLastProvisioned() bool {
	...
	return x.xxx_hidden_LastProvisioned != nil
}

func (x *PrincipalStateStatus) ClearLastProvisioned() {
	x.xxx_hidden_LastProvisioned = nil
}
...
func (b0 PrincipalStateStatus_builder) Build() *PrincipalStateStatus {
	...
	x.xxx_hidden_LastProvisioned = b.LastProvisioned
	x.xxx_hidden_Error = b.Error
	x.xxx_hidden_ProvisionedPrincipalRevision = b.ProvisionedPrincipalRevision
	x.xxx_hidden_ActiveLocks = b.ActiveLocks
	return m0
}
