...
func (UnimplementedLoginRuleServiceServer) CreateLoginRule(context.Context, *CreateLoginRuleRequest) (*LoginRule, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateLoginRule not implemented")
}
func (UnimplementedLoginRuleServiceServer) UpsertLoginRule(context.Context, *UpsertLoginRuleRequest) (*LoginRule, error) {
	return nil, status.Error(codes.Unimplemented, "method UpsertLoginRule not implemented")
}
func (UnimplementedLoginRuleServiceServer) GetLoginRule(context.Context, *GetLoginRuleRequest) (*LoginRule, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLoginRule not implemented")
}
func (UnimplementedLoginRuleServiceServer) ListLoginRules(context.Context, *ListLoginRulesRequest) (*ListLoginRulesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListLoginRules not implemented")
}
func (UnimplementedLoginRuleServiceServer) DeleteLoginRule(context.Context, *DeleteLoginRuleRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteLoginRule not implemented")
}
func (UnimplementedLoginRuleServiceServer) TestLoginRule(context.Context, *TestLoginRuleRequest) (*TestLoginRuleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TestLoginRule not implemented")
}
...
func RegisterLoginRuleServiceServer(s grpc.ServiceRegistrar, srv LoginRuleServiceServer) {
	// If the following call panics, it indicates UnimplementedLoginRuleServiceServer was
