...
var file_teleport_loginrule_v1_loginrule_proto_rawDesc = []byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x42, 0x4a, 0x5a, 0x48, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_teleport_loginrule_v1_loginrule_proto_goTypes = []interface{}{
...
func file_teleport_loginrule_v1_loginrule_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_loginrule_v1_loginrule_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoginRule); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
