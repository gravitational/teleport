...
type CreateLoginRuleRequest struct {
	...
	xxx_hidden_LoginRule *LoginRule             `protobuf:"bytes,1,opt,name=login_rule,json=loginRule,proto3"`
...
func (x *CreateLoginRuleRequest) HasLoginRule() bool {
	...
	return x.xxx_hidden_LoginRule != nil
}

func (x *CreateLoginRuleRequest) ClearLoginRule() {
	x.xxx_hidden_LoginRule = nil
}
...
func (b0 CreateLoginRuleRequest_builder) Build() *CreateLoginRuleRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_LoginRule = b.LoginRule
	return m0
}
...
type ListLoginRulesResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_LoginRules    *[]*LoginRule          `protobuf:"bytes,1,rep,name=login_rules,json=loginRules,proto3"`
...
func (x *ListLoginRulesResponse) GetLoginRules() []*LoginRule {
	if x != nil {
		if x.xxx_hidden_LoginRules != nil {
			return *x.xxx_hidden_LoginRules
		}
	}
	return nil
}
...
func (b0 ListLoginRulesResponse_builder) Build() *ListLoginRulesResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_LoginRules = &b.LoginRules
...
type TestLoginRuleRequest struct {
	state                      protoimpl.MessageState            `protogen:"opaque.v1"`
	xxx_hidden_LoginRules      *[]*LoginRule                     `protobuf:"bytes,1,rep,name=login_rules,json=loginRules,proto3"`
	xxx_hidden_Traits          map[string]*wrappers.StringValues `protobuf:"bytes,4,rep,name=traits,proto3" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_LoadFromCluster bool                              `protobuf:"varint,3,opt,name=load_from_cluster,json=loadFromCluster,proto3"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *TestLoginRuleRequest) GetLoadFromCluster() bool {
	if x != nil {
		return x.xxx_hidden_LoadFromCluster
	}
	return false
}
...
func (x *TestLoginRuleRequest) SetLoadFromCluster(v bool) {
	x.xxx_hidden_LoadFromCluster = v
}
...
func (b0 TestLoginRuleRequest_builder) Build() *TestLoginRuleRequest {
	...
	x.xxx_hidden_LoadFromCluster = b.LoadFromCluster
	return m0
}
...
const file_teleport_loginrule_v1_loginrule_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x16CreateLoginRuleRequest\x12?\n" +
	"\n" +
	"login_rule\x18\x01 \x01(\v2 .teleport.loginrule.v1.LoginRuleR\tloginRule\"Y\n" +
	"\x16UpsertLoginRuleRequest\x12?\n" +
	"\n" +
	"login_rule\x18\x01 \x01(\v2 .teleport.loginrule.v1.LoginRuleR\tloginRule\")\n" +
	...
	"\x16ListLoginRulesResponse\x12A\n" +
	"\vlogin_rules\x18\x01 \x03(\v2 .teleport.loginrule.v1.LoginRuleR\n" +
	"loginRules\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\",\n" +
	"\x16DeleteLoginRuleRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\xa9\x02\n" +
	"\x14TestLoginRuleRequest\x12A\n" +
	"\vlogin_rules\x18\x01 \x03(\v2 .teleport.loginrule.v1.LoginRuleR\n" +
	"loginRules\x12O\n" +
	"\x06traits\x18\x04 \x03(\v27.teleport.loginrule.v1.TestLoginRuleRequest.TraitsEntryR\x06traits\x12*\n" +
	"\x11load_from_cluster\x18\x03 \x01(\bR\x0floadFromCluster\x1aQ\n" +
	"\vTraitsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.wrappers.StringValuesR\x05value:\x028\x01\"\xbc\x01\n" +
	"\x15TestLoginRuleResponse\x12P\n" +
	"\x06traits\x18\x04 \x03(\v28.teleport.loginrule.v1.TestLoginRuleResponse.TraitsEntryR\x06traits\x1aQ\n" +
	"\vTraitsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.wrappers.StringValuesR\x05value:\x028\x012\xed\x04\n" +
	"\x10LoginRuleService\x12b\n" +
	"\x0fCreateLoginRule\x12-.teleport.loginrule.v1.CreateLoginRuleRequest\x1a .teleport.loginrule.v1.LoginRule\x12b\n" +
	"\x0fUpsertLoginRule\x12-.teleport.loginrule.v1.UpsertLoginRuleRequest\x1a .teleport.loginrule.v1.LoginRule\x12\\\n" +
	"\fGetLoginRule\x12*.teleport.loginrule.v1.GetLoginRuleRequest\x1a .teleport.loginrule.v1.LoginRule\x12m\n" +
...
func file_teleport_loginrule_v1_loginrule_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_teleport_loginrule_v1_loginrule_service_proto_rawDesc), len(file_teleport_loginrule_v1_loginrule_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
