...
type BackendInfo struct {
	...
	xxx_hidden_Spec     *BackendInfoSpec       `protobuf:"bytes,5,opt,name=spec,proto3"`
...
type BackendInfoSpec struct {
	state                      protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_TeleportVersion string                 `protobuf:"bytes,1,opt,name=teleport_version,json=teleportVersion,proto3"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
