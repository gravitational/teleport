...
// TPMEnrollPayload is the TPM-specific enrollment payload.
type TPMEnrollPayload struct {
	...
	// attestation_data is used to verify the attestation key.
	AttestationData *TPMAttestationData `protobuf:"bytes,5,opt,name=attestation_data,json=attestationData,proto3" json:"attestation_data,omitempty"`
	// app_certification_params are used to certify the application key.
	AppCertificationParams *TPMCertificationParameters `protobuf:"bytes,6,opt,name=app_certification_params,json=appCertificationParams,proto3" json:"app_certification_params,omitempty"`
}
...
func (x *TPMEnrollPayload) GetEkPublic() []byte {
	if x != nil {
		return x.EkPublic
	}
	return nil
...
func (x *TPMEnrollPayload) GetAttestationData() *TPMAttestationData {
	if x != nil {
...
func (x *TPMEnrollPayload) GetAppCertificationParams() *TPMCertificationParameters {
	if x != nil {
		return x.AppCertificationParams
	}
	return nil
}

// TPMAttetationData contains metadata data about an attestation key.
//
// See https://pkg.go.dev/github.com/google/go-attestation/attest#AttestationParameters.
// This message excludes the `UseTCSDActivationFormat` option as it is TMP 1.x specific and always false.
type TPMAttestationData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// public is an encoded TPMT_PUBLIC structure containing the attestation key and signing parameters.
...
func (x *TPMAttestationData) Reset() {
	*x = TPMAttestationData{}
	if protoimpl.UnsafeEnabled {
...
func (x *TPMAttestationData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TPMAttestationData) ProtoMessage() {}

func (x *TPMAttestationData) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TPMAttestationData.ProtoReflect.Descriptor instead.
func (*TPMAttestationData) Descriptor() ([]byte, []int) {
	return file_teleport_devicetrust_v1_devicetrust_service_proto_rawDescGZIP(), []int{19}
}

func (x *TPMAttestationData) GetPublic() []byte {
	if x != nil {
		return x.Public
	}
	return nil
...
func (x *TPMAttestationData) GetCreateData() []byte {
	if x != nil {
		return x.CreateData
	}
	return nil
...
func (x *TPMAttestationData) GetCreateAttestation() []byte {
	if x != nil {
...
func (x *TPMAttestationData) GetCreateSignature() []byte {
	if x != nil {
...
// TPMCertificationParameters contains metadata about an application key for certification.
//
...
type TPMCertificationParameters struct {
	...
	// public is an encoded TPMT_PUBLIC structure containing the application public key and signing parameters.
	Public []byte `protobuf:"bytes,1,opt,name=public,proto3" json:"public,omitempty"`
	// create_data represents the properties of a TPM key, encoded as a
	// TPMS_CREATION_DATA structure.
	CreateData []byte `protobuf:"bytes,2,opt,name=create_data,json=createData,proto3" json:"create_data,omitempty"`
...
// TPMEnrollChallenge is a TPM enrollment challenge.
type TPMEnrollChallenge struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// credential is the credential to be used for the challenge.
	Credential []byte `protobuf:"bytes,1,opt,name=credential,proto3" json:"credential,omitempty"`
	// secret is an encrypted secret which requires both the EK and AK private parts to decrypt.
...
func (x *TPMEnrollChallenge) GetCredential() []byte {
	if x != nil {
		return x.Credential
	}
	return nil
...
// TPMEnrollChallengeResponse is a TPM enrollment challenge response.
...
func (x *TPMEnrollChallengeResponse) GetSecret() []byte {
	if x != nil {
		return x.Secret
	}
	return nil
...
var file_teleport_devicetrust_v1_devicetrust_service_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x31, 0x74,
	0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x74, 0x72,
	0x75, 0x73, 0x74, 0x2f, 0x76, 0x31, 0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x65, 0x6e,
	0x72, 0x6f, 0x6c, 0x6c, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x1a, 0x2f, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2f, 0x64, 0x65, 0x76, 0x69, 0x63,
	...
	0x6f, 0x22, 0xac, 0x01, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x65, 0x76, 0x69,
	0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x37, 0x0a, 0x06, 0x64, 0x65, 0x76,
	...
	0x63, 0x65, 0x12, 0x2e, 0x0a, 0x13, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x65, 0x6e, 0x72,
	0x6f, 0x6c, 0x6c, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x11, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x45, 0x6e, 0x72, 0x6f, 0x6c, 0x6c, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x12, 0x2c, 0x0a, 0x12, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x61, 0x73, 0x5f,
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10,
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x73, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x22, 0x32, 0x0a, 0x13, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65,
	...
	0x63, 0x65, 0x49, 0x64, 0x22, 0x30, 0x0a, 0x12, 0x46, 0x69, 0x6e, 0x64, 0x44, 0x65, 0x76, 0x69,
	0x63, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x09, 0x69, 0x64,
	0x5f, 0x6f, 0x72, 0x5f, 0x74, 0x61, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x69,
	0x64, 0x4f, 0x72, 0x54, 0x61, 0x67, 0x22, 0x50, 0x0a, 0x13, 0x46, 0x69, 0x6e, 0x64, 0x44, 0x65,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39, 0x0a,
	...
	0x07, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x22, 0x2f, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x44,
	...
	0x08, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x22, 0x89, 0x01, 0x0a, 0x12, 0x4c, 0x69,
	...
	0x09, 0x52, 0x09, 0x70, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x37, 0x0a, 0x04,
	0x76, 0x69, 0x65, 0x77, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x74, 0x65, 0x6c,
	0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x74, 0x72, 0x75, 0x73,
	0x74, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x56, 0x69, 0x65, 0x77, 0x52,
	0x04, 0x76, 0x69, 0x65, 0x77, 0x22, 0x78, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x65, 0x76,
	...
	,
	...
	0x76, 0x69, 0x63, 0x65, 0x73, 0x22, 0x4c, 0x0a, 0x0e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4f,
	0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2a, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	...
	0x02, 0x69, 0x64, 0x22, 0x3d, 0x0a, 0x1e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x65, 0x76,
	...
	0x49, 0x64, 0x22, 0xc1, 0x02, 0x0a, 0x13, 0x45, 0x6e, 0x72, 0x6f, 0x6c, 0x6c, 0x44, 0x65, 0x76,
	...
	,
	...
	0x63, 0x72, 0x65, 0x74, 0x22, 0x34, 0x0a, 0x1a, 0x54, 0x50, 0x4d, 0x45, 0x6e, 0x72, 0x6f, 0x6c,
	0x6c, 0x43, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x22, 0xdc, 0x01, 0x0a, 0x19, 0x41,
	...
	0x0c, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x2a, 0x59, 0x0a, 0x0a,
	...
	0x4f, 0x55, 0x52, 0x43, 0x45, 0x10, 0x02, 0x32, 0xe7, 0x07, 0x0a, 0x12, 0x44, 0x65, 0x76, 0x69,
	...
	,
	...
	0x65, 0x74, 0x72, 0x75, 0x73, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x44, 0x65,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x57, 0x0a,
	0x09, 0x47, 0x65, 0x74, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x12, 0x29, 0x2e, 0x74, 0x65, 0x6c,
	0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x74, 0x72, 0x75, 0x73,
	...
	,
	...
	,
	...
	0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x74, 0x72, 0x75, 0x73, 0x74, 0x2f, 0x76, 0x31, 0x62,
...
var file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_teleport_devicetrust_v1_devicetrust_service_proto_goTypes = []interface{}{
	...
	(*DeleteDeviceRequest)(nil),                 // 2: teleport.devicetrust.v1.DeleteDeviceRequest
	(*FindDevicesRequest)(nil),                  // 3: teleport.devicetrust.v1.FindDevicesRequest
	(*FindDevicesResponse)(nil),                 // 4: teleport.devicetrust.v1.FindDevicesResponse
	(*GetDeviceRequest)(nil),                    // 5: teleport.devicetrust.v1.GetDeviceRequest
	(*ListDevicesRequest)(nil),                  // 6: teleport.devicetrust.v1.ListDevicesRequest
	(*ListDevicesResponse)(nil),                 // 7: teleport.devicetrust.v1.ListDevicesResponse
	(*BulkCreateDevicesRequest)(nil),            // 8: teleport.devicetrust.v1.BulkCreateDevicesRequest
	(*BulkCreateDevicesResponse)(nil),           // 9: teleport.devicetrust.v1.BulkCreateDevicesResponse
	(*DeviceOrStatus)(nil),                      // 10: teleport.devicetrust.v1.DeviceOrStatus
	(*CreateDeviceEnrollTokenRequest)(nil),      // 11: teleport.devicetrust.v1.CreateDeviceEnrollTokenRequest
	(*EnrollDeviceRequest)(nil),                 // 12: teleport.devicetrust.v1.EnrollDeviceRequest
	(*EnrollDeviceResponse)(nil),                // 13: teleport.devicetrust.v1.EnrollDeviceResponse
	(*EnrollDeviceInit)(nil),                    // 14: teleport.devicetrust.v1.EnrollDeviceInit
	(*EnrollDeviceSuccess)(nil),                 // 15: teleport.devicetrust.v1.EnrollDeviceSuccess
	(*MacOSEnrollPayload)(nil),                  // 16: teleport.devicetrust.v1.MacOSEnrollPayload
	(*MacOSEnrollChallenge)(nil),                // 17: teleport.devicetrust.v1.MacOSEnrollChallenge
	(*MacOSEnrollChallengeResponse)(nil),        // 18: teleport.devicetrust.v1.MacOSEnrollChallengeResponse
	(*TPMEnrollPayload)(nil),                    // 19: teleport.devicetrust.v1.TPMEnrollPayload
	(*TPMAttestationData)(nil),                  // 20: teleport.devicetrust.v1.TPMAttestationData
	(*TPMCertificationParameters)(nil),          // 21: teleport.devicetrust.v1.TPMCertificationParameters
	...
	(*AuthenticateDeviceChallenge)(nil),         // 27: teleport.devicetrust.v1.AuthenticateDeviceChallenge
	(*AuthenticateDeviceChallengeResponse)(nil), // 28: teleport.devicetrust.v1.AuthenticateDeviceChallengeResponse
	(*Device)(nil),                              // 29: teleport.devicetrust.v1.Device
	(*status.Status)(nil),                       // 30: google.rpc.Status
	(*DeviceCollectedData)(nil),                 // 31: teleport.devicetrust.v1.DeviceCollectedData
	(*UserCertificates)(nil),                    // 32: teleport.devicetrust.v1.UserCertificates
	(*emptypb.Empty)(nil),                       // 33: google.protobuf.Empty
	(*DeviceEnrollToken)(nil),                   // 34: teleport.devicetrust.v1.DeviceEnrollToken
}
var file_teleport_devicetrust_v1_devicetrust_service_proto_depIdxs = []int32{
	29, // 0: teleport.devicetrust.v1.CreateDeviceRequest.device:type_name -> teleport.devicetrust.v1.Device
	29, // 1: teleport.devicetrust.v1.FindDevicesResponse.devices:type_name -> teleport.devicetrust.v1.Device
	0,  // 2: teleport.devicetrust.v1.ListDevicesRequest.view:type_name -> teleport.devicetrust.v1.DeviceView
	29, // 3: teleport.devicetrust.v1.ListDevicesResponse.devices:type_name -> teleport.devicetrust.v1.Device
	29, // 4: teleport.devicetrust.v1.BulkCreateDevicesRequest.devices:type_name -> teleport.devicetrust.v1.Device
	10, // 5: teleport.devicetrust.v1.BulkCreateDevicesResponse.devices:type_name -> teleport.devicetrust.v1.DeviceOrStatus
	30, // 6: teleport.devicetrust.v1.DeviceOrStatus.status:type_name -> google.rpc.Status
	14, // 7: teleport.devicetrust.v1.EnrollDeviceRequest.init:type_name -> teleport.devicetrust.v1.EnrollDeviceInit
	18, // 8: teleport.devicetrust.v1.EnrollDeviceRequest.macos_challenge_response:type_name -> teleport.devicetrust.v1.MacOSEnrollChallengeResponse
	23, // 9: teleport.devicetrust.v1.EnrollDeviceRequest.tpm_challenge_response:type_name -> teleport.devicetrust.v1.TPMEnrollChallengeResponse
	15, // 10: teleport.devicetrust.v1.EnrollDeviceResponse.success:type_name -> teleport.devicetrust.v1.EnrollDeviceSuccess
	17, // 11: teleport.devicetrust.v1.EnrollDeviceResponse.macos_challenge:type_name -> teleport.devicetrust.v1.MacOSEnrollChallenge
	22, // 12: teleport.devicetrust.v1.EnrollDeviceResponse.tpm_challenge:type_name -> teleport.devicetrust.v1.TPMEnrollChallenge
	31, // 13: teleport.devicetrust.v1.EnrollDeviceInit.device_data:type_name -> teleport.devicetrust.v1.DeviceCollectedData
	16, // 14: teleport.devicetrust.v1.EnrollDeviceInit.macos:type_name -> teleport.devicetrust.v1.MacOSEnrollPayload
	19, // 15: teleport.devicetrust.v1.EnrollDeviceInit.tpm:type_name -> teleport.devicetrust.v1.TPMEnrollPayload
	29, // 16: teleport.devicetrust.v1.EnrollDeviceSuccess.device:type_name -> teleport.devicetrust.v1.Device
	20, // 17: teleport.devicetrust.v1.TPMEnrollPayload.attestation_data:type_name -> teleport.devicetrust.v1.TPMAttestationData
	21, // 18: teleport.devicetrust.v1.TPMEnrollPayload.app_certification_params:type_name -> teleport.devicetrust.v1.TPMCertificationParameters
	26, // 19: teleport.devicetrust.v1.AuthenticateDeviceRequest.init:type_name -> teleport.devicetrust.v1.AuthenticateDeviceInit
	28, // 20: teleport.devicetrust.v1.AuthenticateDeviceRequest.challenge_response:type_name -> teleport.devicetrust.v1.AuthenticateDeviceChallengeResponse
	27, // 21: teleport.devicetrust.v1.AuthenticateDeviceResponse.challenge:type_name -> teleport.devicetrust.v1.AuthenticateDeviceChallenge
	32, // 22: teleport.devicetrust.v1.AuthenticateDeviceResponse.user_certificates:type_name -> teleport.devicetrust.v1.UserCertificates
	32, // 23: teleport.devicetrust.v1.AuthenticateDeviceInit.user_certificates:type_name -> teleport.devicetrust.v1.UserCertificates
	31, // 24: teleport.devicetrust.v1.AuthenticateDeviceInit.device_data:type_name -> teleport.devicetrust.v1.DeviceCollectedData
	1,  // 25: teleport.devicetrust.v1.DeviceTrustService.CreateDevice:input_type -> teleport.devicetrust.v1.CreateDeviceRequest
	2,  // 26: teleport.devicetrust.v1.DeviceTrustService.DeleteDevice:input_type -> teleport.devicetrust.v1.DeleteDeviceRequest
	3,  // 27: teleport.devicetrust.v1.DeviceTrustService.FindDevices:input_type -> teleport.devicetrust.v1.FindDevicesRequest
	5,  // 28: teleport.devicetrust.v1.DeviceTrustService.GetDevice:input_type -> teleport.devicetrust.v1.GetDeviceRequest
	6,  // 29: teleport.devicetrust.v1.DeviceTrustService.ListDevices:input_type -> teleport.devicetrust.v1.ListDevicesRequest
	8,  // 30: teleport.devicetrust.v1.DeviceTrustService.BulkCreateDevices:input_type -> teleport.devicetrust.v1.BulkCreateDevicesRequest
	11, // 31: teleport.devicetrust.v1.DeviceTrustService.CreateDeviceEnrollToken:input_type -> teleport.devicetrust.v1.CreateDeviceEnrollTokenRequest
	12, // 32: teleport.devicetrust.v1.DeviceTrustService.EnrollDevice:input_type -> teleport.devicetrust.v1.EnrollDeviceRequest
	24, // 33: teleport.devicetrust.v1.DeviceTrustService.AuthenticateDevice:input_type -> teleport.devicetrust.v1.AuthenticateDeviceRequest
	29, // 34: teleport.devicetrust.v1.DeviceTrustService.CreateDevice:output_type -> teleport.devicetrust.v1.Device
	33, // 35: teleport.devicetrust.v1.DeviceTrustService.DeleteDevice:output_type -> google.protobuf.Empty
	4,  // 36: teleport.devicetrust.v1.DeviceTrustService.FindDevices:output_type -> teleport.devicetrust.v1.FindDevicesResponse
	29, // 37: teleport.devicetrust.v1.DeviceTrustService.GetDevice:output_type -> teleport.devicetrust.v1.Device
	7,  // 38: teleport.devicetrust.v1.DeviceTrustService.ListDevices:output_type -> teleport.devicetrust.v1.ListDevicesResponse
	9,  // 39: teleport.devicetrust.v1.DeviceTrustService.BulkCreateDevices:output_type -> teleport.devicetrust.v1.BulkCreateDevicesResponse
	34, // 40: teleport.devicetrust.v1.DeviceTrustService.CreateDeviceEnrollToken:output_type -> teleport.devicetrust.v1.DeviceEnrollToken
	13, // 41: teleport.devicetrust.v1.DeviceTrustService.EnrollDevice:output_type -> teleport.devicetrust.v1.EnrollDeviceResponse
	25, // 42: teleport.devicetrust.v1.DeviceTrustService.AuthenticateDevice:output_type -> teleport.devicetrust.v1.AuthenticateDeviceResponse
...
func file_teleport_devicetrust_v1_devicetrust_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TPMAttestationData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[11].OneofWrappers = []interface{}{
		(*EnrollDeviceRequest_Init)(nil),
		(*EnrollDeviceRequest_MacosChallengeResponse)(nil),
		(*EnrollDeviceRequest_TpmChallengeResponse)(nil),
	}
	file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[12].OneofWrappers = []interface{}{
