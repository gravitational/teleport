...
func file_teleport_devicetrust_v1_devicetrust_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListDevicesByUserRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListDevicesByUserResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[15].OneofWrappers = []interface{}{
		(*EnrollDeviceRequest_Init)(nil),
		(*EnrollDeviceRequest_MacosChallengeResponse)(nil),
		(*EnrollDeviceRequest_TpmChallengeResponse)(nil),
	}
	file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[16].OneofWrappers = []interface{}{
		(*EnrollDeviceResponse_Success)(nil),
		(*EnrollDeviceResponse_MacosChallenge)(nil),
		(*EnrollDeviceResponse_TpmChallenge)(nil),
	}
	file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[22].OneofWrappers = []interface{}{
		(*TPMEnrollPayload_EkCert)(nil),
		(*TPMEnrollPayload_EkKey)(nil),
	}
	file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[27].OneofWrappers = []interface{}{
