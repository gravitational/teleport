...
func file_teleport_devicetrust_v1_devicetrust_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[39].Exporter = func(v any, i int) any {
		...
		file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[40].Exporter = func(v any, i int) any {
		...
		file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[41].Exporter = func(v any, i int) any {
		...
		file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[42].Exporter = func(v any, i int) any {
	...
	file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[34].OneofWrappers = []any{
	...
	file_teleport_devicetrust_v1_devicetrust_service_proto_msgTypes[35].OneofWrappers = []any{
