...
const (
	...
	// Credential was verified through an EK->AK->App key chain on enrollment.
	AttestationType_ATTESTATION_TYPE_HW_KEY AttestationType = 1
	// Credential was verified through an EK->AK->App key chain on enrollment and
	// an EKCert was present and signed by a configured approved TPM CA.
	AttestationType_ATTESTATION_TYPE_HW_CERT AttestationType = 2
)
...
var (
	AttestationType_name = map[int32]string{
		...
		1: "ATTESTATION_TYPE_HW_KEY",
		2: "ATTESTATION_TYPE_HW_CERT",
	}
	AttestationType_value = map[string]int32{
		"ATTESTATION_TYPE_UNSPECIFIED": 0,
		"ATTESTATION_TYPE_HW_KEY":      1,
		"ATTESTATION_TYPE_HW_CERT":     2,
	}
)
...
type DeviceCredential struct {
	...
	AttestationType AttestationType `protobuf:"varint,3,opt,name=attestation_type,json=attestationType,proto3,enum=teleport.devicetrust.v1.AttestationType" json:"attestation_type,omitempty"`
	...
	// form.
	TpmAttestationKey []byte `protobuf:"bytes,5,opt,name=tpm_attestation_key,json=tpmAttestationKey,proto3" json:"tpm_attestation_key,omitempty"`
}
...
func (x *DeviceCredential) GetAttestationType() AttestationType {
	if x != nil {
...
func (x *DeviceCredential) GetTpmAttestationKey() []byte {
	if x != nil {
		return x.TpmAttestationKey
	}
	return nil
}
...
var file_teleport_devicetrust_v1_device_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcc, 0x05, 0x0a, 0x06, 0x44,
	...
	0x52, 0x07, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x22, 0xec, 0x01, 0x0a, 0x10, 0x44, 0x65,
	...
	0x79, 0x44, 0x65, 0x72, 0x12, 0x53, 0x0a, 0x10, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74,
	...
	,
	...
	,
...
var file_teleport_devicetrust_v1_device_proto_goTypes = []interface{}{
	(AttestationType)(0),          // 0: teleport.devicetrust.v1.AttestationType
...
var file_teleport_devicetrust_v1_device_proto_depIdxs = []int32{
	...
	0,  // 9: teleport.devicetrust.v1.DeviceCredential.attestation_type:type_name -> teleport.devicetrust.v1.AttestationType
