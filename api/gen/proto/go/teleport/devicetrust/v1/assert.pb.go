...
var file_teleport_devicetrust_v1_assert_proto_goTypes = []interface{}{
...
func file_teleport_devicetrust_v1_assert_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_devicetrust_v1_assert_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_devicetrust_v1_assert_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_devicetrust_v1_assert_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_devicetrust_v1_assert_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_teleport_devicetrust_v1_assert_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*AssertDeviceRequest_Init)(nil),
		(*AssertDeviceRequest_ChallengeResponse)(nil),
		(*AssertDeviceRequest_TpmChallengeResponse)(nil),
	}
	file_teleport_devicetrust_v1_assert_proto_msgTypes[1].OneofWrappers = []interface{}{
