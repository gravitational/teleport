...
const file_teleport_devicetrust_v1_usage_proto_rawDesc = "" +
	"\n" +
	"#teleport/devicetrust/v1/usage.proto\x12\x17teleport.devicetrust.v1\"Y\n" +
	"\fDevicesUsageJ\x04\b\x01\x10\x02J\x04\b\x02\x10\x03J\x04\b\x03\x10\x04R\x12account_usage_typeR\x13devices_usage_limitR\x0edevices_in_use*|\n" +
	"\x10AccountUsageType\x12\"\n" +
	"\x1eACCOUNT_USAGE_TYPE_UNSPECIFIED\x10\x00\x12 \n" +
	"\x1cACCOUNT_USAGE_TYPE_UNLIMITED\x10\x01\x12\"\n" +
	"\x1eACCOUNT_USAGE_TYPE_USAGE_BASED\x10\x02BZZXgithub.com/gravitational/teleport/api/gen/proto/go/teleport/devicetrust/v1;devicetrustv1b\x06proto3"
