...
type UserCertificates struct {
	...
	xxx_hidden_X509Der          []byte                 `protobuf:"bytes,1,opt,name=x509_der,json=x509Der,proto3"`
	xxx_hidden_SshAuthorizedKey []byte                 `protobuf:"bytes,2,opt,name=ssh_authorized_key,json=sshAuthorizedKey,proto3"`
...
func (x *UserCertificates) GetSshAuthorizedKey() []byte {
	if x != nil {
		return x.xxx_hidden_SshAuthorizedKey
	}
	return nil
}
...
func (x *UserCertificates) SetSshAuthorizedKey(v []byte) {
	...
	x.xxx_hidden_SshAuthorizedKey = v
}
...
func (b0 UserCertificates_builder) Build() *UserCertificates {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_X509Der = b.X509Der
	x.xxx_hidden_SshAuthorizedKey = b.SshAuthorizedKey
	return m0
}
