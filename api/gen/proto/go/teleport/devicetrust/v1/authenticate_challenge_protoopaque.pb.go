...
type AuthenticateDeviceChallengeResponse struct {
	...
	xxx_hidden_SshSignature []byte                 `protobuf:"bytes,2,opt,name=ssh_signature,json=sshSignature,proto3"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *AuthenticateDeviceChallengeResponse) GetSshSignature() []byte {
	if x != nil {
		return x.xxx_hidden_SshSignature
	}
	return nil
}
...
func (b0 AuthenticateDeviceChallengeResponse_builder) Build() *AuthenticateDeviceChallengeResponse {
	...
	x.xxx_hidden_SshSignature = b.SshSignature
	return m0
}
...
type TPMAuthenticateDeviceChallenge struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_AttestationNonce []byte                 `protobuf:"bytes,1,opt,name=attestation_nonce,json=attestationNonce,proto3"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *TPMAuthenticateDeviceChallenge) GetAttestationNonce() []byte {
	if x != nil {
		return x.xxx_hidden_AttestationNonce
	}
	return nil
}
...
func (x *TPMAuthenticateDeviceChallenge) SetAttestationNonce(v []byte) {
	...
	x.xxx_hidden_AttestationNonce = v
}
...
func (b0 TPMAuthenticateDeviceChallenge_builder) Build() *TPMAuthenticateDeviceChallenge {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_AttestationNonce = b.AttestationNonce
	return m0
}
...
type TPMAuthenticateDeviceChallengeResponse struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PlatformParameters *TPMPlatformParameters `protobuf:"bytes,1,opt,name=platform_parameters,json=platformParameters,proto3"`
	xxx_hidden_SshSignature       []byte                 `protobuf:"bytes,2,opt,name=ssh_signature,json=sshSignature,proto3"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *TPMAuthenticateDeviceChallengeResponse) GetPlatformParameters() *TPMPlatformParameters {
	if x != nil {
		return x.xxx_hidden_PlatformParameters
	}
	return nil
}
...
func (x *TPMAuthenticateDeviceChallengeResponse) SetPlatformParameters(v *TPMPlatformParameters) {
	x.xxx_hidden_PlatformParameters = v
}
...
func (x *TPMAuthenticateDeviceChallengeResponse) HasPlatformParameters() bool {
	...
	return x.xxx_hidden_PlatformParameters != nil
}

func (x *TPMAuthenticateDeviceChallengeResponse) ClearPlatformParameters() {
	x.xxx_hidden_PlatformParameters = nil
}
...
func (b0 TPMAuthenticateDeviceChallengeResponse_builder) Build() *TPMAuthenticateDeviceChallengeResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_PlatformParameters = b.PlatformParameters
	x.xxx_hidden_SshSignature = b.SshSignature
	return m0
}
