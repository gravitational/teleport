...
func (c *deviceTrustServiceClient) ListDevicesByUser(ctx context.Context, in *ListDevicesByUserRequest, opts ...grpc.CallOption) (*ListDevicesByUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeviceTrustService_ListDevicesByUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDeviceTrustServiceServer) FindDevices(context.Context, *FindDevicesRequest) (*FindDevicesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FindDevices not implemented")
}
...
func (UnimplementedDeviceTrustServiceServer) ListDevicesByUser(context.Context, *ListDevicesByUserRequest) (*ListDevicesByUserResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListDevicesByUser not implemented")
}
func (UnimplementedDeviceTrustServiceServer) BulkCreateDevices(context.Context, *BulkCreateDevicesRequest) (*BulkCreateDevicesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BulkCreateDevices not implemented")
}
func (UnimplementedDeviceTrustServiceServer) CreateDeviceEnrollToken(context.Context, *CreateDeviceEnrollTokenRequest) (*DeviceEnrollToken, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateDeviceEnrollToken not implemented")
}
...
func (UnimplementedDeviceTrustServiceServer) ConfirmDeviceWebAuthentication(context.Context, *ConfirmDeviceWebAuthenticationRequest) (*ConfirmDeviceWebAuthenticationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ConfirmDeviceWebAuthentication not implemented")
}
func (UnimplementedDeviceTrustServiceServer) SyncInventory(grpc.BidiStreamingServer[SyncInventoryRequest, SyncInventoryResponse]) error {
	return status.Error(codes.Unimplemented, "method SyncInventory not implemented")
}
func (UnimplementedDeviceTrustServiceServer) CreateEnrollPairing(context.Context, *CreateEnrollPairingRequest) (*CreateEnrollPairingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateEnrollPairing not implemented")
}
