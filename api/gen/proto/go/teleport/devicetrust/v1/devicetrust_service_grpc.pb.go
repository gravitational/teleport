...
func (c *deviceTrustServiceClient) EnrollDevice(ctx context.Context, opts ...grpc.CallOption) (DeviceTrustService_EnrollDeviceClient, error) {
	...
	x := &deviceTrustServiceEnrollDeviceClient{ClientStream: stream}
	return x, nil
}
...
func (c *deviceTrustServiceClient) AuthenticateDevice(ctx context.Context, opts ...grpc.CallOption) (DeviceTrustService_AuthenticateDeviceClient, error) {
	...
	x := &deviceTrustServiceAuthenticateDeviceClient{ClientStream: stream}
	return x, nil
}
...
func (c *deviceTrustServiceClient) SyncInventory(ctx context.Context, opts ...grpc.CallOption) (DeviceTrustService_SyncInventoryClient, error) {
	...
	x := &deviceTrustServiceSyncInventoryClient{ClientStream: stream}
	return x, nil
}
...
func _DeviceTrustService_EnrollDevice_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DeviceTrustServiceServer).EnrollDevice(&deviceTrustServiceEnrollDeviceServer{ServerStream: stream})
}
...
func _DeviceTrustService_AuthenticateDevice_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DeviceTrustServiceServer).AuthenticateDevice(&deviceTrustServiceAuthenticateDeviceServer{ServerStream: stream})
}
...
func _DeviceTrustService_SyncInventory_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DeviceTrustServiceServer).SyncInventory(&deviceTrustServiceSyncInventoryServer{ServerStream: stream})
}
