...
const file_teleport_devicetrust_v1_device_profile_proto_rawDesc = "" +
	"\n" +
	",teleport/devicetrust/v1/device_profile.proto\x12\x17teleport.devicetrust.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xee\x02\n" +
	"\rDeviceProfile\x12;\n" +
	...
	"\bos_build\x18\x04 \x01(\tR\aosBuild\x12!\n" +
	"\fos_usernames\x18\x05 \x03(\tR\vosUsernames\x12.\n" +
...
func file_teleport_devicetrust_v1_device_profile_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_teleport_devicetrust_v1_device_profile_proto_rawDesc), len(file_teleport_devicetrust_v1_device_profile_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
