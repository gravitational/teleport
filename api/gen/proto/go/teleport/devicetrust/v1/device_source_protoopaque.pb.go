...
type DeviceSource struct {
	...
	xxx_hidden_Origin DeviceOrigin           `protobuf:"varint,2,opt,name=origin,proto3,enum=teleport.devicetrust.v1.DeviceOrigin"`
...
const file_teleport_devicetrust_v1_device_source_proto_rawDesc = "" +
	"\n" +
	"+teleport/devicetrust/v1/device_source.proto\x12\x17teleport.devicetrust.v1\"a\n" +
	"\fDeviceSource\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12=\n" +
	"\x06origin\x18\x02 \x01(\x0e2%.teleport.devicetrust.v1.DeviceOriginR\x06origin*v\n" +
	"\fDeviceOrigin\x12\x1d\n" +
	"\x19DEVICE_ORIGIN_UNSPECIFIED\x10\x00\x12\x15\n" +
