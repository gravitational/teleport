...
type TPMPCR struct {
	...
	xxx_hidden_DigestAlg uint64                 `protobuf:"varint,3,opt,name=digest_alg,json=digestAlg,proto3"`
...
func (b0 TPMPCR_builder) Build() *TPMPCR {
	...
	x.xxx_hidden_DigestAlg = b.DigestAlg
	return m0
}
...
type TPMQuote struct {
	state                protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Quote     []byte                 `protobuf:"bytes,1,opt,name=quote,proto3"`
...
type TPMPlatformParameters struct {
	state               protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Quotes   *[]*TPMQuote           `protobuf:"bytes,1,rep,name=quotes,proto3"`
	xxx_hidden_Pcrs     *[]*TPMPCR             `protobuf:"bytes,2,rep,name=pcrs,proto3"`
	xxx_hidden_EventLog []byte                 `protobuf:"bytes,3,opt,name=event_log,json=eventLog,proto3"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *TPMPlatformParameters) GetPcrs() []*TPMPCR {
	if x != nil {
		if x.xxx_hidden_Pcrs != nil {
			return *x.xxx_hidden_Pcrs
		}
	}
	return nil
}
...
func (b0 TPMPlatformParameters_builder) Build() *TPMPlatformParameters {
	...
	x.xxx_hidden_Pcrs = &b.Pcrs
	x.xxx_hidden_EventLog = b.EventLog
	return m0
}
