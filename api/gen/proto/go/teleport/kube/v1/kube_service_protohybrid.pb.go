...
type ListKubeClustersRequest struct {
	...
	SortMode ListKubeClustersRequest_SortMode `protobuf:"varint,3,opt,name=sort_mode,json=sortMode,proto3,enum=teleport.kube.v1.ListKubeClustersRequest_SortMode" json:"sort_mode,omitempty"`
	...
	Filter *ListKubeClustersRequest_ListKubeClustersFilter `protobuf:"bytes,5,opt,name=filter,proto3" json:"filter,omitempty"`
...
func (b0 ListKubeClustersRequest_builder) Build() *ListKubeClustersRequest {
	...
	x.SortMode = b.SortMode
	x.IsSortDescending = b.IsSortDescending
	x.Filter = b.Filter
