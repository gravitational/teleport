...
var file_teleport_kube_v1_kube_service_proto_rawDesc = []byte{
	...
	0x72, 0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x45, 0x5a, 0x43,
...
var file_teleport_kube_v1_kube_service_proto_goTypes = []interface{}{
...
func file_teleport_kube_v1_kube_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_kube_v1_kube_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_kube_v1_kube_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
