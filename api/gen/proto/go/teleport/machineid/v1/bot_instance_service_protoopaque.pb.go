...
type ListBotInstancesRequest struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_FilterBotName    string                 `protobuf:"bytes,1,opt,name=filter_bot_name,json=filterBotName,proto3"`
	...
	xxx_hidden_FilterSearchTerm string                 `protobuf:"bytes,4,opt,name=filter_search_term,json=filterSearchTerm,proto3"`
	xxx_hidden_Sort             *types.SortBy          `protobuf:"bytes,5,opt,name=sort,proto3"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *ListBotInstancesRequest) GetFilterBotName() string {
	if x != nil {
		return x.xxx_hidden_FilterBotName
	}
	return ""
}
...
func (b0 ListBotInstancesRequest_builder) Build() *ListBotInstancesRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_FilterBotName = b.FilterBotName
...
type ListBotInstancesV2Request struct {
	...
	xxx_hidden_Filter    *ListBotInstancesV2Request_Filters `protobuf:"bytes,5,opt,name=filter,proto3"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type ListBotInstancesResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_BotInstances  *[]*BotInstance        `protobuf:"bytes,1,rep,name=bot_instances,json=botInstances,proto3"`
...
func (x *ListBotInstancesResponse) GetBotInstances() []*BotInstance {
	if x != nil {
		if x.xxx_hidden_BotInstances != nil {
			return *x.xxx_hidden_BotInstances
		}
	}
	return nil
}
...
func (b0 ListBotInstancesResponse_builder) Build() *ListBotInstancesResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_BotInstances = &b.BotInstances
...
type SubmitHeartbeatRequest struct {
	state                    protoimpl.MessageState       `protogen:"opaque.v1"`
	xxx_hidden_Heartbeat     *BotInstanceStatusHeartbeat  `protobuf:"bytes,1,opt,name=heartbeat,proto3"`
	xxx_hidden_ServiceHealth *[]*BotInstanceServiceHealth `protobuf:"bytes,2,rep,name=service_health,json=serviceHealth,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *ListBotInstancesV2Request_Filters) GetSearchTerm() string {
	if x != nil {
		return x.xxx_hidden_SearchTerm
	}
	return ""
}
