...
type ListSPIFFEFederationsResponse struct {
	state                        protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_SpiffeFederations *[]*SPIFFEFederation   `protobuf:"bytes,1,rep,name=spiffe_federations,json=spiffeFederations,proto3"`
...
func (x *ListSPIFFEFederationsResponse) GetSpiffeFederations() []*SPIFFEFederation {
	if x != nil {
		if x.xxx_hidden_SpiffeFederations != nil {
			return *x.xxx_hidden_SpiffeFederations
		}
	}
	return nil
}
...
func (x *ListSPIFFEFederationsResponse) SetSpiffeFederations(v []*SPIFFEFederation) {
	x.xxx_hidden_SpiffeFederations = &v
}
...
func (b0 ListSPIFFEFederationsResponse_builder) Build() *ListSPIFFEFederationsResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_SpiffeFederations = &b.SpiffeFederations
...
type CreateSPIFFEFederationRequest struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_SpiffeFederation *SPIFFEFederation      `protobuf:"bytes,1,opt,name=spiffe_federation,json=spiffeFederation,proto3"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *CreateSPIFFEFederationRequest) HasSpiffeFederation() bool {
	...
	return x.xxx_hidden_SpiffeFederation != nil
}

func (x *CreateSPIFFEFederationRequest) ClearSpiffeFederation() {
	x.xxx_hidden_SpiffeFederation = nil
}
...
func (b0 CreateSPIFFEFederationRequest_builder) Build() *CreateSPIFFEFederationRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_SpiffeFederation = b.SpiffeFederation
	return m0
}
