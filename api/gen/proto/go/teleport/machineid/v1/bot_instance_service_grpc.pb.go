...
func (UnimplementedBotInstanceServiceServer) ListBotInstances(context.Context, *ListBotInstancesRequest) (*ListBotInstancesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListBotInstances not implemented")
}
func (UnimplementedBotInstanceServiceServer) ListBotInstancesV2(context.Context, *ListBotInstancesV2Request) (*ListBotInstancesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListBotInstancesV2 not implemented")
}
...
func (UnimplementedBotInstanceServiceServer) SubmitHeartbeat(context.Context, *SubmitHeartbeatRequest) (*SubmitHeartbeatResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SubmitHeartbeat not implemented")
}
...
func RegisterBotInstanceServiceServer(s grpc.ServiceRegistrar, srv BotInstanceServiceServer) {
	// If the following call panics, it indicates UnimplementedBotInstanceServiceServer was
