...
func file_teleport_machineid_v1_workload_identity_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_teleport_machineid_v1_workload_identity_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_machineid_v1_workload_identity_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_machineid_v1_workload_identity_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_machineid_v1_workload_identity_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
