...
type Bot struct {
	...
	// The scope of the Bot.
	//
	// If unset, the Bot is unscoped (classic behavior) and if set, the Bot is
	// scoped. When the Bot is scoped, the `spec.roles` and `spec.traits` fields
	// must not be set.
