...
func (x *BotStatus) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *BotStatus) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
var file_teleport_machineid_v1_bot_proto_rawDesc = []byte{
	...
	0x22, 0x33, 0x0a, 0x09, 0x42, 0x6f, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x12, 0x0a,
	...
	0x04, 0x72, 0x6f, 0x6c, 0x65, 0x42, 0x56, 0x5a, 0x54, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
