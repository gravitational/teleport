...
type AccessRequestsUsage struct {
	...
	xxx_hidden_MonthlyLimit int32                  `protobuf:"varint,1,opt,name=monthly_limit,json=monthlyLimit,proto3"`
	xxx_hidden_MonthlyUsed  int32                  `protobuf:"varint,2,opt,name=monthly_used,json=monthlyUsed,proto3"`
...
func (x *AccessRequestsUsage) GetMonthlyLimit() int32 {
	if x != nil {
		return x.xxx_hidden_MonthlyLimit
	}
	return 0
}
...
func (b0 AccessRequestsUsage_builder) Build() *AccessRequestsUsage {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_MonthlyLimit = b.MonthlyLimit
	x.xxx_hidden_MonthlyUsed = b.MonthlyUsed
	return m0
}
