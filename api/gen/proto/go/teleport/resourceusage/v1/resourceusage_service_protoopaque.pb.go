...
type GetUsageResponse struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_AccessRequests   *AccessRequestsUsage   `protobuf:"bytes,1,opt,name=access_requests,json=accessRequests,proto3"`
	xxx_hidden_AccountUsageType AccountUsageType       `protobuf:"varint,2,opt,name=account_usage_type,json=accountUsageType,proto3,enum=teleport.resourceusage.v1.AccountUsageType"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *GetUsageResponse) GetAccountUsageType() AccountUsageType {
	if x != nil {
		return x.xxx_hidden_AccountUsageType
	}
...
func (x *GetUsageResponse) SetAccountUsageType(v AccountUsageType) {
	x.xxx_hidden_AccountUsageType = v
}
...
func (b0 GetUsageResponse_builder) Build() *GetUsageResponse {
	...
	x.xxx_hidden_AccountUsageType = b.AccountUsageType
	return m0
}
