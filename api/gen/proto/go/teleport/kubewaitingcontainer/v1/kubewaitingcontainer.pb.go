...
var file_teleport_kubewaitingcontainer_v1_kubewaitingcontainer_proto_goTypes = []interface{}{
...
func file_teleport_kubewaitingcontainer_v1_kubewaitingcontainer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_kubewaitingcontainer_v1_kubewaitingcontainer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KubernetesWaitingContainer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_teleport_kubewaitingcontainer_v1_kubewaitingcontainer_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KubernetesWaitingContainerSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
