...
type Spec struct {
	...
	Github *GitHubIdentity `protobuf:"bytes,6,opt,name=github,proto3" json:"github,omitempty"`
}
...
func (x *Spec) GetGithub() *GitHubIdentity {
	if x != nil {
		return x.Github
	}
	return nil
...
func (x *GitHubIdentity) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GitHubIdentity) ProtoMessage() {}

func (x *GitHubIdentity) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_userloginstate_v1_userloginstate_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GitHubIdentity.ProtoReflect.Descriptor instead.
func (*GitHubIdentity) Descriptor() ([]byte, []int) {
	return file_teleport_userloginstate_v1_userloginstate_proto_rawDescGZIP(), []int{2}
}

func (x *GitHubIdentity) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *GitHubIdentity) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
var file_teleport_userloginstate_v1_userloginstate_proto_rawDesc = []byte{
	...
	0x53, 0x70, 0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x22, 0x99, 0x02, 0x0a, 0x04, 0x53,
	...
	0x74, 0x73, 0x12, 0x42, 0x0a, 0x06, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x47, 0x69, 0x74, 0x48, 0x75, 0x62, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x52, 0x06,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x22, 0x3c, 0x0a, 0x0e, 0x47, 0x69, 0x74, 0x48, 0x75, 0x62,
	...
	0x74, 0x65, 0x2f, 0x76, 0x31, 0x3b, 0x75, 0x73, 0x65, 0x72, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_teleport_userloginstate_v1_userloginstate_proto_goTypes = []any{
	...
	(*GitHubIdentity)(nil),    // 2: teleport.userloginstate.v1.GitHubIdentity
...
var file_teleport_userloginstate_v1_userloginstate_proto_depIdxs = []int32{
	...
	2, // 4: teleport.userloginstate.v1.Spec.github:type_name -> teleport.userloginstate.v1.GitHubIdentity
...
func file_teleport_userloginstate_v1_userloginstate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_userloginstate_v1_userloginstate_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_teleport_userloginstate_v1_userloginstate_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Spec); i {
			case 0:
				return &v.state
			case 1:
		...
		file_teleport_userloginstate_v1_userloginstate_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*GitHubIdentity); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
