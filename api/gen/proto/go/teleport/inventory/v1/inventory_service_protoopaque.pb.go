...
type ListUnifiedInstancesRequest struct {
	...
	xxx_hidden_Filter    *ListUnifiedInstancesFilter `protobuf:"bytes,3,opt,name=filter,proto3"`
	xxx_hidden_Sort      UnifiedInstanceSort         `protobuf:"varint,4,opt,name=sort,proto3,enum=teleport.inventory.v1.UnifiedInstanceSort"`
	xxx_hidden_Order     SortOrder                   `protobuf:"varint,5,opt,name=order,proto3,enum=teleport.inventory.v1.SortOrder"`
...
type ListUnifiedInstancesResponse struct {
	state                    protoimpl.MessageState  `protogen:"opaque.v1"`
	xxx_hidden_Items         *[]*UnifiedInstanceItem `protobuf:"bytes,1,rep,name=items,proto3"`
...
type ListUnifiedInstancesFilter struct {
	...
	xxx_hidden_PredicateExpression string                 `protobuf:"bytes,2,opt,name=predicate_expression,json=predicateExpression,proto3"`
	xxx_hidden_InstanceTypes       []InstanceType         `protobuf:"varint,3,rep,packed,name=instance_types,json=instanceTypes,proto3,enum=teleport.inventory.v1.InstanceType"`
	xxx_hidden_Services            []string               `protobuf:"bytes,4,rep,name=services,proto3"`
	xxx_hidden_UpdaterGroups       []string               `protobuf:"bytes,5,rep,name=updater_groups,json=updaterGroups,proto3"`
	xxx_hidden_Upgraders           []string               `protobuf:"bytes,6,rep,name=upgraders,proto3"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
func (x *ListUnifiedInstancesFilter) GetUpdaterGroups() []string {
	if x != nil {
		return x.xxx_hidden_UpdaterGroups
	}
	return nil
}
...
func (b0 ListUnifiedInstancesFilter_builder) Build() *ListUnifiedInstancesFilter {
	...
	x.xxx_hidden_UpdaterGroups = b.UpdaterGroups
	x.xxx_hidden_Upgraders = b.Upgraders
	return m0
}
...
type UnifiedInstanceItem struct {
	state           protoimpl.MessageState     `protogen:"opaque.v1"`
	xxx_hidden_Item isUnifiedInstanceItem_Item `protobuf_oneof:"item"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *UnifiedInstanceItem) GetInstance() *types.InstanceV1 {
	if x != nil {
		if x, ok := x.xxx_hidden_Item.(*unifiedInstanceItem_Instance); ok {
			return x.Instance
		}
	}
	return nil
...
func (x *UnifiedInstanceItem) GetBotInstance() *v1.BotInstance {
	if x != nil {
		if x, ok := x.xxx_hidden_Item.(*unifiedInstanceItem_BotInstance); ok {
...
func (x *UnifiedInstanceItem) SetInstance(v *types.InstanceV1) {
	...
	x.xxx_hidden_Item = &unifiedInstanceItem_Instance{v}
}
...
func (x *UnifiedInstanceItem) SetBotInstance(v *v1.BotInstance) {
	...
	x.xxx_hidden_Item = &unifiedInstanceItem_BotInstance{v}
}
...
func (x *UnifiedInstanceItem) HasInstance() bool {
	...
	_, ok := x.xxx_hidden_Item.(*unifiedInstanceItem_Instance)
	return ok
}
...
func (x *UnifiedInstanceItem) HasBotInstance() bool {
	...
	_, ok := x.xxx_hidden_Item.(*unifiedInstanceItem_BotInstance)
	return ok
}
...
func (x *UnifiedInstanceItem) ClearInstance() {
	if _, ok := x.xxx_hidden_Item.(*unifiedInstanceItem_Instance); ok {
		x.xxx_hidden_Item = nil
	}
}

func (x *UnifiedInstanceItem) ClearBotInstance() {
	if _, ok := x.xxx_hidden_Item.(*unifiedInstanceItem_BotInstance); ok {
		x.xxx_hidden_Item = nil
	}
}
...
func (b0 UnifiedInstanceItem_builder) Build() *UnifiedInstanceItem {
	...
	_, _ = b, x
	if b.Instance != nil {
		x.xxx_hidden_Item = &unifiedInstanceItem_Instance{b.Instance}
	}
	if b.BotInstance != nil {
		x.xxx_hidden_Item = &unifiedInstanceItem_BotInstance{b.BotInstance}
	}
	return m0
}
