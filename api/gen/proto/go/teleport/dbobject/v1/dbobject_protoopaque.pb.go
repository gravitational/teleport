...
type DatabaseObject struct {
	...
	xxx_hidden_Spec     *DatabaseObjectSpec    `protobuf:"bytes,5,opt,name=spec,proto3"`
...
type DatabaseObjectSpec struct {
	state                          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Protocol            string                 `protobuf:"bytes,1,opt,name=protocol,proto3"`
	xxx_hidden_DatabaseServiceName string                 `protobuf:"bytes,2,opt,name=database_service_name,json=databaseServiceName,proto3"`
	xxx_hidden_ObjectKind          string                 `protobuf:"bytes,3,opt,name=object_kind,json=objectKind,proto3"`
...
func (x *DatabaseObjectSpec) GetDatabaseServiceName() string {
	if x != nil {
		return x.xxx_hidden_DatabaseServiceName
	}
	return ""
}
...
func (x *DatabaseObjectSpec) GetObjectKind() string {
	if x != nil {
		return x.xxx_hidden_ObjectKind
	}
	return ""
}
...
func (x *DatabaseObjectSpec) SetDatabaseServiceName(v string) {
	x.xxx_hidden_DatabaseServiceName = v
}

func (x *DatabaseObjectSpec) SetObjectKind(v string) {
	x.xxx_hidden_ObjectKind = v
}
...
func (b0 DatabaseObjectSpec_builder) Build() *DatabaseObjectSpec {
	...
	x.xxx_hidden_DatabaseServiceName = b.DatabaseServiceName
	x.xxx_hidden_ObjectKind = b.ObjectKind
