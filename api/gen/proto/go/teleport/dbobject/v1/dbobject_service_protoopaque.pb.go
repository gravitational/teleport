...
type CreateDatabaseObjectRequest struct {
	...
	xxx_hidden_Object *DatabaseObject        `protobuf:"bytes,1,opt,name=object,proto3"`
...
type ListDatabaseObjectsResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Objects       *[]*DatabaseObject     `protobuf:"bytes,1,rep,name=objects,proto3"`
...
const file_teleport_dbobject_v1_dbobject_service_proto_rawDesc = "" +
	"\n" +
	"+teleport/dbobject/v1/dbobject_service.proto\x12\x14teleport.dbobject.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a#teleport/dbobject/v1/dbobject.proto\"[\n" +
	"\x1bCreateDatabaseObjectRequest\x12<\n" +
	"\x06object\x18\x01 \x01(\v2$.teleport.dbobject.v1.DatabaseObjectR\x06object\".\n" +
	"\x18GetDatabaseObjectRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"X\n" +
	"\x1aListDatabaseObjectsRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\"\x85\x01\n" +
	"\x1bListDatabaseObjectsResponse\x12>\n" +
	"\aobjects\x18\x01 \x03(\v2$.teleport.dbobject.v1.DatabaseObjectR\aobjects\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"[\n" +
	"\x1bUpdateDatabaseObjectRequest\x12<\n" +
	"\x06object\x18\x01 \x01(\v2$.teleport.dbobject.v1.DatabaseObjectR\x06object\"[\n" +
	"\x1bUpsertDatabaseObjectRequest\x12<\n" +
	"\x06object\x18\x01 \x01(\v2$.teleport.dbobject.v1.DatabaseObjectR\x06object\"1\n" +
	"\x1bDeleteDatabaseObjectRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name2\xb4\x05\n" +
	"\x15DatabaseObjectService\x12i\n" +
	"\x11GetDatabaseObject\x12..teleport.dbobject.v1.GetDatabaseObjectRequest\x1a$.teleport.dbobject.v1.DatabaseObject\x12z\n" +
	"\x13ListDatabaseObjects\x120.teleport.dbobject.v1.ListDatabaseObjectsRequest\x1a1.teleport.dbobject.v1.ListDatabaseObjectsResponse\x12o\n" +
	"\x14CreateDatabaseObject\x121.teleport.dbobject.v1.CreateDatabaseObjectRequest\x1a$.teleport.dbobject.v1.DatabaseObject\x12o\n" +
...
func file_teleport_dbobject_v1_dbobject_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_teleport_dbobject_v1_dbobject_service_proto_rawDesc), len(file_teleport_dbobject_v1_dbobject_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
