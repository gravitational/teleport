...
func file_teleport_dbobject_v1_dbobject_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_dbobject_v1_dbobject_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_teleport_dbobject_v1_dbobject_proto_msgTypes[1].Exporter = func(v any, i int) any {
