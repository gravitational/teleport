...
type WrappedKey struct {
	...
	// KeyEncryptionPair is the asymmetric keypair used to wrap the
	...
	// State represents what state a given WrappedKey is currently in.
...
type KeySet struct {
	...
	// be at least one wrapped key per active keystore configured within the cluster.
...
func (x *KeySet) GetActiveKeys() []*WrappedKey {
	if x != nil {
		return x.ActiveKeys
	}
	return nil
...
type RecordingEncryptionSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// KeySet is the active set of WrappedKeys that should be used for encrypting new session recordings.
	KeySet        *KeySet `protobuf:"bytes,1,opt,name=key_set,json=keySet,proto3" json:"key_set,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RecordingEncryptionSpec) GetKeySet() *KeySet {
	if x != nil {
		return x.KeySet
	}
	return nil
...
type RotatedKeysSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// PublicKey is the Bech32 encoded age X25519 public key that should be used to identify relevant rotated keys.
	PublicKey string `protobuf:"bytes,1,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"`
	// Keys are the rotated WrappedKeys associated with the given PublicKey.
...
const file_teleport_recordingencryption_v1_recording_encryption_proto_rawDesc = "" +
	...
	"\x05state\x18\x03 \x01(\x0e2).teleport.recordingencryption.v1.KeyStateR\x05state\"V\n" +
	"\x06KeySet\x12L\n" +
...
var file_teleport_recordingencryption_v1_recording_encryption_proto_goTypes = []any{
	...
	(*KeySet)(nil),                    // 2: teleport.recordingencryption.v1.KeySet
