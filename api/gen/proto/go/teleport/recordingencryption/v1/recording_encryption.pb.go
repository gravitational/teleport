...
// KeyState represents the possible states a WrappedKey can be in.
type KeyState int32
...
const (
	...
	KeyState_KEY_STATE_ROTATED KeyState = 3
)
...
type WrappedKey struct {
	...
	State         KeyState `protobuf:"varint,3,opt,name=state,proto3,enum=teleport.recordingencryption.v1.KeyState" json:"state,omitempty"`
...
func (x *WrappedKey) GetState() KeyState {
	if x != nil {
		return x.State
	}
...
const file_teleport_recordingencryption_v1_recording_encryption_proto_rawDesc = "" +
	"\n" +
	":teleport/recordingencryption/v1/recording_encryption.proto\x12\x1fteleport.recordingencryption.v1\x1a!teleport/header/v1/metadata.proto\x1a!teleport/legacy/types/types.proto\"\xed\x01\n" +
	"\n" +
	"WrappedKey\x12T\n" +
	"\x19recording_encryption_pair\x18\x01 \x01(\v2\x18.types.EncryptionKeyPairR\x17recordingEncryptionPair\x12H\n" +
	"\x13key_encryption_pair\x18\x02 \x01(\v2\x18.types.EncryptionKeyPairR\x11keyEncryptionPair\x12?\n" +
	"\x05state\x18\x03 \x01(\x0e2).teleport.recordingencryption.v1.KeyStateR\x05state\"g\n" +
	...
	"\x12KEY_STATE_ROTATING\x10\x02\x12\x15\n" +
	"\x11KEY_STATE_ROTATED\x10\x03BjZhgithub.com/gravitational/teleport/api/gen/proto/go/teleport/recordingencryption/v1;recordingencryptionv1b\x06proto3"
...
var file_teleport_recordingencryption_v1_recording_encryption_proto_goTypes = []any{
	...
	(*types.EncryptionKeyPair)(nil),   // 5: types.EncryptionKeyPair
...
var file_teleport_recordingencryption_v1_recording_encryption_proto_depIdxs = []int32{
	5, // 0: teleport.recordingencryption.v1.WrappedKey.recording_encryption_pair:type_name -> types.EncryptionKeyPair
	5, // 1: teleport.recordingencryption.v1.WrappedKey.key_encryption_pair:type_name -> types.EncryptionKeyPair
	0, // 2: teleport.recordingencryption.v1.WrappedKey.state:type_name -> teleport.recordingencryption.v1.KeyState
	1, // 3: teleport.recordingencryption.v1.RecordingEncryptionSpec.active_keys:type_name -> teleport.recordingencryption.v1.WrappedKey
	6, // 4: teleport.recordingencryption.v1.RecordingEncryption.metadata:type_name -> teleport.header.v1.Metadata
	2, // 5: teleport.recordingencryption.v1.RecordingEncryption.spec:type_name -> teleport.recordingencryption.v1.RecordingEncryptionSpec
	3, // 6: teleport.recordingencryption.v1.RecordingEncryption.status:type_name -> teleport.recordingencryption.v1.RecordingEncryptionStatus
