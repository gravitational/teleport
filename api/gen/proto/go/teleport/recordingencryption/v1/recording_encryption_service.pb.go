...
type AgeEncryptionKeyWithState struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	KeyState      KeyState `protobuf:"varint,2,opt,name=key_state,json=keyState,proto3,enum=teleport.recordingencryption.v1.KeyState" json:"key_state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AgeEncryptionKeyWithState) Reset() {
	*x = AgeEncryptionKeyWithState{}
	mi := &file_teleport_recordingencryption_v1_recording_encryption_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AgeEncryptionKeyWithState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AgeEncryptionKeyWithState) ProtoMessage() {}

func (x *AgeEncryptionKeyWithState) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_recordingencryption_v1_recording_encryption_service_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AgeEncryptionKeyWithState.ProtoReflect.Descriptor instead.
func (*AgeEncryptionKeyWithState) Descriptor() ([]byte, []int) {
	return file_teleport_recordingencryption_v1_recording_encryption_service_proto_rawDescGZIP(), []int{3}
}

func (x *AgeEncryptionKeyWithState) GetPublicKey() []byte {
	if x != nil {
		return x.PublicKey
	}
	return nil
...
func (x *AgeEncryptionKeyWithState) GetKeyState() KeyState {
	if x != nil {
		return x.KeyState
	}
...
// in the RecordingEncryption resource.
type GetRotationStateResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Keys contain the current KeyState of all WrappedKeys in the RecordingEncryption resource.
	Keys          []*AgeEncryptionKeyWithState `protobuf:"bytes,1,rep,name=keys,proto3" json:"keys,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetRotationStateResponse) GetKeys() []*AgeEncryptionKeyWithState {
	if x != nil {
		return x.Keys
	}
	return nil
...
const file_teleport_recordingencryption_v1_recording_encryption_service_proto_rawDesc = "" +
	...
	"\x17GetRotationStateRequest\"\x82\x01\n" +
	"\x19AgeEncryptionKeyWithState\x12\x1d\n" +
	"\n" +
	"public_key\x18\x01 \x01(\fR\tpublicKey\x12F\n" +
	"\tkey_state\x18\x02 \x01(\x0e2).teleport.recordingencryption.v1.KeyStateR\bkeyState\"j\n" +
	"\x18GetRotationStateResponse\x12N\n" +
	"\x04keys\x18\x01 \x03(\v2:.teleport.recordingencryption.v1.AgeEncryptionKeyWithStateR\x04keys\"\x19\n" +
...
var file_teleport_recordingencryption_v1_recording_encryption_service_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_teleport_recordingencryption_v1_recording_encryption_service_proto_goTypes = []any{
	...
	(*AgeEncryptionKeyWithState)(nil),        // 3: teleport.recordingencryption.v1.AgeEncryptionKeyWithState
	(*GetRotationStateResponse)(nil),         // 4: teleport.recordingencryption.v1.GetRotationStateResponse
	(*CompleteRotationRequest)(nil),          // 5: teleport.recordingencryption.v1.CompleteRotationRequest
	(*CompleteRotationResponse)(nil),         // 6: teleport.recordingencryption.v1.CompleteRotationResponse
	(*UploadEncryptedRecordingRequest)(nil),  // 7: teleport.recordingencryption.v1.UploadEncryptedRecordingRequest
	(*UploadEncryptedRecordingResponse)(nil), // 8: teleport.recordingencryption.v1.UploadEncryptedRecordingResponse
	(KeyState)(0),                            // 9: teleport.recordingencryption.v1.KeyState
}
var file_teleport_recordingencryption_v1_recording_encryption_service_proto_depIdxs = []int32{
	9, // 0: teleport.recordingencryption.v1.AgeEncryptionKeyWithState.key_state:type_name -> teleport.recordingencryption.v1.KeyState
	3, // 1: teleport.recordingencryption.v1.GetRotationStateResponse.keys:type_name -> teleport.recordingencryption.v1.AgeEncryptionKeyWithState
	0, // 2: teleport.recordingencryption.v1.RecordingEncryptionService.RotateKeySet:input_type -> teleport.recordingencryption.v1.RotateKeySetRequest
	2, // 3: teleport.recordingencryption.v1.RecordingEncryptionService.GetRotationState:input_type -> teleport.recordingencryption.v1.GetRotationStateRequest
	5, // 4: teleport.recordingencryption.v1.RecordingEncryptionService.CompleteRotation:input_type -> teleport.recordingencryption.v1.CompleteRotationRequest
	7, // 5: teleport.recordingencryption.v1.RecordingEncryptionService.UploadEncryptedRecording:input_type -> teleport.recordingencryption.v1.UploadEncryptedRecordingRequest
	1, // 6: teleport.recordingencryption.v1.RecordingEncryptionService.RotateKeySet:output_type -> teleport.recordingencryption.v1.RotateKeySetResponse
	4, // 7: teleport.recordingencryption.v1.RecordingEncryptionService.GetRotationState:output_type -> teleport.recordingencryption.v1.GetRotationStateResponse
	6, // 8: teleport.recordingencryption.v1.RecordingEncryptionService.CompleteRotation:output_type -> teleport.recordingencryption.v1.CompleteRotationResponse
	8, // 9: teleport.recordingencryption.v1.RecordingEncryptionService.UploadEncryptedRecording:output_type -> teleport.recordingencryption.v1.UploadEncryptedRecordingResponse
