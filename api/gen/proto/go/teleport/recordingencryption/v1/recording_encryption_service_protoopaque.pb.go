...
type AuditQueueSealedBatch struct {
	...
	xxx_hidden_Format     AuditQueueBatchFormat  `protobuf:"varint,2,opt,name=format,proto3,enum=teleport.recordingencryption.v1.AuditQueueBatchFormat"`
	xxx_hidden_EventCount int64                  `protobuf:"varint,3,opt,name=event_count,json=eventCount,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type SubmitAuditQueueBatchRequest struct {
	state              protoimpl.MessageState    `protogen:"opaque.v1"`
	xxx_hidden_Batches *[]*AuditQueueSealedBatch `protobuf:"bytes,1,rep,name=batches,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
