...
func (UnimplementedRecordingEncryptionServiceServer) GetRotationState(context.Context, *GetRotationStateRequest) (*GetRotationStateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRotationState not implemented")
}
func (UnimplementedRecordingEncryptionServiceServer) CompleteRotation(context.Context, *CompleteRotationRequest) (*CompleteRotationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CompleteRotation not implemented")
}
func (UnimplementedRecordingEncryptionServiceServer) RollbackRotation(context.Context, *RollbackRotationRequest) (*RollbackRotationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RollbackRotation not implemented")
}
...
func RegisterRecordingEncryptionServiceServer(s grpc.ServiceRegistrar, srv RecordingEncryptionServiceServer) {
	// If the following call panics, it indicates UnimplementedRecordingEncryptionServiceServer was
