...
var file_teleport_transport_v1_transport_service_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x42, 0x4a, 0x5a, 0x48, 0x67, 0x69, 0x74,
...
var file_teleport_transport_v1_transport_service_proto_goTypes = []interface{}{
...
func file_teleport_transport_v1_transport_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_transport_v1_transport_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_transport_v1_transport_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_transport_v1_transport_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_transport_v1_transport_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_transport_v1_transport_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Frame); i {
			case 0:
				return &v.state
			case 1:
		...
		file_teleport_transport_v1_transport_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_transport_v1_transport_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_transport_v1_transport_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_transport_v1_transport_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	file_teleport_transport_v1_transport_service_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*ProxySSHRequest_Ssh)(nil),
		(*ProxySSHRequest_Agent)(nil),
	}
	file_teleport_transport_v1_transport_service_proto_msgTypes[1].OneofWrappers = []interface{}{
