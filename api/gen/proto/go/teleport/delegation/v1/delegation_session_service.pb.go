...
const file_teleport_delegation_v1_delegation_session_service_proto_rawDesc = "" +
	"\n" +
	"7teleport/delegation/v1/delegation_session_service.proto\x12\x16teleport.delegation.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa7\x03\n" +
	...
	"\x15delegation_session_id\x18\x01 \x01(\tR\x13delegationSessionId2\xf9\x01\n" +
...
var file_teleport_delegation_v1_delegation_session_service_proto_goTypes = []any{
	...
	(*TerminateDelegationSessionRequest)(nil), // 4: teleport.delegation.v1.TerminateDelegationSessionRequest
...
var file_teleport_delegation_v1_delegation_session_service_proto_depIdxs = []int32{
	...
	4, // 4: teleport.delegation.v1.DelegationSessionService.TerminateDelegationSession:input_type -> teleport.delegation.v1.TerminateDelegationSessionRequest
	3, // 5: teleport.delegation.v1.DelegationSessionService.GenerateCerts:output_type -> teleport.delegation.v1.GenerateCertsResponse
	6, // 6: teleport.delegation.v1.DelegationSessionService.TerminateDelegationSession:output_type -> google.protobuf.Empty
