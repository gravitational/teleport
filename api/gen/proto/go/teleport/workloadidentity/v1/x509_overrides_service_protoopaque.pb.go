...
type SignX509IssuerCSRRequest struct {
	...
	xxx_hidden_CsrCreationMode CSRCreationMode        `protobuf:"varint,2,opt,name=csr_creation_mode,json=csrCreationMode,proto3,enum=teleport.workloadidentity.v1.CSRCreationMode"`
...
func (x *SignX509IssuerCSRRequest) GetCsrCreationMode() CSRCreationMode {
	if x != nil {
		return x.xxx_hidden_CsrCreationMode
	}
...
func (x *SignX509IssuerCSRRequest) SetCsrCreationMode(v CSRCreationMode) {
	x.xxx_hidden_CsrCreationMode = v
}
...
func (b0 SignX509IssuerCSRRequest_builder) Build() *SignX509IssuerCSRRequest {
	...
	x.xxx_hidden_CsrCreationMode = b.CsrCreationMode
	return m0
}
...
type SignX509IssuerCSRResponse struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Csr []byte                 `protobuf:"bytes,1,opt,name=csr,proto3"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type ListX509IssuerOverridesResponse struct {
	state                          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_X509IssuerOverrides *[]*X509IssuerOverride `protobuf:"bytes,1,rep,name=x509_issuer_overrides,json=x509IssuerOverrides,proto3"`
...
func (x *ListX509IssuerOverridesResponse) GetX509IssuerOverrides() []*X509IssuerOverride {
	if x != nil {
		if x.xxx_hidden_X509IssuerOverrides != nil {
			return *x.xxx_hidden_X509IssuerOverrides
		}
	}
	return nil
}
...
func (x *ListX509IssuerOverridesResponse) SetX509IssuerOverrides(v []*X509IssuerOverride) {
	x.xxx_hidden_X509IssuerOverrides = &v
}
...
func (b0 ListX509IssuerOverridesResponse_builder) Build() *ListX509IssuerOverridesResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_X509IssuerOverrides = &b.X509IssuerOverrides
...
type CreateX509IssuerOverrideRequest struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_X509IssuerOverride *X509IssuerOverride    `protobuf:"bytes,1,opt,name=x509_issuer_override,json=x509IssuerOverride,proto3"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *CreateX509IssuerOverrideRequest) HasX509IssuerOverride() bool {
	...
	return x.xxx_hidden_X509IssuerOverride != nil
}

func (x *CreateX509IssuerOverrideRequest) ClearX509IssuerOverride() {
	x.xxx_hidden_X509IssuerOverride = nil
}
...
func (b0 CreateX509IssuerOverrideRequest_builder) Build() *CreateX509IssuerOverrideRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_X509IssuerOverride = b.X509IssuerOverride
	return m0
}
