...
// WorkloadIdentityX509Revocation blah blah.
type WorkloadIdentityX509Revocation struct {
	...
	// The configured properties of the WorkloadIdentityX509RevocationEntry
...
var file_teleport_workloadidentity_v1_revocation_resource_proto_rawDesc = string([]byte{
