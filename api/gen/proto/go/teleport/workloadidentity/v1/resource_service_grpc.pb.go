...
func (UnimplementedWorkloadIdentityResourceServiceServer) UpsertWorkloadIdentity(context.Context, *UpsertWorkloadIdentityRequest) (*WorkloadIdentity, error) {
	return nil, status.Error(codes.Unimplemented, "method UpsertWorkloadIdentity not implemented")
}
...
func (UnimplementedWorkloadIdentityResourceServiceServer) ListWorkloadIdentitiesV2(context.Context, *ListWorkloadIdentitiesV2Request) (*ListWorkloadIdentitiesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListWorkloadIdentitiesV2 not implemented")
}
...
func RegisterWorkloadIdentityResourceServiceServer(s grpc.ServiceRegistrar, srv WorkloadIdentityResourceServiceServer) {
	// If the following call panics, it indicates UnimplementedWorkloadIdentityResourceServiceServer was
