...
const file_teleport_workloadidentity_v1_resource_proto_rawDesc = "" +
	"\n" +
	"+teleport/workloadidentity/v1/resource.proto\x12\x1cteleport.workloadidentity.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a!teleport/header/v1/metadata.proto\"\xdd\x01\n" +
	...
	"\x13organizational_unit\x18\x03 \x01(\tR\x12organizationalUnit\"\x9f\x01\n" +
	"\x1aWorkloadIdentitySPIFFEX509\x12\x19\n" +
	"\bdns_sans\x18\x01 \x03(\tR\adnsSans\x12f\n" +
	"\x10subject_template\x18\x02 \x01(\v2;.teleport.workloadidentity.v1.X509DistinguishedNameTemplateR\x0fsubjectTemplate\"W\n" +
	"\x19WorkloadIdentitySPIFFEJWT\x12:\n" +
	"\fextra_claims\x18\x01 \x01(\v2\x17.google.protobuf.StructR\vextraClaims\"\xd5\x01\n" +
