...
// Deprecated: Use JoinAttrsGenericOIDC.ProtoReflect.Descriptor instead.
func (*JoinAttrsGenericOIDC) Descriptor() ([]byte, []int) {
	return file_teleport_workloadidentity_v1_join_attrs_proto_rawDescGZIP(), []int{20}
}
