...
type WorkloadIdentityX509Revocation struct {
	...
	xxx_hidden_Spec     *WorkloadIdentityX509RevocationSpec `protobuf:"bytes,5,opt,name=spec,proto3"`
...
type WorkloadIdentityX509RevocationSpec struct {
	...
	xxx_hidden_RevokedAt *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=revoked_at,json=revokedAt,proto3"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
