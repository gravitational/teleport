...
type CreateWorkloadIdentityRequest struct {
	...
	xxx_hidden_WorkloadIdentity *WorkloadIdentity      `protobuf:"bytes,1,opt,name=workload_identity,json=workloadIdentity,proto3"`
...
func (x *CreateWorkloadIdentityRequest) GetWorkloadIdentity() *WorkloadIdentity {
	if x != nil {
		return x.xxx_hidden_WorkloadIdentity
	}
	return nil
}
...
type ListWorkloadIdentitiesV2Request struct {
	...
	xxx_hidden_SortDesc         bool                   `protobuf:"varint,4,opt,name=sort_desc,json=sortDesc,proto3"`
	xxx_hidden_FilterSearchTerm string                 `protobuf:"bytes,5,opt,name=filter_search_term,json=filterSearchTerm,proto3"`
...
func (x *ListWorkloadIdentitiesV2Request) GetFilterSearchTerm() string {
	if x != nil {
		return x.xxx_hidden_FilterSearchTerm
	}
	return ""
}

func (x *ListWorkloadIdentitiesV2Request) GetScopeFilter() *v1.Filter {
	if x != nil {
...
func (x *ListWorkloadIdentitiesV2Request) SetSortDesc(v bool) {
	x.xxx_hidden_SortDesc = v
}

func (x *ListWorkloadIdentitiesV2Request) SetFilterSearchTerm(v string) {
	x.xxx_hidden_FilterSearchTerm = v
}

func (x *ListWorkloadIdentitiesV2Request) SetScopeFilter(v *v1.Filter) {
	x.xxx_hidden_ScopeFilter = v
}

func (x *ListWorkloadIdentitiesV2Request) HasScopeFilter() bool {
	if x == nil {
		return false
	}
...
func (x *ListWorkloadIdentitiesV2Request) ClearScopeFilter() {
...
type ListWorkloadIdentitiesV2Request_builder struct {
	...
	// scope_filter selects WorkloadIdentities by scope. Defaults to one of EXACT
	// or UNSCOPED depending on whether the caller is a scoped or unscoped
	// identity. Exhaustive user-facing views (e.g. `tctl get`) should specify
	// mode ALL.
...
func (b0 ListWorkloadIdentitiesV2Request_builder) Build() *ListWorkloadIdentitiesV2Request {
	...
	x.xxx_hidden_SortDesc = b.SortDesc
	x.xxx_hidden_FilterSearchTerm = b.FilterSearchTerm
...
type ListWorkloadIdentitiesResponse struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_WorkloadIdentities *[]*WorkloadIdentity   `protobuf:"bytes,1,rep,name=workload_identities,json=workloadIdentities,proto3"`
...
func (x *ListWorkloadIdentitiesResponse) GetWorkloadIdentities() []*WorkloadIdentity {
	if x != nil {
		if x.xxx_hidden_WorkloadIdentities != nil {
			return *x.xxx_hidden_WorkloadIdentities
		}
	}
	return nil
}
...
func (x *ListWorkloadIdentitiesResponse) SetWorkloadIdentities(v []*WorkloadIdentity) {
	x.xxx_hidden_WorkloadIdentities = &v
}
...
func (b0 ListWorkloadIdentitiesResponse_builder) Build() *ListWorkloadIdentitiesResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_WorkloadIdentities = &b.WorkloadIdentities
...
const file_teleport_workloadidentity_v1_resource_service_proto_rawDesc = "" +
	"\n" +
	"3teleport/workloadidentity/v1/resource_service.proto\x12\x1cteleport.workloadidentity.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fteleport/scopes/v1/scopes.proto\x1a+teleport/workloadidentity/v1/resource.proto\"|\n" +
	...
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\"\x86\x02\n" +
	...
	"\x12filter_search_term\x18\x05 \x01(\tR\x10filterSearchTerm\x12=\n" +
	"\fscope_filter\x18\x06 \x01(\v2\x1a.teleport.scopes.v1.FilterR\vscopeFilter\"\xa9\x01\n" +
...
var file_teleport_workloadidentity_v1_resource_service_proto_goTypes = []any{
	...
	(*v1.Filter)(nil),                       // 9: teleport.scopes.v1.Filter
...
var file_teleport_workloadidentity_v1_resource_service_proto_depIdxs = []int32{
	...
	9,  // 3: teleport.workloadidentity.v1.ListWorkloadIdentitiesV2Request.scope_filter:type_name -> teleport.scopes.v1.Filter
