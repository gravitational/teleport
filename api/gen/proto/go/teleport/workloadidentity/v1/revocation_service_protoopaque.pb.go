...
type CreateWorkloadIdentityX509RevocationRequest struct {
	...
	xxx_hidden_WorkloadIdentityX509Revocation *WorkloadIdentityX509Revocation `protobuf:"bytes,1,opt,name=workload_identity_x509_revocation,json=workloadIdentityX509Revocation,proto3"`
...
func (x *CreateWorkloadIdentityX509RevocationRequest) HasWorkloadIdentityX509Revocation() bool {
	...
	return x.xxx_hidden_WorkloadIdentityX509Revocation != nil
}

func (x *CreateWorkloadIdentityX509RevocationRequest) ClearWorkloadIdentityX509Revocation() {
	x.xxx_hidden_WorkloadIdentityX509Revocation = nil
}
...
func (b0 CreateWorkloadIdentityX509RevocationRequest_builder) Build() *CreateWorkloadIdentityX509RevocationRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_WorkloadIdentityX509Revocation = b.WorkloadIdentityX509Revocation
	return m0
}
...
type ListWorkloadIdentityX509RevocationsResponse struct {
	state                                      protoimpl.MessageState             `protogen:"opaque.v1"`
	xxx_hidden_WorkloadIdentityX509Revocations *[]*WorkloadIdentityX509Revocation `protobuf:"bytes,1,rep,name=workload_identity_x509_revocations,json=workloadIdentityX509Revocations,proto3"`
...
func (x *ListWorkloadIdentityX509RevocationsResponse) GetWorkloadIdentityX509Revocations() []*WorkloadIdentityX509Revocation {
	if x != nil {
		if x.xxx_hidden_WorkloadIdentityX509Revocations != nil {
			return *x.xxx_hidden_WorkloadIdentityX509Revocations
		}
	}
	return nil
}
...
func (x *ListWorkloadIdentityX509RevocationsResponse) SetWorkloadIdentityX509Revocations(v []*WorkloadIdentityX509Revocation) {
	x.xxx_hidden_WorkloadIdentityX509Revocations = &v
}
...
func (b0 ListWorkloadIdentityX509RevocationsResponse_builder) Build() *ListWorkloadIdentityX509RevocationsResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_WorkloadIdentityX509Revocations = &b.WorkloadIdentityX509Revocations
...
type StreamSignedCRLResponse struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Crl []byte                 `protobuf:"bytes,1,opt,name=crl,proto3"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
