...
type CreateSigstorePolicyRequest struct {
	...
	xxx_hidden_SigstorePolicy *SigstorePolicy        `protobuf:"bytes,1,opt,name=sigstore_policy,json=sigstorePolicy,proto3"`
...
func (x *CreateSigstorePolicyRequest) HasSigstorePolicy() bool {
	...
	return x.xxx_hidden_SigstorePolicy != nil
}

func (x *CreateSigstorePolicyRequest) ClearSigstorePolicy() {
	x.xxx_hidden_SigstorePolicy = nil
}
...
func (b0 CreateSigstorePolicyRequest_builder) Build() *CreateSigstorePolicyRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_SigstorePolicy = b.SigstorePolicy
	return m0
}
...
type ListSigstorePoliciesResponse struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_SigstorePolicies *[]*SigstorePolicy     `protobuf:"bytes,1,rep,name=sigstore_policies,json=sigstorePolicies,proto3"`
...
func (x *ListSigstorePoliciesResponse) GetSigstorePolicies() []*SigstorePolicy {
	if x != nil {
		if x.xxx_hidden_SigstorePolicies != nil {
			return *x.xxx_hidden_SigstorePolicies
		}
	}
	return nil
}
...
func (x *ListSigstorePoliciesResponse) SetSigstorePolicies(v []*SigstorePolicy) {
	x.xxx_hidden_SigstorePolicies = &v
}
...
func (b0 ListSigstorePoliciesResponse_builder) Build() *ListSigstorePoliciesResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_SigstorePolicies = &b.SigstorePolicies
