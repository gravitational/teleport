...
func (UnimplementedWorkloadIdentityIssuanceServiceServer) IssueWorkloadIdentity(context.Context, *IssueWorkloadIdentityRequest) (*IssueWorkloadIdentityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IssueWorkloadIdentity not implemented")
}
func (UnimplementedWorkloadIdentityIssuanceServiceServer) IssueWorkloadIdentities(context.Context, *IssueWorkloadIdentitiesRequest) (*IssueWorkloadIdentitiesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IssueWorkloadIdentities not implemented")
}
func (UnimplementedWorkloadIdentityIssuanceServiceServer) IssueTeleportWorkloadIdentity(context.Context, *IssueTeleportWorkloadIdentityRequest) (*IssueTeleportWorkloadIdentityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IssueTeleportWorkloadIdentity not implemented")
}
...
func RegisterWorkloadIdentityIssuanceServiceServer(s grpc.ServiceRegistrar, srv WorkloadIdentityIssuanceServiceServer) {
	// If the following call panics, it indicates UnimplementedWorkloadIdentityIssuanceServiceServer was
