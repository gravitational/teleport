...
type ListStaticHostUsersResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Users         *[]*StaticHostUser     `protobuf:"bytes,1,rep,name=users,proto3"`
...
type CreateStaticHostUserRequest struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_User *StaticHostUser        `protobuf:"bytes,1,opt,name=user,proto3"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type UpdateStaticHostUserRequest struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_User *StaticHostUser        `protobuf:"bytes,2,opt,name=user,proto3"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
