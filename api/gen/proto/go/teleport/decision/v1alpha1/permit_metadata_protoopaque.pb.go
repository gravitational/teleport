...
type PermitMetadata struct {
	...
	xxx_hidden_FeatureAssertions []EnforcementFeature   `protobuf:"varint,1,rep,packed,name=feature_assertions,json=featureAssertions,proto3,enum=teleport.decision.v1alpha1.EnforcementFeature"`
	xxx_hidden_PdpVersion        string                 `protobuf:"bytes,2,opt,name=pdp_version,json=pdpVersion,proto3"`
...
func (x *PermitMetadata) GetFeatureAssertions() []EnforcementFeature {
	if x != nil {
		return x.xxx_hidden_FeatureAssertions
	}
	return nil
}
...
func (b0 PermitMetadata_builder) Build() *PermitMetadata {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_FeatureAssertions = b.FeatureAssertions
	x.xxx_hidden_PdpVersion = b.PdpVersion
	return m0
}
...
const file_teleport_decision_v1alpha1_permit_metadata_proto_rawDesc = "" +
	"\n" +
	"0teleport/decision/v1alpha1/permit_metadata.proto\x12\x1ateleport.decision.v1alpha1\x1a4teleport/decision/v1alpha1/enforcement_feature.proto\"\x90\x01\n" +
	"\x0ePermitMetadata\x12]\n" +
...
func file_teleport_decision_v1alpha1_permit_metadata_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_teleport_decision_v1alpha1_permit_metadata_proto_rawDesc), len(file_teleport_decision_v1alpha1_permit_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
