...
type RequestMetadata struct {
	...
	xxx_hidden_FeatureAssertions []DecisionFeature      `protobuf:"varint,1,rep,packed,name=feature_assertions,json=featureAssertions,proto3,enum=teleport.decision.v1alpha1.DecisionFeature"`
	xxx_hidden_PepVersionHint    string                 `protobuf:"bytes,2,opt,name=pep_version_hint,json=pepVersionHint,proto3"`
	xxx_hidden_DryRun            bool                   `protobuf:"varint,3,opt,name=dry_run,json=dryRun,proto3"`
	xxx_hidden_DryRunOptions     *DryRunOptions         `protobuf:"bytes,4,opt,name=dry_run_options,json=dryRunOptions,proto3"`
...
func (x *RequestMetadata) GetPepVersionHint() string {
	if x != nil {
		return x.xxx_hidden_PepVersionHint
	}
	return ""
}
...
func (x *RequestMetadata) GetDryRunOptions() *DryRunOptions {
	if x != nil {
		return x.xxx_hidden_DryRunOptions
	}
	return nil
}
...
func (x *RequestMetadata) HasDryRunOptions() bool {
	...
	return x.xxx_hidden_DryRunOptions != nil
}

func (x *RequestMetadata) ClearDryRunOptions() {
	x.xxx_hidden_DryRunOptions = nil
}
...
func (b0 RequestMetadata_builder) Build() *RequestMetadata {
	...
	x.xxx_hidden_PepVersionHint = b.PepVersionHint
	x.xxx_hidden_DryRun = b.DryRun
	x.xxx_hidden_DryRunOptions = b.DryRunOptions
	return m0
}
...
type DryRunOptions struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_GenerateIdentity *DryRunIdentity        `protobuf:"bytes,1,opt,name=generate_identity,json=generateIdentity,proto3"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *DryRunOptions) GetGenerateIdentity() *DryRunIdentity {
	if x != nil {
		return x.xxx_hidden_GenerateIdentity
	}
	return nil
}

func (x *DryRunOptions) SetGenerateIdentity(v *DryRunIdentity) {
	x.xxx_hidden_GenerateIdentity = v
}
...
func (x *DryRunOptions) HasGenerateIdentity() bool {
	...
	return x.xxx_hidden_GenerateIdentity != nil
}

func (x *DryRunOptions) ClearGenerateIdentity() {
	x.xxx_hidden_GenerateIdentity = nil
}
...
func (b0 DryRunOptions_builder) Build() *DryRunOptions {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_GenerateIdentity = b.GenerateIdentity
	return m0
}
