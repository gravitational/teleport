...
const file_teleport_decision_v1alpha1_decision_service_proto_rawDesc = "" +
	"\n" +
	"1teleport/decision/v1alpha1/decision_service.proto\x12\x1ateleport.decision.v1alpha1\x1a0teleport/decision/v1alpha1/database_access.proto\x1a+teleport/decision/v1alpha1/ssh_access.proto2\xa6\x02\n" +
	"\x0fDecisionService\x12\x80\x01\n" +
	"\x11EvaluateSSHAccess\x124.teleport.decision.v1alpha1.EvaluateSSHAccessRequest\x1a5.teleport.decision.v1alpha1.EvaluateSSHAccessResponse\x12\x8f\x01\n" +
