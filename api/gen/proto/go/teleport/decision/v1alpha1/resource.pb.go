...
// Resource is the conventional reference type used to refer to the "object" of an action that is
// being considered for an authorization decision. For example, a call to EvaluateSSHAccess
// would use the Resource type to reference the ssh node being accessed.
type Resource struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Kind is the type of the resource. Wether or not this field is required depends on
	// wether the request is for a method that supports multiple types. Typically safe to omit.
	Kind string `protobuf:"bytes,1,opt,name=kind,proto3" json:"kind,omitempty"`
	// SubKind is the subtype of the resource. This is usually not required as most resource
	// types either don't have subkinds, or their subkinds do not have an effect on authorization
	// decisions.
	SubKind string `protobuf:"bytes,2,opt,name=sub_kind,json=subKind,proto3" json:"sub_kind,omitempty"`
	// Name is the unique name of the resource. This is usually required.
...
var file_teleport_decision_v1alpha1_resource_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1a, 0x74, 0x65, 0x6c,
	0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x64, 0x65, 0x63, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x76,
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x22, 0x4d, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75,
	...
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x60, 0x5a, 0x5e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var (
	...
	file_teleport_decision_v1alpha1_resource_proto_rawDescData = file_teleport_decision_v1alpha1_resource_proto_rawDesc
)
...
func file_teleport_decision_v1alpha1_resource_proto_rawDescGZIP() []byte {
	file_teleport_decision_v1alpha1_resource_proto_rawDescOnce.Do(func() {
		file_teleport_decision_v1alpha1_resource_proto_rawDescData = protoimpl.X.CompressGZIP(file_teleport_decision_v1alpha1_resource_proto_rawDescData)
	})
...
func file_teleport_decision_v1alpha1_resource_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_teleport_decision_v1alpha1_resource_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_teleport_decision_v1alpha1_resource_proto_rawDesc = nil
