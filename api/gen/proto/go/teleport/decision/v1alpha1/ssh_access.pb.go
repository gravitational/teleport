...
const file_teleport_decision_v1alpha1_ssh_access_proto_rawDesc = "" +
	...
	"\rforward_agent\x18\x02 \x01(\bR\fforwardAgent\x12Z\n" +
	"\x11port_forward_mode\x18\x03 \x01(\x0e2..teleport.decision.v1alpha1.SSHPortForwardModeR\x0fportForwardMode\x12I\n" +
	"\x13client_idle_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\x11clientIdleTimeout\x12R\n" +
	"\x17disconnect_expired_cert\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x15disconnectExpiredCert\x12\x1d\n" +
	"\n" +
	"bpf_events\x18\x06 \x03(\tR\tbpfEvents\x12%\n" +
	"\x0ex11_forwarding\x18\a \x01(\bR\rx11Forwarding\x12'\n" +
	"\x0fmax_connections\x18\b \x01(\x03R\x0emaxConnections\x12!\n" +
	"\fmax_sessions\x18\t \x01(\x03R\vmaxSessions\x12\"\n" +
	"\rssh_file_copy\x18\n" +
	" \x01(\bR\vsshFileCopy\x12!\n" +
	"\fhost_sudoers\x18\v \x03(\tR\vhostSudoers\x124\n" +
	"\x16session_recording_mode\x18\f \x01(\tR\x14sessionRecordingMode\x12!\n" +
	"\flocking_mode\x18\r \x01(\tR\vlockingMode\x12,\n" +
	"\x12private_key_policy\x18\x0e \x01(\tR\x10privateKeyPolicy\x12I\n" +
	"\flock_targets\x18\x0f \x03(\v2&.teleport.decision.v1alpha1.LockTargetR\vlockTargets\x12!\n" +
	"\fmapped_roles\x18\x10 \x03(\tR\vmappedRoles\x12Q\n" +
	"\x0fhost_users_info\x18\x11 \x01(\v2).teleport.decision.v1alpha1.HostUsersInfoR\rhostUsersInfo\"Y\n" +
