...
func file_teleport_decision_v1alpha1_ssh_access_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_decision_v1alpha1_ssh_access_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*EvaluateSSHAccessRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_teleport_decision_v1alpha1_ssh_access_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*EvaluateSSHAccessResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_teleport_decision_v1alpha1_ssh_access_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*SSHAccessPermit); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_teleport_decision_v1alpha1_ssh_access_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*SSHAccessDenial); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
