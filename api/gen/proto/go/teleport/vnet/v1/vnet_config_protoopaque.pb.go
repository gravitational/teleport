...
type VnetConfig struct {
	...
	xxx_hidden_Spec     *VnetConfigSpec        `protobuf:"bytes,5,opt,name=spec,proto3"`
...
type VnetConfigSpec struct {
	...
	xxx_hidden_CustomDnsZones *[]*CustomDNSZone      `protobuf:"bytes,2,rep,name=custom_dns_zones,json=customDnsZones,proto3"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *VnetConfigSpec) GetCustomDnsZones() []*CustomDNSZone {
	if x != nil {
		if x.xxx_hidden_CustomDnsZones != nil {
			return *x.xxx_hidden_CustomDnsZones
		}
	}
	return nil
}
...
func (b0 VnetConfigSpec_builder) Build() *VnetConfigSpec {
	...
	x.xxx_hidden_CustomDnsZones = &b.CustomDnsZones
	return m0
}
