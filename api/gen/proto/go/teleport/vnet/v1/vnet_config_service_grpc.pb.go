...
func RegisterVnetConfigServiceServer(s grpc.ServiceRegistrar, srv VnetConfigServiceServer) {
	// If the following call panics, it indicates UnimplementedVnetConfigServiceServer was
