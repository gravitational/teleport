...
type CreateVnetConfigRequest struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_VnetConfig *VnetConfig            `protobuf:"bytes,1,opt,name=vnet_config,json=vnetConfig,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *CreateVnetConfigRequest) HasVnetConfig() bool {
	...
	return x.xxx_hidden_VnetConfig != nil
}

func (x *CreateVnetConfigRequest) ClearVnetConfig() {
	x.xxx_hidden_VnetConfig = nil
}
...
func (b0 CreateVnetConfigRequest_builder) Build() *CreateVnetConfigRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_VnetConfig = b.VnetConfig
	return m0
}
