...
const file_teleport_vnet_v1_vnet_config_service_proto_rawDesc = "" +
	"\n" +
	"*teleport/vnet/v1/vnet_config_service.proto\x12\x10teleport.vnet.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\"teleport/vnet/v1/vnet_config.proto\"\x16\n" +
	"\x14GetVnetConfigRequest\"X\n" +
	"\x17CreateVnetConfigRequest\x12=\n" +
	"\vvnet_config\x18\x01 \x01(\v2\x1c.teleport.vnet.v1.VnetConfigR\n" +
	"vnetConfig\"X\n" +
	"\x17UpdateVnetConfigRequest\x12=\n" +
	"\vvnet_config\x18\x01 \x01(\v2\x1c.teleport.vnet.v1.VnetConfigR\n" +
	"vnetConfig\"X\n" +
	"\x17UpsertVnetConfigRequest\x12=\n" +
	"\vvnet_config\x18\x01 \x01(\v2\x1c.teleport.vnet.v1.VnetConfigR\n" +
	"vnetConfig\"\x19\n" +
	"\x17DeleteVnetConfigRequest2\xd8\x03\n" +
	"\x11VnetConfigService\x12U\n" +
	"\rGetVnetConfig\x12&.teleport.vnet.v1.GetVnetConfigRequest\x1a\x1c.teleport.vnet.v1.VnetConfig\x12[\n" +
	"\x10CreateVnetConfig\x12).teleport.vnet.v1.CreateVnetConfigRequest\x1a\x1c.teleport.vnet.v1.VnetConfig\x12[\n" +
