...
type CreateCrownJewelRequest struct {
	...
	xxx_hidden_CrownJewel *CrownJewel            `protobuf:"bytes,2,opt,name=crown_jewel,json=crownJewel,proto3"`
...
func (x *CreateCrownJewelRequest) HasCrownJewel() bool {
	...
	return x.xxx_hidden_CrownJewel != nil
}

func (x *CreateCrownJewelRequest) ClearCrownJewel() {
	x.xxx_hidden_CrownJewel = nil
}
...
func (b0 CreateCrownJewelRequest_builder) Build() *CreateCrownJewelRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_CrownJewel = b.CrownJewel
	return m0
}
...
type ListCrownJewelsResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_CrownJewels   *[]*CrownJewel         `protobuf:"bytes,1,rep,name=crown_jewels,json=crownJewels,proto3"`
...
func (x *ListCrownJewelsResponse) GetCrownJewels() []*CrownJewel {
	if x != nil {
		if x.xxx_hidden_CrownJewels != nil {
			return *x.xxx_hidden_CrownJewels
		}
	}
	return nil
}
...
func (b0 ListCrownJewelsResponse_builder) Build() *ListCrownJewelsResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_CrownJewels = &b.CrownJewels
