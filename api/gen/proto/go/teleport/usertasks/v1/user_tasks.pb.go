...
const file_teleport_usertasks_v1_user_tasks_proto_rawDesc = "" +
	"\n" +
	"&teleport/usertasks/v1/user_tasks.proto\x12\x15teleport.usertasks.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a!teleport/header/v1/metadata.proto\"\xc6\x01\n" +
	"\bUserTask\x12\x12\n" +
	"\x04kind\x18\x01 \x01(\tR\x04kind\x12\x19\n" +
	"\bsub_kind\x18\x02 \x01(\tR\asubKind\x12\x18\n" +
	"\aversion\x18\x03 \x01(\tR\aversion\x128\n" +
	"\bmetadata\x18\x04 \x01(\v2\x1c.teleport.header.v1.MetadataR\bmetadata\x127\n" +
	"\x04spec\x18\x05 \x01(\v2#.teleport.usertasks.v1.UserTaskSpecR\x04spec\"\xc9\x01\n" +
	"\fUserTaskSpec\x12 \n" +
	...
	"\fdiscover_ec2\x18\x05 \x01(\v2\".teleport.usertasks.v1.DiscoverEC2R\vdiscoverEc2\"\xcd\x02\n" +
	"\vDiscoverEC2\x12O\n" +
	...
	"account_idR\x06regionBVZTgithub.com/gravitational/teleport/api/gen/proto/go/teleport/usertasks/v1;usertasksv1b\x06proto3"
