...
// RiskFactorKind asdasd
type RiskFactorKind int32

const (
	RiskFactorKind_RISK_FACTOR_KIND_UNSPECIFIED           RiskFactorKind = 0
	RiskFactorKind_RISK_FACTOR_KIND_UNSUED_ROLE           RiskFactorKind = 1
	RiskFactorKind_RISK_FACTOR_KIND_EXCESSIVE_PERMISSIONS RiskFactorKind = 2
)

// Enum value maps for RiskFactorKind.
var (
	RiskFactorKind_name = map[int32]string{
		0: "RISK_FACTOR_KIND_UNSPECIFIED",
		1: "RISK_FACTOR_KIND_UNSUED_ROLE",
		2: "RISK_FACTOR_KIND_EXCESSIVE_PERMISSIONS",
	}
	RiskFactorKind_value = map[string]int32{
		"RISK_FACTOR_KIND_UNSPECIFIED":           0,
		"RISK_FACTOR_KIND_UNSUED_ROLE":           1,
		"RISK_FACTOR_KIND_EXCESSIVE_PERMISSIONS": 2,
	}
)

func (x RiskFactorKind) Enum() *RiskFactorKind {
	p := new(RiskFactorKind)
	*p = x
	return p
}

func (x RiskFactorKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RiskFactorKind) Descriptor() protoreflect.EnumDescriptor {
	return file_teleport_usertasks_v1_user_tasks_proto_enumTypes[1].Descriptor()
}

func (RiskFactorKind) Type() protoreflect.EnumType {
	return &file_teleport_usertasks_v1_user_tasks_proto_enumTypes[1]
}

func (x RiskFactorKind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RiskFactorKind.Descriptor instead.
func (RiskFactorKind) EnumDescriptor() ([]byte, []int) {
...
type RiskFactor struct {
	...
	Kind     RiskFactorKind `protobuf:"varint,4,opt,name=kind,proto3,enum=teleport.usertasks.v1.RiskFactorKind" json:"kind,omitempty"`
}
...
func (x *RiskFactor) GetKind() RiskFactorKind {
	if x != nil {
		return x.Kind
	}
	return RiskFactorKind_RISK_FACTOR_KIND_UNSPECIFIED
}
...
var file_teleport_usertasks_v1_user_tasks_proto_rawDesc = []byte{
	...
	0xb0, 0x01, 0x0a, 0x0a, 0x52, 0x69, 0x73, 0x6b, 0x46, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x12,
	0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x12, 0x3b, 0x0a, 0x08, 0x73, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74, 0x79, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e,
	0x75, 0x73, 0x65, 0x72, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x76,
	...
	0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12, 0x39, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x25, 0x2e, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74,
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x69,
	0x73, 0x6b, 0x46, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x4b, 0x69, 0x6e, 0x64, 0x52, 0x04, 0x6b, 0x69,
	0x6e, 0x64, 0x22, 0xcc, 0x01, 0x0a, 0x0b, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x47, 0x72, 0x61,
	0x70, 0x68, 0x12, 0x1b, 0x0a, 0x09, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	...
	0x0e, 0x32, 0x1f, 0x2e, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x75, 0x73, 0x65,
	0x72, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x76, 0x65, 0x72, 0x69,
	0x74, 0x79, 0x52, 0x08, 0x73, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74, 0x79, 0x12, 0x44, 0x0a, 0x0c,
	0x72, 0x69, 0x73, 0x6b, 0x5f, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x21, 0x2e, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x69, 0x73, 0x6b, 0x46,
	0x61, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x0b, 0x72, 0x69, 0x73, 0x6b, 0x46, 0x61, 0x63, 0x74, 0x6f,
	...
	0x64, 0x22, 0x9e, 0x02, 0x0a, 0x13, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x45, 0x43,
	0x32, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x69, 0x6e, 0x73,
	...
	,
	...
	,
	...
	0x67, 0x6f, 0x2f, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2f, 0x75, 0x73, 0x65, 0x72,
	0x74, 0x61, 0x73, 0x6b, 0x73, 0x2f, 0x76, 0x31, 0x3b, 0x75, 0x73, 0x65, 0x72, 0x74, 0x61, 0x73,
...
var file_teleport_usertasks_v1_user_tasks_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_teleport_usertasks_v1_user_tasks_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_teleport_usertasks_v1_user_tasks_proto_goTypes = []any{
	(Severity)(0),                 // 0: teleport.usertasks.v1.Severity
	(RiskFactorKind)(0),           // 1: teleport.usertasks.v1.RiskFactorKind
	(*UserTask)(nil),              // 2: teleport.usertasks.v1.UserTask
	(*UserTaskSpec)(nil),          // 3: teleport.usertasks.v1.UserTaskSpec
	(*DiscoverEC2)(nil),           // 4: teleport.usertasks.v1.DiscoverEC2
	(*RiskFactor)(nil),            // 5: teleport.usertasks.v1.RiskFactor
	(*AccessGraph)(nil),           // 6: teleport.usertasks.v1.AccessGraph
	(*DiscoverEC2Instance)(nil),   // 7: teleport.usertasks.v1.DiscoverEC2Instance
	nil,                           // 8: teleport.usertasks.v1.DiscoverEC2.InstancesEntry
	(*v1.Metadata)(nil),           // 9: teleport.header.v1.Metadata
	(*timestamppb.Timestamp)(nil), // 10: google.protobuf.Timestamp
}
var file_teleport_usertasks_v1_user_tasks_proto_depIdxs = []int32{
	9,  // 0: teleport.usertasks.v1.UserTask.metadata:type_name -> teleport.header.v1.Metadata
	3,  // 1: teleport.usertasks.v1.UserTask.spec:type_name -> teleport.usertasks.v1.UserTaskSpec
	4,  // 2: teleport.usertasks.v1.UserTaskSpec.discover_ec2:type_name -> teleport.usertasks.v1.DiscoverEC2
	6,  // 3: teleport.usertasks.v1.UserTaskSpec.access_graph:type_name -> teleport.usertasks.v1.AccessGraph
	8,  // 4: teleport.usertasks.v1.DiscoverEC2.instances:type_name -> teleport.usertasks.v1.DiscoverEC2.InstancesEntry
	0,  // 5: teleport.usertasks.v1.RiskFactor.severity:type_name -> teleport.usertasks.v1.Severity
	1,  // 6: teleport.usertasks.v1.RiskFactor.kind:type_name -> teleport.usertasks.v1.RiskFactorKind
	0,  // 7: teleport.usertasks.v1.AccessGraph.severity:type_name -> teleport.usertasks.v1.Severity
	5,  // 8: teleport.usertasks.v1.AccessGraph.risk_factors:type_name -> teleport.usertasks.v1.RiskFactor
	10, // 9: teleport.usertasks.v1.DiscoverEC2Instance.sync_time:type_name -> google.protobuf.Timestamp
	7,  // 10: teleport.usertasks.v1.DiscoverEC2.InstancesEntry.value:type_name -> teleport.usertasks.v1.DiscoverEC2Instance
