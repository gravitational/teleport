...
type DiscoverAzureVMInstance struct {
	...
	LastFailureTime *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=last_failure_time,json=lastFailureTime,proto3" json:"last_failure_time,omitempty"`
...
func (b0 DiscoverAzureVMInstance_builder) Build() *DiscoverAzureVMInstance {
	...
	x.DiscoveryGroup = b.DiscoveryGroup
	x.SyncTime = b.SyncTime
	x.LastFailureTime = b.LastFailureTime
