...
const file_teleport_usertasks_v1_user_tasks_service_proto_rawDesc = "" +
	...
	"\rListUserTasks\x12+.teleport.usertasks.v1.ListUserTasksRequest\x1a,.teleport.usertasks.v1.ListUserTasksResponse\x12\x84\x01\n" +
	"\x1aListUserTasksByIntegration\x128.teleport.usertasks.v1.ListUserTasksByIntegrationRequest\x1a,.teleport.usertasks.v1.ListUserTasksResponse\x12_\n" +
