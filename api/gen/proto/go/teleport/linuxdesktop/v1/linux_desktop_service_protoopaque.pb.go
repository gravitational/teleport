...
type CreateLinuxDesktopRequest struct {
	...
	xxx_hidden_LinuxDesktop *LinuxDesktop          `protobuf:"bytes,1,opt,name=linux_desktop,json=linuxDesktop,proto3"`
...
type ListLinuxDesktopsResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_LinuxDesktops *[]*LinuxDesktop       `protobuf:"bytes,1,rep,name=linux_desktops,json=linuxDesktops,proto3"`
...
func (x *ListLinuxDesktopsResponse) GetLinuxDesktops() []*LinuxDesktop {
	if x != nil {
		if x.xxx_hidden_LinuxDesktops != nil {
			return *x.xxx_hidden_LinuxDesktops
		}
	}
	return nil
}
...
func (b0 ListLinuxDesktopsResponse_builder) Build() *ListLinuxDesktopsResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_LinuxDesktops = &b.LinuxDesktops
