...
type SessionRecordingThumbnail struct {
	...
	xxx_hidden_Png           []byte                 `protobuf:"bytes,9,opt,name=png,proto3"`
	xxx_hidden_ScreenWidth   int32                  `protobuf:"varint,10,opt,name=screen_width,json=screenWidth,proto3"`
	xxx_hidden_ScreenHeight  int32                  `protobuf:"varint,11,opt,name=screen_height,json=screenHeight,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *SessionRecordingThumbnail) GetScreenWidth() int32 {
	if x != nil {
		return x.xxx_hidden_ScreenWidth
	}
	return 0
}
...
func (x *SessionRecordingThumbnail) GetScreenHeight() int32 {
	if x != nil {
		return x.xxx_hidden_ScreenHeight
	}
	return 0
}
