...
type ServerHello struct {
	...
	Sessions                 []*SessionSelection    `protobuf:"bytes,4,rep,name=sessions,proto3" json:"sessions,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *ServerHello) GetSessions() []*SessionSelection {
	if x != nil {
		return x.Sessions
	}
	return nil
...
func (x *SessionSelection) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (*SharedDirectoryRequest_Info) Descriptor() ([]byte, []int) {
	return file_teleport_desktop_v1_tdpb_proto_rawDescGZIP(), []int{20, 0}
}
...
func (*SharedDirectoryRequest_Create) Descriptor() ([]byte, []int) {
	return file_teleport_desktop_v1_tdpb_proto_rawDescGZIP(), []int{20, 1}
}
...
func (*SharedDirectoryRequest_Delete) Descriptor() ([]byte, []int) {
	return file_teleport_desktop_v1_tdpb_proto_rawDescGZIP(), []int{20, 2}
}
...
func (*SharedDirectoryRequest_List) Descriptor() ([]byte, []int) {
	return file_teleport_desktop_v1_tdpb_proto_rawDescGZIP(), []int{20, 3}
}
...
func (*SharedDirectoryRequest_Read) Descriptor() ([]byte, []int) {
	return file_teleport_desktop_v1_tdpb_proto_rawDescGZIP(), []int{20, 4}
}
...
func (*SharedDirectoryRequest_Write) Descriptor() ([]byte, []int) {
	return file_teleport_desktop_v1_tdpb_proto_rawDescGZIP(), []int{20, 5}
}
...
func (*SharedDirectoryRequest_Move) Descriptor() ([]byte, []int) {
	return file_teleport_desktop_v1_tdpb_proto_rawDescGZIP(), []int{20, 6}
}
...
func (*SharedDirectoryRequest_Truncate) Descriptor() ([]byte, []int) {
	return file_teleport_desktop_v1_tdpb_proto_rawDescGZIP(), []int{20, 7}
}
...
const file_teleport_desktop_v1_tdpb_proto_rawDesc = "" +
	...
	"screenSpec\x12'\n" +
	"\x0fkeyboard_layout\x18\x03 \x01(\rR\x0ekeyboardLayout\"\x8e\x02\n" +
	"\vServerHello\x12Q\n" +
	...
	"\x1adirectory_remove_supported\x18\x03 \x01(\bR\x18directoryRemoveSupported\x12A\n" +
	"\bsessions\x18\x04 \x03(\v2%.teleport.desktop.v1.SessionSelectionR\bsessions\"&\n" +
	"\x10SessionSelection\x12\x12\n" +
...
var file_teleport_desktop_v1_tdpb_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_teleport_desktop_v1_tdpb_proto_goTypes = []any{
	...
	(*SessionSelection)(nil),                 // 6: teleport.desktop.v1.SessionSelection
	(*Rectangle)(nil),                        // 7: teleport.desktop.v1.Rectangle
	(*PNGFrame)(nil),                         // 8: teleport.desktop.v1.PNGFrame
	(*FastPathPDU)(nil),                      // 9: teleport.desktop.v1.FastPathPDU
	(*RDPResponsePDU)(nil),                   // 10: teleport.desktop.v1.RDPResponsePDU
	(*ConnectionActivated)(nil),              // 11: teleport.desktop.v1.ConnectionActivated
	(*SyncKeys)(nil),                         // 12: teleport.desktop.v1.SyncKeys
	(*MouseMove)(nil),                        // 13: teleport.desktop.v1.MouseMove
	(*MouseButton)(nil),                      // 14: teleport.desktop.v1.MouseButton
	(*KeyboardButton)(nil),                   // 15: teleport.desktop.v1.KeyboardButton
	(*ClientScreenSpec)(nil),                 // 16: teleport.desktop.v1.ClientScreenSpec
	(*Alert)(nil),                            // 17: teleport.desktop.v1.Alert
	(*MouseWheel)(nil),                       // 18: teleport.desktop.v1.MouseWheel
	(*ClipboardData)(nil),                    // 19: teleport.desktop.v1.ClipboardData
	(*MFA)(nil),                              // 20: teleport.desktop.v1.MFA
	(*SharedDirectoryAnnounce)(nil),          // 21: teleport.desktop.v1.SharedDirectoryAnnounce
	(*SharedDirectoryRemove)(nil),            // 22: teleport.desktop.v1.SharedDirectoryRemove
	...
	(*Envelope)(nil),                         // 29: teleport.desktop.v1.Envelope
	(*SharedDirectoryRequest_Info)(nil),      // 30: teleport.desktop.v1.SharedDirectoryRequest.Info
	(*SharedDirectoryRequest_Create)(nil),    // 31: teleport.desktop.v1.SharedDirectoryRequest.Create
	(*SharedDirectoryRequest_Delete)(nil),    // 32: teleport.desktop.v1.SharedDirectoryRequest.Delete
	(*SharedDirectoryRequest_List)(nil),      // 33: teleport.desktop.v1.SharedDirectoryRequest.List
	(*SharedDirectoryRequest_Read)(nil),      // 34: teleport.desktop.v1.SharedDirectoryRequest.Read
	(*SharedDirectoryRequest_Write)(nil),     // 35: teleport.desktop.v1.SharedDirectoryRequest.Write
	(*SharedDirectoryRequest_Move)(nil),      // 36: teleport.desktop.v1.SharedDirectoryRequest.Move
	(*SharedDirectoryRequest_Truncate)(nil),  // 37: teleport.desktop.v1.SharedDirectoryRequest.Truncate
	(*SharedDirectoryResponse_Info)(nil),     // 38: teleport.desktop.v1.SharedDirectoryResponse.Info
	(*SharedDirectoryResponse_Create)(nil),   // 39: teleport.desktop.v1.SharedDirectoryResponse.Create
	(*SharedDirectoryResponse_Delete)(nil),   // 40: teleport.desktop.v1.SharedDirectoryResponse.Delete
	(*SharedDirectoryResponse_List)(nil),     // 41: teleport.desktop.v1.SharedDirectoryResponse.List
	(*SharedDirectoryResponse_Read)(nil),     // 42: teleport.desktop.v1.SharedDirectoryResponse.Read
	(*SharedDirectoryResponse_Write)(nil),    // 43: teleport.desktop.v1.SharedDirectoryResponse.Write
	(*SharedDirectoryResponse_Move)(nil),     // 44: teleport.desktop.v1.SharedDirectoryResponse.Move
	(*SharedDirectoryResponse_Truncate)(nil), // 45: teleport.desktop.v1.SharedDirectoryResponse.Truncate
	(*v1.AuthenticateChallenge)(nil),         // 46: teleport.mfa.v1.AuthenticateChallenge
	(*v1.AuthenticateResponse)(nil),          // 47: teleport.mfa.v1.AuthenticateResponse
}
var file_teleport_desktop_v1_tdpb_proto_depIdxs = []int32{
	16, // 0: teleport.desktop.v1.ClientHello.screen_spec:type_name -> teleport.desktop.v1.ClientScreenSpec
	11, // 1: teleport.desktop.v1.ServerHello.activation_spec:type_name -> teleport.desktop.v1.ConnectionActivated
	6,  // 2: teleport.desktop.v1.ServerHello.sessions:type_name -> teleport.desktop.v1.SessionSelection
	7,  // 3: teleport.desktop.v1.PNGFrame.coordinates:type_name -> teleport.desktop.v1.Rectangle
	0,  // 4: teleport.desktop.v1.MouseButton.button:type_name -> teleport.desktop.v1.MouseButtonType
	1,  // 5: teleport.desktop.v1.Alert.severity:type_name -> teleport.desktop.v1.AlertSeverity
	2,  // 6: teleport.desktop.v1.MouseWheel.axis:type_name -> teleport.desktop.v1.MouseWheelAxis
	3,  // 7: teleport.desktop.v1.MFA.type:type_name -> teleport.desktop.v1.MFAType
	46, // 8: teleport.desktop.v1.MFA.challenge:type_name -> teleport.mfa.v1.AuthenticateChallenge
	47, // 9: teleport.desktop.v1.MFA.authentication_response:type_name -> teleport.mfa.v1.AuthenticateResponse
	30, // 10: teleport.desktop.v1.SharedDirectoryRequest.info:type_name -> teleport.desktop.v1.SharedDirectoryRequest.Info
	31, // 11: teleport.desktop.v1.SharedDirectoryRequest.create:type_name -> teleport.desktop.v1.SharedDirectoryRequest.Create
	32, // 12: teleport.desktop.v1.SharedDirectoryRequest.delete:type_name -> teleport.desktop.v1.SharedDirectoryRequest.Delete
	33, // 13: teleport.desktop.v1.SharedDirectoryRequest.list:type_name -> teleport.desktop.v1.SharedDirectoryRequest.List
	34, // 14: teleport.desktop.v1.SharedDirectoryRequest.read:type_name -> teleport.desktop.v1.SharedDirectoryRequest.Read
	35, // 15: teleport.desktop.v1.SharedDirectoryRequest.write:type_name -> teleport.desktop.v1.SharedDirectoryRequest.Write
	36, // 16: teleport.desktop.v1.SharedDirectoryRequest.move:type_name -> teleport.desktop.v1.SharedDirectoryRequest.Move
	37, // 17: teleport.desktop.v1.SharedDirectoryRequest.truncate:type_name -> teleport.desktop.v1.SharedDirectoryRequest.Truncate
	38, // 18: teleport.desktop.v1.SharedDirectoryResponse.info:type_name -> teleport.desktop.v1.SharedDirectoryResponse.Info
	39, // 19: teleport.desktop.v1.SharedDirectoryResponse.create:type_name -> teleport.desktop.v1.SharedDirectoryResponse.Create
	40, // 20: teleport.desktop.v1.SharedDirectoryResponse.delete:type_name -> teleport.desktop.v1.SharedDirectoryResponse.Delete
	41, // 21: teleport.desktop.v1.SharedDirectoryResponse.list:type_name -> teleport.desktop.v1.SharedDirectoryResponse.List
	42, // 22: teleport.desktop.v1.SharedDirectoryResponse.read:type_name -> teleport.desktop.v1.SharedDirectoryResponse.Read
	43, // 23: teleport.desktop.v1.SharedDirectoryResponse.write:type_name -> teleport.desktop.v1.SharedDirectoryResponse.Write
	44, // 24: teleport.desktop.v1.SharedDirectoryResponse.move:type_name -> teleport.desktop.v1.SharedDirectoryResponse.Move
	45, // 25: teleport.desktop.v1.SharedDirectoryResponse.truncate:type_name -> teleport.desktop.v1.SharedDirectoryResponse.Truncate
	4,  // 26: teleport.desktop.v1.Envelope.client_hello:type_name -> teleport.desktop.v1.ClientHello
	5,  // 27: teleport.desktop.v1.Envelope.server_hello:type_name -> teleport.desktop.v1.ServerHello
	8,  // 28: teleport.desktop.v1.Envelope.png_frame:type_name -> teleport.desktop.v1.PNGFrame
	9,  // 29: teleport.desktop.v1.Envelope.fast_path_pdu:type_name -> teleport.desktop.v1.FastPathPDU
	10, // 30: teleport.desktop.v1.Envelope.rdp_response_pdu:type_name -> teleport.desktop.v1.RDPResponsePDU
	12, // 31: teleport.desktop.v1.Envelope.sync_keys:type_name -> teleport.desktop.v1.SyncKeys
	13, // 32: teleport.desktop.v1.Envelope.mouse_move:type_name -> teleport.desktop.v1.MouseMove
	14, // 33: teleport.desktop.v1.Envelope.mouse_button:type_name -> teleport.desktop.v1.MouseButton
	15, // 34: teleport.desktop.v1.Envelope.keyboard_button:type_name -> teleport.desktop.v1.KeyboardButton
	16, // 35: teleport.desktop.v1.Envelope.client_screen_spec:type_name -> teleport.desktop.v1.ClientScreenSpec
	17, // 36: teleport.desktop.v1.Envelope.alert:type_name -> teleport.desktop.v1.Alert
	18, // 37: teleport.desktop.v1.Envelope.mouse_wheel:type_name -> teleport.desktop.v1.MouseWheel
	19, // 38: teleport.desktop.v1.Envelope.clipboard_data:type_name -> teleport.desktop.v1.ClipboardData
	20, // 39: teleport.desktop.v1.Envelope.mfa:type_name -> teleport.desktop.v1.MFA
	21, // 40: teleport.desktop.v1.Envelope.shared_directory_announce:type_name -> teleport.desktop.v1.SharedDirectoryAnnounce
	23, // 41: teleport.desktop.v1.Envelope.shared_directory_acknowledge:type_name -> teleport.desktop.v1.SharedDirectoryAcknowledge
	24, // 42: teleport.desktop.v1.Envelope.shared_directory_request:type_name -> teleport.desktop.v1.SharedDirectoryRequest
	25, // 43: teleport.desktop.v1.Envelope.shared_directory_response:type_name -> teleport.desktop.v1.SharedDirectoryResponse
	27, // 44: teleport.desktop.v1.Envelope.latency_stats:type_name -> teleport.desktop.v1.LatencyStats
	28, // 45: teleport.desktop.v1.Envelope.ping:type_name -> teleport.desktop.v1.Ping
	22, // 46: teleport.desktop.v1.Envelope.shared_directory_remove:type_name -> teleport.desktop.v1.SharedDirectoryRemove
	6,  // 47: teleport.desktop.v1.Envelope.session_selection:type_name -> teleport.desktop.v1.SessionSelection
	26, // 48: teleport.desktop.v1.SharedDirectoryResponse.Info.fso:type_name -> teleport.desktop.v1.FileSystemObject
	26, // 49: teleport.desktop.v1.SharedDirectoryResponse.Create.fso:type_name -> teleport.desktop.v1.FileSystemObject
	26, // 50: teleport.desktop.v1.SharedDirectoryResponse.List.fso_list:type_name -> teleport.desktop.v1.FileSystemObject
...
func file_teleport_desktop_v1_tdpb_proto_init() {
	...
	file_teleport_desktop_v1_tdpb_proto_msgTypes[25].OneofWrappers = []any{
