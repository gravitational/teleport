...
type MFA struct {
	...
	Challenge              *v2.AuthenticateChallenge `protobuf:"bytes,3,opt,name=challenge,proto3" json:"challenge,omitempty"`
	AuthenticationResponse *v2.AuthenticateResponse  `protobuf:"bytes,4,opt,name=authentication_response,json=authenticationResponse,proto3" json:"authentication_response,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
