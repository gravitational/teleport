...
type SessionSearchServiceClient interface {
	...
	// sessions to the stream. Multiple SearchSessionSummariesResponse messages
	// may be sent per call to stay within gRPC message size limits. The server
	// closes the stream when all matching visible sessions have been sent.
	//
	...
	//	  sessions = append(sessions, resp.Summaries...)
	//	}
