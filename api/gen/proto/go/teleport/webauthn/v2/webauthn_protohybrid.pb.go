...
func (b0 PublicKeyCredentialRequestOptions_builder) Build() *PublicKeyCredentialRequestOptions {
	...
	x.UserVerification = b.UserVerification
	return m0
}
...
func (b0 AuthenticatorAssertionResponse_builder) Build() *AuthenticatorAssertionResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.ClientDataJson = b.ClientDataJson
	x.AuthenticatorData = b.AuthenticatorData
	x.Signature = b.Signature
	x.UserHandle = b.UserHandle
	return m0
}
