...
const (
	WebhookService_GetWebhook_FullMethodName    = "/teleport.webhook.v1.WebhookService/GetWebhook"
	WebhookService_ListWebhooks_FullMethodName  = "/teleport.webhook.v1.WebhookService/ListWebhooks"
	WebhookService_CreateWebhook_FullMethodName = "/teleport.webhook.v1.WebhookService/CreateWebhook"
	WebhookService_UpdateWebhook_FullMethodName = "/teleport.webhook.v1.WebhookService/UpdateWebhook"
	WebhookService_UpsertWebhook_FullMethodName = "/teleport.webhook.v1.WebhookService/UpsertWebhook"
	WebhookService_DeleteWebhook_FullMethodName = "/teleport.webhook.v1.WebhookService/DeleteWebhook"
)
...
type WebhookServiceClient interface {
	...
	UpsertWebhook(ctx context.Context, in *UpsertWebhookRequest, opts ...grpc.CallOption) (*Webhook, error)
...
func (c *webhookServiceClient) UpsertWebhook(ctx context.Context, in *UpsertWebhookRequest, opts ...grpc.CallOption) (*Webhook, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Webhook)
	err := c.cc.Invoke(ctx, WebhookService_UpsertWebhook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WebhookServiceServer interface {
	...
	// UpsertWebhook creates or updates a webhook.
	UpsertWebhook(context.Context, *UpsertWebhookRequest) (*Webhook, error)
	// DeleteWebhook deletes a webhook by name.
...
func (UnimplementedWebhookServiceServer) UpsertWebhook(context.Context, *UpsertWebhookRequest) (*Webhook, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpsertWebhook not implemented")
}
...
func _WebhookService_UpsertWebhook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpsertWebhookRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WebhookServiceServer).UpsertWebhook(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WebhookService_UpsertWebhook_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WebhookServiceServer).UpsertWebhook(ctx, req.(*UpsertWebhookRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WebhookService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpsertWebhook",
			Handler:    _WebhookService_UpsertWebhook_Handler,
		},
		{
	...
	Metadata: "teleport/webhook/v1/webhook_service.proto",
}
