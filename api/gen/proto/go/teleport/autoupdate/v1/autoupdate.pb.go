...
// autoupdate settings.
type ClusterAutoUpdateConfig struct {
	...
	Spec     *ClusterAutoUpdateConfigSpec `protobuf:"bytes,5,opt,name=spec,proto3" json:"spec,omitempty"`
}

func (x *ClusterAutoUpdateConfig) Reset() {
	*x = ClusterAutoUpdateConfig{}
...
func (x *ClusterAutoUpdateConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClusterAutoUpdateConfig) ProtoMessage() {}

func (x *ClusterAutoUpdateConfig) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[0]
...
// Deprecated: Use ClusterAutoUpdateConfig.ProtoReflect.Descriptor instead.
func (*ClusterAutoUpdateConfig) Descriptor() ([]byte, []int) {
	return file_teleport_autoupdate_v1_autoupdate_proto_rawDescGZIP(), []int{0}
}

func (x *ClusterAutoUpdateConfig) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *ClusterAutoUpdateConfig) GetSubKind() string {
	if x != nil {
		return x.SubKind
	}
	return ""
...
func (x *ClusterAutoUpdateConfig) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *ClusterAutoUpdateConfig) GetMetadata() *v1.Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *ClusterAutoUpdateConfig) GetSpec() *ClusterAutoUpdateConfigSpec {
	if x != nil {
		return x.Spec
	}
	return nil
...
type ClusterAutoUpdateConfigSpec struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ClusterAutoUpdateConfigSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClusterAutoUpdateConfigSpec) ProtoMessage() {}

func (x *ClusterAutoUpdateConfigSpec) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClusterAutoUpdateConfigSpec.ProtoReflect.Descriptor instead.
func (*ClusterAutoUpdateConfigSpec) Descriptor() ([]byte, []int) {
...
var file_teleport_autoupdate_v1_autoupdate_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe5, 0x01, 0x0a, 0x17, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
	...
	0x6f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6c, 0x75, 0x73, 0x74,
	0x65, 0x72, 0x41, 0x75, 0x74, 0x6f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x53, 0x70, 0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x22, 0x49, 0x0a, 0x1b,
...
func file_teleport_autoupdate_v1_autoupdate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*ClusterAutoUpdateConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*ClusterAutoUpdateConfigSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
