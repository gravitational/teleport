...
type AgentAutoUpdateGroup struct {
	...
	WaitHours int64 `protobuf:"varint,5,opt,name=wait_hours,json=waitHours,proto3" json:"wait_hours,omitempty"`
}
...
func (x *AgentAutoUpdateGroup) GetWaitHours() int64 {
	if x != nil {
		return x.WaitHours
	}
	return 0
...
type AutoUpdateAgentRolloutStatusGroup struct {
	...
	// This field must be positive.
	ConfigWaitHours int64 `protobuf:"varint,9,opt,name=config_wait_hours,json=configWaitHours,proto3" json:"config_wait_hours,omitempty"`
}
...
func (x *AutoUpdateAgentRolloutStatusGroup) GetConfigWaitHours() int64 {
	if x != nil {
...
var file_teleport_autoupdate_v1_autoupdate_proto_rawDesc = []byte{
	...
	0x61, 0x69, 0x74, 0x5f, 0x68, 0x6f, 0x75, 0x72, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x74, 0x5f, 0x68, 0x6f, 0x75, 0x72, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x63,
