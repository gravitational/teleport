...
type AutoUpdateBotInstanceReport struct {
	...
	Spec          *AutoUpdateBotInstanceReportSpec `protobuf:"bytes,5,opt,name=spec,proto3" json:"spec,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AutoUpdateBotInstanceReport) Reset() {
	*x = AutoUpdateBotInstanceReport{}
	mi := &file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AutoUpdateBotInstanceReport) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AutoUpdateBotInstanceReport) ProtoMessage() {}

func (x *AutoUpdateBotInstanceReport) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *AutoUpdateBotInstanceReport) GetSubKind() string {
	if x != nil {
		return x.SubKind
	}
	return ""
...
func (x *AutoUpdateBotInstanceReport) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *AutoUpdateBotInstanceReport) GetMetadata() *v1.Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *AutoUpdateBotInstanceReport) GetSpec() *AutoUpdateBotInstanceReportSpec {
	if x != nil {
		return x.Spec
	}
	return nil
...
type AutoUpdateBotInstanceReportSpec struct {
	...
	Groups        map[string]*AutoUpdateBotInstanceReportSpecGroup `protobuf:"bytes,2,rep,name=groups,proto3" json:"groups,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AutoUpdateBotInstanceReportSpec) Reset() {
	*x = AutoUpdateBotInstanceReportSpec{}
	mi := &file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AutoUpdateBotInstanceReportSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AutoUpdateBotInstanceReportSpec) ProtoMessage() {}

func (x *AutoUpdateBotInstanceReportSpec) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *AutoUpdateBotInstanceReportSpec) GetGroups() map[string]*AutoUpdateBotInstanceReportSpecGroup {
	if x != nil {
		return x.Groups
	}
	return nil
...
func (x *AutoUpdateBotInstanceReportSpecGroup) Reset() {
	*x = AutoUpdateBotInstanceReportSpecGroup{}
	mi := &file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AutoUpdateBotInstanceReportSpecGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AutoUpdateBotInstanceReportSpecGroup) ProtoMessage() {}

func (x *AutoUpdateBotInstanceReportSpecGroup) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *AutoUpdateBotInstanceReportSpecGroupVersion) Reset() {
	*x = AutoUpdateBotInstanceReportSpecGroupVersion{}
	mi := &file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AutoUpdateBotInstanceReportSpecGroupVersion) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AutoUpdateBotInstanceReportSpecGroupVersion) ProtoMessage() {}

func (x *AutoUpdateBotInstanceReportSpecGroupVersion) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *Canary) Reset() {
	*x = Canary{}
	mi := &file_teleport_autoupdate_v1_autoupdate_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_teleport_autoupdate_v1_autoupdate_proto_goTypes = []any{
	...
	(*AutoUpdateBotInstanceReport)(nil),                 // 21: teleport.autoupdate.v1.AutoUpdateBotInstanceReport
	(*AutoUpdateBotInstanceReportSpec)(nil),             // 22: teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpec
	(*AutoUpdateBotInstanceReportSpecGroup)(nil),        // 23: teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpecGroup
	(*AutoUpdateBotInstanceReportSpecGroupVersion)(nil), // 24: teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpecGroupVersion
	(*Canary)(nil),                                      // 25: teleport.autoupdate.v1.Canary
	nil,                                                 // 26: teleport.autoupdate.v1.AutoUpdateAgentReportSpec.GroupsEntry
	nil,                                                 // 27: teleport.autoupdate.v1.AutoUpdateAgentReportSpecGroup.VersionsEntry
	nil,                                                 // 28: teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpec.GroupsEntry
	nil,                                                 // 29: teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpecGroup.VersionsEntry
...
var file_teleport_autoupdate_v1_autoupdate_proto_depIdxs = []int32{
	30, // 0: teleport.autoupdate.v1.AutoUpdateConfig.metadata:type_name -> teleport.header.v1.Metadata
	...
	31, // 4: teleport.autoupdate.v1.AutoUpdateConfigSpecAgents.maintenance_window_duration:type_name -> google.protobuf.Duration
	...
	30, // 7: teleport.autoupdate.v1.AutoUpdateVersion.metadata:type_name -> teleport.header.v1.Metadata
	...
	30, // 11: teleport.autoupdate.v1.AutoUpdateAgentRollout.metadata:type_name -> teleport.header.v1.Metadata
	...
	31, // 14: teleport.autoupdate.v1.AutoUpdateAgentRolloutSpec.maintenance_window_duration:type_name -> google.protobuf.Duration
	...
	32, // 17: teleport.autoupdate.v1.AutoUpdateAgentRolloutStatus.start_time:type_name -> google.protobuf.Timestamp
	32, // 18: teleport.autoupdate.v1.AutoUpdateAgentRolloutStatus.time_override:type_name -> google.protobuf.Timestamp
	32, // 19: teleport.autoupdate.v1.AutoUpdateAgentRolloutStatusGroup.start_time:type_name -> google.protobuf.Timestamp
	...
	32, // 21: teleport.autoupdate.v1.AutoUpdateAgentRolloutStatusGroup.last_update_time:type_name -> google.protobuf.Timestamp
	25, // 22: teleport.autoupdate.v1.AutoUpdateAgentRolloutStatusGroup.canaries:type_name -> teleport.autoupdate.v1.Canary
	30, // 23: teleport.autoupdate.v1.AutoUpdateAgentReport.metadata:type_name -> teleport.header.v1.Metadata
	17, // 24: teleport.autoupdate.v1.AutoUpdateAgentReport.spec:type_name -> teleport.autoupdate.v1.AutoUpdateAgentReportSpec
	32, // 25: teleport.autoupdate.v1.AutoUpdateAgentReportSpec.timestamp:type_name -> google.protobuf.Timestamp
	26, // 26: teleport.autoupdate.v1.AutoUpdateAgentReportSpec.groups:type_name -> teleport.autoupdate.v1.AutoUpdateAgentReportSpec.GroupsEntry
	...
	27, // 28: teleport.autoupdate.v1.AutoUpdateAgentReportSpecGroup.versions:type_name -> teleport.autoupdate.v1.AutoUpdateAgentReportSpecGroup.VersionsEntry
	30, // 29: teleport.autoupdate.v1.AutoUpdateBotInstanceReport.metadata:type_name -> teleport.header.v1.Metadata
	22, // 30: teleport.autoupdate.v1.AutoUpdateBotInstanceReport.spec:type_name -> teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpec
	32, // 31: teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpec.timestamp:type_name -> google.protobuf.Timestamp
	28, // 32: teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpec.groups:type_name -> teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpec.GroupsEntry
	29, // 33: teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpecGroup.versions:type_name -> teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpecGroup.VersionsEntry
	18, // 34: teleport.autoupdate.v1.AutoUpdateAgentReportSpec.GroupsEntry.value:type_name -> teleport.autoupdate.v1.AutoUpdateAgentReportSpecGroup
	19, // 35: teleport.autoupdate.v1.AutoUpdateAgentReportSpecGroup.VersionsEntry.value:type_name -> teleport.autoupdate.v1.AutoUpdateAgentReportSpecGroupVersion
	23, // 36: teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpec.GroupsEntry.value:type_name -> teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpecGroup
	24, // 37: teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpecGroup.VersionsEntry.value:type_name -> teleport.autoupdate.v1.AutoUpdateBotInstanceReportSpecGroupVersion
