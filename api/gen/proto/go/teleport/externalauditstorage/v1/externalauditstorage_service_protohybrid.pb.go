...
const file_teleport_externalauditstorage_v1_externalauditstorage_service_proto_rawDesc = "" +
	"\n" +
	"Cteleport/externalauditstorage/v1/externalauditstorage_service.proto\x12 teleport.externalauditstorage.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a;teleport/externalauditstorage/v1/externalauditstorage.proto\"%\n" +
	"#GetDraftExternalAuditStorageRequest\"\x94\x01\n" +
	"$GetDraftExternalAuditStorageResponse\x12l\n" +
	"\x16external_audit_storage\x18\x01 \x01(\v26.teleport.externalauditstorage.v1.ExternalAuditStorageR\x14externalAuditStorage\"\x96\x01\n" +
	"&CreateDraftExternalAuditStorageRequest\x12l\n" +
	"\x16external_audit_storage\x18\x01 \x01(\v26.teleport.externalauditstorage.v1.ExternalAuditStorageR\x14externalAuditStorage\"\x97\x01\n" +
	"'CreateDraftExternalAuditStorageResponse\x12l\n" +
	"\x16external_audit_storage\x18\x01 \x01(\v26.teleport.externalauditstorage.v1.ExternalAuditStorageR\x14externalAuditStorage\"\x96\x01\n" +
	"&UpsertDraftExternalAuditStorageRequest\x12l\n" +
	"\x16external_audit_storage\x18\x01 \x01(\v26.teleport.externalauditstorage.v1.ExternalAuditStorageR\x14externalAuditStorage\"\x97\x01\n" +
	"'UpsertDraftExternalAuditStorageResponse\x12l\n" +
	"\x16external_audit_storage\x18\x01 \x01(\v26.teleport.externalauditstorage.v1.ExternalAuditStorageR\x14externalAuditStorage\"(\n" +
	"&DeleteDraftExternalAuditStorageRequest\"-\n" +
	"+PromoteToClusterExternalAuditStorageRequest\"\xab\x01\n" +
	",PromoteToClusterExternalAuditStorageResponse\x12{\n" +
	"\x1ecluster_external_audit_storage\x18\x01 \x01(\v26.teleport.externalauditstorage.v1.ExternalAuditStorageR\x1bclusterExternalAuditStorage\"'\n" +
	"%GetClusterExternalAuditStorageRequest\"\xa5\x01\n" +
	"&GetClusterExternalAuditStorageResponse\x12{\n" +
	"\x1ecluster_external_audit_storage\x18\x01 \x01(\v26.teleport.externalauditstorage.v1.ExternalAuditStorageR\x1bclusterExternalAuditStorage\"+\n" +
	")DisableClusterExternalAuditStorageRequest\"m\n" +
	"(GenerateDraftExternalAuditStorageRequest\x12)\n" +
	"\x10integration_name\x18\x01 \x01(\tR\x0fintegrationName\x12\x16\n" +
	"\x06region\x18\x02 \x01(\tR\x06region\"\x99\x01\n" +
	")GenerateDraftExternalAuditStorageResponse\x12l\n" +
	"\x16external_audit_storage\x18\x01 \x01(\v26.teleport.externalauditstorage.v1.ExternalAuditStorageR\x14externalAuditStorage\"-\n" +
	"+TestDraftExternalAuditStorageBucketsRequest\".\n" +
	",TestDraftExternalAuditStorageBucketsResponse\"*\n" +
	"(TestDraftExternalAuditStorageGlueRequest\"+\n" +
	")TestDraftExternalAuditStorageGlueResponse\",\n" +
	"*TestDraftExternalAuditStorageAthenaRequest\"-\n" +
	"+TestDraftExternalAuditStorageAthenaResponse2\xda\x0f\n" +
	"\x1bExternalAuditStorageService\x12\xad\x01\n" +
	"\x1cGetDraftExternalAuditStorage\x12E.teleport.externalauditstorage.v1.GetDraftExternalAuditStorageRequest\x1aF.teleport.externalauditstorage.v1.GetDraftExternalAuditStorageResponse\x12\xb6\x01\n" +
	"\x1fCreateDraftExternalAuditStorage\x12H.teleport.externalauditstorage.v1.CreateDraftExternalAuditStorageRequest\x1aI.teleport.externalauditstorage.v1.CreateDraftExternalAuditStorageResponse\x12\xb6\x01\n" +
	"\x1fUpsertDraftExternalAuditStorage\x12H.teleport.externalauditstorage.v1.UpsertDraftExternalAuditStorageRequest\x1aI.teleport.externalauditstorage.v1.UpsertDraftExternalAuditStorageResponse\x12\x83\x01\n" +
	"\x1fDeleteDraftExternalAuditStorage\x12H.teleport.externalauditstorage.v1.DeleteDraftExternalAuditStorageRequest\x1a\x16.google.protobuf.Empty\x12\xc5\x01\n" +
	"$PromoteToClusterExternalAuditStorage\x12M.teleport.externalauditstorage.v1.PromoteToClusterExternalAuditStorageRequest\x1aN.teleport.externalauditstorage.v1.PromoteToClusterExternalAuditStorageResponse\x12\xb3\x01\n" +
	"\x1eGetClusterExternalAuditStorage\x12G.teleport.externalauditstorage.v1.GetClusterExternalAuditStorageRequest\x1aH.teleport.externalauditstorage.v1.GetClusterExternalAuditStorageResponse\x12\x89\x01\n" +
	"\"DisableClusterExternalAuditStorage\x12K.teleport.externalauditstorage.v1.DisableClusterExternalAuditStorageRequest\x1a\x16.google.protobuf.Empty\x12\xbc\x01\n" +
	"!GenerateDraftExternalAuditStorage\x12J.teleport.externalauditstorage.v1.GenerateDraftExternalAuditStorageRequest\x1aK.teleport.externalauditstorage.v1.GenerateDraftExternalAuditStorageResponse\x12\xc5\x01\n" +
