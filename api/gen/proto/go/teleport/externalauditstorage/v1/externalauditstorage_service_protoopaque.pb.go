...
type GetDraftExternalAuditStorageResponse struct {
	state                           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ExternalAuditStorage *ExternalAuditStorage  `protobuf:"bytes,1,opt,name=external_audit_storage,json=externalAuditStorage,proto3"`
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
func (x *GetDraftExternalAuditStorageResponse) HasExternalAuditStorage() bool {
	...
	return x.xxx_hidden_ExternalAuditStorage != nil
}

func (x *GetDraftExternalAuditStorageResponse) ClearExternalAuditStorage() {
	x.xxx_hidden_ExternalAuditStorage = nil
}
...
func (b0 GetDraftExternalAuditStorageResponse_builder) Build() *GetDraftExternalAuditStorageResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_ExternalAuditStorage = b.ExternalAuditStorage
	return m0
}
...
type PromoteToClusterExternalAuditStorageResponse struct {
	state                                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ClusterExternalAuditStorage *ExternalAuditStorage  `protobuf:"bytes,1,opt,name=cluster_external_audit_storage,json=clusterExternalAuditStorage,proto3"`
	unknownFields                          protoimpl.UnknownFields
	sizeCache                              protoimpl.SizeCache
}
...
func (x *PromoteToClusterExternalAuditStorageResponse) HasClusterExternalAuditStorage() bool {
	...
	return x.xxx_hidden_ClusterExternalAuditStorage != nil
}

func (x *PromoteToClusterExternalAuditStorageResponse) ClearClusterExternalAuditStorage() {
	x.xxx_hidden_ClusterExternalAuditStorage = nil
}
...
func (b0 PromoteToClusterExternalAuditStorageResponse_builder) Build() *PromoteToClusterExternalAuditStorageResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_ClusterExternalAuditStorage = b.ClusterExternalAuditStorage
	return m0
}
