...
type CreateAccessListWithPresetRequest struct {
	...
	AccessRoles   []*types.RoleV6 `protobuf:"bytes,3,rep,name=access_roles,json=accessRoles,proto3" json:"access_roles,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateAccessListWithPresetRequest) GetAccessRoles() []*types.RoleV6 {
	if x != nil {
...
type CreateAccessListWithPresetResponse struct {
	...
	AccessList *AccessList `protobuf:"bytes,1,opt,name=access_list,json=accessList,proto3" json:"access_list,omitempty"`
	// access_roles are the roles that grant actual permissions to resources. Managed by Teleport.
	AccessRoles   []*types.RoleV6 `protobuf:"bytes,2,rep,name=access_roles,json=accessRoles,proto3" json:"access_roles,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateAccessListWithPresetResponse) GetAccessRoles() []*types.RoleV6 {
	if x != nil {
		return x.AccessRoles
	}
	return nil
...
// Deprecated: Use UpdateAccessListWithPresetRequest.ProtoReflect.Descriptor instead.
func (*UpdateAccessListWithPresetRequest) Descriptor() ([]byte, []int) {
...
func (x *UpdateAccessListWithPresetRequest) GetAccessRoles() []*types.RoleV6 {
	if x != nil {
		return x.AccessRoles
	}
	return nil
...
type UpdateAccessListWithPresetResponse struct {
	...
	AccessList *AccessList `protobuf:"bytes,1,opt,name=access_list,json=accessList,proto3" json:"access_list,omitempty"`
	// access_roles are the updated roles that grant permissions to resources. Managed by Teleport.
	AccessRoles   []*types.RoleV6 `protobuf:"bytes,2,rep,name=access_roles,json=accessRoles,proto3" json:"access_roles,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// Deprecated: Use UpdateAccessListWithPresetResponse.ProtoReflect.Descriptor instead.
func (*UpdateAccessListWithPresetResponse) Descriptor() ([]byte, []int) {
...
func (x *UpdateAccessListWithPresetResponse) GetAccessRoles() []*types.RoleV6 {
	if x != nil {
		return x.AccessRoles
	}
	return nil
...
// DeleteAccessListWithPresetRequest is the request for deleting an access list with preset configuration.
type DeleteAccessListWithPresetRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// name is the name of the access list to delete along with all its managed preset roles.
	Name          string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DeleteAccessListWithPresetRequest) Reset() {
	*x = DeleteAccessListWithPresetRequest{}
	mi := &file_teleport_accesslist_v1_accesslist_service_proto_msgTypes[55]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteAccessListWithPresetRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteAccessListWithPresetRequest) ProtoMessage() {}

func (x *DeleteAccessListWithPresetRequest) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_accesslist_v1_accesslist_service_proto_msgTypes[55]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteAccessListWithPresetRequest.ProtoReflect.Descriptor instead.
func (*DeleteAccessListWithPresetRequest) Descriptor() ([]byte, []int) {
	return file_teleport_accesslist_v1_accesslist_service_proto_rawDescGZIP(), []int{55}
}

func (x *DeleteAccessListWithPresetRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
// DeleteAccessListWithPresetResponse is the response for deleting an access list with preset configuration.
...
func (x *DeleteAccessListWithPresetResponse) Reset() {
	*x = DeleteAccessListWithPresetResponse{}
	mi := &file_teleport_accesslist_v1_accesslist_service_proto_msgTypes[56]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteAccessListWithPresetResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteAccessListWithPresetResponse) ProtoMessage() {}

func (x *DeleteAccessListWithPresetResponse) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_accesslist_v1_accesslist_service_proto_msgTypes[56]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteAccessListWithPresetResponse.ProtoReflect.Descriptor instead.
func (*DeleteAccessListWithPresetResponse) Descriptor() ([]byte, []int) {
	return file_teleport_accesslist_v1_accesslist_service_proto_rawDescGZIP(), []int{56}
}
...
const file_teleport_accesslist_v1_accesslist_service_proto_rawDesc = "" +
	...
	"accessList\x120\n" +
	"\faccess_roles\x18\x03 \x03(\v2\r.types.RoleV6R\vaccessRoles\"\x9b\x01\n" +
	"\"CreateAccessListWithPresetResponse\x12C\n" +
	"\vaccess_list\x18\x01 \x01(\v2\".teleport.accesslist.v1.AccessListR\n" +
	"accessList\x120\n" +
	"\faccess_roles\x18\x02 \x03(\v2\r.types.RoleV6R\vaccessRoles\"\x9a\x01\n" +
	"!UpdateAccessListWithPresetRequest\x12C\n" +
	"\vaccess_list\x18\x01 \x01(\v2\".teleport.accesslist.v1.AccessListR\n" +
	"accessList\x120\n" +
	"\faccess_roles\x18\x02 \x03(\v2\r.types.RoleV6R\vaccessRoles\"\x9b\x01\n" +
	"\"UpdateAccessListWithPresetResponse\x12C\n" +
	"\vaccess_list\x18\x01 \x01(\v2\".teleport.accesslist.v1.AccessListR\n" +
	"accessList\x120\n" +
	"\faccess_roles\x18\x02 \x03(\v2\r.types.RoleV6R\vaccessRoles\"7\n" +
	"!DeleteAccessListWithPresetRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"$\n" +
	"\"DeleteAccessListWithPresetResponse2\x8a\"\n" +
	...
	"\x1aUpdateAccessListWithPreset\x129.teleport.accesslist.v1.UpdateAccessListWithPresetRequest\x1a:.teleport.accesslist.v1.UpdateAccessListWithPresetResponse\x12\x93\x01\n" +
	"\x1aDeleteAccessListWithPreset\x129.teleport.accesslist.v1.DeleteAccessListWithPresetRequest\x1a:.teleport.accesslist.v1.DeleteAccessListWithPresetResponseBXZVgithub.com/gravitational/teleport/api/gen/proto/go/teleport/accesslist/v1;accesslistv1b\x06proto3"
...
var file_teleport_accesslist_v1_accesslist_service_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_teleport_accesslist_v1_accesslist_service_proto_goTypes = []any{
	...
	(*DeleteAccessListWithPresetRequest)(nil),              // 55: teleport.accesslist.v1.DeleteAccessListWithPresetRequest
	(*DeleteAccessListWithPresetResponse)(nil),             // 56: teleport.accesslist.v1.DeleteAccessListWithPresetResponse
	(*AccessList)(nil),                                     // 57: teleport.accesslist.v1.AccessList
	(*types.SortBy)(nil),                                   // 58: types.SortBy
	(*AccessListGrants)(nil),                               // 59: teleport.accesslist.v1.AccessListGrants
	(*Member)(nil),                                         // 60: teleport.accesslist.v1.Member
	...
	(*types.RoleV6)(nil),                                   // 65: types.RoleV6
	(*emptypb.Empty)(nil),                                  // 66: google.protobuf.Empty
}
var file_teleport_accesslist_v1_accesslist_service_proto_depIdxs = []int32{
	57, // 0: teleport.accesslist.v1.GetAccessListsResponse.access_lists:type_name -> teleport.accesslist.v1.AccessList
	57, // 1: teleport.accesslist.v1.ListAccessListsResponse.access_lists:type_name -> teleport.accesslist.v1.AccessList
	58, // 2: teleport.accesslist.v1.ListAccessListsV2Request.sort_by:type_name -> types.SortBy
	5,  // 3: teleport.accesslist.v1.ListAccessListsV2Request.filter:type_name -> teleport.accesslist.v1.AccessListsFilter
	57, // 4: teleport.accesslist.v1.ListAccessListsV2Response.access_lists:type_name -> teleport.accesslist.v1.AccessList
	59, // 5: teleport.accesslist.v1.GetInheritedGrantsResponse.grants:type_name -> teleport.accesslist.v1.AccessListGrants
	57, // 6: teleport.accesslist.v1.UpsertAccessListRequest.access_list:type_name -> teleport.accesslist.v1.AccessList
	57, // 7: teleport.accesslist.v1.UpdateAccessListRequest.access_list:type_name -> teleport.accesslist.v1.AccessList
	57, // 8: teleport.accesslist.v1.GetAccessListsToReviewResponse.access_lists:type_name -> teleport.accesslist.v1.AccessList
	60, // 9: teleport.accesslist.v1.ListAccessListMembersResponse.members:type_name -> teleport.accesslist.v1.Member
	60, // 10: teleport.accesslist.v1.ListAllAccessListMembersResponse.members:type_name -> teleport.accesslist.v1.Member
	57, // 11: teleport.accesslist.v1.UpsertAccessListWithMembersRequest.access_list:type_name -> teleport.accesslist.v1.AccessList
	60, // 12: teleport.accesslist.v1.UpsertAccessListWithMembersRequest.members:type_name -> teleport.accesslist.v1.Member
	57, // 13: teleport.accesslist.v1.UpsertAccessListWithMembersResponse.access_list:type_name -> teleport.accesslist.v1.AccessList
	60, // 14: teleport.accesslist.v1.UpsertAccessListWithMembersResponse.members:type_name -> teleport.accesslist.v1.Member
	60, // 15: teleport.accesslist.v1.GetStaticAccessListMemberResponse.member:type_name -> teleport.accesslist.v1.Member
	61, // 16: teleport.accesslist.v1.GetAccessListOwnersResponse.owners:type_name -> teleport.accesslist.v1.AccessListOwner
	60, // 17: teleport.accesslist.v1.UpsertAccessListMemberRequest.member:type_name -> teleport.accesslist.v1.Member
	60, // 18: teleport.accesslist.v1.UpsertStaticAccessListMemberRequest.member:type_name -> teleport.accesslist.v1.Member
	60, // 19: teleport.accesslist.v1.UpsertStaticAccessListMemberResponse.member:type_name -> teleport.accesslist.v1.Member
	60, // 20: teleport.accesslist.v1.UpdateAccessListMemberRequest.member:type_name -> teleport.accesslist.v1.Member
	62, // 21: teleport.accesslist.v1.ListAccessListReviewsResponse.reviews:type_name -> teleport.accesslist.v1.Review
	62, // 22: teleport.accesslist.v1.ListAllAccessListReviewsResponse.reviews:type_name -> teleport.accesslist.v1.Review
	62, // 23: teleport.accesslist.v1.CreateAccessListReviewRequest.review:type_name -> teleport.accesslist.v1.Review
	63, // 24: teleport.accesslist.v1.CreateAccessListReviewResponse.next_audit_date:type_name -> google.protobuf.Timestamp
	64, // 25: teleport.accesslist.v1.AccessRequestPromoteResponse.access_request:type_name -> types.AccessRequestV3
	57, // 26: teleport.accesslist.v1.GetSuggestedAccessListsResponse.access_lists:type_name -> teleport.accesslist.v1.AccessList
	57, // 27: teleport.accesslist.v1.ListUserAccessListsResponse.access_lists:type_name -> teleport.accesslist.v1.AccessList
	57, // 28: teleport.accesslist.v1.CreateAccessListWithPresetRequest.access_list:type_name -> teleport.accesslist.v1.AccessList
	65, // 29: teleport.accesslist.v1.CreateAccessListWithPresetRequest.access_roles:type_name -> types.RoleV6
	57, // 30: teleport.accesslist.v1.CreateAccessListWithPresetResponse.access_list:type_name -> teleport.accesslist.v1.AccessList
	65, // 31: teleport.accesslist.v1.CreateAccessListWithPresetResponse.access_roles:type_name -> types.RoleV6
	57, // 32: teleport.accesslist.v1.UpdateAccessListWithPresetRequest.access_list:type_name -> teleport.accesslist.v1.AccessList
	65, // 33: teleport.accesslist.v1.UpdateAccessListWithPresetRequest.access_roles:type_name -> types.RoleV6
	57, // 34: teleport.accesslist.v1.UpdateAccessListWithPresetResponse.access_list:type_name -> teleport.accesslist.v1.AccessList
	65, // 35: teleport.accesslist.v1.UpdateAccessListWithPresetResponse.access_roles:type_name -> types.RoleV6
	...
	55, // 69: teleport.accesslist.v1.AccessListService.DeleteAccessListWithPreset:input_type -> teleport.accesslist.v1.DeleteAccessListWithPresetRequest
	1,  // 70: teleport.accesslist.v1.AccessListService.GetAccessLists:output_type -> teleport.accesslist.v1.GetAccessListsResponse
	3,  // 71: teleport.accesslist.v1.AccessListService.ListAccessLists:output_type -> teleport.accesslist.v1.ListAccessListsResponse
	6,  // 72: teleport.accesslist.v1.AccessListService.ListAccessListsV2:output_type -> teleport.accesslist.v1.ListAccessListsV2Response
	57, // 73: teleport.accesslist.v1.AccessListService.GetAccessList:output_type -> teleport.accesslist.v1.AccessList
	57, // 74: teleport.accesslist.v1.AccessListService.UpsertAccessList:output_type -> teleport.accesslist.v1.AccessList
	57, // 75: teleport.accesslist.v1.AccessListService.UpdateAccessList:output_type -> teleport.accesslist.v1.AccessList
	66, // 76: teleport.accesslist.v1.AccessListService.DeleteAccessList:output_type -> google.protobuf.Empty
	66, // 77: teleport.accesslist.v1.AccessListService.DeleteAllAccessLists:output_type -> google.protobuf.Empty
	15, // 78: teleport.accesslist.v1.AccessListService.GetAccessListsToReview:output_type -> teleport.accesslist.v1.GetAccessListsToReviewResponse
	17, // 79: teleport.accesslist.v1.AccessListService.CountAccessListMembers:output_type -> teleport.accesslist.v1.CountAccessListMembersResponse
	19, // 80: teleport.accesslist.v1.AccessListService.ListAccessListMembers:output_type -> teleport.accesslist.v1.ListAccessListMembersResponse
	21, // 81: teleport.accesslist.v1.AccessListService.ListAllAccessListMembers:output_type -> teleport.accesslist.v1.ListAllAccessListMembersResponse
	60, // 82: teleport.accesslist.v1.AccessListService.GetAccessListMember:output_type -> teleport.accesslist.v1.Member
	26, // 83: teleport.accesslist.v1.AccessListService.GetStaticAccessListMember:output_type -> teleport.accesslist.v1.GetStaticAccessListMemberResponse
	28, // 84: teleport.accesslist.v1.AccessListService.GetAccessListOwners:output_type -> teleport.accesslist.v1.GetAccessListOwnersResponse
	60, // 85: teleport.accesslist.v1.AccessListService.UpsertAccessListMember:output_type -> teleport.accesslist.v1.Member
	31, // 86: teleport.accesslist.v1.AccessListService.UpsertStaticAccessListMember:output_type -> teleport.accesslist.v1.UpsertStaticAccessListMemberResponse
	60, // 87: teleport.accesslist.v1.AccessListService.UpdateAccessListMember:output_type -> teleport.accesslist.v1.Member
	66, // 88: teleport.accesslist.v1.AccessListService.DeleteAccessListMember:output_type -> google.protobuf.Empty
	35, // 89: teleport.accesslist.v1.AccessListService.DeleteStaticAccessListMember:output_type -> teleport.accesslist.v1.DeleteStaticAccessListMemberResponse
	66, // 90: teleport.accesslist.v1.AccessListService.DeleteAllAccessListMembersForAccessList:output_type -> google.protobuf.Empty
	66, // 91: teleport.accesslist.v1.AccessListService.DeleteAllAccessListMembers:output_type -> google.protobuf.Empty
	23, // 92: teleport.accesslist.v1.AccessListService.UpsertAccessListWithMembers:output_type -> teleport.accesslist.v1.UpsertAccessListWithMembersResponse
	39, // 93: teleport.accesslist.v1.AccessListService.ListAccessListReviews:output_type -> teleport.accesslist.v1.ListAccessListReviewsResponse
	41, // 94: teleport.accesslist.v1.AccessListService.ListAllAccessListReviews:output_type -> teleport.accesslist.v1.ListAllAccessListReviewsResponse
	43, // 95: teleport.accesslist.v1.AccessListService.CreateAccessListReview:output_type -> teleport.accesslist.v1.CreateAccessListReviewResponse
	66, // 96: teleport.accesslist.v1.AccessListService.DeleteAccessListReview:output_type -> google.protobuf.Empty
	46, // 97: teleport.accesslist.v1.AccessListService.AccessRequestPromote:output_type -> teleport.accesslist.v1.AccessRequestPromoteResponse
	48, // 98: teleport.accesslist.v1.AccessListService.GetSuggestedAccessLists:output_type -> teleport.accesslist.v1.GetSuggestedAccessListsResponse
	8,  // 99: teleport.accesslist.v1.AccessListService.GetInheritedGrants:output_type -> teleport.accesslist.v1.GetInheritedGrantsResponse
	50, // 100: teleport.accesslist.v1.AccessListService.ListUserAccessLists:output_type -> teleport.accesslist.v1.ListUserAccessListsResponse
	52, // 101: teleport.accesslist.v1.AccessListService.CreateAccessListWithPreset:output_type -> teleport.accesslist.v1.CreateAccessListWithPresetResponse
	54, // 102: teleport.accesslist.v1.AccessListService.UpdateAccessListWithPreset:output_type -> teleport.accesslist.v1.UpdateAccessListWithPresetResponse
	56, // 103: teleport.accesslist.v1.AccessListService.DeleteAccessListWithPreset:output_type -> teleport.accesslist.v1.DeleteAccessListWithPresetResponse
