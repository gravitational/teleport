...
func (x *GetAccessListResponse) Reset() {
	*x = GetAccessListResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAccessListResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAccessListResponse) ProtoMessage() {}

func (x *GetAccessListResponse) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_accesslist_v1_accesslist_service_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAccessListResponse.ProtoReflect.Descriptor instead.
...
func (x *GetAccessListResponse) GetAccessList() *AccessList {
	if x != nil {
		return x.AccessList
	}
	return nil
...
func (x *UpsertAccessListResponse) Reset() {
	*x = UpsertAccessListResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpsertAccessListResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpsertAccessListResponse) ProtoMessage() {}

func (x *UpsertAccessListResponse) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_accesslist_v1_accesslist_service_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpsertAccessListResponse.ProtoReflect.Descriptor instead.
...
func (x *UpsertAccessListResponse) GetAccessList() *AccessList {
	if x != nil {
		return x.AccessList
	}
	return nil
...
var file_teleport_accesslist_v1_accesslist_service_proto_rawDesc = []byte{
	...
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x5c, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x65,
	...
	0x69, 0x73, 0x74, 0x22, 0x5e, 0x0a, 0x17, 0x55, 0x70, 0x73, 0x65, 0x72, 0x74, 0x41, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x43,
	0x0a, 0x0b, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x61,
	0x63, 0x63, 0x65, 0x73, 0x73, 0x6c, 0x69, 0x73, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x0a, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x4c,
	0x69, 0x73, 0x74, 0x22, 0x5f, 0x0a, 0x18, 0x55, 0x70, 0x73, 0x65, 0x72, 0x74, 0x41, 0x63, 0x63,
	...
	0x4c, 0x69, 0x73, 0x74, 0x22, 0x2d, 0x0a, 0x17, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x41, 0x63,
	...
	0x73, 0x74, 0x32, 0x91, 0x04, 0x0a, 0x11, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x4c, 0x69, 0x73,
	...
	,
	...
	0x6d, 0x70, 0x74, 0x79, 0x12, 0x5b, 0x0a, 0x10, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x41, 0x63,
...
var file_teleport_accesslist_v1_accesslist_service_proto_goTypes = []interface{}{
	...
	(*GetAccessListResponse)(nil),       // 3: teleport.accesslist.v1.GetAccessListResponse
	(*UpsertAccessListRequest)(nil),     // 4: teleport.accesslist.v1.UpsertAccessListRequest
	(*UpsertAccessListResponse)(nil),    // 5: teleport.accesslist.v1.UpsertAccessListResponse
...
var file_teleport_accesslist_v1_accesslist_service_proto_depIdxs = []int32{
	...
	8, // 1: teleport.accesslist.v1.GetAccessListResponse.access_list:type_name -> teleport.accesslist.v1.AccessList
	8, // 2: teleport.accesslist.v1.UpsertAccessListRequest.access_list:type_name -> teleport.accesslist.v1.AccessList
	8, // 3: teleport.accesslist.v1.UpsertAccessListResponse.access_list:type_name -> teleport.accesslist.v1.AccessList
	0, // 4: teleport.accesslist.v1.AccessListService.GetAccessLists:input_type -> teleport.accesslist.v1.GetAccessListsRequest
	2, // 5: teleport.accesslist.v1.AccessListService.GetAccessList:input_type -> teleport.accesslist.v1.GetAccessListRequest
	4, // 6: teleport.accesslist.v1.AccessListService.UpsertAccessList:input_type -> teleport.accesslist.v1.UpsertAccessListRequest
	...
	3, // 10: teleport.accesslist.v1.AccessListService.GetAccessList:output_type -> teleport.accesslist.v1.GetAccessListResponse
	9, // 11: teleport.accesslist.v1.AccessListService.UpsertAccessList:output_type -> google.protobuf.Empty
	9, // 12: teleport.accesslist.v1.AccessListService.DeleteAccessList:output_type -> google.protobuf.Empty
	9, // 13: teleport.accesslist.v1.AccessListService.DeleteAllAccessLists:output_type -> google.protobuf.Empty
...
func file_teleport_accesslist_v1_accesslist_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_teleport_accesslist_v1_accesslist_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAccessListResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_teleport_accesslist_v1_accesslist_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpsertAccessListResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
