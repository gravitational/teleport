...
const file_teleport_accesslist_v1_accesslist_proto_rawDesc = "" +
	...
	"J\x04\b\n" +
	"\x10\vR\amembersR\n" +
	"membershipR\townership\"\x9e\x01\n" +
	"\x0fAccessListOwner\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12U\n" +
	"\x11ineligible_status\x18\x03 \x01(\x0e2(.teleport.accesslist.v1.IneligibleStatusR\x10ineligibleStatus\"\xf7\x01\n" +
	...
	"\x04spec\x18\x02 \x01(\v2\".teleport.accesslist.v1.MemberSpecR\x04spec\"\xc7\x02\n" +
	"\n" +
	"MemberSpec\x12\x1f\n" +
	...
	"\x11ineligible_status\x18\a \x01(\x0e2(.teleport.accesslist.v1.IneligibleStatusR\x10ineligibleStatusJ\x04\b\b\x10\tR\n" +
	"membership\"|\n" +
	"\x06Review\x12:\n" +
	"\x06header\x18\x01 \x01(\v2\".teleport.header.v1.ResourceHeaderR\x06header\x126\n" +
	...
	"\x1breview_day_of_month_changed\x18\x05 \x01(\x0e2(.teleport.accesslist.v1.ReviewDayOfMonthR\x17reviewDayOfMonthChangedJ\x04\b\x01\x10\x02R\x11frequency_changed\"K\n" +
	"\x10AccessListStatus\x12&\n" +
	"\fmember_count\x18\x01 \x01(\rH\x00R\vmemberCount\x88\x01\x01B\x0f\n" +
	"\r_member_count*\xb6\x01\n" +
