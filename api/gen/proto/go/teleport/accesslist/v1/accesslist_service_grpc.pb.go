...
const (
	...
	AccessListService_DeleteAccessListWithPreset_FullMethodName              = "/teleport.accesslist.v1.AccessListService/DeleteAccessListWithPreset"
)
...
type AccessListServiceClient interface {
	...
	// DeleteAccessListWithPreset deletes an access list and all associated preset roles.
	DeleteAccessListWithPreset(ctx context.Context, in *DeleteAccessListWithPresetRequest, opts ...grpc.CallOption) (*DeleteAccessListWithPresetResponse, error)
}
...
func (c *accessListServiceClient) DeleteAccessListWithPreset(ctx context.Context, in *DeleteAccessListWithPresetRequest, opts ...grpc.CallOption) (*DeleteAccessListWithPresetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteAccessListWithPresetResponse)
	err := c.cc.Invoke(ctx, AccessListService_DeleteAccessListWithPreset_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccessListServiceServer interface {
	...
	// DeleteAccessListWithPreset deletes an access list and all associated preset roles.
	DeleteAccessListWithPreset(context.Context, *DeleteAccessListWithPresetRequest) (*DeleteAccessListWithPresetResponse, error)
...
func (UnimplementedAccessListServiceServer) ListAccessListsV2(context.Context, *ListAccessListsV2Request) (*ListAccessListsV2Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListAccessListsV2 not implemented")
}
...
func (UnimplementedAccessListServiceServer) DeleteAccessListWithPreset(context.Context, *DeleteAccessListWithPresetRequest) (*DeleteAccessListWithPresetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteAccessListWithPreset not implemented")
}
...
func _AccessListService_DeleteAccessListWithPreset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteAccessListWithPresetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccessListServiceServer).DeleteAccessListWithPreset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccessListService_DeleteAccessListWithPreset_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccessListServiceServer).DeleteAccessListWithPreset(ctx, req.(*DeleteAccessListWithPresetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccessListService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteAccessListWithPreset",
			Handler:    _AccessListService_DeleteAccessListWithPreset_Handler,
		},
	},
