...
type ReviewStatus struct {
	state                       protoimpl.MessageState  `protogen:"opaque.v1"`
	xxx_hidden_ReviewerDisplays map[string]*UserDisplay `protobuf:"bytes,1,rep,name=reviewer_displays,json=reviewerDisplays,proto3" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *ReviewStatus) GetReviewerDisplays() map[string]*UserDisplay {
	if x != nil {
		return x.xxx_hidden_ReviewerDisplays
	}
	return nil
}

func (x *ReviewStatus) SetReviewerDisplays(v map[string]*UserDisplay) {
	x.xxx_hidden_ReviewerDisplays = v
}
...
func (b0 ReviewStatus_builder) Build() *ReviewStatus {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_ReviewerDisplays = b.ReviewerDisplays
	return m0
}
...
type Review struct {
	...
	xxx_hidden_Scope  string                 `protobuf:"bytes,3,opt,name=scope,proto3"`
	xxx_hidden_Status *ReviewStatus          `protobuf:"bytes,4,opt,name=status,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
