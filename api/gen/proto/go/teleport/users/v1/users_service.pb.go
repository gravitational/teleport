...
const file_teleport_users_v1_users_service_proto_rawDesc = "" +
	...
	"\fwith_secrets\x18\x03 \x01(\bR\vwithSecrets\"4\n" +
	"\x0fGetUserResponse\x12!\n" +
	"\x04user\x18\x01 \x01(\v2\r.types.UserV2R\x04user\"\x9c\x01\n" +
	"\x10ListUsersRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\x12!\n" +
	"\fwith_secrets\x18\x03 \x01(\bR\vwithSecrets\x12)\n" +
	"\x06filter\x18\x04 \x01(\v2\x11.types.UserFilterR\x06filter\"`\n" +
	"\x11ListUsersResponse\x12#\n" +
	"\x05users\x18\x01 \x03(\v2\r.types.UserV2R\x05users\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"6\n" +
	"\x11CreateUserRequest\x12!\n" +
	"\x04user\x18\x01 \x01(\v2\r.types.UserV2R\x04user\"7\n" +
	"\x12CreateUserResponse\x12!\n" +
	"\x04user\x18\x01 \x01(\v2\r.types.UserV2R\x04user\"6\n" +
	"\x11UpdateUserRequest\x12!\n" +
	"\x04user\x18\x02 \x01(\v2\r.types.UserV2R\x04user\"7\n" +
	...
	"\n" +
	"CreateUser\x12$.teleport.users.v1.CreateUserRequest\x1a%.teleport.users.v1.CreateUserResponse\x12Y\n" +
	"\n" +
	"UpdateUser\x12$.teleport.users.v1.UpdateUserRequest\x1a%.teleport.users.v1.UpdateUserResponse\x12Y\n" +
	"\n" +
