...
type GetUserRequest struct {
	...
	xxx_hidden_CurrentUser bool                   `protobuf:"varint,2,opt,name=current_user,json=currentUser,proto3"`
...
func (x *GetUserRequest) GetCurrentUser() bool {
	if x != nil {
		return x.xxx_hidden_CurrentUser
	}
	return false
}
...
func (b0 GetUserRequest_builder) Build() *GetUserRequest {
	...
	x.xxx_hidden_CurrentUser = b.CurrentUser
...
type GetUserResponse struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_User *types.UserV2          `protobuf:"bytes,1,opt,name=user,proto3"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type ListUsersRequest struct {
	...
	xxx_hidden_WithSecrets bool                   `protobuf:"varint,3,opt,name=with_secrets,json=withSecrets,proto3"`
	xxx_hidden_Filter      *types.UserFilter      `protobuf:"bytes,4,opt,name=filter,proto3"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type ListUsersResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Users         *[]*types.UserV2       `protobuf:"bytes,1,rep,name=users,proto3"`
...
type UpdateUserRequest struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_User *types.UserV2          `protobuf:"bytes,2,opt,name=user,proto3"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type ResetUserResponse struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PasswordResetToken *types.UserTokenV3     `protobuf:"bytes,1,opt,name=password_reset_token,json=passwordResetToken,proto3"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *ResetUserResponse) GetPasswordResetToken() *types.UserTokenV3 {
	if x != nil {
		return x.xxx_hidden_PasswordResetToken
	}
	return nil
}

func (x *ResetUserResponse) SetPasswordResetToken(v *types.UserTokenV3) {
	x.xxx_hidden_PasswordResetToken = v
}
...
func (x *ResetUserResponse) HasPasswordResetToken() bool {
	...
	return x.xxx_hidden_PasswordResetToken != nil
}

func (x *ResetUserResponse) ClearPasswordResetToken() {
	x.xxx_hidden_PasswordResetToken = nil
}
...
func (b0 ResetUserResponse_builder) Build() *ResetUserResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_PasswordResetToken = b.PasswordResetToken
	return m0
}
