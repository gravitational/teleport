...
const file_teleport_integration_v1_awsoidc_service_proto_rawDesc = "" +
	"\n" +
	"-teleport/integration/v1/awsoidc_service.proto\x12\x17teleport.integration.v1\x1a!teleport/legacy/types/types.proto\"\x83\x01\n" +
	...
	"\n" +
	"next_token\x18\x04 \x01(\tR\tnextToken\"\xc6\x01\n" +
	...
	"\x06vpc_id\x18\x06 \x01(\tR\x05vpcId\"\xa7\x01\n" +
	...
	"\tendpoints\x18\x03 \x03(\v2&.teleport.integration.v1.EC2ICEndpointR\tendpoints\"n\n" +
	"\rEC2ICEndpoint\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1b\n" +
	"\tsubnet_id\x18\x02 \x01(\tR\bsubnetId\x12,\n" +
	"\x12security_group_ids\x18\x03 \x03(\tR\x10securityGroupIds\"}\n" +
	"\x12CreateEICEResponse\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12S\n" +
	"\x11created_endpoints\x18\x02 \x03(\v2&.teleport.integration.v1.EC2ICEndpointR\x10createdEndpoints\"\xbb\x01\n" +
	...
	"\aresults\x18\x01 \x03(\v2/.teleport.integration.v1.EnrollEKSClusterResultR\aresults\"i\n" +
	...
	"\n" +
	"next_token\x18\x02 \x01(\tR\tnextToken\"q\n" +
	...
	"\auser_id\x18\x03 \x01(\tR\x06userId2\xce\v\n" +
	"\x0eAWSOIDCService\x12_\n" +
	"\bListEICE\x12(.teleport.integration.v1.ListEICERequest\x1a).teleport.integration.v1.ListEICEResponse\x12e\n" +
	"\n" +
	"CreateEICE\x12*.teleport.integration.v1.CreateEICERequest\x1a+.teleport.integration.v1.CreateEICEResponse\x12n\n" +
	...
	"\x11EnrollEKSClusters\x121.teleport.integration.v1.EnrollEKSClustersRequest\x1a2.teleport.integration.v1.EnrollEKSClustersResponse\x12\\\n" +
	"\aListEC2\x12'.teleport.integration.v1.ListEC2Request\x1a(.teleport.integration.v1.ListEC2Response\x12t\n" +
