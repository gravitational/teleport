...
type CreateDatabaseObjectImportRuleRequest struct {
	...
	xxx_hidden_Rule *DatabaseObjectImportRule `protobuf:"bytes,1,opt,name=rule,proto3"`
...
type ListDatabaseObjectImportRulesResponse struct {
	state                    protoimpl.MessageState       `protogen:"opaque.v1"`
	xxx_hidden_Rules         *[]*DatabaseObjectImportRule `protobuf:"bytes,1,rep,name=rules,proto3"`
