...
type DatabaseObjectImportRule struct {
	...
	xxx_hidden_Spec     *DatabaseObjectImportRuleSpec `protobuf:"bytes,5,opt,name=spec,proto3"`
...
type DatabaseObjectImportRuleSpec struct {
	...
	xxx_hidden_DatabaseLabels *[]*v11.Label                       `protobuf:"bytes,3,rep,name=database_labels,json=databaseLabels,proto3"`
	xxx_hidden_Mappings       *[]*DatabaseObjectImportRuleMapping `protobuf:"bytes,4,rep,name=mappings,proto3"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *DatabaseObjectImportRuleSpec) GetDatabaseLabels() []*v11.Label {
	if x != nil {
		if x.xxx_hidden_DatabaseLabels != nil {
			return *x.xxx_hidden_DatabaseLabels
		}
	}
	return nil
}
...
func (b0 DatabaseObjectImportRuleSpec_builder) Build() *DatabaseObjectImportRuleSpec {
	...
	x.xxx_hidden_DatabaseLabels = &b.DatabaseLabels
...
type DatabaseObjectImportRuleMapping struct {
	state                protoimpl.MessageState     `protogen:"opaque.v1"`
	xxx_hidden_Match     *DatabaseObjectImportMatch `protobuf:"bytes,1,opt,name=match,proto3"`
	xxx_hidden_Scope     *DatabaseObjectImportScope `protobuf:"bytes,2,opt,name=scope,proto3"`
	xxx_hidden_AddLabels map[string]string          `protobuf:"bytes,3,rep,name=add_labels,json=addLabels,proto3" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (b0 DatabaseObjectImportRuleMapping_builder) Build() *DatabaseObjectImportRuleMapping {
	...
	x.xxx_hidden_AddLabels = b.AddLabels
	return m0
}
...
type DatabaseObjectImportMatch struct {
	state                     protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_TableNames     []string               `protobuf:"bytes,1,rep,name=table_names,json=tableNames,proto3"`
	xxx_hidden_ViewNames      []string               `protobuf:"bytes,2,rep,name=view_names,json=viewNames,proto3"`
	xxx_hidden_ProcedureNames []string               `protobuf:"bytes,3,rep,name=procedure_names,json=procedureNames,proto3"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *DatabaseObjectImportMatch) GetTableNames() []string {
	if x != nil {
		return x.xxx_hidden_TableNames
	}
	return nil
}
...
func (b0 DatabaseObjectImportMatch_builder) Build() *DatabaseObjectImportMatch {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_TableNames = b.TableNames
	x.xxx_hidden_ViewNames = b.ViewNames
	x.xxx_hidden_ProcedureNames = b.ProcedureNames
	return m0
}
...
type DatabaseObjectImportScope struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_DatabaseNames []string               `protobuf:"bytes,1,rep,name=database_names,json=databaseNames,proto3"`
	xxx_hidden_SchemaNames   []string               `protobuf:"bytes,2,rep,name=schema_names,json=schemaNames,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *DatabaseObjectImportScope) GetDatabaseNames() []string {
	if x != nil {
		return x.xxx_hidden_DatabaseNames
	}
	return nil
}
...
func (b0 DatabaseObjectImportScope_builder) Build() *DatabaseObjectImportScope {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_DatabaseNames = b.DatabaseNames
	x.xxx_hidden_SchemaNames = b.SchemaNames
	return m0
}
