...
type CreateDatabaseObjectImportRuleRequest struct {
	...
	Item *DatabaseObjectImportRule `protobuf:"bytes,1,opt,name=item,proto3" json:"item,omitempty"`
}
...
func (x *CreateDatabaseObjectImportRuleRequest) GetItem() *DatabaseObjectImportRule {
	if x != nil {
		return x.Item
	}
	return nil
...
type ListDatabaseObjectImportRulesResponse struct {
	...
	Items []*DatabaseObjectImportRule `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
...
func (x *ListDatabaseObjectImportRulesResponse) GetItems() []*DatabaseObjectImportRule {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *UpdateDatabaseObjectImportRuleRequest) GetItem() *DatabaseObjectImportRule {
	if x != nil {
		return x.Item
	}
	return nil
...
func (x *UpsertDatabaseObjectImportRuleRequest) GetItem() *DatabaseObjectImportRule {
	if x != nil {
		return x.Item
	}
	return nil
...
var file_teleport_dbobjectimportrule_v1_dbobjectimportrule_service_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x72, 0x74, 0x52, 0x75, 0x6c, 0x65, 0x52, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x22, 0x38,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x4c, 0x0a, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x38, 0x2e, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74,
	0x2e, 0x64, 0x62, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x69, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x72,
	0x75, 0x6c, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x4f,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x75, 0x6c, 0x65, 0x52,
	0x04, 0x69, 0x74, 0x65, 0x6d, 0x22, 0x75, 0x0a, 0x25, 0x55, 0x70, 0x73, 0x65, 0x72, 0x74, 0x44,
	...
	0x0a, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x38, 0x2e, 0x74,
	...
	0x72, 0x74, 0x52, 0x75, 0x6c, 0x65, 0x52, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x22, 0x3b, 0x0a, 0x25,
...
var file_teleport_dbobjectimportrule_v1_dbobjectimportrule_service_proto_depIdxs = []int32{
	7,  // 0: teleport.dbobjectimportrule.v1.CreateDatabaseObjectImportRuleRequest.item:type_name -> teleport.dbobjectimportrule.v1.DatabaseObjectImportRule
	7,  // 1: teleport.dbobjectimportrule.v1.ListDatabaseObjectImportRulesResponse.items:type_name -> teleport.dbobjectimportrule.v1.DatabaseObjectImportRule
	7,  // 2: teleport.dbobjectimportrule.v1.UpdateDatabaseObjectImportRuleRequest.item:type_name -> teleport.dbobjectimportrule.v1.DatabaseObjectImportRule
	7,  // 3: teleport.dbobjectimportrule.v1.UpsertDatabaseObjectImportRuleRequest.item:type_name -> teleport.dbobjectimportrule.v1.DatabaseObjectImportRule
