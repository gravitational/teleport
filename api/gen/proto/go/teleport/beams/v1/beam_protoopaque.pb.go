...
type Beam struct {
	...
	xxx_hidden_Spec     *BeamSpec              `protobuf:"bytes,5,opt,name=spec,proto3"`
	xxx_hidden_Status   *BeamStatus            `protobuf:"bytes,6,opt,name=status,proto3"`
...
type BeamSpec struct {
	...
	xxx_hidden_Publish         *PublishSpec           `protobuf:"bytes,3,opt,name=publish,proto3"`
	xxx_hidden_Expires         *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=expires,proto3"`
	xxx_hidden_RequestedRegion string                 `protobuf:"bytes,5,opt,name=requested_region,json=requestedRegion,proto3"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *BeamSpec) GetRequestedRegion() string {
	if x != nil {
		return x.xxx_hidden_RequestedRegion
	}
	return ""
}
...
func (x *BeamSpec) SetRequestedRegion(v string) {
	x.xxx_hidden_RequestedRegion = v
}
...
func (b0 BeamSpec_builder) Build() *BeamSpec {
	...
	x.xxx_hidden_RequestedRegion = b.RequestedRegion
	return m0
}
...
type PublishSpec struct {
	...
	xxx_hidden_Protocol Protocol               `protobuf:"varint,2,opt,name=protocol,proto3,enum=teleport.beams.v1.Protocol"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type BeamStatus struct {
	...
	xxx_hidden_SshAddr              string                 `protobuf:"bytes,4,opt,name=ssh_addr,json=sshAddr,proto3"`
	xxx_hidden_AppName              string                 `protobuf:"bytes,5,opt,name=app_name,json=appName,proto3"`
	xxx_hidden_AppAddrTcp           string                 `protobuf:"bytes,6,opt,name=app_addr_tcp,json=appAddrTcp,proto3"`
	xxx_hidden_AppAddrHttp          string                 `protobuf:"bytes,7,opt,name=app_addr_http,json=appAddrHttp,proto3"`
	xxx_hidden_BotName              string                 `protobuf:"bytes,8,opt,name=bot_name,json=botName,proto3"`
	xxx_hidden_JoinTokenName        string                 `protobuf:"bytes,9,opt,name=join_token_name,json=joinTokenName,proto3"`
	xxx_hidden_DelegationSessionId  string                 `protobuf:"bytes,10,opt,name=delegation_session_id,json=delegationSessionId,proto3"`
	xxx_hidden_WorkloadIdentityName string                 `protobuf:"bytes,11,opt,name=workload_identity_name,json=workloadIdentityName,proto3"`
	xxx_hidden_ComputeStatus        ComputeStatus          `protobuf:"varint,12,opt,name=compute_status,json=computeStatus,proto3,enum=teleport.beams.v1.ComputeStatus"`
...
func (x *BeamStatus) GetAppAddrTcp() string {
	if x != nil {
		return x.xxx_hidden_AppAddrTcp
	}
	return ""
}
...
func (x *BeamStatus) GetAppAddrHttp() string {
	if x != nil {
		return x.xxx_hidden_AppAddrHttp
	}
	return ""
}
...
func (x *BeamStatus) GetComputeStatus() ComputeStatus {
	if x != nil {
		return x.xxx_hidden_ComputeStatus
	}
...
func (x *BeamStatus) SetAppAddrTcp(v string) {
	x.xxx_hidden_AppAddrTcp = v
}

func (x *BeamStatus) SetAppAddrHttp(v string) {
	x.xxx_hidden_AppAddrHttp = v
}
...
func (b0 BeamStatus_builder) Build() *BeamStatus {
	...
	x.xxx_hidden_SshAddr = b.SshAddr
	x.xxx_hidden_AppName = b.AppName
	x.xxx_hidden_AppAddrTcp = b.AppAddrTcp
	x.xxx_hidden_AppAddrHttp = b.AppAddrHttp
	...
	x.xxx_hidden_ComputeStatus = b.ComputeStatus
