...
type CompleteRequest struct {
	...
	AnthropicRequest []byte `protobuf:"bytes,1,opt,name=anthropic_request,json=anthropicRequest,proto3" json:"anthropic_request,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (b0 CompleteRequest_builder) Build() *CompleteRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.AnthropicRequest = b.AnthropicRequest
	return m0
}
...
func (b0 CompleteResponse_builder) Build() *CompleteResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.AnthropicResponse = b.AnthropicResponse
	return m0
}
