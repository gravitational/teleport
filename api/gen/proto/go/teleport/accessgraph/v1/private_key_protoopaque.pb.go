...
type PrivateKey struct {
	...
	xxx_hidden_Spec     *PrivateKeySpec        `protobuf:"bytes,5,opt,name=spec,proto3"`
...
type PrivateKeySpec struct {
	...
	xxx_hidden_PublicKeyFingerprint string                 `protobuf:"bytes,2,opt,name=public_key_fingerprint,json=publicKeyFingerprint,proto3"`
	xxx_hidden_PublicKeyMode        PublicKeyMode          `protobuf:"varint,3,opt,name=public_key_mode,json=publicKeyMode,proto3,enum=teleport.access_graph.v1.PublicKeyMode"`
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
func (x *PrivateKeySpec) GetPublicKeyFingerprint() string {
	if x != nil {
		return x.xxx_hidden_PublicKeyFingerprint
	}
	return ""
}
...
func (x *PrivateKeySpec) GetPublicKeyMode() PublicKeyMode {
	if x != nil {
		return x.xxx_hidden_PublicKeyMode
	}
...
func (x *PrivateKeySpec) SetPublicKeyFingerprint(v string) {
	x.xxx_hidden_PublicKeyFingerprint = v
}

func (x *PrivateKeySpec) SetPublicKeyMode(v PublicKeyMode) {
	x.xxx_hidden_PublicKeyMode = v
}
...
func (b0 PrivateKeySpec_builder) Build() *PrivateKeySpec {
	...
	x.xxx_hidden_PublicKeyFingerprint = b.PublicKeyFingerprint
	x.xxx_hidden_PublicKeyMode = b.PublicKeyMode
	return m0
}
