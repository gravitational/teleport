...
type AuthorizedKey struct {
	...
	xxx_hidden_Spec     *AuthorizedKeySpec     `protobuf:"bytes,5,opt,name=spec,proto3"`
...
func (x *AuthorizedKey) SetMetadata(v *v1.Metadata) {
	x.xxx_hidden_Metadata = v
}

func (x *AuthorizedKey) SetKind(v string) {
	x.xxx_hidden_Kind = v
}

func (x *AuthorizedKey) SetSubKind(v string) {
	x.xxx_hidden_SubKind = v
}

func (x *AuthorizedKey) SetVersion(v string) {
	x.xxx_hidden_Version = v
}

func (x *AuthorizedKey) SetSpec(v *AuthorizedKeySpec) {
	x.xxx_hidden_Spec = v
}

func (x *AuthorizedKey) HasMetadata() bool {
	if x == nil {
		return false
	}
...
func (x *AuthorizedKey) HasSpec() bool {
	if x == nil {
		return false
	}
...
func (x *AuthorizedKey) ClearMetadata() {
	x.xxx_hidden_Metadata = nil
}

func (x *AuthorizedKey) ClearSpec() {
	x.xxx_hidden_Spec = nil
}

type AuthorizedKey_builder struct {
...
func (b0 AuthorizedKey_builder) Build() *AuthorizedKey {
	m0 := &AuthorizedKey{}
	b, x := &b0, m0
	_, _ = b, x
...
type AuthorizedKeySpec struct {
	...
	xxx_hidden_KeyFingerprint string                 `protobuf:"bytes,2,opt,name=key_fingerprint,json=keyFingerprint,proto3"`
	xxx_hidden_HostUser       string                 `protobuf:"bytes,3,opt,name=host_user,json=hostUser,proto3"`
	xxx_hidden_KeyComment     string                 `protobuf:"bytes,4,opt,name=key_comment,json=keyComment,proto3"`
	xxx_hidden_KeyType        string                 `protobuf:"bytes,5,opt,name=key_type,json=keyType,proto3"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *AuthorizedKeySpec) GetKeyComment() string {
	if x != nil {
		return x.xxx_hidden_KeyComment
	}
	return ""
}
...
func (x *AuthorizedKeySpec) SetHostId(v string) {
	x.xxx_hidden_HostId = v
}

func (x *AuthorizedKeySpec) SetKeyFingerprint(v string) {
	x.xxx_hidden_KeyFingerprint = v
}

func (x *AuthorizedKeySpec) SetHostUser(v string) {
	x.xxx_hidden_HostUser = v
}

func (x *AuthorizedKeySpec) SetKeyComment(v string) {
	x.xxx_hidden_KeyComment = v
}

func (x *AuthorizedKeySpec) SetKeyType(v string) {
	x.xxx_hidden_KeyType = v
}

type AuthorizedKeySpec_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 AuthorizedKeySpec_builder) Build() *AuthorizedKeySpec {
	m0 := &AuthorizedKeySpec{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_HostId = b.HostId
	x.xxx_hidden_KeyFingerprint = b.KeyFingerprint
	x.xxx_hidden_HostUser = b.HostUser
	x.xxx_hidden_KeyComment = b.KeyComment
