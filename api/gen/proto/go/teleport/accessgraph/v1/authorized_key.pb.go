...
var file_teleport_access_graph_v1_authorized_key_proto_goTypes = []interface{}{
...
func file_teleport_access_graph_v1_authorized_key_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_access_graph_v1_authorized_key_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_access_graph_v1_authorized_key_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
