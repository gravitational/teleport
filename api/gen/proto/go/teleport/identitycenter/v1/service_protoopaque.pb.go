...
type PrincipalSummary struct {
	...
	xxx_hidden_PrincipalName      string                                `protobuf:"bytes,1,opt,name=principal_name,json=principalName,proto3"`
	xxx_hidden_PrincipalType      PrincipalType                         `protobuf:"varint,2,opt,name=principal_type,json=principalType,proto3,enum=teleport.identitycenter.v1.PrincipalType"`
	xxx_hidden_Assignment         *PrincipalSummary_AssignmentSummary   `protobuf:"bytes,3,opt,name=assignment,proto3"`
	xxx_hidden_Provisioning       *PrincipalSummary_ProvisioningSummary `protobuf:"bytes,4,opt,name=provisioning,proto3"`
	xxx_hidden_AccountAssignments *[]*AccountAssignmentRef              `protobuf:"bytes,5,rep,name=account_assignments,json=accountAssignments,proto3"`
...
func (x *PrincipalSummary) GetPrincipalName() string {
	if x != nil {
		return x.xxx_hidden_PrincipalName
	}
	return ""
}
...
func (x *PrincipalSummary) GetAccountAssignments() []*AccountAssignmentRef {
	if x != nil {
		if x.xxx_hidden_AccountAssignments != nil {
			return *x.xxx_hidden_AccountAssignments
		}
	}
	return nil
}
...
func (x *PrincipalSummary) SetAccountAssignments(v []*AccountAssignmentRef) {
	x.xxx_hidden_AccountAssignments = &v
}
...
type ListPrincipalsRequest struct {
	...
	xxx_hidden_ListUsers       bool                   `protobuf:"varint,3,opt,name=list_users,json=listUsers,proto3"`
	xxx_hidden_ListAccessLists bool                   `protobuf:"varint,4,opt,name=list_access_lists,json=listAccessLists,proto3"`
	xxx_hidden_Pattern         string                 `protobuf:"bytes,5,opt,name=pattern,proto3"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *ListPrincipalsRequest) GetListAccessLists() bool {
	if x != nil {
		return x.xxx_hidden_ListAccessLists
	}
	return false
}
...
func (x *ListPrincipalsRequest) SetListUsers(v bool) {
	x.xxx_hidden_ListUsers = v
}

func (x *ListPrincipalsRequest) SetListAccessLists(v bool) {
	x.xxx_hidden_ListAccessLists = v
}
...
func (b0 ListPrincipalsRequest_builder) Build() *ListPrincipalsRequest {
	...
	x.xxx_hidden_ListUsers = b.ListUsers
	x.xxx_hidden_ListAccessLists = b.ListAccessLists
...
type ListPrincipalsResponse struct {
	...
	xxx_hidden_Principals    *[]*PrincipalSummary   `protobuf:"bytes,2,rep,name=principals,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
type PrincipalSummary_ProvisioningSummary struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Status     v1.ProvisioningState   `protobuf:"varint,1,opt,name=status,proto3,enum=teleport.provisioning.v1.ProvisioningState"`
...
type PrincipalSummary_AssignmentSummary struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Status     ProvisioningState      `protobuf:"varint,1,opt,name=status,proto3,enum=teleport.identitycenter.v1.ProvisioningState"`
	xxx_hidden_ExternalId string                 `protobuf:"bytes,2,opt,name=external_id,json=externalId,proto3"`
	xxx_hidden_Error      string                 `protobuf:"bytes,3,opt,name=error,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
