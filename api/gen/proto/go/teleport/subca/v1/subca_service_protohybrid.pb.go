...
type CreateCSRRequest struct {
	...
	// If true, don't fan out CSR requests of unusable private keys to other Auth
	// servers.
...
type CreateCSRResponse struct {
	...
	// Warnings about missing/skipped CSRs.
	Warnings      []*CreateCSRWarning `protobuf:"bytes,2,rep,name=warnings,proto3" json:"warnings,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateCSRResponse) GetWarnings() []*CreateCSRWarning {
	if x != nil {
		return x.Warnings
	}
	return nil
...
func (x *CreateCSRResponse) SetWarnings(v []*CreateCSRWarning) {
	x.Warnings = v
}
...
// A warning returned as part of a CreateCSRResponse.
type CreateCSRWarning struct {
	state protoimpl.MessageState `protogen:"hybrid.v1"`
	// The end-user warning message.
	UserMessage string `protobuf:"bytes,1,opt,name=user_message,json=userMessage,proto3" json:"user_message,omitempty"`
	// Public key hash of the certificate/public key that generated the warning.
...
func (x *CreateCSRWarning) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateCSRWarning) ProtoMessage() {}

func (x *CreateCSRWarning) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_subca_v1_subca_service_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *CreateCSRWarning) GetUserMessage() string {
	if x != nil {
...
func (x *CreateCSRWarning) GetPublicKeyHash() string {
	if x != nil {
		return x.PublicKeyHash
	}
	return ""
...
func (x *CreateCSRWarning) SetUserMessage(v string) {
	x.UserMessage = v
}

func (x *CreateCSRWarning) SetPublicKeyHash(v string) {
	x.PublicKeyHash = v
}

type CreateCSRWarning_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 CreateCSRWarning_builder) Build() *CreateCSRWarning {
	m0 := &CreateCSRWarning{}
	b, x := &b0, m0
	_, _ = b, x
...
func (x *DeleteCertAuthorityOverrideResponse) Reset() {
	*x = DeleteCertAuthorityOverrideResponse{}
	mi := &file_teleport_subca_v1_subca_service_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_teleport_subca_v1_subca_service_proto_rawDesc = "" +
	...
	"\n" +
	"local_only\x18\x04 \x01(\bR\tlocalOnly\"\x96\x01\n" +
	"\x11CreateCSRResponse\x12@\n" +
	"\x04csrs\x18\x01 \x03(\v2,.teleport.subca.v1.CertificateSigningRequestR\x04csrs\x12?\n" +
	"\bwarnings\x18\x02 \x03(\v2#.teleport.subca.v1.CreateCSRWarningR\bwarnings\"]\n" +
	"\x10CreateCSRWarning\x12!\n" +
	"\fuser_message\x18\x01 \x01(\tR\vuserMessage\x12&\n" +
	"\x0fpublic_key_hash\x18\x02 \x01(\tR\rpublicKeyHash\"o\n" +
...
var file_teleport_subca_v1_subca_service_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_teleport_subca_v1_subca_service_proto_goTypes = []any{
	...
	(*CreateCSRWarning)(nil),                    // 2: teleport.subca.v1.CreateCSRWarning
	(*CreateCertAuthorityOverrideRequest)(nil),  // 3: teleport.subca.v1.CreateCertAuthorityOverrideRequest
	(*CreateCertAuthorityOverrideResponse)(nil), // 4: teleport.subca.v1.CreateCertAuthorityOverrideResponse
	(*UpdateCertAuthorityOverrideRequest)(nil),  // 5: teleport.subca.v1.UpdateCertAuthorityOverrideRequest
	(*UpdateCertAuthorityOverrideResponse)(nil), // 6: teleport.subca.v1.UpdateCertAuthorityOverrideResponse
	(*UpsertCertAuthorityOverrideRequest)(nil),  // 7: teleport.subca.v1.UpsertCertAuthorityOverrideRequest
	(*UpsertCertAuthorityOverrideResponse)(nil), // 8: teleport.subca.v1.UpsertCertAuthorityOverrideResponse
	(*AddCertificateOverrideRequest)(nil),       // 9: teleport.subca.v1.AddCertificateOverrideRequest
	(*AddCertificateOverrideResponse)(nil),      // 10: teleport.subca.v1.AddCertificateOverrideResponse
	(*UpdateCertificateOverrideRequest)(nil),    // 11: teleport.subca.v1.UpdateCertificateOverrideRequest
	(*UpdateCertificateOverrideResponse)(nil),   // 12: teleport.subca.v1.UpdateCertificateOverrideResponse
	(*RemoveCertificateOverrideRequest)(nil),    // 13: teleport.subca.v1.RemoveCertificateOverrideRequest
	(*RemoveCertificateOverrideResponse)(nil),   // 14: teleport.subca.v1.RemoveCertificateOverrideResponse
	(*GetCertAuthorityOverrideRequest)(nil),     // 15: teleport.subca.v1.GetCertAuthorityOverrideRequest
	(*GetCertAuthorityOverrideResponse)(nil),    // 16: teleport.subca.v1.GetCertAuthorityOverrideResponse
	(*ListCertAuthorityOverrideRequest)(nil),    // 17: teleport.subca.v1.ListCertAuthorityOverrideRequest
	(*ListCertAuthorityOverrideResponse)(nil),   // 18: teleport.subca.v1.ListCertAuthorityOverrideResponse
	(*DeleteCertAuthorityOverrideRequest)(nil),  // 19: teleport.subca.v1.DeleteCertAuthorityOverrideRequest
	(*DeleteCertAuthorityOverrideResponse)(nil), // 20: teleport.subca.v1.DeleteCertAuthorityOverrideResponse
	(*PublicKeyHash)(nil),                       // 21: teleport.subca.v1.PublicKeyHash
	(*DistinguishedName)(nil),                   // 22: teleport.subca.v1.DistinguishedName
	(*CertificateSigningRequest)(nil),           // 23: teleport.subca.v1.CertificateSigningRequest
	(*CertAuthorityOverride)(nil),               // 24: teleport.subca.v1.CertAuthorityOverride
	(*CertAuthorityOverrideID)(nil),             // 25: teleport.subca.v1.CertAuthorityOverrideID
	(*CertificateOverride)(nil),                 // 26: teleport.subca.v1.CertificateOverride
	(*fieldmaskpb.FieldMask)(nil),               // 27: google.protobuf.FieldMask
	(*CertificateOverrideID)(nil),               // 28: teleport.subca.v1.CertificateOverrideID
}
var file_teleport_subca_v1_subca_service_proto_depIdxs = []int32{
	21, // 0: teleport.subca.v1.CreateCSRRequest.public_key_hash:type_name -> teleport.subca.v1.PublicKeyHash
	22, // 1: teleport.subca.v1.CreateCSRRequest.custom_subject:type_name -> teleport.subca.v1.DistinguishedName
	23, // 2: teleport.subca.v1.CreateCSRResponse.csrs:type_name -> teleport.subca.v1.CertificateSigningRequest
	2,  // 3: teleport.subca.v1.CreateCSRResponse.warnings:type_name -> teleport.subca.v1.CreateCSRWarning
	24, // 4: teleport.subca.v1.CreateCertAuthorityOverrideRequest.ca_override:type_name -> teleport.subca.v1.CertAuthorityOverride
	24, // 5: teleport.subca.v1.CreateCertAuthorityOverrideResponse.ca_override:type_name -> teleport.subca.v1.CertAuthorityOverride
	24, // 6: teleport.subca.v1.UpdateCertAuthorityOverrideRequest.ca_override:type_name -> teleport.subca.v1.CertAuthorityOverride
	24, // 7: teleport.subca.v1.UpdateCertAuthorityOverrideResponse.ca_override:type_name -> teleport.subca.v1.CertAuthorityOverride
	24, // 8: teleport.subca.v1.UpsertCertAuthorityOverrideRequest.ca_override:type_name -> teleport.subca.v1.CertAuthorityOverride
	24, // 9: teleport.subca.v1.UpsertCertAuthorityOverrideResponse.ca_override:type_name -> teleport.subca.v1.CertAuthorityOverride
	25, // 10: teleport.subca.v1.AddCertificateOverrideRequest.ca_id:type_name -> teleport.subca.v1.CertAuthorityOverrideID
	26, // 11: teleport.subca.v1.AddCertificateOverrideRequest.certificate_override:type_name -> teleport.subca.v1.CertificateOverride
	26, // 12: teleport.subca.v1.AddCertificateOverrideResponse.certificate_override:type_name -> teleport.subca.v1.CertificateOverride
	25, // 13: teleport.subca.v1.UpdateCertificateOverrideRequest.ca_id:type_name -> teleport.subca.v1.CertAuthorityOverrideID
	26, // 14: teleport.subca.v1.UpdateCertificateOverrideRequest.certificate_override:type_name -> teleport.subca.v1.CertificateOverride
	27, // 15: teleport.subca.v1.UpdateCertificateOverrideRequest.update_mask:type_name -> google.protobuf.FieldMask
	26, // 16: teleport.subca.v1.UpdateCertificateOverrideResponse.certificate_override:type_name -> teleport.subca.v1.CertificateOverride
	28, // 17: teleport.subca.v1.RemoveCertificateOverrideRequest.certificate_override_id:type_name -> teleport.subca.v1.CertificateOverrideID
	25, // 18: teleport.subca.v1.GetCertAuthorityOverrideRequest.ca_id:type_name -> teleport.subca.v1.CertAuthorityOverrideID
	24, // 19: teleport.subca.v1.GetCertAuthorityOverrideResponse.ca_override:type_name -> teleport.subca.v1.CertAuthorityOverride
	24, // 20: teleport.subca.v1.ListCertAuthorityOverrideResponse.ca_overrides:type_name -> teleport.subca.v1.CertAuthorityOverride
	25, // 21: teleport.subca.v1.DeleteCertAuthorityOverrideRequest.ca_id:type_name -> teleport.subca.v1.CertAuthorityOverrideID
	0,  // 22: teleport.subca.v1.SubCAService.CreateCSR:input_type -> teleport.subca.v1.CreateCSRRequest
	3,  // 23: teleport.subca.v1.SubCAService.CreateCertAuthorityOverride:input_type -> teleport.subca.v1.CreateCertAuthorityOverrideRequest
	5,  // 24: teleport.subca.v1.SubCAService.UpdateCertAuthorityOverride:input_type -> teleport.subca.v1.UpdateCertAuthorityOverrideRequest
	7,  // 25: teleport.subca.v1.SubCAService.UpsertCertAuthorityOverride:input_type -> teleport.subca.v1.UpsertCertAuthorityOverrideRequest
	9,  // 26: teleport.subca.v1.SubCAService.AddCertificateOverride:input_type -> teleport.subca.v1.AddCertificateOverrideRequest
	11, // 27: teleport.subca.v1.SubCAService.UpdateCertificateOverride:input_type -> teleport.subca.v1.UpdateCertificateOverrideRequest
	13, // 28: teleport.subca.v1.SubCAService.RemoveCertificateOverride:input_type -> teleport.subca.v1.RemoveCertificateOverrideRequest
	15, // 29: teleport.subca.v1.SubCAService.GetCertAuthorityOverride:input_type -> teleport.subca.v1.GetCertAuthorityOverrideRequest
	17, // 30: teleport.subca.v1.SubCAService.ListCertAuthorityOverride:input_type -> teleport.subca.v1.ListCertAuthorityOverrideRequest
	19, // 31: teleport.subca.v1.SubCAService.DeleteCertAuthorityOverride:input_type -> teleport.subca.v1.DeleteCertAuthorityOverrideRequest
	1,  // 32: teleport.subca.v1.SubCAService.CreateCSR:output_type -> teleport.subca.v1.CreateCSRResponse
	4,  // 33: teleport.subca.v1.SubCAService.CreateCertAuthorityOverride:output_type -> teleport.subca.v1.CreateCertAuthorityOverrideResponse
	6,  // 34: teleport.subca.v1.SubCAService.UpdateCertAuthorityOverride:output_type -> teleport.subca.v1.UpdateCertAuthorityOverrideResponse
	8,  // 35: teleport.subca.v1.SubCAService.UpsertCertAuthorityOverride:output_type -> teleport.subca.v1.UpsertCertAuthorityOverrideResponse
	10, // 36: teleport.subca.v1.SubCAService.AddCertificateOverride:output_type -> teleport.subca.v1.AddCertificateOverrideResponse
	12, // 37: teleport.subca.v1.SubCAService.UpdateCertificateOverride:output_type -> teleport.subca.v1.UpdateCertificateOverrideResponse
	14, // 38: teleport.subca.v1.SubCAService.RemoveCertificateOverride:output_type -> teleport.subca.v1.RemoveCertificateOverrideResponse
	16, // 39: teleport.subca.v1.SubCAService.GetCertAuthorityOverride:output_type -> teleport.subca.v1.GetCertAuthorityOverrideResponse
	18, // 40: teleport.subca.v1.SubCAService.ListCertAuthorityOverride:output_type -> teleport.subca.v1.ListCertAuthorityOverrideResponse
	20, // 41: teleport.subca.v1.SubCAService.DeleteCertAuthorityOverride:output_type -> teleport.subca.v1.DeleteCertAuthorityOverrideResponse
