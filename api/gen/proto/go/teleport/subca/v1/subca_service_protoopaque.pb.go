...
type CreateCSRResponse struct {
	...
	xxx_hidden_Warnings *[]*CreateCSRWarning          `protobuf:"bytes,2,rep,name=warnings,proto3"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type CreateCSRWarning struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_UserMessage   string                 `protobuf:"bytes,1,opt,name=user_message,json=userMessage,proto3"`
	xxx_hidden_PublicKeyHash string                 `protobuf:"bytes,2,opt,name=public_key_hash,json=publicKeyHash,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
type UpdateCertificateOverrideRequest struct {
	...
	xxx_hidden_CertificateOverride   *CertificateOverride     `protobuf:"bytes,2,opt,name=certificate_override,json=certificateOverride,proto3"`
	xxx_hidden_ForceImmediateDisable bool                     `protobuf:"varint,3,opt,name=force_immediate_disable,json=forceImmediateDisable,proto3"`
	xxx_hidden_UpdateMask            *fieldmaskpb.FieldMask   `protobuf:"bytes,4,opt,name=update_mask,json=updateMask,proto3"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
