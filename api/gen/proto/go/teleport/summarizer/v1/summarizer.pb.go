...
type SearchModelSpec struct {
	...
	// inference_model is the name of the model used to convert natural
	...
	InferenceModel string `protobuf:"bytes,2,opt,name=inference_model,json=inferenceModel,proto3" json:"inference_model,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SearchModelSpec) GetInferenceModel() string {
	if x != nil {
...
const file_teleport_summarizer_v1_summarizer_proto_rawDesc = "" +
	...
	"\aversion\x18\x03 \x01(\tR\aversion\x128\n" +
	"\bmetadata\x18\x04 \x01(\v2\x1c.teleport.header.v1.MetadataR\bmetadata\x12;\n" +
	"\x04spec\x18\x05 \x01(\v2'.teleport.summarizer.v1.SearchModelSpecR\x04spec\"\xd8\x01\n" +
	"\x0fSearchModelSpec\x12@\n" +
	"\x06openai\x18\x01 \x01(\v2&.teleport.summarizer.v1.OpenAIProviderH\x00R\x06openai\x12C\n" +
	"\abedrock\x18\x03 \x01(\v2'.teleport.summarizer.v1.BedrockProviderH\x00R\abedrock\x12'\n" +
	"\x0finference_model\x18\x02 \x01(\tR\x0einferenceModelB\x15\n" +
