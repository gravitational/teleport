...
type CreateInferenceModelRequest struct {
	...
	xxx_hidden_Model *InferenceModel        `protobuf:"bytes,1,opt,name=model,proto3"`
...
type ListInferenceModelsResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Models        *[]*InferenceModel     `protobuf:"bytes,1,rep,name=models,proto3"`
...
type CreateInferenceSecretRequest struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Secret *InferenceSecret       `protobuf:"bytes,1,opt,name=secret,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type ListInferenceSecretsResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Secrets       *[]*InferenceSecret    `protobuf:"bytes,1,rep,name=secrets,proto3"`
	xxx_hidden_NextPageToken string                 `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
type CreateInferencePolicyRequest struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Policy *InferencePolicy       `protobuf:"bytes,1,opt,name=policy,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type ListInferencePoliciesResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Policies      *[]*InferencePolicy    `protobuf:"bytes,1,rep,name=policies,proto3"`
	xxx_hidden_NextPageToken string                 `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *GetClassifierRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetClassifierRequest) GetName() string {
	if x != nil {
		return x.xxx_hidden_Name
	}
	return ""
...
func (x *GetClassifierRequest) SetName(v string) {
	x.xxx_hidden_Name = v
}

type GetClassifierRequest_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// Name is the resource name of the Classifier to retrieve.
	Name string
}

func (b0 GetClassifierRequest_builder) Build() *GetClassifierRequest {
	m0 := &GetClassifierRequest{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Name = b.Name
	return m0
...
// GetClassifierResponse is a response to retrieving a Classifier.
...
func (x *GetClassifierResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetClassifierResponse) GetClassifier() *Classifier {
	if x != nil {
		return x.xxx_hidden_Classifier
	}
	return nil
...
func (x *GetClassifierResponse) SetClassifier(v *Classifier) {
	x.xxx_hidden_Classifier = v
}

func (x *GetClassifierResponse) HasClassifier() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_Classifier != nil
...
func (x *GetClassifierResponse) ClearClassifier() {
	x.xxx_hidden_Classifier = nil
}

type GetClassifierResponse_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// Classifier is the Classifier resource that was retrieved.
	Classifier *Classifier
}

func (b0 GetClassifierResponse_builder) Build() *GetClassifierResponse {
	m0 := &GetClassifierResponse{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Classifier = b.Classifier
	return m0
...
func (x *DeleteClassifierRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DeleteClassifierRequest) GetName() string {
	if x != nil {
		return x.xxx_hidden_Name
	}
	return ""
...
func (x *DeleteClassifierRequest) SetName(v string) {
	x.xxx_hidden_Name = v
}

type DeleteClassifierRequest_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// Name is the resource name of the Classifier to delete.
	Name string
}

func (b0 DeleteClassifierRequest_builder) Build() *DeleteClassifierRequest {
	m0 := &DeleteClassifierRequest{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Name = b.Name
	return m0
...
// DeleteClassifierResponse is a response to deleting a Classifier.
...
func (x *DeleteClassifierResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type DeleteClassifierResponse_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

}

func (b0 DeleteClassifierResponse_builder) Build() *DeleteClassifierResponse {
	m0 := &DeleteClassifierResponse{}
	b, x := &b0, m0
	_, _ = b, x
	return m0
}

// ListClassifiersRequest is a request for listing Classifiers.
...
func (x *ListClassifiersRequest) GetPageSize() int32 {
	if x != nil {
		return x.xxx_hidden_PageSize
	}
	return 0
...
func (x *ListClassifiersRequest) GetPageToken() string {
	if x != nil {
		return x.xxx_hidden_PageToken
	}
	return ""
...
func (x *ListClassifiersRequest) SetPageSize(v int32) {
	x.xxx_hidden_PageSize = v
}

func (x *ListClassifiersRequest) SetPageToken(v string) {
	x.xxx_hidden_PageToken = v
}

type ListClassifiersRequest_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 ListClassifiersRequest_builder) Build() *ListClassifiersRequest {
	m0 := &ListClassifiersRequest{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_PageSize = b.PageSize
	x.xxx_hidden_PageToken = b.PageToken
...
type ListClassifiersResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Classifiers   *[]*Classifier         `protobuf:"bytes,1,rep,name=classifiers,proto3"`
	xxx_hidden_NextPageToken string                 `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *ListClassifiersResponse) GetClassifiers() []*Classifier {
	if x != nil {
		if x.xxx_hidden_Classifiers != nil {
			return *x.xxx_hidden_Classifiers
		}
	}
	return nil
}

func (x *ListClassifiersResponse) GetNextPageToken() string {
	if x != nil {
		return x.xxx_hidden_NextPageToken
	}
	return ""
...
func (x *ListClassifiersResponse) SetClassifiers(v []*Classifier) {
	x.xxx_hidden_Classifiers = &v
}

func (x *ListClassifiersResponse) SetNextPageToken(v string) {
	x.xxx_hidden_NextPageToken = v
}

type ListClassifiersResponse_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// Classifiers is the page of Classifiers that matched the request.
...
func (b0 ListClassifiersResponse_builder) Build() *ListClassifiersResponse {
	m0 := &ListClassifiersResponse{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Classifiers = &b.Classifiers
	x.xxx_hidden_NextPageToken = b.NextPageToken
	return m0
}
...
type GetSummaryResponse struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Summary *Summary               `protobuf:"bytes,1,opt,name=summary,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type TestInferenceModelRequest struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Model  *InferenceModelSpec    `protobuf:"bytes,1,opt,name=model,proto3"`
	xxx_hidden_Secret *InferenceSecretSpec   `protobuf:"bytes,2,opt,name=secret,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type TestRetrievalModelRequest struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Model  *RetrievalModelSpec    `protobuf:"bytes,1,opt,name=model,proto3"`
	xxx_hidden_Secret *InferenceSecretSpec   `protobuf:"bytes,2,opt,name=secret,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type CreateRetrievalModelRequest struct {
	state            protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Model *RetrievalModel        `protobuf:"bytes,1,opt,name=model,proto3"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_teleport_summarizer_v1_summarizer_service_proto_rawDesc = "" +
	...
	"classifier\x18\x01 \x01(\v2\".teleport.summarizer.v1.ClassifierR\n" +
	"classifier\"-\n" +
	"\x17DeleteClassifierRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\x1a\n" +
	"\x18DeleteClassifierResponse\"T\n" +
	"\x16ListClassifiersRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\"\x87\x01\n" +
	"\x17ListClassifiersResponse\x12D\n" +
	"\vclassifiers\x18\x01 \x03(\v2\".teleport.summarizer.v1.ClassifierR\vclassifiers\x12&\n" +
	...
	"\x1cDeleteRetrievalModelResponse2\xe3 \n" +
...
var file_teleport_summarizer_v1_summarizer_service_proto_msgTypes = make([]protoimpl.MessageInfo, 66)
var file_teleport_summarizer_v1_summarizer_service_proto_goTypes = []any{
	...
	(*IsEnabledRequest)(nil),              // 50: teleport.summarizer.v1.IsEnabledRequest
	(*IsEnabledResponse)(nil),             // 51: teleport.summarizer.v1.IsEnabledResponse
	(*TestInferenceModelRequest)(nil),     // 52: teleport.summarizer.v1.TestInferenceModelRequest
	(*TestInferenceModelResponse)(nil),    // 53: teleport.summarizer.v1.TestInferenceModelResponse
	(*TestRetrievalModelRequest)(nil),     // 54: teleport.summarizer.v1.TestRetrievalModelRequest
	(*TestRetrievalModelResponse)(nil),    // 55: teleport.summarizer.v1.TestRetrievalModelResponse
	(*CreateRetrievalModelRequest)(nil),   // 56: teleport.summarizer.v1.CreateRetrievalModelRequest
	(*CreateRetrievalModelResponse)(nil),  // 57: teleport.summarizer.v1.CreateRetrievalModelResponse
	(*GetRetrievalModelRequest)(nil),      // 58: teleport.summarizer.v1.GetRetrievalModelRequest
	(*GetRetrievalModelResponse)(nil),     // 59: teleport.summarizer.v1.GetRetrievalModelResponse
	(*UpdateRetrievalModelRequest)(nil),   // 60: teleport.summarizer.v1.UpdateRetrievalModelRequest
	(*UpdateRetrievalModelResponse)(nil),  // 61: teleport.summarizer.v1.UpdateRetrievalModelResponse
	(*UpsertRetrievalModelRequest)(nil),   // 62: teleport.summarizer.v1.UpsertRetrievalModelRequest
	(*UpsertRetrievalModelResponse)(nil),  // 63: teleport.summarizer.v1.UpsertRetrievalModelResponse
	(*DeleteRetrievalModelRequest)(nil),   // 64: teleport.summarizer.v1.DeleteRetrievalModelRequest
	(*DeleteRetrievalModelResponse)(nil),  // 65: teleport.summarizer.v1.DeleteRetrievalModelResponse
	(*InferenceModel)(nil),                // 66: teleport.summarizer.v1.InferenceModel
	(*InferenceSecret)(nil),               // 67: teleport.summarizer.v1.InferenceSecret
	(*InferencePolicy)(nil),               // 68: teleport.summarizer.v1.InferencePolicy
	(*Classifier)(nil),                    // 69: teleport.summarizer.v1.Classifier
	(*Summary)(nil),                       // 70: teleport.summarizer.v1.Summary
...
var file_teleport_summarizer_v1_summarizer_service_proto_depIdxs = []int32{
	66, // 0: teleport.summarizer.v1.CreateInferenceModelRequest.model:type_name -> teleport.summarizer.v1.InferenceModel
	66, // 1: teleport.summarizer.v1.CreateInferenceModelResponse.model:type_name -> teleport.summarizer.v1.InferenceModel
	66, // 2: teleport.summarizer.v1.GetInferenceModelResponse.model:type_name -> teleport.summarizer.v1.InferenceModel
	66, // 3: teleport.summarizer.v1.UpdateInferenceModelRequest.model:type_name -> teleport.summarizer.v1.InferenceModel
	66, // 4: teleport.summarizer.v1.UpdateInferenceModelResponse.model:type_name -> teleport.summarizer.v1.InferenceModel
	66, // 5: teleport.summarizer.v1.UpsertInferenceModelRequest.model:type_name -> teleport.summarizer.v1.InferenceModel
	66, // 6: teleport.summarizer.v1.UpsertInferenceModelResponse.model:type_name -> teleport.summarizer.v1.InferenceModel
	66, // 7: teleport.summarizer.v1.ListInferenceModelsResponse.models:type_name -> teleport.summarizer.v1.InferenceModel
	67, // 8: teleport.summarizer.v1.CreateInferenceSecretRequest.secret:type_name -> teleport.summarizer.v1.InferenceSecret
	67, // 9: teleport.summarizer.v1.CreateInferenceSecretResponse.secret:type_name -> teleport.summarizer.v1.InferenceSecret
	67, // 10: teleport.summarizer.v1.GetInferenceSecretResponse.secret:type_name -> teleport.summarizer.v1.InferenceSecret
	67, // 11: teleport.summarizer.v1.UpdateInferenceSecretRequest.secret:type_name -> teleport.summarizer.v1.InferenceSecret
	67, // 12: teleport.summarizer.v1.UpdateInferenceSecretResponse.secret:type_name -> teleport.summarizer.v1.InferenceSecret
	67, // 13: teleport.summarizer.v1.UpsertInferenceSecretRequest.secret:type_name -> teleport.summarizer.v1.InferenceSecret
	67, // 14: teleport.summarizer.v1.UpsertInferenceSecretResponse.secret:type_name -> teleport.summarizer.v1.InferenceSecret
	67, // 15: teleport.summarizer.v1.ListInferenceSecretsResponse.secrets:type_name -> teleport.summarizer.v1.InferenceSecret
	68, // 16: teleport.summarizer.v1.CreateInferencePolicyRequest.policy:type_name -> teleport.summarizer.v1.InferencePolicy
	68, // 17: teleport.summarizer.v1.CreateInferencePolicyResponse.policy:type_name -> teleport.summarizer.v1.InferencePolicy
	68, // 18: teleport.summarizer.v1.GetInferencePolicyResponse.policy:type_name -> teleport.summarizer.v1.InferencePolicy
	68, // 19: teleport.summarizer.v1.UpdateInferencePolicyRequest.policy:type_name -> teleport.summarizer.v1.InferencePolicy
	68, // 20: teleport.summarizer.v1.UpdateInferencePolicyResponse.policy:type_name -> teleport.summarizer.v1.InferencePolicy
	68, // 21: teleport.summarizer.v1.UpsertInferencePolicyRequest.policy:type_name -> teleport.summarizer.v1.InferencePolicy
	68, // 22: teleport.summarizer.v1.UpsertInferencePolicyResponse.policy:type_name -> teleport.summarizer.v1.InferencePolicy
	68, // 23: teleport.summarizer.v1.ListInferencePoliciesResponse.policies:type_name -> teleport.summarizer.v1.InferencePolicy
	69, // 24: teleport.summarizer.v1.CreateClassifierRequest.classifier:type_name -> teleport.summarizer.v1.Classifier
	69, // 25: teleport.summarizer.v1.CreateClassifierResponse.classifier:type_name -> teleport.summarizer.v1.Classifier
	69, // 26: teleport.summarizer.v1.GetClassifierResponse.classifier:type_name -> teleport.summarizer.v1.Classifier
	69, // 27: teleport.summarizer.v1.UpdateClassifierRequest.classifier:type_name -> teleport.summarizer.v1.Classifier
	69, // 28: teleport.summarizer.v1.UpdateClassifierResponse.classifier:type_name -> teleport.summarizer.v1.Classifier
	69, // 29: teleport.summarizer.v1.UpsertClassifierRequest.classifier:type_name -> teleport.summarizer.v1.Classifier
	69, // 30: teleport.summarizer.v1.UpsertClassifierResponse.classifier:type_name -> teleport.summarizer.v1.Classifier
	69, // 31: teleport.summarizer.v1.ListClassifiersResponse.classifiers:type_name -> teleport.summarizer.v1.Classifier
	70, // 32: teleport.summarizer.v1.GetSummaryResponse.summary:type_name -> teleport.summarizer.v1.Summary
	71, // 33: teleport.summarizer.v1.TestInferenceModelRequest.model:type_name -> teleport.summarizer.v1.InferenceModelSpec
	72, // 34: teleport.summarizer.v1.TestInferenceModelRequest.secret:type_name -> teleport.summarizer.v1.InferenceSecretSpec
	73, // 35: teleport.summarizer.v1.TestRetrievalModelRequest.model:type_name -> teleport.summarizer.v1.RetrievalModelSpec
	72, // 36: teleport.summarizer.v1.TestRetrievalModelRequest.secret:type_name -> teleport.summarizer.v1.InferenceSecretSpec
	74, // 37: teleport.summarizer.v1.CreateRetrievalModelRequest.model:type_name -> teleport.summarizer.v1.RetrievalModel
	74, // 38: teleport.summarizer.v1.CreateRetrievalModelResponse.model:type_name -> teleport.summarizer.v1.RetrievalModel
	74, // 39: teleport.summarizer.v1.GetRetrievalModelResponse.model:type_name -> teleport.summarizer.v1.RetrievalModel
	74, // 40: teleport.summarizer.v1.UpdateRetrievalModelRequest.model:type_name -> teleport.summarizer.v1.RetrievalModel
	74, // 41: teleport.summarizer.v1.UpdateRetrievalModelResponse.model:type_name -> teleport.summarizer.v1.RetrievalModel
	74, // 42: teleport.summarizer.v1.UpsertRetrievalModelRequest.model:type_name -> teleport.summarizer.v1.RetrievalModel
	74, // 43: teleport.summarizer.v1.UpsertRetrievalModelResponse.model:type_name -> teleport.summarizer.v1.RetrievalModel
	0,  // 44: teleport.summarizer.v1.SummarizerService.CreateInferenceModel:input_type -> teleport.summarizer.v1.CreateInferenceModelRequest
	2,  // 45: teleport.summarizer.v1.SummarizerService.GetInferenceModel:input_type -> teleport.summarizer.v1.GetInferenceModelRequest
	4,  // 46: teleport.summarizer.v1.SummarizerService.UpdateInferenceModel:input_type -> teleport.summarizer.v1.UpdateInferenceModelRequest
	6,  // 47: teleport.summarizer.v1.SummarizerService.UpsertInferenceModel:input_type -> teleport.summarizer.v1.UpsertInferenceModelRequest
	8,  // 48: teleport.summarizer.v1.SummarizerService.DeleteInferenceModel:input_type -> teleport.summarizer.v1.DeleteInferenceModelRequest
	10, // 49: teleport.summarizer.v1.SummarizerService.ListInferenceModels:input_type -> teleport.summarizer.v1.ListInferenceModelsRequest
	12, // 50: teleport.summarizer.v1.SummarizerService.CreateInferenceSecret:input_type -> teleport.summarizer.v1.CreateInferenceSecretRequest
	14, // 51: teleport.summarizer.v1.SummarizerService.GetInferenceSecret:input_type -> teleport.summarizer.v1.GetInferenceSecretRequest
	16, // 52: teleport.summarizer.v1.SummarizerService.UpdateInferenceSecret:input_type -> teleport.summarizer.v1.UpdateInferenceSecretRequest
	18, // 53: teleport.summarizer.v1.SummarizerService.UpsertInferenceSecret:input_type -> teleport.summarizer.v1.UpsertInferenceSecretRequest
	20, // 54: teleport.summarizer.v1.SummarizerService.DeleteInferenceSecret:input_type -> teleport.summarizer.v1.DeleteInferenceSecretRequest
	22, // 55: teleport.summarizer.v1.SummarizerService.ListInferenceSecrets:input_type -> teleport.summarizer.v1.ListInferenceSecretsRequest
	24, // 56: teleport.summarizer.v1.SummarizerService.CreateInferencePolicy:input_type -> teleport.summarizer.v1.CreateInferencePolicyRequest
	26, // 57: teleport.summarizer.v1.SummarizerService.GetInferencePolicy:input_type -> teleport.summarizer.v1.GetInferencePolicyRequest
	28, // 58: teleport.summarizer.v1.SummarizerService.UpdateInferencePolicy:input_type -> teleport.summarizer.v1.UpdateInferencePolicyRequest
	30, // 59: teleport.summarizer.v1.SummarizerService.UpsertInferencePolicy:input_type -> teleport.summarizer.v1.UpsertInferencePolicyRequest
	32, // 60: teleport.summarizer.v1.SummarizerService.DeleteInferencePolicy:input_type -> teleport.summarizer.v1.DeleteInferencePolicyRequest
	34, // 61: teleport.summarizer.v1.SummarizerService.ListInferencePolicies:input_type -> teleport.summarizer.v1.ListInferencePoliciesRequest
	36, // 62: teleport.summarizer.v1.SummarizerService.CreateClassifier:input_type -> teleport.summarizer.v1.CreateClassifierRequest
	38, // 63: teleport.summarizer.v1.SummarizerService.GetClassifier:input_type -> teleport.summarizer.v1.GetClassifierRequest
	40, // 64: teleport.summarizer.v1.SummarizerService.UpdateClassifier:input_type -> teleport.summarizer.v1.UpdateClassifierRequest
	42, // 65: teleport.summarizer.v1.SummarizerService.UpsertClassifier:input_type -> teleport.summarizer.v1.UpsertClassifierRequest
	44, // 66: teleport.summarizer.v1.SummarizerService.DeleteClassifier:input_type -> teleport.summarizer.v1.DeleteClassifierRequest
	46, // 67: teleport.summarizer.v1.SummarizerService.ListClassifiers:input_type -> teleport.summarizer.v1.ListClassifiersRequest
	48, // 68: teleport.summarizer.v1.SummarizerService.GetSummary:input_type -> teleport.summarizer.v1.GetSummaryRequest
	50, // 69: teleport.summarizer.v1.SummarizerService.IsEnabled:input_type -> teleport.summarizer.v1.IsEnabledRequest
	52, // 70: teleport.summarizer.v1.SummarizerService.TestInferenceModel:input_type -> teleport.summarizer.v1.TestInferenceModelRequest
	56, // 71: teleport.summarizer.v1.SummarizerService.CreateRetrievalModel:input_type -> teleport.summarizer.v1.CreateRetrievalModelRequest
	58, // 72: teleport.summarizer.v1.SummarizerService.GetRetrievalModel:input_type -> teleport.summarizer.v1.GetRetrievalModelRequest
	60, // 73: teleport.summarizer.v1.SummarizerService.UpdateRetrievalModel:input_type -> teleport.summarizer.v1.UpdateRetrievalModelRequest
	62, // 74: teleport.summarizer.v1.SummarizerService.UpsertRetrievalModel:input_type -> teleport.summarizer.v1.UpsertRetrievalModelRequest
	64, // 75: teleport.summarizer.v1.SummarizerService.DeleteRetrievalModel:input_type -> teleport.summarizer.v1.DeleteRetrievalModelRequest
	54, // 76: teleport.summarizer.v1.SummarizerService.TestRetrievalModel:input_type -> teleport.summarizer.v1.TestRetrievalModelRequest
	1,  // 77: teleport.summarizer.v1.SummarizerService.CreateInferenceModel:output_type -> teleport.summarizer.v1.CreateInferenceModelResponse
	3,  // 78: teleport.summarizer.v1.SummarizerService.GetInferenceModel:output_type -> teleport.summarizer.v1.GetInferenceModelResponse
	5,  // 79: teleport.summarizer.v1.SummarizerService.UpdateInferenceModel:output_type -> teleport.summarizer.v1.UpdateInferenceModelResponse
	7,  // 80: teleport.summarizer.v1.SummarizerService.UpsertInferenceModel:output_type -> teleport.summarizer.v1.UpsertInferenceModelResponse
	9,  // 81: teleport.summarizer.v1.SummarizerService.DeleteInferenceModel:output_type -> teleport.summarizer.v1.DeleteInferenceModelResponse
	11, // 82: teleport.summarizer.v1.SummarizerService.ListInferenceModels:output_type -> teleport.summarizer.v1.ListInferenceModelsResponse
	13, // 83: teleport.summarizer.v1.SummarizerService.CreateInferenceSecret:output_type -> teleport.summarizer.v1.CreateInferenceSecretResponse
	15, // 84: teleport.summarizer.v1.SummarizerService.GetInferenceSecret:output_type -> teleport.summarizer.v1.GetInferenceSecretResponse
	17, // 85: teleport.summarizer.v1.SummarizerService.UpdateInferenceSecret:output_type -> teleport.summarizer.v1.UpdateInferenceSecretResponse
	19, // 86: teleport.summarizer.v1.SummarizerService.UpsertInferenceSecret:output_type -> teleport.summarizer.v1.UpsertInferenceSecretResponse
	21, // 87: teleport.summarizer.v1.SummarizerService.DeleteInferenceSecret:output_type -> teleport.summarizer.v1.DeleteInferenceSecretResponse
	23, // 88: teleport.summarizer.v1.SummarizerService.ListInferenceSecrets:output_type -> teleport.summarizer.v1.ListInferenceSecretsResponse
	25, // 89: teleport.summarizer.v1.SummarizerService.CreateInferencePolicy:output_type -> teleport.summarizer.v1.CreateInferencePolicyResponse
	27, // 90: teleport.summarizer.v1.SummarizerService.GetInferencePolicy:output_type -> teleport.summarizer.v1.GetInferencePolicyResponse
	29, // 91: teleport.summarizer.v1.SummarizerService.UpdateInferencePolicy:output_type -> teleport.summarizer.v1.UpdateInferencePolicyResponse
	31, // 92: teleport.summarizer.v1.SummarizerService.UpsertInferencePolicy:output_type -> teleport.summarizer.v1.UpsertInferencePolicyResponse
	33, // 93: teleport.summarizer.v1.SummarizerService.DeleteInferencePolicy:output_type -> teleport.summarizer.v1.DeleteInferencePolicyResponse
	35, // 94: teleport.summarizer.v1.SummarizerService.ListInferencePolicies:output_type -> teleport.summarizer.v1.ListInferencePoliciesResponse
	37, // 95: teleport.summarizer.v1.SummarizerService.CreateClassifier:output_type -> teleport.summarizer.v1.CreateClassifierResponse
	39, // 96: teleport.summarizer.v1.SummarizerService.GetClassifier:output_type -> teleport.summarizer.v1.GetClassifierResponse
	41, // 97: teleport.summarizer.v1.SummarizerService.UpdateClassifier:output_type -> teleport.summarizer.v1.UpdateClassifierResponse
	43, // 98: teleport.summarizer.v1.SummarizerService.UpsertClassifier:output_type -> teleport.summarizer.v1.UpsertClassifierResponse
	45, // 99: teleport.summarizer.v1.SummarizerService.DeleteClassifier:output_type -> teleport.summarizer.v1.DeleteClassifierResponse
	47, // 100: teleport.summarizer.v1.SummarizerService.ListClassifiers:output_type -> teleport.summarizer.v1.ListClassifiersResponse
	49, // 101: teleport.summarizer.v1.SummarizerService.GetSummary:output_type -> teleport.summarizer.v1.GetSummaryResponse
	51, // 102: teleport.summarizer.v1.SummarizerService.IsEnabled:output_type -> teleport.summarizer.v1.IsEnabledResponse
	53, // 103: teleport.summarizer.v1.SummarizerService.TestInferenceModel:output_type -> teleport.summarizer.v1.TestInferenceModelResponse
	57, // 104: teleport.summarizer.v1.SummarizerService.CreateRetrievalModel:output_type -> teleport.summarizer.v1.CreateRetrievalModelResponse
	59, // 105: teleport.summarizer.v1.SummarizerService.GetRetrievalModel:output_type -> teleport.summarizer.v1.GetRetrievalModelResponse
	61, // 106: teleport.summarizer.v1.SummarizerService.UpdateRetrievalModel:output_type -> teleport.summarizer.v1.UpdateRetrievalModelResponse
	63, // 107: teleport.summarizer.v1.SummarizerService.UpsertRetrievalModel:output_type -> teleport.summarizer.v1.UpsertRetrievalModelResponse
	65, // 108: teleport.summarizer.v1.SummarizerService.DeleteRetrievalModel:output_type -> teleport.summarizer.v1.DeleteRetrievalModelResponse
	55, // 109: teleport.summarizer.v1.SummarizerService.TestRetrievalModel:output_type -> teleport.summarizer.v1.TestRetrievalModelResponse
