...
// ClassifierActionMode is a tri-state toggle for classifier match actions.
type ClassifierActionMode int32

const (
	// ClassifierActionModeUnspecified is the default value and applies the
	// default behavior of the action, which is the same as disabled. It is
	// distinct from an explicitly disabled action.
	ClassifierActionMode_CLASSIFIER_ACTION_MODE_UNSPECIFIED ClassifierActionMode = 0
	// ClassifierActionModeEnabled explicitly enables the action.
	ClassifierActionMode_CLASSIFIER_ACTION_MODE_ENABLED ClassifierActionMode = 1
	// ClassifierActionModeDisabled explicitly disables the action.
	ClassifierActionMode_CLASSIFIER_ACTION_MODE_DISABLED ClassifierActionMode = 2
)

// Enum value maps for ClassifierActionMode.
var (
	ClassifierActionMode_name = map[int32]string{
		0: "CLASSIFIER_ACTION_MODE_UNSPECIFIED",
		1: "CLASSIFIER_ACTION_MODE_ENABLED",
		2: "CLASSIFIER_ACTION_MODE_DISABLED",
	}
	ClassifierActionMode_value = map[string]int32{
		"CLASSIFIER_ACTION_MODE_UNSPECIFIED": 0,
		"CLASSIFIER_ACTION_MODE_ENABLED":     1,
		"CLASSIFIER_ACTION_MODE_DISABLED":    2,
	}
)

func (x ClassifierActionMode) Enum() *ClassifierActionMode {
	p := new(ClassifierActionMode)
	*p = x
	return p
}

func (x ClassifierActionMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ClassifierActionMode) Descriptor() protoreflect.EnumDescriptor {
	return file_teleport_summarizer_v1_summarizer_proto_enumTypes[0].Descriptor()
}

func (ClassifierActionMode) Type() protoreflect.EnumType {
	return &file_teleport_summarizer_v1_summarizer_proto_enumTypes[0]
}

func (x ClassifierActionMode) Number() protoreflect.EnumNumber {
...
const (
	...
	// NeedsReviewReasonClassifierMatched indicates that the session matched a
	// classifier configured to flag matching sessions for review.
	NeedsReviewReason_NEEDS_REVIEW_REASON_CLASSIFIER_MATCHED NeedsReviewReason = 6
)
...
var (
	NeedsReviewReason_name = map[int32]string{
		...
		6: "NEEDS_REVIEW_REASON_CLASSIFIER_MATCHED",
	}
	NeedsReviewReason_value = map[string]int32{
		...
		"NEEDS_REVIEW_REASON_CLASSIFIER_MATCHED":               6,
	}
)
...
// BeamInstructionConsistency indicates whether a beam agent's actions were
// consistent with the instructions it received from the LLM. Modeled on
// AccessRequestConsistency.
type BeamInstructionConsistency int32

const (
	BeamInstructionConsistency_BEAM_INSTRUCTION_CONSISTENCY_UNSPECIFIED          BeamInstructionConsistency = 0
	BeamInstructionConsistency_BEAM_INSTRUCTION_CONSISTENCY_CONSISTENT           BeamInstructionConsistency = 1
	BeamInstructionConsistency_BEAM_INSTRUCTION_CONSISTENCY_PARTIALLY_CONSISTENT BeamInstructionConsistency = 2
	BeamInstructionConsistency_BEAM_INSTRUCTION_CONSISTENCY_INCONSISTENT         BeamInstructionConsistency = 3
)

// Enum value maps for BeamInstructionConsistency.
var (
	BeamInstructionConsistency_name = map[int32]string{
		0: "BEAM_INSTRUCTION_CONSISTENCY_UNSPECIFIED",
		1: "BEAM_INSTRUCTION_CONSISTENCY_CONSISTENT",
		2: "BEAM_INSTRUCTION_CONSISTENCY_PARTIALLY_CONSISTENT",
		3: "BEAM_INSTRUCTION_CONSISTENCY_INCONSISTENT",
	}
	BeamInstructionConsistency_value = map[string]int32{
		"BEAM_INSTRUCTION_CONSISTENCY_UNSPECIFIED":          0,
		"BEAM_INSTRUCTION_CONSISTENCY_CONSISTENT":           1,
		"BEAM_INSTRUCTION_CONSISTENCY_PARTIALLY_CONSISTENT": 2,
		"BEAM_INSTRUCTION_CONSISTENCY_INCONSISTENT":         3,
	}
)

func (x BeamInstructionConsistency) Enum() *BeamInstructionConsistency {
	p := new(BeamInstructionConsistency)
	*p = x
	return p
}

func (x BeamInstructionConsistency) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BeamInstructionConsistency) Descriptor() protoreflect.EnumDescriptor {
	return file_teleport_summarizer_v1_summarizer_proto_enumTypes[6].Descriptor()
}

func (BeamInstructionConsistency) Type() protoreflect.EnumType {
	return &file_teleport_summarizer_v1_summarizer_proto_enumTypes[6]
}

func (x BeamInstructionConsistency) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
// Classifier resource configures a classifier applied to sessions during
// summarization. Classifiers are matched to sessions by session kind and by
// an optional filter expression, the same way inference policies are.
type Classifier struct {
	...
	xxx_hidden_Version  string                 `protobuf:"bytes,3,opt,name=version,proto3"`
	xxx_hidden_Metadata *v1.Metadata           `protobuf:"bytes,4,opt,name=metadata,proto3"`
	xxx_hidden_Spec     *ClassifierSpec        `protobuf:"bytes,5,opt,name=spec,proto3"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *Classifier) GetKind() string {
	if x != nil {
		return x.xxx_hidden_Kind
	}
	return ""
...
func (x *Classifier) GetSubKind() string {
	if x != nil {
		return x.xxx_hidden_SubKind
	}
	return ""
...
func (x *Classifier) GetVersion() string {
	if x != nil {
		return x.xxx_hidden_Version
	}
	return ""
...
func (x *Classifier) GetMetadata() *v1.Metadata {
	if x != nil {
		return x.xxx_hidden_Metadata
	}
	return nil
...
func (x *Classifier) GetSpec() *ClassifierSpec {
	if x != nil {
		return x.xxx_hidden_Spec
	}
	return nil
...
func (x *Classifier) SetKind(v string) {
	x.xxx_hidden_Kind = v
}

func (x *Classifier) SetSubKind(v string) {
	x.xxx_hidden_SubKind = v
}

func (x *Classifier) SetVersion(v string) {
	x.xxx_hidden_Version = v
}

func (x *Classifier) SetMetadata(v *v1.Metadata) {
	x.xxx_hidden_Metadata = v
}

func (x *Classifier) SetSpec(v *ClassifierSpec) {
	x.xxx_hidden_Spec = v
}

func (x *Classifier) HasMetadata() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_Metadata != nil
...
func (x *Classifier) HasSpec() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_Spec != nil
...
func (x *Classifier) ClearMetadata() {
	x.xxx_hidden_Metadata = nil
}

func (x *Classifier) ClearSpec() {
	x.xxx_hidden_Spec = nil
}

type Classifier_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// Kind is the resource kind. Should always be set to "classifier".
	Kind string
	// SubKind is the resource sub-kind. Should be empty.
	SubKind string
	// Version is the resource version. Should be set to "v1".
	...
	Metadata *v1.Metadata
	// Spec selects the sessions that this classifier applies to and defines
	// what the classifier matches.
	Spec *ClassifierSpec
}

func (b0 Classifier_builder) Build() *Classifier {
	m0 := &Classifier{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Kind = b.Kind
...
// ClassifierSpec selects the sessions that a classifier applies to and
// defines what the classifier matches. Fields may be added to this message as
// long as they are backward compatible; incompatible schema changes require
// bumping the resource version on the Classifier message instead.
...
func (x *ClassifierSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClassifierSpec) ProtoMessage() {}

func (x *ClassifierSpec) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_summarizer_v1_summarizer_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *ClassifierSpec) GetKinds() []string {
	if x != nil {
		return x.xxx_hidden_Kinds
	}
	return nil
...
func (x *ClassifierSpec) GetFilter() string {
	if x != nil {
		return x.xxx_hidden_Filter
	}
	return ""
...
func (x *ClassifierSpec) GetCriteria() string {
	if x != nil {
...
func (x *ClassifierSpec) GetActions() *ClassifierActions {
	if x != nil {
...
func (x *ClassifierSpec) SetFilter(v string) {
	x.xxx_hidden_Filter = v
}

func (x *ClassifierSpec) SetCriteria(v string) {
...
func (x *ClassifierSpec) ClearActions() {
	x.xxx_hidden_Actions = nil
}

type ClassifierSpec_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// Kinds are session kinds matched by this classifier, e.g., "ssh", "k8s",
	// "db".
	Kinds []string
	// Filter is an optional filter expression using Teleport Predicate Language
	// that selects the sessions this classifier applies to. It supports the
	// same language and matching context as the inference policy filter, e.g.,
	// `equals(resource.metadata.labels["env"], "prod")`. If empty, the
	// classifier applies to all sessions of matching kinds.
	Filter string
	// Criteria is a natural-language description of what this classifier
...
// ClassifierActions configures the effects of a classifier match. Matches are
// always recorded on the stored session summary, regardless of the actions
// configured here.
type ClassifierActions struct {
	state                     protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_EmitAuditEvent ClassifierActionMode   `protobuf:"varint,1,opt,name=emit_audit_event,json=emitAuditEvent,proto3,enum=teleport.summarizer.v1.ClassifierActionMode"`
	xxx_hidden_RiskLevelFloor RiskLevel              `protobuf:"varint,2,opt,name=risk_level_floor,json=riskLevelFloor,proto3,enum=teleport.summarizer.v1.RiskLevel"`
	xxx_hidden_FlagForReview  ClassifierActionMode   `protobuf:"varint,3,opt,name=flag_for_review,json=flagForReview,proto3,enum=teleport.summarizer.v1.ClassifierActionMode"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}

func (x *ClassifierActions) Reset() {
	*x = ClassifierActions{}
...
func (x *ClassifierActions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClassifierActions) ProtoMessage() {}

func (x *ClassifierActions) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_summarizer_v1_summarizer_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *ClassifierActions) GetEmitAuditEvent() ClassifierActionMode {
	if x != nil {
		return x.xxx_hidden_EmitAuditEvent
	}
	return ClassifierActionMode_CLASSIFIER_ACTION_MODE_UNSPECIFIED
}

func (x *ClassifierActions) GetRiskLevelFloor() RiskLevel {
	if x != nil {
		return x.xxx_hidden_RiskLevelFloor
	}
	return RiskLevel_RISK_LEVEL_UNSPECIFIED
}

func (x *ClassifierActions) GetFlagForReview() ClassifierActionMode {
	if x != nil {
		return x.xxx_hidden_FlagForReview
	}
	return ClassifierActionMode_CLASSIFIER_ACTION_MODE_UNSPECIFIED
}

func (x *ClassifierActions) SetEmitAuditEvent(v ClassifierActionMode) {
	x.xxx_hidden_EmitAuditEvent = v
}

func (x *ClassifierActions) SetRiskLevelFloor(v RiskLevel) {
	x.xxx_hidden_RiskLevelFloor = v
}

func (x *ClassifierActions) SetFlagForReview(v ClassifierActionMode) {
	x.xxx_hidden_FlagForReview = v
}

type ClassifierActions_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// EmitAuditEvent, if enabled, emits an audit event when a session matches
	// this classifier.
	EmitAuditEvent ClassifierActionMode
	// RiskLevelFloor, if set, raises the session's risk level (and risk score)
	// to at least this level on match. It never lowers the risk level. Leaving
	// it unspecified means a match does not change the risk level. Only applies
	// to summaries that carry an EnhancedSummary.
	RiskLevelFloor RiskLevel
	// FlagForReview, if enabled, marks the session as needing further review on
	// match. Only applies to summaries that carry an EnhancedSummary.
	FlagForReview ClassifierActionMode
}

func (b0 ClassifierActions_builder) Build() *ClassifierActions {
	m0 := &ClassifierActions{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_EmitAuditEvent = b.EmitAuditEvent
	x.xxx_hidden_RiskLevelFloor = b.RiskLevelFloor
	x.xxx_hidden_FlagForReview = b.FlagForReview
	return m0
}
...
func (x *ClassifierMatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ClassifierMatch) GetClassifierName() string {
	if x != nil {
		return x.xxx_hidden_ClassifierName
	}
	return ""
}

func (x *ClassifierMatch) GetReasoning() string {
	if x != nil {
...
func (x *ClassifierMatch) GetMatchedCommandIndexes() []int32 {
	if x != nil {
		return x.xxx_hidden_MatchedCommandIndexes
	}
	return nil
}
...
func (x *ClassifierMatch) SetReasoning(v string) {
...
type ClassifierMatch_builder struct {
	...
	// ClassifierName is the name of the matching classifier resource.
	ClassifierName string
	// Reasoning is the model's explanation of why the session matched.
	Reasoning string
	// MatchedCommandIndexes are indexes into the session's analyzed commands
...
type Summary struct {
	...
	xxx_hidden_ClassifierMatches   *[]*ClassifierMatch    `protobuf:"bytes,10,rep,name=classifier_matches,json=classifierMatches,proto3"`
	xxx_hidden_ProcessedDuration   *durationpb.Duration   `protobuf:"bytes,11,opt,name=processed_duration,json=processedDuration,proto3"`
	xxx_hidden_TotalDuration       *durationpb.Duration   `protobuf:"bytes,12,opt,name=total_duration,json=totalDuration,proto3"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
func (x *Summary) GetClassifierMatches() []*ClassifierMatch {
	if x != nil {
		if x.xxx_hidden_ClassifierMatches != nil {
			return *x.xxx_hidden_ClassifierMatches
		}
	}
	return nil
}
...
func (x *Summary) GetProcessedDuration() *durationpb.Duration {
	if x != nil {
		return x.xxx_hidden_ProcessedDuration
	}
	return nil
}
...
func (x *Summary) SetClassifierMatches(v []*ClassifierMatch) {
	x.xxx_hidden_ClassifierMatches = &v
}

func (x *Summary) SetProcessedDuration(v *durationpb.Duration) {
	x.xxx_hidden_ProcessedDuration = v
}

func (x *Summary) SetTotalDuration(v *durationpb.Duration) {
...
func (x *Summary) HasProcessedDuration() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_ProcessedDuration != nil
}

func (x *Summary) HasTotalDuration() bool {
	if x == nil {
		return false
	}
...
func (x *Summary) ClearProcessedDuration() {
	x.xxx_hidden_ProcessedDuration = nil
}

func (x *Summary) ClearTotalDuration() {
...
type Summary_builder struct {
	...
	// ClassifierMatches records the classifiers that matched this session
	// summary.
	ClassifierMatches []*ClassifierMatch
	// ProcessedDuration is how much of the recording has been analyzed. Set while
	// the state is SUMMARY_STATE_IN_PROGRESS.
	ProcessedDuration *durationpb.Duration
...
func (b0 Summary_builder) Build() *Summary {
	...
	x.xxx_hidden_ClassifierMatches = &b.ClassifierMatches
	x.xxx_hidden_ProcessedDuration = b.ProcessedDuration
...
type EnhancedSummary struct {
	...
	xxx_hidden_InstructionConsistency    BeamInstructionConsistency `protobuf:"varint,17,opt,name=instruction_consistency,json=instructionConsistency,proto3,enum=teleport.summarizer.v1.BeamInstructionConsistency"`
	xxx_hidden_InstructionAssessment     string                     `protobuf:"bytes,18,opt,name=instruction_assessment,json=instructionAssessment,proto3"`
...
func (x *EnhancedSummary) GetInstructionConsistency() BeamInstructionConsistency {
	if x != nil {
		return x.xxx_hidden_InstructionConsistency
	}
	return BeamInstructionConsistency_BEAM_INSTRUCTION_CONSISTENCY_UNSPECIFIED
}

func (x *EnhancedSummary) GetInstructionAssessment() string {
	if x != nil {
		return x.xxx_hidden_InstructionAssessment
	}
	return ""
}
...
func (x *EnhancedSummary) SetInstructionConsistency(v BeamInstructionConsistency) {
	x.xxx_hidden_InstructionConsistency = v
}

func (x *EnhancedSummary) SetInstructionAssessment(v string) {
	x.xxx_hidden_InstructionAssessment = v
}
...
type EnhancedSummary_builder struct {
	...
	// InstructionConsistency indicates whether a beam agent's actions followed the
	// instructions it received from the LLM. Only set for beam activity summaries.
	InstructionConsistency BeamInstructionConsistency
	// InstructionAssessment is a free-text explanation of how the agent's actions
	// related to its LLM instructions. Empty for non-beam summaries.
	InstructionAssessment string
}
...
func (b0 EnhancedSummary_builder) Build() *EnhancedSummary {
	...
	x.xxx_hidden_InstructionConsistency = b.InstructionConsistency
	x.xxx_hidden_InstructionAssessment = b.InstructionAssessment
	return m0
}
...
const file_teleport_summarizer_v1_summarizer_proto_rawDesc = "" +
	...
	"\x06filter\x18\x03 \x01(\tR\x06filter\"\xcb\x01\n" +
	"\n" +
	"Classifier\x12\x12\n" +
	"\x04kind\x18\x01 \x01(\tR\x04kind\x12\x19\n" +
	"\bsub_kind\x18\x02 \x01(\tR\asubKind\x12\x18\n" +
	...
	"\x10enhanced_summary\x18\t \x01(\v2'.teleport.summarizer.v1.EnhancedSummaryR\x0fenhancedSummary\x12V\n" +
	"\x12classifier_matches\x18\n" +
	" \x03(\v2'.teleport.summarizer.v1.ClassifierMatchR\x11classifierMatches\x12H\n" +
	"\x12processed_duration\x18\v \x01(\v2\x19.google.protobuf.DurationR\x11processedDuration\x12@\n" +
	"\x0etotal_duration\x18\f \x01(\v2\x19.google.protobuf.DurationR\rtotalDuration\"\xe7\t\n" +
	"\fSessionEvent\x12C\n" +
	...
	"\fscore_impact\x18\x02 \x01(\x05R\vscoreImpact\"\x95\n" +
	"\n" +
	...
	"\x0esession_events\x18\x10 \x03(\v2$.teleport.summarizer.v1.SessionEventR\rsessionEvents\x12k\n" +
	"\x17instruction_consistency\x18\x11 \x01(\x0e22.teleport.summarizer.v1.BeamInstructionConsistencyR\x16instructionConsistency\x125\n" +
	"\x16instruction_assessment\x18\x12 \x01(\tR\x15instructionAssessmentB\x17\n" +
	...
	"\x14THREAT_CATEGORY_NONE\x10\f*\xdd\x02\n" +
	...
	"-NEEDS_REVIEW_REASON_OUTPUT_NOT_FULLY_CAPTURED\x10\x05\x12*\n" +
	"&NEEDS_REVIEW_REASON_CLASSIFIER_MATCHED\x10\x06*\xdd\x01\n" +
	"\x1aBeamInstructionConsistency\x12,\n" +
	"(BEAM_INSTRUCTION_CONSISTENCY_UNSPECIFIED\x10\x00\x12+\n" +
	"'BEAM_INSTRUCTION_CONSISTENCY_CONSISTENT\x10\x01\x125\n" +
	"1BEAM_INSTRUCTION_CONSISTENCY_PARTIALLY_CONSISTENT\x10\x02\x12-\n" +
...
var file_teleport_summarizer_v1_summarizer_proto_goTypes = []any{
	...
	(CommandCategory)(0),            // 2: teleport.summarizer.v1.CommandCategory
	(RiskLevel)(0),                  // 3: teleport.summarizer.v1.RiskLevel
	(ThreatCategory)(0),             // 4: teleport.summarizer.v1.ThreatCategory
	(NeedsReviewReason)(0),          // 5: teleport.summarizer.v1.NeedsReviewReason
	(BeamInstructionConsistency)(0), // 6: teleport.summarizer.v1.BeamInstructionConsistency
	(*InferenceModel)(nil),          // 7: teleport.summarizer.v1.InferenceModel
	(*InferenceModelSpec)(nil),      // 8: teleport.summarizer.v1.InferenceModelSpec
	(*OpenAIProvider)(nil),          // 9: teleport.summarizer.v1.OpenAIProvider
	(*BedrockProvider)(nil),         // 10: teleport.summarizer.v1.BedrockProvider
	(*InferenceSecret)(nil),         // 11: teleport.summarizer.v1.InferenceSecret
	(*InferenceSecretSpec)(nil),     // 12: teleport.summarizer.v1.InferenceSecretSpec
	(*InferencePolicy)(nil),         // 13: teleport.summarizer.v1.InferencePolicy
	(*InferencePolicySpec)(nil),     // 14: teleport.summarizer.v1.InferencePolicySpec
