...
const file_teleport_scim_v1_scim_service_proto_rawDesc = "" +
	...
	"\x18ListSCIMResourcesRequest\x125\n" +
	"\x04meta\x18\x04 \x01(\v2!.teleport.scim.v1.RequestMetadataR\x04meta\x127\n" +
	...
	"\x19UpdateSCIMResourceRequest\x125\n" +
	"\x04meta\x18\x03 \x01(\v2!.teleport.scim.v1.RequestMetadataR\x04meta\x127\n" +
	"\x06target\x18\x01 \x01(\v2\x1f.teleport.scim.v1.RequestTargetR\x06target\x126\n" +
	"\bresource\x18\x02 \x01(\v2\x1a.teleport.scim.v1.ResourceR\bresource\"\x8b\x01\n" +
	"\x19DeleteSCIMResourceRequest\x125\n" +
	"\x04meta\x18\x02 \x01(\v2!.teleport.scim.v1.RequestMetadataR\x04meta\x127\n" +
	"\x06target\x18\x01 \x01(\v2\x1f.teleport.scim.v1.RequestTargetR\x06target\"\xc0\x01\n" +
...
var file_teleport_scim_v1_scim_service_proto_depIdxs = []int32{
	5,  // 0: teleport.scim.v1.ListSCIMResourcesRequest.meta:type_name -> teleport.scim.v1.RequestMetadata
	9,  // 1: teleport.scim.v1.ListSCIMResourcesRequest.target:type_name -> teleport.scim.v1.RequestTarget
	10, // 2: teleport.scim.v1.ListSCIMResourcesRequest.page:type_name -> teleport.scim.v1.Page
	...
	5,  // 8: teleport.scim.v1.UpdateSCIMResourceRequest.meta:type_name -> teleport.scim.v1.RequestMetadata
	9,  // 9: teleport.scim.v1.UpdateSCIMResourceRequest.target:type_name -> teleport.scim.v1.RequestTarget
	6,  // 10: teleport.scim.v1.UpdateSCIMResourceRequest.resource:type_name -> teleport.scim.v1.Resource
	5,  // 11: teleport.scim.v1.DeleteSCIMResourceRequest.meta:type_name -> teleport.scim.v1.RequestMetadata
	9,  // 12: teleport.scim.v1.DeleteSCIMResourceRequest.target:type_name -> teleport.scim.v1.RequestTarget
