...
const (
	...
	SCIMService_PatchSCIMResource_FullMethodName  = "/teleport.scim.v1.SCIMService/PatchSCIMResource"
)
...
type SCIMServiceClient interface {
	...
	// PatchSCIMResource handles a request to patch a resource as per RFC 7644
	// Section 3.5.2.
	//
	// See https://datatracker.ietf.org/doc/html/rfc7644#section-3.5.2
	PatchSCIMResource(ctx context.Context, in *PatchSCIMResourceRequest, opts ...grpc.CallOption) (*Resource, error)
}
...
func (c *sCIMServiceClient) PatchSCIMResource(ctx context.Context, in *PatchSCIMResourceRequest, opts ...grpc.CallOption) (*Resource, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Resource)
	err := c.cc.Invoke(ctx, SCIMService_PatchSCIMResource_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SCIMServiceServer interface {
	...
	//
	// See https://datatracker.ietf.org/doc/html/rfc7644#section-3.5.2
	PatchSCIMResource(context.Context, *PatchSCIMResourceRequest) (*Resource, error)
...
func (UnimplementedSCIMServiceServer) ListSCIMResources(context.Context, *ListSCIMResourcesRequest) (*ResourceList, error) {
	return nil, status.Error(codes.Unimplemented, "method ListSCIMResources not implemented")
}
func (UnimplementedSCIMServiceServer) GetSCIMResource(context.Context, *GetSCIMResourceRequest) (*Resource, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSCIMResource not implemented")
}
func (UnimplementedSCIMServiceServer) CreateSCIMResource(context.Context, *CreateSCIMResourceRequest) (*Resource, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateSCIMResource not implemented")
}
func (UnimplementedSCIMServiceServer) UpdateSCIMResource(context.Context, *UpdateSCIMResourceRequest) (*Resource, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateSCIMResource not implemented")
}
func (UnimplementedSCIMServiceServer) DeleteSCIMResource(context.Context, *DeleteSCIMResourceRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteSCIMResource not implemented")
}
func (UnimplementedSCIMServiceServer) PatchSCIMResource(context.Context, *PatchSCIMResourceRequest) (*Resource, error) {
	return nil, status.Error(codes.Unimplemented, "method PatchSCIMResource not implemented")
}
...
func RegisterSCIMServiceServer(s grpc.ServiceRegistrar, srv SCIMServiceServer) {
	// If the following call panics, it indicates UnimplementedSCIMServiceServer was
...
func _SCIMService_PatchSCIMResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PatchSCIMResourceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SCIMServiceServer).PatchSCIMResource(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SCIMService_PatchSCIMResource_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SCIMServiceServer).PatchSCIMResource(ctx, req.(*PatchSCIMResourceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SCIMService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PatchSCIMResource",
			Handler:    _SCIMService_PatchSCIMResource_Handler,
		},
	},
