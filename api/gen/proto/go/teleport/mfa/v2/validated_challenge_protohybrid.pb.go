...
type SessionIdentifyingPayload struct {
	...
	//	*SessionIdentifyingPayload_TlsSessionId
...
func (x *SessionIdentifyingPayload) GetTlsSessionId() []byte {
	if x != nil {
		if x, ok := x.Payload.(*SessionIdentifyingPayload_TlsSessionId); ok {
...
func (x *SessionIdentifyingPayload) SetSshSessionId(v []byte) {
	...
	x.Payload = &SessionIdentifyingPayload_SshSessionId{v}
}
...
func (x *SessionIdentifyingPayload) SetTlsSessionId(v []byte) {
	...
	x.Payload = &SessionIdentifyingPayload_TlsSessionId{v}
}
...
func (x *SessionIdentifyingPayload) HasSshSessionId() bool {
	...
	_, ok := x.Payload.(*SessionIdentifyingPayload_SshSessionId)
	return ok
}
...
func (x *SessionIdentifyingPayload) HasTlsSessionId() bool {
	...
	_, ok := x.Payload.(*SessionIdentifyingPayload_TlsSessionId)
	return ok
}
...
func (x *SessionIdentifyingPayload) ClearSshSessionId() {
	if _, ok := x.Payload.(*SessionIdentifyingPayload_SshSessionId); ok {
		x.Payload = nil
	}
}

func (x *SessionIdentifyingPayload) ClearTlsSessionId() {
	if _, ok := x.Payload.(*SessionIdentifyingPayload_TlsSessionId); ok {
		x.Payload = nil
	}
}
...
func (b0 SessionIdentifyingPayload_builder) Build() *SessionIdentifyingPayload {
	...
	if b.SshSessionId != nil {
		x.Payload = &SessionIdentifyingPayload_SshSessionId{b.SshSessionId}
	}
	if b.TlsSessionId != nil {
		x.Payload = &SessionIdentifyingPayload_TlsSessionId{b.TlsSessionId}
	}
	return m0
}
