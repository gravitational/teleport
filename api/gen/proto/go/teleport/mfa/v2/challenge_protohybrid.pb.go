...
type AuthenticateChallenge struct {
	...
	WebauthnChallenge *v2.CredentialAssertion `protobuf:"bytes,2,opt,name=webauthn_challenge,json=webauthnChallenge,proto3" json:"webauthn_challenge,omitempty"`
...
func (x *AuthenticateChallenge) HasWebauthnChallenge() bool {
	...
	return x.WebauthnChallenge != nil
}
...
func (x *AuthenticateChallenge) HasBrowserChallenge() bool {
	...
	return x.BrowserChallenge != nil
}

func (x *AuthenticateChallenge) ClearWebauthnChallenge() {
	x.WebauthnChallenge = nil
}
...
func (b0 AuthenticateChallenge_builder) Build() *AuthenticateChallenge {
	...
	_, _ = b, x
	x.Name = b.Name
	x.WebauthnChallenge = b.WebauthnChallenge
	x.SsoChallenge = b.SsoChallenge
	x.BrowserChallenge = b.BrowserChallenge
	return m0
}
...
func (x *AuthenticateResponse) SetWebauthn(v *v2.CredentialAssertionResponse) {
	...
	x.Response = &AuthenticateResponse_Webauthn{v}
}
...
func (x *AuthenticateResponse) SetSso(v *SSOChallengeResponse) {
	...
	x.Response = &AuthenticateResponse_Sso{v}
}
...
func (x *AuthenticateResponse) SetBrowser(v *BrowserMFAResponse) {
	...
	x.Response = &AuthenticateResponse_Browser{v}
}
...
func (x *AuthenticateResponse) HasWebauthn() bool {
	...
	_, ok := x.Response.(*AuthenticateResponse_Webauthn)
	return ok
}
...
func (x *AuthenticateResponse) HasSso() bool {
	...
	_, ok := x.Response.(*AuthenticateResponse_Sso)
	return ok
}
...
func (x *AuthenticateResponse) HasBrowser() bool {
	...
	_, ok := x.Response.(*AuthenticateResponse_Browser)
	return ok
}
...
func (x *AuthenticateResponse) ClearWebauthn() {
	if _, ok := x.Response.(*AuthenticateResponse_Webauthn); ok {
		x.Response = nil
	}
}

func (x *AuthenticateResponse) ClearSso() {
	if _, ok := x.Response.(*AuthenticateResponse_Sso); ok {
		x.Response = nil
	}
}

func (x *AuthenticateResponse) ClearBrowser() {
	if _, ok := x.Response.(*AuthenticateResponse_Browser); ok {
		x.Response = nil
	}
}
...
func (b0 AuthenticateResponse_builder) Build() *AuthenticateResponse {
	...
	x.Name = b.Name
	if b.Webauthn != nil {
		x.Response = &AuthenticateResponse_Webauthn{b.Webauthn}
	}
	if b.Sso != nil {
		x.Response = &AuthenticateResponse_Sso{b.Sso}
	}
	if b.Browser != nil {
		x.Response = &AuthenticateResponse_Browser{b.Browser}
	}
	return m0
}
...
type BrowserMFAResponse struct {
	...
	WebauthnResponse *v2.CredentialAssertionResponse `protobuf:"bytes,2,opt,name=webauthn_response,json=webauthnResponse,proto3" json:"webauthn_response,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *BrowserMFAResponse) HasWebauthnResponse() bool {
	...
	return x.WebauthnResponse != nil
}

func (x *BrowserMFAResponse) ClearWebauthnResponse() {
	x.WebauthnResponse = nil
}
...
func (b0 BrowserMFAResponse_builder) Build() *BrowserMFAResponse {
	...
	_, _ = b, x
	x.RequestId = b.RequestId
	x.WebauthnResponse = b.WebauthnResponse
	return m0
}
