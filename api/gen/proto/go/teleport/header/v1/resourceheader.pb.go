...
var file_teleport_header_v1_resourceheader_proto_goTypes = []interface{}{
...
func file_teleport_header_v1_resourceheader_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_header_v1_resourceheader_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
