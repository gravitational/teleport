...
const file_teleport_okta_v1_okta_service_proto_rawDesc = "" +
	...
	"\x05Group\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\"\xf8\x04\n" +
	...
	" \x01(\bR\x17enableBidirectionalSync\x12?\n" +
	"\x1cdisable_assign_default_roles\x18\f \x01(\bR\x19disableAssignDefaultRoles\"\xc4\x04\n" +
	...
	"\x19enable_bidirectional_sync\x18\n" +
	" \x01(\bR\x17enableBidirectionalSync\x12?\n" +
	"\x1cdisable_assign_default_roles\x18\f \x01(\bR\x19disableAssignDefaultRoles\"\x7f\n" +
