...
type ListTunnelConnectionsRequest struct {
	...
	Filter        *ListTunnelConnectionsFilter `protobuf:"bytes,3,opt,name=filter,proto3" json:"filter,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListTunnelConnectionsResponse struct {
	...
	TunnelConnections []*types.TunnelConnectionV2 `protobuf:"bytes,1,rep,name=tunnel_connections,json=tunnelConnections,proto3" json:"tunnel_connections,omitempty"`
	// Token to retrieve the next page of results, or empty if there are no
	// more results in the list.
	NextPageToken string `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (b0 ListTunnelConnectionsResponse_builder) Build() *ListTunnelConnectionsResponse {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.TunnelConnections = b.TunnelConnections
	x.NextPageToken = b.NextPageToken
	return m0
}
