...
func file_teleport_trust_v1_trust_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_teleport_trust_v1_trust_service_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_teleport_trust_v1_trust_service_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
