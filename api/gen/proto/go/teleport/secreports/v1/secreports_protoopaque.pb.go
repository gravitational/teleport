...
type AuditQuery struct {
	...
	xxx_hidden_Spec   *AuditQuerySpec        `protobuf:"bytes,2,opt,name=spec,proto3"`
...
type Report struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Header *v1.ResourceHeader     `protobuf:"bytes,1,opt,name=header,proto3"`
	xxx_hidden_Spec   *ReportSpec            `protobuf:"bytes,2,opt,name=spec,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type ReportSpec struct {
	...
	xxx_hidden_AuditQueries *[]*AuditQuerySpec     `protobuf:"bytes,3,rep,name=audit_queries,json=auditQueries,proto3"`
...
func (x *ReportSpec) GetAuditQueries() []*AuditQuerySpec {
	if x != nil {
		if x.xxx_hidden_AuditQueries != nil {
			return *x.xxx_hidden_AuditQueries
		}
	}
	return nil
}
...
func (b0 ReportSpec_builder) Build() *ReportSpec {
	...
	x.xxx_hidden_Name = b.Name
	x.xxx_hidden_Description = b.Description
	x.xxx_hidden_AuditQueries = &b.AuditQueries
	x.xxx_hidden_Title = b.Title
...
type ReportState struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Header *v1.ResourceHeader     `protobuf:"bytes,1,opt,name=header,proto3"`
	xxx_hidden_Spec   *ReportStateSpec       `protobuf:"bytes,2,opt,name=spec,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type ReportStateSpec struct {
	...
	xxx_hidden_UpdatedAt string                 `protobuf:"bytes,2,opt,name=updated_at,json=updatedAt,proto3"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
