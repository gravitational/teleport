...
type DiscoveryConfigStatus struct {
	...
	AwsEc2ResourcesDiscovered []*AWSResourcesDiscoveredSummary `protobuf:"bytes,6,rep,name=aws_ec2_resources_discovered,json=awsEc2ResourcesDiscovered,proto3" json:"aws_ec2_resources_discovered,omitempty"`
}
...
func (x *DiscoveryConfigStatus) GetAwsEc2ResourcesDiscovered() []*AWSResourcesDiscoveredSummary {
	if x != nil {
		return x.AwsEc2ResourcesDiscovered
	}
	return nil
}

// AWSResourcesDiscoveredSummary represents the AWS resources that were discovered.
type AWSResourcesDiscoveredSummary struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Enrolled uint64 `protobuf:"varint,3,opt,name=enrolled,proto3" json:"enrolled,omitempty"`
...
func (x *AWSResourcesDiscoveredSummary) Reset() {
	*x = AWSResourcesDiscoveredSummary{}
	if protoimpl.UnsafeEnabled {
...
func (x *AWSResourcesDiscoveredSummary) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AWSResourcesDiscoveredSummary) ProtoMessage() {}

func (x *AWSResourcesDiscoveredSummary) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_discoveryconfig_v1_discoveryconfig_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AWSResourcesDiscoveredSummary.ProtoReflect.Descriptor instead.
func (*AWSResourcesDiscoveredSummary) Descriptor() ([]byte, []int) {
	return file_teleport_discoveryconfig_v1_discoveryconfig_proto_rawDescGZIP(), []int{3}
}

func (x *AWSResourcesDiscoveredSummary) GetIntegration() string {
	if x != nil {
...
func (x *AWSResourcesDiscoveredSummary) GetFound() uint64 {
	if x != nil {
		return x.Found
	}
	return 0
...
func (x *AWSResourcesDiscoveredSummary) GetEnrolled() uint64 {
	if x != nil {
		return x.Enrolled
	}
	return 0
...
func (x *AWSResourcesDiscoveredSummary) GetFailed() uint64 {
	if x != nil {
		return x.Failed
	}
	return 0
...
var file_teleport_discoveryconfig_v1_discoveryconfig_proto_rawDesc = []byte{
	...
	0x63, 0x52, 0x0b, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x47, 0x72, 0x61, 0x70, 0x68, 0x22, 0xb2,
	...
	,
	...
	0x67, 0x6f, 0x2f, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2f, 0x64, 0x69, 0x73, 0x63,
	0x6f, 0x76, 0x65, 0x72, 0x79, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x76, 0x31, 0x3b, 0x64,
	0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x76, 0x31,
...
var file_teleport_discoveryconfig_v1_discoveryconfig_proto_goTypes = []any{
	...
	(*AWSResourcesDiscoveredSummary)(nil), // 4: teleport.discoveryconfig.v1.AWSResourcesDiscoveredSummary
	(*v1.ResourceHeader)(nil),             // 5: teleport.header.v1.ResourceHeader
	(*types.AWSMatcher)(nil),              // 6: types.AWSMatcher
	(*types.AzureMatcher)(nil),            // 7: types.AzureMatcher
	(*types.GCPMatcher)(nil),              // 8: types.GCPMatcher
	(*types.KubernetesMatcher)(nil),       // 9: types.KubernetesMatcher
	(*types.AccessGraphSync)(nil),         // 10: types.AccessGraphSync
	(*timestamppb.Timestamp)(nil),         // 11: google.protobuf.Timestamp
}
var file_teleport_discoveryconfig_v1_discoveryconfig_proto_depIdxs = []int32{
	5,  // 0: teleport.discoveryconfig.v1.DiscoveryConfig.header:type_name -> teleport.header.v1.ResourceHeader
	...
	6,  // 3: teleport.discoveryconfig.v1.DiscoveryConfigSpec.aws:type_name -> types.AWSMatcher
	7,  // 4: teleport.discoveryconfig.v1.DiscoveryConfigSpec.azure:type_name -> types.AzureMatcher
	8,  // 5: teleport.discoveryconfig.v1.DiscoveryConfigSpec.gcp:type_name -> types.GCPMatcher
	9,  // 6: teleport.discoveryconfig.v1.DiscoveryConfigSpec.kube:type_name -> types.KubernetesMatcher
	10, // 7: teleport.discoveryconfig.v1.DiscoveryConfigSpec.access_graph:type_name -> types.AccessGraphSync
	0,  // 8: teleport.discoveryconfig.v1.DiscoveryConfigStatus.state:type_name -> teleport.discoveryconfig.v1.DiscoveryConfigState
	11, // 9: teleport.discoveryconfig.v1.DiscoveryConfigStatus.last_sync_time:type_name -> google.protobuf.Timestamp
	4,  // 10: teleport.discoveryconfig.v1.DiscoveryConfigStatus.aws_ec2_resources_discovered:type_name -> teleport.discoveryconfig.v1.AWSResourcesDiscoveredSummary
...
func file_teleport_discoveryconfig_v1_discoveryconfig_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_teleport_discoveryconfig_v1_discoveryconfig_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*AWSResourcesDiscoveredSummary); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
