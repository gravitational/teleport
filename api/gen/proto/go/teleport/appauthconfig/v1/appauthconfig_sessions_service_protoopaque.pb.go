...
type App struct {
	...
	xxx_hidden_AppName     string                 `protobuf:"bytes,2,opt,name=app_name,json=appName,proto3"`
	xxx_hidden_Uri         string                 `protobuf:"bytes,3,opt,name=uri,proto3"`
	xxx_hidden_PublicAddr  string                 `protobuf:"bytes,4,opt,name=public_addr,json=publicAddr,proto3"`
...
type CreateAppSessionWithJWTRequest struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ConfigName string                 `protobuf:"bytes,1,opt,name=config_name,json=configName,proto3"`
	xxx_hidden_App        *App                   `protobuf:"bytes,2,opt,name=app,proto3"`
	xxx_hidden_Jwt        string                 `protobuf:"bytes,3,opt,name=jwt,proto3"`
	xxx_hidden_RemoteAddr string                 `protobuf:"bytes,4,opt,name=remote_addr,json=remoteAddr,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type CreateAppSessionWithJWTResponse struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Session *types.WebSessionV2    `protobuf:"bytes,1,opt,name=session,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
