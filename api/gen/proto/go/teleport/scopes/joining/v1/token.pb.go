...
type Kubernetes struct {
	...
	// Controls which behavior should be used for validating the Kubernetes Service Account token. Support values:
	// - `in_cluster`
	// - `static_jwks`
	// - `oidc`
...
type Kubernetes_StaticJWKSConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The JSON Web Key Set formatted public keys of that the Kubernetes Cluster uses to sign service
