...
type ScopedTokenSpec struct {
	...
	Gitlab        *GitLab `protobuf:"bytes,6,opt,name=gitlab,proto3" json:"gitlab,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (*GitLab_Rule) Descriptor() ([]byte, []int) {
	return file_teleport_scopes_joining_v1_token_proto_rawDescGZIP(), []int{5, 0}
}
...
const file_teleport_scopes_joining_v1_token_proto_rawDesc = "" +
	...
	"\x06status\x18\a \x01(\v2-.teleport.scopes.joining.v1.ScopedTokenStatusR\x06status\"\x9a\x02\n" +
	...
	"\x06github\x18\x05 \x01(\v2\".teleport.scopes.joining.v1.GithubR\x06github\x12:\n" +
	"\x06gitlab\x18\x06 \x01(\v2\".teleport.scopes.joining.v1.GitLabR\x06gitlab\"+\n" +
...
var file_teleport_scopes_joining_v1_token_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_teleport_scopes_joining_v1_token_proto_goTypes = []any{
	...
	(*GitLab)(nil),            // 5: teleport.scopes.joining.v1.GitLab
	(*AWS_Rule)(nil),          // 6: teleport.scopes.joining.v1.AWS.Rule
	(*Github_Rule)(nil),       // 7: teleport.scopes.joining.v1.Github.Rule
	(*GitLab_Rule)(nil),       // 8: teleport.scopes.joining.v1.GitLab.Rule
	(*v1.Metadata)(nil),       // 9: teleport.header.v1.Metadata
}
var file_teleport_scopes_joining_v1_token_proto_depIdxs = []int32{
	9, // 0: teleport.scopes.joining.v1.ScopedToken.metadata:type_name -> teleport.header.v1.Metadata
	...
	5, // 5: teleport.scopes.joining.v1.ScopedTokenSpec.gitlab:type_name -> teleport.scopes.joining.v1.GitLab
	6, // 6: teleport.scopes.joining.v1.AWS.allow:type_name -> teleport.scopes.joining.v1.AWS.Rule
	7, // 7: teleport.scopes.joining.v1.Github.allow:type_name -> teleport.scopes.joining.v1.Github.Rule
	8, // 8: teleport.scopes.joining.v1.GitLab.allow:type_name -> teleport.scopes.joining.v1.GitLab.Rule
...
func file_teleport_scopes_joining_v1_token_proto_init() {
	...
	file_teleport_scopes_joining_v1_token_proto_msgTypes[8].OneofWrappers = []any{}
	type x struct{}
