...
func (GivingUp_Reason) EnumDescriptor() ([]byte, []int) {
	return file_teleport_join_v1_joinservice_proto_rawDescGZIP(), []int{24, 0}
}
...
var file_teleport_join_v1_joinservice_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_teleport_join_v1_joinservice_proto_goTypes = []any{
	...
	(*ChallengeSolution)(nil),              // 24: teleport.join.v1.ChallengeSolution
	(*GivingUp)(nil),                       // 25: teleport.join.v1.GivingUp
	(*JoinRequest)(nil),                    // 26: teleport.join.v1.JoinRequest
	(*ServerInit)(nil),                     // 27: teleport.join.v1.ServerInit
	(*Challenge)(nil),                      // 28: teleport.join.v1.Challenge
	(*Result)(nil),                         // 29: teleport.join.v1.Result
	(*Certificates)(nil),                   // 30: teleport.join.v1.Certificates
	(*HostResult)(nil),                     // 31: teleport.join.v1.HostResult
	(*BotResult)(nil),                      // 32: teleport.join.v1.BotResult
	(*JoinResponse)(nil),                   // 33: teleport.join.v1.JoinResponse
	(*ClientInit_ProxySuppliedParams)(nil), // 34: teleport.join.v1.ClientInit.ProxySuppliedParams
	(*timestamppb.Timestamp)(nil),          // 35: google.protobuf.Timestamp
}
var file_teleport_join_v1_joinservice_proto_depIdxs = []int32{
	34, // 0: teleport.join.v1.ClientInit.proxy_supplied_parameters:type_name -> teleport.join.v1.ClientInit.ProxySuppliedParams
	...
	35, // 3: teleport.join.v1.BotParams.expires:type_name -> google.protobuf.Timestamp
	...
	10, // 13: teleport.join.v1.ChallengeSolution.bound_keypair_challenge_solution:type_name -> teleport.join.v1.BoundKeypairChallengeSolution
	12, // 14: teleport.join.v1.ChallengeSolution.bound_keypair_rotation_response:type_name -> teleport.join.v1.BoundKeypairRotationResponse
	16, // 15: teleport.join.v1.ChallengeSolution.iam_challenge_solution:type_name -> teleport.join.v1.IAMChallengeSolution
	20, // 16: teleport.join.v1.ChallengeSolution.oracle_challenge_solution:type_name -> teleport.join.v1.OracleChallengeSolution
	23, // 17: teleport.join.v1.ChallengeSolution.tpm_solution:type_name -> teleport.join.v1.TPMSolution
	0,  // 18: teleport.join.v1.GivingUp.reason:type_name -> teleport.join.v1.GivingUp.Reason
	1,  // 19: teleport.join.v1.JoinRequest.client_init:type_name -> teleport.join.v1.ClientInit
	6,  // 20: teleport.join.v1.JoinRequest.token_init:type_name -> teleport.join.v1.TokenInit
	8,  // 21: teleport.join.v1.JoinRequest.bound_keypair_init:type_name -> teleport.join.v1.BoundKeypairInit
	24, // 22: teleport.join.v1.JoinRequest.solution:type_name -> teleport.join.v1.ChallengeSolution
	14, // 23: teleport.join.v1.JoinRequest.iam_init:type_name -> teleport.join.v1.IAMInit
	25, // 24: teleport.join.v1.JoinRequest.giving_up:type_name -> teleport.join.v1.GivingUp
	17, // 25: teleport.join.v1.JoinRequest.ec2_init:type_name -> teleport.join.v1.EC2Init
	7,  // 26: teleport.join.v1.JoinRequest.oidc_init:type_name -> teleport.join.v1.OIDCInit
	18, // 27: teleport.join.v1.JoinRequest.oracle_init:type_name -> teleport.join.v1.OracleInit
	21, // 28: teleport.join.v1.JoinRequest.tpm_init:type_name -> teleport.join.v1.TPMInit
	9,  // 29: teleport.join.v1.Challenge.bound_keypair_challenge:type_name -> teleport.join.v1.BoundKeypairChallenge
	11, // 30: teleport.join.v1.Challenge.bound_keypair_rotation_request:type_name -> teleport.join.v1.BoundKeypairRotationRequest
	15, // 31: teleport.join.v1.Challenge.iam_challenge:type_name -> teleport.join.v1.IAMChallenge
	19, // 32: teleport.join.v1.Challenge.oracle_challenge:type_name -> teleport.join.v1.OracleChallenge
	22, // 33: teleport.join.v1.Challenge.tpm_encrypted_credential:type_name -> teleport.join.v1.TPMEncryptedCredential
	31, // 34: teleport.join.v1.Result.host_result:type_name -> teleport.join.v1.HostResult
	32, // 35: teleport.join.v1.Result.bot_result:type_name -> teleport.join.v1.BotResult
	30, // 36: teleport.join.v1.HostResult.certificates:type_name -> teleport.join.v1.Certificates
	30, // 37: teleport.join.v1.BotResult.certificates:type_name -> teleport.join.v1.Certificates
	13, // 38: teleport.join.v1.BotResult.bound_keypair_result:type_name -> teleport.join.v1.BoundKeypairResult
	27, // 39: teleport.join.v1.JoinResponse.init:type_name -> teleport.join.v1.ServerInit
	28, // 40: teleport.join.v1.JoinResponse.challenge:type_name -> teleport.join.v1.Challenge
	29, // 41: teleport.join.v1.JoinResponse.result:type_name -> teleport.join.v1.Result
	26, // 42: teleport.join.v1.JoinService.Join:input_type -> teleport.join.v1.JoinRequest
	33, // 43: teleport.join.v1.JoinService.Join:output_type -> teleport.join.v1.JoinResponse
...
func file_teleport_join_v1_joinservice_proto_init() {
	...
	file_teleport_join_v1_joinservice_proto_msgTypes[32].OneofWrappers = []any{
