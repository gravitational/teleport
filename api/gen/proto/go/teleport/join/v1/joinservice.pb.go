...
type JoinRequest_OidcInit struct {
	OidcInit *OIDCInit `protobuf:"bytes,7,opt,name=oidc_init,json=oidcInit,proto3,oneof"`
}
...
const file_teleport_join_v1_joinservice_proto_rawDesc = "" +
	...
	" REASON_CHALLENGE_SOLUTION_FAILED\x10\x03\"\xdc\x03\n" +
	"\vJoinRequest\x12?\n" +
	...
	"\tgiving_up\x18\x06 \x01(\v2\x1a.teleport.join.v1.GivingUpH\x00R\bgivingUp\x129\n" +
	"\toidc_init\x18\a \x01(\v2\x1a.teleport.join.v1.OIDCInitH\x00R\boidcInitB\t\n" +
	"\apayload\"i\n" +
	"\n" +
	"ServerInit\x12\x1f\n" +
...
var file_teleport_join_v1_joinservice_proto_depIdxs = []int32{
	...
	10, // 10: teleport.join.v1.ChallengeSolution.bound_keypair_challenge_solution:type_name -> teleport.join.v1.BoundKeypairChallengeSolution
	12, // 11: teleport.join.v1.ChallengeSolution.bound_keypair_rotation_response:type_name -> teleport.join.v1.BoundKeypairRotationResponse
	16, // 12: teleport.join.v1.ChallengeSolution.iam_challenge_solution:type_name -> teleport.join.v1.IAMChallengeSolution
	...
	8,  // 16: teleport.join.v1.JoinRequest.bound_keypair_init:type_name -> teleport.join.v1.BoundKeypairInit
	17, // 17: teleport.join.v1.JoinRequest.solution:type_name -> teleport.join.v1.ChallengeSolution
	14, // 18: teleport.join.v1.JoinRequest.iam_init:type_name -> teleport.join.v1.IAMInit
	18, // 19: teleport.join.v1.JoinRequest.giving_up:type_name -> teleport.join.v1.GivingUp
	7,  // 20: teleport.join.v1.JoinRequest.oidc_init:type_name -> teleport.join.v1.OIDCInit
	9,  // 21: teleport.join.v1.Challenge.bound_keypair_challenge:type_name -> teleport.join.v1.BoundKeypairChallenge
	11, // 22: teleport.join.v1.Challenge.bound_keypair_rotation_request:type_name -> teleport.join.v1.BoundKeypairRotationRequest
	15, // 23: teleport.join.v1.Challenge.iam_challenge:type_name -> teleport.join.v1.IAMChallenge
	...
	13, // 28: teleport.join.v1.BotResult.bound_keypair_result:type_name -> teleport.join.v1.BoundKeypairResult
