...
type ClientInit struct {
	...
	HostParams              *ClientInit_HostParams          `protobuf:"bytes,7,opt,name=host_params,json=hostParams,proto3" json:"host_params,omitempty"`
	BotParams               *ClientInit_BotParams           `protobuf:"bytes,8,opt,name=bot_params,json=botParams,proto3" json:"bot_params,omitempty"`
...
const file_teleport_join_v1_joinservice_proto_rawDesc = "" +
	"\n" +
	"\"teleport/join/v1/joinservice.proto\x12\x10teleport.join.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbd\x06\n" +
	"\n" +
	"ClientInit\x12$\n" +
	...
	"\x12forwarded_by_proxy\x18\x06 \x01(\bR\x10forwardedByProxy\x12H\n" +
	"\vhost_params\x18\a \x01(\v2'.teleport.join.v1.ClientInit.HostParamsR\n" +
	"hostParams\x12E\n" +
	"\n" +
	"bot_params\x18\b \x01(\v2&.teleport.join.v1.ClientInit.BotParamsR\tbotParams\x12q\n" +
	"\x19proxy_supplied_parameters\x18\t \x01(\v20.teleport.join.v1.ClientInit.ProxySuppliedParamsH\x01R\x17proxySuppliedParameters\x88\x01\x01\x1a{\n" +
	"\n" +
	"HostParams\x12\x1b\n" +
	"\thost_name\x18\x01 \x01(\tR\bhostName\x123\n" +
	"\x15additional_principals\x18\x02 \x03(\tR\x14additionalPrincipals\x12\x1b\n" +
	"\tdns_names\x18\x03 \x03(\tR\bdnsNames\x1aA\n" +
	"\tBotParams\x124\n" +
	"\aexpires\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\aexpires\x1a]\n" +
