...
const file_teleport_dynamicwindows_v1_dynamicwindows_service_proto_rawDesc = "" +
	"\n" +
	"7teleport/dynamicwindows/v1/dynamicwindows_service.proto\x12\x1ateleport.dynamicwindows.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a!teleport/legacy/types/types.proto\"_\n" +
	"!ListDynamicWindowsDesktopsRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\"\x88\x01\n" +
	"\"ListDynamicWindowsDesktopsResponse\x12:\n" +
	"\bdesktops\x18\x01 \x03(\v2\x1e.types.DynamicWindowsDesktopV1R\bdesktops\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"5\n" +
	"\x1fGetDynamicWindowsDesktopRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"^\n" +
	"\"CreateDynamicWindowsDesktopRequest\x128\n" +
