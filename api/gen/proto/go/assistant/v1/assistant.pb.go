...
// TitleSummaryRequest is request for TitleSummary endpoint.
type TitleSummaryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TitleSummaryRequest) Reset() {
	*x = TitleSummaryRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_teleport_assistant_v1_assistant_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TitleSummaryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TitleSummaryRequest) ProtoMessage() {}

func (x *TitleSummaryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_assistant_v1_assistant_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TitleSummaryRequest.ProtoReflect.Descriptor instead.
func (*TitleSummaryRequest) Descriptor() ([]byte, []int) {
	return file_teleport_assistant_v1_assistant_proto_rawDescGZIP(), []int{4}
}

func (x *TitleSummaryRequest) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
// TitleSummaryResponse is response for TitleSummary endpoint.
...
func (x *TitleSummaryResponse) Reset() {
	*x = TitleSummaryResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_teleport_assistant_v1_assistant_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TitleSummaryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TitleSummaryResponse) ProtoMessage() {}

func (x *TitleSummaryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_assistant_v1_assistant_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TitleSummaryResponse.ProtoReflect.Descriptor instead.
func (*TitleSummaryResponse) Descriptor() ([]byte, []int) {
	return file_teleport_assistant_v1_assistant_proto_rawDescGZIP(), []int{5}
}

func (x *TitleSummaryResponse) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
var file_teleport_assistant_v1_assistant_proto_rawDesc = []byte{
	...
	0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x52, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x22, 0x2f,
	0x0a, 0x13, 0x54, 0x69, 0x74, 0x6c, 0x65, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22,
	0x2c, 0x0a, 0x14, 0x54, 0x69, 0x74, 0x6c, 0x65, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x32, 0xda, 0x01,
	...
	0x65, 0x12, 0x67, 0x0a, 0x0c, 0x54, 0x69, 0x74, 0x6c, 0x65, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72,
	0x79, 0x12, 0x2a, 0x2e, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x61, 0x73, 0x73,
	0x69, 0x73, 0x74, 0x61, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x69, 0x74, 0x6c, 0x65, 0x53,
	0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2b, 0x2e,
	0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x61, 0x73, 0x73, 0x69, 0x73, 0x74, 0x61,
	0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x69, 0x74, 0x6c, 0x65, 0x53, 0x75, 0x6d, 0x6d, 0x61,
	0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x41, 0x5a, 0x3f, 0x67, 0x69,
	...
	0x2f, 0x61, 0x73, 0x73, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x74, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70,
...
var file_teleport_assistant_v1_assistant_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_teleport_assistant_v1_assistant_proto_goTypes = []interface{}{
	...
	(*TitleSummaryRequest)(nil),   // 4: teleport.assistant.v1.TitleSummaryRequest
	(*TitleSummaryResponse)(nil),  // 5: teleport.assistant.v1.TitleSummaryResponse
}
var file_teleport_assistant_v1_assistant_proto_depIdxs = []int32{
	...
	4, // 3: teleport.assistant.v1.AssistantService.TitleSummary:input_type -> teleport.assistant.v1.TitleSummaryRequest
	3, // 4: teleport.assistant.v1.AssistantService.Complete:output_type -> teleport.assistant.v1.CompletionResponse
	5, // 5: teleport.assistant.v1.AssistantService.TitleSummary:output_type -> teleport.assistant.v1.TitleSummaryResponse
...
func file_teleport_assistant_v1_assistant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_teleport_assistant_v1_assistant_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TitleSummaryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_teleport_assistant_v1_assistant_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TitleSummaryResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
