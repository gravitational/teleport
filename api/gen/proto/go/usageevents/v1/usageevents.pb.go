...
type ResourceDiscoveredEvent struct {
	// resource_type is the type of resource ("node", "node.openssh", "db", "k8s", "app").
	ResourceType string `protobuf:"bytes,1,opt,name=resource_type,json=resourceType,proto3" json:"resource_type,omitempty"`
	// resource_name is the name of the discovered resource.
	ResourceName string `protobuf:"bytes,2,opt,name=resource_name,json=resourceName,proto3" json:"resource_name,omitempty"`
	// cloud_provider is the cloud provider ("AWS", "Azure", "GCP").
	CloudProvider string `protobuf:"bytes,3,opt,name=cloud_provider,json=cloudProvider,proto3" json:"cloud_provider,omitempty"`
	// discovery_config_name is the name of the DiscoveryConfig that triggered
	// discovery. Empty for static configuration matchers.
	DiscoveryConfigName string `protobuf:"bytes,4,opt,name=discovery_config_name,json=discoveryConfigName,proto3" json:"discovery_config_name,omitempty"`
	// discovery_method is how the resource was discovered ("static", "guided", "iac")
	DiscoveryMethod      string   `protobuf:"bytes,5,opt,name=discovery_method,json=discoveryMethod,proto3" json:"discovery_method,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ResourceDiscoveredEvent) Reset()         { *m = ResourceDiscoveredEvent{} }
func (m *ResourceDiscoveredEvent) String() string { return proto.CompactTextString(m) }
func (*ResourceDiscoveredEvent) ProtoMessage()    {}
func (*ResourceDiscoveredEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_94cf2ca1c69fd564, []int{65}
}
func (m *ResourceDiscoveredEvent) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResourceDiscoveredEvent) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResourceDiscoveredEvent.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResourceDiscoveredEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResourceDiscoveredEvent.Merge(m, src)
}
func (m *ResourceDiscoveredEvent) XXX_Size() int {
	return m.Size()
}
func (m *ResourceDiscoveredEvent) XXX_DiscardUnknown() {
	xxx_messageInfo_ResourceDiscoveredEvent.DiscardUnknown(m)
}

var xxx_messageInfo_ResourceDiscoveredEvent proto.InternalMessageInfo

func (m *ResourceDiscoveredEvent) GetResourceType() string {
	if m != nil {
		return m.ResourceType
	}
	return ""
...
func (m *ResourceDiscoveredEvent) GetResourceName() string {
	if m != nil {
...
func (m *ResourceDiscoveredEvent) GetCloudProvider() string {
	if m != nil {
		return m.CloudProvider
	}
	return ""
...
func (m *ResourceDiscoveredEvent) GetDiscoveryConfigName() string {
	if m != nil {
...
func (m *ResourceDiscoveredEvent) GetDiscoveryMethod() string {
	if m != nil {
...
type UsageEventOneOf struct {
	...
	//	*UsageEventOneOf_ResourceDiscoveredEvent
...
type UsageEventOneOf_ResourceDiscoveredEvent struct {
	ResourceDiscoveredEvent *ResourceDiscoveredEvent `protobuf:"bytes,66,opt,name=resource_discovered_event,json=resourceDiscoveredEvent,proto3,oneof" json:"resource_discovered_event,omitempty"`
}
...
func (*UsageEventOneOf_ResourceDiscoveredEvent) isUsageEventOneOf_Event()                           {}
...
func (m *UsageEventOneOf) GetResourceDiscoveredEvent() *ResourceDiscoveredEvent {
	if x, ok := m.GetEvent().(*UsageEventOneOf_ResourceDiscoveredEvent); ok {
		return x.ResourceDiscoveredEvent
	}
	return nil
}
...
func (*UsageEventOneOf) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*UsageEventOneOf_ResourceDiscoveredEvent)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*ResourceDiscoveredEvent)(nil), "teleport.usageevents.v1.ResourceDiscoveredEvent")
...
var fileDescriptor_94cf2ca1c69fd564 = []byte{
	...
	,
}
...
func (m *ResourceDiscoveredEvent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResourceDiscoveredEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResourceDiscoveredEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.DiscoveryMethod) > 0 {
		i -= len(m.DiscoveryMethod)
		copy(dAtA[i:], m.DiscoveryMethod)
		i = encodeVarintUsageevents(dAtA, i, uint64(len(m.DiscoveryMethod)))
		i--
		dAtA[i] = 0x2a
	}
	...
	if len(m.ResourceName) > 0 {
		...
		i = encodeVarintUsageevents(dAtA, i, uint64(len(m.ResourceName)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ResourceType) > 0 {
...
func (m *UsageEventOneOf_ResourceDiscoveredEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UsageEventOneOf_ResourceDiscoveredEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ResourceDiscoveredEvent != nil {
		{
			size, err := m.ResourceDiscoveredEvent.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ResourceDiscoveredEvent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UsageEventOneOf_ResourceDiscoveredEvent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ResourceDiscoveredEvent != nil {
		l = m.ResourceDiscoveredEvent.Size()
		n += 2 + l + sovUsageevents(uint64(l))
	}
	return n
}
...
func (m *ResourceDiscoveredEvent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResourceDiscoveredEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResourceDiscoveredEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DiscoveryMethod", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DiscoveryMethod = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipUsageevents(dAtA[iNdEx:])
...
func (m *UsageEventOneOf) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 66:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResourceDiscoveredEvent", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &ResourceDiscoveredEvent{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Event = &UsageEventOneOf_ResourceDiscoveredEvent{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipUsageevents(dAtA[iNdEx:])
