...
type UnifiedResourcePreferences struct {
	...
	xxx_hidden_DefaultTab            DefaultTab             `protobuf:"varint,1,opt,name=default_tab,json=defaultTab,proto3,enum=teleport.userpreferences.v1.DefaultTab"`
	xxx_hidden_ViewMode              ViewMode               `protobuf:"varint,2,opt,name=view_mode,json=viewMode,proto3,enum=teleport.userpreferences.v1.ViewMode"`
	xxx_hidden_LabelsViewMode        LabelsViewMode         `protobuf:"varint,3,opt,name=labels_view_mode,json=labelsViewMode,proto3,enum=teleport.userpreferences.v1.LabelsViewMode"`
	xxx_hidden_AvailableResourceMode AvailableResourceMode  `protobuf:"varint,4,opt,name=available_resource_mode,json=availableResourceMode,proto3,enum=teleport.userpreferences.v1.AvailableResourceMode"`
...
func (x *UnifiedResourcePreferences) GetDefaultTab() DefaultTab {
	if x != nil {
		return x.xxx_hidden_DefaultTab
	}
...
func (x *UnifiedResourcePreferences) GetLabelsViewMode() LabelsViewMode {
	if x != nil {
		return x.xxx_hidden_LabelsViewMode
	}
...
func (x *UnifiedResourcePreferences) GetAvailableResourceMode() AvailableResourceMode {
	if x != nil {
		return x.xxx_hidden_AvailableResourceMode
	}
...
func (b0 UnifiedResourcePreferences_builder) Build() *UnifiedResourcePreferences {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_DefaultTab = b.DefaultTab
	x.xxx_hidden_ViewMode = b.ViewMode
	x.xxx_hidden_LabelsViewMode = b.LabelsViewMode
	x.xxx_hidden_AvailableResourceMode = b.AvailableResourceMode
	return m0
}
