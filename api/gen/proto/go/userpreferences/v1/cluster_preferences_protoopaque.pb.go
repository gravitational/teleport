...
type PinnedResourcesUserPreferences struct {
	...
	xxx_hidden_ResourceIds []string               `protobuf:"bytes,1,rep,name=resource_ids,json=resourceIds,proto3"`
...
type ClusterUserPreferences struct {
	state                      protoimpl.MessageState          `protogen:"opaque.v1"`
	xxx_hidden_PinnedResources *PinnedResourcesUserPreferences `protobuf:"bytes,1,opt,name=pinned_resources,json=pinnedResources,proto3"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *ClusterUserPreferences) HasPinnedResources() bool {
	...
	return x.xxx_hidden_PinnedResources != nil
}

func (x *ClusterUserPreferences) ClearPinnedResources() {
	x.xxx_hidden_PinnedResources = nil
}
...
func (b0 ClusterUserPreferences_builder) Build() *ClusterUserPreferences {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_PinnedResources = b.PinnedResources
	return m0
}
