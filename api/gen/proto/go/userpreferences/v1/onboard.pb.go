...
func file_teleport_userpreferences_v1_onboard_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_userpreferences_v1_onboard_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*MarketingParams); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_teleport_userpreferences_v1_onboard_proto_msgTypes[1].Exporter = func(v any, i int) any {
