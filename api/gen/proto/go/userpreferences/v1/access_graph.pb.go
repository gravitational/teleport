...
var file_teleport_userpreferences_v1_access_graph_proto_goTypes = []interface{}{
...
func file_teleport_userpreferences_v1_access_graph_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_teleport_userpreferences_v1_access_graph_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AccessGraphUserPreferences); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
