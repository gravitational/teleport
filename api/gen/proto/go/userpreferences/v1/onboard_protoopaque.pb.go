...
type MarketingParams struct {
	...
	xxx_hidden_Campaign string                 `protobuf:"bytes,1,opt,name=campaign,proto3"`
	xxx_hidden_Source   string                 `protobuf:"bytes,2,opt,name=source,proto3"`
	xxx_hidden_Medium   string                 `protobuf:"bytes,3,opt,name=medium,proto3"`
	xxx_hidden_Intent   string                 `protobuf:"bytes,4,opt,name=intent,proto3"`
...
func (b0 MarketingParams_builder) Build() *MarketingParams {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Campaign = b.Campaign
...
type OnboardUserPreferences struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PreferredResources []Resource             `protobuf:"varint,1,rep,packed,name=preferred_resources,json=preferredResources,proto3,enum=teleport.userpreferences.v1.Resource"`
	xxx_hidden_MarketingParams    *MarketingParams       `protobuf:"bytes,2,opt,name=marketing_params,json=marketingParams,proto3"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *OnboardUserPreferences) GetPreferredResources() []Resource {
	if x != nil {
		return x.xxx_hidden_PreferredResources
	}
	return nil
}
...
func (x *OnboardUserPreferences) HasMarketingParams() bool {
	...
	return x.xxx_hidden_MarketingParams != nil
}

func (x *OnboardUserPreferences) ClearMarketingParams() {
	x.xxx_hidden_MarketingParams = nil
}
...
func (b0 OnboardUserPreferences_builder) Build() *OnboardUserPreferences {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_PreferredResources = b.PreferredResources
	x.xxx_hidden_MarketingParams = b.MarketingParams
	return m0
}
