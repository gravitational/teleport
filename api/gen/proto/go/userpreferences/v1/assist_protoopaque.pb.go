...
type AssistUserPreferences struct {
	...
	xxx_hidden_PreferredLogins []string               `protobuf:"bytes,1,rep,name=preferred_logins,json=preferredLogins,proto3"`
	xxx_hidden_ViewMode        AssistViewMode         `protobuf:"varint,2,opt,name=view_mode,json=viewMode,proto3,enum=teleport.userpreferences.v1.AssistViewMode"`
...
func (x *AssistUserPreferences) GetPreferredLogins() []string {
	if x != nil {
		return x.xxx_hidden_PreferredLogins
	}
	return nil
}
...
func (x *AssistUserPreferences) SetPreferredLogins(v []string) {
	x.xxx_hidden_PreferredLogins = v
}
...
func (b0 AssistUserPreferences_builder) Build() *AssistUserPreferences {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_PreferredLogins = b.PreferredLogins
