...
func TestValidateUserTask(t *testing.T) {
	...
	baseEC2DiscoverTaskInstanceID := "i-123"
		...
		userTask, err := usertasks.NewDiscoverEC2UserTask(&usertasksv1.UserTaskSpec{
			...
			DiscoverEc2: &usertasksv1.DiscoverEC2{
				...
				Instances: map[string]*usertasksv1.DiscoverEC2Instance{
					baseEC2DiscoverTaskInstanceID: {
						InstanceId:      baseEC2DiscoverTaskInstanceID,
	...
	tests := []struct {
		...
		},
		{
			...
			task: func(t *testing.T) *usertasksv1.UserTask {
				ut := baseEC2DiscoverTask(t)
				origInstanceMetadata := ut.Spec.DiscoverEc2.Instances[baseEC2DiscoverTaskInstanceID]
		...
		},
		{
			...
			task: func(t *testing.T) *usertasksv1.UserTask {
				...
				ut.Spec.DiscoverEc2.Instances[baseEC2DiscoverTaskInstanceID] = origInstanceMetadata
				return ut
			},
			wantErr: require.Error,
		},
