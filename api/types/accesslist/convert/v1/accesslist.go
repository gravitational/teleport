...
func ToProto(accessList *accesslist.AccessList) *accesslistv1.AccessList {
	...
	if status := toStatusProto(&accessList.Status); status != nil {
		proto.Status = status
	}
...
func toStatusProto(status *accesslist.Status) *accesslistv1.AccessListStatus {
	...
	if status.CurrentUserAssignments != nil {
		protoStatus.CurrentUserAssignments = &accesslistv1.CurrentUserAssignments{
			OwnershipType:  status.CurrentUserAssignments.OwnershipType,
			MembershipType: status.CurrentUserAssignments.MembershipType,
		}
	}
...
func fromStatusProto(msg *accesslistv1.AccessList) *accesslist.Status {
	...
	if msg.Status.CurrentUserAssignments != nil {
		status.CurrentUserAssignments = &accesslist.CurrentUserAssignments{
			OwnershipType:  msg.Status.CurrentUserAssignments.OwnershipType,
			MembershipType: msg.Status.CurrentUserAssignments.MembershipType,
		}
	}
