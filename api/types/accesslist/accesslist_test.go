...
func TestAccessList_IsSemanticallyEqual(t *testing.T) {
	t.Parallel()
	...
	for _, test := range tests {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			require.Equal(t, test.want, test.a.IsSemanticallyEqual(test.b), "AccessList equality check failed for '%s'", test.name)
...
func TestAccessList_NormalizeSemanticallyEqualFields(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			require.Equal(t, test.want, test.b.IsSemanticallyEqual(test.a), "AccessList normalization failed for '%s'", test.name)
		})
	}
}
