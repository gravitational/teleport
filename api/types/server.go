...
func GetAzureVMID(s Server) string {
	const skipEmptyValue = true
	vmID, _ := getLabelWithFallbacks(s, skipEmptyValue, VMIDLabel, VMIDLabelInternal)
	return vmID
}
...
func GetAzureSubscriptionID(s Server) string {
	const skipEmptyValue = true
	subID, _ := getLabelWithFallbacks(s, skipEmptyValue, SubscriptionIDLabel, SubscriptionIDLabelInternal)
	return subID
}
...
func GetAzureRegion(s Server) string {
	const skipEmptyValue = true
	region, _ := getLabelWithFallbacks(s, skipEmptyValue, RegionLabel, RegionLabelInternal)
	return region
}
...
func GetAzureResourceGroup(s Server) string {
	const skipEmptyValue = true
	rg, _ := getLabelWithFallbacks(s, skipEmptyValue, ResourceGroupLabel, ResourceGroupLabelInternal)
	return rg
}
