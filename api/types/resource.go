...
type ResourcePrincipalSet struct {
	// PrincipalType is the dimension's inline constraint key ("logins",
	// "role_arns").
...
// Principal types, matching inline constraint keys.
const (
	// PrincipalTypeLogins is SSH logins on nodes.
