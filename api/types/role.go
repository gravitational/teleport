...
type Role interface {
	...
	// GetLinuxLogins gets Linux desktop logins for allow or deny condition.
	GetLinuxLogins(RoleConditionType) []string
	// SetLinuxLogins sets Linux desktop logins for allow or deny condition.
	SetLinuxLogins(RoleConditionType, []string)
...
func (r *RoleV6) GetLinuxLogins(rct RoleConditionType) []string {
	if rct == Allow {
...
func (r *RoleV6) SetLinuxLogins(rct RoleConditionType, logins []string) {
	lcopy := slices.Clone(logins)
