...
func (h *CreateHostUserMode) decode(val any) error {
	err := decodeEnumRepresentation[CreateHostUserMode](h, val, map[interface{}]CreateHostUserMode{
...
func (h *CreateDatabaseUserMode) decode(val any) error {
	err := decodeEnumRepresentation[CreateDatabaseUserMode](h, val, map[interface{}]CreateDatabaseUserMode{
