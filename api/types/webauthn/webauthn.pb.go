...
const (
	...
	ChallengeScope_CHALLENGE_SCOPE_MANAGE_DEVICES ChallengeScope = 3
	// Account recovery.
	ChallengeScope_CHALLENGE_SCOPE_RECOVERY ChallengeScope = 4
	// Used for per-session MFA and moderated session presence checks.
	ChallengeScope_CHALLENGE_SCOPE_SESSION ChallengeScope = 5
	// Headless login approval.
	ChallengeScope_CHALLENGE_SCOPE_HEADLESS ChallengeScope = 6
...
var ChallengeScope_name = map[int32]string{
	...
	3: "CHALLENGE_SCOPE_MANAGE_DEVICES",
	4: "CHALLENGE_SCOPE_RECOVERY",
	5: "CHALLENGE_SCOPE_SESSION",
	6: "CHALLENGE_SCOPE_HEADLESS",
...
type SessionData struct {
	...
	Scope ChallengeScope `protobuf:"varint,6,opt,name=scope,proto3,enum=webauthn.ChallengeScope" json:"scope,omitempty"`
	// AllowReuse indicates that this session can be used multiple times for
	// authentication, until the session expires.
	AllowReuse           bool     `protobuf:"varint,7,opt,name=allow_reuse,json=allowReuse,proto3" json:"allow_reuse,omitempty"`
...
func (m *SessionData) GetScope() ChallengeScope {
	if m != nil {
		return m.Scope
	}
...
func (m *SessionData) GetAllowReuse() bool {
	if m != nil {
		return m.AllowReuse
	}
	return false
...
func init() {
	proto.RegisterEnum("webauthn.ChallengeScope", ChallengeScope_name, ChallengeScope_value)
...
var fileDescriptor_0d490a6db28e8798 = []byte{
	...
	,
}
...
func (m *SessionData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Scope != 0 {
		i = encodeVarintWebauthn(dAtA, i, uint64(m.Scope))
		i--
		dAtA[i] = 0x30
	}
...
func (m *SessionData) Size() (n int) {
	...
	if m.Scope != 0 {
		n += 1 + sovWebauthn(uint64(m.Scope))
	}
	if m.AllowReuse {
		n += 2
	}
