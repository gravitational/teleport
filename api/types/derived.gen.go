...
// deriveTeleportEqualAppServer returns whether this and that are equal.
func deriveTeleportEqualAppServer(this, that *AppServerV3) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			this.Kind == that.Kind &&
			this.SubKind == that.SubKind &&
...
func deriveTeleportEqual_(this, that *AppServerSpecV3) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			...
			deriveTeleportEqual_31(this.ComponentFeatures, that.ComponentFeatures)
}
...
func deriveTeleportEqual_13(this, that *DatabaseSpecV3) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			...
			deriveTeleportEqual_32(&this.TLS, &that.TLS) &&
			deriveTeleportEqual_33(&this.AD, &that.AD) &&
			deriveTeleportEqual_34(&this.MySQL, &that.MySQL) &&
			deriveTeleportEqual_35(this.AdminUser, that.AdminUser) &&
			deriveTeleportEqual_36(&this.MongoAtlas, &that.MongoAtlas) &&
			deriveTeleportEqual_37(&this.Oracle, &that.Oracle)
}
...
func deriveTeleportEqual_14(this, that *DynamicWindowsDesktopSpecV1) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			...
			deriveTeleportEqual_38(this.ScreenSize, that.ScreenSize)
}
...
func deriveTeleportEqual_17(this, that *KubernetesClusterDiscoveryStatus) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			deriveTeleportEqual_39(this.Aws, that.Aws)
}
...
func deriveTeleportEqual_31(this, that *componentfeaturesv1.ComponentFeatures) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			deriveTeleportEqual_47(this.Features, that.Features)
}

// deriveTeleportEqual_32 returns whether this and that are equal.
func deriveTeleportEqual_32(this, that *DatabaseTLS) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			this.Mode == that.Mode &&
			this.CACert == that.CACert &&
...
func deriveTeleportEqual_33(this, that *AD) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
...
func deriveTeleportEqual_34(this, that *MySQLOptions) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
...
func deriveTeleportEqual_35(this, that *DatabaseAdminUser) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			this.Name == that.Name &&
...
func deriveTeleportEqual_36(this, that *MongoAtlas) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			this.Name == that.Name
}
...
func deriveTeleportEqual_37(this, that *OracleOptions) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
...
func deriveTeleportEqual_38(this, that *Resolution) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
...
func deriveTeleportEqual_39(this, that *KubernetesClusterAWSStatus) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			this.SetupAccessForArn == that.SetupAccessForArn &&
			this.Integration == that.Integration &&
			deriveTeleportEqual_48(this.DiscoveryAssumedRole, that.DiscoveryAssumedRole)
}
...
func deriveTeleportEqual_47(this, that []componentfeaturesv1.ComponentFeatureID) bool {
	if this == nil || that == nil {
		return this == nil && that == nil
	}
	if len(this) != len(that) {
...
func deriveTeleportEqual_48(this, that *AssumeRole) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
