...
func deriveTeleportEqual(this, that *AppSpecV3) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			...
			deriveTeleportEqual_22(this.IdentityCenter, that.IdentityCenter)
}
...
func deriveTeleportEqual_22(this, that *AppIdentityCenter) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			this.AccountID == that.AccountID &&
			deriveTeleportEqual_34(this.PermissionSets, that.PermissionSets)
}
...
func deriveTeleportEqual_30(this, that *Rotation) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			...
			deriveTeleportEqual_35(&this.Schedule, &that.Schedule)
}
...
func deriveTeleportEqual_34(this, that []*IdentityCenterPermissionSet) bool {
	if this == nil || that == nil {
		return this == nil && that == nil
	}
	if len(this) != len(that) {
...
func deriveTeleportEqual_35(this, that *RotationSchedule) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
...
func deriveTeleportEqual_38(this, that *IdentityCenterPermissionSet) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			this.ARN == that.ARN &&
			this.Name == that.Name &&
			this.RequireRequest == that.RequireRequest
}
