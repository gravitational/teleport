...
type Application interface {
	...
	// GetAlwaysUseProxyPublicAddr will return true if a client should rebuild this app's public addr based on the proxy's public addr.
	GetAlwaysUseProxyPublicAddr() bool
...
func (a *AppV3) GetAlwaysUseProxyPublicAddr() bool {
	return a.Spec.AlwaysUseProxyPublicAddr
}
