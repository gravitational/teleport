...
const (
	...
	LegacyClusterTokenType TeleportRole = "Trustedcluster"
)
...
// Include returns 'true' if a given list of roles includes a given role
...
// StringSlice returns roles as string slice
