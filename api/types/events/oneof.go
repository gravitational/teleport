...
func ToOneOf(in AuditEvent) (*OneOf, error) {
	...
	case *CloudClusterCreate:
		out.Event = &OneOf_CloudClusterCreate{CloudClusterCreate: e}
	case *CloudClusterUpdate:
		out.Event = &OneOf_CloudClusterUpdate{CloudClusterUpdate: e}
	case *CloudClusterDelete:
		out.Event = &OneOf_CloudClusterDelete{CloudClusterDelete: e}
	default:
