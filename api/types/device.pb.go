...
type DeviceCredential struct {
	...
	AttestationType      string   `protobuf:"bytes,3,opt,name=attestation_type,json=attestationType,proto3" json:"attestation_type"`
	TpmSerial            string   `protobuf:"bytes,4,opt,name=tpm_serial,json=tpmSerial,proto3" json:"tpm_serial"`
	TpmAttestationKey    []byte   `protobuf:"bytes,5,opt,name=tpm_attestation_key,json=tpmAttestationKey,proto3" json:"tpm_attestation_key"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_aceaef1b58496e7d = []byte{
	...
	,
}
...
func (m *DeviceCredential) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TpmAttestationKey) > 0 {
		i -= len(m.TpmAttestationKey)
		copy(dAtA[i:], m.TpmAttestationKey)
		i = encodeVarintDevice(dAtA, i, uint64(len(m.TpmAttestationKey)))
		i--
		dAtA[i] = 0x2a
	}
	...
	if len(m.AttestationType) > 0 {
		...
		i = encodeVarintDevice(dAtA, i, uint64(len(m.AttestationType)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *DeviceCredential) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TpmAttestationKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TpmAttestationKey = append(m.TpmAttestationKey[:0], dAtA[iNdEx:postIndex]...)
			if m.TpmAttestationKey == nil {
				m.TpmAttestationKey = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
