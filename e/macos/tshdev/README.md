...
cp tsh e/macos/tshdev/tsh.app/Contents/MacOS/         # copy binary to .app
e/macos/tshdev/sign.sh e/macos/tshdev/tsh.app         # sign .app
e/macos/tshdev/tsh.app/Contents/MacOS/tsh touchid ls  # use tsh
```
...
```shell
go build -tags=touchid ./tool/tsh  # at Teleport root
e/macos/tshdev/sign.sh tsh         # sign tsh binary
