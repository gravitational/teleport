...
func InitOkta(process *service.TeleportProcess) error {
	...
	process.RegisterCriticalFunc(oktaInit, func() error {
		return initOktaService(process.ExitContext(), process, process.Config.Okta.APIEndpoint, token, process.GetID())
	})
	return nil
}
...
func InitOktaPlugin(ctx context.Context, process *service.TeleportProcess, apiEndpoint, token string, pluginName string) string {
	...
	process.RegisterFunc(oktaInit, func() error {
		return initOktaService(ctx, process, apiEndpoint, token, pluginLogComponent(pluginName), components...)
	})
...
func initOktaService(ctx context.Context, process *service.TeleportProcess, apiEndpoint, token string, logComponent string, components ...string) error {
