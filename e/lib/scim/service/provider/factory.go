...
// CreatePluginHandler creates a resource handler for the given plugin.
// The handler is not wrapped with any middleware - that is the responsibility of the caller.
func CreatePluginHandler(plugin types.Plugin, config common.Config, resourceType string) (common.ResourceHandler, error) {
