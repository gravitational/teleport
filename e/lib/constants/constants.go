...
const (
	...
	LicenseWarningMessageFormat = "Your Teleport Enterprise Edition license will expire in %v days on one or more of your auth servers. Please reach out to mailto:licenses@goteleport.com to obtain a new license. Inaction may lead to unplanned outage or degraded performance and support."

	// LicenseExpiredMessageFormat is the format for the alert message generated when a license has expired.
	LicenseExpiredMessageFormat = "Your Teleport Enterprise Edition license has expired on one or more of your auth servers. Please reach out to licenses@goteleport.com to obtain a new license. Inaction may lead to unplanned outage or degraded performance and support."
)
