...
func requireFeatures(t *testing.T, backend backend.Backend, ctx context.Context, want modules.Features) {
	t.Helper()
...
func TestRun_UpdateCloudFeatures(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		requireFeatures(t, backend, ctx, modules.Features{
			...
			CloudAnonymizationKey:   []byte("anonymization-key-1"),
			Entitlements: getPopulatedEntitlements(map[entitlements.EntitlementKind]modules.EntitlementInfo{
