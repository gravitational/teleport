...
// EntraID will create Entra ID services based on the plugin specification.
func EntraID(ctx context.Context, plugin *types.PluginV1, deps Dependencies) (Delegate, error) {
