...
setver: validate-semver helm-version tsh-version
	@awk -v "verstr=$(VERSION)" 'BEGIN {split(verstr, meta, "+"); split(meta[1], pre, "-"); split(pre[1], ver, "."); printf "// Code generated by \"make version\". DO NOT EDIT.\n\npackage api\n\nconst Version = \"%s\"\n\nconst VersionMajor = %d\nconst VersionMinor = %d\nconst VersionPatch = %d\nconst VersionPreRelease = \"%s\"\nconst VersionMetadata = \"%s\"\n", verstr, ver[1], ver[2], ver[3], pre[2], meta[2]}' | gofmt > ./api/version.go
