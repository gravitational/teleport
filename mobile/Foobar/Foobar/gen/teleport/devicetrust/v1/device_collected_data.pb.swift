...
extension Teleport_Devicetrust_V1_DeviceCollectedData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}collect_time\0\u{3}record_time\0\u{3}os_type\0\u{3}serial_number\0\u{3}model_identifier\0\u{3}os_version\0\u{3}os_build\0\u{3}os_username\0\u{3}jamf_binary_version\0\u{3}macos_enrollment_profiles\0\u{3}reported_asset_tag\0\u{3}system_serial_number\0\u{3}base_board_serial_number\0\u{3}tpm_platform_attestation\0\u{3}os_id\0")
