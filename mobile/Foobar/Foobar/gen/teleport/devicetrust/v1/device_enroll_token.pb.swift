...
public struct Teleport_Devicetrust_V1_DeviceEnrollToken: Sendable {
...
extension Teleport_Devicetrust_V1_DeviceEnrollToken: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DeviceEnrollToken"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}token\0\u{3}expire_time\0")
  ...
  public static func ==(lhs: Teleport_Devicetrust_V1_DeviceEnrollToken, rhs: Teleport_Devicetrust_V1_DeviceEnrollToken) -> Bool {
