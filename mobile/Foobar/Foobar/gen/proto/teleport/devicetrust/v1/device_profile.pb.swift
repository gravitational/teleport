...
public struct Teleport_Devicetrust_V1_DeviceProfile: Sendable {
  ...
  public var modelIdentifier: String = String()
  ...
  /// Example: "22F770820d".
  public var osBuildSupplemental: String = String()
...
extension Teleport_Devicetrust_V1_DeviceProfile: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}update_time\0\u{3}model_identifier\0\u{3}os_version\0\u{3}os_build\0\u{3}os_usernames\0\u{3}jamf_binary_version\0\u{3}external_id\0\u{3}os_build_supplemental\0\u{3}os_id\0")
  ...
  public static func ==(lhs: Teleport_Devicetrust_V1_DeviceProfile, rhs: Teleport_Devicetrust_V1_DeviceProfile) -> Bool {
