...
public struct Teleport_Devicetrust_V1_DeviceConfirmationToken: Sendable {
...
extension Teleport_Devicetrust_V1_DeviceConfirmationToken: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DeviceConfirmationToken"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}token\0")
  ...
  public static func ==(lhs: Teleport_Devicetrust_V1_DeviceConfirmationToken, rhs: Teleport_Devicetrust_V1_DeviceConfirmationToken) -> Bool {
