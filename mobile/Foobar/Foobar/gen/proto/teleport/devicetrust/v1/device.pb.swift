...
public struct Teleport_Devicetrust_V1_DeviceCredential: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Teleport_Devicetrust_V1_DeviceAttestationType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0DEVICE_ATTESTATION_TYPE_UNSPECIFIED\0\u{1}DEVICE_ATTESTATION_TYPE_TPM_EKPUB\0\u{1}DEVICE_ATTESTATION_TYPE_TPM_EKCERT\0\u{1}DEVICE_ATTESTATION_TYPE_TPM_EKCERT_TRUSTED\0")
}

extension Teleport_Devicetrust_V1_DeviceEnrollStatus: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0DEVICE_ENROLL_STATUS_UNSPECIFIED\0\u{1}DEVICE_ENROLL_STATUS_NOT_ENROLLED\0\u{1}DEVICE_ENROLL_STATUS_ENROLLED\0")
}
...
extension Teleport_Devicetrust_V1_Device: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}api_version\0\u{1}id\0\u{3}os_type\0\u{3}asset_tag\0\u{3}create_time\0\u{3}update_time\0\u{3}enroll_token\0\u{3}enroll_status\0\u{1}credential\0\u{3}collected_data\0\u{1}source\0\u{1}profile\0\u{1}owner\0")
...
extension Teleport_Devicetrust_V1_DeviceCredential: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{3}public_key_der\0\u{3}device_attestation_type\0\u{3}tpm_ekcert_serial\0\u{3}tpm_ak_public\0")
