...
extension Teleport_Devicetrust_V1_AccountUsageType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0ACCOUNT_USAGE_TYPE_UNSPECIFIED\0\u{1}ACCOUNT_USAGE_TYPE_UNLIMITED\0\u{1}ACCOUNT_USAGE_TYPE_USAGE_BASED\0")
}
...
extension Teleport_Devicetrust_V1_DevicesUsage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{b}account_usage_type\0\u{b}devices_usage_limit\0\u{b}devices_in_use\0\u{c}\u{1}\u{1}\u{c}\u{2}\u{1}\u{c}\u{3}\u{1}")
