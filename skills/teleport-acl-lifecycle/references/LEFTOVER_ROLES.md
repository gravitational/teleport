...
A weak confirmation like "Delete these leftover roles? (They may still be
assigned to users.)" is not acceptable: it drops the verify-first requirement and
batches roles the user has not individually verified.
