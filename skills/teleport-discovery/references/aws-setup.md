...
- The AWS credentials running Terraform need permission to create an IAM OIDC provider, an IAM role, and an IAM policy in the target account.
...
project already declares the `module "aws_discovery"` block, read it, pre-populate the gathered
