...
# boring-sys builds and runs a Go program which fails for odd reasons if
# CGO_ENABLED is on. It also needs to know the cross-compiler sysroot
# to properly cross-compile.
