...
teleport-hot-reload:
	CompileDaemon --graceful-kill=true --exclude-dir=".git" --exclude-dir="node_modules" --exclude-dir="target" --build="make $(BUILDDIR)/teleport" --command="$(BUILDDIR)/teleport $(TELEPORT_ARGS)"
