...
func (m *ChaCha20Poly1305KeyFormat) Reset()         { *m = ChaCha20Poly1305KeyFormat{} }
func (m *ChaCha20Poly1305KeyFormat) String() string { return proto.CompactTextString(m) }
...
func (m *ChaCha20Poly1305KeyFormat) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ChaCha20Poly1305KeyFormat.Unmarshal(m, b)
}
func (m *ChaCha20Poly1305KeyFormat) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ChaCha20Poly1305KeyFormat.Marshal(b, m, deterministic)
}
func (m *ChaCha20Poly1305KeyFormat) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChaCha20Poly1305KeyFormat.Merge(m, src)
}
func (m *ChaCha20Poly1305KeyFormat) XXX_Size() int {
	return xxx_messageInfo_ChaCha20Poly1305KeyFormat.Size(m)
}
func (m *ChaCha20Poly1305KeyFormat) XXX_DiscardUnknown() {
	xxx_messageInfo_ChaCha20Poly1305KeyFormat.DiscardUnknown(m)
}

var xxx_messageInfo_ChaCha20Poly1305KeyFormat proto.InternalMessageInfo
...
func (*ChaCha20Poly1305Key) Descriptor() ([]byte, []int) {
	return fileDescriptor_ddbcaacfeec7ca2e, []int{1}
}
...
func init() {
	proto.RegisterType((*ChaCha20Poly1305KeyFormat)(nil), "google.crypto.tink.ChaCha20Poly1305KeyFormat")
...
var fileDescriptor_ddbcaacfeec7ca2e = []byte{
	...
	,
}
