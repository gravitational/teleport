...
func (c *DesktopCommand) ListDesktop(ctx context.Context, clt *authclient.Client) error {
	// The unified resource API is used here because it both supports pagination and
	// is backward compatible. Consider changing this to use ListWindowsDesktops in the future.
