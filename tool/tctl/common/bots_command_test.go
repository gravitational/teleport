...
// individual element.
func unmarshalProtoResourceArray[T services.ProtoResourcePtr[U], U any](data []byte, opts ...services.MarshalOption) ([]T, error) {
	...
	for _, msg := range msgs {
		resource, err := services.UnmarshalProtoResource[T](msg, opts...)
		if err != nil {
			return nil, trace.Wrap(err)
		}
