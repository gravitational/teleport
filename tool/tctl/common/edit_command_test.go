...
func TestEditResources(t *testing.T) {
	...
	tests := []struct {
		kind string
		edit func(t *testing.T, fc *config.FileConfig, clt *client.Client)
	}{
		{
...
func testEditGithubConnector(t *testing.T, fc *config.FileConfig, clt *client.Client) {
...
func testEditRole(t *testing.T, fc *config.FileConfig, clt *client.Client) {
	ctx := context.Background()
...
func testEditUser(t *testing.T, fc *config.FileConfig, clt *client.Client) {
	ctx := context.Background()
...
func testEditClusterNetworkingConfig(t *testing.T, fc *config.FileConfig, clt *client.Client) {
	ctx := context.Background()
...
func testEditAuthPreference(t *testing.T, fc *config.FileConfig, clt *client.Client) {
	ctx := context.Background()
...
func testEditSessionRecordingConfig(t *testing.T, fc *config.FileConfig, clt *client.Client) {
	ctx := context.Background()
...
func testEditOIDCConnector(t *testing.T, fc *config.FileConfig, clt *client.Client) {
	ctx := context.Background()
...
func testEditSAMLConnector(t *testing.T, fc *config.FileConfig, clt *client.Client) {
	ctx := context.Background()
