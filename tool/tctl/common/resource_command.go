...
type ResourceCreateHandler func(context.Context, authclient.ClientI, services.UnknownResource) error
...
func (rc *ResourceCommand) Get(ctx context.Context, client authclient.ClientI) error {
	if rc.refs.IsAll() {
...
func (rc *ResourceCommand) GetMany(ctx context.Context, client authclient.ClientI) error {
...
func (rc *ResourceCommand) GetAll(ctx context.Context, client authclient.ClientI) error {
	rc.withSecrets = true
...
func (rc *ResourceCommand) Create(ctx context.Context, client authclient.ClientI) (err error) {
...
func (rc *ResourceCommand) createTrustedCluster(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createCertAuthority(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createGithubConnector(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateGithubConnector(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	connector, err := services.UnmarshalGithubConnector(raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createRole(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateRole(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	role, err := services.UnmarshalRole(raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createUser(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createBot(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createDatabaseObjectImportRule(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createDatabaseObject(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateUser(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	user, err := services.UnmarshalUser(raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createAuthPreference(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateAuthPreference(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	newAuthPref, err := services.UnmarshalAuthPreference(raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createClusterNetworkingConfig(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateClusterNetworkingConfig(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	newNetConfig, err := services.UnmarshalClusterNetworkingConfig(raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createClusterMaintenanceConfig(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createSessionRecordingConfig(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateSessionRecordingConfig(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	newRecConfig, err := services.UnmarshalSessionRecordingConfig(raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createExternalAuditStorage(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createLock(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createNetworkRestrictions(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createWindowsDesktop(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createDynamicWindowsDesktop(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateDynamicWindowsDesktop(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	wd, err := services.UnmarshalDynamicWindowsDesktop(raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createAppServer(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createApp(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createKubeCluster(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createCrownJewel(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createUserTask(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createSPIFFEFederation(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createWorkloadIdentity(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateCrownJewel(ctx context.Context, client authclient.ClientI, resource services.UnknownResource) error {
...
func (rc *ResourceCommand) updateUserTask(ctx context.Context, client authclient.ClientI, resource services.UnknownResource) error {
...
func (rc *ResourceCommand) createDatabase(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createToken(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createInstaller(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createUIConfig(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createNode(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createOIDCConnector(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateOIDCConnector(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createSAMLConnector(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateSAMLConnector(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	// Create services.SAMLConnector from raw YAML to extract the connector name.
	conn, err := services.UnmarshalSAMLConnector(raw.Raw)
	if err != nil {
		return trace.Wrap(err)
...
func (rc *ResourceCommand) createLoginRule(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createSAMLIdPServiceProvider(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createDevice(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createOktaImportRule(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createIntegration(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createDiscoveryConfig(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createAccessList(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createServerInfo(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createStaticHostUser(ctx context.Context, client authclient.ClientI, resource services.UnknownResource) error {
...
func (rc *ResourceCommand) updateStaticHostUser(ctx context.Context, client authclient.ClientI, resource services.UnknownResource) error {
	hostUser, err := services.UnmarshalProtoResource[*userprovisioningpb.StaticHostUser](resource.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) Delete(ctx context.Context, client authclient.ClientI) (err error) {
...
func resetAuthPreference(ctx context.Context, client authclient.ClientI) error {
	storedAuthPref, err := client.GetAuthPreference(ctx)
	if err != nil {
		return trace.Wrap(err)
	}
...
func resetClusterNetworkingConfig(ctx context.Context, client authclient.ClientI) error {
	storedNetConfig, err := client.GetClusterNetworkingConfig(ctx)
	if err != nil {
		return trace.Wrap(err)
	}
...
func resetSessionRecordingConfig(ctx context.Context, client authclient.ClientI) error {
	storedRecConfig, err := client.GetSessionRecordingConfig(ctx)
	if err != nil {
		return trace.Wrap(err)
	}
...
func resetNetworkRestrictions(ctx context.Context, client authclient.ClientI) error {
	return trace.Wrap(client.DeleteNetworkRestrictions(ctx))
}

// UpdateFields updates select resource fields: expiry and labels
func (rc *ResourceCommand) UpdateFields(ctx context.Context, clt authclient.ClientI) error {
...
func (rc *ResourceCommand) getCollection(ctx context.Context, client authclient.ClientI) (ResourceCollection, error) {
	if rc.ref.Kind == "" {
...
func getSAMLConnectors(ctx context.Context, client authclient.ClientI, name string, withSecrets bool) ([]types.SAMLConnector, error) {
	if name == "" {
...
func getOIDCConnectors(ctx context.Context, client authclient.ClientI, name string, withSecrets bool) ([]types.OIDCConnector, error) {
	if name == "" {
...
func getGithubConnectors(ctx context.Context, client authclient.ClientI, name string, withSecrets bool) ([]types.GithubConnector, error) {
	if name == "" {
...
func (rc *ResourceCommand) createAuditQuery(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createSecurityReport(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createAccessMonitoringRule(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateAccessMonitoringRule(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	in, err := services.UnmarshalAccessMonitoringRule(raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createVnetConfig(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateVnetConfig(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	vnetConfig, err := services.UnmarshalProtoResource[*vnet.VnetConfig](raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) updatePlugin(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) createPlugin(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) upsertAccessGraphSettings(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateAccessGraphSettings(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	settings, err := clusterconfigrec.UnmarshalAccessGraphSettings(raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createAutoUpdateConfig(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateAutoUpdateConfig(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	config, err := services.UnmarshalProtoResource[*autoupdatev1pb.AutoUpdateConfig](raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createAutoUpdateVersion(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateAutoUpdateVersion(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	version, err := services.UnmarshalProtoResource[*autoupdatev1pb.AutoUpdateVersion](raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createAutoUpdateAgentRollout(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateAutoUpdateAgentRollout(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	version, err := services.UnmarshalProtoResource[*autoupdatev1pb.AutoUpdateAgentRollout](raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createGitServer(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateGitServer(ctx context.Context, client authclient.ClientI, raw services.UnknownResource) error {
	server, err := services.UnmarshalGitServer(raw.Raw)
	if err != nil {
		return trace.Wrap(err)
	}
