...
func Handlers() map[string]Handler {
	...
	return map[string]Handler{
		...
		types.KindCrownJewel:                         crownJewelHandler(),
		...
		types.KindDatabaseServer:                     databaseServerHandler(),
		types.KindDatabaseService:                    databaseServiceHandler(),
		types.KindDevice:                             deviceHandler(),
		...
		types.KindHealthCheckConfig:                  healthCheckConfigHandler(),
		...
		types.KindNetworkRestrictions:                networkRestrictionsHandler(),
		types.KindNode:                               serverHandler(),
		types.KindOIDCConnector:                      oidcConnectorHandler(),
		types.KindOktaAssignment:                     oktaAssignmentHandler(),
		types.KindOktaImportRule:                     oktaImportRuleHandler(),
		types.KindPlugin:                             pluginHandler(),
		types.KindProxy:                              proxyHandler(),
		types.KindRelayServer:                        relayServerHandler(),
		types.KindRemoteCluster:                      remoteClusterHandler(),
		types.KindRetrievalModel:                     retrievalModelHandler(),
		types.KindReverseTunnel:                      reverseTunnelHandler(),
		...
		types.KindSecurityReport:                     securityReportHandler(),
		types.KindSemaphore:                          semaphoreHandler(),
		...
		types.KindUserGroup:                          userGroupHandler(),
