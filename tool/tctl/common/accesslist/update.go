...
func (c *Command) updateAccessListWithPreset(ctx context.Context, client *authclient.Client, al *accesslist.AccessList, newMembers []*accesslist.AccessListMember, membersChanged bool) (*accesslist.AccessList, []string, []string, error) {
	...
	return finalAccessList, roleNames, resp.GetRolesToBeDeleted(), nil
}
