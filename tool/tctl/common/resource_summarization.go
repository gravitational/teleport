...
func (rc *ResourceCommand) createSummarizationInferenceSecret(
	...
	if _, err := clt.SummarizerServiceClient().CreateSummarizationInferenceSecret(ctx, req); err != nil {
		return trace.Wrap(err)
	}
...
func (rc *ResourceCommand) createSummarizationInferencePolicy(
	...
	if _, err := clt.SummarizerServiceClient().CreateSummarizationInferencePolicy(ctx, req); err != nil {
		return trace.Wrap(err)
	}
