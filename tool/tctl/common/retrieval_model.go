...
func (rc *ResourceCommand) createRetrievalModel(ctx context.Context, clt *authclient.Client, raw services.UnknownResource) error {
...
func (rc *ResourceCommand) updateRetrievalModel(ctx context.Context, clt *authclient.Client, raw services.UnknownResource) error {
	model, err := services.UnmarshalProtoResource[*summarizerv1.RetrievalModel](
		raw.Raw, services.DisallowUnknown())
	if err != nil {
		return trace.Wrap(err)
...
func (rc *ResourceCommand) deleteRetrievalModel(ctx context.Context, clt *authclient.Client) error {
