...
func githubTest(c authclient.ClientI, connector types.GithubConnector) (*AuthRequestInfo, error) {
...
func handleGithubConnector(c authclient.ClientI, connBytes []byte) (*AuthRequestInfo, error) {
