...
func (cmd *SSOTestCommand) runSSOLoginFlow(ctx context.Context, protocol string, c *authclient.Client, ssoFn client.SSOLoginConsoleRequestFn) (*authclient.SSHLoginResponse, error) {
