...
{{if .canUseTCP }}or use a direct connection to {{.address}} without a username and password with other GUI/CLI clients.
{{else }}or using following Oracle JDBC connection string in order to connect with other GUI/CLI clients:
  {{.jdbcConnectionString}}
