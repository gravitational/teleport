...
func Run(ctx context.Context, args []string, opts ...CliOption) error {
	...
	gitLogin := git.Command("login", "Opens a browser and retrieves your login from GitHub.")
	gitLogin.Flag("github-org", "GitHub organization.").Required().StringVar(&cf.GitHubOrg)
