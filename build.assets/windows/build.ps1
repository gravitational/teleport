...
function Build-Tsh {
    ...
    $CommandDuration = Measure-Block {
        ...
        # It is important to pass -Update here
        Compress-Archive -Update -Path "$PackageDirectory\*" -DestinationPath "$ArtifactDirectory\teleport-v$TeleportVersion-windows-amd64-bin.zip"
    }
...
function Build-Artifacts {
    ...
    Package-Artifacts `
        ...
        -SignedTctlBinaryPath "$SignedTtclBinaryPath"
