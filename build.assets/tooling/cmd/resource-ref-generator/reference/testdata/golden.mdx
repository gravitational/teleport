...
|Field Name|Description|Type|
|---|---|---|
|period|A time between command runs|See example YAML.|
...
|expires|A global expiry time header can be set on any resource in the system.|See example YAML.|
...
|started|Set to the time when rotation has been started in case if the state of the rotation is "in_progress".|See example YAML.|
|grace_period|A period during which old and new CA are valid for checking purposes, but only new CA is issuing certificates.|See example YAML.|
|last_rotated|Specifies the last time of the completed rotation.|See example YAML.|
...
mode: "string"
current_id: "string"
started: "2023-01-31T00:00:00-00:00"
grace_period: 12h
last_rotated: "2023-01-31T00:00:00-00:00"
schedule: # [...]
...
|Field Name|Description|Type|
|---|---|---|
|update_clients|Specifies time to switch to the "Update clients" phase|See example YAML.|
|update_servers|Specifies time to switch to the "Update servers" phase.|See example YAML.|
|standby|Specifies time to switch to the "Standby" phase.|See example YAML.|
...
```yaml
update_clients: "2023-01-31T00:00:00-00:00"
update_servers: "2023-01-31T00:00:00-00:00"
standby: "2023-01-31T00:00:00-00:00"
