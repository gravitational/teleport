...
For partial updates, prefer `Patch`.
...
The revision of the fetched resource is used for the `ConditionalUpdate`. The
Patch method should reject mutations that change the revision of the fetched
resource. If a consumer wishes to provide the revision, they should instead
