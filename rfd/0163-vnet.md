...
quickly stop VNet, similar to how they can disconnect existing database, SSH and Kube connections.

Clicking on the VNet item opens a dedicated VNet tab. From there, the user can see which DNS zones
are currently being proxied and the status of recent connections.

(TBD, for now see [the comment about capturing errors related to specific
apps](https://github.com/gravitational/teleport/pull/37834#discussion_r1488830437).)
