...
zone with a new singleton `vnet` Teleport configuration resource:
...
Cluster-wide VNet configuration will be exposed through a new singleton `vnet` resource
...
We will add new audit events for Create/Update/Delete of the `vnet` cluster configuration resources.
