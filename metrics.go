...
const (
	...
	MetricProxyPeerClientRequest = "proxy_peer_client_request"

	// MetricProxyPeerClientRequestHandled counts the number of handled grpc client requests.
	MetricProxyPeerClientRequestHandled = "proxy_peer_client_request_handled"

	// MetricProxyPeerClientStreamReceived counts the number of received stream messages on the client.
	MetricProxyPeerClientStreamReceived = "proxy_peer_client_stream_received"

	// MetricProxyPeerClientStreamSent counts the number of sent stream messages on the client.
	MetricProxyPeerClientStreamSent = "proxy_peer_client_stream_sent"

	// MetricProxyPeerClientRequestLatency measures the latency of grpc client requests.
	MetricProxyPeerClientRequestLatency = "proxy_peer_client_request_latency"

	// MetricProxyPeerClientStreamReceivedLatency measures the latency of received stream messages on the client.
	MetricProxyPeerClientStreamReceivedLatency = "proxy_peer_client_stream_received_latency"

	// MetricProxyPeerClientStreamSentLatency measures the latency of sent stream messages on the client.
	MetricProxyPeerClientStreamSentLatency = "proxy_peer_client_stream_sent_latency"

	// MetricProxyPeerServerRequest counts the number of grpc server requests.
	MetricProxyPeerServerRequest = "proxy_peer_server_request"

	// MetricProxyPeerServerRequestHandled counts the number of handled grpc server requests.
	MetricProxyPeerServerRequestHandled = "proxy_peer_server_request_handled"

	// MetricProxyPeerServerStreamReceived counts the number of received stream messages on the server.
	MetricProxyPeerServerStreamReceived = "proxy_peer_server_stream_received"

	// MetricProxyPeerServerStreamSent counts the number of sent stream messages on the server.
	MetricProxyPeerServerStreamSent = "proxy_peer_server_stream_sent"
