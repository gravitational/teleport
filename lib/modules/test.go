...
func (m *TestModules) AttestHardwareKey(ctx context.Context, obj any, as *hardwarekey.AttestationStatement, pk crypto.PublicKey, d time.Duration) (*keys.AttestationData, error) {
