...
goog.exportSymbol('proto.teleport.terminal.v1.WebauthnCredentialInfo', null, global);
/**
 ...
 * @constructor
 */
proto.teleport.terminal.v1.WebauthnCredentialInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.teleport.terminal.v1.WebauthnCredentialInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.terminal.v1.WebauthnCredentialInfo.displayName = 'proto.teleport.terminal.v1.WebauthnCredentialInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.teleport.terminal.v1.WebauthnCredentialInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.terminal.v1.WebauthnCredentialInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.terminal.v1.WebauthnCredentialInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.WebauthnCredentialInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.teleport.terminal.v1.WebauthnCredentialInfo}
 */
proto.teleport.terminal.v1.WebauthnCredentialInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.terminal.v1.WebauthnCredentialInfo;
  return proto.teleport.terminal.v1.WebauthnCredentialInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.terminal.v1.WebauthnCredentialInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.terminal.v1.WebauthnCredentialInfo}
 */
proto.teleport.terminal.v1.WebauthnCredentialInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.teleport.terminal.v1.WebauthnCredentialInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.terminal.v1.WebauthnCredentialInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.terminal.v1.WebauthnCredentialInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.WebauthnCredentialInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.teleport.terminal.v1.WebauthnCredentialInfo.prototype.getUsername = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.teleport.terminal.v1.WebauthnCredentialInfo} returns this
 */
proto.teleport.terminal.v1.WebauthnCredentialInfo.prototype.setUsername = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
...
proto.teleport.terminal.v1.LoginPasswordlessResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.teleport.terminal.v1.WebauthnCredentialInfo.toObject, includeInstance)
  };
...
proto.teleport.terminal.v1.LoginPasswordlessResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.teleport.terminal.v1.WebauthnCredentialInfo;
      reader.readMessage(value,proto.teleport.terminal.v1.WebauthnCredentialInfo.deserializeBinaryFromReader);
...
proto.teleport.terminal.v1.LoginPasswordlessResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.teleport.terminal.v1.WebauthnCredentialInfo.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated WebauthnCredentialInfo credentials = 2;
 * @return {!Array<!proto.teleport.terminal.v1.WebauthnCredentialInfo>}
 */
proto.teleport.terminal.v1.LoginPasswordlessResponse.prototype.getCredentialsList = function() {
  return /** @type{!Array<!proto.teleport.terminal.v1.WebauthnCredentialInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.teleport.terminal.v1.WebauthnCredentialInfo, 2));
};


/**
 * @param {!Array<!proto.teleport.terminal.v1.WebauthnCredentialInfo>} value
 * @return {!proto.teleport.terminal.v1.LoginPasswordlessResponse} returns this
*/
...
/**
 * @param {!proto.teleport.terminal.v1.WebauthnCredentialInfo=} opt_value
 * @param {number=} opt_index
 * @return {!proto.teleport.terminal.v1.WebauthnCredentialInfo}
 */
proto.teleport.terminal.v1.LoginPasswordlessResponse.prototype.addCredentials = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.teleport.terminal.v1.WebauthnCredentialInfo, opt_index);
};
