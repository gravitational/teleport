...
goog.exportSymbol('proto.teleport.terminal.v1.ClusterEvent', null, global);
goog.exportSymbol('proto.teleport.terminal.v1.ClusterEvent.EventCase', null, global);
goog.exportSymbol('proto.teleport.terminal.v1.ClusterEventsRequest', null, global);
...
goog.exportSymbol('proto.teleport.terminal.v1.NewGatewayConnectionAccepted', null, global);
 ...
 * @constructor
 */
proto.teleport.terminal.v1.ClusterEventsRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.teleport.terminal.v1.ClusterEventsRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.terminal.v1.ClusterEventsRequest.displayName = 'proto.teleport.terminal.v1.ClusterEventsRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.teleport.terminal.v1.ClusterEvent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.teleport.terminal.v1.ClusterEvent.oneofGroups_);
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.teleport.terminal.v1.ClusterEvent.displayName = 'proto.teleport.terminal.v1.ClusterEvent';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.teleport.terminal.v1.NewGatewayConnectionAccepted = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.teleport.terminal.v1.NewGatewayConnectionAccepted, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.terminal.v1.NewGatewayConnectionAccepted.displayName = 'proto.teleport.terminal.v1.NewGatewayConnectionAccepted';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.teleport.terminal.v1.ClusterEventsRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.terminal.v1.ClusterEventsRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.terminal.v1.ClusterEventsRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.ClusterEventsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.teleport.terminal.v1.ClusterEventsRequest}
 */
proto.teleport.terminal.v1.ClusterEventsRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.terminal.v1.ClusterEventsRequest;
  return proto.teleport.terminal.v1.ClusterEventsRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.terminal.v1.ClusterEventsRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.terminal.v1.ClusterEventsRequest}
 */
proto.teleport.terminal.v1.ClusterEventsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.teleport.terminal.v1.ClusterEventsRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.terminal.v1.ClusterEventsRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.terminal.v1.ClusterEventsRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.ClusterEventsRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.teleport.terminal.v1.ClusterEvent.oneofGroups_ = [[2,3]];

/**
 * @enum {number}
 */
proto.teleport.terminal.v1.ClusterEvent.EventCase = {
  EVENT_NOT_SET: 0,
  CERT_EXPIRED: 2,
...
/**
 * @return {proto.teleport.terminal.v1.ClusterEvent.EventCase}
 */
proto.teleport.terminal.v1.ClusterEvent.prototype.getEventCase = function() {
  return /** @type {proto.teleport.terminal.v1.ClusterEvent.EventCase} */(jspb.Message.computeOneofCase(this, proto.teleport.terminal.v1.ClusterEvent.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.teleport.terminal.v1.ClusterEvent.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.terminal.v1.ClusterEvent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.terminal.v1.ClusterEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.ClusterEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    clusterUri: jspb.Message.getFieldWithDefault(msg, 1, ""),
    certExpired: (f = msg.getCertExpired()) && proto.teleport.terminal.v1.CertExpired.toObject(includeInstance, f),
    newGatewayConnectionAccepted: (f = msg.getNewGatewayConnectionAccepted()) && proto.teleport.terminal.v1.NewGatewayConnectionAccepted.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.teleport.terminal.v1.ClusterEvent}
 */
proto.teleport.terminal.v1.ClusterEvent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.terminal.v1.ClusterEvent;
  return proto.teleport.terminal.v1.ClusterEvent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.terminal.v1.ClusterEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.terminal.v1.ClusterEvent}
 */
proto.teleport.terminal.v1.ClusterEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.teleport.terminal.v1.NewGatewayConnectionAccepted;
      reader.readMessage(value,proto.teleport.terminal.v1.NewGatewayConnectionAccepted.deserializeBinaryFromReader);
      msg.setNewGatewayConnectionAccepted(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.teleport.terminal.v1.ClusterEvent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.terminal.v1.ClusterEvent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.terminal.v1.ClusterEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.ClusterEvent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getClusterUri();
  if (f.length > 0) {
    writer.writeString(
  ...
  f = message.getNewGatewayConnectionAccepted();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.teleport.terminal.v1.NewGatewayConnectionAccepted.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {string}
 */
proto.teleport.terminal.v1.ClusterEvent.prototype.getClusterUri = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.teleport.terminal.v1.ClusterEvent} returns this
 */
proto.teleport.terminal.v1.ClusterEvent.prototype.setClusterUri = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.teleport.terminal.v1.ClusterEvent.prototype.getCertExpired = function() {
 ...
 * @return {!proto.teleport.terminal.v1.ClusterEvent} returns this
*/
proto.teleport.terminal.v1.ClusterEvent.prototype.setCertExpired = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.teleport.terminal.v1.ClusterEvent.oneofGroups_[0], value);
};
 ...
 * @return {!proto.teleport.terminal.v1.ClusterEvent} returns this
 */
proto.teleport.terminal.v1.ClusterEvent.prototype.clearCertExpired = function() {
 ...
 * @return {boolean}
 */
proto.teleport.terminal.v1.ClusterEvent.prototype.hasCertExpired = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional NewGatewayConnectionAccepted new_gateway_connection_accepted = 3;
 * @return {?proto.teleport.terminal.v1.NewGatewayConnectionAccepted}
 */
proto.teleport.terminal.v1.ClusterEvent.prototype.getNewGatewayConnectionAccepted = function() {
  return /** @type{?proto.teleport.terminal.v1.NewGatewayConnectionAccepted} */ (
    jspb.Message.getWrapperField(this, proto.teleport.terminal.v1.NewGatewayConnectionAccepted, 3));
};


/**
 * @param {?proto.teleport.terminal.v1.NewGatewayConnectionAccepted|undefined} value
 * @return {!proto.teleport.terminal.v1.ClusterEvent} returns this
*/
proto.teleport.terminal.v1.ClusterEvent.prototype.setNewGatewayConnectionAccepted = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.teleport.terminal.v1.ClusterEvent.oneofGroups_[0], value);
};
 ...
 * @return {!proto.teleport.terminal.v1.ClusterEvent} returns this
 */
proto.teleport.terminal.v1.ClusterEvent.prototype.clearNewGatewayConnectionAccepted = function() {
  return this.setNewGatewayConnectionAccepted(undefined);
};
 ...
 * @return {boolean}
 */
proto.teleport.terminal.v1.ClusterEvent.prototype.hasNewGatewayConnectionAccepted = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {!Object}
 */
proto.teleport.terminal.v1.NewGatewayConnectionAccepted.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.terminal.v1.NewGatewayConnectionAccepted.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.terminal.v1.NewGatewayConnectionAccepted} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.NewGatewayConnectionAccepted.toObject = function(includeInstance, msg) {
  var f, obj = {
    gatewayUri: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * @return {!proto.teleport.terminal.v1.NewGatewayConnectionAccepted}
 */
proto.teleport.terminal.v1.NewGatewayConnectionAccepted.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.terminal.v1.NewGatewayConnectionAccepted;
  return proto.teleport.terminal.v1.NewGatewayConnectionAccepted.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.terminal.v1.NewGatewayConnectionAccepted} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.terminal.v1.NewGatewayConnectionAccepted}
 */
proto.teleport.terminal.v1.NewGatewayConnectionAccepted.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.teleport.terminal.v1.NewGatewayConnectionAccepted.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.terminal.v1.NewGatewayConnectionAccepted.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.terminal.v1.NewGatewayConnectionAccepted} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.NewGatewayConnectionAccepted.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getGatewayUri();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.teleport.terminal.v1.NewGatewayConnectionAccepted.prototype.getGatewayUri = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.teleport.terminal.v1.NewGatewayConnectionAccepted} returns this
 */
proto.teleport.terminal.v1.NewGatewayConnectionAccepted.prototype.setGatewayUri = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.teleport.terminal.v1.NewGatewayConnectionAccepted.prototype.getTargetUri = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.teleport.terminal.v1.NewGatewayConnectionAccepted} returns this
 */
proto.teleport.terminal.v1.NewGatewayConnectionAccepted.prototype.setTargetUri = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
