...
goog.exportSymbol('proto.teleport.terminal.v1.LoginRequest.PasswordlessParams', null, global);
...
goog.exportSymbol('proto.teleport.terminal.v1.WebauthnPrompt', null, global);
/**
 ...
 * @constructor
 */
proto.teleport.terminal.v1.LoginRequest.PasswordlessParams = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.teleport.terminal.v1.LoginRequest.PasswordlessParams, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.displayName = 'proto.teleport.terminal.v1.LoginRequest.PasswordlessParams';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.teleport.terminal.v1.LoginPasswordlessResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.teleport.terminal.v1.WebauthnPrompt} */ (reader.readEnum());
      msg.setPrompt(value);
      break;
    default:
      reader.skipField();
...
/**
 * optional WebauthnPrompt prompt = 1;
 * @return {!proto.teleport.terminal.v1.WebauthnPrompt}
 */
proto.teleport.terminal.v1.LoginPasswordlessResponse.prototype.getPrompt = function() {
  return /** @type {!proto.teleport.terminal.v1.WebauthnPrompt} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.teleport.terminal.v1.WebauthnPrompt} value
 ...
 * @return {string}
 */
proto.teleport.terminal.v1.LoginPasswordlessRequest.prototype.getClusterUri = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.teleport.terminal.v1.LoginPasswordlessRequest.prototype.setClusterUri = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.teleport.terminal.v1.LoginPasswordlessRequest.prototype.getUser = function() {
 ...
 * @return {!proto.teleport.terminal.v1.LoginPasswordlessRequest} returns this
 */
proto.teleport.terminal.v1.LoginPasswordlessRequest.prototype.setUser = function(value) {
 ...
 * @const
 */
proto.teleport.terminal.v1.LoginRequest.oneofGroups_ = [[2,3,4]];
...
proto.teleport.terminal.v1.LoginRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    passwordless: (f = msg.getPasswordless()) && proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.toObject(includeInstance, f)
  };
...
proto.teleport.terminal.v1.LoginRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.teleport.terminal.v1.LoginRequest.PasswordlessParams;
      reader.readMessage(value,proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.deserializeBinaryFromReader);
      msg.setPasswordless(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.teleport.terminal.v1.LoginRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getPasswordless();
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.terminal.v1.LoginRequest.PasswordlessParams} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.toObject = function(includeInstance, msg) {
  var f, obj = {
    user: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.teleport.terminal.v1.LoginRequest.PasswordlessParams}
 */
proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.terminal.v1.LoginRequest.PasswordlessParams;
  return proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.terminal.v1.LoginRequest.PasswordlessParams} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.terminal.v1.LoginRequest.PasswordlessParams}
 */
proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.terminal.v1.LoginRequest.PasswordlessParams} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUser();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.prototype.getUser = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.teleport.terminal.v1.LoginRequest.PasswordlessParams} returns this
 */
proto.teleport.terminal.v1.LoginRequest.PasswordlessParams.prototype.setUser = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
...
/**
 * optional PasswordlessParams passwordless = 4;
 * @return {?proto.teleport.terminal.v1.LoginRequest.PasswordlessParams}
 */
proto.teleport.terminal.v1.LoginRequest.prototype.getPasswordless = function() {
  return /** @type{?proto.teleport.terminal.v1.LoginRequest.PasswordlessParams} */ (
    jspb.Message.getWrapperField(this, proto.teleport.terminal.v1.LoginRequest.PasswordlessParams, 4));
};


/**
 * @param {?proto.teleport.terminal.v1.LoginRequest.PasswordlessParams|undefined} value
 * @return {!proto.teleport.terminal.v1.LoginRequest} returns this
*/
proto.teleport.terminal.v1.LoginRequest.prototype.setPasswordless = function(value) {
  return jspb.Message.setOneofWrapperField(this, 4, proto.teleport.terminal.v1.LoginRequest.oneofGroups_[0], value);
};
 ...
 * @return {!proto.teleport.terminal.v1.LoginRequest} returns this
 */
proto.teleport.terminal.v1.LoginRequest.prototype.clearPasswordless = function() {
  return this.setPasswordless(undefined);
};
 ...
 * @return {boolean}
 */
proto.teleport.terminal.v1.LoginRequest.prototype.hasPasswordless = function() {
 ...
 * @enum {number}
 */
proto.teleport.terminal.v1.WebauthnPrompt = {
