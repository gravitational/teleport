...
function serialize_teleport_terminal_v1_EventReportedResponse(arg) {
  if (!(arg instanceof v1_usage_events_pb.EventReportedResponse)) {
    throw new Error('Expected argument of type teleport.terminal.v1.EventReportedResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_teleport_terminal_v1_EventReportedResponse(buffer_arg) {
  return v1_usage_events_pb.EventReportedResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_teleport_terminal_v1_ReportEventRequest(arg) {
  if (!(arg instanceof v1_usage_events_pb.ReportEventRequest)) {
    throw new Error('Expected argument of type teleport.terminal.v1.ReportEventRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_teleport_terminal_v1_ReportEventRequest(buffer_arg) {
  return v1_usage_events_pb.ReportEventRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
reportEvent: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: v1_usage_events_pb.ReportEventRequest,
    responseType: v1_usage_events_pb.EventReportedResponse,
    requestSerialize: serialize_teleport_terminal_v1_ReportEventRequest,
    requestDeserialize: deserialize_teleport_terminal_v1_ReportEventRequest,
    responseSerialize: serialize_teleport_terminal_v1_EventReportedResponse,
    responseDeserialize: deserialize_teleport_terminal_v1_EventReportedResponse,
  },
};
