...
function serialize_teleport_terminal_v1_AssumeRoleResponse(arg) {
  if (!(arg instanceof v1_service_pb.AssumeRoleResponse)) {
    throw new Error('Expected argument of type teleport.terminal.v1.AssumeRoleResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_teleport_terminal_v1_AssumeRoleResponse(buffer_arg) {
  return v1_service_pb.AssumeRoleResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_teleport_terminal_v1_DeleteAccessRequestResponse(arg) {
  if (!(arg instanceof v1_service_pb.DeleteAccessRequestResponse)) {
    throw new Error('Expected argument of type teleport.terminal.v1.DeleteAccessRequestResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_teleport_terminal_v1_DeleteAccessRequestResponse(buffer_arg) {
  return v1_service_pb.DeleteAccessRequestResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
deleteAccessRequest: {
    ...
    responseType: v1_service_pb.DeleteAccessRequestResponse,
    ...
    responseSerialize: serialize_teleport_terminal_v1_DeleteAccessRequestResponse,
    responseDeserialize: deserialize_teleport_terminal_v1_DeleteAccessRequestResponse,
  },
...
assumeRole: {
    ...
    responseType: v1_service_pb.AssumeRoleResponse,
    ...
    responseSerialize: serialize_teleport_terminal_v1_AssumeRoleResponse,
    responseDeserialize: deserialize_teleport_terminal_v1_AssumeRoleResponse,
  },
