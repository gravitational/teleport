 ...
 * @const
 */
proto.teleport.terminal.v1.LoggedInUser.repeatedFields_ = [2,3,4];
...
proto.teleport.terminal.v1.LoggedInUser.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    activeRequestsList: (f = jspb.Message.getRepeatedField(msg, 4)) == null ? undefined : f,
...
proto.teleport.terminal.v1.LoggedInUser.prototype.getAcl = function() {
  return /** @type{?proto.teleport.terminal.v1.ACL} */ (
    jspb.Message.getWrapperField(this, proto.teleport.terminal.v1.ACL, 5));
};
