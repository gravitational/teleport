...
type Cluster struct {
	...
	// Unfortunately, we made a mistake where instead of taking the name of the cluster from the key,
	// we take it from the hostname part of the proxy service. These two are not always equal.
	// And actually there are places in tsh code where it needs the name of the cluster from the key,
	// not the hostname of the proxy service (like in the `TELEPORT_CLUSTER` env var).
	// Since this identifier is so widely used, we didn't have time to change it before the preview release.
	// In the future we plan to fix the value sent under name to the name from the key and get rid of the `actual_name` field.
...
func (x *Cluster) GetActualName() string {
	if x != nil {
		return x.ActualName
	}
	return ""
...
var file_v1_cluster_proto_rawDesc = []byte{
	...
	0x6d, 0x69, 0x6e, 0x61, 0x6c, 0x2e, 0x76, 0x31, 0x22, 0xeb, 0x01, 0x0a, 0x07, 0x43, 0x6c, 0x75,
	...
	0x74, 0x75, 0x61, 0x6c, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0a, 0x61, 0x63, 0x74, 0x75, 0x61, 0x6c, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x70,
	0x72, 0x6f, 0x78, 0x79, 0x5f, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x48, 0x6f, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x6f,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x6c, 0x65, 0x61, 0x66, 0x12, 0x48, 0x0a, 0x0e,
	0x6c, 0x6f, 0x67, 0x67, 0x65, 0x64, 0x5f, 0x69, 0x6e, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x18, 0x07,
