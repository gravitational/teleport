...
const (
	...
	// PASSWORDLESS_PROMPT_RETAP is used when we require a user to re-tap their device.
	PasswordlessPrompt_PASSWORDLESS_PROMPT_RETAP PasswordlessPrompt = 3
	// PASSWORDLESS_PROMPT_CREDENTIAL is used when we require a user to select a usernamer
	// associated with their account.
	PasswordlessPrompt_PASSWORDLESS_PROMPT_CREDENTIAL PasswordlessPrompt = 4
)
...
var (
	PasswordlessPrompt_name = map[int32]string{
		...
		3: "PASSWORDLESS_PROMPT_RETAP",
		4: "PASSWORDLESS_PROMPT_CREDENTIAL",
	}
...
type LoginPasswordlessResponse struct {
	...
	// usernames is a list of usernames associated with a passwordless device.
	// Sent during the webauthncli.PromptCredential step.
...
func (x *LoginPasswordlessResponse) GetUsernames() []string {
	if x != nil {
		return x.Usernames
	}
	return nil
...
type LoginPasswordlessRequest struct {
	...
	//	*LoginPasswordlessRequest_ClusterUri
	//	*LoginPasswordlessRequest_Pin
	//	*LoginPasswordlessRequest_UsernameIndex
...
func (x *LoginPasswordlessRequest) GetClusterUri() string {
	if x, ok := x.GetRequest().(*LoginPasswordlessRequest_ClusterUri); ok {
		return x.ClusterUri
	}
	return ""
}
...
func (x *LoginPasswordlessRequest) GetUsernameIndex() int64 {
	if x, ok := x.GetRequest().(*LoginPasswordlessRequest_UsernameIndex); ok {
		return x.UsernameIndex
	}
	return 0
}
...
type LoginPasswordlessRequest_ClusterUri struct {
	// cluster_uri required for init request to resolve cluster by its uri.
	ClusterUri string `protobuf:"bytes,1,opt,name=cluster_uri,json=clusterUri,proto3,oneof"`
}

type LoginPasswordlessRequest_Pin struct {
	// pin is the device's pin number provided by user sent during the webauthncli.PromptPIN
	// step.
	Pin string `protobuf:"bytes,2,opt,name=pin,proto3,oneof"`
}

type LoginPasswordlessRequest_UsernameIndex struct {
	// usernameIndex is the index of the username the user selected from the list of usernames
	// sent during the webauthncli.PromptCredential step.
	UsernameIndex int64 `protobuf:"varint,3,opt,name=usernameIndex,proto3,oneof"`
}

func (*LoginPasswordlessRequest_ClusterUri) isLoginPasswordlessRequest_Request() {}

func (*LoginPasswordlessRequest_Pin) isLoginPasswordlessRequest_Request() {}

func (*LoginPasswordlessRequest_UsernameIndex) isLoginPasswordlessRequest_Request() {}
...
var file_v1_service_proto_rawDesc = []byte{
	...
	,
	...
	0x73, 0x74, 0x65, 0x72, 0x73, 0x22, 0x37, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74,
	0x61, 0x62, 0x61, 0x73, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a,
	0x0b, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x75, 0x72, 0x69, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x55, 0x72, 0x69, 0x22, 0x3a,
	...
	0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x55, 0x72, 0x69, 0x22, 0x55, 0x0a, 0x15, 0x4c, 0x69,
	0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x3c, 0x0a, 0x09, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72,
	0x74, 0x2e, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x61, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x61,
	0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x52, 0x09, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
	0x73, 0x22, 0x31, 0x0a, 0x18, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
	...
	0x72, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x36, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x47,
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f,
	...
	0x51, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x73, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39, 0x0a, 0x08, 0x67, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x74, 0x65, 0x6c, 0x65,
	...
	0x0a, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x55, 0x72, 0x69, 0x22, 0x38, 0x0a, 0x15, 0x52,
	0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x52, 0x65, 0x71,
	...
	0x63, 0x61, 0x6c, 0x50, 0x6f, 0x72, 0x74, 0x22, 0x35, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x53,
	...
	0x72, 0x76, 0x65, 0x72, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x22, 0x45, 0x0a,
	...
	0x6e, 0x73, 0x65, 0x2a, 0xb6, 0x01, 0x0a, 0x12, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64,
	...
	,
	...
	0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x6d, 0x0a, 0x10, 0x4c,
	...
	0x6e, 0x61, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4c, 0x65, 0x61, 0x66, 0x43,
	...
	0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x68, 0x0a, 0x0d, 0x4c, 0x69,
	0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x73, 0x12, 0x2a, 0x2e, 0x74, 0x65,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x74, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61,
	0x62, 0x61, 0x73, 0x65, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x2e, 0x2e, 0x74, 0x65, 0x6c, 0x65,
	0x70, 0x6f, 0x72, 0x74, 0x2e, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x61, 0x6c, 0x2e, 0x76, 0x31,
	...
	,
...
var file_v1_service_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_v1_service_proto_goTypes = []interface{}{
	...
	(*RestartGatewayRequest)(nil),                  // 21: teleport.terminal.v1.RestartGatewayRequest
	(*SetGatewayTargetSubresourceNameRequest)(nil), // 22: teleport.terminal.v1.SetGatewayTargetSubresourceNameRequest
	(*SetGatewayLocalPortRequest)(nil),             // 23: teleport.terminal.v1.SetGatewayLocalPortRequest
	(*ListServersRequest)(nil),                     // 24: teleport.terminal.v1.ListServersRequest
	(*ListServersResponse)(nil),                    // 25: teleport.terminal.v1.ListServersResponse
	(*ListKubesResponse)(nil),                      // 26: teleport.terminal.v1.ListKubesResponse
	(*ListAppsResponse)(nil),                       // 27: teleport.terminal.v1.ListAppsResponse
	(*GetAuthSettingsRequest)(nil),                 // 28: teleport.terminal.v1.GetAuthSettingsRequest
	(*EmptyResponse)(nil),                          // 29: teleport.terminal.v1.EmptyResponse
	(*LoginRequest_LocalParams)(nil),               // 30: teleport.terminal.v1.LoginRequest.LocalParams
	(*LoginRequest_SsoParams)(nil),                 // 31: teleport.terminal.v1.LoginRequest.SsoParams
	(*Cluster)(nil),                                // 32: teleport.terminal.v1.Cluster
	(*Database)(nil),                               // 33: teleport.terminal.v1.Database
	(*Gateway)(nil),                                // 34: teleport.terminal.v1.Gateway
	(*Server)(nil),                                 // 35: teleport.terminal.v1.Server
	(*Kube)(nil),                                   // 36: teleport.terminal.v1.Kube
	(*App)(nil),                                    // 37: teleport.terminal.v1.App
	(*AuthSettings)(nil),                           // 38: teleport.terminal.v1.AuthSettings
}
var file_v1_service_proto_depIdxs = []int32{
	...
	30, // 1: teleport.terminal.v1.LoginRequest.local:type_name -> teleport.terminal.v1.LoginRequest.LocalParams
	31, // 2: teleport.terminal.v1.LoginRequest.sso:type_name -> teleport.terminal.v1.LoginRequest.SsoParams
	32, // 3: teleport.terminal.v1.ListClustersResponse.clusters:type_name -> teleport.terminal.v1.Cluster
	33, // 4: teleport.terminal.v1.ListDatabasesResponse.databases:type_name -> teleport.terminal.v1.Database
	34, // 5: teleport.terminal.v1.ListGatewaysResponse.gateways:type_name -> teleport.terminal.v1.Gateway
	35, // 6: teleport.terminal.v1.ListServersResponse.servers:type_name -> teleport.terminal.v1.Server
	36, // 7: teleport.terminal.v1.ListKubesResponse.kubes:type_name -> teleport.terminal.v1.Kube
	37, // 8: teleport.terminal.v1.ListAppsResponse.apps:type_name -> teleport.terminal.v1.App
	10, // 9: teleport.terminal.v1.TerminalService.ListRootClusters:input_type -> teleport.terminal.v1.ListClustersRequest
	13, // 10: teleport.terminal.v1.TerminalService.ListLeafClusters:input_type -> teleport.terminal.v1.ListLeafClustersRequest
	12, // 11: teleport.terminal.v1.TerminalService.ListDatabases:input_type -> teleport.terminal.v1.ListDatabasesRequest
	15, // 12: teleport.terminal.v1.TerminalService.ListDatabaseUsers:input_type -> teleport.terminal.v1.ListDatabaseUsersRequest
	24, // 13: teleport.terminal.v1.TerminalService.ListServers:input_type -> teleport.terminal.v1.ListServersRequest
	8,  // 14: teleport.terminal.v1.TerminalService.ListKubes:input_type -> teleport.terminal.v1.ListKubesRequest
	9,  // 15: teleport.terminal.v1.TerminalService.ListApps:input_type -> teleport.terminal.v1.ListAppsRequest
	7,  // 16: teleport.terminal.v1.TerminalService.AddCluster:input_type -> teleport.terminal.v1.AddClusterRequest
	1,  // 17: teleport.terminal.v1.TerminalService.RemoveCluster:input_type -> teleport.terminal.v1.RemoveClusterRequest
	18, // 18: teleport.terminal.v1.TerminalService.ListGateways:input_type -> teleport.terminal.v1.ListGatewaysRequest
	17, // 19: teleport.terminal.v1.TerminalService.CreateGateway:input_type -> teleport.terminal.v1.CreateGatewayRequest
	20, // 20: teleport.terminal.v1.TerminalService.RemoveGateway:input_type -> teleport.terminal.v1.RemoveGatewayRequest
	21, // 21: teleport.terminal.v1.TerminalService.RestartGateway:input_type -> teleport.terminal.v1.RestartGatewayRequest
	22, // 22: teleport.terminal.v1.TerminalService.SetGatewayTargetSubresourceName:input_type -> teleport.terminal.v1.SetGatewayTargetSubresourceNameRequest
	23, // 23: teleport.terminal.v1.TerminalService.SetGatewayLocalPort:input_type -> teleport.terminal.v1.SetGatewayLocalPortRequest
	28, // 24: teleport.terminal.v1.TerminalService.GetAuthSettings:input_type -> teleport.terminal.v1.GetAuthSettingsRequest
	2,  // 25: teleport.terminal.v1.TerminalService.GetCluster:input_type -> teleport.terminal.v1.GetClusterRequest
	6,  // 26: teleport.terminal.v1.TerminalService.Login:input_type -> teleport.terminal.v1.LoginRequest
	5,  // 27: teleport.terminal.v1.TerminalService.LoginPasswordless:input_type -> teleport.terminal.v1.LoginPasswordlessRequest
	3,  // 28: teleport.terminal.v1.TerminalService.Logout:input_type -> teleport.terminal.v1.LogoutRequest
	11, // 29: teleport.terminal.v1.TerminalService.ListRootClusters:output_type -> teleport.terminal.v1.ListClustersResponse
	11, // 30: teleport.terminal.v1.TerminalService.ListLeafClusters:output_type -> teleport.terminal.v1.ListClustersResponse
	14, // 31: teleport.terminal.v1.TerminalService.ListDatabases:output_type -> teleport.terminal.v1.ListDatabasesResponse
	16, // 32: teleport.terminal.v1.TerminalService.ListDatabaseUsers:output_type -> teleport.terminal.v1.ListDatabaseUsersResponse
	25, // 33: teleport.terminal.v1.TerminalService.ListServers:output_type -> teleport.terminal.v1.ListServersResponse
	26, // 34: teleport.terminal.v1.TerminalService.ListKubes:output_type -> teleport.terminal.v1.ListKubesResponse
	27, // 35: teleport.terminal.v1.TerminalService.ListApps:output_type -> teleport.terminal.v1.ListAppsResponse
	32, // 36: teleport.terminal.v1.TerminalService.AddCluster:output_type -> teleport.terminal.v1.Cluster
	29, // 37: teleport.terminal.v1.TerminalService.RemoveCluster:output_type -> teleport.terminal.v1.EmptyResponse
	19, // 38: teleport.terminal.v1.TerminalService.ListGateways:output_type -> teleport.terminal.v1.ListGatewaysResponse
	34, // 39: teleport.terminal.v1.TerminalService.CreateGateway:output_type -> teleport.terminal.v1.Gateway
	29, // 40: teleport.terminal.v1.TerminalService.RemoveGateway:output_type -> teleport.terminal.v1.EmptyResponse
	29, // 41: teleport.terminal.v1.TerminalService.RestartGateway:output_type -> teleport.terminal.v1.EmptyResponse
	34, // 42: teleport.terminal.v1.TerminalService.SetGatewayTargetSubresourceName:output_type -> teleport.terminal.v1.Gateway
	34, // 43: teleport.terminal.v1.TerminalService.SetGatewayLocalPort:output_type -> teleport.terminal.v1.Gateway
	38, // 44: teleport.terminal.v1.TerminalService.GetAuthSettings:output_type -> teleport.terminal.v1.AuthSettings
	32, // 45: teleport.terminal.v1.TerminalService.GetCluster:output_type -> teleport.terminal.v1.Cluster
	29, // 46: teleport.terminal.v1.TerminalService.Login:output_type -> teleport.terminal.v1.EmptyResponse
	4,  // 47: teleport.terminal.v1.TerminalService.LoginPasswordless:output_type -> teleport.terminal.v1.LoginPasswordlessResponse
	29, // 48: teleport.terminal.v1.TerminalService.Logout:output_type -> teleport.terminal.v1.EmptyResponse
...
func file_v1_service_proto_init() {
	...
	file_v1_service_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*LoginPasswordlessRequest_ClusterUri)(nil),
		(*LoginPasswordlessRequest_Pin)(nil),
		(*LoginPasswordlessRequest_UsernameIndex)(nil),
	}
