...
type ReportUsageEventRequest struct {
	...
	PrehogEvent   *v1alpha.SubmitConnectEventRequest `protobuf:"bytes,2,opt,name=prehog_event,json=prehogEvent,proto3" json:"prehog_event,omitempty"`
}
...
func (x *ReportUsageEventRequest) GetPrehogEvent() *v1alpha.SubmitConnectEventRequest {
	if x != nil {
		return x.PrehogEvent
	}
	return nil
}
...
var file_v1_usage_events_proto_rawDesc = []byte{
	...
	0x6e, 0x6e, 0x65, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8f, 0x01, 0x0a, 0x17,
	...
	0x4c, 0x0a, 0x0c, 0x70, 0x72, 0x65, 0x68, 0x6f, 0x67, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x18,
	...
	0x52, 0x0b, 0x70, 0x72, 0x65, 0x68, 0x6f, 0x67, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x42, 0x33, 0x5a,
...
var file_v1_usage_events_proto_depIdxs = []int32{
	1, // 0: teleport.terminal.v1.ReportUsageEventRequest.prehog_event:type_name -> prehog.v1alpha.SubmitConnectEventRequest
