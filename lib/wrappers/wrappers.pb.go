...
type StringValues struct {
	Values               []string `protobuf:"bytes,1,rep,name=Values,json=values" json:"Values,omitempty"`
...
func (*StringValues) Descriptor() ([]byte, []int) {
	return fileDescriptor_wrappers_531b45fea5eef830, []int{0}
}
...
type LabelValues struct {
	...
	Values               map[string]StringValues `protobuf:"bytes,1,rep,name=Values,json=values" json:"labels" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func (*LabelValues) Descriptor() ([]byte, []int) {
	return fileDescriptor_wrappers_531b45fea5eef830, []int{1}
}
...
func init() { proto.RegisterFile("wrappers.proto", fileDescriptor_wrappers_531b45fea5eef830) }

var fileDescriptor_wrappers_531b45fea5eef830 = []byte{
	...
	,
}
