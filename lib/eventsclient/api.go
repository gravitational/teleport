...
const (
	...
	EventLogin = "login"
	// EventProtocolSSH specifies SSH as a type of captured protocol
	...
	// AccessRequestExpireEvent is emitted when an access request expires.
	...
	// OktaGroupsUpdateEvent event is emitted when the groups synced from Okta have been updated.
	...
	// DiscoveryConfigCreateEvent is emitted when a discovery config is created.
	DiscoveryConfigCreateEvent = "discovery_config.create"
	// DiscoveryConfigUpdateEvent is emitted when a discovery config is updated.
	DiscoveryConfigUpdateEvent = "discovery_config.update"
	// DiscoveryConfigDeleteEvent is emitted when a discovery config is deleted.
	DiscoveryConfigDeleteEvent = "discovery_config.delete"
	// DiscoveryConfigDeleteAllEvent is emitted when all discovery configs are deleted.
