...
const kubernetesDefaultTokenPath = "/var/run/secrets/kubernetes.io/serviceaccount/name"
...
func GetIDToken(getEnv getEnvFunc, readFile readFileFunc) (string, error) {
	...
	// This is useful when the operator wants to use a custom projected name, or another service account.
