...
func (h *Handler) getUserContext(w http.ResponseWriter, r *http.Request, p httprouter.Params, c *SessionContext, site reversetunnelclient.RemoteSite) (any, error) {
	...
	accessMonitoringEnabled := pingResp.ServerFeatures != nil && pingResp.ServerFeatures.GetAccessMonitoring().GetEnabled()
	...
	if pingResp.ServerFeatures != nil && pingResp.ServerFeatures.AccessMonitoring == nil {
