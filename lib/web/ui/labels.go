...
// MakeUILabelsWithoutInternalPrefixes is a function that transforms map[string]string arguments passed to it to sorted slice of Labels.
// It also removes all Teleport internal labels from output.
func MakeUILabelsWithoutInternalPrefixes(labelMaps ...map[string]string) []Label {
	length := 0
