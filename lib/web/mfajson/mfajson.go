...
// In v17.0 and older, the WebUI sends a flattened webauthn response instead of
// a full MFA challenge response. Newer WebUI versions v17.1+ will send both for
