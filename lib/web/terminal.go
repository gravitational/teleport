...
func newMFACeremonyPerformer(ws terminal.WSConn, mfaClient mfav2.MFAServiceClient, proxyAddr string, targetCluster string) (clientssh.MFACeremonyPerformer, error) {
