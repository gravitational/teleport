...
// sessionMgr starts and stop enforcing restrictions for a given session.
...
// NOP is a stubbed implementation of sessionMgr for cases where the real thing is not used.
type NOP struct{}
