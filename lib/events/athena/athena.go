...
const (
	...
	// in a single batch. Defaults to 400MB, which is less than the maximum allowed size of SQS message (256KB) multiplied by the default batch items (20000).
	defaultBatchMaxBytes = 400 * 1024 * 1024
...
type Config struct {
	...
	// single batch (optional). Default is 400MB.
	BatchMaxBytes int
