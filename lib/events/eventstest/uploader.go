...
func (m *MemoryUploader) Reset() {
	...
	m.details = make(map[session.ID][]byte)
}
...
// UploadThumbnail uploads session summary and returns URL with uploaded file in
// case of success.
