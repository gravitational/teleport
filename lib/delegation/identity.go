...
// delegation chain.
func FromUser(user types.User) *types.Delegation {
	d := &types.Delegation{Previous: user.GetDelegation()}
	...
	case user.IsBot():
		...
		d.Delegator = &types.Delegation_Bot{
	...
	default:
		d.Delegator = &types.Delegation_User{
