...
func requestBoundKeypairRotation(
	...
	algoSuiteText, err := cap.GetSignatureAlgorithmSuite().MarshalText()
	if err != nil {
...
func (p *JoinParams) checkAndSetDefaults() error {
	...
	case p.ChallengeResponse == nil:
		return trace.BadParameter("ChallengeResponse is required")
	case p.Logger == nil:
...
func HandleBoundKeypairJoin(
	...
	if params.ClientInit.SystemRole != types.RoleBot.String() {
