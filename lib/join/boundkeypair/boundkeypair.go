...
type boundHostIDMutator struct {
	newHostID            string
...
func mutateStatusBoundHostID(newHostID, expectPreviousHostID string) boundKeypairStatusMutatorV2 {
	return &boundHostIDMutator{
		newHostID:            newHostID,
		expectPreviousHostID: expectPreviousHostID,
	}
}
