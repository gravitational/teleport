...
func TestBackground(t *testing.T) {
	...
	// termination is asynchronous and may only terminate the "next"
	// generate step if one is already in progress (but at most one additional
	// generate will occur after termination).
	select {
	case <-gench:
