...
// automatically, but can be manually overriden by admins. If someone manually
// sets a host ID that looks like one of our generated EC2 node IDs, they may
// be able to trick this function, so don't use it for any critical purpose.
