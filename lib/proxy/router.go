...
func (r *Router) getRemoteCluster(ctx context.Context, clusterName string, checker func(types.RemoteCluster) error) (reversetunnelclient.RemoteSite, error) {
