...
func (*embeddedApplicationServiceClient) ReportConnections(context.Context, *vnetv1.ReportConnectionsRequest, ...grpc.CallOption) (*vnetv1.ReportConnectionsResponse, error) {
