...
func newRemoteOSConfigProvider(clt targetOSConfigGetter, tunName, ipv6Prefix, dnsIPv6 string) (*remoteOSConfigProvider, error) {
...
func (p *remoteOSConfigProvider) setV4IPsFromFirstCIDR(cidrRange string) error {
	...
	p.tunIPv4 = tunIPv4
	p.nameservers = append(p.nameservers, dnsIPv4)
	return nil
}
