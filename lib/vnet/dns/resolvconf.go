...
// place to read them. Eventually, we should probably use a better method, but
// for now this works.
func ResolvConfUpstreamNameserverSource(slog *slog.Logger) UpstreamNameserverSource {
