...
//
// TODO(tangyatsu): if x/crypto/ssh/agent starts supporting
// session-bind@openssh.com, we might need to also bind the session on each
// connection before signing. See https://github.com/golang/go/issues/77146.
