...
func MakeDefaultAuthClient(t *testing.T, log utils.Logger, fc *config.FileConfig) *authclient.Client {
	t.Helper()
...
func MakeBot(t *testing.T, client *authclient.Client, name string, roles ...string) *proto.CreateBotResponse {
	t.Helper()
