...
func TestChooseOneDatabase(t *testing.T) {
	t.Parallel()
	fooDB1 := testutils.NewMockDiscoveredDB(t, "foo-rds-us-west-1-123456789012", "foo")
	fooDB2 := testutils.NewMockDiscoveredDB(t, "foo-rds-us-west-2-123456789012", "foo")
	barDB := testutils.NewMockDiscoveredDB(t, "bar-rds-us-west-1-123456789012", "bar")
	tests := []struct {
		desc      string
