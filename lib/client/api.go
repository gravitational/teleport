...
func (tc *TeleportClient) ReissueUserCerts(ctx context.Context, cachePolicy CertCachePolicy, params ReissueParams) error {
	...
	err = RetryWithRelogin(ctx, tc, func() error {
		err := clusterClient.ReissueUserCerts(ctx, cachePolicy, params)
		return trace.Wrap(err)
	})
	return trace.Wrap(err)
}
...
func (tc *TeleportClient) CreateAccessRequest(ctx context.Context, req types.AccessRequest) error {
	...
	return clusterClient.CreateAccessRequest(ctx, req)
}
...
func (tc *TeleportClient) GetAccessRequests(ctx context.Context, filter types.AccessRequestFilter) ([]types.AccessRequest, error) {
	...
	return clusterClient.GetAccessRequests(ctx, filter)
}
...
func (tc *TeleportClient) GetRole(ctx context.Context, name string) (types.Role, error) {
	...
	return clusterClient.GetRole(ctx, name)
}
...
func (tc *TeleportClient) NewWatcher(ctx context.Context, watch types.Watch) (types.Watcher, error) {
	...
	watcher, err := clusterClient.NewWatcher(ctx, watch)
	if err != nil {
		clusterClient.Close()
		return nil, trace.Wrap(err)
	}
...
func (tc *TeleportClient) NewTracingClient(ctx context.Context) (*apitracing.Client, error) {
	...
	clientConfig := clusterClient.ClientConfig(ctx, clusterClient.ClusterName())
...
func (tc *TeleportClient) SSH(ctx context.Context, command []string, runLocally bool, opts ...func(*SSHOptions)) error {
	...
	nodeAddrs, err := tc.getTargetNodes(ctx, clt.CurrentCluster(), options)
	if err != nil {
		return trace.Wrap(err)
	}
	if len(nodeAddrs) == 0 {
...
func (tc *TeleportClient) ConnectToNode(ctx context.Context, clt *ClusterClient, nodeDetails NodeDetails, user string) (*NodeClient, error) {
	...
	go func() {
		...
		conn, details, err := clt.DialHost(ctx, nodeDetails.Addr, nodeDetails.Cluster, tc.localAgent.ExtendedAgent)
		if err != nil {
...
func (tc *TeleportClient) Join(ctx context.Context, mode types.SessionParticipantMode, namespace string, sessionID session.ID, input io.Reader) (err error) {
	...
	if mode == types.SessionModeratorMode {
		beforeStart = func(out io.Writer) {
			nc.OnMFA = func() {
				RunPresenceTask(presenceCtx, out, clt.CurrentCluster(), session.GetSessionID(), func(ctx context.Context, proxyAddr string, c *proto.MFAAuthenticateChallenge) (*proto.MFAAuthenticateResponse, error) {
...
func (tc *TeleportClient) Play(ctx context.Context, namespace, sessionID string) (err error) {
	...
	if len(sessionEvents) > 0 {
		...
		case events.WindowsDesktopSessionStartEvent:
			url := getDesktopEventWebURL(tc.localAgent.proxyHost, clusterClient.ClusterName(), sid, sessionEvents)
...
func (tc *TeleportClient) ListNodesWithFilters(ctx context.Context) ([]types.Server, error) {
	...
	servers, err := client.GetAllResources[types.Server](ctx, clt.CurrentCluster(), req)
...
func (tc *TeleportClient) GetClusterAlerts(ctx context.Context, req types.GetClusterAlertsRequest) ([]types.ClusterAlert, error) {
	...
	alerts, err := clusterClient.GetClusterAlerts(ctx, req)
...
func (tc *TeleportClient) ListAppServersWithFilters(ctx context.Context, customFilter *proto.ListResourcesRequest) ([]types.AppServer, error) {
	...
	servers, err := clusterClient.FindAppServersByFilters(ctx, *filter)
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (tc *TeleportClient) CreateAppSession(ctx context.Context, req types.CreateAppSessionRequest) (types.WebSession, error) {
	...
	defer clusterClient.Close()
	return clusterClient.CreateAppSession(ctx, req)
}
...
func (tc *TeleportClient) GetAppSession(ctx context.Context, req types.GetAppSessionRequest) (types.WebSession, error) {
	...
	appSession, err := clusterClient.GetAppSession(ctx, req)
	return appSession, trace.Wrap(err)
}
...
func (tc *TeleportClient) DeleteAppSession(ctx context.Context, sessionID string) error {
	...
	err = clusterClient.DeleteAppSession(ctx, sessionID)
	return trace.Wrap(err)
}
...
func (tc *TeleportClient) ListAllNodes(ctx context.Context) ([]types.Server, error) {
	...
	servers, err := client.GetAllResources[types.Server](ctx, clt.CurrentCluster(), &proto.ListResourcesRequest{
		Namespace:    tc.Namespace,
...
func (tc *TeleportClient) runCommandOnNodes(ctx context.Context, clt *ClusterClient, nodeAddresses []string, command []string) error {
	...
	g.SetLimit(commandLimit(ctx, clt.CurrentCluster(), mfaRequiredCheck.Required))
