...
// ExportFunc represents the ExportMaintenanceWindows rpc exposed by auth servers.
type ExportFunc func(ctx context.Context, req proto.ExportMaintenanceWindowsRequest) (proto.ExportMaintenanceWindowsResponse, error)
...
func (e *Exporter[C]) exportWithRetry(ctx context.Context) {
	...
	for {
		...
		rsp, err := e.cfg.ExportFunc(ctx, proto.ExportMaintenanceWindowsRequest{
...
func (e *kubeDriver) Sync(ctx context.Context, rsp proto.ExportMaintenanceWindowsResponse) error {
...
func (e *systemdDriver) Sync(ctx context.Context, rsp proto.ExportMaintenanceWindowsResponse) error {
