...
// SAMLOktaConnectorV2WithoutRoleMapping is a SAML connector without attributes_to_roles mapping field.
const SAMLOktaConnectorV2WithoutRoleMapping = `kind: saml
version: v2
metadata:
  name: OktaSAML
  namespace: default
