...
type App struct {
	...
	// https://github.com/golang/go/issues/49918). Accepted YAML
	// values are `http1` and `http2`; see types.HTTPProtocolPriority
	// for details.
	HTTPProtocolPriority types.HTTPProtocolPriority `yaml:"http_protocol_priority,omitempty"`
