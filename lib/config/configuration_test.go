...
func TestApplyConfig(t *testing.T) {
	...
	require.Equal(t, "tcp://webhost:6379", cfg.Proxy.RedisAddr.FullAddress())
	...
	require.Len(t, cfg.Proxy.RedisPublicAddrs, 1)
	require.Equal(t, "tcp://redis.example:6379", cfg.Proxy.RedisPublicAddrs[0].FullAddress())
