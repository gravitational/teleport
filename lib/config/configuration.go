...
func applyAuthConfig(fc *FileConfig, cfg *servicecfg.Config) error {
	...
	log.WithField("allow_downgrade", cfg.Auth.PROXYAllowDowngrade).Debug("capturing auth.proxy_protocol_allow_downgrade")
...
func applyProxyConfig(fc *FileConfig, cfg *servicecfg.Config) error {
	...
	log.WithField("allow_downgrade", cfg.Proxy.PROXYAllowDowngrade).Debug("capturing proxy.proxy_protocol_allow_downgrade")
