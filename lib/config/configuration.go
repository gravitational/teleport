...
func applyKeyStoreConfig(fc *FileConfig, cfg *service.Config) error {
	...
	if fc.Auth.CAKeyParams.PKCS11 != nil {
		if fc.Auth.CAKeyParams.GCP_KMS != nil {
	...
	if fc.Auth.CAKeyParams.GCP_KMS != nil {
		return trace.Wrap(applyGCPKMSConfig(fc.Auth.CAKeyParams.GCP_KMS, cfg))
	}
	return nil
}
...
func applyGCPKMSConfig(kmsConfig *GCP_KMS, cfg *service.Config) error {
