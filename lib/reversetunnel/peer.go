...
func (p *clusterPeers) CachingAccessPoint() (reversetunnelclient.RemoteProxyAccessPoint, error) {
	peer, err := p.pickPeer()
	if err != nil {
...
func (s *clusterPeer) CachingAccessPoint() (reversetunnelclient.RemoteProxyAccessPoint, error) {
