...
import (
	...
	"github.com/gravitational/teleport/lib/oxy/testutils"
...
func (s *FwdSuite) TestForwardedHeaders(c *C) {
	...
	c.Assert(outHeaders.Get(XForwardedSSL), Equals, "off")
	c.Assert(outHeaders.Get(XForwardedPort), Equals, strings.Split(srv.URL, ":")[2])
}
