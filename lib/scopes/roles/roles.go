...
func RoleIsAssignableAtScope(role *accesspb.ScopedRole, scope string) bool {
...
func WeakValidatedAssignableScopes(role *accesspb.ScopedRole) iter.Seq[string] {
...
func WeakValidateRole(role *accesspb.ScopedRole) error {
...
func StrongValidateRole(role *accesspb.ScopedRole) error {
	if err := commonValidateRole(role); err != nil {
		return trace.Wrap(err)
	}
...
func commonValidateRole(role *accesspb.ScopedRole) error {
...
// assignable to.
func WeakValidatedSubAssignments(assignment *accesspb.ScopedRoleAssignment) iter.Seq[*accesspb.Assignment] {
	return func(yield func(*accesspb.Assignment) bool) {
...
func WeakValidateAssignment(assignment *accesspb.ScopedRoleAssignment) error {
...
func StrongValidateAssignment(assignment *accesspb.ScopedRoleAssignment) error {
	if err := commonValidateAssignment(assignment); err != nil {
		return trace.Wrap(err)
	}
...
func commonValidateAssignment(assignment *accesspb.ScopedRoleAssignment) error {
