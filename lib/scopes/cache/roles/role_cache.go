...
type RoleCache struct {
	cache *cache.Cache[*srpb.ScopedRole, string]
}

// NewRoleCache creates a new role cache instance.
func NewRoleCache() *RoleCache {
	return &RoleCache{
		cache: cache.Must(cache.Config[*srpb.ScopedRole, string]{
			Scope: func(role *srpb.ScopedRole) string {
				return role.GetScope()
			},
			Key: func(role *srpb.ScopedRole) string {
				return role.GetMetadata().GetName()
			},
			Clone: proto.CloneOf[*srpb.ScopedRole],
		}),
	}
}

// ListScopedRoles returns a paginated list of scoped roles.
func (c *RoleCache) ListScopedRoles(ctx context.Context, req *srpb.ListScopedRolesRequest) (*srpb.ListScopedRolesResponse, error) {
...
Outer:
	...
	return &srpb.ListScopedRolesResponse{
		Roles:         out,
...
func (c *RoleCache) Put(role *srpb.ScopedRole) error {
