...
// GetSite returns the cluster with the provided name.
...
// FakeCluster is a fake reversetunnelclient.Cluster implementation used in tests.
type FakeCluster struct {
	...
	// closed is set to true after the cluster is closed.
	closed bool
}
...
// Dial returns the connection to the cluster.
