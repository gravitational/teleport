...
#[test]
fn test_scard_ioctl_writecachew() {
    let context_value = 5;
    let mut c = client(true, context_value, Some(context_value - 1));
    ...
    test_payload_in_to_response_out(
        ...
        PayloadIn {
            ...
            request: Box::new(DeviceControlRequest {
                ...
                output_buffer_length: 2048,
                input_buffer_length: 184,
                io_control_code: IoctlCode::SCARD_IOCTL_WRITECACHEW,
            }),
            scard_ctl: Some(Box::new(WriteCache_Call {
...
#[test]
fn test_scard_ioctl_endtransaction() {
    let context_value = 5;
    let mut c = client(true, context_value, Some(context_value - 1));
    ...
    test_payload_in_to_response_out(
        ...
        PayloadIn {
            ...
            request: Box::new(DeviceControlRequest {
                ...
                output_buffer_length: 2048,
                input_buffer_length: 56,
                io_control_code: IoctlCode::SCARD_IOCTL_ENDTRANSACTION,
            }),
            scard_ctl: Some(Box::new(HCardAndDisposition_Call {
                handle: Handle {
                    context: Context {
...
#[test]
fn test_scard_ioctl_disconnect() {
    let context_value = 5;
    let mut c = client(true, context_value, Some(context_value - 1));
    ...
    test_payload_in_to_response_out(
        ...
        PayloadIn {
            ...
            request: Box::new(DeviceControlRequest {
                ...
                output_buffer_length: 2048,
                input_buffer_length: 56,
                io_control_code: IoctlCode::SCARD_IOCTL_DISCONNECT,
            }),
            scard_ctl: Some(Box::new(HCardAndDisposition_Call {
                handle: Handle {
                    context: Context {
