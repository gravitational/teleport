...
impl Client {
    ...
    pub fn ioctl(&mut self, code: u32, input: &mut PayloadIn) -> RdpResult<(u32, Vec<u8>)> {
    ...
    fn handle_access_started_event(&self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
    ...
    fn handle_establish_context(&mut self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
    ...
    fn handle_release_context(&mut self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
    ...
    fn handle_cancel(&self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
        let req = Context_Call::decode(input)?;
        debug!("got {:?}", req);
        let resp = Long_Return::new(ReturnCode::SCARD_S_SUCCESS);
        debug!("sending {:?}", resp);
    ...
    fn handle_is_valid_context(&self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
        let req = Context_Call::decode(input)?;
        debug!("got {:?}", req);
        let resp = Long_Return::new(ReturnCode::SCARD_S_SUCCESS);
        debug!("sending {:?}", resp);
    ...
    fn handle_list_readers(&self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
    ...
    fn handle_get_status_change(&self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
    ...
    fn handle_connect(&mut self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
    ...
    fn handle_disconnect(&mut self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
    ...
    fn handle_begin_transaction(&self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
        let req = HCardAndDisposition_Call::decode(input)?;
        debug!("got {:?}", req);
        let resp = Long_Return::new(ReturnCode::SCARD_S_SUCCESS);
        debug!("sending {:?}", resp);
    ...
    fn handle_end_transaction(&self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
        let req = HCardAndDisposition_Call::decode(input)?;
        debug!("got {:?}", req);
        let resp = Long_Return::new(ReturnCode::SCARD_S_SUCCESS);
        debug!("sending {:?}", resp);
    ...
    fn handle_transmit(&mut self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
    ...
    fn handle_get_device_type_id(&mut self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
    ...
    fn handle_read_cache(&mut self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
    ...
    fn handle_write_cache(&mut self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
    ...
    fn handle_get_reader_icon(&mut self, input: &mut PayloadIn) -> RdpResult<Option<Vec<u8>>> {
...
impl RPCEStreamHeader {
    ...
    fn encode(&self) -> RdpResult<MessageOut> {
        let mut w = vec![];
    ...
    fn decode(payload: &mut PayloadIn) -> RdpResult<Self> {
        let header = Self {
...
impl Context {
    ...
    fn decode_ptr(payload: &mut PayloadIn, index: &mut u32) -> RdpResult<Self> {
        let length = payload.read_u32::<LittleEndian>()?;
        let _ptr = decode_ptr(payload, index)?;
        Ok(Self { length, value: 0 })
    }
    fn decode_value(&mut self, payload: &mut PayloadIn) -> RdpResult<()> {
        let length = payload.read_u32::<LittleEndian>()?;
...
fn decode_ptr(payload: &mut PayloadIn, index: &mut u32) -> RdpResult<u32> {
...
// dump).
fn decode_multistring_unicode(payload: &mut PayloadIn) -> RdpResult<(u32, Vec<String>)> {
...
fn decode_string_unicode(payload: &mut PayloadIn) -> RdpResult<String> {
...
fn debug_print_payload(payload: &mut PayloadIn) {
