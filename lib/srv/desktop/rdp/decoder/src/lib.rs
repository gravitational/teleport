    ...
    pub fn new(width: u16, height: u16) -> Self {
        Self {
            ...
            fast_path_processor: ProcessorBuilder {
                ...
                io_channel_id: 0,
                user_channel_id: 0,
                // v18 backport: this IronRDP rev exposes the inverted
                // `no_server_pointer` field instead of `enable_server_pointer`.
                // `enable_server_pointer: false` == `no_server_pointer: true`.
