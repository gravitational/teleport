...
// It accepts optional interceptors to intercept received messages.
func NewConnProxy(client, server io.ReadWriteCloser, serverInterceptor Interceptor, clientInterceptor Interceptor) *ConnProxy {
	return &ConnProxy{
