...
func TestWatcher(t *testing.T) {
	...
	azPostgresServerUnknownVersion, azPostgresDBUUnknownVersion := makeAzurePostgresServer(t, "server-6", subscription1, group1, eastus, nil, withAzurePostgresVersion("unknown"))
