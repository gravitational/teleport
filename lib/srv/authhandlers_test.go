...
// mockScopedRoleGetter is a mock implementation of ScopedRoleGetter for testing. It implementes the entire
...
func TestScopedRBAC(t *testing.T) {
	t.Setenv("TELEPORT_UNSTABLE_AGENT_SCOPE", "/staging/west")
