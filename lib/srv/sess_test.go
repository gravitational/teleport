...
type fakeAccessChecker struct {
	...
	err      error
	hostInfo decisionpb.HostUsersInfo
}
...
func (f *fakeHostUsersBackend) UpsertUser(name string, hostRoleInfo decisionpb.HostUsersInfo, takeOwnerhip bool) (io.Closer, error) {
	if f.users == nil {
