...
func MergeResources(results ...*Resources) *Resources {
	...
	for _, r := range results {
		...
		result.CloudHSMClusters = append(result.CloudHSMClusters, r.CloudHSMClusters...)
	}
...
func deduplicateResources(result *Resources) {
	...
	result.CloudHSMClusters = deduplicateSlice(result.CloudHSMClusters, cloudHSMClusterKey)
}
