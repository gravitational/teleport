...
type AuthInfoService interface {
	...
	GetAuthInfo(ctx context.Context) (*authinfo.AuthInfo, error)
	// CreateAuthInfo creates the AuthInfo singleton resource.
	CreateAuthInfo(ctx context.Context, info *authinfo.AuthInfo) (*authinfo.AuthInfo, error)
	// UpdateAuthInfo updates the AuthInfo singleton resource.
	UpdateAuthInfo(ctx context.Context, info *authinfo.AuthInfo) (*authinfo.AuthInfo, error)
