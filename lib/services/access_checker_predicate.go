...
// CheckLoginDuration checks if role set can log in up to given duration and
...
// GetAllowedSearchAsRoles returns all the allowed SearchAsRoles.
func (a *accessCheckerPredicate) GetAllowedSearchAsRoles() []string {
	return []string{}
}

// GetAllowedPreviewAsRoles returns all the allowed PreviewAsRoles.
...
func (a *accessCheckerPredicate) Traits() wrappers.Traits {
	//TODO implement me
	panic("implement me")
}

func (a *accessCheckerPredicate) EnumerateEntities(resource AccessCheckable, listFn roleEntitiesListFn, newMatcher roleMatcherFactoryFn, extraEntities ...string) EnumerationResult {
	//TODO implement me
	panic("implement me")
}

func (a *accessCheckerPredicate) EnumerateDatabaseUsers(database types.Database, extraUsers ...string) EnumerationResult {
	//TODO implement me
	panic("implement me")
}

func (a *accessCheckerPredicate) EnumerateDatabaseNames(database types.Database, extraNames ...string) EnumerationResult {
	//TODO implement me
	panic("implement me")
}

func (a *accessCheckerPredicate) GetAllowedLoginsForResource(resource AccessCheckable) ([]string, error) {
	//TODO implement me
	panic("implement me")
}
