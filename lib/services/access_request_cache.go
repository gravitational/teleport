...
type AccessRequestCache struct {
	...
	primaryCache *sortcache.SortCache[*types.AccessRequestV3, accessRequestCacheIndex, string]
...
func (c *AccessRequestCache) fetch(ctx context.Context) (*sortcache.SortCache[*types.AccessRequestV3, accessRequestCacheIndex, string], error) {
	cache := sortcache.New(sortcache.Config[*types.AccessRequestV3, accessRequestCacheIndex, string]{
...
func (c *AccessRequestCache) read(ctx context.Context) (*sortcache.SortCache[*types.AccessRequestV3, accessRequestCacheIndex, string], error) {
	c.rw.RLock()
	...
	temp, err := utils.FnCacheGet(ctx, c.ttlCache, "access-request-cache", func(ctx context.Context) (*sortcache.SortCache[*types.AccessRequestV3, accessRequestCacheIndex, string], error) {
		return c.fetch(ctx)
	})
