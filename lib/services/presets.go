		...
		Spec: types.RoleSpecV6{
			...
			Allow: types.RoleConditions{
				...
				Rules: []types.Rule{
					...
					types.NewRule(types.KindSummarizationInferenceModel, RW()),
					types.NewRule(types.KindSummarizationInferenceSecret, RW()),
					types.NewRule(types.KindSummarizationInferencePolicy, RW()),
				},
			},
		},
	}
