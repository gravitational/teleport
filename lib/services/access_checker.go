...
//   full RoleSet
func NewAccessChecker(ctx context.Context, info *AccessInfo, localCluster string, access RoleGetter) (AccessChecker, error) {
	roleSet, err := FetchRoles(ctx, info.Roles, access, info.Traits)
	if err != nil {
