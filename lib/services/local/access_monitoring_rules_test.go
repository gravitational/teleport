...
func TestListAccessMonitoringRulesWithFilter(t *testing.T) {
	tests := []struct {
		...
		{
			description: "filter by notification name",
			rule: &accessmonitoringrulesv1.AccessMonitoringRule{
				Kind:    types.KindAccessMonitoringRule,
				Version: types.V1,
				Metadata: &v1.Metadata{
		...
		{
			description: "filter by automatic_approval name",
			rule: &accessmonitoringrulesv1.AccessMonitoringRule{
				Kind:    types.KindAccessMonitoringRule,
				Version: types.V1,
				Metadata: &v1.Metadata{
		...
		{
			description: "filter by both notification and automatic_approval name",
			rule: &accessmonitoringrulesv1.AccessMonitoringRule{
				Kind:    types.KindAccessMonitoringRule,
				Version: types.V1,
				Metadata: &v1.Metadata{
		...
		{
			description: "filter by native automatic_approval rules",
			rule: &accessmonitoringrulesv1.AccessMonitoringRule{
				Kind:    types.KindAccessMonitoringRule,
				Version: types.V1,
				Metadata: &v1.Metadata{
					Name: "example-native-automatic_approval-rule",
				},
				Spec: &accessmonitoringrulesv1.AccessMonitoringRuleSpec{
					Subjects:  []string{types.KindAccessRequest},
					Condition: "someCondition",
