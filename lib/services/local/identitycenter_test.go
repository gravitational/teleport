...
func TestIdentityCenterResourceCRUD(t *testing.T) {
	...
	testCases := []struct {
		name               string
		createResource     func(*testing.T, context.Context, services.IdentityCenterInternal, string) types.Resource153
		getResource        func(context.Context, services.IdentityCenterInternal, string) (types.Resource153, error)
		updateResource     func(context.Context, services.IdentityCenterInternal, types.Resource153) (types.Resource153, error)
		upsertResource     func(context.Context, services.IdentityCenterInternal, types.Resource153) (types.Resource153, error)
		deleteAllResources func(context.Context, services.IdentityCenterInternal) error
	}{
		{
			name: "Account",
			createResource: func(subtestT *testing.T, subtestCtx context.Context, svc services.IdentityCenterInternal, id string) types.Resource153 {
				return makeTestIdentityCenterAccount(subtestT, subtestCtx, svc, id)
			},
			getResource: func(subtestCtx context.Context, svc services.IdentityCenterInternal, id string) (types.Resource153, error) {
				return svc.GetIdentityCenterAccount(subtestCtx, id)
			},
			updateResource: func(subtestCtx context.Context, svc services.IdentityCenterInternal, r types.Resource153) (types.Resource153, error) {
				acct := r.(*identitycenterv1.Account)
				return svc.UpdateIdentityCenterAccount(subtestCtx, acct)
			},
			upsertResource: func(subtestCtx context.Context, svc services.IdentityCenterInternal, r types.Resource153) (types.Resource153, error) {
				acct := r.(*identitycenterv1.Account)
				return svc.UpsertIdentityCenterAccount(subtestCtx, acct)
			},
			deleteAllResources: func(subtestCtx context.Context, svc services.IdentityCenterInternal) error {
		...
		},
		{
			...
			getResource: func(subtestCtx context.Context, svc services.IdentityCenterInternal, id string) (types.Resource153, error) {
				return svc.GetPermissionSet(subtestCtx, id)
			},
			updateResource: func(subtestCtx context.Context, svc services.IdentityCenterInternal, r types.Resource153) (types.Resource153, error) {
		...
		},
		{
			...
			getResource: func(subtestCtx context.Context, svc services.IdentityCenterInternal, id string) (types.Resource153, error) {
				return svc.GetAccountAssignment(subtestCtx, id)
			},
			updateResource: func(subtestCtx context.Context, svc services.IdentityCenterInternal, r types.Resource153) (types.Resource153, error) {
		...
		},
		{
			...
			getResource: func(subtestCtx context.Context, svc services.IdentityCenterInternal, id string) (types.Resource153, error) {
				return svc.GetPrincipalAssignment(subtestCtx, id)
			},
			updateResource: func(subtestCtx context.Context, svc services.IdentityCenterInternal, r types.Resource153) (types.Resource153, error) {
	...
	for _, test := range testCases {
		t.Run(test.name, func(t *testing.T) {
			...
			t.Run("DeleteAllResources", func(t *testing.T) {
				...
				err = test.deleteAllResources(ctx, uut)
				require.NoError(t, err)
...
func makeTestIdentityCenterAccountAssignment(t *testing.T, ctx context.Context, svc services.IdentityCenter, id string) *identitycenterv1.AccountAssignment {
	t.Helper()
	created, err := svc.CreateAccountAssignment(ctx, &identitycenterv1.AccountAssignment{
