...
func cloneVirtualDefaultDB() *healthcheckconfigv1.HealthCheckConfig {
	// Clone to avoid race conditions in parallel tests.
	return proto.Clone(services.VirtualDefaultHealthCheckConfigDB()).(*healthcheckconfigv1.HealthCheckConfig)
}

func cloneVirtualDefaultKube() *healthcheckconfigv1.HealthCheckConfig {
	// Clone to avoid race conditions in parallel tests.
	return proto.Clone(services.VirtualDefaultHealthCheckConfigKube()).(*healthcheckconfigv1.HealthCheckConfig)
}

func newHealthCfgDefaults(t *testing.T) []*healthcheckconfigv1.HealthCheckConfig {
	t.Helper()
	return []*healthcheckconfigv1.HealthCheckConfig{
		cloneVirtualDefaultDB(),
		cloneVirtualDefaultKube(),
	}
}
...
func newHealthCfgDefaultsMap(t *testing.T) map[string]*healthcheckconfigv1.HealthCheckConfig {
	...
	return map[string]*healthcheckconfigv1.HealthCheckConfig{
		teleport.VirtualDefaultHealthCheckConfigDBName:   cloneVirtualDefaultDB(),
		teleport.VirtualDefaultHealthCheckConfigKubeName: cloneVirtualDefaultKube(),
	}
}
