...
func (s *accessListAndMembersGetter) ListAccessListMembers(ctx context.Context, accessListName string, pageSize int, pageToken string) ([]*accesslist.AccessListMember, string, error) {
	return s.ListAccessListMembersV2(ctx, accesslist.ScopeQualifiedName{Name: accessListName}, pageSize, pageToken)
}

func (s *accessListAndMembersGetter) ListAccessListMembersV2(ctx context.Context, accessListName accesslist.ScopeQualifiedName, pageSize int, pageToken string) ([]*accesslist.AccessListMember, string, error) {
	membersService, err := membersServiceForAccessList(s.memberService, accessListName)
	if err != nil {
...
func (s *accessListAndMembersGetter) GetAccessListMember(ctx context.Context, accessListName, memberName string) (*accesslist.AccessListMember, error) {
	return s.GetAccessListMemberV2(ctx, accesslist.ScopeQualifiedName{Name: accessListName}, accesslist.ScopeQualifiedName{Name: memberName})
}

// GetAccessListMemberV2 returns the specified access list member resource.
// If a user is not directly a member of the access list the NotFound error is returned.
func (s *accessListAndMembersGetter) GetAccessListMemberV2(ctx context.Context, accessListName, memberName accesslist.ScopeQualifiedName) (*accesslist.AccessListMember, error) {
...
func membersServiceForAccessList(
	...
	listName accesslist.ScopeQualifiedName,
) (*membersService, error) {
	service, err := genericService.WithScopedResourcePrefix(accesslists.ToScopesQualifiedName(listName))
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func memberServiceForNamedMember(
	...
	listName, memberName accesslist.ScopeQualifiedName,
) (*memberService, error) {
	service, err := membersService.WithScopedResourcePrefix(accesslists.ToScopesQualifiedName(listName))
	if err != nil {
		return nil, trace.Wrap(err)
	}
	...
	return &memberService{
		service:    service,
		memberName: accesslists.ScopeQualifiedNameToString(memberName),
	}, nil
}
...
func (a *AccessListService) runOpWithLock(ctx context.Context, accessList *accesslist.AccessList, op opType) (*accesslist.AccessList, error) {
	...
	membersService, err := a.membersServiceForAccessList(accessList.GetScopeQualifiedName())
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *AccessListService) CountAccessListMembers(ctx context.Context, accessListName string) (users uint32, lists uint32, err error) {
	return a.CountAccessListMembersV2(ctx, accesslist.ScopeQualifiedName{Name: accessListName})
}

// CountAccessListMembersV2 will count all access list members.
func (a *AccessListService) CountAccessListMembersV2(ctx context.Context, accessListName accesslist.ScopeQualifiedName) (users uint32, lists uint32, err error) {
	count := uint(0)
	listCount := uint(0)
...
func (a *AccessListService) ListAccessListMembers(ctx context.Context, accessListName string, pageSize int, nextToken string) ([]*accesslist.AccessListMember, string, error) {
	return a.ListAccessListMembersV2(ctx, accesslist.ScopeQualifiedName{Name: accessListName}, pageSize, nextToken)
}

// ListAccessListMembersV2 returns a paginated list of all members of the given list.
func (a *AccessListService) ListAccessListMembersV2(ctx context.Context, accessListName accesslist.ScopeQualifiedName, pageSize int, nextToken string) ([]*accesslist.AccessListMember, string, error) {
	...
	return membersService.listResources(ctx, pageSize, nextToken)
}
...
func (a *AccessListService) GetAccessListMember(ctx context.Context, accessList string, memberName string) (*accesslist.AccessListMember, error) {
	return a.GetAccessListMemberV2(ctx, accesslist.ScopeQualifiedName{Name: accessList}, accesslist.ScopeQualifiedName{Name: memberName})
}

// GetAccessListMemberV2 returns the specified access list member resource.
func (a *AccessListService) GetAccessListMemberV2(ctx context.Context, accessListName, memberName accesslist.ScopeQualifiedName) (*accesslist.AccessListMember, error) {
	_, err := a.getAccessList(ctx, accessListName)
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
// memberServiceForNamedMember returns a [*memberService] valid for only the
// exact named member, with an appropriate backend prefix and NameKeyFunc configured.
func (a *AccessListService) memberServiceForNamedMember(listName, memberName accesslist.ScopeQualifiedName) (*memberService, error) {
...
// get, create, or delete any single member, use [memberServiceForNamedMember]
// in those cases.
func (a *AccessListService) membersServiceForAccessList(listName accesslist.ScopeQualifiedName) (*membersService, error) {
...
func (a *AccessListService) updateAccessListMemberOf(ctx context.Context, accessListName, memberName accesslist.ScopeQualifiedName, new bool) error {
...
func (a *AccessListService) DeleteAccessListMember(ctx context.Context, accessList string, memberName string) error {
	return a.DeleteAccessListMemberV2(ctx, accesslist.ScopeQualifiedName{Name: accessList}, accesslist.ScopeQualifiedName{Name: memberName})
}

// DeleteAccessListMemberV2 hard deletes the specified access list member resource.
func (a *AccessListService) DeleteAccessListMemberV2(ctx context.Context, accessListName, memberName accesslist.ScopeQualifiedName) error {
...
func (a *AccessListService) DeleteAllAccessListMembersForAccessList(ctx context.Context, accessList string) error {
	return a.DeleteAllAccessListMembersForAccessListV2(ctx, accesslist.ScopeQualifiedName{Name: accessList})
}
...
// allowed on a list with implicit membership, as it provides a mechanism for
// cleaning out the user list if a list is converted from explicit to implicit.
func (a *AccessListService) DeleteAllAccessListMembersForAccessListV2(ctx context.Context, accessListName accesslist.ScopeQualifiedName) error {
	membersService, err := a.membersServiceForAccessList(accessListName)
	if err != nil {
		return trace.Wrap(err)
	}
...
func (a *AccessListService) writeAccessListWithMembers(ctx context.Context, accessList *accesslist.AccessList, membersIn []*accesslist.AccessListMember, op opType) (*accesslist.AccessList, []*accesslist.AccessListMember, error) {
	...
	reconcileMembers := func() error {
		...
		membersMap := make(map[accesslist.ScopeQualifiedName]*accesslist.AccessListMember, len(membersIn))
		...
		for existingMember, err := range membersService.resources(ctx, "", "") {
			...
			memberService, err := a.memberServiceForNamedMember(accessList.GetScopeQualifiedName(), existingMemberName)
			if err != nil {
				return trace.Wrap(err)
			}
			...
			if newMember, ok := membersMap[existingMemberName]; !ok {
				...
				if existingMember.IsList() != newMember.IsList() {
					if err := a.updateAccessListMemberOf(ctx, accessList.GetScopeQualifiedName(), existingMemberName, newMember.IsList()); err != nil {
						return trace.Wrap(err)
					}
				}
			}
		...
		if err := a.insertMembersAndUpdateNestedRelationships(ctx, accessList.GetScopeQualifiedName(), slices.Collect(maps.Values(membersMap))); err != nil {
			return trace.Wrap(err)
		}
		return nil
	}
...
func (a *AccessListService) CreateAccessListReview(ctx context.Context, review *accesslist.Review) (*accesslist.Review, time.Time, error) {
	...
	err = a.service.RunWhileLocked(ctx, lockName(review.Spec.AccessList), accessListLockTTL, func(ctx context.Context, _ backend.Backend) error {
		...
		// TODO(nklaassen): support scoped access list reviews.
		reviewedListName := accesslist.ScopeQualifiedName{Name: review.Spec.AccessList}
		...
		for _, removedMember := range review.Spec.Changes.RemovedMembers {
			...
			if isAccessListMember {
				if err := a.updateAccessListMemberOf(ctx, reviewedListName, accesslist.ScopeQualifiedName{Name: removedMember}, false); err != nil {
					return trace.Wrap(err)
				}
			}
...
func (a *AccessListService) insertMembersAndUpdateNestedRelationships(ctx context.Context, accessListName accesslist.ScopeQualifiedName, members []*accesslist.AccessListMember) error {
...
func (a *AccessListService) insertMembers(ctx context.Context, acl accesslist.ScopeQualifiedName, members []*accesslist.AccessListMember) error {
...
func (a *AccessListService) membersToBackendItems(acl accesslist.ScopeQualifiedName, members []*accesslist.AccessListMember) ([]backend.Item, error) {
...
func (a *AccessListService) CleanupAccessListStatusV2(ctx context.Context, accessListName accesslist.ScopeQualifiedName) (*accesslist.AccessList, error) {
	return a.runWithGlobalLockAccessList(ctx, accessListName, func() (*accesslist.AccessList, error) {
		...
		accessList.Status.ScopedMemberOf = slices.DeleteFunc(accessList.Status.ScopedMemberOf, func(scopedMemberOf string) bool {
			...
			memberService, err := a.memberServiceForNamedMember(parentListName, accessList.GetScopeQualifiedName())
			if err != nil {
				memberRefreshErr = err
				return false
			}
