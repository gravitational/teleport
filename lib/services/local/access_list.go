...
func (a *AccessListService) runOpWithLock(ctx context.Context, accessList *accesslist.AccessList, op opType) (*accesslist.AccessList, error) {
	...
	validateAccessList := func() error {
		...
		if err := a.checkScopedRoleGrants(ctx, existingAccessList, accessList); err != nil {
			return trace.Wrap(err)
		}
...
func (a *AccessListService) checkScopedRoleGrants(ctx context.Context, existingList, newList *accesslist.AccessList) error {
