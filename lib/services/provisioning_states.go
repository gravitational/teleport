...
// DownstreamID holds the configured ID of a downstream SCIM server
...
// differentiated with a DownstreamID when queried or updated.
type ProvisioningStateID string

// ProvisioningStates defines an interface doe interacting with a ProvisioningState
// storage service
type ProvisioningStates interface {
	...
	ListProvisioningStates(context.Context, DownstreamID, *pagination.PageRequestToken) ([]*provisioningv1.PrincipalState, pagination.NextPageToken, error)
	CreateProvisioningState(context.Context, DownstreamID, *provisioningv1.PrincipalState) (*provisioningv1.PrincipalState, error)
	UpdateProvisioningState(context.Context, DownstreamID, *provisioningv1.PrincipalState) (*provisioningv1.PrincipalState, error)
	DeleteProvisioningState(context.Context, DownstreamID, ProvisioningStateID) error
	DeleteAllProvisioningStates(context.Context, DownstreamID) error
}
