...
// UnmarshalResetPasswordTokenSecrets unmarshals the ResetPasswordTokenSecrets resource.
...
// MarshalResetPasswordTokenSecrets marshals the ResetPasswordTokenSecrets resource.
