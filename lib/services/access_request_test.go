	...
	roleDesc := map[string]types.RoleSpecV6{
		"kube-access-wildcard": {
			Allow: types.RoleConditions{
				...
				KubernetesResources: []types.KubernetesResource{
					{Kind: "*", Namespace: "*", Name: "*", Verbs: []string{"*"}, Group: "*"},
				},
			},
		},
		"kube-no-access": {
		...
		"kube-access-namespace": {
			Allow: types.RoleConditions{
				...
				KubernetesResources: []types.KubernetesResource{
					{Kind: types.KindNamespace, Namespace: "*", Name: "*", Verbs: []string{"*"}, Group: "*"},
				},
			},
		},
		"kube-access-pod": {
			Allow: types.RoleConditions{
				...
				KubernetesResources: []types.KubernetesResource{
					{Kind: types.KindKubePod, Namespace: "*", Name: "*", Verbs: []string{"*"}, Group: "*"},
				},
			},
		},
		"kube-access-deployment": {
			Allow: types.RoleConditions{
				...
				KubernetesResources: []types.KubernetesResource{
					{Kind: types.KindKubeDeployment, Namespace: "*", Name: "*", Verbs: []string{"*"}, Group: "*"},
				},
			},
		},
		"db-access-wildcard": {
