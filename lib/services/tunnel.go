...
func MarshalReverseTunnel(t ReverseTunnel, opts ...MarshalOption) ([]byte, error) {
	cfg, err := CollectOptions(opts)
	if err != nil {
		return nil, trace.Wrap(err)
	}
	...
	default:
		return nil, trace.BadParameter("unrecognized reverse tunnel version %T", t)
	}
}
