...
// DefaultIssuerURL is the issuer URL for Env0
const DefaultIssuerURL = "https://login.app.env0.com/"
...
type IDTokenValidatorConfig struct {
	// issuerHostnameOverride overrides the default Env0 issuer URL. Used only in
	// tests.
...
// Validate validates an Env0 issued ID token.
