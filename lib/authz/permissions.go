		...
		return services.RoleFromSpec(
			...
			types.RoleSpecV6{
				Allow: types.RoleConditions{
					...
					AppLabels:            types.Labels{types.Wildcard: {types.Wildcard}},
					DatabaseLabels:       types.Labels{types.Wildcard: {types.Wildcard}},
					KubernetesLabels:     types.Labels{types.Wildcard: {types.Wildcard}},
