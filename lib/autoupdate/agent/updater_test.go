		...
		t.Run(tt.name, func(t *testing.T) {
			for _, tbot := range []bool{false, true} {
				...
				updater.Installer = &testInstaller{
					FuncInstall: func(_ context.Context, rev Revision, baseURL string, force bool, insecureSkipArtifactSignature bool) error {
...
type testInstaller struct {
	FuncInstall       func(ctx context.Context, rev Revision, baseURL string, force bool, insecureSkipArtifactSignature bool) error
...
func (ti *testInstaller) Install(ctx context.Context, rev Revision, baseURL string, force bool, insecureSkipArtifactSignature bool) error {
	return ti.FuncInstall(ctx, rev, baseURL, force, insecureSkipArtifactSignature)
}
