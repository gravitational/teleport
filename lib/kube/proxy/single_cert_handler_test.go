	...
	tests := []struct {
		...
		},
		{
			...
			roleSpec: RoleSpec{
				...
				SetupRoleFunc: func(r types.Role) {
					r.SetKubeResources(types.Deny, []types.KubernetesResource{{Kind: types.KindKubePod, Name: types.Wildcard, Namespace: types.Wildcard, Verbs: []string{types.Wildcard}, Group: types.Wildcard}})
				},
			},
			assert: func(t *testing.T, restConfig *rest.Config) {
		...
		},
		{
			...
			roleSpec: RoleSpec{
				...
				KubeGroups: roleKubeGroups,
				SetupRoleFunc: func(r types.Role) {
					r.SetKubeResources(types.Allow, []types.KubernetesResource{{Kind: types.KindKubePod, Name: types.Wildcard, Namespace: types.Wildcard, Verbs: []string{types.Wildcard}, Group: types.Wildcard}})
