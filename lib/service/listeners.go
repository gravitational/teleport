...
var (
	...
	ListenerProxySSH   = ListenerType(teleport.CompoundComponent(teleport.ComponentProxy, "ssh"))
	ListenerDiagnostic = ListenerType(teleport.ComponentDiagnostic)
	ListenerProxyKube  = ListenerType(teleport.CompoundComponent(teleport.ComponentProxy, "kube"))
	...
	ListenerProxyTunnelAndWeb = ListenerType(teleport.CompoundComponent(teleport.ComponentProxy, "tunnel", "web"))
	ListenerProxyWeb          = ListenerType(teleport.CompoundComponent(teleport.ComponentProxy, "web"))
	ListenerProxyTunnel       = ListenerType(teleport.CompoundComponent(teleport.ComponentProxy, "tunnel"))
	ListenerProxyMySQL        = ListenerType(teleport.CompoundComponent(teleport.ComponentProxy, "mysql"))
	ListenerProxyPostgres     = ListenerType(teleport.CompoundComponent(teleport.ComponentProxy, "postgres"))
	ListenerProxyMongo        = ListenerType(teleport.CompoundComponent(teleport.ComponentProxy, "mongo"))
	ListenerProxyPeer         = ListenerType(teleport.CompoundComponent(teleport.ComponentProxy, "peer"))
