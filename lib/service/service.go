...
func (process *TeleportProcess) initAuthService() error {
	...
	recordingMetadataService := recordingmetadatav1.NewRecordingMetadata(recordingmetadatav1.RecordingMetadataConfig{
		Streamer:      authServer,
		UploadHandler: authServer,
	})
	recordingMetadataProvider.SetRecordingMetadata(recordingMetadataService)
