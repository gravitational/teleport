...
func (process *TeleportProcess) initSSH() error {
	...
	process.RegisterCriticalFunc("ssh.node", func() error {
		...
		if explicitListen {
			logger.InfoContext(process.ExitContext(), "---- TELEPORT_UNSTABLE_EXPLICIT_SSH_LISTEN was set, enabling local listener for tunnel node", "listen_addr", cfg.SSH.Addr.String())
		}
