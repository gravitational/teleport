...
// TargetDialer health-checks network endpoints by dialing them with a
// configurable protocol and resolver.
...
// CheckAndSetDefaults checks and sets default values for the target dialer.
...
// dialEndpoints dials multiple endpoints.
...
// defaultDialer returns a new net.Dialer.
