...
type resourceKey struct {
	...
	kind string
	// origin is the target resource origin.
	origin string
}

func (r resourceKey) String() string {
	return fmt.Sprintf("name=%s, kind=%s, origin=%s", r.name, r.kind, r.origin)
}
