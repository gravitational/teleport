...
// TestGetAccessListsForReview tests the "teleport_get_access_lists_for_review" MCP tool.
func TestGetAccessListsForReview(t *testing.T) {
	...
	res, err := env.mcpClient.CallTool(env.ctx, mcp.CallToolRequest{
		Params: mcp.CallToolParams{
			Name: "teleport_get_access_lists_for_review",
		},
	})
...
// TestReviewAccessList tests the "teleport_review_access_list" MCP tool.
func TestReviewAccessList(t *testing.T) {
	...
	_, err := env.mcpClient.CallTool(env.ctx, mcp.CallToolRequest{
		Params: mcp.CallToolParams{
			Name: "teleport_review_access_list",
