...
func (c *Client) GetTokens(ctx context.Context, opts ...auth.MarshalOption) ([]services.ProvisionToken, error) {
...
type clientProvisioning interface {
	// GetTokens returns a list of active invitation tokens for nodes and users
	GetTokens(ctx context.Context, opts ...auth.MarshalOption) (tokens []services.ProvisionToken, err error)
