...
// GetAutoUpdateAgentReport gets the current AutoUpdateAgentReport singleton.
...
// CreateAutoUpdateAgentReport creates AutoUpdateAgentReport singleton.
...
// UpdateAutoUpdateAgentReport updates AutoUpdateAgentReport singleton.
...
// UpsertAutoUpdateAgentReport updates or creates AutoUpdateAgentReport singleton.
...
// DeleteAutoUpdateAgentReport deletes AutoUpdateAgentReport singleton.
...
func (s *Service) DeleteAllAutoUpdateAgentReports(ctx context.Context, req *autoupdate.DeleteAllAutoUpdateAgentReportsRequest) (*emptypb.Empty, error) {
	authCtx, err := s.authorizer.Authorize(ctx)
	if err != nil {
		return nil, trace.Wrap(err)
	}
	...
	if err := s.backend.DeleteAllAutoUpdateAgentReports(ctx); err != nil {
		return nil, trace.Wrap(err)
	}
	return &emptypb.Empty{}, nil
}
