...
// See Login.
func AttemptLogin(origin, user string, assertion *webauthntypes.CredentialAssertion, picker CredentialPicker) (*webauthntypes.CredentialAssertionResponse, string, error) {
