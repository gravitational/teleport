...
func (p *ProcessStorage) GetTeleportVersion(ctx context.Context, _ string) (*semver.Version, error) {
...
func (p *ProcessStorage) WriteTeleportVersion(ctx context.Context, _ string, version *semver.Version) error {
	if version == nil {
