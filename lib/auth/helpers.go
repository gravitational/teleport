...
func (s FakeTeleportVersion) GetTeleportVersion(_ context.Context, _ string) (*semver.Version, error) {
	return teleport.SemVersion, nil
}

// WriteTeleportVersion stub function for writing.
func (s FakeTeleportVersion) WriteTeleportVersion(_ context.Context, _ string, _ *semver.Version) error {
	return nil
}
