...
const (
	...
	SAMLSigningKeyExpiryTimeframe        = samlSigningKeyExpiryTimeframe
	SAMLSigningKeyExpiryNotificationName = samlSigningKeyExpiryNotificationName
)
...
func (a *Server) CheckSAMLSigningKeyExpiry(ctx context.Context) error {
	return a.checkSAMLSigningKeyExpiry(ctx)
}
