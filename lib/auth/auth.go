...
func NewServer(cfg *InitConfig, opts ...ServerOption) (*Server, error) {
	...
	if cfg.DatabaseObjectImportRule == nil {
		cfg.DatabaseObjectImportRule, err = local.NewDatabaseObjectImportRuleService(cfg.Backend)
		if err != nil {
			return nil, trace.Wrap(err)
		}
	}
	...
	services := &Services{
		...
		DatabaseObjectImportRule: cfg.DatabaseObjectImportRule,
