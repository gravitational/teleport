...
func NewServer(cfg *InitConfig, opts ...ServerOption) (*Server, error) {
	...
	if cfg.RecordingEncryption == nil {
		cfg.RecordingEncryption, err = local.NewRecordingEncryptionService(cfg.Backend, cfg.Logger)
	}
	...
	services := &Services{
		...
		RecordingEncryptionServiceInternal: cfg.RecordingEncryption,
	}
...
type Services struct {
	...
	services.RecordingEncryptionServiceInternal
}
