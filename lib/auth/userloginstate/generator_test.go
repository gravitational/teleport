...
func newUserLoginState(t *testing.T, name string, labels map[string]string, originalRoles []string, originalTraits map[string][]string,
	roles []string, traits map[string][]string, inheritedRoles []string, inheritedTraits map[string][]string) *userloginstate.UserLoginState {
	t.Helper()
