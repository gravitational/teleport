...
type CreateAppSessionForV15Client = authclient.CreateAppSessionForV15Client
...
func TryCreateAppSessionForClientCertV15(ctx context.Context, client CreateAppSessionForV15Client, username string, routeToApp proto.RouteToApp) (string, error) {
	return authclient.TryCreateAppSessionForClientCertV15(ctx, client, username, routeToApp)
}
