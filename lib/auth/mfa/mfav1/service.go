...
func NewService(cfg ServiceConfig) (*Service, error) {
	if cfg.AuthServer == nil {
		return nil, trace.BadParameter("auth server is required for mfa service")
	}
...
func (s *Service) ValidateSessionChallenge(
	...
	// TODO(cthach): Validate the challenge response and store it in the backend for later retrieval.
...
func validateCreateSessionChallengeRequest(req *mfav1.CreateSessionChallengeRequest) error {
	...
	// TODO(cthach): Validate TargetCluster is a valid cluster name.
