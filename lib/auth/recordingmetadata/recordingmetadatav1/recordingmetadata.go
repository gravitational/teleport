...
loop:
	for {
		...
		case evt := <-evts:
			...
			case *apievents.SessionStart:
				...
				metadata.Metadata.ClusterName = e.ClusterName
	...
	metadata.Metadata.StartTime = timestamppb.New(startTime)
	metadata.Metadata.EndTime = timestamppb.New(lastEvent.GetTime())
