...
// These are stub implementations of CGO callbacks that the full RDP client
// library expects. Since we're only using the decoder functionality,
// these will never be called, but they need to exist for linking.
