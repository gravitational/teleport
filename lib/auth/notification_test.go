...
func TestNotifications(t *testing.T) {
	...
	require.NoError(t, err)
	require.NotEqual(t, resp.Notifications[0].GetMetadata().GetLabels()[types.NotificationTitleLabel], "all-except-manager")
	...
	require.NoError(t, err)
	require.Equal(t, resp.Notifications[0].GetMetadata().GetLabels()[types.NotificationTitleLabel], "all-except-manager")
