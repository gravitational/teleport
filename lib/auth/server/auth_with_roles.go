...
// TODO(dmitri): rename to WithRoles
type ServerWithRoles struct { //nolint:golint
	authServer *Server
...
func (a *ServerWithRoles) actionWithContext(ctx *auth.Context, namespace string, resource string, action string) error {
...
func (a *ServerWithRoles) action(namespace string, resource string, action string, opts ...actionOption) error {
	...
	return utils.OpaqueAccessDenied(a.context.Checker.CheckAccessToRule(&auth.Context{User: a.context.User}, namespace, resource, action, cfg.quiet))
}
...
func (a *ServerWithRoles) currentUserAction(username string) error {
	...
	return utils.OpaqueAccessDenied(
		a.context.Checker.CheckAccessToRule(&auth.Context{User: a.context.User},
...
func (a *ServerWithRoles) authConnectorAction(namespace string, resource string, verb string) error {
	if err := a.context.Checker.CheckAccessToRule(&auth.Context{User: a.context.User}, namespace, resource, verb, true); err != nil {
...
// not.
func hasRemoteUserRole(checker auth.AccessChecker) bool {
	_, ok := checker.(RemoteUserRoleSet)
	return ok
}

// hasLocalUserRole checks if the type of the role set is a local user or not.
func hasLocalUserRole(checker auth.AccessChecker) bool {
...
func (a *ServerWithRoles) GetCertAuthorities(caType services.CertAuthType, loadKeys bool, opts ...auth.MarshalOption) ([]services.CertAuthority, error) {
...
func (a *ServerWithRoles) GetCertAuthority(id services.CertAuthID, loadKeys bool, opts ...auth.MarshalOption) (services.CertAuthority, error) {
	if err := a.action(defaults.Namespace, services.KindCertAuthority, services.VerbReadNoSecrets); err != nil {
		return nil, trace.Wrap(err)
	}
	if loadKeys {
...
func (a *ServerWithRoles) filterNodes(nodes []services.Server) ([]services.Server, error) {
	...
	// to them.
	mfaParams := auth.AccessMFAParams{Verified: true}
NextNode:
...
func (a *ServerWithRoles) GetNodes(namespace string, opts ...auth.MarshalOption) ([]services.Server, error) {
...
func (a *ServerWithRoles) GetReverseTunnel(name string, opts ...auth.MarshalOption) (services.ReverseTunnel, error) {
...
func (a *ServerWithRoles) GetReverseTunnels(opts ...auth.MarshalOption) ([]services.ReverseTunnel, error) {
...
func (a *ServerWithRoles) GetTokens(ctx context.Context, opts ...auth.MarshalOption) ([]services.ProvisionToken, error) {
...
func (a *ServerWithRoles) GetToken(ctx context.Context, token string) (services.ProvisionToken, error) {
	if err := a.action(defaults.Namespace, services.KindToken, services.VerbRead); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *ServerWithRoles) UpsertToken(ctx context.Context, token services.ProvisionToken) error {
	if err := a.action(defaults.Namespace, services.KindToken, services.VerbCreate); err != nil {
		return trace.Wrap(err)
	}
...
func (a *ServerWithRoles) ChangePassword(req auth.ChangePasswordReq) error {
...
func (a *ServerWithRoles) GetAccessRequests(ctx context.Context, filter services.AccessRequestFilter) ([]services.AccessRequest, error) {
	...
	checker, err := auth.NewReviewPermissionChecker(ctx, a.authServer, a.context.User.GetName())
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *ServerWithRoles) generateUserCerts(ctx context.Context, req proto.UserCertsRequest, opts ...certRequestOption) (*proto.Certs, error) {
	...
	if len(req.AccessRequests) > 0 {
		...
		for _, reqID := range req.AccessRequests {
			accessReq, err := auth.GetAccessRequest(ctx, a.authServer, reqID)
			if err != nil {
	...
	parsedRoles, err := auth.FetchRoleList(roles, a.authServer, traits)
	if err != nil {
		return nil, trace.Wrap(err)
	}
	// add implicit roles to the set and build a checker
	checker := auth.NewRoleSet(parsedRoles...)
...
func (a *ServerWithRoles) GetOIDCConnector(ctx context.Context, id string, withSecrets bool) (services.OIDCConnector, error) {
...
func (a *ServerWithRoles) GetOIDCConnectors(ctx context.Context, withSecrets bool) ([]services.OIDCConnector, error) {
...
func (a *ServerWithRoles) CreateOIDCAuthRequest(req auth.OIDCAuthRequest) (*auth.OIDCAuthRequest, error) {
...
func (a *ServerWithRoles) GetSAMLConnector(ctx context.Context, id string, withSecrets bool) (services.SAMLConnector, error) {
...
func (a *ServerWithRoles) GetSAMLConnectors(ctx context.Context, withSecrets bool) ([]services.SAMLConnector, error) {
...
func (a *ServerWithRoles) CreateSAMLAuthRequest(req auth.SAMLAuthRequest) (*auth.SAMLAuthRequest, error) {
...
func (a *ServerWithRoles) GetGithubConnector(ctx context.Context, id string, withSecrets bool) (services.GithubConnector, error) {
...
func (a *ServerWithRoles) GetGithubConnectors(ctx context.Context, withSecrets bool) ([]services.GithubConnector, error) {
...
func (a *ServerWithRoles) CreateGithubAuthRequest(req auth.GithubAuthRequest) (*auth.GithubAuthRequest, error) {
...
func (a *ServerWithRoles) UpsertRole(ctx context.Context, role services.Role) error {
	...
	if err := auth.ValidateAccessPredicates(role); err != nil {
		return trace.Wrap(err)
	}
...
func (a *ServerWithRoles) GetClusterConfig(opts ...auth.MarshalOption) (services.ClusterConfig, error) {
...
func (a *ServerWithRoles) GetClusterName(opts ...auth.MarshalOption) (services.ClusterName, error) {
...
func (a *ServerWithRoles) GetTrustedClusters(ctx context.Context) ([]services.TrustedCluster, error) {
...
func (a *ServerWithRoles) GetTrustedCluster(ctx context.Context, name string) (services.TrustedCluster, error) {
	if err := a.action(defaults.Namespace, services.KindTrustedCluster, services.VerbRead); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *ServerWithRoles) GetTunnelConnections(clusterName string, opts ...auth.MarshalOption) ([]services.TunnelConnection, error) {
...
func (a *ServerWithRoles) GetAllTunnelConnections(opts ...auth.MarshalOption) ([]services.TunnelConnection, error) {
	if err := a.action(defaults.Namespace, services.KindTunnelConnection, services.VerbList); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *ServerWithRoles) GetRemoteClusters(opts ...auth.MarshalOption) ([]services.RemoteCluster, error) {
...
func (a *ServerWithRoles) GetDatabaseServers(ctx context.Context, namespace string, opts ...auth.MarshalOption) ([]types.DatabaseServer, error) {
	...
	for _, server := range servers {
		err := a.context.Checker.CheckAccessToDatabase(server, mfaParams, &auth.DatabaseLabelsMatcher{Labels: server.GetAllLabels()})
...
func (a *ServerWithRoles) GetAppServers(ctx context.Context, namespace string, opts ...auth.MarshalOption) ([]services.Server, error) {
