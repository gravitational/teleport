...
func (a *AuthWithRoles) GenerateAppToken(ctx context.Context, params services.AppTokenParams) (string, error) {
	if err := a.action(params.Namespace, services.KindJWT, services.VerbCreate); err != nil {
		return "", trace.Wrap(err)
	}
