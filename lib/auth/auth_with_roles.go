...
func (a *ServerWithRoles) agentOwnedResourceAction(ctx context.Context, hostID string, systemRoles ...types.SystemRole) error {
...
func (a *ServerWithRoles) KeepAliveServer(ctx context.Context, handle types.KeepAlive) error {
	...
	case constants.KeepAliveNode:
		if err := a.agentOwnedResourceAction(ctx, handle.Name, types.RoleNode); err != nil {
			return trace.Wrap(err)
		}
	case constants.KeepAliveApp:
		...
		if err := a.agentOwnedResourceAction(ctx, hostID, types.RoleApp, types.RoleOkta); err != nil {
			return trace.Wrap(err)
		}
	case constants.KeepAliveDatabase:
		...
		if err := a.agentOwnedResourceAction(ctx, handle.HostID, types.RoleDatabase); err != nil {
			return trace.Wrap(err)
		}
	case constants.KeepAliveWindowsDesktopService:
		if err := a.agentOwnedResourceAction(ctx, handle.Name, types.RoleWindowsDesktop); err != nil {
			return trace.Wrap(err)
		}
	case constants.KeepAliveKube:
		...
		if err := a.agentOwnedResourceAction(ctx, handle.HostID, types.RoleKube, types.RoleProxy); err != nil {
			return trace.Wrap(err)
		}
	case constants.KeepAliveDatabaseService:
		if err := a.agentOwnedResourceAction(ctx, handle.Name, types.RoleDatabase); err != nil {
			return trace.Wrap(err)
		}
	default:
...
func (a *ServerWithRoles) UpsertDatabaseServer(ctx context.Context, server types.DatabaseServer) (*types.KeepAlive, error) {
	if err := a.agentOwnedResourceAction(ctx, server.GetHostID(), types.RoleDatabase); err != nil {
...
func (a *ServerWithRoles) DeleteDatabaseServer(ctx context.Context, namespace, hostID, name string) error {
	if err := a.agentOwnedResourceAction(ctx, hostID, types.RoleDatabase); err != nil {
...
func (a *ServerWithRoles) UpsertDatabaseService(ctx context.Context, service types.DatabaseService) (*types.KeepAlive, error) {
	if err := a.agentOwnedResourceAction(ctx, service.GetName(), types.RoleDatabase); err != nil {
...
func (a *ServerWithRoles) UpsertApplicationServer(ctx context.Context, server types.AppServer) (*types.KeepAlive, error) {
	if err := a.agentOwnedResourceAction(ctx, server.GetHostID(), types.RoleApp); err != nil {
...
func (a *ServerWithRoles) DeleteApplicationServer(ctx context.Context, namespace, hostID, name string) error {
	if err := a.agentOwnedResourceAction(ctx, hostID, types.RoleApp); err != nil {
...
func (a *ServerWithRoles) UpsertKubernetesServer(ctx context.Context, s types.KubeServer) (*types.KeepAlive, error) {
	if err := a.agentOwnedResourceAction(ctx, s.GetHostID(), types.RoleKube); err != nil {
...
func (a *ServerWithRoles) DeleteKubernetesServer(ctx context.Context, hostID, name string) error {
	if err := a.agentOwnedResourceAction(ctx, hostID, types.RoleKube); err != nil {
...
func (a *ServerWithRoles) ListDatabases(ctx context.Context, limit int, startKey string) ([]types.Database, string, error) {
	...
	results, err := stream.Collect(
		stream.FilterMap(
			stream.PageFunc(func() ([]types.Database, error) {
				if done {
					return nil, io.EOF
				}
				items, next, err := a.authServer.ListDatabases(ctx, limit, startKey)
				if err != nil {
					return nil, trace.Wrap(err)
				}
			...
			func(db types.Database) (types.Database, bool) {
				...
				if err := a.checkAccessToDatabase(db); err != nil {
					return nil, false
				}
...
func (a *ServerWithRoles) UpsertWindowsDesktopService(ctx context.Context, s types.WindowsDesktopService) (*types.KeepAlive, error) {
	if err := a.agentOwnedResourceAction(ctx, s.GetName(), types.RoleWindowsDesktop); err != nil {
...
func (a *ServerWithRoles) UpsertWindowsDesktop(ctx context.Context, s types.WindowsDesktop) error {
	if err := a.agentOwnedResourceAction(ctx, s.GetHostID(), types.RoleWindowsDesktop); err == nil {
...
func (a *ServerWithRoles) DeleteWindowsDesktop(ctx context.Context, hostID, name string) error {
	if err := a.agentOwnedResourceAction(ctx, hostID, types.RoleWindowsDesktop); err == nil {
