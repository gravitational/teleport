...
func (Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_auth_8e5e9ee1e015aa07, []int{0}
}
...
func (*Watch) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_8e5e9ee1e015aa07, []int{1}
}
...
func (*WatchKind) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_8e5e9ee1e015aa07, []int{2}
}
...
func (*Certs) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_8e5e9ee1e015aa07, []int{3}
}
...
func (*UserCertsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_8e5e9ee1e015aa07, []int{4}
}
...
func (*GetUserRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_8e5e9ee1e015aa07, []int{5}
}
...
func (*GetUsersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_8e5e9ee1e015aa07, []int{6}
}
...
type UploadSessionRecordingRequest struct {
	...
	EventData            []byte   `protobuf:"bytes,3,opt,name=EventData,proto3" json:"event_data"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *UploadSessionRecordingRequest) Reset()         { *m = UploadSessionRecordingRequest{} }
func (m *UploadSessionRecordingRequest) String() string { return proto.CompactTextString(m) }
func (*UploadSessionRecordingRequest) ProtoMessage()    {}
func (*UploadSessionRecordingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_8e5e9ee1e015aa07, []int{7}
}
func (m *UploadSessionRecordingRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UploadSessionRecordingRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UploadSessionRecordingRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *UploadSessionRecordingRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UploadSessionRecordingRequest.Merge(dst, src)
}
func (m *UploadSessionRecordingRequest) XXX_Size() int {
	return m.Size()
}
func (m *UploadSessionRecordingRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_UploadSessionRecordingRequest.DiscardUnknown(m)
}

var xxx_messageInfo_UploadSessionRecordingRequest proto.InternalMessageInfo

func (m *UploadSessionRecordingRequest) GetNamespace() string {
	if m != nil {
		return m.Namespace
	}
	return ""
...
func (m *UploadSessionRecordingRequest) GetSID() string {
	if m != nil {
		return m.SID
	}
	return ""
...
func (m *UploadSessionRecordingRequest) GetEventData() []byte {
	if m != nil {
		return m.EventData
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*UploadSessionRecordingRequest)(nil), "proto.UploadSessionRecordingRequest")
...
type AuthServiceClient interface {
	...
	UploadSessionRecording(ctx context.Context, opts ...grpc.CallOption) (AuthService_UploadSessionRecordingClient, error)
}
...
func (c *authServiceClient) UploadSessionRecording(ctx context.Context, opts ...grpc.CallOption) (AuthService_UploadSessionRecordingClient, error) {
	stream, err := c.cc.NewStream(ctx, &_AuthService_serviceDesc.Streams[3], "/proto.AuthService/UploadSessionRecording", opts...)
	if err != nil {
		return nil, err
	}
	x := &authServiceUploadSessionRecordingClient{stream}
	return x, nil
}

type AuthService_UploadSessionRecordingClient interface {
	Send(*UploadSessionRecordingRequest) error
	CloseAndRecv() (*empty.Empty, error)
	grpc.ClientStream
}

type authServiceUploadSessionRecordingClient struct {
	grpc.ClientStream
}

func (x *authServiceUploadSessionRecordingClient) Send(m *UploadSessionRecordingRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *authServiceUploadSessionRecordingClient) CloseAndRecv() (*empty.Empty, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(empty.Empty)
...
type AuthServiceServer interface {
	...
	// UploadSessionRecording
	UploadSessionRecording(AuthService_UploadSessionRecordingServer) error
}
...
func _AuthService_UploadSessionRecording_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AuthServiceServer).UploadSessionRecording(&authServiceUploadSessionRecordingServer{stream})
}

type AuthService_UploadSessionRecordingServer interface {
	SendAndClose(*empty.Empty) error
	Recv() (*UploadSessionRecordingRequest, error)
	grpc.ServerStream
}

type authServiceUploadSessionRecordingServer struct {
	grpc.ServerStream
}

func (x *authServiceUploadSessionRecordingServer) SendAndClose(m *empty.Empty) error {
	return x.ServerStream.SendMsg(m)
}

func (x *authServiceUploadSessionRecordingServer) Recv() (*UploadSessionRecordingRequest, error) {
	m := new(UploadSessionRecordingRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "UploadSessionRecording",
			Handler:       _AuthService_UploadSessionRecording_Handler,
			ClientStreams: true,
		},
	},
	Metadata: "auth.proto",
...
func (m *UploadSessionRecordingRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UploadSessionRecordingRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.SID) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintAuth(dAtA, i, uint64(len(m.SID)))
		i += copy(dAtA[i:], m.SID)
	}
	if len(m.EventData) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintAuth(dAtA, i, uint64(len(m.EventData)))
...
func (m *UploadSessionRecordingRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.Namespace)
	if l > 0 {
...
func (m *UploadSessionRecordingRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UploadSessionRecordingRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UploadSessionRecordingRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func init() { proto.RegisterFile("auth.proto", fileDescriptor_auth_8e5e9ee1e015aa07) }

var fileDescriptor_auth_8e5e9ee1e015aa07 = []byte{
	...
	,
}
