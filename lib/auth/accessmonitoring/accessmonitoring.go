...
const (
	// handlerName specifies the name used to configure the access monitoring
	// event handlers. This value is used to identify which access monitoring
...
func (s *AccessMonitoringService) Run(ctx context.Context) (err error) {
	...
	// Configure access approval handlers.
	monitor.AddAccessMonitoringRuleHandler(accessApprovalHandler.HandleAccessMonitoringRule)
	monitor.AddAccessRequestHandler(accessApprovalHandler.HandleAccessRequest)
