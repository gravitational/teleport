...
func (s *Server) CreateAccountRecoveryCodes(ctx context.Context, req *proto.CreateAccountRecoveryCodesRequest) (*proto.AccountRecoveryCode, error) {
...
func (s *Server) GetAccountRecoveryCodes(ctx context.Context, req *proto.GetAccountRecoveryCodesRequest) (*proto.AccountRecoveryCode, error) {
	...
	return &proto.AccountRecoveryCode{
		Created: rc.Spec.Created,
	}, nil
}

func (s *Server) generateAndUpsertRecoveryCodes(ctx context.Context, username string) (*proto.AccountRecoveryCode, error) {
