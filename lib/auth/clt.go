...
type IdentityService interface {
	...
	CreateAccountRecoveryCodes(ctx context.Context, req *proto.CreateAccountRecoveryCodesRequest) (*proto.AccountRecoveryCode, error)
	...
	GetAccountRecoveryCodes(ctx context.Context, req *proto.GetAccountRecoveryCodesRequest) (*proto.AccountRecoveryCode, error)
