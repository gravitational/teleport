...
func TestAutoUpdateConfig(t *testing.T) {
	...
	testResources153(t, p, testFuncs[*autoupdatev1.AutoUpdateConfig]{
		...
		list: legacyListAdapter(func(ctx context.Context) ([]*autoupdatev1.AutoUpdateConfig, error) {
		...
		cacheList: legacyListAdapter(func(ctx context.Context) ([]*autoupdatev1.AutoUpdateConfig, error) {
...
func TestAutoUpdateVersion(t *testing.T) {
	...
	testResources153(t, p, testFuncs[*autoupdatev1.AutoUpdateVersion]{
		...
		list: legacyListAdapter(func(ctx context.Context) ([]*autoupdatev1.AutoUpdateVersion, error) {
		...
		cacheList: legacyListAdapter(func(ctx context.Context) ([]*autoupdatev1.AutoUpdateVersion, error) {
...
func TestAutoUpdateAgentRollout(t *testing.T) {
	...
	testResources153(t, p, testFuncs[*autoupdatev1.AutoUpdateAgentRollout]{
		...
		list: legacyListAdapter(func(ctx context.Context) ([]*autoupdatev1.AutoUpdateAgentRollout, error) {
		...
		cacheList: legacyListAdapter(func(ctx context.Context) ([]*autoupdatev1.AutoUpdateAgentRollout, error) {
