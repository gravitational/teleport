...
func cloneRecordingEncryption(encryption *recordingencryptionv1.RecordingEncryption) *recordingencryptionv1.RecordingEncryption {
	clone, ok := proto.Clone(encryption).(*recordingencryptionv1.RecordingEncryption)
	if !ok {
		return nil
	}
...
func newRecordingEncryptionCollection(upstream services.RecordingEncryption, w types.WatchKind) (*collection[*recordingencryptionv1.RecordingEncryption, recordingEncryptionIndex], error) {
	...
	return &collection[*recordingencryptionv1.RecordingEncryption, recordingEncryptionIndex]{
		store: newStore(types.KindRecordingEncryption, cloneRecordingEncryption, map[recordingEncryptionIndex]func(*recordingencryptionv1.RecordingEncryption) string{
