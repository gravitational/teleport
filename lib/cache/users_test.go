...
func TestUsers(t *testing.T) {
	...
	t.Run("GetUsers", func(t *testing.T) {
		testResources(t, p, testFuncs[types.User]{
			...
			list:      legacyListAdapter(func(ctx context.Context) ([]types.User, error) { return p.usersS.GetUsers(ctx, false) }),
			cacheList: legacyListAdapter(func(ctx context.Context) ([]types.User, error) { return p.cache.GetUsers(ctx, false) }),
