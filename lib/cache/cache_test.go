...
func TestCacheWatchKindExistsInEvents(t *testing.T) {
	...
	events := map[string]types.Resource{
		...
		// types.KindClusterConfig doesn't map to a types.ClusterConfigV2 because it gets
		// split into derived resources (RFD 28).
		types.KindClusterConfig:           types.DefaultClusterNetworkingConfig(),
		...
		types.KindRole:                    &types.RoleV4{Version: types.V4},
