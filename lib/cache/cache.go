...
func ForAuth(cfg Config) Config {
	...
	cfg.Watches = []types.WatchKind{
		...
		{Kind: types.KindAppServer, SubKind: types.SubKindTeleportApp},
		{Kind: types.KindAppServer, SubKind: types.SubKindOktaApp},
		{Kind: types.KindApp},
...
func ForRemoteProxy(cfg Config) Config {
	...
	cfg.Watches = []types.WatchKind{
		...
		{Kind: types.KindReverseTunnel},
		{Kind: types.KindTunnelConnection},
		{Kind: types.KindAppServer}, // The old proxy will make no distinctions about app server subkinds.
		{Kind: types.KindAppServer, SubKind: types.SubKindTeleportApp},
		{Kind: types.KindAppServer, SubKind: types.SubKindOktaApp},
		{Kind: types.KindRemoteCluster},
		{Kind: types.KindDatabaseServer},
