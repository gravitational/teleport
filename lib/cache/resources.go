...
func (c *Cache) listResources(ctx context.Context, req proto.ListResourcesRequest) (*types.ListResourcesResponse, error) {
	...
	case types.KindDatabaseServer:
		resp, err := buildListResourcesResponse[types.DatabaseServer](
	...
	case types.KindDatabaseService:
		resp, err := buildListResourcesResponse[types.DatabaseService](
	...
	case types.KindAppServer:
		resp, err := buildListResourcesResponse[types.AppServer](
		...
		return resp, trace.Wrap(err)
	case types.KindNode:
		resp, err := buildListResourcesResponse[types.Server](
	...
	case types.KindWindowsDesktopService:
		resp, err := buildListResourcesResponse[types.WindowsDesktopService](
	...
	case types.KindKubeServer:
		resp, err := buildListResourcesResponse[types.KubeServer](
