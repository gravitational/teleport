...
func TestRemoteClusters(t *testing.T) {
	...
	t.Run("GetRemoteClusters", func(t *testing.T) {
		...
		testResources(t, p, testFuncs[types.RemoteCluster]{
			...
			list:      legacyListAdapter(p.trustS.GetRemoteClusters),
			cacheGet:  p.cache.GetRemoteCluster,
			cacheList: legacyListAdapter(p.cache.GetRemoteClusters),
...
func TestTunnelConnections(t *testing.T) {
	...
	testResources(t, p, testFuncs[types.TunnelConnection]{
		...
		list:      legacyListAdapter(func(ctx context.Context) ([]types.TunnelConnection, error) { return p.trustS.GetAllTunnelConnections() }),
		cacheList: legacyListAdapter(func(ctx context.Context) ([]types.TunnelConnection, error) { return p.cache.GetAllTunnelConnections() }),
