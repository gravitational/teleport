...
func TestLocks(t *testing.T) {
	...
	testResources(t, p, testFuncs[types.Lock]{
		...
		list:      legacyListAdapter(func(ctx context.Context) ([]types.Lock, error) { return p.accessS.GetLocks(ctx, false) }),
		cacheList: legacyListAdapter(func(ctx context.Context) ([]types.Lock, error) { return p.cache.GetLocks(ctx, false) }),
