...
type collections struct {
	...
	provisionTokens                    *collection[types.ProvisionToken, provisionTokenIndex, string]
	staticTokens                       *collection[types.StaticTokens, staticTokensIndex, string]
	certAuthorities                    *collection[types.CertAuthority, certAuthorityIndex, string]
	users                              *collection[types.User, userIndex, string]
	roles                              *collection[types.Role, roleIndex, string]
	authServers                        *collection[types.Server, authServerIndex, string]
	proxyServers                       *collection[types.Server, proxyServerIndex, string]
	nodes                              *collection[types.Server, nodeIndex, string]
	apps                               *collection[types.Application, appIndex, string]
	appServers                         *collection[types.AppServer, appServerIndex, string]
	dbs                                *collection[types.Database, databaseIndex, string]
	dbServers                          *collection[types.DatabaseServer, databaseServerIndex, string]
	dbServices                         *collection[types.DatabaseService, databaseServiceIndex, string]
	kubeServers                        *collection[types.KubeServer, kubeServerIndex, string]
	kubeClusters                       *collection[types.KubeCluster, kubeClusterIndex, string]
	kubeWaitingContainers              *collection[*kubewaitingcontainerv1.KubernetesWaitingContainer, kubeWaitingContainerIndex, string]
	windowsDesktops                    *collection[types.WindowsDesktop, windowsDesktopIndex, string]
	windowsDesktopServices             *collection[types.WindowsDesktopService, windowsDesktopServiceIndex, string]
	dynamicWindowsDesktops             *collection[types.DynamicWindowsDesktop, dynamicWindowsDesktopIndex, string]
	userGroups                         *collection[types.UserGroup, userGroupIndex, string]
	identityCenterAccounts             *collection[*identitycenterv1.Account, identityCenterAccountIndex, string]
	identityCenterAccountAssignments   *collection[*identitycenterv1.AccountAssignment, identityCenterAccountAssignmentIndex, string]
	healthCheckConfig                  *collection[*healthcheckconfigv1.HealthCheckConfig, healthCheckConfigIndex, string]
	reverseTunnels                     *collection[types.ReverseTunnel, reverseTunnelIndex, string]
	spiffeFederations                  *collection[*machineidv1.SPIFFEFederation, spiffeFederationIndex, string]
	workloadIdentity                   *collection[*workloadidentityv1.WorkloadIdentity, workloadIdentityIndex, string]
	userNotifications                  *collection[*notificationsv1.Notification, userNotificationIndex, string]
	globalNotifications                *collection[*notificationsv1.GlobalNotification, globalNotificationIndex, string]
	clusterName                        *collection[types.ClusterName, clusterNameIndex, string]
	auditConfig                        *collection[types.ClusterAuditConfig, clusterAuditConfigIndex, string]
	networkingConfig                   *collection[types.ClusterNetworkingConfig, clusterNetworkingConfigIndex, string]
	authPreference                     *collection[types.AuthPreference, authPreferenceIndex, string]
	sessionRecordingConfig             *collection[types.SessionRecordingConfig, sessionRecordingConfigIndex, string]
	autoUpdateConfig                   *collection[*autoupdatev1.AutoUpdateConfig, autoUpdateConfigIndex, string]
	autoUpdateVerion                   *collection[*autoupdatev1.AutoUpdateVersion, autoUpdateVersionIndex, string]
	autoUpdateRollout                  *collection[*autoupdatev1.AutoUpdateAgentRollout, autoUpdateAgentRolloutIndex, string]
	autoUpdateReports                  *collection[*autoupdatev1.AutoUpdateAgentReport, autoUpdateAgentReportIndex, string]
	oktaImportRules                    *collection[types.OktaImportRule, oktaImportRuleIndex, string]
	oktaAssignments                    *collection[types.OktaAssignment, oktaAssignmentIndex, string]
	samlIdPServiceProviders            *collection[types.SAMLIdPServiceProvider, samlIdPServiceProviderIndex, string]
	webSessions                        *collection[types.WebSession, webSessionIndex, string]
	appSessions                        *collection[types.WebSession, appSessionIndex, string]
	snowflakeSessions                  *collection[types.WebSession, snowflakeSessionIndex, string]
	accessLists                        *collection[*accesslist.AccessList, accessListIndex, string]
	accessListMembers                  *collection[*accesslist.AccessListMember, accessListMemberIndex, string]
	accessListReviews                  *collection[*accesslist.Review, accessListReviewIndex, string]
	crownJewels                        *collection[*crownjewelv1.CrownJewel, crownJewelIndex, string]
	accessGraphSettings                *collection[*clusterconfigv1.AccessGraphSettings, accessGraphSettingsIndex, string]
	integrations                       *collection[types.Integration, integrationIndex, string]
	pluginStaticCredentials            *collection[types.PluginStaticCredentials, pluginStaticCredentialsIndex, string]
	accessMonitoringRules              *collection[*accessmonitoringrulesv1.AccessMonitoringRule, accessMonitoringRuleIndex, string]
	webTokens                          *collection[types.WebToken, webTokenIndex, string]
	uiConfigs                          *collection[types.UIConfig, webUIConfigIndex, string]
	installers                         *collection[types.Installer, installerIndex, string]
	locks                              *collection[types.Lock, lockIndex, string]
	tunnelConnections                  *collection[types.TunnelConnection, tunnelConnectionIndex, string]
	remoteClusters                     *collection[types.RemoteCluster, remoteClusterIndex, string]
	userTasks                          *collection[*usertasksv1.UserTask, userTaskIndex, string]
	userLoginStates                    *collection[*userloginstate.UserLoginState, userLoginStateIndex, string]
	gitServers                         *collection[types.Server, gitServerIndex, string]
	databaseObjects                    *collection[*dbobjectv1.DatabaseObject, databaseObjectIndex, string]
	staticHostUsers                    *collection[*userprovisioningv2.StaticHostUser, staticHostUserIndex, string]
	networkRestrictions                *collection[types.NetworkRestrictions, networkingRestrictionIndex, string]
	discoveryConfigs                   *collection[*discoveryconfig.DiscoveryConfig, discoveryConfigIndex, string]
	provisioningStates                 *collection[*provisioningv1.PrincipalState, principalStateIndex, string]
	identityCenterPrincipalAssignments *collection[*identitycenterv1.PrincipalAssignment, identityCenterPrincipalAssignmentIndex, string]
	auditQueries                       *collection[*secreports.AuditQuery, auditQueryIndex, string]
	secReports                         *collection[*secreports.Report, securityReportIndex, string]
	secReportsStates                   *collection[*secreports.ReportState, securityReportStateIndex, string]
	relayServers                       *collection[*presencev1.RelayServer, relayServerIndex, string]
	botInstances                       *collection[*machineidv1.BotInstance, botInstanceIndex, string]
	recordingEncryption                *collection[*recordingencryptionv1.RecordingEncryption, recordingEncryptionIndex, string]
	plugins                            *collection[types.Plugin, pluginIndex, string]
}
