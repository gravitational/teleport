...
func TestNodes(t *testing.T) {
	...
	t.Run("GetNodes", func(t *testing.T) {
		...
		testResources(t, p, testFuncs[types.Server]{
			...
			list: legacyListAdapter(func(ctx context.Context) ([]types.Server, error) {
			...
			cacheList: legacyListAdapter(func(ctx context.Context) ([]types.Server, error) { return p.cache.GetNodes(ctx, apidefaults.Namespace) }),
