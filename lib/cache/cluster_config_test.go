...
func TestAccessGraphSettings(t *testing.T) {
	...
	testResources153(t, p, testFuncs[*clusterconfigv1.AccessGraphSettings]{
		...
		list: legacyListAdapter(func(ctx context.Context) ([]*clusterconfigv1.AccessGraphSettings, error) {
		...
		cacheList: legacyListAdapter(func(ctx context.Context) ([]*clusterconfigv1.AccessGraphSettings, error) {
