...
func TestProxies(t *testing.T) {
	...
	testResources(t, p, testFuncs[types.Server]{
		...
		list:      legacyListAdapter(func(_ context.Context) ([]types.Server, error) { return p.presenceS.GetProxies() }),
		cacheList: legacyListAdapter(func(_ context.Context) ([]types.Server, error) { return p.cache.GetProxies() }),
