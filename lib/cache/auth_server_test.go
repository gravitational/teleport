...
func TestAuthServers(t *testing.T) {
	...
	testResources(t, p, testFuncs[types.Server]{
		...
		list:      legacyListAdapter(func(context.Context) ([]types.Server, error) { return p.presenceS.GetAuthServers() }),
		cacheList: legacyListAdapter(func(context.Context) ([]types.Server, error) { return p.cache.GetAuthServers() }),
