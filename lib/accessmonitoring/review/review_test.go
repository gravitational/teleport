...
func TestScheduleRequest(t *testing.T) {
	...
	// Set inline schedule
	testRule.Spec.Schedules = []*accessmonitoringrulesv1.Schedule{
		{
			Name: "test-schedule",
			Inline: &accessmonitoringrulesv1.InlineSchedule{
				Timezone: time.UTC.String(),
				Shifts: []*accessmonitoringrulesv1.InlineSchedule_Shift{
					{
