...
export const resourceIconSpecs = {
  ...
  adept: { dark: i.adeptDark, light: i.adeptLight },
  ...
  alertmanager: forAllThemes(i.prometheus),
  ...
  anthropic: { dark: i.anthropicDark, light: i.anthropicLight },
  ...
  awsathena: forAllThemes(i.awsathena),
  ...
  awsec2: forAllThemes(i.awsec2),
  awseks: forAllThemes(i.awseks),
  awselasticache: forAllThemes(i.awselasticache),
  awselasticblockstore: forAllThemes(i.awselasticblockstore),
  awselasticcontainerservice: forAllThemes(i.awselasticcontainerservice),
  awselasticsearchservice: forAllThemes(i.awselasticsearchservice),
  awsfargate: forAllThemes(i.awsfargate),
  awsiamidentitycenter: forAllThemes(i.awsiamidentitycenter),
  awsidentityandaccessmanagementiam: forAllThemes(
    i.awsidentityandaccessmanagementiam
  ),
  awskeyspaces: forAllThemes(i.awskeyspaces),
  awsmanagementconsole: forAllThemes(i.awsmanagementconsole),
  awsmemorydb: forAllThemes(i.awsmemorydb),
  awsrds: forAllThemes(i.awsrds),
  ...
  canva: { dark: i.canvaDark, light: i.canvaLight },
  ...
  claude: forAllThemes(i.anthropicclaude),
  clay: forAllThemes(i.clay),
  ...
  coreweave: { dark: i.coreweaveDark, light: i.coreweaveLight },
  cronitor: forAllThemes(i.cronitor),
  cultureamp: { dark: i.cultureampDark, light: i.cultureampLight },
  cursor: { dark: i.cursorDark, light: i.cursorLight },
  customerio: { dark: i.customerioDark, light: i.customerioLight },
  ...
  dynamo: forAllThemes(i.awsdynamodb),

  ec2: forAllThemes(i.ec2),
  eks: forAllThemes(i.eks),
  elastic: forAllThemes(i.elastic),
  elevenlabs: { dark: i.elevenlabsDark, light: i.elevenlabsLight },
  ...
  grok: { dark: i.grokDark, light: i.grokLight },
  ...
  hashicorpvault: forAllThemes(i.hashicorpvault),
  headliner: forAllThemes(i.headliner),
  highspot: forAllThemes(i.highspot),
  ...
  instantly: { dark: i.instantlyDark, light: i.instantlyLight },
  ...
  kling: { dark: i.klingaiDark, light: i.klingaiLight },
  ...
  lean: { dark: i.leanDark, light: i.leanLight },
  ...
  metaview: { dark: i.metaviewDark, light: i.metaviewLight },
  micro1: { dark: i.micro1Dark, light: i.micro1Light },
  microsoft: forAllThemes(i.microsoft),
  microsoftactivedirectory: forAllThemes(i.microsoftactivedirectory),
  microsoftadvertising: forAllThemes(i.microsoftadvertising),
  ...
  microsoftvisualstudiocode: forAllThemes(i.microsoftvisualstudiocode),
  ...
  pencil: { dark: i.pencilDark, light: i.pencilLight },
  perplexity: { dark: i.perplexityDark, light: i.perplexityLight },
  photoroom: { dark: i.photoroomDark, light: i.photoroomLight },
  ...
  reachdesk: { dark: i.reachdeskDark, light: i.reachdeskLight },
  redhat: forAllThemes(i.redhat),
  redis: forAllThemes(i.redis),
  redshift: forAllThemes(i.awsredshift),
  relay: forAllThemes(i.relay),
  replit: forAllThemes(i.replit),
  retell: { dark: i.retellDark, light: i.retellLight },
  ...
  windsurf: { dark: i.windsurfDark, light: i.windsurfLight },
