...
export const Icons = () => (
  <Flex flexWrap="wrap">
    ...
    <IconBox IconCmpt={Icon.CheckSquare} text="CheckSquare" />
    ...
    <IconBox IconCmpt={Icon.Funnel} text="Funnel" />
    ...
    <IconBox IconCmpt={Icon.Square} text="Square" />
    ...
    <IconBox IconCmpt={Icon.TreeStructure} text="TreeStructure" />
