...
export function AWSIcon({ size = 24, fill }: SVGIconProps) {
  return (
    <SVGIcon
      ...
      width={size}
      height={size}
      fill={fill} // This fill is for the text "aws"
      size={size}
    >
      ...
      <path
        ...
        fillRule="evenodd"
        clipRule="evenodd"
        // this fill is for the "smiley" part of this icon,
        // this color works for both dark/light theme.
        fill="#f90"
      />
      <path
        ...
        fillRule="evenodd"
        clipRule="evenodd"
        // this fill is for the "arrow" part of the "smiley" part of this icon,
        // this color works for both dark/light theme.
        fill="#f90"
      />
    </SVGIcon>
