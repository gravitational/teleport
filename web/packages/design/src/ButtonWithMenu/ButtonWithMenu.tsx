 ...
 *
 * Clicking on a menu item automatically closes the menu. This is done by injecting a wrapped
 * onClick intoto each child of <ButtonWithMenu>. As such, children must be passed directly, not
 * wrapped in a React.Fragment. If you must, use an array of JSX elements instead:
 * [<MenuItem>Foo</MenuItem>, <MenuItem>Bar</MenuItem].
 *
 * @example
 *
 * <ButtonWithMenu
