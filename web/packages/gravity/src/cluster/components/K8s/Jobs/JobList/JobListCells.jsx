...
const getSucceededStatus = value => value && <States.StateSuccess mr="2">Succeeded: {value}</States.StateSuccess> ;
const getFailedStatus = value => value && <States.StateDanger  mr="2">Failed: {value}</States.StateDanger> ;
const getActiveStatus = value => value && <States.StateSuccess  mr="2">Active: {value}</States.StateSuccess> ;