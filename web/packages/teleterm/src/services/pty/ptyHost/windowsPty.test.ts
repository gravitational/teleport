...
test.each([
  {
    ...
    expected: { backend: 'conpty', buildNumber: 22621 },
  },
  {
    ...
    terminalOptions: { useConpty: true },
    expected: { backend: 'winpty', buildNumber: 18308 },
  },
  {
    name: 'uses winpty when Windows version is supported, but conpty is disabled in options',
    platform: 'win32' as const,
    osVersion: '10.0.22621',
    terminalOptions: { useConpty: false },
    expected: { backend: 'winpty', buildNumber: 22621 },
  },
  {
