...
import { useMongo, MongoProps } from './useMongo';

export function Mongo(props: MongoProps) {
  const {
    mongoConnectionStr,
  ...
  return (
    <Box maxWidth="1024px" mx="auto" mt="4" px="5">
      ...
      />
      <Text bold>Mongo connection string</Text>
      <TextSelectCopy
        bash={false}
        bg={'primary.dark'}
        mb={6}
        text={mongoConnectionStr}
      />
      <Text bold>Mongosh connection string</Text>
      <TextSelectCopy
        bash={false}
        bg={'primary.dark'}
        mb={6}
        text={mongoshConnectionStr}
      />
