...
import type { AwsRole } from 'shared-new/services/apps/types';

import type { ResourceLabel } from '../agents/types';
import type { SamlServiceProviderPreset } from '../samlidp/types';
...
export interface UserGroupAndDescription {
  name: string;
  description: string;
}
