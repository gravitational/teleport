 ...
 */
export interface IntegrationEnrollEventData {
  id: string;
 ...
 */
export interface IntegrationEnrollEventRequest {
...
export interface DiscoverEventStepStatus {
  stepStatus: DiscoverEventStatus;
  stepStatusError?: string;
}

export interface DiscoverServiceDeploy {
