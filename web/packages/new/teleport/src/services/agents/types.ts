...
import type { Platform } from 'shared-new/platform';
import type { IncludedResourceMode } from 'shared-new/unifiedResources/types';

import type { App } from '../apps/types';
import type { Database } from '../databases/types';
import type { Desktop } from '../desktops/types';
import type { GitServer } from '../gitServers/types';
import type { Kube } from '../kube/types';
import type { MfaChallengeResponse } from '../mfa/types';
import type { Node } from '../nodes/types';
import type { UserGroup } from '../userGroups/types';
 ...
 */
export interface ConnectionDiagnosticRequest {
...
export interface KubeImpersonation {
