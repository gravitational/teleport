...
export interface Resource<T extends Kind> {
  id: string;
  kind: T;
  name: string;
  description?: string;
...
export interface DefaultAuthConnector {
  name?: string;
  type: AuthType;
}
...
export interface CreateOrOverwriteGitServerBase {
  id: string;
  /**
