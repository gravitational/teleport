...
import type { PluginStatusOkta } from './oktaStatusTypes';
...
export interface IntegrationTemplate<
  T extends string,
  K extends string,
  SP extends object | null = null,
  SD extends object | null = null,
> {
  resourceType: T;
  kind: K;
  spec?: SP;
...
export interface IntegrationSpecGitHub {
  /**
...
export interface IntegrationSpecAwsOidc {
  roleArn: string;
...
export interface AwsOidcPingRequest {
...
export interface AwsOidcPingResponse {
  accountId: string;
  arn: string;
  userId: string;
}
...
export interface ExternalAuditStorage {
...
export type Plugin<SP extends object, D extends object> = IntegrationTemplate<
  'plugin',
  PluginKind,
  SP,
  PluginStatus<D>
...
export interface PluginStatus<D extends object> {
  /**
 ...
 * spec types.
 */
export interface PluginNameToSpec {
  okta: PluginOktaSpec;
 ...
 */
export interface PluginNameToDetails {
...
export interface PluginOktaSpec {
...
export interface PluginSlackSpec {
  fallbackChannel: string;
}

export interface PluginMattermostSpec {
  channel: string;
  team: string;
  reportToEmail: string;
}

export interface PluginMsTeamsSpec {
  appID: string;
  tenantID: string;
  teamsAppID: string;
  region: string;
...
export interface PluginOpsgenieSpec {
  defaultSchedules: string[];
}

export interface PluginDatadogSpec {
  apiEndpoint: string;
  fallbackRecipient: string;
}

export interface PluginEmailSpec {
  sender: string;
  fallbackRecipient: string;
}
...
interface IntegrationCreateGitHubRequest {
  name: string;
...
interface IntegrationCreateAwsOidcRequest {
  name: string;
...
export interface IntegrationWithSummary {
  name: string;
  subKind: string;
...
export interface IntegrationDiscoveryRules {
...
export interface DiscoverEc2Instance {
...
export interface DiscoverEksCluster {
...
export interface DiscoverRdsDatabase {
...
export interface IntegrationDiscoveryRule {
...
export interface AWSOIDCListDeployedDatabaseServiceResponse {
...
export interface AWSOIDCDeployedDatabaseService {
...
export interface AwsOidcListDatabasesRequest {
...
export interface AwsRdsDatabase {
...
export interface ListAwsRdsDatabaseResponse {
...
export interface ListAwsRdsFromAllEnginesResponse {
  databases: AwsRdsDatabase[];
  /**
...
export interface UpdateIntegrationAwsOidc {
...
export interface UpdateIntegrationGithub {
...
export interface AwsOidcDeployServiceRequest {
...
interface DeployDatabaseServiceDeployment {
...
export interface AwsOidcDeployDatabaseServicesRequest {
...
export interface EnrollEksClustersRequest {
  region: string;
...
export interface EnrollEksClustersResponse {
  results: {
    clusterName: string;
    resourceId: string;
    error: string;
...
export interface ListEksClustersRequest {
  region: Regions;
  nextToken?: string;
}

export interface ListEksClustersResponse {
  /**
...
export interface ListAwsSubnetsRequest {
  vpcId: string;
  region: Regions;
  nextToken?: string;
}

export interface ListAwsSubnetsResponse {
  subnets: Subnet[];
  nextToken?: string;
}

export interface ListAwsSecurityGroupsRequest {
...
export interface ListAwsSecurityGroupsResponse {
...
export interface IntegrationUrlLocationState {
...
export interface AwsDatabaseVpcsResponse {
  vpcs: Vpc[];
  nextToken: string;
}
 ...
 */
export interface CreateAwsAppAccessRequest {
  /**
...
export interface ExportedIntegrationCaResponse {
  ssh: SshKey[];
  tls: TlsKey[];
  jwt: JwtKey[];
}

export interface IntegrationDeleteRequest {
  name: string;
  clusterId: string;
  /**
