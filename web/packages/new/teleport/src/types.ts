...
import type { IconProps } from 'design-new/icons/types';

import type { UserPreferences } from 'gen-proto-ts/teleport/lib/teleterm/v1/service_pb';

import type { NavigationCategory } from './navigation/categories';
