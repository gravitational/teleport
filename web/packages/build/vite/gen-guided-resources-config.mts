...
function stubTeleportConfigPlugin(): Plugin {
  ...
  return {
    ...
    // a file path. Instead, return a virtual module ID, which by convention
    // in the bundler (Rollup), begins with "\0". This way, the load hook
    // receives the virtual module ID, rather than a file path, and returns
    // the stub.
    resolveId(id) {
