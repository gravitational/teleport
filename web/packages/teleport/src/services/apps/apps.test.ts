...
test('correct formatting of apps fetch response', async () => {
  ...
  expect(response).toEqual({
    agents: [
      ...
      {
        kind: 'app',
        id: 'cluster-id-anthropic-anthropic.example.com',
        name: 'anthropic',
        useAnyProxyPublicAddr: false,
        description: 'Anthropic inference endpoint',
        uri: 'llm://',
        publicAddr: 'anthropic.example.com',
        labels: [],
        clusterId: 'cluster-id',
        fqdn: '',
        friendlyName: '',
        ...
        isLLM: true,
        isTcp: false,
        addrWithProtocol: 'llm://anthropic.example.com',
        llmFormat: 'anthropic',
        userGroups: [],
        samlApp: false,
        samlAppSsoUrl: '',
      ...
      {
        kind: 'app',
        id: 'cluster-id-openai-openai.example.com',
        name: 'openai',
        useAnyProxyPublicAddr: false,
        description: 'OpenAI inference endpoint',
        uri: 'llm://',
        publicAddr: 'openai.example.com',
        labels: [],
        clusterId: 'cluster-id',
        fqdn: '',
        friendlyName: '',
        ...
        isLLM: true,
        isTcp: false,
        addrWithProtocol: 'llm://openai.example.com',
        llmFormat: 'openai',
        userGroups: [],
        samlApp: false,
        samlAppSsoUrl: '',
