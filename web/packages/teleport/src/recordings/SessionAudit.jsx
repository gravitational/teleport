...
import Tabs, { TabItem } from './SessionAuditTabs';
...
export default function SessionAudit() {
  ...
  const indexRoute = cfg.getSessionAuditRoute({ sid });
  ...
  return (
    <StyledSessionAudit>
      ...
      <StyledDocument visible={isPlayerTabActive}>
        <Player sid={sid} clusterId={clusterId} />
      </StyledDocument>
...
const StyledSessionAudit = styled.div`
  display: flex;
  height: 100%;
  width: 100%;
  position: absolute;
