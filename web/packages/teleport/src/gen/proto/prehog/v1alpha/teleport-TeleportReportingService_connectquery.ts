...
import { HelloTeleportRequest, HelloTeleportResponse, SubmitEventRequest, SubmitEventResponse, SubmitEventsRequest, SubmitEventsResponse } from "./teleport_pb";
 ...
 */
export const helloTeleport = {
  localName: "helloTeleport",
  name: "HelloTeleport",
  kind: MethodKind.Unary,
