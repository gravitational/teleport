...
import type { Settings } from 'teleport/Assist/types';
...
export function Settings(props: SettingsProps) {
  ...
  const { settings, updateSettings } = useAssist();
  ...
  function handleChangeViewMode(viewMode: ViewMode) {
    ...
    saveSettings({
      ...settings,
      viewMode,
      sidebarVisible: viewMode === ViewMode.PopupExpandedSidebarVisible,
    });
  }
  ...
  function handleChangePreferredLogins(preferredLogins: string[]) {
    ...
    if (
      ...
      JSON.stringify(settings.preferredLogins)
    ) {
      return;
    }
  ...
  return (
    <Container viewMode={settings.viewMode} onClick={handleClose}>
          ...
          <SettingsPage>
            ...
            {selectedPage === Page.RemoteExecution && (
              <RemoteExecutionSettings
                preferredLogins={settings.preferredLogins}
