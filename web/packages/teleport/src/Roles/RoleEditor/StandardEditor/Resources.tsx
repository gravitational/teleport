    ...
    <Flex flexDirection="column" gap={3}>
      ...
      {show.mcpTools && (
        <FieldMultiInput
          ...
          tooltipContent={
            <>
              List of Modern Context Protocol (MCP) tools allowed to access.
              Each entry can be a literal string (e.g. <Mark>search-files</Mark>
              ), a glob pattern (e.g. <Mark>slack_*</Mark>), or a regular
              expression that must start with &apos;^&apos; and end with
              &apos;$&apos; (e.g.
              <Mark>^(get|list).*$</Mark>). A wildcard{' '}
              <Mark>&apos;*&apos;</Mark> allows all tools.
            </>
          }
        />
      )}
