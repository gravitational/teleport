...
// Converts all field types in T to a boolean type.
type FieldTypesToBoolean<T> = {
...
/*
 * Models for the kubernetes resource access section.
 */
...
export type KubernetesAccessInputFields =
  FieldTypesToBoolean<KubernetesAccessFields>;

export type KubernetesAccess = ResourceAccessBase<'kube_cluster'> &
  KubernetesAccessFields &
  KubernetesRoleVersion;
...
/*
 * Models for the server resource access section.
 */
...
export type ServerAccess = ResourceAccessBase<'node'> & ServerAccessFields;

/*
 * Models for the app resource access section.
 */
type AppAccessFields = {
  labels: UILabel[];
  awsRoleARNs: string[];
...
export type AppAccessInputFields = FieldTypesToBoolean<AppAccessFields>;

export type AppAccess = ResourceAccessBase<'app'> & AppAccessFields;

/*
 * Models for the database resource access section.
 */
...
export type DatabaseAccessInputFields =
  FieldTypesToBoolean<DatabaseAccessFields>;

export type DatabaseAccess = ResourceAccessBase<'db'> & DatabaseAccessFields;

/*
 * Models for the windows desktop resource access section.
 */
...
export type WindowsDesktopAccessInputFields =
  FieldTypesToBoolean<WindowsDesktopAccessFields>;
...
export type GitHubOrganizationAccessInputFields =
  FieldTypesToBoolean<GitHubOrganizationAccessFields>;

export type GitHubOrganizationAccess = ResourceAccessBase<'git_server'> &
  GitHubOrganizationAccessFields;
