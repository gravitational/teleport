...
export function ConfigureOAuth({
  ...
  const callbackURL = "https://" + cluster.publicURL + "/v1/webapi/github/"
        ...
        {({ validator }) => (
          <>
            <Container mb={5}>
              ...
              <Text>
                The OAuth app will be used to retrieve GitHub login information
              ...
              <br />
              <Text>Click on "Register Application" and then "Generate a new client secret". Copy the ClientID and Client Secret below:</Text>
              <Box width="600px">
                <FieldInput
                  value={clientID}
