...
type RegionsOrWildcard = WildcardRegion | Regions[];
...
const isWildcard = (regions: RegionsOrWildcard) =>
    ...
    <>
      ...
      <Box>
        <FieldRadio
          ...
          onChange={() => onChange(['*'] as WildcardRegion)}
          mb={3}
        />
        <FieldRadio
          name="regions"
        ...
        {!isWildcard(regions) && (
          <Box mb={3}>
            <RegionMultiSelector
              selectedRegions={regions as Regions[]}
