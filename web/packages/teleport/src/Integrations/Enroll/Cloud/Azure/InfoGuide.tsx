      ...
      <Box pl={2}>
        ...
        >
          <li>
            ...
            Specify subscriptions, regions, resource types (VMs), and tag
            filters to control which resources are discovered.
          </li>
          <li>
            <strong>Use the generated Terraform module.</strong> <br />
            The generated Terraform module can be used to create an Azure
            managed identity that grants Teleport read-only access and configure
            Teleport discovery service to scan for your Azure resources.
          </li>
          <li>
            <strong>
