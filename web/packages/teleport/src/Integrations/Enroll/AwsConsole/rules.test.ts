...
test.each`
  ...
  ${'invalid missing arn'}      | ${missingArn}     | ${false} | ${'Output lines should start with arn:aws:, please double check the output'}
  ...
  ${'invalid missingAll'}       | ${missingAll}     | ${false} | ${'Output lines should start with arn:aws:, please double check the output'}
