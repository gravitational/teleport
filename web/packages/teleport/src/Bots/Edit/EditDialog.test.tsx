...
describe('EditDialog', () => {
  ...
  it('should show a version mismatch warning', async () => {
    ...
    expect(
      screen.getByText(
        'Error: We could not complete your request. Your proxy (v18.0.0) may be behind the minimum required version (v17.6.1) to support this request. Ensure all proxies are upgraded and try again.'
      )
    ).toBeInTheDocument();
  });
});
