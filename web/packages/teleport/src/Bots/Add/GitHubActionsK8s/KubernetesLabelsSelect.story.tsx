...
import { fetchUnifiedResources } from 'teleport/test/helpers/resources';

import { KubernetesLabelsSelect } from './KubernetesLabelsSelect';

const meta = {
  title: 'Teleport/Bots/GHA+K8sWizard/KubernetesLabelsSelect',
  component: Wrapper,
  beforeEach: () => {
...
export const Happy: Story = {
  parameters: {
    msw: {
      handlers: [fetchUnifiedResources()],
    },
  },
};
...
type Labels = ComponentProps<typeof KubernetesLabelsSelect>['selected'];
