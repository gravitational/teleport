          ...
          {({ validator }) => (
            <>
              ...
              <Box>
                ...
                <Text mb={3}>
                  Specifying a branch is recommended to prevent workflows
                  running from any branch to access your Teleport resources.
                </Text>
              </Box>
