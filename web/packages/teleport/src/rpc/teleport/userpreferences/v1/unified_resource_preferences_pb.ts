...
// Retrieve enum metadata with: proto3.getEnumType(DefaultTab)
proto3.util.setEnumType(DefaultTab, "teleport.userpreferences.v1.DefaultTab", [
  { no: 0, name: "DEFAULT_TAB_UNSPECIFIED" },
  { no: 1, name: "DEFAULT_TAB_ALL" },
  { no: 2, name: "DEFAULT_TAB_PINNED" },
]);
...
proto3.util.setEnumType(ViewMode, "teleport.userpreferences.v1.ViewMode", [
  { no: 0, name: "VIEW_MODE_UNSPECIFIED" },
  { no: 1, name: "VIEW_MODE_CARD" },
  { no: 2, name: "VIEW_MODE_LIST" },
]);
...
// Retrieve enum metadata with: proto3.getEnumType(LabelsViewMode)
proto3.util.setEnumType(LabelsViewMode, "teleport.userpreferences.v1.LabelsViewMode", [
  { no: 0, name: "LABELS_VIEW_MODE_UNSPECIFIED" },
  { no: 1, name: "LABELS_VIEW_MODE_EXPANDED" },
  { no: 2, name: "LABELS_VIEW_MODE_COLLAPSED" },
]);
...
// Retrieve enum metadata with: proto3.getEnumType(AvailableResourceMode)
proto3.util.setEnumType(AvailableResourceMode, "teleport.userpreferences.v1.AvailableResourceMode", [
  { no: 0, name: "AVAILABLE_RESOURCE_MODE_UNSPECIFIED" },
  { no: 1, name: "AVAILABLE_RESOURCE_MODE_ALL" },
  { no: 2, name: "AVAILABLE_RESOURCE_MODE_ACCESSIBLE" },
  { no: 3, name: "AVAILABLE_RESOURCE_MODE_REQUESTABLE" },
  { no: 4, name: "AVAILABLE_RESOURCE_MODE_NONE" },
]);
 ...
 */
export class UnifiedResourcePreferences extends Message<UnifiedResourcePreferences> {
  /**
   ...
   */
  defaultTab = DefaultTab.UNSPECIFIED;
   ...
   */
  labelsViewMode = LabelsViewMode.UNSPECIFIED;
   ...
   */
  availableResourceMode = AvailableResourceMode.UNSPECIFIED;

  constructor(data?: PartialMessage<UnifiedResourcePreferences>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "teleport.userpreferences.v1.UnifiedResourcePreferences";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "default_tab", kind: "enum", T: proto3.getEnumType(DefaultTab) },
    { no: 2, name: "view_mode", kind: "enum", T: proto3.getEnumType(ViewMode) },
    { no: 3, name: "labels_view_mode", kind: "enum", T: proto3.getEnumType(LabelsViewMode) },
    { no: 4, name: "available_resource_mode", kind: "enum", T: proto3.getEnumType(AvailableResourceMode) },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UnifiedResourcePreferences {
    return new UnifiedResourcePreferences().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UnifiedResourcePreferences {
    return new UnifiedResourcePreferences().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UnifiedResourcePreferences {
    return new UnifiedResourcePreferences().fromJsonString(jsonString, options);
  }

  static equals(a: UnifiedResourcePreferences | PlainMessage<UnifiedResourcePreferences> | undefined, b: UnifiedResourcePreferences | PlainMessage<UnifiedResourcePreferences> | undefined): boolean {
    return proto3.util.equals(UnifiedResourcePreferences, a, b);
  }
}
