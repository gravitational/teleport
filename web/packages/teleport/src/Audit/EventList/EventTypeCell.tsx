...
const EventIconMap: Record<EventCode, any> = {
  ...
  [eventCodes.AWS_IC_ACCOUNT_SYNC]: Icons.AmazonAws,
  [eventCodes.AWSIC_ACCOUNT_ASSIGNMENT_SYNC]: Icons.AmazonAws,
  [eventCodes.AWSIC_PERMISSION_SET_SYNC]: Icons.AmazonAws,
  [eventCodes.AWS_IC_USER_GROUP_SYNC]: Icons.AmazonAws,
  [eventCodes.AWSIC_PRINCIPAL_ASSIGNMENT_CREATE]: Icons.AmazonAws,
  [eventCodes.AWSIC_PRINCIPAL_ASSIGNMENT_DELETE]: Icons.AmazonAws,
  [eventCodes.AWSIC_PRINCIPAL_PROVISIONING_CREATE]: Icons.AmazonAws,
  [eventCodes.AWSIC_PRINCIPAL_PROVISIONING_DELETE]: Icons.AmazonAws,
  [eventCodes.AWSIC_PRINCIPAL_PROVISIONING_UPDATE]: Icons.AmazonAws,
};
