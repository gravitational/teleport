...
const EventIconMap: Record<EventCode, any> = {
  ...
  [eventCodes.AWS_IC_RESOURCE_SYNC]: Icons.AmazonAws,
  [eventCodes.AWSIC_PERMISSION_ASSIGNMENT_CREATE]: Icons.AmazonAws,
  [eventCodes.AWSIC_PERMISSION_ASSIGNMENT_DELETE]: Icons.AmazonAws,
