...
const EventIconMap: Record<EventCode, any> = {
  ...
  [eventCodes.ACCESS_LIST_MEMBER_CREATE]: Icons.Info,
  [eventCodes.ACCESS_LIST_MEMBER_CREATE_FAILURE]: Icons.Warning,
  [eventCodes.ACCESS_LIST_MEMBER_UPDATE]: Icons.Info,
  [eventCodes.ACCESS_LIST_MEMBER_UPDATE_FAILURE]: Icons.Warning,
  [eventCodes.ACCESS_LIST_MEMBER_DELETE]: Icons.Info,
  [eventCodes.ACCESS_LIST_MEMBER_DELETE_FAILURE]: Icons.Warning,
  [eventCodes.ACCESS_LIST_MEMBER_DELETE_ALL_MEMBERS]: Icons.Info,
  [eventCodes.ACCESS_LIST_MEMBER_DELETE_ALL_MEMBERS_FAILURE]: Icons.Warning,
