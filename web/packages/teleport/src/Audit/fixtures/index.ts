...
export const events = [
  ...
  {
    'addr.remote': '11.22.33.44',
    app_name: 'aws-console-app',
    app_public_addr: 'aws-console-app.example.teleport.sh',
    app_uri: 'https://console.aws.amazon.com/ec2/v2/home',
    aws_role_arn: 'arn:aws:iam::278576220453:role/steve-poweruser',
    cluster_name: 'example.teleport.sh',
    code: 'T2014I',
    ei: 1724359576222794500,
    event: 'app.session.aws_console.request',
    namespace: 'default',
    private_key_policy: 'none',
    role_session_name: 'STeve',
    server_id: '645019de-ce15-4032-8b12-98b0b6f7d6ea',
    server_version: '17.0.0',
    sid: '236f58d343898ff94ee16b51c63aeff4df5eb89164413757d071d54e7a3487dc',
    success: true,
    time: '2024-08-22T20:46:16.218Z',
    uid: '04e55955-f002-479a-8dd2-3ea3aaabb388',
    user: 'STeve',
    user_kind: 1,
  },
  {
    ...
    app_public_addr: 'aws-console-app.example.teleport.sh',
    app_uri: 'https://console.aws.amazon.com/ec2/v2/home',
    aws_role_arn: 'arn:aws:iam::278576220453:role/does-not-exist',
    cluster_name: 'example.teleport.sh',
    code: 'T2014W',
    ei: 1724359575664750800,
    error: 'some error',
    event: 'app.session.aws_console.request',
    namespace: 'default',
    private_key_policy: 'none',
    ...
    server_id: '645019de-ce15-4032-8b12-98b0b6f7d6ea',
    server_version: '17.0.0',
    sid: 'c3ee8fca1cd2b76897860cc68c06dfd9bc777f650a7986f5897f3caa510b1fd9',
    success: false,
    time: '2024-08-22T20:46:15.66Z',
    uid: '503abbed-193a-4b85-a6e4-68bb40f1dc4e',
    user: 'STeve',
    user_kind: 1,
  },
].map(makeEvent);
