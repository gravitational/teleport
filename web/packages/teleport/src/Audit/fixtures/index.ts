...
export const events = [
  ...
  },
  {
    ...
    db_user: 'postgres',
    ei: 19,
    event: 'db.session.postgres.parse',
  ...
  },
  {
    ...
    db_user: 'postgres',
    ei: 21,
    event: 'db.session.postgres.execute',
    portal_name: '',
    sid: '5e0c50cc-4ee7-4110-8d6e-735bf1f06f1f',
    time: '2021-12-16T00:40:37.071Z',
  ...
  },
  {
    ...
    db_user: 'postgres',
    ei: 22,
    event: 'db.session.postgres.close',
    portal_name: '',
    sid: '5e0c50cc-4ee7-4110-8d6e-735bf1f06f1f',
    statement_name: 'test-ps',
  ...
  },
  {
    ...
    db_user: "alice",
    ei: 0,
    event: "db.session.mysql.stmt_prepare",
    query: "UPDATE `test`.`user` SET `age` = '7' WHERE (`name` = 'alice')",
    sid: "e42e968c-53cd-4b9d-8464-d5617c86f886",
    time: "2022-02-10T20:57:57.715Z",
  ...
  },
  {
    ...
    db_user: "alice",
    ei: 0,
    event: "db.session.mysql.stmt_execute",
    parameters: null,
    sid: "e42e968c-53cd-4b9d-8464-d5617c86f886",
    statement_id: 1,
    time: "2022-02-10T20:57:57.742Z",
    uid: "0a2bd129-7c2f-4e68-9c84-a17dc4415444",
    user: "alice@example.com"
  },
  {
    ...
    db_user: "alice",
    ei: 0,
    event: "db.session.mysql.stmt_send_long_data",
    sid: "e42e968c-53cd-4b9d-8464-d5617c86f886",
    statement_id: 1,
    parameter_id: 2,
    data_size: 32,
    time: "2022-02-10T20:57:57.777Z",
    uid: "0a2bd129-7c2f-4e68-9c84-a17dc4415444",
    user: "alice@example.com"
  },
  {
    ...
    db_user: "alice",
    ei: 0,
    event: "db.session.mysql.stmt_close",
    sid: "e42e968c-53cd-4b9d-8464-d5617c86f886",
    statement_id: 1,
    time: "2022-02-10T20:57:57.803Z",
    uid: "0a2bd129-7c2f-4e68-9c84-a17dc4415444",
    user: "alice@example.com"
  },
  {
    ...
    db_user: "alice",
    ei: 0,
    event: "db.session.mysql.stmt_reset",
    sid: "e42e968c-53cd-4b9d-8464-d5617c86f886",
    statement_id: 1,
    time: "2022-02-10T20:57:57.788Z",
    uid: "0a2bd129-7c2f-4e68-9c84-a17dc4415444",
    user: "alice@example.com"
  },
].map(makeEvent);
