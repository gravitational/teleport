...
export function AddAuthDeviceWizard({
  ...
  const registerMfaOptions = createMfaOptionsFromAuth2faType(auth2faType);
  ...
  return (
    ...
    >
      <StepSlider
        ...
        // Step properties
        registerMfaOptions={registerMfaOptions}
        reauthMfaOptions={reauthMfaOptions.data}
        attempt={attempt}
