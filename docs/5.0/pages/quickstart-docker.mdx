...
[there are more instructions above in Step 3](quickstart.mdx) if you'd like additional details):
...
You can now [follow this guide from Step 4 onwards](quickstart.mdx) to
