...
it's listening on [TCP/IP ports](../admin-guide.mdx#ports). On _auth.example.com_, it should
...
Take a look at the [SSH via Single Sign-on](ssh-sso.mdx) chapter to learn the basics of
