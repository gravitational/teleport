...
Teleport core service [`teleport`](cli-docs.mdx#teleport) and admin tools [`tctl`](cli-docs.mdx#tctl) has been designed to run on **Linux** and **Mac** operating systems.
