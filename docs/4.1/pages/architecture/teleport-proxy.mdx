...
1. It serves as an authentication gateway. It asks for credentials from
   ...
   API](teleport-auth.mdx#auth-api).
...
See the [admin guide](../admin-guide.mdx#recorded-sessions) to learn how to turn on
the recording proxy mode.

## More Concepts

* [Architecture Overview](teleport-architecture-overview.mdx)
* [Teleport Users](teleport-users.mdx)
* [Teleport Auth](teleport-auth.mdx)
* [Teleport Proxy](teleport-proxy.mdx)
