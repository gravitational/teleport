---
title: Workload Identity Overview
...
of our supported join methods, which in many cases enable it to authenticate 
...
- [Workload Identity API and Workload Attestation](../../reference/machine-workload-identity/workload-identity/workload-identity-api-and-workload-attestation.mdx): To learn more about the Workload Identity API and Workload Attestation.
