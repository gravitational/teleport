...
In this guide, you will configure the RBAC necessary to allow a Bot to issue
...
- Read the [Workload Identity reference](../../reference/machine-workload-identity/workload-identity/workload-identity-resource.mdx)
