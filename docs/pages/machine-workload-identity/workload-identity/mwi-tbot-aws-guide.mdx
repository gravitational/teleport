...
In this guide, you will deploy the Machine & Workload Identity agent `tbot` on
an Amazon EC2 instance and set up Machine and Workload Identity (MWI). By the
end, you'll have a working `tbot` service that issues SPIFFE-compatible
credentials to workloads running on your EC2 instance.
