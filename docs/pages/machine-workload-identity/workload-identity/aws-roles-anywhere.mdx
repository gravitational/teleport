...
In this guide, you will configure AWS Roles Anywhere to accept Teleport-issued
certificates, create a Workload Identity Bot to issue them, and configure your
AWS tooling to authenticate to AWS services with these credentials.
