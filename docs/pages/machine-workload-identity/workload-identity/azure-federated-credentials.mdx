...
In this guide, you will configure Teleport Workload Identity and Azure to allow
a workload to authenticate to the Azure Blob Storage and upload content to a
container.
