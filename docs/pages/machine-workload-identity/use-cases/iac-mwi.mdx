...
Teleport further enhances this model by recording every credential issuance in a comprehensive [audit log](../../get-started/audit.mdx), simplifying compliance and reporting.
