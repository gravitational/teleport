---
title: Deploy SPIFFE Workload API with tbot
sidebar_label: SPIFFE Workload API with tbot
description: Configure tbot to provide SPIFFE-compatible workload identities through the Workload API endpoint
tags:
 - get-started
 - mwi
...
[Best Practices](../introduction-workload-id/best-practices.mdx) guide.
...
See the [Best Practices](../introduction-workload-id/best-practices.mdx) guide for more information on
