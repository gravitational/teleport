...
- [AWS](../../machine-workload-identity/deployment/aws-oidc-federation.mdx)
- [Google Cloud Platform](../../machine-workload-identity/access-guides/gcp-workload-identity-federation-jwt.mdx)
...
Workload Identity.
- [Best Practices](./best-practices.mdx): Best practices for using SPIFFE with Workload
