---
title: Best Practices for SPIFFE in Teleport Workload Identity
sidebar_label: SPIFFE Best Practices
description: Answers common questions and describes best practices for using SPIFFE with Teleport Workload Identity.
tags:
 - conceptual
 - mwi
...
[Getting Started with Workload Identity](./spiffe-workload-api.mdx).
