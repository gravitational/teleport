...
For the role defintion, edit the `kubernetes_labels`
...
spec:
  ...
  # enterprise_server_host: github.mycompany.com # use for self-hosted GitHub Enterprise
  # enterprise_slug: mycompany # use for GitHub Enterprise Cloud organization
```
</details>
...
In your GitHub repository, go to the `Actions` tab, select the workflow you created, and click `Run workflow`.
