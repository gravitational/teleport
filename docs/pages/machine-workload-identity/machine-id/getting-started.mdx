...
Teleport Machine and Workload Identity (MWI) is a versatile tool that integrates
with many platforms and protected resource types and enables use cases from
secure [Infrastructure-as-Code](../iac-mwi.mdx) to [AI Agents](../ai-agents-mwi.mdx).
This guide shows one of the most common use cases, running commands on deployment targets
from CI/CD. If this is not your goal, this guide will show you the basics of how to get started with MWI
configuration, and you can then explore the use case pages to find links to your tools.
...
Most people should be able to set up a GitHub Actions workflow on a personal repository, and
will already have one of those targets enrolled. If you don't have a target resource that you can use
for this guide enrolled, follow one of the [guides](../../enroll-resources/enroll-resources.mdx) for
...
without distributing long-lived credentials, making the process more secure and more efficient for development teams.
