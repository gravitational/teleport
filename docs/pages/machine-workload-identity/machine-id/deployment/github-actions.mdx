...
[GitHub Actions reference page.](../../../reference/machine-workload-identity/machine-id/github-actions.mdx)
...
- For more information about the `github` join method, read the [GitHub Actions
  reference page](../../../reference/machine-workload-identity/machine-id/github-actions.mdx)
- Find out more about GitHub Actions itself, read
  [their documentation](https://docs.github.com/en/actions).
- [More information about `anonymous-telemetry`.](../../../reference/machine-workload-identity/machine-id/telemetry.mdx)
