...
- If you have not already connected your Kubernetes cluster to Teleport, follow
  [Enroll a Kubernetes Cluster](../../../zero-trust-access/enroll-resources/kubernetes-access/getting-started.mdx).
...
- Read the [Teleport Kubernetes RBAC guide](../../../zero-trust-access/enroll-resources/kubernetes-access/controls.mdx)
