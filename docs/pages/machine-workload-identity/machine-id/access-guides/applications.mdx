...
- If you have not already connected your application to Teleport, follow
  the [Protect a Web Application with Teleport](../../../zero-trust-access/enroll-resources/application-access/getting-started.mdx).
...
- Review the [Access Controls Reference](../../../reference/access-controls/roles.mdx)
  ...
  your bot may access.
- Configure [JWTs](../../../zero-trust-access/enroll-resources/application-access/jwt/introduction.mdx) for your
