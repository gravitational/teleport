...
- If you have not already put your database behind the Teleport Database Service,
  follow the [database access getting started guide](../../../zero-trust-access/enroll-resources/database-access/getting-started.mdx).
  The Teleport Database Service supports databases like PostgreSQL, MongoDB,
  Redis, and much more. See our [database access
  guides](../../../zero-trust-access/enroll-resources/database-access/guides/guides.mdx) for a complete list.
...
[Database Access RBAC guide](../../../zero-trust-access/enroll-resources/database-access/rbac.mdx)
