...
- [Google Cloud Platform](../machine-workload-identity/deployment/gcp-workload-identity-federation-jwt.mdx)
- [Azure](../machine-workload-identity/deployment/azure-federated-credentials.mdx)
