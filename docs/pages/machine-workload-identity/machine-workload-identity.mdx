...
description: "Includes guides for Machine & Workload Identity, which replaces static secrets with secure, short-lived identities for machines and workloads."
...
<Integrations
  ...
  integrations={[
    ...
    {
      title: 'Azure DevOps',
      href: './deployment/azure-devops/',
      iconColor: '#0078D41A',
      iconComponent: azureDevOpsSvg,
    },
    {
      title: 'Bitbucket Pipelines',
      href: './deployment/bitbucket/',
      iconColor: '#0078D41A',
      iconComponent: bitbucketSvg,
    },
    {
      title: 'CircleCI',
      href: './deployment/circleci/',
      iconColor: '#0000001A',
    ...
    }, 
    {
      ...
      href: './deployment#deployment-guides',
...
<Integrations
  ...
  integrations={[
    ...
    },
    {
      ...
      href: './access-guides/applications/',
      iconColor: '#F1F2F4',
