...
description: How to deploy tbot and configure Machine ID and Workload Identity on an AWS EC2 instance
tags:
 - how-to
 - get-started
 - mwi
...
Next, configure Workload Identity on the target resource you just created. 
...
The Workload Identity resource specifies a number of key things, including:
...
[Best Practices](./best-workload-identity/best-practices.mdx) guide.

## Step 6/9. Create Workload Identity file 
...
## Step 7/9. Configure `workload-identity-api` service in `tbot`
