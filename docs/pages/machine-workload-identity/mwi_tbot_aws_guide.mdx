...
services:
  - type: workload-identity-api
    ...
    # Optional workload attestation configuration to restrict which processes
    # can obtain credentials from this service
    unix:
      enabled: true
      # Optional: Restrict by user IDs (numeric)
      uid:
        equals: [1000]
      # Optional: Restrict by group IDs (numeric)
      gid:
        equals: [1000]
```
...
## Step 9/9. Testing the Workload API with `tbot spiffe-inspect`
