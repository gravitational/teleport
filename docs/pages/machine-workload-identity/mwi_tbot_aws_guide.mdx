...
## Step 5/10: Create a role for tbot
...
Together, these settings let tbot securely act as a delegate that retrieves and renews Teleport-issued credentials for your workloads, without giving it 
unnecessary or permanent privileges.

## Step 6/10: Assign the role to the bot
...
## Step 7/10. Configure Workload Identity
...
## Step 8/10. Expose a Workload API endpoint
...
## Step 9/10. Testing the Workload API with `tbot spiffe-inspect`
...
## Step 10/10. Configuring your workload to use the Workload API
