...
Teleport further enhances this model by recording every credential issuance in a comprehensive [audit log](/reference/monitoring/audit.mdx), simplifying compliance and reporting.