...
Workload Identity.
- [JWT SVID Overview](../../machine-workload-identity/SPIFFE/jwt-svids.mdx): Overview of the JWT SVIDs issued by
Teleport Workload Identity.
- [Best Practices](../SPIFFE/best-practices.mdx): Best practices for using Workload
