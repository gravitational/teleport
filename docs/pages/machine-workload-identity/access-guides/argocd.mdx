---
title: Machine & Workload Identity with Argo CD
description: How to use Machine & Workload Identity to enable Argo CD to connect to external Kubernetes clusters
...
cluster credentials. When configured to use the Argo CD output service, `tbot`
...
[methods](../../reference/deployment/join-methods.mdx), but for this guide we will use
...
$ argocd cluster list
SERVER                                                                    NAME
https://example.teleport.sh:443/v1/teleport/dHAxLmZsb3BweS5jbw/Ym94b2ZyYWQ1  test.teleport.sh-prod-eu-1
