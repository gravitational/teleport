...
Teleport Machine & Workload Identity replaces long-lived static secrets in Infrastructure-as-Code (IaC) tools with short-lived, automatically generated certificates.

Machine & Workload Identity supports Terraform and Pulumi, and has native integrations with AWS, GCP and Azure, as well as solutions for on-prem configuration.
