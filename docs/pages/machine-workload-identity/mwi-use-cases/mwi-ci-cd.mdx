...
<TileGrid
  tiles={[
    {
      icon: <Icon name="azure-devops" size="xl" />,
      to: "../machine-id/deployment/azure-devops",
      name: "Azure DevOps",
    },
    {
      icon: <Icon name="bitbucket" size="xl" />,
      to: "../machine-id/deployment/bitbucket",
      name: "BitBucket",
    },
    {
      icon: <Icon name="circleci" size="xl" />,
      to: "../machine-id/deployment/circleci",
      name: "CircleCI",
    },
    {
      icon: <Icon name="gitlab-ci" size="xl" />,
      to: "../machine-id/deployment/gitlab",
      name: "GitLab CI",
    },
    {
      icon: <Icon name="jenkins" size="xl" />,
      to: "../machine-id/deployment/jenkins",
      name: "Jenkins",
    }
  ]}
/>
