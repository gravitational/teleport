...
description: Managing App to App mTLS with Machine & Workload Identity
labels:
 - conceptual
 - mwi
---
...
[Introduction to Workload Identity](/machine-workload-identity/workload-identity/introduction.mdx): Learn how Teleport verifies applications and issues credentials
