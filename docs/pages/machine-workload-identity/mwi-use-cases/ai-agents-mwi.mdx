...
Teleport can secure any type of infrastructure it supports, such as SSH servers, Kubernetes clusters, databases, or MCP servers, when accessed by agents. All queries, commands, and requests executed by the agent are logged, providing full visibility and [auditability](/reference/monitoring/audit.mdx).

## Interested in a Design Partnership?

<Admonition type="tip" title="Exploring AI Agents with MWI?">
If you're exploring how to secure AI Agents with Teleport Machine & Workload Identity, we'd love to hear from you. Contact us to share your use case and learn more about opportunities for a design partnership.
</Admonition>
