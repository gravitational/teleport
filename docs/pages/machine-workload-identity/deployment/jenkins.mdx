...
In this guide, you will create a Machine & Workload Identity Bot and use it to
generate short-lived credentials that your Jenkins pipeline can use to connect
to Teleport-protected infrastructure.

{/* lint ignore page-structure remark-link */}
