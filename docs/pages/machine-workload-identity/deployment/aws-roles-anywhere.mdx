...
[best practices guide](../introduction-workload-id/best-practices.mdx) for further advice.
...
- [Workload Identity Overview](../introduction-workload-id/introduction.mdx): Overview of Teleport
Workload Identity.
- [Best Practices](../introduction-workload-id/best-practices.mdx): Best practices for using Workload
