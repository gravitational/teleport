...
auth_service:
 access_monitoring:
   ...
   # The Teleport role should have a configured trust relationship and be able to assume this role.
...
Access Monitoring uses a different AWS role to execute Athena SQL queries.
...
You can used our [Terraform Example](https://github.com/gravitational/teleport/tree/f38bac4bcf6e462a1cab66a0b6074ded4201867d/examples/athena)
