---
title: Authenticate to Grafana with Teleport
...
- An instance of Grafana Enterprise, with edit access to `grafana.ini`.
  - A certificate solution to create TLS certificates/keys for the SAML connection.
...
| `ipd_metadata`     | The base64-encoded contents of the Teleport metadata XML file. |
