...
In the case of iamshowcase app, which this guide is based on, the sample app is desigend to grant access protected page
...
This concludes a working service provider added to Teleport SAML IdP.
