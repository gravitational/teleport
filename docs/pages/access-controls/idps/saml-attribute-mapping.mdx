...
This page explains how the SAML attribute mapping works in Teleport, which can be used to assert custom
user attribute name and values in a SAML response.
