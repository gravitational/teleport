...
By default, Headless Login is available on cluster's with WebAuthn configured. If you want to forbid headless login to your cluster, add `headless: false` to your configuration:
