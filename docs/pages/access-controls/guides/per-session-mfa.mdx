...
- Installed [Teleport](../getting-started.mdx) or [Teleport Pro](../../pro/introduction.mdx) >= (=teleport.version=)
...
<iframe
  width="712"
  height="400"
  src="https://www.youtube-nocookie.com/embed/j8Ze7HhjFGw?rel=0&modestbranding=1"
  frameBorder="0"
