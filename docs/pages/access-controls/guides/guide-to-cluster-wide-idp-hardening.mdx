...
[sign up](https://goteleport.com/signup) for a free trial or [set up a demo environment](../../index.mdx).
...
- A device must be registered. Registration may be [manual](#register-a-trusted-device) or performed using an
