...
- [Per-Session MFA](../access-controls/guides/per-session-mfa.mdx): Per-session multi-factor authentication.
- [MFA for Administrative Actions](../access-controls/guides/mfa-for-admin-actions.mdx): Multi-factor authentication for admin actions.
