...
- Machines for Headless WebAuthn activities have [Linux](../../installation#linux), [Mac](../../installation.mdx#macos) or [Windows](../../installation.mdx##windows-tsh-client-only) `tsh` binary v12.2+ installed.
