...
- Installed [Teleport Enterprise](../../enterprise/introduction.mdx) or [Teleport Pro](../../pro/introduction.mdx) >= (=teleport.version=)
...
<iframe
  width="712"
  height="400"
  src="https://www.youtube-nocookie.com/embed/b_iqJm_o15I?rel=0&modestbranding=1"
  frameBorder="0"
