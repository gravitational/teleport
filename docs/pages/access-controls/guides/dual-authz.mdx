...
>
  This guide requires a commercial edition of Teleport. The open source Teleport Community Edition only supports [Github](../../admin-guide.mdx#github-oauth-20) as
  an SSO provider.
</Admonition>
