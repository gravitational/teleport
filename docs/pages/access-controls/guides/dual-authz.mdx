...
You can set up Teleport to require require approvals of multiple members to perform some critical actions.
Here are the most common scenarios:

- Improve security of your system and prevent one successful phishing attack to compromise your system.
...
Teleport will generate `auth.crt`, `auth.key`, and `auth.cas` - a certificate, a private key, and a CA certs respectively.
...
You may be getting certificate errors if Teleport's auth server missing
