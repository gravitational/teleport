...
<Details title="Version Requirements" min="8.3" opened>
  Moderated Sessions is only available in Teleport 8.3.0 and above.
  If you are using a previous version of Teleport, you must specify `version: v4` or earlier for role resources.
</Details>
