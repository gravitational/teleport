...
In addition, Teleport administrators can define rules that allow users to join eachothers
sessions from `tsh` and the Web UI. More on this [here](#join_sessions).
