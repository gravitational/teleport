...
For a detailed list of cryptographic algorithms used in FIPS mode please consult [Teleport FIPS documentation](https://goteleport.com/docs/access-controls/compliance-frameworks/fedramp/#default-cryptographic-algorithms).
