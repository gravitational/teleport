...
| `reviewer`| Enterprise-only role that allows reviewing of application and user group access requests. |
| `requester`| Enterprise-only role that allows requesting of application and user group access. |
