...
allow:
  rules:
    ...
    - resources:
        - role
      verbs: [list, create, read, update, delete]
    # Auth Connectors: aka SSO connectors.
    - resources:
        - auth_connector
      verbs: [list, create, read, update, delete]
    ...
    - resources:
        - trusted_cluster
      verbs: [list, create, read, update, delete]
    # Events: Determines whether a user view the audit log and session recordings.
    - resources:
        - event
      verbs: [list, read]
    - resources:
        - user
      verbs: [list, create, read, update, delete]
    # Enterprise customers can enable app and node wizard enabling the token resource.
    - resources:
        - token
      verbs: [list, create, read, update, delete]
