...
Below is an example `allow` section of commonly used `rules`:

```yaml
allow:
  rules:
    # Role: CRUD options for managing Teleport Server Access Nodes
    - resources:
        - node
      verbs: [list, create, read, update, delete]
    # Role: CRUD options for managing Teleport Application Access Servers
    - resources:
        - app_server
      verbs: [list, create, read, update, delete]
    # Role: CRUD options for managing Teleport Kubernetes Access Services
    - resources:
        - kube_service
      verbs: [list, create, read, update, delete]
    # Role: CRUD options for managing Teleport Database Access Servers
    - resources:
        - db_server
      verbs: [list, create, read, update, delete]
    # Role: CRUD options for managing Teleport Desktop Access Desktops
    - resources:
        - windows_desktop
      verbs: [list, create, read, update, delete]
