...
spec:
  ...
  deny:
    ...
    # users to create sessions including SSH ones but to only view their own sessions.
    - resources: [session_tracker]
...
| `session_tracker.participants` | The list of participants from an SSH or Kubernetes session      |
