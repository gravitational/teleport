...
List of key rule options defined below.

```yaml
allow:
  rules:
    # Role: CRUD options for managing Teleport Nodes
    - resources:
        - node
      verbs: [list, create, read, update, delete]
    # Role: CRUD options for managing Teleport Application Servers
    - resources:
        - app_server
      verbs: [list, create, read, update, delete]
    # Role: CRUD options for managing Teleport Kubernetes Services
    - resources:
        - kube_service
      verbs: [list, create, read, update, delete]
    # Role: CRUD options for managing Teleport Database Servers
    - resources:
        - db_server
      verbs: [list, create, read, update, delete]
    # Role: CRUD options for managing Teleport Windows Desktops
    - resources:
        - windows_desktop
      verbs: [list, create, read, update, delete]
