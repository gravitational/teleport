...
| `record_session` |Defines the session recording options, including [Session recording modes](../reference/audit.mdx#modes) for SSH access.|The strictest value takes precedence.|
