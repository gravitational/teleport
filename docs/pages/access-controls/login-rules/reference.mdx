...
`traits_map` will remove any traits not included while `trait_expression` will
not. This is useful if you want to keep only a handful of traits while filtering
everything else.
