...
The `email.local` helper was introduced in Teleport v13.3.0, all Auth servers
...
<Admonition type="note">
The `regexp.replace` helper was introduced in Teleport v13.3.0, all Auth servers
must be running this version or greater before it can be used.
</Admonition>
