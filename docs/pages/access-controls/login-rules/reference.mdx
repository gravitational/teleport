...
## Maintaining Login Rule objects

Users must have right to read and maintain `login_rule` objects within 
their role. The default `editor` role will automatically have this configured. Here
is an example role with those rights.
