...
- Follow Step 1 of the
  [Teleport operator guide](../../management/configuration/teleport-operator.mdx#step-13-install-teleport-cluster-helm-chart-with-the-operator)
...
- Read the [Teleport Operator Guide](../../management/configuration/teleport-operator.mdx) to
