...
If you Teleport cluster is older than v12, you will need to create and grant `device` role to manage device inventory.[link to below]
</Admonition>
...
A previously registered device is necessary for
