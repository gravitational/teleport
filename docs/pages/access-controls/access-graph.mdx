...
Note: For Teleport Cloud customers, Access Graph is enabled by default.
If you are a self-hosted Teleport customer, you will need to set up [Access Graph](./access-controls/self-hosted.mdx). 
</Admonition>
