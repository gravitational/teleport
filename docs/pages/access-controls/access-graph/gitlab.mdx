...
description: Describes how to syncronize GitLab access patterns using Teleport Policy and Access Graph.
---
Teleport Policy streamlines and centralizes access management across your entire infrastructure, allowing you to view
access relationships within seconds. You can see unified, up-to-date relationships and policies between all users, groups,
...
- For self-hosted clusters, a running Access Graph node v1.20.0 or later.
...
Create a new token with the `read_api` scope and copy the generated token.
...
to all projects and subprojects within that group.
