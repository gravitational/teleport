...
account necessitates the setup of the Access Graph (TAG)
service, a Discovery Service, and integration with your AWS account.

Teleport Policy’s Access Graph is a feature of the [Teleport
Policy](https://goteleport.com/platform/policy/) product that is 
...
Service pushes them to the Access Graph feature service, ensuring that 
the Access Graph remains updated with the latest information from your AWS environment.
