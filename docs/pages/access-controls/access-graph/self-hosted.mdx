...
setting up the Teleport Access Graph (TAG) service. TAG is a dedicated service which uses 
...
This guide will help you set up the TAG service and enable Access Graph in your Teleport cluster.
...
## Step 1/3. Set up Teleport Policy Access Graph
