...
Utilizing the Access Graph to analyze Entra ID policies necessitates the setup of the Access Graph service,
and an integration with your Azure account.
...
- For self-hosted clusters, an updated `license.pem` with Teleport Identity and Teleport Policy enabled.
