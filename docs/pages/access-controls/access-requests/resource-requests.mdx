...
permissions for the cluter-scoped resource in the Teleport role.  This is an example of the 
required permissions to request access to the namespace `prod` only:
