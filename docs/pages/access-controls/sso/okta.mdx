...
configure a Teleport connector. You can find this on the "View Setup Instructions" page under "Optional- Provide the following IDP metadata to your SP provider.":
