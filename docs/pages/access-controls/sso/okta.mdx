...
- Single sign on URL: `https://<cluster-url>:<port>/webapi/saml/acs/okta`
- Audience URI (SP Entity ID): <nobr>`https://<cluster-url>:<port>/webapi/saml/acs/okta`</nobr>
...
metadata:
  name: okta
spec:
  acs: https://teleport.example.com:443/webapi/saml/acs/okta
  attributes_to_roles:
  - name: groups
    roles:
    - editor
  ...
  - name: groups
    ...
    - access
    value: okta-dev
  audience: https://teleport.example.com:443/webapi/saml/acs/okta
  cert: ""
  display: "Okta"
  entity_descriptor: ""
  entity_descriptor_url: https://example.okta.com/app/000000/sso/saml/metadata
  issuer: ""
  service_provider_issuer: https://teleport.example.com:443/webapi/saml/acs/okta
  sso: ""
version: v2
```
