...
<Admonition type="tip">
Set <Var name="teleport.example.com:443" description="Your Teleport proxy address and port, or cloud tenant." /> here with your Teleport Proxy address and port, or Teleport Cloud tenant (e.g. `company.teleport.sh:443`) to fill out the values below.
</Admonition>
