...
1. Enter the host **and port** of your Teleport Proxy Service host in the
   **Entity ID** and **Reply URL**  fields. For Teleport Cloud, the port is 443:

   ```code
   https://<Var name="mytenant.teleport.sh:443" />/v1/webapi/saml/acs
   ```
...
metadata:
  name: ad
spec:
  acs: https://<Var name="mytenant.teleport.sh:443" />/v1/webapi/saml/acs/ad
  attributes_to_roles:
  ...
  - name: http://schemas.microsoft.com/ws/2008/06/identity/claims/groups
    ...
    - access
    value: 8adac502...
  audience: https://<Var name="mytenant.teleport.sh:443" />/v1/webapi/saml/acs/ad
  cert: ""
  display: Microsoft
  entity_descriptor: ""
  ...
  issuer: ""
  service_provider_issuer: https://<Var name="mytenant.teleport.sh:443" />/v1/webapi/saml/acs/ad
  sso: ""
version: v2
...
metadata:
  name: ad
spec:
  acs: https://<Var name="mytenant.teleport.sh:443" />/v1/webapi/saml/acs/azure-saml
  attributes_to_roles:
  - name: http://schemas.microsoft.com/ws/2008/06/identity/claims/groups
    roles:
    - editor
    ...
    - auditor
    value: '*'
  audience: https://<Var name="mytenant.teleport.sh:443" />/v1/webapi/saml/acs/azure-saml
  cert: ""
  display: Microsoft
  entity_descriptor:
  entity_descriptor_url: https://login.microsoftonline.com/ff882432.../federationmetadata/2007-06/federationmetadata.xml?appid=b8d06e01...
  issuer: https://sts.windows.net/your-id-here/
  service_provider_issuer: https://<Var name="mytenant.teleport.sh:443" />/v1/webapi/saml/acs/azure-saml
  signing_key_pair:
    cert: |
      -----BEGIN CERTIFICATE-----
      ...
