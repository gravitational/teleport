...
7. For **Entity ID** and **Reply URL**, enter the same proxy URL.
   ...
   For self-hosted deployments, the URL will be similar to `https://teleport.example.com:3080/webapi/saml/acs/connectorName`.
...
spec:
  ...
  acs: https://teleport.example.com:3080/webapi/saml/acs/azure-saml
  attributes_to_roles:
...
metadata:
  name: azure-saml
spec:
  acs: https://teleport.example.com/webapi/saml/acs/azure-saml
  attributes_to_roles:
  - name: http://schemas.microsoft.com/ws/2008/06/identity/claims/groups
    ...
    - auditor
    value: '*'
  audience: https://teleport.example.com/webapi/saml/acs/azure-saml
  cert: ""
  display: Microsoft
  entity_descriptor: |
    <?xml ...
  ...
  service_provider_issuer: https://teleport.example.com/webapi/saml/acs/azure-saml
  signing_key_pair:
    cert: |
      -----BEGIN CERTIFICATE-----
      ...
