...
1. Select a **Non-gallery application**

   ![Select Non-gallery application](../../../img/azuread/azuread-3-selectnongalleryapp.png)

1. Enter the display name (e.g, Teleport)

   ![Enter application name](../../../img/azuread/azuread-4-enterappname.png)

1. Select **Properties** under **Manage** and set **User assignment required?** to **No**
...
1. For **Entity ID** and **Reply URL**, enter the same proxy URL.
...
1. In **SAML Signing Certificate**, click the link to download the **Federation Metadata XML**.
