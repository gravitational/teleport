...
7. Enter the URL for your Teleport cluster or Teleport tenant in the **Entity ID** and **Reply URL**  fields. For example:
...
8. Edit **Attributes & Claims**
   ...
   - Add a claim that transforms the format of the Azure AD username to lower case, in order to pass it to
