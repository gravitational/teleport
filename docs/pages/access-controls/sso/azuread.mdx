...
8. For **Entity ID** and **Reply URL**, enter the same proxy URL.
   ...
   For self-hosted deployments, the URL will be similar to `https://teleport.example.com:443/v1/webapi/saml/acs/connectorName`.
...
spec:
  ...
  acs: https://teleport.example.com:443/v1/webapi/saml/acs/azure-saml
  attributes_to_roles:
