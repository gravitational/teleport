...
<nobr><Var name="https://example.teleport.sh"/>`/webapi/oidc/callback`</nobr>
...
spec:
  ...
  redirect_url: https://example.teleport.sh:443/webapi/oidc/callback
version: v3
```
...
spec:
  ...
  issuer_url: https://accounts.google.com
  redirect_url: https://teleport.example.com/webapi/oidc/callback
version: v3
```
