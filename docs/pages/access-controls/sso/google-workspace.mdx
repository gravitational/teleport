...
Teleport Cloud: `example.teleport.sh:443/v1/webapi/oidc/callback`

Teleport Enterprise: `example.teleport.com:443/v1/webapi/oidc/callback`

Teleport Enterprise: `example.teleport.com:3080/v1/webapi/oidc/callback`
