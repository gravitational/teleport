...
Within the output of that command look for `"public_addr": "example.teleport.com:443"`. Some
cluster may specify a different port. Use the port you find in the output of the previous command
for the next steps.
