...
JSON into the configuration YAML. If you plan to take the first approach, you
will need to upload the JSON to the Auth Server.
...
Unless you paste the JSON into the OIDC Connector configuration, you will need
to upload the JSON file to all Auth Server hosts.
</Admonition>
