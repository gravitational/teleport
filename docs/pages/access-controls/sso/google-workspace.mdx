...
Most deployments use port 443 or port 3080. The callback URL you use might look like the following examples (replace example.teleport.com or example.teleport.sh with your cluster's value):

Teleport Cloud: `https://example.teleport.sh:443/v1/webapi/oidc/callback`

Teleport Enterprise: `https://example.teleport.com:443/v1/webapi/oidc/callback`

Teleport Enterprise: `https://example.teleport.com:3080/v1/webapi/oidc/callback`

Some clusters may specify a different port.
...
the callback URL you gathered in the [Determine your callback URL](#determine-your-callback-url)
section in the Callback URI field.
