...
command with your Oauth app's client ID, client secret, and the roles you want
to map from your GitHub organization to Teleport roles. See [tctl sso configure
github](../../reference/cli.mdx#tctl-sso-configure-github) for a full reference
of flags for this command:

```code
$ tctl ssh configure github \
...
You can optionally test the connector configuration before applying it to your cluster:
