...
By default, Teleport will reject OIDC claims/users that do not have a verified email address.
This information is given to Teleport via the `email_verified` OIDC claim.

For testing and other purposes, this may be disabled as shown below. Note that this may harm
security and extreme care should be taken outside of testing environments.
