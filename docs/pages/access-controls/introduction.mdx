...
Role-Based Access Control (RBAC) is almost always used in conjunction with Single Sign-On (SSO), Github (in the Teleport Community Edition) and OIDC or SAML (in the Teleport Enterprise
editions). 
