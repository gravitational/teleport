...
![Add integration](../../../img/access-graph/aws_enable_sync_access_graph_step2.png)
...
Teleport can also import and grant access to resources from an Okta organizations, such as user profiles, groups and applications. You can view connection data in Access Graph. Follow the steps here to add an [Okta 
