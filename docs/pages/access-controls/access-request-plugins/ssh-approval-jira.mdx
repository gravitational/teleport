...
This step is not necessary for Cloud-Hosted plugins.
</ScopedBlock>
...
<ScopedBlock scope="cloud">
The Jira plugin is automatically installed in your cluster.
</ScopedBlock>
...
<ScopedBlock scope="cloud">
### Enroll Jira Integration
Navigate to <em>Enroll New Integration</em> in the Teleport cluster management UI,
and select Jira from the list of No-Code Integrations.

![Enroll Jira](../../../img/access-controls/access-request-plugins/jira/1-enroll.png)

### Configure the Plugin

Configure the plugin to use your Jira server, and the Jira project board and API key generated in step 3.

![Configure Jira](../../../img/access-controls/access-request-plugins/jira/2-configure.png)

### Connect

Once you have supplied all of the required parameters, click the <em>Connect Jira</em> button and 
Teleport will automatically integrate with your Jira instance.
