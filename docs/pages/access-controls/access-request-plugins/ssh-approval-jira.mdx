...
This guide describes how to integrate Teleport access requests into a Jira project workflow. 
...
The Teleport access request plugin for Jira plugin automatically creates a new issue for each 
