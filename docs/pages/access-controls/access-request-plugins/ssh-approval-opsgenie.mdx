...
- The Opsgenie integration is currently only available in Teleport Enterprise Cloud.
...
or if annotations were set to override this then the alert will appear where specified
there instead.
