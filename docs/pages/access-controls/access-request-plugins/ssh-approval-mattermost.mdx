...
<TabItem label="Command line" options="Executable">
...
the host where you will run the Mattermost plugin, create a file called
...
`teleport-mattermost-helm.yaml` and execute the `helm upgrade ...` command
