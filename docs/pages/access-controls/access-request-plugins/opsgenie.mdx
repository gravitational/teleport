...
The 'opsgenie_notify_services' annotation specifies the service the alert will be be created for.
...
![Integrations menu](../../../img/enterprise/plugins/opsgenie/opsgenie-integrations-menu.png)
