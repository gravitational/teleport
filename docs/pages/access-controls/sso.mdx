...
<Admonition type="note" title="IdP-initiated SSO">
  ...
  This comes with [multiple security considerations worth reviewing](https://github.com/gravitational/teleport/blob/master/rfd/0073-idp-initiated-login.md).
  Please ensure you understand the security implications of enabling this flag before doing so.
</Admonition>
