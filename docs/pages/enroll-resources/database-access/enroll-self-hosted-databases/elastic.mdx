...
In a scenario where Teleport is using [single sign-on](../../../zero-trust-access/access-controls/sso/sso.mdx) you may want to define a mapping for all users to a role:
