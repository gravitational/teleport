...
<Admonition type="warning" title="Important">
  By default, Active Directory requires the user SID to be present in the certificate used for PKINIT authentication.
  Teleport retrieves this SID by querying LDAP.
  To ensure successful authentication, verify that all LDAP-related fields are correctly configured.
</Admonition>
...
These fields are required if your Active Directory setup mandates that the user’s SID be included in the certificate used for PKINIT.
