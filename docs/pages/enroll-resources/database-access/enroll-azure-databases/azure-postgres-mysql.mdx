...
needs to obtain access tokens from Entra ID.
...
Refer to [Use Microsoft Entra ID for authenticating with PostgreSQL](https://docs.microsoft.com/en-us/azure/postgresql/single-server/concepts-azure-ad-authentication)
