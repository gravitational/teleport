...
- If your Database Service runs on a Virtual Machine Scale Set (VMSS) in uniform
  mode, such as on an AKS cluster. In that case, `Microsoft.Compute/virtualMachineScaleSets/virtualMachines/read`
