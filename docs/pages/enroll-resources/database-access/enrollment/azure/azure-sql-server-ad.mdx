...
description: How to configure Teleport database access with Azure SQL Server using Microsoft Entra ID authentication.
tags:
 - how-to
 - zero-trust
...
![Access Azure SQL Server Microsoft Entra ID Self-Hosted](../../../../../img/database-access/guides/sqlserver/sql-aad.png)
</TabItem>
<TabItem scope={["cloud"]} label="Teleport Enterprise Cloud">
![Access Azure SQL Server Microsoft Entra ID Cloud](../../../../../img/database-access/guides/sqlserver/cloud-sql-aad.png)
</TabItem>
...
## Step 2/8. Enable the Microsoft Entra ID authentication

If you have it enabled, you can go to the next step.

Go to the [Azure Portal](https://portal.azure.com/), select **Database
servers**, and select the database you wish to enable the Microsoft Entra ID
authentication.
...
![Azure SQL Server Microsoft Entra ID admin page](../../../../../img/database-access/guides/sqlserver/azure-set-ad-admin.png)
...
its Active Directory Admin and execute the query:
...
## Further reading
- [Microsoft Entra ID authentication for Azure SQL](https://learn.microsoft.com/en-us/azure/azure-sql/database/authentication-aad-overview?view=azuresql)
