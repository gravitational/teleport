...
architecture-beta
  ...
  service users(carbon-user)[Users]
  service teleport(teleport-logo-purple)[Teleport Control Plane]

  group aws(logos-aws)[Virtual Private Cloud]
  service tdb(teleport-logo-purple)[Teleport Database Service] in aws
  service ddb(logos-aws-documentdb)[Amazon DocumentDB] in aws
