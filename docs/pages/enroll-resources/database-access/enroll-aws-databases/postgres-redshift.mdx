...
user that already exists in the Redshift database. This is the default
authentication method Teleport uses as demonstrated above.
...
If you choose the second method, create an AWS IAM role to provide user access
