...
![Enroll RDS with a Self-Hosted Teleport Cluster](../../../../img/database-access/guides/aws_memorydb_selfhosted.png)
</TabItem>
<TabItem scope={["cloud","team"]} label="Teleport Cloud">
![Enroll RDS with a Cloud-Hosted Teleport Cluster](../../../../img/database-access/guides/aws_memorydb_cloud.png)
</TabItem>
