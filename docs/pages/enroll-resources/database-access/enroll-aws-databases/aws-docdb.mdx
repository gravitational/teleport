...
![Teleport Architecture DocumentDB Access Self-Hosted](../../../../img/database-access/guides/docdb_selfhosted.png)
</TabItem>
<TabItem label="Cloud-Hosted">
![Teleport Architecture DocumentDB Cloud](../../../../img/database-access/guides/docdb_cloud.png)
</TabItem>
