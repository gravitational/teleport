...
## Step 1/8. Prepare the Oracle RDS Instance
...
## Step 2/8. Create Oracle AD users
...
## Step 3/8. Join the Linux node to Active Directory
...
## Step 5/8. Set up the Teleport Database Service
...
## Step 7/8. Create a Teleport users
...
```code
$ tsh db connect --db-user="alice" oracle --db-name MYPDB
```
