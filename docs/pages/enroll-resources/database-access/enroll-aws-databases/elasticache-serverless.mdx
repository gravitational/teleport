...
We recommend setting a strong password on your customized default user (IAM authentication as the default user is not possible) and using an access string that is not permissive.
