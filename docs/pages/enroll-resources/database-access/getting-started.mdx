...
See the [Automatic User Provisioning](./auto-user-provisioning/postgres..mdx) guide for how to configure Teleport to create accounts for your PostgreSQL users on demand.
...
- Learn how to configure [GUI clients](../../connect-your-client/third-party/gui-clients.mdx).
