...
To specify the database roles a user should be assigned within the database, use
the `db_roles` role option. To create the role below, open a file called
`db-user-creator.yaml`:
