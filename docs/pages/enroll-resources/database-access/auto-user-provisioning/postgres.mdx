...
- Teleport cluster with a configured [self-hosted
  PostgreSQL](../../../zero-trust-access/enroll-resources/database-access/enroll-self-hosted-databases/postgres-self-hosted.mdx) or [RDS
...
Refer to the [self-hosted PostgreSQL guide](../../../zero-trust-access/enroll-resources/database-access/enroll-self-hosted-databases/postgres-self-hosted.mdx#step-35-configure-your-postgresql-server)
