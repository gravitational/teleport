...
- Teleport cluster with a configured [self-hosted
  MariaDB](../../../zero-trust-access/enroll-resources/database-access/enroll-self-hosted-databases/mysql-self-hosted.mdx) or [RDS MariaDB](../enroll-aws-databases/rds.mdx)
  database.
