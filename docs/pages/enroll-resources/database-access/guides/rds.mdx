...
<Tabs>
<<<<<<<< HEAD:docs/pages/enroll-resources/database-access/guides/rds.mdx
...
>>>>>>>> e223dde982 ([v15] Condense docs sections into "Enroll Resources"):docs/pages/enroll-resources/database-access/enroll-aws-databases/rds.mdx
</TabItem>
...
(!docs/pages/includes/database-access/aws-create-db-configuration.mdx type="RDS" matcher="rds" protocol="&lt;Var name&equals;&quot;mysql or postgres&quot;&sol;&gt;" example="my-aurora-cluster.abcdefghijklm.us-west-1.rds.amazonaws.com:5432" !)
