...
- **High Availability**: Multiple Teleport Database Services can be deployed to proxy connections to the same enrolled databases. Teleport will avoid routing user connections through Database Services that can't reach the database endpoint.
