...
## Option 1: Configure the Discovery Service with automatic policy creation
...
## Option 2: Configure the Discovery Service manually
...
## Option 1: Configure multi-account discovery with automatic policy creation
...
## Option 2: Configure multi-account discovery manually
