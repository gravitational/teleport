...
If you want to discover EC2 instances in a single AWS account, follow either the
[Guided EC2 Auto-Discovery Configuration](ec2-discovery-guided.mdx) or
[Manual EC2 Auto-Discovery Configuration](ec2-discovery-manual.mdx) guides.
