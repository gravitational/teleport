...
Teleport, starts it and joins the cluster using the [IAM join method](../../../../installation/agents/aws-iam.mdx).
...
Teleport supports discovering EC2 instances launched by Amazon EC2 Auto Scaling
groups (ASGs). The Discovery Service discovers and enrolls ASG members as
ordinary EC2 instances through the existing EC2 discovery process. No
ASG-specific Teleport configuration is required.
...
manual or Terraform configuration may be suitable for you.
