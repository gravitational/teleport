...
sidebar_label: AWS Organizations for Self-Hosted
...
## Step 1/6. Create an EC2 invite token in Teleport
...
## Step 2/6. Allow the Auth Service to verify organization membership
...
## Step 3/6. Allow the Discovery Service to list accounts in the organization and assume roles in the target accounts
...
## Step 4/6. Configure IAM Roles in each target account
...
## Step 5/6. Install Teleport on the Discovery Node
<Admonition type="tip">
...
## Step 6/6. Configure Teleport to discover EC2 instances
