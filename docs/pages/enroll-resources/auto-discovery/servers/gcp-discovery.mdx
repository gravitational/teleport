...
<TabItem label="Console">
  ...
  If the Discovery Services will run in a GCP compute instance, edit the instance and
...
<TabItem label="gcloud">
  ...
  If the Discovery Services will run in a GCP compute instance, run the following command to
