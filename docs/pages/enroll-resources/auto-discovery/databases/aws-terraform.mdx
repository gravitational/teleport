...
Elastic Container Service (ECS) to provide access to those databases.
...
[AWS OIDC integration](../../application-access/cloud-apis/awsoidc-integration.mdx),
...
The Discovery Service only needs to be able to reach the Teleport Proxy and the
AWS API - it does not need network access to the databases.
...
[Amazon ECS console](https://console.aws.amazon.com/ecs/v2/clusters) and inspect
