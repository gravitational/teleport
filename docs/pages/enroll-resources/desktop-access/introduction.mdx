---
title: Manage Access to Desktop Resources
sidebar_label: Introduction
description: Demonstrates how you can manage access to Windows and Linux desktops with Teleport.
...
access to Windows and Linux desktops. Teleport provides the following key features:

- Passwordless access to desktop hosts backed by secure cryptographic
...
For more information about configuring basic access using Teleport Desktop
...
- [Configure access for Linux desktops](./linux-desktop.mdx)
