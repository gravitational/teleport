...
#### Error : The Kerberos Key Distribution Center (KDC) for the domain <Your Domain> does not have a certificate installed or does not support logon using certificates: 0xC0000320

You see this error in your Security-Kerberos Windows Event log on the client you're trying to connect to.

**Solution:** Review the Kerberos-Key-Distribution-Center Logs on each of your **Domain Controler** for causes.
...
Kdc Certificate Information:
  ...
  Serial Number: XX0000000XXXXXXXXXXXXXX000000000000
  Thumbprint: X00XX0990YYY9Y9Y22YYY123456789987654321
  Template: <Template used to generate your DC Certificate>
```
