...
### LDAP connection failing for 35 minutes

You see Teleport failing to contact your LDAP server for 35 minutes and an error in Teleport logs that looks similar to this:
...
**Solution:** Decrease the Domain Controller's timeouts in Certifiate Path Validation Settings Properties
...
Configuration > Windows Settings > Security Settings > Public Key Policies > Certifiate Path Validation Settings Properties
then under the Network Retreival tab.
