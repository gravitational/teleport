...
As of Teleport v18.8, Windows Desktop Service supports logins for users outside of a given `windows_desktop_service`
instance's configured domain so long as there is an outgoing trust relationship from the primary (Teleport configured)
