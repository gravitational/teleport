...
#### Grant access through remote desktop to foreign users
...
1. Click **Locations** and select the domain for which you wish to grant logon access to users/groups.
...
#### Add foreign users to the 'Remote Desktop Users' AD group
