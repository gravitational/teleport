...
description: Protect Windows and Linux desktop resources with Teleport's passwordless access and other features.
sidebar_position: 7
template: doc-page
tags:
 - zero-trust
...
<DocHero
  title="Configure access for Windows and Linux desktops"
  youtubeVideoId={
  ...
  ctaLinks={[
    ...
    {
      title: "Get started with Linux access",
      href: "./linux-desktop/",
      variant: "secondary",
      arrow: true,
    },
  ...
  links={[
    {
      title: "Desktop RBAC",
      description: "Set up granular access policies for desktops connected to Teleport.",
      href: "./rbac/",
      icon: userCheckSvg,
    }, 
    {
    ...
    },
    {
      ...
      description: "Common desktop access issues with Teleport and their solutions.",
      href: "./troubleshooting/",
      icon: questionSvg,
    },
  ]}
>
Provide secure, passwordless access to Windows and Linux desktops, backed by short-lived certificates, role-based access controls, clipboard and directory sharing, session recordings, and detailed audit logs.
</DocHero>
...
<Resources
  ...
  resources={[
    {
      title: "Intro to desktop access",
      description: "Windows and Linux desktop access with clipboard and file sharing, session recording, and audit logs.",
    ...
    },
    {
      ...
      description: "Provide secure, audited access to Linux desktops running X11 desktop environments.",
