...
See the
[Teleport Access Controls Reference](../../../reference/rbac/teleport-roles.mdx)
...
Refer to the `storage` section of the [Teleport Configuration Reference](../../../reference/config-references/config.mdx)
for more information on session logging and recording management.
