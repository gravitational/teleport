...
5. Restart the computer.
   ...
   Once restarted, you can verify the Teleport authentication package is loaded by running the following command in a Command Prompt and confirming that teleport appears in the output:
