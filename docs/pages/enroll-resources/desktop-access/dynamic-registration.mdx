...
Windows Desktop Service instances watch for updates from the Teleport Auth Service for
...
Windows desktops as long as at least one Windows Desktop Service
