...
See the full database resource spec [reference](../../../../reference/config-references/database-access.mdx).
...
- [Terraform Provider](../../../configure-teleport/dynamic-resources/terraform-provider.mdx)
- [Kubernetes Operator](../../../configure-teleport/dynamic-resources/teleport-operator.mdx)
- [Teleport API](../../../../index.mdx)

See [Using Dynamic Resources](../../../configure-teleport/dynamic-resources/overview.mdx) to learn
