...
Auth Service instances config file:
...
Teleport Proxy Service or Teleport Enterprise tenant (e.g.,
...
possibility in Teleport Enterprise.) Depending on the design of your
...
generated by the Auth Service instances certificate authority, called a **CA pin**. This
