...
The Kubernetes join method is not available in Teleport Enterprise as it requires the
...
- The Auth Service Account must be granted the `system:auth-delegator`
