...
- A running Teleport cluster in Kubernetes. For details on how to set this up,
  see [Guides for running Teleport using Helm](../../../../index.mdx).
...
- The Auth Service ServiceAccount must be granted the `system:auth-delegator`
  ...
  chart](../../../../reference/config-references/helm-reference/teleport-cluster.mdx) version 12 or
...
- The possible values for `teleport-kube-agent` chart are documented
  [in its reference](../../../../reference/config-references/helm-reference/teleport-kube-agent.mdx).
- See [Application Access Guides](../../../../index.mdx)
- See [Database Access Guides](../../../../index.mdx)
