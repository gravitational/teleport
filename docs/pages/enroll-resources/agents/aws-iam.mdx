...
to the instance, using either the AWS Management Console or CLI: 
...
1. Create an instance profile:
   ...
   ```code
   $ aws iam create-instance-profile --instance-profile-name <Var name="ExampleNoOpRole" />
   ```
...
1. Add the <Var name="ExampleNoOpRole" /> role to the profile:
   ...
   --instance-profile-name <Var name="ExampleNoOpRole" /> \
...
1. Run the following command to associate the new instance profile with your
   ...
   ```code
   $ aws ec2 associate-iam-instance-profile --iam-instance-profile Name="<Var name="ExampleNoOpRole" />" \
