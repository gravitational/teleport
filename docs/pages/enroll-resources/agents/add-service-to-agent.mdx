...
- [Terraform
  provider](../../reference/api/terraform-provider/resources/provision_token.mdx)
- [Kubernetes
  operator](../../reference/api/operator-resources/resources-teleport-dev-provisiontokens.mdx)
