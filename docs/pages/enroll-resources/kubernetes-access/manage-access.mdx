...
the Kubernetes [Access Controls Guide](../../../reference/agents/controls.mdx). You can leave your
...
Requests](../../access-controls/just-in-time/access-requests/resource-requests.mdx)
