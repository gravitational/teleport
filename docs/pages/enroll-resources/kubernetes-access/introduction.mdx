...
auto-discovery](../../zero-trust-access/enroll-resources/auto-discovery/kubernetes/kubernetes.mdx).
...
how to deploy a [pool of Teleport Agents](../../zero-trust-access/enroll-resources/agents/agents.mdx) to run
