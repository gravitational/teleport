...
This integration enables managing Rancher RBAC through Teleport's unified access control system, including role mappings and audit logging.
...
## Step 1/4. Configure Rancher access

In this step, we'll configure RBAC in Rancher to allow the Teleport Kubernetes Service to access Rancher clusters. This involves:

1. Adding users/groups to your clusters and assigning the Cluster Member role: [Adding Users to Clusters](https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/manage-clusters/access-clusters/add-users-to-clusters)
...
$ tsh login --proxy teleport.example.com
$ tsh status
>>>>>>> 65821460ed3bbbe51741fde27d0681c35ec70df7
