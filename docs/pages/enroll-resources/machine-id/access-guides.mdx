...
- [Teleport Terraform provider](../../management/dynamic-resources/terraform-provider/dedicated-server.mdx): How to use Machine ID with the Teleport Terraform provider to manage your Teleport configuration as IaC.
