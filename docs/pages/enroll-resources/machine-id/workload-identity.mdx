...
- [Federation](./workload-identity/federation.mdx): Learn about using Federation to allow workloads to trust workloads from other trust domains.
- [JWT SVIDs](./workload-identity/jwt-svids.mdx): Learn about the short-lived JWTs issued by Workload Identity.
...
- [GCP Workload Identity Federation](./workload-identity/gcp-workload-identity-federation-jwt.mdx): Configuring GCP to accept Workload ID JWTs as authentication using GCP Workload Identity Federation.
