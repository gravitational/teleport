...
| Field             | Description                                                                  |
|-------------------|------------------------------------------------------------------------------|
| `unix.attestated` | Indicates that the workload has been attested by the Unix Workload Attestor. |
...
| Field                        | Description                                                                        |
|------------------------------|------------------------------------------------------------------------------------|
| `kubernetes.attestated`      | Indicates that the workload has been attested by the Kubernetes Workload Attestor. |
