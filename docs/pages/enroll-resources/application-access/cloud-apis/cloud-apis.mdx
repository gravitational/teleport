...
<EnrollmentMethods title="" variant="rows">
  ...
  >
    ...
    <Method title="AWS Console and CLI with OIDC integration" href="../../../zero-trust-access/management/guides/awsoidc-integration-console/">
      **Recommended when:**
        - Full API audit for all requests is required.
  ...
  >
    ...
    <Method title="Azure Portal and CLI access with Teleport as IdP" href="../../../identity-governance/idps/saml-microsoft-entra-external-id/">
      **Recommended when:**
  ...
  >
    ...
    <Method title="Google Cloud Web Console and API access with Teleport as IdP" href="../../../identity-governance/idps/saml-gcp-workforce-identity-federation/">
      **Recommended when:**
