...
- A running Teleport cluster with a public domain name and valid TLS certificate.
  AWS must be able to reach `https://<your-cluster>/.well-known/openid-configuration`
  to validate OIDC tokens. IP-based or self-signed clusters will not work with
  this integration.
