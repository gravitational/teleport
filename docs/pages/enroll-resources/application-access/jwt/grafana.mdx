...
Add an `auth.jwt` section in your main config. Replace <Var
...
In your Teleport Application Service configuration file, `teleport.yaml`,
register an application entry for your Grafana instance. Assign <Var
name="http://grafana.example.com:3000"/> to the domain of your Grafana instance:
...
app_service:
  ...
  apps:
  - name: "grafana"
    uri: <Var name="http://grafana.example.com:3000"/>
    rewrite:
      headers:
