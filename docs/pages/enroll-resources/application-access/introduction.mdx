...
![Application access architecture](../../../img/application-access/architecture.svg)
...
- [Google Cloud Web Console](../../zero-trust-access/access-controls/idps/saml-gcp-workforce-identity-federation.mdx): How to access the Google Cloud web console with Teleport.
