...
the Application Service back to end users. 
...
<Tabs>
<TabItem label="Docker">
Select a Teleport edition, then follow the [Installation](../../installation/single-machine/single-machine.mdx) instructions 
...
- Setting configuration options AND running CLI commands in the [Application Service reference](reference.mdx).
