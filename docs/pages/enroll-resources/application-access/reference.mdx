...
app_service:
  ...
  - name: "grafana"
    ...
    aws:
      ...
      # When true, sets the Teleport username as the AWS STS source identity
      # on assumed role sessions. Persists across role chaining and is logged
      # in CloudTrail. Requires sts:SetSourceIdentity in the role trust policy.
