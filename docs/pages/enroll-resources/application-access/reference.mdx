---
title: Teleport Application Service Reference
...
app_service:
  ...
  - name: "grafana"
    ...
    # Optional: customize the session recording configuration for this app.
    session_recording:
       # Controls whether session recordings will be generated for non-human
       # (bot) users. Disabling session recording for bots provides a way to
       # mitigate the load caused by service-to-service use-cases. Supported
       # values are "on" and "off". Defaults to "on".
       bots: "on"
