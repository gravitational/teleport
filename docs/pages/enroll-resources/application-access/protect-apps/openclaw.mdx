...
- A running OpenClaw instance. See the [OpenClaw documentation](https://openclaw.io/docs/installation) for installation instructions and minimum version requirements.
- OpenClaw version `1.0` or later.
...
- Learn about the [Teleport Agentic Identity Framework](../../../agentic-identity-framework/agentic-identity-framework.mdx).
