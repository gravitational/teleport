...
- A running OpenClaw instance, `1.0` or later. See the [OpenClaw documentation](https://openclaw.io/docs/installation) for installation instructions and minimum version requirements.
