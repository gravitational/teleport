...
that you can optionally supply during Okta integration enrollment. Access Lists
will not be created for groups or applications without any assignments.

The synchronizer creates the following resources for each matched Okta group or application:
...
1. In the box labeled **Filter by Group Name(s)**, enter names of Okta user
   ...
   When filters are added, the results of the user group or application list
   will update with the results of your filter applied.
