...
Teleport's default [SSH and Kubernetes session recording](../../../architecture/session-recording.mdx)
...
<Notice type="tip">
  ...
  Session Recording](../../../architecture/session-recording.mdx) for more details.
...
<Details title="Isolate session system resources">
...
- Read more about
  [session recording](../../../architecture/session-recording.mdx).
