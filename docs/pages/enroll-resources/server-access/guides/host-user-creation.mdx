...
## Step 3/4 Sudoers Configuration

Teleport host user creation leverages the `sudoers.d` directory for new users. 
For CentOS builds, ensure that the following line is present in your sudoers file. Please ignore for any other Linux distros:
