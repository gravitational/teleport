...
Teleport Enterprise only supports session recording at the Node level. If you are
...
all OpenSSH nodes. To generate a host certificate, run this on your Teleport Auth Service:
