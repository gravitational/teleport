...
For more information about using traits in roles, see [Role Templates](../../zero-trust-access/access-controls/guides/role-templates.mdx).
...
[Joining Sessions](../../zero-trust-access/access-controls/guides/joining-sessions.mdx).
