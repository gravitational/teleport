...
For more information about using traits in roles, see [Role Templates](../../zero-trust-access/rbac-get-started/role-templates.mdx).
...
[Joining Sessions](../../zero-trust-access/authentication/joining-sessions.mdx).
