...
- RBAC and resource filtering based on [dynamically updated labels](../../../zero-trust-access/management/admin/labels.mdx)
- [Session recording without SSH connection termination](../guides/recording-proxy-mode.mdx)
- [Session sharing](../../../zero-trust-access/access-controls/guides/joining-sessions.mdx)
