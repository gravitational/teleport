...
For a more general description of Teleport roles and examples see our [Access Controls guides](../../zero-trust-access/access-controls/access-controls.mdx), as
...
Variables with the format `{{external.xyz}}` are replaced with values from external [SSO](../../zero-trust-access/access-controls/sso/sso.mdx)
