...
To keep things simple within this guide, the policy will grant full access to
the bucket. In a production environment, you should modify this to grant the 
