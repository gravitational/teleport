...
Teleport's Workload Identity securely issues flexible short-lived
cryptographic to workloads. These identities can be used for a range of purposes
from securing communication between services to authenticating to cloud
providers.
