...
<UseCasesList
  ...
  description="Connect to popular services over MCP"
  desktopColumnsCount={2}
  variant="doc"
  useCases={[
    {
    ...
    {
      title: "Access Kubernetes Clusters over MCP",
      description: "Configure fine-grained access to a Teleport-protected Kubernetes clusters for MCP clients such as Claude Desktop or Cursor.",
      href: "../../connect-your-client/model-context-protocol/kube-access/",
    },
    {
      title: "Access GitHub over MCP",
      description: "Connect GitHub over MCP via Teleport.",
      href: "./integration-guides/github/",
    },
    {
      title: "Access Grafana over MCP",
      description: "Connect Grafana over MCP via Teleport.",
      href: "./integration-guides/grafana/",
    },
    {
      title: "Access HashiCorp Vault over MCP",
      description: "Connect HashiCorp Vault over MCP via Teleport.",
      href: "./integration-guides/vault/",
    },
    {
      title: "Access Notion over MCP",
      description: "Connect Notion over MCP via Teleport.",
