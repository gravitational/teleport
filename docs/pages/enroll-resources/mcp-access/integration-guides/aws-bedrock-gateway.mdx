...
## Step 1/2. Configure Inbound Auth Configurations for Amazon Bedrock AgentCore Gateway

Go to your gateway in AWS Management Console. Click the **Edit** button in the
**Inbound Identity** section.
