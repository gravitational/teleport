...
Create a user that grants access to all MCP servers and all available tools
provided by those servers:
...
Once your MCP client configuration is updated, you will find
the Teleport demo MCP server in your MCP client.
