...
description: Provides a detaield breakdown of Teleport usage reporting and billing.
---

Teleport Team, Teleport Enterprise Cloud, and Teleport Enterprise send
anonymized usage data to Teleport so we can calculate billing metrics. This
guide describes the anonymized usage data and the billing metrics we calculate.
