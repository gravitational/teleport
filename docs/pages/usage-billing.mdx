...
The Monthly Active Users (MAU) is the aggregate number of unique
...
"Active" means a user having performed any activity that would appear in an audit; for example, 
...
through an identity provider as users activity.
...
A "resource" is any unique bot, such as a CI/CD Jenkins or GitHub Job, 
...
We aggregate all counts of the billing metrics on monthly basis starting on
