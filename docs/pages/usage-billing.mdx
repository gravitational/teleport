...
Teleport Enterprise. Teleport Enterprise accounts provide this information as an
...
Teleport Enterprise clusters use an HMAC key that's randomly generated when
...
therefore, all clusters will periodically reach out to Teleport Enterprise to report
