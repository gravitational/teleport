...
from [Teleport Customer
Portal](https://dashboard.gravitational.com/web/login) and reinstall to all Teleport Auth Servers.
After restarting the Teleport Auth service any changes to the license will take impact.
