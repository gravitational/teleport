...
Generate a systemd unit file for Teleport and save it in `/etc/systemd/system/teleport.service` on both servers. If using Teleport `v10.1.4` or later, this can be completed
