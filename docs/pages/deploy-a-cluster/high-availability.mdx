...
flowchart
   ...
   Developers & serv1 & serv2 & serv3 --> lb1[Load Balancer]
   lb1 --> proxypool

   subgraph teleport[Private Network]
     subgraph proxypool[Proxy Service Pool]
       tp1[Teleport Proxy Service]
       tp2[Teleport Proxy Service]
     end

     proxypool --> lb2[Load Balancer]

     subgraph authpool[Auth Service Pool]
    ...
    authpool-->kv[Key/Value Store]
    authpool-->os[Object Store]
   end
```
