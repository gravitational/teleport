...
Terraform v1.2.6
```
## Step 1/4. Set up Teleport cluster in Primary Region (In my example us-west-1 is Primary Region) region:
...
## Step 2/4. Setup DynamoDB & S3 Global replication to Secondary Region (In my example us-east-1 is the Secondary Region):
- Check the Key components section of this document for Global replication.

## Step 3/4. Set up Teleport cluster in Secondary Region same as Step 1/7:
...
## Step 4/4. Configure Proxy Peering:
