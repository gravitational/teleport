...
## Step 3/6. Set up Teleport cluster in Primary Region (In this example us-west-1 is the Primary Region) region:
...
secondary region. We will enable `kube operator` in the event of Primary Region failure.
