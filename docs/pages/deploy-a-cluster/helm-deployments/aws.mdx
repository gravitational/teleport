...
To use ACM to handle TLS, add annotations to the chart values in the section below specifying
...
Edit your `aws-values.yaml` file to refer to the name of your secret:
