...
<Var name="teleport-clie-ntid-uuid-123456789012" />
```
...
azure:
  ...
  clientID: "<Var name="teleport-clie-ntid-uuid-123456789012" />"
highAvailability:
...
`*.teleport.example.com`, using your Azure DNS zone rooted at `example.com`.
