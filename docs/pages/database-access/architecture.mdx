...
Database Service establishes an SSH reverse tunnel to the Proxy Service. As
...
1. The Proxy Service authenticates the connection and dispatches it to the
   appropriate Database Service based on the routing information encoded in the
