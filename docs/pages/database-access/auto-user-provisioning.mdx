...
Automatically created users will either receive a predefined set of roles, or can be granted permissions to specific database objects based on their required level of access using [Database Object Permissions](./auto-user-provisioning/database-object-permissions.mdx) feature.
