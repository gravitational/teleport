...
[configuration file](./reference/configuration/#database-service-configuration)
...
reference [configuration file](./reference/configuration/#database-service-configuration)
for more details.
...
to the reference [configuration file](./reference/configuration/#database-service-configuration).