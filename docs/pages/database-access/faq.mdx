...
- [Canceling requests in progress](https://www.postgresql.org/docs/current/protocol-flow.html#id-1.10.5.7.9).
  Cancel requests issued by PostgreSQL clients connected to the Teleport proxy
...
## Do you support X database clients?
...
databases in the future based on customer demand.

Check if the database you're interested in has [already been requested](https://github.com/gravitational/teleport/labels/database-access).

Open a [new issue](https://github.com/gravitational/teleport/issues/new/choose) to register your interest.
