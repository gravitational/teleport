...
The [Automatic User Provisioning](./auto-user-provisioning.mdx)
guide explains how to get Teleport to create accounts for your PostgreSQL,
MySQL, or MariaDB users on-demand.
