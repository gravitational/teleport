...
Refer to the [RDS guide](../guides/rds.mdx#step-56-create-a-database-iam-user)
for more information.
</TabItem>
<TabItem label="Self-hosted PostgreSQL">
Self-hosted PostgreSQL admin user must have X.509 authentication configured.
...
- Be assigned all roles from the Teleport user's roleset that match the database.
