...
(!docs/pages/includes/database-access/guideintro.mdx  dbType="Elasticsearch" dbConfigure="Self-hosted Elasticsearch with mutual TLS authentication" dbName="Elasticsearch" !)
