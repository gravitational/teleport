...
(!docs/pages/includes/database-access/db-configure-start.mdx  dbProtocol="elastic" databaseAddress="elasticsearch.example.com:9200" !)
...
<TabItem label="Kubernetes Cluster">
  ...
  (!docs/pages/includes/database-access/db-helm-install.mdx dbProtocol="elastic" databaseAddress="elasticsearch.example.com:9200" !)
</TabItem>
</Tabs>
