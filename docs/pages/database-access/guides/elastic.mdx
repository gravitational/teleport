...
(!docs/pages/includes/database-access/self-hosted-introduction.mdx  dbType="Elasticsearch" dbConfigure="Self-hosted Elasticsearch with mutual TLS authentication" dbName="Elasticsearch" !)
