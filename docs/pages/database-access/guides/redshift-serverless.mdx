...
## Step 1/5. Register the database

(!docs/pages/includes/database-access/aws-register-resource.mdx type="Redshift Serverless" matcher="redshift-serverless" protocol="postgres" example="my-workgroup.123456789012.us-west-1.redshift-serverless.amazonaws.com:5439" !)
