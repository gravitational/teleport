...
This guide provides an example configuration of IAM roles as a model,
...
- Manage IAM user and role policies.
...
- Replace `teleport.example.com` with your Teleport Proxy Service URI or cloud tenant
...
- In manual mode, Teleport will print the required IAM policies. You can then create
