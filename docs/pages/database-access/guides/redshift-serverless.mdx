...
(!docs/pages/includes/database-access/guideintro.mdx  dbType="AWS Redshift Serverless" dbConfigure="AWS Redshift Serverless database with IAM authentication" dbName="AWS Redshift Serverless" !)
