...
<Admonition type="note" title="Note">
  You can override the database name by applying the `teleport.dev/database_name` tag to the resource. The value of the tag will be used as the database name.
</Admonition>
