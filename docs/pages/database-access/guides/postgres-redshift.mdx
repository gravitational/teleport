...
- Cluster identifier can be found on the `General information` panel:

![Redshift Cluster ID](../../../img/database-access/guides/redshift/cluster-id@2x.png)

- Cluster endpoint can also be copied from the `General information` panel:
...
- Database user name and database name.

If you haven't created any database users, default database admin user name and
maintenance database can be found on the `Database configurations` panel of the
`Properties` tab:
