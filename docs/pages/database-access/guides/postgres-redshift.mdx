...
(!docs/pages/includes/database-access/aws-register-resource.mdx type="Redshift" matcher="redshift" protocol="postgres" example="redshift-cluster-1.abcdefghijklmnop.us-west-1.redshift.amazonaws.com:5438" !)
...
(!docs/pages/includes/database-access/aws-create-db-configuration.mdx type="Redshift" matcher="redshift" protocol="postgres" example="redshift-cluster-1.abcdefghijklmnop.us-west-1.redshift.amazonaws.com:5438"!)
