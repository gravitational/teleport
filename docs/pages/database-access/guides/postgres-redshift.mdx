...
description: How to configure Teleport Database Access for AWS Redshift PostgreSQL databases.
---

# AWS Redshift PostgreSQL

This Guide describes how to configure Teleport Database Access for AWS Redshift PostgreSQL databases.
...
Teleport Database Access for Redshift is available starting from the `6.2` release.
...
```bash
sudo tctl get users/alice > alice.yaml
```
