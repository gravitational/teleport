...
The first method involves accessing Redshift as an existing database user. If
you are using this traditional IAM authentication, you can skip this step.

The second method is to authenticate as an IAM role. In this case, Redshift
maps the IAM role to a database username and creates this user if it doesn't
