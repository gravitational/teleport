...
(!docs/pages/includes/database-access/aws-register-resource.mdx type="OpenSearch" matcher="opensearch" protocol="opensearch" example="my-opensearch-instance-xxxxxx.us-west-1.es.amazonaws.com"!)
