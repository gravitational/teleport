...
(!docs/pages/includes/database-access/aws-register-resource.mdx type="OpenSearch" matcher="opensearch" protocol="opensearch" example="my-opensearch-instance-xxxxxx.us-west-1.es.amazonaws.com" partialSuffix="-with-account-id" !)

## Step 2/5. Create IAM roles for OpenSearch Managed Cluster access
...
## Step 3/5. Configure the Teleport IAM role mapping
...
(!docs/pages/includes/database-access/aws-create-db-configuration.mdx type="OpenSearch" matcher="opensearch" protocol="opensearch" example="my-opensearch-instance-xxxxxx.us-west-1.es.amazonaws.com" partialSuffix="-with-account-id" !)
