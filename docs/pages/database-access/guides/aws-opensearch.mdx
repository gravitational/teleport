...
(!docs/pages/includes/database-access/aws-create-db-configuration-with-account-id.mdx type="OpenSearch" matcher="opensearch" protocol="opensearch" example="my-opensearch-instance-xxxxxx.us-west-1.es.amazonaws.com" !)
...
=======
```
>>>>>>> 69df3245557c0964e10b74bf7f6d588f28da0655
