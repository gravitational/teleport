...
(!docs/pages/includes/database-access/guideintro.mdx  dbType="AWS OpenSearch" dbConfigure="AWS OpenSearch Service via REST API with IAM Authentication" dbName="AWS OpenSearch" !)
...
### OpenSearch Manage Cluster access role
