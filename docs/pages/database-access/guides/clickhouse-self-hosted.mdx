...
(!docs/pages/includes/database-access/db-helm-install.mdx dbName="example-clickhouse" dbProtocol="clickhouse-http" databaseAddress="clickhouse.example.com:8443" !)

</TabItem>
<TabItem label="Native (TCP)">

(!docs/pages/includes/database-access/db-helm-install.mdx dbName="example-clickhouse" dbProtocol="clickhouse" databaseAddress="clickhouse.example.com:9440" !)
