...
(!docs/pages/includes/database-access/db-configure-start.mdx  dbProtocol="mongodb" databaseAddress="mongo.example.com:27017" !)
...
<TabItem label="Kubernetes Cluster">
  ...
  (!docs/pages/includes/database-access/db-helm-install.mdx dbProtocol="mongodb" databaseAddress="mongo.example.com:27017" !)
</TabItem>
</Tabs>
