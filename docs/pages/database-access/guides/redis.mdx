...
and sets of Redis ACL rules. Redis allows providing passwords as a plain text or SHA256 checksum version. For security
reason we strongly recommend to use SHA256 checksum instead of plain text password.
...
### Supported Redis commands
  ...
  <Tabs>
    ...
    <TabItem label="Cluster">
      ...
      * AUTH - it's used by Teleport to verify user identity before it's send to Redis.
