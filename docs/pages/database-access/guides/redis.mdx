...
Each Redis user must be protected by a strong password. We recommend using OpenSSL to generate them:
...
If you have access to Redis you can also generate password by using the below command from the Redis console:
