...
description: How to configure Teleport Database Access for AWS RDS/Aurora PostgreSQL databases.
---

# AWS RDS/Aurora PostgreSQL

This Guide describes how to configure Teleport Database Access for AWS RDS/Aurora PostgreSQL databases.
