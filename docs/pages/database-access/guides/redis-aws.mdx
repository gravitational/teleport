...
## Step 1/8. Register the database

<Tabs>

<TabsItem label="ElastiCache">

(!docs/pages/includes/database-access/aws-register-resource.mdx type="ElastiCache" matcher="elasticache" protocol="redis" example="clustercfg.my-redis-cluster.xxxxxx.usw1.cache.amazonaws.com:6379" !)

</TabsItem>

<TabsItem label="MemoryDB">

(!docs/pages/includes/database-access/aws-register-resource.mdx type="MemoryDB" matcher="memorydb" protocol="redis" example="clustercfg.my-memorydb.xxxxxx.memorydb.us-west-1.amazonaws.com:6379" !)

</TabsItem>

</Tabs>

## Step 2/8. Create a Teleport user

(!docs/pages/includes/database-access/create-user.mdx!)

## Step 3/8. Create a Database Service configuration
...
## Step 4/8. Create an IAM policy for Teleport
...
## Step 5/8. Start the Database Service

(!docs/pages/includes/start-teleport.mdx service="the Database Service"!)

## Step 6/8. Create an ElastiCache IAM user (optional)
...
## Step 7/8. Create a Teleport-managed ElastiCache or MemoryDB user (optional)
