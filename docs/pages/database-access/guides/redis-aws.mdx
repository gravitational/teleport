---
title: Database Access with AWS ElastiCache for Redis and AWS MemoryDB
description: How to configure Teleport Database Access with AWS ElastiCache for Redis and AWS MemoryDB.
---

This guide will help you to:

- Install Teleport `(=teleport.version=)`.
- Set up Teleport to access your ElastiCache for Redis and MemoryDB clusters.
...
- AWS account with at least one ElastiCache for Redis or MemoryDB clusters
...
- Discover and register ElastiCache for Redis and MemoryDB clusters.
...
and MemoryDB clusters according to the configuration.
...
and [Authenticating users with Role-Based Access Control for
MemoryDB](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/Clusters.RBAC.html).
