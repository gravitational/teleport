...
![SQL Server with self-hosted Teleport](../../../img/database-access/guides/sqlserver_selfhosted.png)
{/*```mermaid
...
![Teleport SQL Server access with Teleport Cloud](../../../img/database-access/guides/sqlserver_cloud.png)
{/*```mermaid
%%{ init: { 'flowchart': { 'curve': 'stepBefore' } } }%%
graph LR
a(Users)
