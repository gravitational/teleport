...
(!docs/pages/includes/database-access/db-configure-start.mdx dbProtocol="oracle" databaseAddress="oracle.example.com:2484" dbName="oracle" !)
...
<TabItem label="Kubernetes Cluster">
  ...
  (!docs/pages/includes/database-access/db-helm-install.mdx dbProtocol="oracle" databaseAddress="oracle.example.com:2484" dbName="oracle" !)
</TabItem>
</Tabs>
