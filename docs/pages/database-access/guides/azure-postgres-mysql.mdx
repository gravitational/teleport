...
Teleport needs Azure IAM permissions to be able to discover and register MySQL and PostgreSQL databases.
...
<Admonition type="not" title="Custom role assignable scope">
Custom roles, unlike
...
Refer to [Concepts Azure AD Authentication](https://docs.microsoft.com/en-us/azure/postgresql/single-server/concepts-azure-ad-authentication)
