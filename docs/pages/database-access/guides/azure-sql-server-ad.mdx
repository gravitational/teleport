...
On the **Teleport Database Service virtual machine instance** **Identity**
...
the virtual machine system assigned identity. On the same page, on the **Azure
...
### Timeout on connecting to the database
...
In case your database is public, you can enable it from receiving connections
from Azure services without creating firewall rules: Go to your database page,
**Network** tab, at the bottom of the page on the **Exceptions** section, you
