...
(!docs/pages/includes/database-access/db-configure-start.mdx dbProtocol="postgres" databaseAddress="postgres.example.com:5432" !)
...
<TabItem label="Kubernetes Cluster">
  ...
  (!docs/pages/includes/database-access/db-helm-install.mdx dbProtocol="postgres" databaseAddress="postgres.example.com:5432" !)
</TabItem>
</Tabs>
