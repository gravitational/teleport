...
(!docs/pages/includes/database-access/self-hosted-introduction.mdx  dbType="MySQL or MariaDB" dbConfigure="MySQL or MariaDB database with mutual TLS authentication" dbName="MySQL or MariaDB" !)
...
- A host, e.g., an Amazon EC2 instance, where you will run the Teleport Database
  Service.
- Optional: a certificate authority that issues certificates and private keys for
