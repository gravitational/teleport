...
(!docs/pages/includes/database-access/db-configure-start.mdx dbProtocol="mysql" databaseAddress="mysql.example.com:3306" !)
...
<TabItem label="Kubernetes Cluster">
  ...
  (!docs/pages/includes/database-access/db-helm-install.mdx dbProtocol="mysql" databaseAddress="mysql.example.com:3306" !)
</TabItem>
</Tabs>
