...
To create these secrets, use the `tctl auth sign` command. Note that it requires a
...
Note that you will only be able to see databases your role has access to. Read about
[Role-Based Access Control](../rbac.mdx) for more details.
