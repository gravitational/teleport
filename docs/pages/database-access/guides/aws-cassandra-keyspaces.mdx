...
description: How to configure Teleport Database Access with Azure Database for AWS Keyspaces (Apache Cassandra)
---
...
- Set up Teleport to access your AWS Keyspaces (Apache Cassandra)..
...
## Step 3/5. [Optional] Create AWS Keyspaces role:
Create an AWS IAM Role that will be used as Keyspaces user. If you already have a custom IAM Keyspaces role, you can skip this step.
...
Create custom [IAM Keyspaces Policy](https://docs.aws.amazon.com/keyspaces/latest/devguide/security_iam_id-based-policy-examples.html) or select an AWS-managed policy like `AmazonKeyspacesReadOnlyAccess` policy.
![Create Role Step 1](../../../img/database-access/guides/keyspaces/create-role-step2.png)
<Admonition type="tip">
  You can make the policy more strict by providing specific IAM role cassandra action and specifying the cassandra keyspace and table [Amazon Keyspaces identity-based policy examples](https://docs.aws.amazon.com/keyspaces/latest/devguide/security_iam_id-based-policy-examples.html).
</Admonition>
Confirm role
