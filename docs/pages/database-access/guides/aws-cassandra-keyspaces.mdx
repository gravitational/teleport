...
Create custom [IAM Keyspaces Policy](https://docs.aws.amazon.com/keyspaces/latest/devguide/security_iam_id-based-policy-examples.html) or select already existed `AmazonKeyspacesReadOnlyAccess` policy.
