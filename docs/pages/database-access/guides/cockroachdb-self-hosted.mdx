...
(!docs/pages/includes/database-access/db-configure-start.mdx  dbProtocol="cockroachdb" databaseAddress="roach.example.com:26257" !)
...
<TabItem label="Kubernetes Cluster">
  ...
  (!docs/pages/includes/database-access/db-helm-install.mdx dbProtocol="cockroachdb" databaseAddress="roach.example.com:26257" !)
</TabItem>
</Tabs>
