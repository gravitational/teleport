...
<Tabs>
  ...
  database agent runs as an IAM user (for example, it uses an AWS credentials
  file).
  ```json
  {
      "Version": "2012-10-17",
...
<Tabs>
  ...
  your Teleport database agent runs as an IAM user (for example, it uses an AWS
  credentials file).
  ```json
  {
      "Version": "2012-10-17",
  ...
  and your Teleport database agent runs as an IAM user (for example, it uses an
  ...
  <TabItem label="Aurora / IAM role">
  Use this permission boundary policy if you're connecting to Aurora clusters
  and your Teleport database agent runs as an IAM role (for example, on an EC2
  instance with attached IAM role).
  ```json
  {
      "Version": "2012-10-17",
