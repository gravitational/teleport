...
(!docs/pages/includes/database-access/aws-register-resource-with-var-protocol.mdx type="RDS" matcher="rds" protocol="mysql or postgres" example="my-aurora-cluster.abcdefghijklm.us-west-1.rds.amazonaws.com:5432" !)
...
(!docs/pages/includes/database-access/aws-create-db-configuration-with-var-protocol.mdx type="RDS" matcher="rds" protocol="mysql or postgres" example="my-aurora-cluster.abcdefghijklm.us-west-1.rds.amazonaws.com:5432" !)
