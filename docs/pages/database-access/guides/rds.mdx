...
## Step 1/7. Register the database

Skip this step if using IAM OIDC provider for your Kubernetes cluster.

(!docs/pages/includes/database-access/aws-register-resource-with-var-protocol.mdx type="RDS" matcher="rds" protocol="mysql or postgres" example="my-aurora-cluster.abcdefghijklmnop.us-west-1.rds.amazonaws.com:5432" !)
...
(!docs/pages/includes/database-access/aws-create-db-configuration-with-var-protocol.mdx type="RDS" matcher="rds" protocol="mysql or postgres" example="my-aurora-cluster.abcdefghijklmnop.us-west-1.rds.amazonaws.com:5432" !)
...
## Step 4/7. Create IAM policies for Teleport
