...
The final part of configuring GCP is to create another service account with
...
file from the "Connections" tab under the "Security" section:
...
For more detailed information about database access controls read our [Role-Based Access Control](../rbac.mdx) 
documentation.
...
to be able to generate IAM auth tokens.
