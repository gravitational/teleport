...
![Teleport Database Access RDS Self-Hosted](../../../img/database-access/guides/rds-proxy_selfhosted.png)
</ScopedBlock>
<ScopedBlock scope={["cloud"]}>
![Teleport Database Access RDS Cloud](../../../img/database-access/guides/rds-proxy_cloud.png)
</ScopedBlock>
...
## Step 4/5. Create a database IAM user
