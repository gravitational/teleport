...
## Step 1/6. Register the database

(!docs/pages/includes/database-access/aws-register-resource-with-var-protocol.mdx type="RDS Proxy" matcher="rdsproxy" protocol="mysql or postgres or sqlserver" example="my-proxy.proxy-abcdefghijklmnop.us-west-1.rds.amazonaws.com:3306" !)
...
(!docs/pages/includes/database-access/aws-create-db-configuration-with-var-protocol.mdx type="RDS Proxy" matcher="rdsproxy" protocol="mysql or postgres or sqlserver" example="my-proxy.proxy-abcdefghijklmnop.us-west-1.rds.amazonaws.com:3306" !)

## Step 3/6. Create an IAM policy for Teleport

(!docs/pages/includes/database-access/aws-bootstrap.mdx type="rdsproxy" !)
