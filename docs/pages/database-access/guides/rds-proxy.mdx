...
(!docs/pages/includes/database-access/aws-create-db-configuration.mdx type="RDS Proxy" matcher="rdsproxy" protocol="&lt;Var name&equals;&quot;mysql or postgres or sqlserver&quot;&sol;&gt;" example="my-proxy.proxy-abcdefghijklm.us-west-1.rds.amazonaws.com:3306" !)
