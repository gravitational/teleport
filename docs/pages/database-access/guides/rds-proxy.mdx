...
(!docs/pages/includes/database-access/aws-register-resource-with-var-protocol.mdx type="RDS Proxy" matcher="rdsproxy" protocol="mysql or postgres or sqlserver" example="my-proxy.proxy-abcdefghijklm.us-west-1.rds.amazonaws.com:3306" !)
...
(!docs/pages/includes/database-access/aws-create-db-configuration-with-var-protocol.mdx type="RDS Proxy" matcher="rdsproxy" protocol="mysql or postgres or sqlserver" example="my-proxy.proxy-abcdefghijklm.us-west-1.rds.amazonaws.com:3306" !)
