...
description: YAML configuration reference documentation for Teleport Database Access.
---

# Database Access Configuration Reference

This document describes the YAML configuration for Teleport Database Access.

## Database Service Configuration

The following snippet shows the full YAML configuration of a Database Service appearing in `teleport.yaml` configuration file:
