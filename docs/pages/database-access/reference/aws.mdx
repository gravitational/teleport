...
configures IAM policies for Amazon RDS, Redshift and ElastiCache.

Teleport may also require permission to update database configurations, for
example, to enable IAM authentication on RDS databases.
