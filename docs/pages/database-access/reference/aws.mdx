...
| `resource-id` | Database AWS resource identifier: `db-XXX` for RDS, `cluster-XXX` for Aurora, `prx-XXX` for RDS Proxies. Can be found under Configuration section in the RDS control panel. |
