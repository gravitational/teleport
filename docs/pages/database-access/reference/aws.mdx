...
The Teleport database service requires a set of AWS IAM permissions to:
- update database configurations;
- update its identity with connection-related permissions;

You can generate and manage the permissions bootstrap command. Or if you prefer,
you manage the IAM permissions yourself. Examples of policies for each discovery
