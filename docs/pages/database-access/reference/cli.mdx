...
| `--elasticache-discovery` | List of AWS regions the agent will discover for ElastiCache Redis clusters. |
| `--memorydb-discovery` | List of AWS regions the agent will discover for MemoryDB clusters. |
