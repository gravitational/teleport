...
description: Event auditing reference documentation for Teleport Database Access.
---

# Database Access Audit Events Reference

This document describes the expected Teleport Database Access Event object schema in common scenarios.
