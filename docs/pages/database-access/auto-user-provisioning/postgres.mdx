...
<Admonition type="note" title="Database object permissions for `teleport-admin`">
When [Database Object Permissions](./database-object-permissions.mdx) feature is in use, the `teleport-admin` should have permissions to relevant database objects. For example:
...
<TabItem label="Database Object Permissions">
...
For additional information, refer to the [database object permissions](./database-object-permissions.mdx) page.
...
- Read database permission managemend [RFD](https://github.com/gravitational/teleport/blob/master/rfd/0151-database-permission-management.md).
