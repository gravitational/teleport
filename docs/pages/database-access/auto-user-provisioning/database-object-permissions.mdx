...
**Database Object Permissions** is a Teleport feature that lets you configure
role-based access controls for data stored within a database. A **database
object** can be a table, view, or stored procedure. With Database Object
Permissions, you can ensure that users only have permissions to manage the data
they need.
