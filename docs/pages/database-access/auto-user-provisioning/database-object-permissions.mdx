...
Database object permissions is a Teleport feature that enables the configuration of access levels for individual users to specific database objects based on their required level of access.
