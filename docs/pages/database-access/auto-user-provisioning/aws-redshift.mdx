...
session. Instead, the user will be stripped of all roles, updated with
`CONNECTION LIMIT 0` trait and reactivated during the next connection.

(!docs/pages/includes/database-access/auto-user-provisioning/db-definition.mdx protocol="postgres" uri="redshift-cluster-1.abcdefghijklmnop.us-east-1.redshift.amazonaws.com:5439" !)
