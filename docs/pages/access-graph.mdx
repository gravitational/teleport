...
relationships between nodes. Paths always go from:

  Users to User Groups to Actions to Resource Groups to Resources
...
User Groups are created from Teleport Roles and access requests. Roles create a User Groups where the members
