...
<Admonition type="note">
  Directory sharing in Teleport Connect is more permissive than in the Web UI.
  Because Teleport Connect uses a native file system API, it can access and share any directory on your local machine.
</Admonition>
