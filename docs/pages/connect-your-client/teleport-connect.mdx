...
During the setup, Connect My Computer creates [a join token](../installation/agents/join-token.mdx)
...
them on a file system. For more details, see [Hardware Key Support guide](../zero-trust-access/access-controls/guides/hardware-key-support.mdx).
