...
When it comes to [cloud APIs secured with Teleport](../zero-trust-access/enroll-resources/application-access/cloud-apis/cloud-apis.mdx),
...
as logging in as other system users or [host user creation](../zero-trust-access/server-access/guides/host-user-creation.mdx).
...
During the setup, Connect My Computer creates [a join token](../zero-trust-access/enroll-resources/agents/join-token.mdx)
