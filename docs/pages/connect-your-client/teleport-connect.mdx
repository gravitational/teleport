...
If the background mode is on, it remains active even after you close the window.
To end the connection, click Close Connection or quit the app.

The port number will persist between app restarts—you can set up your favorite client
...
If the background mode is on, it remains shared even after you close the window.
