...
certificates or for demo purposes. We do not recommend using this mode in production.
...
## Uninstall Teleport Connect

<Tabs>
<TabItem label="macOS">

Remove Teleport Connect for MacOS from the Applications with this command.
...
Installs that used the tarball download and extraction should remove the
