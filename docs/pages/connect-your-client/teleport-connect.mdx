...
The selected shell will be used only for that session unless you choose to set it as the default.
![Changing the terminal shell in Teleport Connect on Windows](../../img/use-teleport/shell-switcher.png)
