...
1. Open a tab with cluster resources by clicking on the plus symbol at the right end of the tab bar.
   You can also press <span style="white-space: nowrap;">`Ctrl+Shift+T/Cmd+T`</span> to achieve the same result.
...
actions menu or press <span style="white-space: nowrap;">`` Ctrl+Shift+`/Cmd+` ``</span>.
...
1. Open a tab with cluster resources by clicking on the plus symbol at the end of the tab bar. You
  can also press <span style="white-space: nowrap;">`Ctrl+Shift+T/Cmd+T`</span> to achieve the same result.
...
1. Open the profile selector with a shortcut (<span style="white-space: nowrap;">`Ctrl+Shift+I/Cmd+I`</span>).
