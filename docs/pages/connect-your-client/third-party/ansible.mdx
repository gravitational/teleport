...
pipelines, or automation, use [Machine ID](../../machine-workload-identity/access-guides/ansible.mdx)
...
it is possible to enable case-insensitive routing using the following instructions:
