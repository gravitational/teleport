...
- One or more Teleport Agents running the Teleport SSH Service. If you have not yet
  ...
  [getting started guide](../../enroll-resources/server-access/getting-started.mdx) to learn how.
...
[OpenSSH guide](../../enroll-resources/server-access/openssh/openssh.mdx) to configure the remote host to authenticate via
