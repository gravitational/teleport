...
- One or more Teleport SSH Service instances. If you have not yet done this,
  read the [getting started guide](../../enroll-resources/server-access/getting-started.mdx) to
  learn how.
...
<Admonition type="note">
  ...
  See the [OpenSSH guide](../../enroll-resources/server-access/openssh/openssh.mdx) for more information.
...
[dedicated guide](../../enroll-resources/server-access/openssh/openssh.mdx) for additional information.
