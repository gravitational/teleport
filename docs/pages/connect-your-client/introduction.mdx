...
Teleport Connect allows you to transfer files to a remote server and runs on MacOS, Linux and Windows. You can use the arrows in the top-left corner of the Web UI to upload and download files:

![Download with connect](../../img/download_files_connect.png)

You can upload files from systems using drag and drop:

![Drag and drop in Connect](../../img/upload_files_connect_dragndrop.png)
