...
Teleport Connect allows you to transfer files to a remote server and runs on MacOS, Linux and Windows:

![Download with connect](../../img/download-with-connect.png)

You can upload and download files from systems using drag and drop:

![Drag and drop in WebUI](../../img/teleport-connect-drag-drop.png)

</TabItem>
<TabItem label="Web UI">

You can also use the arrows in the top-left corner of the Web UI to upload and download files:

![Arrows in Web UI](../../img/webui_load_files_arrows.png)
