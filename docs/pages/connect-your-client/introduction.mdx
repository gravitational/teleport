...
```code
$ tsh login --proxy=<Var name="teleport.example.com" description="Your Teleport Proxy Service or Teleport Enterprise tenant address"/> --user=<Var name="user" description="Your Teleport username"/>
