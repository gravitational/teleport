...
After entering your Teleport variables above you can copy and paste the below command.  You should see similar output
after running.
...
After entering your Teleport variables above you can copy and paste the below command.  You should see similar output
after running. The username is set from the Identity Provider so it is not required as a parameter.
...
2. Provide the address of your Teleport Cluster (e.g. <Var name="teleport.example.com" description="Your Teleport Proxy Service or Teleport Cloud tenant address"/>) and click **NEXT**.
...
found at the same URL used to connect to Teleport with (e.g. <Var name="teleport.example.com" description="Your Teleport Proxy Service or Teleport Cloud tenant address"/>,
