...
For other databases the Teleport Web UI will list those that are accessible
to your user under **Databases** and provide `tsh` commands to connect from
your local terminal environment.
