---
title: Teleport Clients Overview
...
the additional flag `--auth`. Your administrator should provide the details
...
a friendly graphical user interface. After [downloading](https://goteleport.com/download/)
...
additional access to Request and Activity logs for users with the right
permissions.
...
- Teleport Connect is a graphical utility for connecting to resources through
