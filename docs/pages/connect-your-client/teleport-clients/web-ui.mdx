...
| Column         | Description                                                                                                              |
| -------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Host/Bot Name  | The hostname for an instance, or the bot name for a bot instance. The instance ID below can be clicked to be copied.     |
| Version        | The version of Teleport running on the instance.                                                                         |
| Type           | Whether this is an instance or bot instance.                                                                             |
...
The filter controls can be used to filter by various criteria like type, services, upgrader, and version. To filter by version,
