...
access controls and features like [Per-session MFA](../zero-trust-access/access-controls/guides/per-session-mfa.mdx)
and [Hardware Key Support](../zero-trust-access/access-controls/guides/hardware-key-support.mdx).
...
If [per-session MFA](../zero-trust-access/access-controls/guides/per-session-mfa.mdx) is enabled, the
