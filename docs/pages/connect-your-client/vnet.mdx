...
ports](../zero-trust-access/enroll-resources/application-access/guides/tcp.mdx#configuring-access-to-multiple-ports),
...
[guide](../zero-trust-access/enroll-resources/application-access/guides/vnet.mdx#configuring-ipv4-cidr-range).
...
- Read our VNet configuration [guide](../zero-trust-access/enroll-resources/application-access/guides/vnet.mdx)
