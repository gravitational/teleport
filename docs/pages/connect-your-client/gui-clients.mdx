...
![SQL Developer (VS Code) Start](../../img/database-access/guides/oracle/sql-developer-vscode-start.png)
...
![SQL Developer (VS Code) Connection Details (basic)](../../img/database-access/guides/oracle/sql-developer-vscode-conn-details-basic.png)

The new connection should appear on the list.

<Figure width="400">
![SQL Developer (VS Code) Connected (basic)](../../img/database-access/guides/oracle/sql-developer-vscode-connected-basic.png)
</Figure>
...
![SQL Developer (VS Code) Connection Details (JDBC)](../../img/database-access/guides/oracle/sql-developer-vscode-conn-details-jdbc.png)

The new connection should appear on the list.

<Figure width="400">
![SQL Developer (VS Code) Connected (JDBC)](../../img/database-access/guides/oracle/sql-developer-vscode-connected-jdbc.png)
</Figure>
...
### Oracle Developer Tools (VS Code extension)

Install the extension from [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=Oracle.oracledevtools).

Open "Oracle Explorer" toolbar, then click on "+" (New Connection...) to add a new database entry.

<Figure width="400">
![Oracle Developer Tools Add Database Connection](../../img/database-access/guides/oracle/developer-tools-vscode-new-conn.png)
</Figure>
...
Test and create the connection. You should not be prompted for a password.

![Oracle Developer Tools Connection Details](../../img/database-access/guides/oracle/developer-tools-vscode-conn-details.png)

Once created, the connection should appear in the database section of Oracle Explorer.

<Figure width="400">
![Oracle Developer Tools Opened Connection](../../img/database-access/guides/oracle/developer-tools-vscode-opened.png)
</Figure>
...
![Toad Add Login Record](../../img/database-access/guides/oracle/toad-add-login-record.png)
...
![Toad Add Login Tested](../../img/database-access/guides/oracle/toad-add-login-tested.png)

The newly added login should appear on the login list.

![Toad Login List](../../img/database-access/guides/oracle/toad-login-list.png)
...
![DBeaver new connection button](../../img/database-access/guides/oracle/dbeaver-new-connection.png)

Select "Oracle" from the driver list. You may use the search toolbar to narrow down the list.
![DBeaver connect to a database](../../img/database-access/guides/oracle/dbeaver-connect-to-a-database.png)

Choose "Custom" connection type and paste the JDBC connection string printed by `tsh proxy db`.
![DBeaver JDBC details](../../img/database-access/guides/oracle/dbeaver-jdbc-details.png)
