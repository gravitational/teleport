...
- The `tsh` client tool. Visit [Installation](../installation/single-machine/single-machine.mdx) for instructions on downloading
...
routing](../zero-trust-access/management/operations/tls-routing.mdx), run the
