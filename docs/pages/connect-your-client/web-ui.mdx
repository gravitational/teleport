...
For more informaton about role permissions and access to resources, see [Teleport Access Controls 
...
- **As a Observer** with read-only access to the session. You can view output but cannot control the session in any way nor 
  send any input.
