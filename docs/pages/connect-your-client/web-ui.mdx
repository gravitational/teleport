...
Teleport Connect is a graphical user interface for Teleport that runs on Mac, Linux and Windows. This makes it easy to upload local files to a remote server.
