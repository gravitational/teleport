...
description: How to configure MCP clients to use Teleport-protected Kubernetes Clusters as MCP servers.
tags:
 - mcp
...
This guide explains how to connect to Teleport-protected Kubernetes Clusters with MCP clients.
...
Now login your Kubernetes cluster, replacing <Var name="minikube" /> with your our Kubernetes cluster name:
```code
...
You can now use these tools to interactive with your Kubernetes clusters via
...
Alternatively, you can use [Teleport Connect](../teleport-connect.mdx) to run
