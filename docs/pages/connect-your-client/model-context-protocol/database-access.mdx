---
title: Access Teleport Databases over MCP
...
This guide shows you how to connect to your PostgreSQL Teleport databases with MCP clients using interactive tsh login. 
For headless environments, CI/CD pipelines, or automation, see the Machine ID guide (tbot) to issue short-lived 
credentials without interactive authentication.
