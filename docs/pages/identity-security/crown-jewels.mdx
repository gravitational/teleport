...
[Okta](../identity-governance/integrations/okta/okta.mdx) or [Microsoft Entra ID](./integrations/entra-id.mdx).
...
Check [Access Graph page](identity-security.mdx) for details on
