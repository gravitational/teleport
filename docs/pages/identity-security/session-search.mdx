...
Use [`tctl recordings search`](../reference/cli/tctl.mdx#tctl-recordings-search)
to search summarized recordings. By default, the command searches the last 24
hours and opens an interactive terminal UI.
