...
1. Restart the Access Graph Service, assigning <Var name="container-id" /> with
   the ID of the Access Graph Service container:

   ```code
   $ docker restart <Var name="container-id" />
   ```
