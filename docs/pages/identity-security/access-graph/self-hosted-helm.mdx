...
In order to visualize the data from the Access Graph service, use the Graph Explorer under "Identity Security" in the Web UI.
![Graph Explorer menu item](../../../img/access-graph/graph-explorer-ui.png)
