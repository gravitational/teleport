...
{/*TODO: write about the "Browse Connections" sidebar button and how it lets you
step through connections*/}
{/*TODO: connect each H2 to use cases */}

Teleport Access Graph can help you determine who can access a specific resource,
and understand the pathways that grant access. 
