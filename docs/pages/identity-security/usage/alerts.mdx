...
# Teleport Identity Security - Identity Activity Center Alerts

Teleport Identity Security - Identity Activity Center provides 50 pre-built security detections that automatically create alerts for suspicious identity-related activities across your infrastructure. These detections monitor events from Teleport and integrated services like AWS, GitHub, and Okta to identify potential security risks.

## Overview

Identity Activity Center alerts help you detect and respond to security threats by monitoring for:
...
Identity Activity Center monitors your AWS infrastructure for critical security events:
