...
sidebar_label: Azure
description: Describes how to import and visualize Azure subscription access patterns using Identity Security.
tags:
 - how-to
 - identity-security
 - azure
...
- For self-hosted clusters:
  ...
  - A running Access Graph node v1.27.0 or later. Check the [Identity Security page](../identity-security.mdx) for details on
...
Restart the Teleport process on the machine where you modified the configuration
file:
