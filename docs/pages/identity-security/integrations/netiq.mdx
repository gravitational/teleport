...
sidebar_label: NetIQ
description: Describes how to synchronize OpenText NetIQ access patterns using Identity Security.
tags:
 - how-to
 - identity-security
 - access-risks
...
[Access Graph page](../identity-security.mdx).  
...
- An OpenText NetIQ instance with a user that has read access to the organization.
