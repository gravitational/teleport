...
integration](../../identity-governance/integrations/okta/okta.mdx) in your
cluster. Once enrolled, follow the [Okta Identity Security guide](./okta.mdx) to
discover access patterns and audit activity from your Okta organization.
