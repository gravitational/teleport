...
Session Recording Summaries is available only to Teleport Enterprise customers with Teleport Identity Security. 
[Learn more about the features included in Teleport Identity Security](../feature-matrix/#teleport-identity-security).
</Admonition>
