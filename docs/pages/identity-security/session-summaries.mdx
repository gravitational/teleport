...
Session Recording Summaries are available only to Teleport Enterprise (Self-Hosted)
customers with Teleport Identity Security. 

Session Recording Summaries will be coming soon to Teleport Enterprise (Cloud) customers 
with Teleport Identity Security. If you would like an [early preview; please get in touch](https://goteleport.com/contact-sales/).
...
This feature is powered by AI levearing a Large Language Model, and as such, 
