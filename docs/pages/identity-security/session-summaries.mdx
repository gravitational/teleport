...
<Admonition type="note" scope={["cloud"]} scopeOnly>
For Teleport Enterprise Cloud customers using the Teleport-managed model,
session recording summary costs are included in the price of Identity Security.
If you bring your own LLM provider, controlling the token budget is your
responsibility.
</Admonition>
