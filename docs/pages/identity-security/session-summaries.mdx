...
sections of [Teleport Resources Reference](../reference/api/resources.mdx):

- [`inference_model`](../reference/api/resources.mdx#inference-model)
- [`inference_secret`](../reference/api/resources.mdx#inference-secret)
- [`inference_policy`](../reference/api/resources.mdx#inference-policy)
