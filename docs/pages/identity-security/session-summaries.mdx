...
[Teleport predicate language](../reference/predicate-language.mdx#scoping-allowdeny-rules-in-role-resources-and-matching-session-summary-inference-policies).
...
spec:
  openai:
    ...
    api_key_secret_ref: litellm-master-key
