...
Teleport Enterprise Cloud includes a built-in inference model powered by Amazon
Bedrock.  Teleport manages the underlying infrastructure.
...
1. Create an `inference-model.yaml` file with the following content:
   ...
   spec:
     # TODO: Add Teleport-managed model spec here.
     teleport_managed: {}
