...
![summary button](https://website.goteleport.com/_uploads/session_summary_sparkle_dc77016a68.png). Clicking the
...
forward events to a SIEM to alert the high severivity sessions. 
...
![Session Summary in Teleport Identity Security Investigate View](https://website.goteleport.com/_uploads/session_audit_event_fa6a9e68cc.png)
