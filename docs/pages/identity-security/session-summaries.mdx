...
**Important**: AI-powered summarization is **disabled by default** in all Teleport deployments 
(both self-hosted and cloud). No AI processing occurs unless you explicitly enable this feature. 

When you choose to enable summarization:

- For Teleport Enterprise (Self-hosted): You configure and manage your own AI integration. Using OpenAI or 
OpenAI compatible LLMs gateways such as Lite LMM.
- For Teleport Enterprise (Cloud) with Identity Security: Session Recording Summarization can be enabled 
with your own OpenAI key. Later this year, Teleport Enterprise (Cloud) will provide summarization via Amazon Bedrock. 

This ensures you have complete control over whether and how AI is used with your session recordings.
...
- [`inference_secret`](../reference/infrastructure-as-code/teleport-resources/inference-secret.mdx)
