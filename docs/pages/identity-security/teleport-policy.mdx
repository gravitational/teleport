...
If you are a self-hosted Teleport customer, you will need to [deploy the Access Graph Service](access-graph/access-graph.mdx) and ensure you have an updated
...
- [Enable Identity Activity Center](access-graph/identity-activity-center.mdx) guide.
...
- [Analyze and correlate Okta Audit Logs and Access Paths](../access-controls/okta/okta.mdx#syncing-system-logs-and-api-keys-with-teleport-identity-security-activity-center) guide.
