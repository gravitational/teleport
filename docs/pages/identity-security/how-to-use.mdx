...
across your infrastructure. Ingesting and correlating data between IdPs (Okta), Code ([GitHub](./integrations/github.mdx)), Cloud Providers ([AWS](./integrations/aws-sync.mdx)) and 
Teleport Audit Log. 
