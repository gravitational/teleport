...
- Visually understand a user's access pathways, or resources pathways with Graph Explorer.
...
## Dashboard: Identity Activity Center - Investigate

The Identity Security with Identity Activity Center dashboard provides a high-level overview of recent identity activity
across your infrastructure. Ingesting and correlating data between IdPs ([Okta](../identity-governance/okta/okta/)), Code ([GitHub](./integrations/github/)), Cloud Providers ([AWS](./integrations/aws-sync/)) and 
Teleport Audit Log. 
