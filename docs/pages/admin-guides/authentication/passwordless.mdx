...
- A signed and notarized version of `tsh` is required for Touch ID. This precludes
  versions installed from Homebrew. [Download the macOS tsh installer](../../get-started/download-install/installation.mdx).
...
[installation page](../../get-started/download-install/installation.mdx).
...
../../get-started/download-install/installation.mdx#macos).
