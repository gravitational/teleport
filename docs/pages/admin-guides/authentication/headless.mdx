...
- Machines for Headless WebAuthn activities have [Linux](../../get-started/download-install/installation.mdx), [macOS](../../get-started/download-install/installation.mdx) or [Windows](../../get-started/download-install/installation.mdx) `tsh` binary v12.2+ installed.
