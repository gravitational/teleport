...
works similarly to [`require_session_mfa`](../per-session-mfa.mdx).
...
clusters](../../access-controls/trustedclusters.mdx) to limit the impact of
...
[registered and enrolled](device-management.mdx),
...
Similar to [session and identity locking](../../access-controls/locking.mdx), a device can
