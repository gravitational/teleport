...
- [Servers](../../zero-trust-access/server-access/rbac.mdx)
- [Databases](../../zero-trust-access/enroll-resources/database-access/rbac.mdx)
- [Kubernetes clusters](../../zero-trust-access/enroll-resources/kubernetes-access/controls.mdx)
- [Windows Desktops](../../zero-trust-access/enroll-resources/desktop-access/rbac.mdx)
- [Applications](../../zero-trust-access/enroll-resources/application-access/controls.mdx)
...
- [AWS](../../zero-trust-access/enroll-resources/application-access/cloud-apis/aws-console.mdx)
- [Google Cloud](../../zero-trust-access/enroll-resources/application-access/cloud-apis/google-cloud.mdx)
- [Azure](../../zero-trust-access/enroll-resources/application-access/cloud-apis/azure.mdx)
