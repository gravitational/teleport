...
connect to the Auth Service instances gRPC endpoint.
...
|---|---|
|`proxyAddr`|The host and port of the Teleport Proxy Service, e.g., `example.teleport.sh:443`, which we will use to connect the client to your cluster. **Assign this to your own Proxy Service's host and port:** <Var name="proxy-address" /> |
