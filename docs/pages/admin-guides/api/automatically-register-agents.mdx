...
clusters](../../zero-trust-access/enroll-resources/auto-discovery/kubernetes/kubernetes.mdx) in AWS, Azure, and
Google Cloud, as well as
[servers](../../zero-trust-access/enroll-resources/auto-discovery/servers/ec2-discovery.mdx) on
