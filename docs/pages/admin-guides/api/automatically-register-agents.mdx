...
Client applications can look up tokens they have created with the following code:
    ...
    for {
        ...
        if err != nil {
            if trace.IsNotImplemented(err) {
                // Backward compatibility code, for Teleport version not supporting paginated APIs
                // This is not needed for versions >= 19.
