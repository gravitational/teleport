...
clusters](../../enroll-resources/auto-discovery/kubernetes/overview.mdx) in AWS, Azure, and Google Cloud,
as well as [servers](../../enroll-resources/auto-discovery/servers/ec2-discovery.mdx) on Amazon EC2.
