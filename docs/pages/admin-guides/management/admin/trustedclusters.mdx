...
- The `tctl` admin tool and `tsh` client tool version >= (=teleport.version=).
  ...
  For Teleport Enterprise and Teleport Enterprise, you should have the
...
You can also enable verbose output by updating the configuration file for both Auth Service instances.
