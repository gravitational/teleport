...
[Teleport Agent](../../../zero-trust-access/enroll-resources/agents/agents.mdx) to your Teleport
...
- Compare the number of resources that are protected by Teleport with those that
  ...
  Discovery](../../../zero-trust-access/enroll-resources/auto-discovery/auto-discovery.mdx).
