...
[follow the guide](../../../zero-trust-access/enroll-resources/desktop-access/active-directory.mdx)
...
[documentation](../../../zero-trust-access/enroll-resources/database-access/database-access.mdx)
...
[OpenSSH servers registered with Teleport](../../../zero-trust-access/server-access/openssh/openssh.mdx).
...
If you used the
[manual method](../../../zero-trust-access/server-access/openssh/openssh-manual-install.mdx)
...
If you used the
[automated method](../../../zero-trust-access/server-access/openssh/openssh-agentless.mdx)
...
Elasticsearch](../../../zero-trust-access/enroll-resources/application-access/jwt/elasticsearch.mdx).
