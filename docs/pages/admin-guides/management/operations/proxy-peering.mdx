...
An existing self-hosted Teleport Enterprise cluster that is **not** using [Trusted Clusters](../../../admin-guides/management/admin/trustedclusters.mdx). See the documentation on [self-hosting Teleport](../../../zero-trust-access/deploy-a-cluster/deploy-a-cluster.mdx) to get started.
