...
[Trusted Clusters](../../../admin-guides/management/admin/trustedclusters.mdx) must not be used together with Proxy Peering. Proxy Peering and Trusted Clusters are not compatible.
