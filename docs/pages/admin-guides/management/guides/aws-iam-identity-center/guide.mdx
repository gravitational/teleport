...
[Okta integration](../../../access-controls/okta/okta.mdx).
...
- Take a deeper dive into fundamental Teleport concepts used in Identity Center
  ...
  and the [Teleport SAML IdP](../../../../enroll-resources/application-access/idps/idps.mdx).
- Learn how to enable the [Okta integration](../../../access-controls/okta/okta.mdx)
