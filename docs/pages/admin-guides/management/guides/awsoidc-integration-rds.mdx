...
[dynamic database registration](../../../zero-trust-access/enroll-resources/database-access/guides/dynamic-registration.mdx)
...
- Set up [automatic database user provisioning](../../../zero-trust-access/enroll-resources/database-access/auto-user-provisioning/auto-user-provisioning.mdx).
