...
SailPoint provides the SCIM Identity Management Connector that allows to manage Teleport Access List membership
...
* **Client ID**: The Client ID copied from SCIM Teleport Integration pag
