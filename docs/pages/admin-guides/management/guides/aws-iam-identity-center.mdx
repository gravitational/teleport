...
With the Identity Center integration, you can manage AWS access by granting or revoking persistent permissions with 
Identity Governance Access Lists or using Teleport Access Requests for temporary elevated privileges.
