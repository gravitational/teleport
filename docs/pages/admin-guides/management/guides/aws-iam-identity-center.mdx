...
With the AWS Identity Center integration, you can manage AWS access by granting short term access with Teleport Access Requests, or by granting longer-term access with Identity Governance Access Lists.
