...
description: Store audit logs and session recordings on your own infrastructure with Teleport Enterprise.
---
...
[S3](../../reference/backends.mdx#s3) backend for session recordings. It is only
available on Teleport Enterprise clusters running Teleport v14.2.1 or
above.

## Prerequisites

1. A Teleport Enterprise account. If you do not have one, [sign
...
With External Audit Storage enabled, your Teleport Enterprise cluster acts
...
the Teleport Enterprise infrastructure.
...
new events will be stored on Teleport Enterprise infrastructure. While External Audit
Storage is disabled, only events stored in the Teleport Enterprise infrastructure
