...
<Admonition type="note">
  ...
  See [the user type reference](../../../reference/operations/user-types.mdx) for more details.
</Admonition>
...
- Allow users with the `manager` role to grant access to production servers to
  ...
  See [the AccessList documentation](../../access-controls/just-in-time/access-lists.mdx) for
...
- Allow users with the `engineer` role to request temporary access to
  ...
  See [the Access Requests documentation](../../access-controls/just-in-time/access-requests/overview.mdx)
- You can see all supported fields in the references
  of [the user resource](../../../reference/config-references/resources.mdx)
  and [the role resource](../../../reference/config-references/resources.mdx).
