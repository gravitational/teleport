...
- [Servers](../../../reference/agents/server-rbac.mdx)
- [Databases](../../enroll-resources/database-access/rbac.mdx)
- [Kubernetes clusters](../../../reference/agents/controls.mdx)
- [Windows Desktops](../../../reference/agents/desktop-access.mdx)
- [Applications](../../../reference/agents/applications.mdx)
