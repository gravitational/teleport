...
<Admonition type="tip" title="Tip">
  Read [API authorization](../../../reference/architecture/architecture.mdx) to learn more about defining custom roles for your API client.
</Admonition>
...
- Read about Teleport [API architecture](../../../reference/architecture/architecture.mdx) for an in-depth overview of the API and API clients.
- Read [API authorization](../../../reference/architecture/architecture.mdx) to learn more about defining custom roles for your API client.
...
- Familiarize yourself with the [admin manual](../../../index.mdx) to make the best use of the API.
