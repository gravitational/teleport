...
- [Routing Access Request notifications](notification-routing-rules.mdx): How to set up Teleport's Access Monitoring Rules to route Access Request notifications
