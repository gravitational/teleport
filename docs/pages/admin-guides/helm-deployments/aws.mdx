...
[ensure you set](../../../../reference/config-references/helm-reference/teleport-cluster.mdx)
...
[reference the secret](../../../../reference/config-references/helm-reference/teleport-cluster.mdx)
