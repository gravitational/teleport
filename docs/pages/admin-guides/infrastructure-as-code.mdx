...
While Teleport Enterprise does not expose the static configuration file to
...
All three methods connect to the Teleport Auth Service instances gRPC endpoint in order
...
available for operators to modify. Users of Teleport Enterprise may see
...
of the Teleport Auth Service instances gRPC API. To build your own API client to extend
