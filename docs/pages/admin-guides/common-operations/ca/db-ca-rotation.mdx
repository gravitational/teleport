...
[Teleport Database Access Guide](../../enroll-resources/database-access.mdx) for your
...
[Teleport Database Access Guide](../../enroll-resources/database-access.mdx) and reconfigure
