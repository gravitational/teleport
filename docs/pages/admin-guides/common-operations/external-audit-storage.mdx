...
[Athena](../../reference/operations/backends.mdx) backend for audit events and the
[S3](../../reference/operations/backends.mdx) backend for session recordings. It is only
...
[Event Handler](../../index.mdx) plugin to export
