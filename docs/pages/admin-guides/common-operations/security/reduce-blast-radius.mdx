...
- [Dual authorization](../../authentication/dual-authz.mdx)
- [Role templates, allow/deny rules, and traits](../../access-controls/role-templates.mdx)
- [Access Requests](../../access-controls/just-in-time/access-requests/overview.mdx)

### Background reading
- [Authentication connectors](../../../reference/operations/authentication.mdx)
