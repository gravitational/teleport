...
- the ["Creating Access Lists with IaC" guide](access-list.mdx)
- the ["Registering Agentless OpenSSH Servers with IaC" guide](agentless-ssh-servers.mdx)
...
provider](terraform-provider.mdx).
...
[Get started with the Kubernetes Operator](teleport-operator.mdx).
...
- For a comprehensive reference of Teleport's static configuration options, read
  the [Configuration Reference](../../../reference/config-references/config.mdx).
- To see the dynamic configuration resources available to apply, read the
  [Configuration Resource Reference](../../../reference/config-references/resources.mdx). There are also
  dedicated configuration resource references for
  [applications](../../../reference/agents/application-access.mdx) and
  [databases](../../../reference/config-references/database-access.mdx).
