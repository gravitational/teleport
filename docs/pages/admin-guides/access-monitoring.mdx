...
- For self-hosted Teleport the [AWS Athena Backend](../reference/operations/backends.mdx) is required.
...
**Suggestion:**  Use short-lived tokens to reduce risk of compromise or [delegated](../reference/operations/join-methods.mdx) joining when possible.
