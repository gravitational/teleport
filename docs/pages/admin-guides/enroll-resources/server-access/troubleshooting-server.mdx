...
For more information about using traits in roles, see [Role Templates](../../access-controls/role-templates.mdx).
...
[Moderated Sessions](../../access-controls/moderated-sessions.mdx).
