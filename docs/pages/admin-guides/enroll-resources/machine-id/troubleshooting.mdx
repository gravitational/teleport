...
be automatically [locked](../../access-controls/locking.mdx). 
...
When requesting [Database Access](../../../index.mdx)
...
Teleport [RBAC permissions](../../../reference/rbac/teleport-roles.mdx) and are not
