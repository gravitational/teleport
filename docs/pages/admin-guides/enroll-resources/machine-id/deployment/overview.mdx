---
title: Machine ID Deployment Overview
...
custom approaches, you can also read the [Machine ID Reference](../../../../index.mdx)
and [Architecture](../../../../reference/architecture/machine-id.mdx) to plan your deployment.
...
| [Spacelift](spacelift.mdx)           | Docker Image                                                  | Spacelift-signed identity document |
