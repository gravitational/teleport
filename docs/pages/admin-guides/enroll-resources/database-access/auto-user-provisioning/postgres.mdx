...
Refer to the [self-hosted PostgreSQL guide](../enroll-self-hosted-databases/postgres-self-hosted.mdx)
...
- Learn about [role
  templating](../../../access-controls/role-templates.mdx).
...
- The `internal.db_roles` traits we illustrated in this guide
  ...
  Access Controls Reference](../../../../reference/rbac/teleport-roles.mdx).
