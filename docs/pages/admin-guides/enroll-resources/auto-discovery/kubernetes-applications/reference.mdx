...
please see [helm chart documentation](../../../../reference/config-references/helm-reference/teleport-kube-agent.mdx).
...
For more information you can take a look at [`discovery_service`](../../../../reference/config-references/config.mdx) and [`app_service`](../../../../reference/config-references/config.mdx) configuration references.
...
contain full rewrite configuration in YAML format, same as one would use when configuring an app with dynamic registration syntax (see [documentation](../../application-access/guides/connecting-apps.mdx)).
