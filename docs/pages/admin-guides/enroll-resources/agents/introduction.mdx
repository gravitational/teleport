...
Auto-Discovery](../../../index.mdx), in which the Teleport
...
Reference](../../../reference/config-references/config.mdx) for which
...
Cluster](join-services-to-your-cluster/overview.mdx) guides.
