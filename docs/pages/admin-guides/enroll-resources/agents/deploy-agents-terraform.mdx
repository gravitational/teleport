...
Cluster](join-services-to-your-cluster/overview.mdx) guide. In this guide, we will use
...
- An identity file for the Teleport Terraform provider. Make sure you are
  ...
  provider](../../configure-teleport/dynamic-resources/terraform-provider.mdx) before
...
reference](../../../reference/config-references/terraform-provider.mdx).
