...
[Registering Kubernetes Clusters with Teleport](../../../index.mdx).
...
[Kubernetes Cluster Discovery](../auto-discovery/kubernetes/overview.mdx). 
...
helm chart, see the [Chart Reference](../../../reference/config-references/helm-reference/teleport-kube-agent.mdx).
