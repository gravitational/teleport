---
title: Getting Started with Protecting Applications with Teleport.
...
<Tabs>
<TabItem label="Docker">
Select a Teleport edition, then follow the [Installation](../../../get-started/download-install/installation.mdx) instructions 
...
- Setting configuration options AND running CLI commands in the [Application Access reference](../../../reference/agents/application-access.mdx).
