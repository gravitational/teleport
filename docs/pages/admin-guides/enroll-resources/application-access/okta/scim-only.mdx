...
- [Authentication With Okta as an SSO Provider](../../../authentication/sso/okta.mdx)
...
For detailed instructions on configuring SCIM provisioning in the Okta app, see the [Okta Integration *Configuring SCIM provisioning*](hosted-guide.mdx) guide.
