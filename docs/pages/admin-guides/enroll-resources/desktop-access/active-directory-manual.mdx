...
- Access to a running Teleport cluster, `tctl` admin tool, and `tsh` client tool
  ...
  instructions](../../../get-started/download-install/installation.mdx) for the Teleport
  edition you use.
...
1. Add the configuration for the Windows Desktop Service to the `/etc/teleport.yaml`
   ...
   [Desktop Configuration Reference](../../../reference/config-references/desktop-access-config.mdx).
...
[Role-Based Access Control for Desktops](../../../reference/agents/desktop-access.mdx).
