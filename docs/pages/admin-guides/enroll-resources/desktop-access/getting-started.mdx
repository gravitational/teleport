...
instructions](../../../get-started/download-install/installation.mdx) for your environment.
...
1. (Optional) Add labels for the Windows Desktop Service to the configuration file.
   ...
   role permissions](../../../reference/agents/desktop-access.mdx).
...
1. Create a `windows-desktop-admins.yaml` file to define a new role:
   ...
   to create local Windows logins, see [Logins](../../../reference/agents/desktop-access.mdx).
...
Getting Started](../../access-controls/access-controls-getting-started.mdx).
