...
- Teleport must be configured for WebAuthn. See the [multi-factor:
...
stored in the Teleport Auth Service. Regardless of your device type, passwordless
...
<Tabs>
  <TabItem label="Static Config">
    Auth Service `teleport.yaml` file:
