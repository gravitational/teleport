...
- a Teleport [trusted device](
  ../../../identity-governance/device-trust/enforcing-device-trust.mdx#locking-a-device) by the device ID
...
- an [Access Request](../../../identity-governance/access-requests/access-requests.mdx) by UUID
