...
by FIPS-compliant binaries.  If the Teleport auth service was already deployed with a standard binary or without 
...
To migrate to a FIPS-compliant installation, [set the signature algorithm suite](../../../reference/signature-algorithms.mdx)
...
complete, proceed with installing the FIPS-compliant binary.
