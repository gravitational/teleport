...
| CC6.1 - Considers Network Segmentation | Network segmentation permits unrelated portions of the entity&#39;s information system to be isolated from each other. | [Teleport enables beyond corp network segmentation](../../management/admin/trustedclusters.mdx) <br/><br/> [Connect to nodes behind Firewalls or create reverse tunnels to a proxy server](../../../faq.mdx) |
