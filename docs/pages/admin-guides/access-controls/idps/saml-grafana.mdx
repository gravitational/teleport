...
Your Teleport cluster then uses a SAML IdP service provider resource (a dynamic
resource stored on the Auth Service backend) to provide information about your
Grafana deployment to the Teleport SAML IdP.
