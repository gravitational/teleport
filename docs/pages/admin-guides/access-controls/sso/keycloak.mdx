...
1. Repeat steps 1 - 6 to add the **User Attribute** mapper.
   ...
   ![User atrribute](../../../../img/sso/keycloak/user_attribute.png)
...
To optionally test the auth connector, navigate to the **Keys** tab to
temporarily disable the **Client signature required** option. 
This will be enabled later as you proceed through the guide. 
