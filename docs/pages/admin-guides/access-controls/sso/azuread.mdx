...
1. Enter the URL for your Teleport Proxy Service host in the **Entity ID** and **Reply URL**  fields:
   ...
   ```code
   https://<Var name="example.teleport.sh:443" />/v1/webapi/saml/acs/ad
   ```
...
metadata:
  name: ad
spec:
  acs: example.teleport.sh/v1/webapi/saml/acs/ad
  attributes_to_roles:
  ...
  - name: http://schemas.microsoft.com/ws/2008/06/identity/claims/groups
    ...
    - access
    value: 8adac502...
  audience: example.teleport.sh/v1/webapi/saml/acs/ad
  cert: ""
  display: Microsoft
  entity_descriptor: ""
  ...
  issuer: ""
  service_provider_issuer: example.teleport.sh/v1/webapi/saml/acs/ad
  sso: ""
version: v2
...
metadata:
  name: ad
spec:
  acs: example.teleport.sh/v1/webapi/saml/acs/azure-saml
  attributes_to_roles:
  - name: http://schemas.microsoft.com/ws/2008/06/identity/claims/groups
    roles:
    - editor
    ...
    - auditor
    value: '*'
  audience: example.teleport.sh/v1/webapi/saml/acs/azure-saml
  cert: ""
  display: Microsoft
  entity_descriptor:
  entity_descriptor_url: https://login.microsoftonline.com/ff882432.../federationmetadata/2007-06/federationmetadata.xml?appid=b8d06e01...
  issuer: https://sts.windows.net/your-id-here/
  service_provider_issuer: example.teleport.sh/v1/webapi/saml/acs/azure-saml
  signing_key_pair:
    cert: |
      -----BEGIN CERTIFICATE-----
      ...
