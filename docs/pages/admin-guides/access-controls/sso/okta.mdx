...
Teleport can automatically configure an SSO connector for you when as part of [enrolling the
...
<TabItem label="Teleport Enterprise" scope="cloud">
...
Cloud tenant (e.g. `example.teleport.sh`). Replace `<port>` with your Proxy
