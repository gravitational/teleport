...
If you already have Okta groups you want to assign to "access" and "editor" roles in
Teleport, you can skip to the [next step](#step-23-configure-okta).
...
--attributes-to-roles=groups,okta-dev,access > okta-connector.yaml
```
