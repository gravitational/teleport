...
name="example.teleport.sh" description="Your Teleport Enterprise tenant or Proxy
Service address"/>`/v1/webapi/oidc/callback`</nobr>. Replace `example.teleport.sh`
with your Teleport Enterprise tenant or Proxy Service address.
...
spec:
  ...
  redirect_url: "example.teleport.sh/v1/webapi/oidc/callback"
