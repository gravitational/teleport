...
The redirect URL for OIDC authentication in Teleport is the followng, where
`example.teleport.sh` is your Teleport account URL or Teleport Proxy Service
address:

```text
example.teleport.sh/v1/webapi/oidc/callback
```
