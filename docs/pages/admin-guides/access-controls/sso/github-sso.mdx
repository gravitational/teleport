...
Assign <Var name="github-enterprise-server-address"/> to your GitHub Enterprise
server address and <Var name="api-github-enterprise-server-address"/> to the
address of your GitHub Enterprise API endpoint:
