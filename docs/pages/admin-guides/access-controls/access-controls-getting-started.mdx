...
Follow our [SAML Okta Guide](../authentication/sso/okta.mdx) to
...
Follow our [OIDC guides](../authentication/sso/oidc.mdx) to
...
- [Mapping SSO and local users traits with role templates](role-templates.mdx)
- [Create certs for CI/CD using impersonation](impersonation.mdx)
