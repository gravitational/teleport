...
This guide explains how to set up the Teleport Zero Trust Access Request plugin for Jira.
Teleport's Jira integration allows you to manage Zero Trust Access Requests as
Jira issues.
...
we assume that your project is called "Zero Trust Access Requests", which
...
Obtain an API token that the Zero Trust Access Request plugin uses to make
...
Enter "Zero Trust Access Request Plugin" in the "Name" field. In the "URL" field,
...
the Zero Trust Access Requests board:
