...
This guide explains how to set up the Teleport Trust Access Request plugin for Jira.
Teleport's Jira integration allows you to manage Trust Access Requests as
Jira issues.
...
we assume that your project is called Teleport Trust Access Requests", which
...
Enter "Access Request Plugin" in the "Name" field. In the "URL" field,
...
When you create the request, you will see a new task in the "Pending" column of the Trust Access Requests board:
