...
## Step 3/5. Generate Datadog credentials
...
## Step 4/5. Enroll the Datadog Incident Management plugin
...
This should be "teleport-access". The fallback recipient will be the default recipient
for notifications. You can configure more custom notification routing rules afterwards
using Access Monitoring Rules.
...
team. Instead you will want to navigate to **Incidents -> Settings -> Notifications -> Rules**
...
## Step 5/5. Test your Datadog Incident Management plugin
