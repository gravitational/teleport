...
[Access Monitoring Rules](https://goteleport.com/docs/admin-guides/access-controls/access-request-plugins/notification-routing-rules).
...
Configure the Teleport `editor-requester` role and add the `datadog_auto_approvals`
annotation. This annotation expects a list of Datadog team handle names.
