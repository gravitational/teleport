...
on your local computer. 
   ...
   **Checking your user profile**
   ...
   For more information about managing logins for Teleport users, see [Local Users](../../../reference/operations/users.mdx).
...
For more information, see [Resource filtering](../../../reference/config-references/predicate-language.mdx).
