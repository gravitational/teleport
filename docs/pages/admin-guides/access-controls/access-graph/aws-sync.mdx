...
[Teleport Policy usage page](../teleport-policy/policy-how-to-use.mdx).
...
- For self-hosted clusters, a running Access Graph node v1.17.0 or later.  Check
  the [Access Graph page](../teleport-policy/getting-started-policy.mdx) for
  details on how to set up Access Graph.
- The node running the Access Graph service must be reachable from Teleport Auth
