...
click on Access List. Click on "Create an Access List."
...
- Familiarize yourself with the CLI tooling available for managing Access List in the [reference](../../../reference/access-controls/access-lists.mdx).
