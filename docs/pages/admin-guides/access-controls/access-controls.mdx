...
- SREs can access a production server only when using a [trusted hardware
  device](../../identity-governance/device-trust/guide.mdx).
...
Read our [Single Sign-On guide](../../zero-trust-access/sso/sso.mdx) to get started.
...
[Get started with Access Requests](../../identity-governance/access-requests/access-requests.mdx).
...
[Get started with Access Request plugins](../../identity-governance/access-request-plugins/access-request-plugins.mdx).
...
- [FedRAMP](../../zero-trust-access/compliance-frameworks/fedramp.mdx)
- [SOC 2](../../zero-trust-access/compliance-frameworks/soc2.mdx)
