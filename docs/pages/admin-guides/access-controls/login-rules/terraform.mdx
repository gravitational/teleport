...
The [Terraform provider guide](../../configure-teleport/dynamic-resources/terraform-provider.mdx)
...
- Read the [Terraform Guide](../../configure-teleport/dynamic-resources/terraform-provider.mdx) to
