...
Auth Service instances gRPC API to listen for audit events relating to new or updated
...
## Enrolling Access Request plugins in Teleport Enterprise

(!docs/pages/includes/plugins/enroll.mdx name="Access Request plugins"!)

The following Access Request plugins are hosted on Teleport Enterprise:
...
Team or Teleport Enterprise, you can run self-hosted Access Request
