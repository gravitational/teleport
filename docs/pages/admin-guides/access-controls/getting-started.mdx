...
Internal users can authenticate using credentials managed within Teleport, such as:
    ...
    - Second-factor authentication (2FA), such as TOTP (time-based one-time passwords) or U2F (universal second factor).
...
External users authenticate using external Identity Providers (IdP) like:
    - Okta, Google, GitHub, Microsoft Azure Active Directory, or other SAML/OIDC providers.
...
Admins create and assign roles to manage who can access which parts of the infrastructure.
    ...
    Some examples of roles include:
        ...
        auditor: Allows viewing logs and auditing activities.
