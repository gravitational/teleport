...
By configuring Identity Security to utilize the Identity Activity Center,
you can centralize audit logs and access paths from various sources for enhanced
visibility and management.

(!docs/pages/includes/policy/identity-activity-center.mdx!)

Identity Activity Center is a feature of the [Identity Security](https://goteleport.com/platform/policy/)
...
AWS Athena powers a powerful query engine in the Identity Activity Center.
