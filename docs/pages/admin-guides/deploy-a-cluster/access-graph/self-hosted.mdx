---
title: Run Teleport Teleport Identity Security on Self-Hosted Clusters
description: Describes how to deploy Access Graph on self-hosted clusters.
---

Identity Security's Access Graph with a self-hosted Teleport cluster requires setting up 
