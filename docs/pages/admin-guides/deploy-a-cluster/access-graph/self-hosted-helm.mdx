...
`values-teleport.yaml`), assigning <Var name="teleport-cluster-deployment-name"
/> to the name of your `teleport-cluster` deployment. Once the Auth Service
changes succeed, restart the Proxy Service.
