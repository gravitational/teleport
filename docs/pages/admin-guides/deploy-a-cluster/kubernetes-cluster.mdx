...
- The `tsh` client tool v(=teleport.version=)+ installed on your workstation.
  You can download this from our [installation page](../../../../get-started/download-install/installation.mdx).
...
guide](../../../../reference/agents/controls.mdx) before you begin.
...
- **Set up Single Sign-On:** In this guide, we showed you how to create a local
  ...
  Sign-On guides](../../../authentication/sso/overview.mdx) for how to do this.
- **Configure your Teleport deployment:** To see all of the options you can set
  ...
  [reference guide](../../../../reference/config-references/helm-reference/teleport-cluster.mdx).
- **Register resources:** You can register all of the Kubernetes clusters in
  ...
  guides](../../../enroll-resources/auto-discovery/kubernetes/overview.mdx) to see how to automatically
...
- **Fine-tune your Kubernetes RBAC:** While the user you created in this guide
  ...
  Access Controls Guide](../../../../reference/agents/controls.mdx) for more
  information.
