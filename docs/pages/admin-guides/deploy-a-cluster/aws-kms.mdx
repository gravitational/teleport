...
Include the following `ca_key_params` configuration in the `auth_service` section, assigning 
<Var name="AWS account" /> to your AWS account and <Var name="AWS region" /> to
your AWS region:
