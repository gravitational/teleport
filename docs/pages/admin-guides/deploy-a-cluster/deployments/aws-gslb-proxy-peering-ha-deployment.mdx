...
- Using load balancers for the Proxy and Auth Service instances allows for increased availability 
...
<Admonition
  ...
  title="Note"
>
Cross-zone load balancing is required for the Auth Service and Proxy Service service NLB configurations to route 
...
|---|---|---|
|```*.teleport.example.com```|CNAME|Amazon Route 53 nameservers|
