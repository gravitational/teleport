...
An AWS ALB can be used in this architecture. Please reference our [guide for using an AWS ALB](https://goteleport.com/docs/reference/architecture/tls-routing/#working-with-layer-7-load-balancers-or-reverse-proxies) for this step is you wish to use an ALB.
