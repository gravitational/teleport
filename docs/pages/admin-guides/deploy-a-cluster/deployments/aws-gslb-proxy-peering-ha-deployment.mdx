...
An AWS Application Load Balancer (ALB) can also be used in this architecture. Please reference our [guide for using an AWS ALB](../../../reference/architecture/tls-routing/#working-with-layer-7-load-balancers-or-reverse-proxies) for this step if you wish to use an ALB.
