...
- [Add Nodes to the Teleport
  cluster](../../../zero-trust-access/enroll-resources/agents/agents.mdx)
...
You can also generate an SSH Service join token using `tctl tokens add --type=node` [as detailed here in our admin guide](../../../zero-trust-access/enroll-resources/agents/join-token.mdx).
...
To manually join Teleport Agents to your cluster, you will need [a join token](../../../zero-trust-access/enroll-resources/agents/join-token.mdx).
