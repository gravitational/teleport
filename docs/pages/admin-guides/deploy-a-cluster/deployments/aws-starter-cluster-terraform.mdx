...
- An AWS ACM certificate for the subdomain in Amazon Route 53 that you control and choose during installation
...
Teleport (Gravitational) automatically builds and publishes Teleport Community Edition, Enterprise and Enterprise FIPS 140-2 AMIs when we
