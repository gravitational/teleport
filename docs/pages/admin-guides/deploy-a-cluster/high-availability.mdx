...
- [Servers](../../zero-trust-access/server-access/getting-started.mdx)
- [Kubernetes clusters](../../zero-trust-access/enroll-resources/kubernetes-access/getting-started.mdx)
- [Databases](../../zero-trust-access/enroll-resources/database-access/getting-started.mdx)
- [Windows desktops](../../zero-trust-access/enroll-resources/desktop-access/introduction.mdx)
