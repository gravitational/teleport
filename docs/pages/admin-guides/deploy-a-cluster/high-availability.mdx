...
will enable [TLS Routing](../management/tls-routing.mdx) in your
Teleport cluster.
...
Helm chart, read our [Helm Deployments](../../../index.mdx) documentation.
...
Consult our [Backends Reference](../../../reference/operations/backends.mdx) for the configuration
...
- [High-availability Teleport Deployments on Kubernetes with
  Helm](../../../index.mdx)
- [Reference Deployments](../../../index.mdx) for running Teleport on a cluster of
  virtual machines
...
- [Scaling a Teleport cluster](../management/scaling.mdx)
- [Monitoring a Teleport cluster](../../../index.mdx)
