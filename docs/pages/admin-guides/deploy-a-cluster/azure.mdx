...
Access](../../../../index.mdx) section to get started enrolling
users and setting up RBAC.

See the [high availability section of our Helm chart reference](../../../../reference/config-references/helm-reference/teleport-cluster.mdx) for more details on high availability.
