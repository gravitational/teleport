...
4.	Additionally helm parameters can be set in the 'Create App'
	![ArgoCD application page](../../../../img/helm/argocd/helm-parameters.png)
5. Edit this example configuration to match your needs.
...
6. Then select 'Sync' to apply the changes.
