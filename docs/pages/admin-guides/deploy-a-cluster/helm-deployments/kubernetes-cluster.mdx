...
guide](../../../zero-trust-access/enroll-resources/kubernetes-access/controls.mdx) before you begin.
...
- **Register resources:** You can register all of the Kubernetes clusters in
  ...
  guides](../../../zero-trust-access/enroll-resources/auto-discovery/kubernetes/kubernetes.mdx) to see how to automatically
...
- **Fine-tune your Kubernetes RBAC:** While the user you created in this guide
  ...
  Access Controls Guide](../../../zero-trust-access/enroll-resources/kubernetes-access/controls.mdx) for more
  information.
