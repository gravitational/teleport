...
- enroll [servers](../../../zero-trust-access/server-access/introduction.mdx),
  [Kubernetes clusters](../../../zero-trust-access/enroll-resources/kubernetes-access/introduction.mdx),
  [databases](../../../zero-trust-access/enroll-resources/database-access/getting-started.mdx),
  [applications](../../../zero-trust-access/enroll-resources/application-access/getting-started.mdx),
  or [Windows desktops](../../../zero-trust-access/enroll-resources/desktop-access/desktop-access.mdx) into your Teleport cluster
