...
teleport:
    ...
    ...
```
Review the [configuration reference](../../../../reference/config-references/config.mdx) page for 
additional settings.       
...
```
Reference the [Auth Server configuration](../../../../reference/config-references/config.mdx) reference page 
...
Reference the [Proxy Service configuration](../../../../reference/config-references/config.mdx) reference page 
for additional settings.
