---
title: Teleport Teleport Identity Security Connections
description: Connections in Access Graph with Identity Security.
---

Identity Security's Access Graph feature feature shows the relationships between users, roles, and resources. 
...
When you inspect a particular user's access, the Teleport Zero Trust Access Graph will automatically display the database objects that the user can access.
