...
description: Connections in Graph Explorer with Teleport Policy.
---

Teleport Policy's Graph Explorer shows the relationships between users, roles, and resources. 
...
Graph Explorer imports all resources and identities from Teleport and keeps them up to date, so every time you make a change
