---
title: How to use Teleport Teleport Identity Security
...
## How to use Identity Security feature

Identity Security's Access Graph feature can help you to answer questions like:
...
Identity Security's Access Graph dashboard provides a high-level overview of standing privileges across 
