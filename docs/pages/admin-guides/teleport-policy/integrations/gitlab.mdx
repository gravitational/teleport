---
title: Discover GitLab Access Patterns with Teleport Teleport Identity Security
description: Describes how to synchronize GitLab access patterns using Identity Security and Access Graph.
---

With Identity Security's Access Graph, you gain insights into access patterns within your GitLab account. By scanning all
