...
To register a new OAuth client with OSP (IDM Authorization Server), modify the 
...
<Tabs>
<TabItem label="Encrypted secret (Recommended)" >
...
<TabItem label="Plaintext secret (Insecure, Not Recommended)" >
