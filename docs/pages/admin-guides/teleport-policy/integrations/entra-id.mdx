---
title: Analyze Entra ID policies with Teleport Teleport Identity Security
description: Describes how to import and visualize Entra ID policies using Identity Security and Access Graph.
---

The Microsoft Entra ID integration in Teleport Teleport Identity Governance synchronizes your Entra ID directory into your Teleport cluster,
