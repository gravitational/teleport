---
title: Discover AWS Access Patterns and CloudTrail events with Teleport Identity Security
...
The importing process involves tree primary steps:
...
### CloudTrail logs import (optional)

If CloudTrail is configured to log activity in your AWS account, it delivers log files to an S3 bucket.
Identity Activity Center can process near real-time the Trail data. Enabling Amazon SNS notifications
...
- A running Teleport Enterprise cluster v14.3.9/v15.2.0 or later. Teleport v18.0.0 is required for Identity Activity Center.
...
- For self-hosted clusters:
  ...
  - A running Access Graph node v1.17.0 or later. Access Graph v1.24.0 is required for Identity Activity Center.
