---
title: Discover Insecure SSH Access with Teleport Teleport Identity Security
description: Describes how to enable SSH Key Scanning using Identity Security and Access Graph.
---

With Identity Security's Access Graph, you can gain insights on how SSH keys are used within your environment. By scanning
...
Teleport and Identity Security's Access Graph synchronize various resources, including SSH authorized keys and private keys.
...
To enable the SSH Key Scanning feature, edit the Teleport Zero Trust Access Graph configuration file:
