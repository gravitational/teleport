...
Advanced Database Access Controls features allow Teleport administrators to configure user permissions for individual database objects using powerful, label-based approach for expressing access policies.

The database objects-level access information is automatically synchronized to Teleport Policy, making it easy to see who has particular levels of access to the different parts of the database.
