...
- against a remote Teleport instance (such as Teleport Enterprise or deployed with Terraform)
...
If you are hosting Teleport out of Kubernetes (Teleport Enterprise, Terraform, ...),
