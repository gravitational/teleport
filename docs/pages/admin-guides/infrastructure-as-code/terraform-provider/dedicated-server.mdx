...
To do so, follow [the `tbot` deployment guide for Linux](../../../enroll-resources/machine-id/deployment/linux.mdx)
until step 3. 
...
<<<<<<< HEAD:docs/pages/enroll-resources/machine-id/access-guides/terraform.mdx
- Read the [configuration reference](../../../reference/machine-id/configuration.mdx) to explore
||||||| parent of c11ea7a5f4 (Document how to use the TF provider):docs/pages/enroll-resources/machine-id/access-guides/terraform.mdx
- Read the [configuration reference](../reference/configuration.mdx) to explore
=======
- Read the [tbot configuration reference](../../../enroll-resources/machine-id/reference/configuration.mdx) to explore
>>>>>>> c11ea7a5f4 (Document how to use the TF provider):docs/pages/management/dynamic-resources/terraform-provider/dedicated-server.mdx
