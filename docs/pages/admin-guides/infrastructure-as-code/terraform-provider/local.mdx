...
If [MFA for Administrative Actions](../../../access-controls/guides/mfa-for-admin-actions.mdx)
...
- Consult the list of Terraform-supported resources [in the Terraform reference}(../../reference/terraform-provider.mdx).
