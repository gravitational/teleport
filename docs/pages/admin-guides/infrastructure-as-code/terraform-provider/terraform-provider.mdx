...
and Machine ID](../../../machine-workload-identity/machine-id/deployment/spacelift.mdx).
...
- See how to use Machine ID with Terraform in
  [production](../../../machine-workload-identity/machine-id/access-guides/terraform.mdx).
