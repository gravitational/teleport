...
- (!docs/pages/includes/tctl-tsh-prerequisite.mdx!)
  ...
  See [Installation](../../../get-started/download-install/installation.mdx) for details.
...
- A running Teleport cluster. For details on how to set this up, see our Enterprise
  [Getting Started](../introduction.mdx) guide.
...
<Tabs>
    ...
    [extraArgs](../../../reference/config-references/helm-reference/teleport-cluster.mdx)
    ...
    [insecureSkipProxyTLSVerify](../../../reference/config-references/helm-reference/teleport-kube-agent.mdx)
    flag to `true`:
    <Tabs>
      <TabItem label="values.yaml">
      ```yaml
...
- [Run Teleport as a systemd Daemon](../../common-operations/daemon.mdx)
