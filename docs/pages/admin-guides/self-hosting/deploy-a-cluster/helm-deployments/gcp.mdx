...
If you want to use a different version of Teleport, set the [`teleportVersionOverride`](../../../../reference/config-references/helm-reference/teleport-cluster.mdx) value.
