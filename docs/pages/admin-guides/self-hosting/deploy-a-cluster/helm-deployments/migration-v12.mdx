...
- The chart can now be scaled up in `standalone` mode. Proxy replication requires
  a TLS certificate; Auth replication requires using [HA storage backends](../../../../reference/operations/backends.mdx).
...
- [backup the cluster content](../../../common-operations/backup-restore.mdx),
