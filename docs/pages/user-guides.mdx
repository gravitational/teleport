...
and installing `tsh`, sign in to your Teleport plane:
...
you can log in initiate sessions for Server, Database, and Desktop Access all
within a single window.

1. Click **CONNECT** to connect to the Teleport plane:
...
For other connection types, you can create a local tunnel to point your software to:
...
<ScopedBlock scope={["oss", "enterprise"]}>`https://teleport.example.com`</ScopedBlock>
<ScopedBlock scope={["cloud"]}>`https://mytennant.teleport.sh`</ScopedBlock>
). From the menu on the right, select **<Icon name="desktop" inline={true} size="sm"/>
Desktops**. Next to the desktop you want to access, click **CONNECT**. Select
