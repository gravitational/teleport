...
<Admonition
  ...
  title="important"
>
  The groups will be fetched only if admins include special auth scope [https://www.googleapis.com/auth/admin.directory.group.readonly](https://www.googleapis.com/auth/admin.directory.group.readonly) in the scopes of the connector as shown in the example above.
</Admonition>
