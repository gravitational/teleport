...
Reference the following table for guidance on styling common list types. 

| List type | Usage | 
|----------------|--------------------------------------------------------------------------------|
| Numbered list  | Steps to be performed in the listed numerical order. <br>                      |
                   For example:
                   ``` 1. Log in
                       2. Click Add Server
                       3. And so on
                   ```
                   Lowercase letters should be used for nexted sequencial steps. 
                   For example:
                   ``` 1. Log in
                          a. nested step 1.
                          b. nested step 2.
                          c. nexted step 3. 
                   ```
| Header list    | For use when numbered list steps must be broken into larger sections.               |
                   Header lists should be styled to indicate the current step as well as the number of 
                   steps remaining. 
