...
This article serves as the primary entry point for all things documentation-related.
...
- **At best:** an arm of Engineering, an advocate for developers, empowerment for learning, and definitive resolution for customers. 
...
- Not marketing although it plays a role in onboarding customers. Pageviews matter, but accuracy and customer satisfaction matter most.
...
This section enumerates the most common kinds of documents we write at Teleport and includes them within our document set.

### Getting started articles

*Getting started guides* are self-contained, *quickstart*, articles and should aim to get a user up and running the quickest.
...
5. Wrap up with a "Next steps" section.

Getting started guides should be written to keep a busy user engaged. 
...
*Architecture* articles explain how Teleport works to advanced readers. Architects, devsecops, or similar professionals constitute the most common audience. 

These articles are used to decide whether and how to use Teleport.
