...
notification that a lock has been created or modified, they enact safeguards
...
as per usual. See the [Admin Guide](../reference/infrastructure-as-code/teleport-resources/teleport-resources.mdx) for more
details.
</details>
