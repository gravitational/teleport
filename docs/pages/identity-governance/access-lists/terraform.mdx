...
- Familiarize yourself with
  [teleport_access_list](../../reference/api/terraform-provider/resources/access_list.mdx) and
  [teleport_access_list_member](../../reference/api/terraform-provider/resources/access_list_member.mdx)
  Terraform resources.
