...
The Okta integration allows [synchronizing Okta groups and apps](../integrations/okta/app-and-group-sync.mdx) as
...
Entra ID integration allows [synchronizing groups](../integrations/entra-id/entra-id.mdx) as
Teleport Access Lists. 
...
Lists created by an integration (e.g. [Okta](../integrations/okta/app-and-group-sync.mdx) or [Entra
ID](../integrations/entra-id/entra-id.mdx)). An existing static list created by another Terraform setup (with
