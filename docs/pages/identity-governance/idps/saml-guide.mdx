...
In the Web UI, select **Add New**, click **Resource**, and look for SAML.
Choose the appropriate SAML IdP integration tile. Click the tile and follow the resulting steps.
