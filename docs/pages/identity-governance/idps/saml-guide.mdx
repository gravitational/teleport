...
In the Teleport Web UI, from the side navigation menu, select **Zero Trust Access > Roles** 
...
to service provider. Some service providers may ask to provide Teleport SAML IdP's 
entity ID, SSO URL and X.509 certificate explicitly. Others may ask to upload 
...
based on, it is designed to grant access to the protected page for any well formatted 
