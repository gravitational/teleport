...
All attributes sent with the SAML assertion will be stored as the [user's external traits](../../reference/access-controls/roles.mdx#referring-to-external-traits-in-teleport-roles) which then can be used to build RBAC rules.
