...
This example resource has the label `env: demo`. If your resource has not been
labeled, reconfigure your resource with a label. Alternatively, you can add a
label using a `server_info` resource.
...
For more details about applying resource-based labels with `server_info` resources,
refer to [Apply resource-based labels](https://goteleport.com/docs/admin-guides/management/admin/labels/#apply-resource-based-labels).
