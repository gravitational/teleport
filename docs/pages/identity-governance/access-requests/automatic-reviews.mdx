...
- Automatically approve requests when a user from a particular team requests a specific role.
- Automatically approve requests when a user from a particular team requests a specific resource.
...
To demonstrate role-based automatic reviews, create the following Access Automation
Rule via the Teleport Web UI:
...
To demonstrate resource-based automatic reviews, create the following Access Automation
Rule via the Teleport Web UI:
...
- For more details about managing resource labels, refer to the
  [Add Labels to Resources Guide](../../zero-trust-access/management/admin/labels.mdx).
