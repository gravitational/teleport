...
To request access to one or more roles, use the left sidebar to navigate to
**Identity Governance** > **Access Requests** and select **New Access Request**.

From here, a dropdown will allow you to request access to roles or to specific
...
Click **+ Request Access** to include a role in the pending request.
