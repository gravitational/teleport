...
For short-term requests, an Access List is applicable when its member grants include a role that allows requesting one of the requested roles.

For long-term requests, an Access List is applicable when the Access List directly grants one of the requested roles.
