...
Access Requests enable your organization to implement security best practices,
including:
...
- **Principle of least privilege:** You can configure Access Requests to give an
  attacker no permanent admin roles' targets.  Users receive elevated privileges
...
While users cannot approve their own requests, Teleport does support [automatic
reviews](./automatic-reviews.mdx) for Access Request workflows without requiring
manual approval.
...
Configuration](configuration/configuration.mdx) guide for an
