...
Integrate with IdPs like **AWS IAM Identity Center** and **Okta** to sync groups to Teleport roles. 
...
- Learn how [Access Lists](../identity-governance/access-lists/guide.mdx) works.