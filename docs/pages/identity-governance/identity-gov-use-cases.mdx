  ...
  tiles={[
    {
      ...
      to: "/docs/identity-governance/aws-iam-identity-center",
      name: "AWS IAM Identity Center",
    },
    {
      icon: <Icon name="oktaIntegration" size="xl" />,
      to: "/docs/identity-governance/okta",
      name: "Okta Integration",
    },
    {
      icon: <Icon name="entraIDIntegration" size="xl" />,
      to: "/docs/identity-governance/entra-id/getting-started",
      name: "Entra ID Integration",
    },
    {
      icon: <Icon name="teleportIdentity provider" size="xl" />,
      to: "/docs/identity-governance/idps",
