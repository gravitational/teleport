...
Identity Center configuration. It specifically describes two scenarios: one where 
...
Okta to Teleport, including User provisioning and SAML SSO.
...
Specifically:
 ...
 - Teleport controls Identity Center user and group account assignments for the Identity Center principals under its control.
