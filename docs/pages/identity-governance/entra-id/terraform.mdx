...
To set up system credential, you need to grant Graph API permissions to the Managed Identity 
...
First, ensure that system assigned Managed Identity is enabled for your VM.
