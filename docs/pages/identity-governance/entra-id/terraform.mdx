...
First, set up the `azuread` [provider](https://registry.terraform.io/providers/hashicorp/azuread/latest/docs) in your 
...
The example provides a configurable Terraform module to set up Entra ID with attributes that are 
