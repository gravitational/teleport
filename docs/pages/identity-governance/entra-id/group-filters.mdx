---
title: Entra ID Group Filters
description: How to configure group filters for the Teleport Entra ID integration.
sidebar_position: 5
tags:
 - identity-governance
 - azure
...
This page explains how to configure group filters in the Teleport Entra ID integration. 
