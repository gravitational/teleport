...
The procedure varies slightly depending on whether your Teleport cluster is
...
To learn how Teleport can use synced Okta profile name and email attributes in
the Web UI, see [User Display
Names](../../../reference/access-controls/user-display-names.mdx).
