...
Save and copy the generated **Bearer Token** and store it for later. It will be required for the Okta Teleport app configuration. If the **Save SCIM Configuration** button is not greyed out the token is not saved yet.
