...
![Object Broswer](../../../../img/sailpoint/sailpoint-object-browser.png)
...
section above. This will make the SailPoint SCIM provisioner SailPoint to fetch
and preserve the resource versions.
</Admonition>
