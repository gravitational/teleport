...
1. Create a new Standard Account with the following settings:
   ...
   User account setup: ![Jamf user setup](../../../img/access-controls/device-trust/jamf-setup-1.png)

   Privileges setup: ![Jamf privileges setup](../../../img/access-controls/device-trust/jamf-setup-2.png)
