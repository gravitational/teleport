...
In this step, you'll install the Teleport email plugin on a host that has network
access to your SMTP server. This host can be any system capable of reaching both
your Teleport cluster and the SMTP server used for sending emails.
