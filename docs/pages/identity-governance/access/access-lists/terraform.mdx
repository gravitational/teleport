...
The Okta integration allows [synchronizing Okta groups and apps](../../identity-integrations/okta/app-and-group-sync.mdx) as
...
Entra ID integration allows [synchronizing groups](../../identity-integrations/entra-id/entra-id.mdx) as
Teleport Access Lists. 
...
Lists created by an integration (e.g. [Okta](../../identity-integrations/okta/app-and-group-sync.mdx) or [Entra
ID](../../identity-integrations/entra-id/entra-id.mdx)). An existing static list created by another Terraform setup (with
...
- Learn how [nested Access Lists](../access-lists/nested-access-lists.mdx) grants inheritance work.
