...
Every user in Teleport is **always** assigned a set of roles. The Open Source Edition (OSS)
 of Teleport automatically assigns every user to the built-in `admin`
