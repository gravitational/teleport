...
This section will give an overview of Teleport Enterprise, the commercial product built around Teleport Open Source core. For those that want to jump right in, you can play
...
With Teleport 4.2 we've introduced the ability for users to request additional roles. The Access Request API makes it easy to dynamically approve or deny these requests.
