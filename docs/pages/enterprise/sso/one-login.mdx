...
>
  This guide requires an Enterprise edition of Teleport. The Open Source Edition of Teleport only supports [Github](../../admin-guide.mdx#github-oauth-20) as an SSO provider.
</Admonition>
