...
h1: Teleport SSO Authentication with Okta
---
...
![image](https://user-images.githubusercontent.com/60704961/112176449-7ce77700-8bce-11eb-8e00-069952bb9b78.png)

2. Collect the `Application ID` and `Secret` in the Application

These will be used in the Teleport OIDC Auth Connector.

![image](https://user-images.githubusercontent.com/60704961/112177135-0e56e900-8bcf-11eb-861f-3b179d36be07.png)
...
<Admonition
  ...
  title="IMPORTANT"
>
  The `prompt` value must be blank.  Setting to blank means Teleport will not send this as a parameter which will result in an error from GitLab.
</Admonition>
