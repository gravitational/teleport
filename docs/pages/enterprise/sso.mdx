...
The Enterprise edition of Teleport, self-hosted or Teleport Cloud, allows for using a organization's
Single Sign-On (SSO) provider to authenticate and authorize accessing 
SSH, Kubernetes, Databases, Desktops and Web applications.  Teleport Enterprise supports OIDC and SAML protocols
for SSO providers in addition to the OpenSource [GitHub SSO](../setup/admin/github-sso.mdx) support.

<TileSet>
  <Tile icon="bolt" title="Azure Active Directory (AD)" href="./sso/azuread.mdx">
    Configure Azure Active Directory SSO for SSH, Kubernetes, Database, Desktops and Web apps.
  </Tile>
  <Tile icon="bolt" title="Active Directory (ADFS)" href="./sso/adfs.mdx">
    Configure Windows Active Directory SSO for SSH, Kubernetes, Database, Desktops and Web apps.
  </Tile>
  <Tile icon="bolt" title="Google Workspace" href="./sso/google-workspace.mdx">
    Configure Google Workspace SSO for SSH, Kubernetes, Database, Desktops and Web apps.
  </Tile>
  <Tile icon="bolt" title="GitLab" href="./sso/gitlab.mdx">
    Configure GitLab SSO for SSH, Kubernetes, Database, Desktops and Web apps.
  </Tile>
  <Tile icon="bolt" title="OneLogin" href="./sso/one-login.mdx">
    Configure OneLogin SSO for SSH, Kubernetes, Database, Desktops and Web apps.
  </Tile>
  <Tile icon="bolt" title="OIDC" href="./sso/oidc.mdx">
    Configure OIDC SSO for SSH, Kubernetes, Database, Desktops and Web apps.
  </Tile>
  <Tile icon="bolt" title="Okta" href="./sso/okta.mdx">
    Configure Okta SSO for SSH, Kubernetes, Database, Desktops and Web apps.
  </Tile>
</TileSet>
...
- Ensure that HTTPS/TLS certificates are configured properly for both Teleport
