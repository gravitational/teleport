...
<TabItem label="Download">
  ```bash
  $ curl -L https://get.gravitational.com/teleport-slack-v(=teleport.version=)-linux-amd64-bin.tar.gz
  $ tar -xzf teleport-slack-v(=teleport.version=)-linux-amd64-bin.tar.gz
  $ cd teleport-slack
  $ ./install
  ```
</TabItem>
