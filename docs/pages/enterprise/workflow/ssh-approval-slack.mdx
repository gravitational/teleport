...
The slack plugin uses the `access-plugin` role and user to perform the approval. Export credentials for the slack plugin to connect to Teleport using [`tctl auth sign`](https://goteleport.com/docs/cli-docs/#tctl-auth-sign).
