...
Teleport Plugin use the `access-plugin` role and user to perform the approval. Export credientials using [`tctl auth sign`](https://goteleport.com/docs/cli-docs/#tctl-auth-sign).
