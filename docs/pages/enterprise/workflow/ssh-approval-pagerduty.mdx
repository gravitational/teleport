...
<TabItem label="Download">
  ```code
  $ curl -L https://get.gravitational.com/teleport-access-pagerduty-v(=teleport.version=)-linux-amd64-bin.tar.gz
  $ tar -xzf teleport-access-pagerduty-v(=teleport.version=)-linux-amd64-bin.tar.gz
...
```code
$ docker pull quay.io/gravitational/access-plugin-pagerduty:(=teleport.version=)
```
</TabItem>
</Tabs>
