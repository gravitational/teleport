...
<TabItem label="Download">
  ```code
  $ curl -L https://get.gravitational.com/teleport-access-pagerduty-v(=teleport.plugin.version=)-linux-amd64-bin.tar.gz
...
<TabItem label="Docker">
  ```code
  $ docker pull quay.io/gravitational/access-plugin-pagerduty:(=teleport.plugin.version=)
  ```
</TabItem>
</Tabs>
