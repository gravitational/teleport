...
This guide will talk through how to set up Teleport with Mattermost. Teleport to
...
>
  <img src="../../../img/enterprise/plugins/teleport_bot@2x.png" alt="Teleport Bot Icon" height="128" width="128"/>
</Figure>
...
Teleport Plugin uses the `access-plugin-mattermost` role and user to perform the approval. We export the identity files, using [`tctl auth sign`](https://gravitational.com/teleport/docs/cli-docs/#tctl-auth-sign).
