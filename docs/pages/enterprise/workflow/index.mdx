---
title: Access Requests for SSH, Kubernetes, Databases, Desktops and Web Apps.
description: Teleport allows users to request elevated privileges in the middle of their command-line sessions.  Requests can be escalted via ChatOps or anywhere else via flexible Authorization Workflow API.
