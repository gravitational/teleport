...
description: Teleport allows users to request elevated privileges by requesting new roles from the CLI or UI.  Requests can be escalted via ChatOps or anywhere else via flexible Authorization Workflow API.
