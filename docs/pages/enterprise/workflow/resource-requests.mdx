...
<TileSet>
<Tile icon="cloud" title="Teleport Cloud" href="./resource-requests.mdx/?scope=cloud">
</Tile>
<Tile icon="building" title="Teleport Enterprise" href="./resource-requests.mdx/?scope=enterprise">
</Tile>
</TileSet>
...
Advanced filters and queries are supported, see our [filtering reference](/setup/reference/cli/#resource-filtering).
...
## Step 8/8. Automatically request access for SSH
...
### Restrict the resources users can request access to
