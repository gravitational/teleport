...
<TabItem label="Download">
  ```code
  $ curl -L https://get.gravitational.com/teleport-access-jira-v(=teleport.plugin.version=)-linux-amd64-bin.tar.gz
...
<TabItem label="Docker">
  ```code
  $ docker pull quay.io/gravitational/access-plugin-jira:(=teleport.plugin.version=)
  ```
</TabItem>
</Tabs>
