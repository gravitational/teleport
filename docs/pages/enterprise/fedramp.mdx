---
title: FedRAMP compliance for SSH, Kubernetes, Databases and Web Apps.
description: How to configure SSH, Kubernetes, Databases,  and Web Apps access to be FedRAMP compliant, including support for FIPS 140-2
