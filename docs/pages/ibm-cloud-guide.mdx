...
While you can use Teleport for all the services that you would SSH int, this guide is focused on IBM Cloud. 

In the future, we'll update how to use Teleport with IBM Cloud Kubernetes Service.
...
We recommend setting up Teleport in High Availability (HA) mode. In HA mode [etcd](https://etcd.io/)
