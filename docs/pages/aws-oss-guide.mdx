...
like help setting up Teleport Enterprise on AWS, please mail us at <a href="mailto:info@gravitational.com">[info@gravitational.com](mailto:info@gravitational.com)</a>

## Running Teleport in HA on AWS

We have a [guide for setting up Teleport in a high availability configuration on AWS](aws-terraform-guide.mdx).
