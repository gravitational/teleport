...
description: Configure business and security contact emails to receive important updates from SoftwareX.
tocDepth: 3
---
...
billing, and security-related notifications from SoftwareX.
...
Users will need permission to list contact resource.

</Admonition>

### SoftwareX Cloud

1. Go to https://SoftwareX.sh and enter your tenant name.
