...
<Admonition
  type="note"
  title="Why do I see SSH Ports for Application Access?"
>
...
For testing and debugging purposes we provide an inbuilt debugging app. This can be turned on use `debug_app: true`.
...
- SPA with custom JSON Web Token (JWT) support 
