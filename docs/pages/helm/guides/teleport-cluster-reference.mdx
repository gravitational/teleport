...
- [Running a quick one-pod Teleport cluster in Kubernetes using Helm (`standalone` mode)](./standalone.mdx)
- [Setting up a highly-available Teleport cluster using AWS & EKS (`aws` mode)](./aws.mdx)
- [Setting up a highly-available Teleport cluster using GCP & GKE (`gcp` mode)](./gcp.mdx)
- [Bring your own Teleport config (`ownconfig` mode)](./ownconfig.mdx)
...
`ownconfig` settings are described in their own guide: [Bring your own Teleport config (`ownconfig` mode)](./ownconfig.mdx)
