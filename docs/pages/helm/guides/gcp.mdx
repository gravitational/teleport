---
title: Setting up a highly-available Teleport cluster using GCP & GKE
...
See the [high availability section of our `teleport-cluster` chart reference](./teleport-cluster-reference/#highavailability) for more details.
...
4. Click the "continue" buttton to save these settings, then click the "create" button to create the service account.
