...
description: Getting started with Teleport - identity-aware ccess plane for SSH, HTTPS, Kubernetes, and Databases.
layout: tocless-doc
---
...
<TileSet>
  ...
  <Tile icon="kubernetes" title="Kubernetes" href="./kubernetes-access/getting-started.mdx">
