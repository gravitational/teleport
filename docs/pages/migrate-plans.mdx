...
To learn how to restart and configure a Machine & Workload Identity Bot in your
infrastructure, read the [full documentation](machine-workload-identity/machine-id/deployment/deployment.mdx)
on deploying a Machine & Workload Identity Bot.
