...
1. Retrieve your `github`  configuration resource:
...
1. Edit `github.yaml`, adding `{{ role }}` to the `teams_to_roles` section. 
   ...
   organization's role-based acces controls (RBAC). However, the team must include your user account and
...
1. Edit `saml.yaml`, adding `{{ role }}` to the `attributes_to_roles` section. 
   ...
   organization's role-based acces controls (RBAC). However, the group must include your 
...
1. Edit `oidc.yaml`, adding `{{ role }}` to the `claims_to_roles` section. 
   ...
   role-based acces controls (RBAC). However, the group must include your user account and
