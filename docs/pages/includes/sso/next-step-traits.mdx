...
<Admonition type="tip">
Teleport can also use common name and email attributes or claims from SAML or
OIDC providers to show [display
names](../../reference/access-controls/user-display-names.mdx) in the Web UI.
</Admonition>
