...
The recommended approach is to use the following document,
setting <Var name="teleport.example.com:443" /> to the host and port of your Teleport Proxy Service or Enterprise Cloud site, 
...
Some additional configurations are required, and this section explains them in further detail below:
...
#### Allow the Discovery Service to list accounts and assume the discovery role in those accounts
