  ...
  github:
    ...
    allow:
      - # repository is a fully qualified (e.g. including the owner) name of a
        ...
        # enterprise is the name of the enterprise that owns the repository.
        # This is only populated for repositories owned by a GitHub Enterprise.
        #
        # Specifying only this value will allow any GitHub Actions workflow
        # running in any repository belonging to this enterprise to join.
        enterprise: my-enterprise
        # enterprise_id is the ID of the enterprise that owns the repository.
        # This is only populated for repositories owned by a GitHub Enterprise.
        #
        # Specifying only this value will allow any GitHub Actions workflow
        # running in any repository belonging to this enterprise to join.
