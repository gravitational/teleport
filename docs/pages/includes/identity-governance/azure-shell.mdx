...
Once a Cloud Shell instance opens, paste the generated bash script that downloads the Teleport binary in your 
Azure Shell and runs the `teleport integration configure azure-oidc` command. 
