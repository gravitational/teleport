...
- Create an IAM policy and attach it to the Teleport Auth Service instances IAM
  identity.
...
Create the following IAM policy and attach it to the Teleport Auth Service instances IAM
identity.
