...
<details>
<summary>1. Configure Trust Relationships on {{role2}}</summary>
...
<details>
<summary>2. Configure Permissions Policies on {{role1}}</summary>
...
<details>
<summary>3. Configure Permissions Boundary on {{role1}}</summary>
