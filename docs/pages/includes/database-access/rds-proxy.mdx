...
[PostgreSQL](../../zero-trust-access/enroll-resources/database-access/enroll-aws-databases/rds-proxy-postgres.mdx),
[MariaDB/MySQL](../../zero-trust-access/enroll-resources/database-access/enroll-aws-databases/rds-proxy-postgres.mdx) or
[Microsoft SQL Server](../../zero-trust-access/enroll-resources/database-access/enroll-aws-databases/rds-proxy-sqlserver.mdx).
</Admonition>
