...
[PostgreSQL](../../admin-guides/enroll-resources/database-access/enroll-aws-databases/rds-proxy-postgres.mdx),
[MariaDB/MySQL](../../admin-guides/enroll-resources/database-access/enroll-aws-databases/rds-proxy-postgres.mdx) or
[Microsoft SQL Server](../../admin-guides/enroll-resources/database-access/enroll-aws-databases/rds-proxy-sqlserver.mdx).
</Admonition>
...
the Teleport Discovery Service](../../admin-guides/enroll-resources/auto-discovery/databases.mdx) to
