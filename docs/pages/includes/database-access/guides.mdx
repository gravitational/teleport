...
- [Active Directory Azure SQL Server (Preview)](../../database-access/guides/azure-sql-server-ad.mdx): Connect Azure SQL Server with Active Directory authentication.
