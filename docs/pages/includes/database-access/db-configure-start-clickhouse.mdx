...
For ClickHouse integration with Native interface set the protocol value to `--protocol=clickhouse` installed of `--protocol=clickhouse-http` and point `--uri` to the
