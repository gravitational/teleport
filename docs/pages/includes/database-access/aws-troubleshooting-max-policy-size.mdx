...
Access](../../zero-trust-access/enroll-resources/database-access/enroll-aws-databases/aws-cross-account.mdx).
...
configuration](../../zero-trust-access/enroll-resources/database-access/guides/ha.mdx) where databases can be
