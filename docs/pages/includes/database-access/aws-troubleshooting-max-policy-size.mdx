...
<Tabs>
  ...
  labels](https://goteleport.com/docs/database-access/reference/labels/#auto-discovery)
  for more details.
  </Admonition>
  </TabItem>
  ...
  <TabItem label="Other dyanmic resources">
