...
<Tabs>
  ...
  labels](../../reference/agents/database-labels.mdx)
...
Access](../../admin-guides/enroll-resources/database-access/enroll-aws-databases/aws-cross-account.mdx).
...
configuration](../../admin-guides/enroll-resources/database-access/guides/ha.mdx) where databases can be
