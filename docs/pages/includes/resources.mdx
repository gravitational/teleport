...
|assume_start_time|The time the requested roles can be assumed.|See example YAML.|
...
access_list: # [...]
assume_start_time: "2023-01-31T00:00:00-00:00"
...
|priv|The SSH private key for the user.|base64-encoded string|
