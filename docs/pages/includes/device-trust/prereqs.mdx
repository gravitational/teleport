- To enroll a macOS device, you need:
  - A signed and notarized `tsh` binary, v12.0.0 or newer.
    [Download the macOS tsh installer](../../get-started/download-install/installation.mdx).
- To enroll a Windows device, you need:
  ...
  - `tsh` v13.1.2 or newer. [Download the Windows tsh installer](../../get-started/download-install/installation.mdx).
- To enroll a Linux device, you need:
  ...
  - `tsh` v15.0.0 or newer. [Install tsh for Linux](../../get-started/download-install/installation.mdx).
