...
When successfully authenticated to use device trust in the web UI, you will see a green
...
If you are not authenticated to use device trust in the web UI, but one or more of the user's
roles (or the cluster-wide configuration) requires device trust, you will see a yellow warning shield
next to the logged-in username at the top right of the screen:
