...
* L7 load balancer: make sure it propagates the [X-Forwarded-For header](../../reference/agent-services/agent_services_glossary.mdx#proxy-service) 
* L4 load balancer: enable [PROXY protocol](../../admin-guides/management/security/proxy-protocol.mdx)
