...
device. [Download the macOS tsh installer](../../get-started/download-install/installation.mdx) to fix
the problem.
...
../../admin-guides/authentication/device-trust/device-management.mdx#register-a-trusted-device) and
[enrollment](
../../admin-guides/authentication/device-trust/device-management.mdx#enroll-a-trusted-device) steps
...
[App Access support](
../../admin-guides/authentication/device-trust/enforcing-device-trust.mdx#app-access-support).
...
1. Make sure your device is [registered and enrolled](
   ../../admin-guides/authentication/device-trust/device-management.mdx#register-a-trusted-device)
