...
Teleport as such. Follow the [registration](../../identity-governance/device-trust/device-management.mdx) and
[enrollment](../../identity-governance/device-trust/device-management.mdx) steps
...
1. Make sure your device is [registered and enrolled](
   ../../identity-governance/device-trust/device-management.mdx#register-a-trusted-device)
...
* L4 load balancer: enable [PROXY protocol](../../zero-trust-access/management/security/proxy-protocol.mdx)
