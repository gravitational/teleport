...
automatically rebuilt every night.  Our images are provided as distroless that provides only Teleport binaries
and their application dependencies. To learn more about the advantages
and specifics of distroless images see the [Distroless Debian 11 README](https://github.com/GoogleContainerTools/distroless).
