...
Versions without an architecture postfix type use the `amd64` architecture. (public.ecr.aws/gravitational/teleport:(=teleport.major_version=)). All architecture versions are available 
