...
spec:
  ...
  allow:
    ...
    # Windows logins a user is allowed to use for Windows desktop sessions.
    windows_desktop_logins: [Administrator, '{{internal.logins}}']

    # Linux desktop logins a user is allowed to use for Linux desktop sessions.
    linux_desktop_logins: [root, '{{internal.linux_desktop_logins}}']
    ...
    linux_desktop_labels_expression: 'labels["env"] == "staging"'
