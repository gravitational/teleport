...
Teleport RBAC for that database user by following the appropriate
[database enrollment guide](../../enroll-resources/database-access/enrollment/enrollment.mdx).
</Admonition>
...
The enrollment guide for your database may provide more specific
