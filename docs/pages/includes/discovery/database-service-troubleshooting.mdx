...
[Enroll AWS Databases](../../zero-trust-access/enroll-resources/database-access/enroll-aws-databases/enroll-aws-databases.mdx).
</Admonition>
...
guide](../../zero-trust-access/enroll-resources/database-access/troubleshooting.mdx) for more
