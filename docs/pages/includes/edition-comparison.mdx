...
||Open Source|Enterprise|Cloud|Team|
|---|---|---|---|---|
|[Structured Audit Logs](../blargh.mdx)|✔|✔|✔|✔|
|[Session Recording with Playback](../blargh.mdx)|✔|✔|✔|✔|
...
|Proxy Service domain name|Custom|Custom|A subdomain of `teleport.sh`|Subdomain of `teleport.sh`|
