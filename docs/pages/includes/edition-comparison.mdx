...
|[Hardware Key Support](../zero-trust-access/access-controls/guides/hardware-key-support.mdx)|✖|✔|✔|
|[Moderated Sessions](../zero-trust-access/access-controls/guides/joining-sessions.mdx)|✖|✔|✔|
|[Role-Based Access Control](../zero-trust-access/access-controls/guides/role-templates.mdx)|✔|✔|✔|
|[Single Sign-On](../zero-trust-access/sso/sso.mdx)|GitHub|GitHub, Google Workspace, OIDC, SAML, Teleport|GitHub, Google Workspace, OIDC, SAML, Teleport|
...
|[JIT Access Requests](../zero-trust-access/access-controls/guides/dual-authz.mdx)|Limited|✔|✔|
...
|[Hardware Security Module support](../zero-trust-access/deploy-a-cluster/hsm.mdx) for encryption at rest|✖|✔|✖|
