...
instance is set to 1. You can use the following commands to check and update
the hop limit:
```code
$ aws ec2 describe-instances --instance-ids <node-instance-id> | grep HttpPutResponseHopLimit
                        "HttpPutResponseHopLimit": 1,
$ aws ec2 modify-instance-metadata-options --http-put-response-hop-limit 2 --instance-id <node-instance-id>
```
