...
to your geodns service or putting it behind the load balancer for the Anycast
...
`join_params` are arameters for joining the Teleport Cluster.
...
other parameters here. See
[Teleport Config Reference](https://goteleport.com/docs/reference/deployment/config/#instance-wide-settings).

To create the token, see docs ([Terraform](https://goteleport.com/docs/reference/infrastructure-as-code/terraform-provider/resources/provision_token/) or [tctl](https://goteleport.com/docs/reference/cli/tctl/#tctl-tokens-add)):
...
* [AWS](https://goteleport.com/docs/reference/deployment/join-methods/#aws-iam-role-iam)
* [Azure](https://goteleport.com/docs/reference/deployment/join-methods/)#azure-managed-identity-azure
* [GCP](https://goteleport.com/docs/reference/deployment/join-methods/#gcp-service-account-gcp)
...
If method is 'token' and joinTokenSecre.create is true, token_name is
...
`ingress` is the Kubernets Ingress object.
...
### `ingress.supressAutomaticWildcards`

`ingress.supressAutomaticWildcards` will not automatically add 
...
## `terminationGracePeriodSecongs`

`terminationGracePeriodSecongs` Kubernetes termination grace period
