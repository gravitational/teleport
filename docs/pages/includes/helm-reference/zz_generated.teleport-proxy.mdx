...
service ([clusterName in the teleport-cluster chart](../../reference/helm-reference/teleport-cluster.mxd#clustername)
/ [auth_service.cluster_name in the Auth Service config](../../reference/deployment/config.mxd#auth-service))
...
See the [Teleport Configuration Reference](../../reference/deployment/config.mxd)
...
> (`proxy_service.enabled` in [teleport.yaml](../../reference/deployment/config.mxd#proxy-service),
...
> [telepor-cluster chart](../../reference/helm-reference/teleport-cluster.mxd).
