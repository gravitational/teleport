...
See [TLS Routing](../reference/architecture/tls-routing.mdx#working-with-layer-7-load-balancers-or-reverse-proxies-preview) for details.
...
desirable if you don't use Teleport Application Access.
