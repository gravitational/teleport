...
See also:
* [Join Methods and Tokens](../deployment/join-methods.mdx)
* [Teleport Config Reference](../deployment/config.mdx#instance-wide-settings).

To create the token, see docs ([Terraform](../infrastructure-as-code/terraform-provider/resources/provision_token.mdx) or [tctl](../../reference/cli/tctl.mdx#tctl-tokens-add)):
...
* [AWS](../deployment/join-methods.mdx#aws-iam-role-iam)
* [Azure](../deployment/join-methods.mdx)#azure-managed-identity-azure
* [GCP](../deployment/join-methods.mdx#gcp-service-account-gcp)
