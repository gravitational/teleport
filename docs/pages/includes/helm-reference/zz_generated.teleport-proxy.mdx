...
To create the token, see docs ([Terraform](../../reference/infrastructure-as-code/terraform-provider/resources/provision_token.mdx)
or [tctl](../../reference/cli/tctl.mdx#tctl-create)):
