...
See also:
* [Join Methods and Tokens](../../deployment/join-methods/)
* [Teleport Config Reference](../../deployment/config/#instance-wide-settings).

To create the token, see docs ([Terraform](../../infrastructure-as-code/terraform-provider/resources/provision_token/) or [tctl](https://goteleport.com/docs/reference/cli/tctl/#tctl-tokens-add)):
...
* [AWS](../../deployment/join-methods/#aws-iam-role-iam)
* [Azure](../../deployment/join-methods/)#azure-managed-identity-azure
* [GCP](../../deployment/join-methods/#gcp-service-account-gcp)
...
`podMonitor` controls the [PodMonitor CR](monitoring.coreos.com/v1).
...
See [TLS Routing](https://goteleport.com/docs/architecture/tls-routing/#working-with-layer-7-load-balancers-or-reverse-proxies-preview) for details.
