...
the Teleport cluster. It can be either the address of the Auth Service instances or the
proxy servers.
...
PagerDuty](../../admin-guides/access-controls/access-request-plugins/ssh-approval-pagerduty.mdx) guide
