...
Microsoft Teams](../../identity-governance/access-requests/plugins/msteams.mdx) guide
...
See [the MsTeams guide](../../identity-governance/access-requests/plugins/msteams.mdx) to know how to get this value.
