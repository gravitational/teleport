...
Microsoft Teams](../../admin-guides/access-controls/just-in-time/access-request-plugins/ssh-approval-msteams.mdx) guide
...
See [the MsTeams guide](../../admin-guides/access-controls/just-in-time/access-request-plugins/ssh-approval-msteams.mdx) to know how to get this value.
