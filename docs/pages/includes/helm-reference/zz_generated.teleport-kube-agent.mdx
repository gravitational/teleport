...
See [the join method reference](../../reference/operations/join-methods.mdx) for the list of possible
...
When `joinParams.method` is [a delegated join method](../../reference/operations/join-methods.mdx),
...
the agent. See [the Teleport Application access documentation](../../admin-guides/enroll-resources/application-access/introduction.mdx)
for more details.
...
<Admonition type="tip" title="Supported values">
  ...
  Reference](../../reference/agents/application-access.mdx).
</Admonition>
...
Application access documentation](../../admin-guides/enroll-resources/application-access/introduction.mdx)
for more details.
...
`tsh` by following [the Dynamic App Registration guide](../../admin-guides/enroll-resources/application-access/guides/dynamic-registration.mdx).
</Admonition>
...
<Admonition type="note" title="IAM roles">
  For AWS database auto-discovery to work, your Database Service pods will need to use a role which has appropriate IAM permissions as per the [database documentation](../../admin-guides/enroll-resources/database-access/enroll-aws-databases/rds.mdx).
...
<Admonition type="note" title="Azure IAM">
  For Azure database auto-discovery to work, your Database Service pods will need to have appropriate IAM permissions as per the [database documentation](../../admin-guides/enroll-resources/database-access/enroll-azure-databases/azure-postgres-mysql.mdx).
...
the agent. See [the Teleport Database access documentation](../../index.mdx)
for more details.
...
<Admonition type="tip" title="Supported values">
  You can see a list of all the supported [values which can be used in a Teleport database service configuration here](../../reference/config-references/database-access.mdx).
</Admonition>
...
Database access documentation](../../index.mdx)
for more details.
...
`tsh` by following [this guide](../../admin-guides/enroll-resources/database-access/guides/dynamic-registration.mdx).
</Admonition>
...
documentation](../../admin-guides/enroll-resources/auto-discovery/kubernetes-applications/architecture.mdx)
for more details.
...
<Admonition type="warning">
  ...
  One option might be to use Teleport's built-in [ACME support](../../reference/config-references/helm-reference/teleport-cluster.mdx) or enable [cert-manager support](../../reference/config-references/helm-reference/teleport-cluster.mdx).
</Admonition>
...
See the [Teleport Configuration Reference](../../reference/config-references/config.mdx) for the list of supported fields.
...
<Admonition type="note">
  ...
  For more information on how to set static/dynamic labels for Teleport services, see [labelling nodes and applications](../../admin-guides/access-controls/labels/labels.mdx).
</Admonition>
...
See the [Teleport config file reference](../../reference/config-references/config.mdx) for
