...
`containerName` sets the name of the main container in the teleport pod.
This value is used to identify the container in Kubernetes and is typically set to "teleport"
for the teleport-kube-agent chart.

## `appImage`

`appImage` sets the container image used for tbot pods created by this
chart.
