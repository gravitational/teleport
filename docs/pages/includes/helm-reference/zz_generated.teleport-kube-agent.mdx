...
`highAvailability.podDisruptionBudget.unhealthyPodEvictionPolicy` Allow
...
`highAvailability.podDisruptionBudget.forceUnhealthyPodEvictionPolicy` enabled unhealthyPodEvictionPolicy for kubernetes clusters < v1.31. The
