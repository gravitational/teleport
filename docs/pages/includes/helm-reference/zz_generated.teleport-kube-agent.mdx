...
prevents draining a node. Set to "" to disable this option, or set an
explicit policy to force rendering it on Kubernetes versions before 1.27.
See: [unhealthyPodEvictionPolicy in Kube
