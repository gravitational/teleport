...
[Kubernetes JWKS](../../reference/deployment/join-methods.mdx#kubernetes-jwks) join method.
...
When running in scoped mode, the operator generates a UUID and stored it in Kubernetes.
