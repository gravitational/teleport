...
<Tabs dropdownView dropdownCaption="Teleport Edition">
  ...
  Amazon Linux 2023 installations should utilize the Tarball installation or
  install with a Teleport RPM file. You can download the matching RPM architecture for your instance
  from the [Teleport Download](https://goteleport.com/download) page and install with the example command below.
