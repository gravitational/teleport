...
Visit your [Teleport Workspace](https://teleport.sh) or the [Downloads Page](https://dashboard.gravitational.com/web/downloads) in
the legacy customer portal and select the URL for your package of choice.
