...
| `heartbeat_missed_total`                        | counter     | Teleport Auth       | Number of times the Auth Service did not receive a heartbeat from a Node.                          |
...
| `proxy_peer_client_dial_error_total`      | counter   | Teleport Proxy | Total number of errors encountered dialing peer proxies.                                                                        |
| `proxy_peer_server_connections`           | gauge     | Teleport Proxy | Number of currently opened connection to proxy peer servers.                                                                    |
...
| `proxy_peer_server_connections`           | gauge     | Teleport Proxy | Number of currently opened connection to proxy peer clients.                                                                    |
