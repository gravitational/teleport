...
- We recommend that you read the [Architecture Guide](architecture/teleport-architecture-overview.mdx) before
...
Instead follow the [Admin Guide](admin-guide.mdx))**
...
get all the important details. The [Admin Guide](admin-guide.mdx) will lay out
