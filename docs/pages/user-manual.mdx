...
terminal for the [CLI reference](reference/cli-docs.mdx).
...
[`tsh`](reference/cli-docs.mdx#tsh):
...
to call [`tsh login`](reference/cli-docs.mdx#tsh-login) in the beginning.
...
[CLI Docs - tsh ssh](reference/cli-docs.mdx#tsh-ssh)
...
[CLI Docs - tsh login](reference/cli-docs.mdx#tsh-login)
...
<Admonition
  ...
  title="Tip"
>
  It is recommended to always use [`tsh login`](reference/cli-docs.mdx#tsh-login) before using any other `tsh` commands. This allows users to omit `--proxy` flag in subsequent tsh commands. For example
...
[CLI Docs - tsh status](reference/cli-docs.mdx#tsh-status)
...
[`tsh login`](reference/cli-docs.mdx#tsh-login) can also save the user certificate into a
file:
...
[CLI Docs - tctl auth sign](reference/cli-docs.mdx#tctl-auth-sign)
...
[CLI Docs - tsh ls](reference/cli-docs.mdx#tsh-ls)
...
[CLI Docs - tsh clusters](reference/cli-docs.mdx#tsh-clusters)
...
He executes the [`tsh login`](reference/cli-docs.mdx#tsh-login) command:
