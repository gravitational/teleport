...
| [Machines](machine-workload-identity/machine-workload-identity.mdx) and [workloads](machine-workload-identity/introduction-workload-id/introduction.mdx) | Available in Teleport Machine & Workload Identity | Available in Teleport Machine & Workload Identity | Available in Teleport Machine & Workload Identity |
