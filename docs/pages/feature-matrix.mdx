...
| [Single Sign-On](zero-trust-access/sso/sso.mdx)| GitHub, Google Workspace, Microsoft Entra ID, Okta, OIDC, SAML, Teleport | GitHub, Google Workspace, Microsoft Entra ID, Okta, OIDC, SAML, Teleport | GitHub |
...
| [Hardware Private Key Support](zero-trust-access/access-controls/guides/hardware-key-support.mdx) (e.g., via YubiKey) | ✔ (External-connected HSM/KMS coming soon) | ✔ | ✖ |
| [Per-Session MFA](zero-trust-access/access-controls/guides/per-session-mfa.mdx)| ✔ | ✔ | ✔ |
|**Resource identity.** Assign a cryptographic identity to every Teleport Protected Resource:||||
| Protecting: [Applications](./enroll-resources/application-access/getting-started.mdx), [Databases](./enroll-resources/database-access/getting-started.mdx), [Kubernetes Clusters](./enroll-resources/kubernetes-access/getting-started.mdx), [Linux Servers](./enroll-resources/server-access/getting-started.mdx), [Windows Servers](./enroll-resources/desktop-access/introduction.mdx), [Windows Desktops](./enroll-resources/desktop-access/introduction.mdx), Cloud Consoles & Resources (AWS, Azure, GCP), [GitHub](zero-trust-access/management/guides/github-integration.mdx) | ✔ | ✔ | ✔ (does not include Oracle support) |
...
| [IP-Based Restrictions](zero-trust-access/access-controls/guides/ip-pinning.mdx) | ✔ | ✔ | ✖ |
...
| [Role-Based Access Control](zero-trust-access/access-controls/guides/role-templates.mdx) | ✔ | ✔ | ✔ |
...
| [Dual Authorization](zero-trust-access/access-controls/guides/dual-authz.mdx) | ✔ | ✔ | ✖ |
| [Session Sharing & Moderation](zero-trust-access/access-controls/guides/joining-sessions.mdx) | ✔ | ✔ | ✖ |
...
|  | **Enterprise (Cloud)** | **Enterprise (Self-Hosted)** | **Community Edition** |
|---|:---:|:---:|:---:|
| [JIT Access Requests](zero-trust-access/access-controls/guides/dual-authz.mdx): Grant only those privileges necessary to complete the task at hand. Remove the need for super-privileged accounts. | ✔ | ✔ | Only can request roles through CLI  |
...
| Microsoft Entra ID directory synchronization and SSO [integration](zero-trust-access/sso/azuread.mdx) | ✔ | ✔ | ✖ |
