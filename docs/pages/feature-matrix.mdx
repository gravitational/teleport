...
| [Single Sign-On](zero-trust-access/access-controls/sso/sso.mdx)| GitHub, Google Workspace, Microsoft Entra ID, Okta, OIDC, SAML, Teleport | GitHub, Google Workspace, Microsoft Entra ID, Okta, OIDC, SAML, Teleport | GitHub |
...
| [Export to SIEM](zero-trust-access/management/export-audit-events/export-audit-events.mdx) | ✔ | ✔ | ✔ |
|**Regulatory standards and frameworks:**||||
| [FedRAMP Control](zero-trust-access/access-controls/compliance-frameworks/fedramp.mdx) | ✖ | ✔ | ✖ |
...
| Microsoft Entra ID directory synchronization and SSO [integration](zero-trust-access/access-controls/sso/azuread.mdx) | ✔ | ✔ | ✖ |
