...
| [Session Recording Summaries and Session Recording Search](identity-security/session-search.mdx) | ✔ | ✔ | ✖ |
...
| [Hardware Private Key Support](zero-trust-access/authentication/hardware-key-support.mdx) (e.g., via YubiKey) | ✔ (External-connected HSM/KMS coming soon) | ✔ | ✖ |
| [Hardware Security Module support](installation/self-hosted/private-keys/hsm.mdx) for encryption at rest | ✔ (External-connected HSM/KMS coming soon) | ✔ | ✖ |
