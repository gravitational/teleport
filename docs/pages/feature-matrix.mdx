...
The Teleport feature matrix lists capabilities of the Teleport Identity
Infrastructure Platform, organized by product.
...
| [Hardware Private Key Support](zero-trust-access/authentication/hardware-key-support.mdx) (e.g., via YubiKey) | ✔ (External-connected HSM/KMS coming soon) | ✔ | ✖ |
| [Hardware Security Module support](zero-trust-access/deploy-a-cluster/private-keys/hsm.mdx) for encryption at rest | ✔ (External-connected HSM/KMS coming soon) | ✔ | ✖ |
