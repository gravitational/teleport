...
You must know the desired read/write minimum, maximum and target capacity.

Autoscaling configuration can be delegated to Teleport or managed by an AWS Application Auto Scaling policy you create.
