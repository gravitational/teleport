...
See [the SSO documentation](../../enterprise/sso.mdx). Other possible values are `local` and
[`passwordless`](../../access-controls/guides/passwordless.mdx#optional-enable-passwordless-by-default).
Defaults to `local`.
