...
| `chartMode` | Guide |
| - | - |
| `standalone` | [Getting started with Teleport on Kubernetes](../../getting-started/kubernetes-cluster.mdx) |
...
| `chartMode` | Guide |
| - | - |
| `standalone` | [Getting started with Teleport on
Kubernetes](../../getting-started/kubernetes-cluster.mdx) |
| `aws` | [Running an HA Teleport cluster using an AWS EKS Cluster](../helm-deployments/aws.mdx) |
| `gcp` | [Running an HA Teleport cluster using a Google Cloud GKE cluster](../helm-deployments/gcp.mdx) |
| `custom` | [Running a Teleport cluster with a custom config](../helm-deployments/custom.mdx) |
...
`aws` settings are described in the AWS guide: [Running an HA Teleport cluster using an AWS EKS Cluster](../helm-deployments.mdx)
...
<Admonition type="note" title="Installing cert-manager">
  ...
  and the relevant sections of the [AWS](../helm-deployments/aws.mdx#step-47-tls-certificates-for-teleport) and [GCP](../helm-deployments/gcp.mdx#step-47-install-and-configure-cert-manager) guides for more information.
</Admonition>
...
<Admonition type="note" title="Configuring an Issuer">
  ...
  of the [AWS](../helm-deployments/aws.mdx#step-47-tls-certificates-for-teleport) and [GCP](../helm-deployments/gcp.mdx#step-47-install-and-configure-cert-manager) guides for more information.
</Admonition>
