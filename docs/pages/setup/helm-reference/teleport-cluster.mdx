...
`operator` controls whether to start Teleport Operator.

Teleport Operator is a Kubernetes Operator that helps you manage your Teleport Cluster using the Kubernetes API/tools.

It currently supports managing Users and Roles.
