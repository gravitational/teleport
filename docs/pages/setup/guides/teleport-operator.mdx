...
- Kubernetes cluster (with or without `teleport-cluster` already deployed);
...
## Step 1/3. Install teleport-cluster with the operator
...
## Step 2/3. Manage users and roles using `kubectl`
