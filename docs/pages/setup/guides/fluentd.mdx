...
<Tabs>
  ...
  See the Helm chart example under [Step 6/6. Start the event handler plugin](#step-66-start-the-event-handler-plugin) to see how to create `teleport-plugin-event-handler-values.yaml`!
...
Use the following template to create values file:
...
fluentd:
  url: "https://localhost:8888/test.log"
  caPath: "/home/sasha/scripts/event-handler/ca.crt"
  certPath: "/home/sasha/scripts/event-handler/client.crt"
  keyPath: "/home/sasha/scripts/event-handler/client.key"
