...
metadata:
  name: terraform
  # This gives Terraform user an access to all apps and databases in the cluster. You might want to choose a stricter
  # value or remove it if you do not plan to manage your apps and databases via Terraform.
  app_labels:
    '*': '*'
  db_labels: 
    '*': '*'
