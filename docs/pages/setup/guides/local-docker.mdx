...
<Admonition type="tip">
  This setup will not let you 'SSH into' the Docker container that is running Teleport without additional configuration.
</Admonition>
...
You can now [follow this guide from **Step 4** onwards](../../getting-started.mdx#step-44-have-fun-with-teleport) to create your user and log into Teleport.
