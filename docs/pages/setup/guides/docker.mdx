...
<Tabs>
<TabItem scope={["oss","cloud"]} label="Open Source">
...
<TabItem scope={["enterprise"]} label="Commercial">

- Access to the [customer portal](https://dashboard.gravitational.com/web/login) for the Teleport license
- Docker v(=docker.version=) or later. We currently only offer Docker images for
  `x86_64` architectures.
...
$ cp ~/downloads/license.pem ~/teleport/data
