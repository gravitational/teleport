...
If the tag `TeleportHostname` is present, its value will override the node's hostname.
...
- A Teleport cluster running on an AWS EC2 instance For details on setting this up, see [Getting
...
- A Teleport cluster running on an AWS EC2 instance For details on setting this up, see our
...
<Admonition type="note" title="Note">
  Instances that are not running on the [Nitro system](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html#ec2-nitro-instances)
  [will not update tags until they are restarted](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html#work-with-tags-in-IMDS).
</Admonition>
