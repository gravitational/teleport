...
<Admonition
  ...
  title="IMPORTANT"
>
  The data directory used (e.g. `/var/lib/teleport` by default) should be empty prior to launching
  node.  An error will occur if this node had attached by another method, such as IAM and now switching to
  EC2 Joining. 
</Admonition>
