...
teleport:
    ...
    # default, but you can enable them using the diagnosis address. See the Teleport
    # Metrics of the Reference Manual (https://goteleport.com/docs/setup/reference/metrics/)
