...
teleport:
    ...
    # audit log. Several back-end types are supported. See the "Storage backends" (https://goteleport.com/docs/setup/reference/backends)
    ...
    storage:
        ...
        # in an AWS S3 bucket or use GCP Storage with 'gs://'. See the S3 section on "Storage backends" for more information
...
ssh_service:
    ...
    # See explanation of labels in "Labels" page
    ...
    # as node labels.
    # See "Labels" page for more information and more examples
    # (https://goteleport.com/docs/setup/admin/labels).
    commands:
