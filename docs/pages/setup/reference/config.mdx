...
teleport:
    ...
    # Teleport provides HTTP endpoints for monitoring purposes. They are disabled by default
    #, but you can enable them using the diagnosis address. See the Teleport Metrics of the 
    # Reference Manual (https://goteleport.com/docs/setup/reference/metrics/)
