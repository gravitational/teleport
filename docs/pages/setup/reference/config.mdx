...
teleport:
    ...
    # 'stdout', 'stderr' and 'syslog'. Possible severity values are INFO (default), WARN, DEBUG,
    # and ERROR.  ERROR is recommended for the production setting to minimize unnecessary logging.
    log:
