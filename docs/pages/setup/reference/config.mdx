...
auth_service:
    ...
    # Sends the host CAs of all clusters to SSH clients logging in when enabled,
	  # instead of just the host CA for the current cluster. Defaults to false.
    send_all_host_cas: false
