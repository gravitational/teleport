...
Attempts to use unlicensed products will result in a error message and users will be unable to use those products. For example, if you attempt to use database access without it being included in the license, you will get a message similar to:
```code
