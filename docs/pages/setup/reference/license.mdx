...
Teleport Cloud manages the Teleport licensing for customers.  No license file managements is required in Teleport Cloud to manage by a Teleport Customer.
</Admonition>
