...
- `u2f` implements the [U2F](https://en.wikipedia.org/wiki/Universal\_2nd_Factor)
  ...
  [SoloKeys](https://solokeys.com/) or any other hardware token which implements the FIDO U2F standard. See our [Second Factor - U2F](https://goteleport.com/docs/access-controls/guides/u2f/) guide for detailed instructions on setting up U2F for Teleport.
