...
| `teleport_cache_events` | counter | Teleport | Number of events received by a Teleport service cache. |
| `teleport_cache_stale_events` | counter | Teleport | Number of stale events received by a Teleport service cache. A large number of stale events can indicate a degraded backend. |
