...
| `failed_connect_to_node_attempts_total` | counter | Teleport Proxy | Number of failed SSH connection attempts to a node. Used with `teleport_connect_to_node_attempts_total` to get failure rate. |
...
| `teleport_connect_to_node_attempts_total` | counter | Teleport Proxy | Number of SSH connection attempts to a node. Used with `failed_connect_to_node_attempts_total` to get failure rate. |
