...
| `dynamo_api_total` | counter | dynamodb | Number of requests to the DynamoDB api. |
| `dynamo_api_failed_total` | counter | dynamodb |  Number of failed requests to the DynamoDB api. |
| `dynamo_api_request_seconds` | counter | dynamodb | Latency of DynamoDB api requests. |
