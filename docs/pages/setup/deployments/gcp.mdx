...
teleport:
  ...
  # Nodes and other agents can be joined to the cluster via the proxy's public adress.
...
Follow [adding users](../../getting-started/deploy-a-cluster/enterprise.mdx#adding-users) or integrate with [Google Workspace](../../enterprise/sso/google-workspace.mdx) to provide SSO access.
