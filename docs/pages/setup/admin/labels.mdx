...
|[Windows desktops](../../desktop-access/getting-started.mdx)|Dynamic labels are not supported for Windows desktops.|
...
You can use labels to limit the access that different roles have to specific
classes of resources. For more information, see
