---
title: Access Databases with GUI Clients
...
- The Teleport Database Service configured to access a database. See one of our
  [guides](../index.mdx) for how to set up the Teleport
...
If you're using Teleport in [TLS routing](../admin-guides/self-hosting/management/tls-routing.mdx)
