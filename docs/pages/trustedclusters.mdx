...
As explained in the [architecture document](architecture/teleport-architecture-overview.mdx#design-principles),
...
*leaf* cluster "east" to connect to the *root* cluster "main". When this
...
[Example of how to use a cluster join token.](admin-guide.mdx#example-configuration)
