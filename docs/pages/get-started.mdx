...
You can quickly spin up a self-hosted Teleport cluster so you can protect
infrastructure resources in your home lab.

To get started, read [Run a Self-Hosted Demo Cluster](./linux-demo.mdx).
