...
## Step 2/5. Set up Teleport on your Linux host
...
## Step 3/5. Create a Teleport user and set up two-factor authentication
...
## Step 5/5. Add your infrastructure
...
To register a resource with Teleport, visit the Web UI and click the name of a
resource on the sidebar. The Web UI will show you the steps you can take to
register that resource.

![Adding resources](../img/add-resources.png)

In the **Servers** tab, you can see that you have already registered your Linux
server. 
