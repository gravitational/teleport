...
6. Your new API key will be displayed. Make sure to copy it and save it in a file on the system where Teleport Proxy is running, e.g., `/etc/teleport/openai_key`.
