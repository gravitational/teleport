...
The migration process involves transferring configurations, migrating Teleport agents, and ensuring a successful transition with good performance on Teleport Cloud.


## Prerequisites

- An existing self-hosted Teleport Cluster
