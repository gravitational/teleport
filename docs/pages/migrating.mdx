...
To ensure a smooth migration process across your infrastructure, start by cataloging the various services you're managing with Teleport, The following resources should be considered for migration:
