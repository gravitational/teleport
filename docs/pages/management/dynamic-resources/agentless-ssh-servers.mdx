...
description: Use infrastructure-as-code tooling to register Ggentless OpenSSH servers in Teleport.
---
...
And the created Teleport resources:
```code
...
Then, validate it was created with:
