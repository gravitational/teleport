---
title: Secure cluster operations
...
convenience and security that you should take into consideration. Different organizations and industries 
can have different security requirements and accept different levels of risk, so it's important to 
consider the tradeoffs as you make decisions about privileged and unprivileged access to your infrastructure. 

The topics in this section are intended to help you make those decisions based on what's acceptable and 
...
- [Privilege Elevation](./security/privilege-elevation.mdx). Learn about potential risks of allowing privileged 
  access and how to migrate them.
