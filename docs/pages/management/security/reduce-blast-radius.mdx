...
If you have enabled SSO in your Teleport environment, mfa challenges at login will only apply to Teleport local users. The IDP will be responsible for implementing any second factor challenges at login time.
