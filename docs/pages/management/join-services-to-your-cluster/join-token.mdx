...
description: How to join services with your Teleport cluster via a join token
---
...
your cluster by connecting it to the Proxy Service. (This is the only posibility
in Teleport Enterprise Cloud.) Depending on the design of your infrastructure,
you may need to connect your new Teleport process directly to the Auth Service.
