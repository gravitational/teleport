...
If you need help, please ask on our [community forum](https://github.com/gravitational/teleport/discussions). You can also open an [issue on GitHub](https://github.com/gravitational/teleport/issues) or create a ticket through your [Teleport Workspace](https://teleport.sh) or the legacy [customer dashboard](https://dashboard.gravitational.com/web/login).
