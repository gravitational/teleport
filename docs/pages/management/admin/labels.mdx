...
|[Windows desktops](../../desktop-access/introduction.mdx)|Dynamic labels are not supported for Windows desktops. See our [Desktop Access documentation](../../desktop-access/rbac.mdx#labeling) for how to label desktops.|
>>>>>>> ac5a6197ec (change link from getting started to introduction)
