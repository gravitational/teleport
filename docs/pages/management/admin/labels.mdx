...
on your local computer. 
   ...
   1. Locate the `traits` section and update the `logins` field to specify one or more local users that exist 
   on the local host:
   ...
   1. Sign out, then sign back in to the cluster and run `tsh ls`.
