...
reverse-tunnel proxies and enroll and manage thousands of resources without creating a new 
cluster.
...
- Verifies that the certificate signature matches its trusted root cluster.
