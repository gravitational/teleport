...
Yeleport cluster can scale to hundreds of thousands of connected resources.
...
- Cluster `sso.example.com` is the root cluster. This cluster can have its own resources or be 
used for collecting audit logs and authenticating users.
...
- Add and remove trusted clusters.
