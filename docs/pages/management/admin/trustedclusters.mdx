...
reverse tunnel using using the Teleport Proxy Service instance running on the root cluster.

## Who uses trusted clusters?

Most organizations don't need to configure trusted clusters. In most cases, you can add 
reverse-tunnel proxy instances and enroll and manage thousands of resources without creating a new 
cluster.
