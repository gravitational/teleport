...
destinatation for the event handler:
...
![Fluentd example diagram](../../../img/management/fluentd-demo-dia.png)

You can follow the parameters below for a local proof-of-concept demo, or use any
of the additional installation instructions to configure the Teleport Event Hanndler
...
# -rw------- 1 bob bob      260 Jul  1 11:13 teleport-event-handler-v(=teleport.plugin.version=)-darwin-amd64-bin.tar.gz
