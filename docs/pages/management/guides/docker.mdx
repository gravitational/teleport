...
description: In this guide we explain how to run a container using one of Teleport's Docker images and execute commands on that container via Teleport's tsh client.
