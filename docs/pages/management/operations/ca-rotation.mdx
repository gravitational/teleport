...
For more information about configuring group policies to protect access to Windows
Desktops, see [Configure a GPO to allow Teleport 
connections](../../desktop-access/active-directory-manual.mdx#step37-configure-a-GPO-to-allow-Teleport-connections)
</Admonition>
