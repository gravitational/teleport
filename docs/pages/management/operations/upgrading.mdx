...
The Teleport Auth Service and Proxy Service are upgraded automatically within the specified
window. When upgrading resource services, you may upgrade in any sequence or at the same
time.

As documented in the Component compatibility the resource services should be the same major version or
one behind of the Teleport Cloud tenant (Ex: Do not install V12 resources services if Teleport Cloud tenant is V11).
