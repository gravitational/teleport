...
- [SSH servers](../zero-trust-access/server-access/introduction.mdx)
...
- [Applications](../zero-trust-access/enroll-resources/application-access/introduction.mdx)
- [Remote desktops](../zero-trust-access/enroll-resources/desktop-access/introduction.mdx)
