...
description: How to install Teleport using Helm.
---
...
You can also follow our [getting started guide](../admin-guides/deploy-a-cluster/helm-deployments/kubernetes-cluster.mdx) that will walk you through deploying Teleport on a Kubernetes cluster using Helm.
