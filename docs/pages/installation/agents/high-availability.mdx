...
This guide describes how agent high availability works and how to configure it
...
(!docs/pages/includes/database-access/proxy-db-tunnel.mdx db="postgres-us-east-1a"!)
...
auto-discovery](../../enroll-resources/auto-discovery/auto-discovery.mdx).
