...
\[1] *`tsh` is a Command Line Interface (CLI) client and Teleport Connect is a Graphical User Interface (GUI) desktop client. See [Using Teleport Connect](../connect-your-client/teleport-clients/teleport-connect.mdx) for usage and installation.*
