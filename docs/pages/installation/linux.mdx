...
You can also use the example Terraform module for deploying agents in [Deploy Agents with Terraform](../admin-guides/infrastructure-as-code/terraform-starter/enroll-resources.mdx).
