...
<Checkpoint
  ...
  description="Success looks like: `teleport version` displays the expected version number."
>
...
<Checkpoint
  ...
  description="Success looks like: `teleport version` displays the version, and systemctl status shows active (running)."
>
...
<Checkpoint
  ...
  description="Success looks like: echo $ID and echo $VERSION_CODENAME (or $VERSION_ID) return valid values."
>
...
<Checkpoint
  ...
  description="Success looks like: uname -m returns a recognized architecture (x86_64, aarch64, armv7l, or i686)."
>
