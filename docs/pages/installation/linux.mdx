...
1. Follow the instructions for your package manager:
   ...
   # sudo dnf config-manager --add-repo "$(rpm --eval "$(rpm --eval "https://yum.releases.teleport.dev/$ID/$VERSION_ID/Teleport/%{_arch}/${TELEPORT_CHANNEL?}/teleport.repo")"
   # Fedora 41 or later
   $ sudo dnf config-manager addrepo --overwrite --from-repofile="$(rpm --eval "$(rpm --eval "https://yum.releases.teleport.dev/$ID/$VERSION_ID/Teleport/%{_arch}/${TELEPORT_CHANNEL?}/teleport.repo")"
