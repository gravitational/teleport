---
title: Installing Teleport on a Single Machine
sidebar_label: Single Machine
...
Whether you are installing Teleport as a cluster (the Auth Service and Proxy
Service )or as an agent that talks to the cluster, the Teleport binary is the
same. The difference is only in how you [configure
it](../../reference/deployment/config.mdx), which you will need to do after
installation. 

The guides in this section explain how to install the `teleport` binary on a
single machine.

If you want to install client tools on your workstation, visit the [Download
page](https://goteleport.com/download).
...
If you wish to uninstall Teleport at any time, see our documentation on [Uninstalling Teleport](../uninstall-teleport.mdx).
...
- [Machine & Workload Identity](../../machine-workload-identity/introduction.mdx)
