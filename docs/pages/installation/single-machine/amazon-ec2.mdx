...
See the [AWS Single-Instance Deployment](../self-hosted/deployments/aws-starter-cluster-terraform.mdx)
and the [Running Teleport Enterprise in High Availability mode on AWS using Terraform](../self-hosted/deployments/aws-ha-autoscale-cluster-terraform.mdx)
