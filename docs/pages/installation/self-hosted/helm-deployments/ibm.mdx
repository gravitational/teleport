...
In this guide, you will set up a self-hosted Teleport cluster on IBM Cloud.
...
- [Storage: IBM Cloud Databases for PostgreSQL](https://www.ibm.com/products/databases-for-postgresql)
  to store the Teleport cluster state, and the Teleport audit events (see [backends reference](../../../reference/deployment/backends.mdx)
  for more details).
