...
- A running Teleport cluster. For details on how to set this up, see our
  [Getting Started](../../get-started/deploy-community.mdx) guide (skip TLS certificate setup).
...
- A running Teleport cluster. For details on how to set this up, see our Enterprise
  [Getting Started](self-hosted.mdx) guide.
...
- The `tctl` and `tsh` client tools:
  ...
  <Tabs>
    ...
    <TabItem label="Linux">
      ...
      the [installation page](../../installation/single-machine/single-machine.mdx).
...
flag](../../connect-your-client/teleport-clients/teleport-connect.mdx).

## Further reading

- [Configuring Teleport TLS Certs](../../get-started/deploy-community.mdx)
- [Run Teleport as a systemd Daemon](../../reference/cli/teleport.mdx#teleport-install-systemd)
