...
- Teleport's [Proxy Peering](../../../zero-trust-access/management/proxy-peering.mdx) is used to reduce the total number of tunnel connections in the Teleport cluster.
...
- [Teleport Proxy Peering](../../../zero-trust-access/management/proxy-peering.mdx) for reducing the number of resource connections
...
|```*.teleport.example.com```|CNAME|Latency|us-west-1| ```elb.us-west-1.amazonaws.com``` |
|```teleport.example.com```|CNAME|Latency|eu-central-1| ```elb.eu-central-1.amazonaws.com```|
|```*.teleport.example.com```|CNAME|Latency|eu-central-1| ```elb.eu-central-1.amazonaws.com```|
...
teleport:
    ...
    ...
```
Review the [configuration reference](../../../reference/deployment/config.mdx) page for
additional settings.

## Configure Proxy Peering

In this deployment architecture, [Proxy Peering](../../../zero-trust-access/management/proxy-peering.mdx) is used to restrict the number of connections made from
...
```
Reference the [Auth Service configuration](../../../reference/deployment/config.mdx) reference page
...
Reference the [Proxy Service configuration](../../../reference/deployment/config.mdx) reference page
for additional settings.
