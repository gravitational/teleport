...
This guide describes the components of a high-availability Teleport deployment.
...
will enable [TLS Routing](../../../zero-trust-access/management/tls-routing.mdx) in your
Teleport cluster.
...
- [Scaling a Teleport cluster](../../../reference/deployment/scaling.mdx)
- [Monitoring a Teleport cluster](../../../zero-trust-access/management/diagnostics/diagnostics.mdx)
