...
- Multi-region setups do not offer better scalability than single-region setups.
  Due to their distributed and redundant nature, they are less performant and
  more expensive than single-region setups for the same number of agents.
...
[Proxy Peering](../../../zero-trust-access/management/proxy-peering.mdx) to connect users to resources
...
See the [Teleport scaling](../../../reference/deployment/scaling.mdx) page for more
