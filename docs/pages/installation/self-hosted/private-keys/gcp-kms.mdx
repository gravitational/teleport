...
If your Teleport Auth Service runs on a GCE VM, you can attach the service account directly to the VM instance instead of using a JSON key file:

```code
$ gcloud compute instances set-service-account "<Var name="instance-name" description="The name of your GCE VM instance"/>" \
    --service-account=$SERVICE_ACCOUNT \
    --scopes=cloud-platform \
    --zone=<Var name="instance-zone" description="The zone of your GCE VM instance"/>
```
