...
description: Provides a comparison of Teleport Enterprise (Self-Hosted), Teleport Enterprise (Cloud), and Teleport Community Edition.
---
...
Teleport Zero Trust Access provides engineers with just-in-time,
least-privileged access to applications, servers, databases, Kubernetes
clusters, and other resources across distributed infrastructure. Built on a
foundation of cryptographic identity and purpose-built for infrastructure,
Teleport Zero Trust Access uses short-lived credentials to enforcing granular
access policies and Zero-Trust principles.

Teleport Zero Trust Access is available in all Teleport editions, with some
features only available in Teleport Enterprise.
...
Machine & Workload Identity is part of the Teleport Infrastructure Identity
Platform. See [Usage and
Billing](./usage-billing.mdx#machine-and-workload-identities) for how Teleport
calculates usage of this product in addition to Teleport Enterprise usage.
