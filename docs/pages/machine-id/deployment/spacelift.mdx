...
- A GitHub repository where you will store your Terraform configuration. 
- A Spacelift stack you wish to allow access to your Teleport cluster.
...
In the `provider` block, change `proxy.example.com:443` to the host and HTTPS
