...
for a machine or group of machines. Just like a User, a Bot can have roles and
traits.

If multiple machines complete similar tasks, and therefore require the same
access, it is recommended that they share a single Bot identity.
