...
## Step 2/4. Configure `tbot` output
...
the Linux user that Ansible will run as.
...
use the Teleport Proxy with the correct credentials when making connections.
