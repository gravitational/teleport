...
You can see a full example of Terraform commands to run in CI at Hashicorp's GitHub Actions
[tutorial page](https://developer.hashicorp.com/terraform/tutorials/automation/github-actions#review-terraform-plan-workflow).
