...
destinations:
    ...
    - directory:
          ...
          acls: try
      configs:
        # Enables the creation of an SSH Host Certificate for OpenSSL with short-lived machine ID credentials.
        # The principal should be the hostname of the domain be accessed, ensuring that it meets the limits of
        # any limiting predicates defined by the associated role configuration.
        -ssh_host_cert:
           principlals [my.machineid.domain.com]
