...
- [GitHub Actions and SSH](../guides/github-actions.mdx)
- [GitHub Actions and Kubernetes](../guides/github-actions-kubernetes.mdx)
...
spec:
  ...
  github:
    ...
    # allow is an array of rule configurations for what GitHub Action workflows
    # should be allowed to join. All options configured within one allow entry
    # must be satisfied for the GitHub Action run to be allowed to join. Where
    ...
    # - sub
    allow:
      - # repository is full qualified (e.g including the owner) name of a
        # GitHub repository.
        ...
        # whether by comitting or by directly despatching the workflow.
        actor: octocat
...
utilising Teleport Machine ID and GitHub Actions.
