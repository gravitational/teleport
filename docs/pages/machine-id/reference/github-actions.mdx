...
- [Using Machine ID with GitHub Actions](../access-guides/github-actions.mdx): How to
  use Machine ID to SSH into Teleport nodes from GitHub Actions.
- [Using Machine ID with GitHub Actions and Kubernetes](../access-guides/github-actions-kubernetes.mdx):
