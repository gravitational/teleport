...
- An Azure VM you wish to install Machine ID onto with the managed identity
  configured as a user-assigned mnaaged identity.
...
Replace:
- `11111111-1111-1111-1111-111111111111` with the ID of your Azure subscription
- `group1` with the name of the resource group that the VM resides within
