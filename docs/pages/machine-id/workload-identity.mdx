...
- Rich auditing of the issuance of SPIFFE SVIDs.
- Powerful RBAC for limiting access to SPIFFE IDs to specific machines and
  users.
- Easy rotation and management of the SPIFFE CA.
...
cluster acts as a SPIFFE trust domain, with the Auth Server as a certificate
...
- [Solving The Bottom Turtle](https://spiffe.io/pdf/Solving-the-bottom-turtle-SPIFFE-SPIRE-Book.pdf): A great book covering the fundamentals and details of SPIFFE.