...
9.3](https://goteleport.com/docs/changelog/#930=). Older versions of the
Teleport Proxy Server will need to be configured with a dedicated SSH listener:
...
- `destination-dir` is where Machine ID writes user certificates which can be used by applications and tools.
...
- [Machine ID with Web Apps](./guides/webapps.mdx)
