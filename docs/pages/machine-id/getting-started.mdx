...
You will be using the `tbot` binary from the package you download and install.

## Step 2/4. Create Bot User

Before you create a bot user, you need to determine which role you want to assign to it. You can use `tctl` to examine what roles exist on your system.
...
This directory contains private key material, SSH certificates, X.509 certificates, and OpenSSH configuration to make it easy to integrate Machine ID with external tooling.
