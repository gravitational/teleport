...
The new configuration YAML will require a `ssh_host` output that resembles the following, replacing `nodename.my.domain.com` with your own required domain name:
