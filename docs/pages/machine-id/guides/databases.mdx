...
You can use Machine ID to protect your data when machines, like web
applications, access your data as well. With Machine ID you will be able to get
the same short-lived certificates tied to a machine identity that can be
rotated, audited, and controlled with all the familiar Teleport access
controls.
...
[Machine ID Getting Started Guide](../getting-started.mdx)
