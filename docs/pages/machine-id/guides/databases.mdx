...
In this guide, we will demonstrate how to use Machine ID protect and access a
database from a custom application.
...
In the example below, you will create a bot user `app` and assign
