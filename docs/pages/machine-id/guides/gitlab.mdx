...
- A running instance of the Teleport SSH Service registered with
...
your setup.
- A GitLab project to connect to Teleport. This can either be on GitLab's cloud-hosted
...
to create a join token. These tokens define the rules that allow a bot to join
