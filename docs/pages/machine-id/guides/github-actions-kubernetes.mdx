...
spec:
  allow:
    ...
    kubernetes_groups:
      ...
      # requests to your Kubernetes cluster. In a later step, you will bind this
...
subjects:
  - kind: Group
    # Note that this name field matches the group name you provided in the
