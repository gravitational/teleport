...
- A Linux based host that can support Machine ID. This "Machine ID Host" is the host that will be used to create Host Certificates.
...
assign to it. You can use the `tctl` command below from your Machine ID host with TSH access to examine what roles exist
on your system:
