...
actions runners. GitHub Enterprise Server requires
[additional configuration](#github-enterprise-server).
...
runs within a GitHub Enterprise Server instances to authenticate using the
GitHub join method.
...
spec:
  ...
  bot_name: github-demo
  github:
    // Configure `enterprise_server_host` to the host of your GHES instance.
    enterprise_server_host: your.ghes.instance.example.com
    allow:
      - repository: gravitational/example
```

Follow the rest of the instructions above as normal.