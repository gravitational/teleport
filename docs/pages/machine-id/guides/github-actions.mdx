...
- `metadata.name` defines the name of the token.
...
In this guide, both `metadata.name` and `spec.name` are the same value, `github-demo`, however
these can be changed to any name of your choice.
...
----------- ---- ------ ----------------------------------------------
github-demo Bot         01 Jan 00 00:00 UTC (2562047h47m16.854775807s)
```
