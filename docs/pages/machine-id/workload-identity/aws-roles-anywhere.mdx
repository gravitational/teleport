...
The [best practices guide](./best-practices.mdx) has some recommendations for
this.

For the purposes of this guide, we will be granting access to AWS to the
`spiffe://example.teleport.sh/my-workload` identity.
    ...
    "Statement": [
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:PrincipalTag/x509SAN/URI": "spiffe://example.teleport.sh/my-workload"
                },
                "ArnEquals": {
