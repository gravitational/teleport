...
- [Teleport CLI client: `tsh ssh`](../reference/cli-docs.mdx#tsh-ssh) (works on Linux and macOS)
...
12 hours by default. This [TTL](https://en.wikipedia.org/wiki/Time_to_live) can be [configured](../reference/cli-docs.mdx#tctl-users-add)
