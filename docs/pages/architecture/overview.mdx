...
- [Teleport CLI client: `tsh ssh`](../reference/cli/tsh.mdx#tsh-ssh) (works on Linux and macOS)
...
12 hours by default. This [TTL](https://en.wikipedia.org/wiki/Time_to_live) can be [configured](../reference/cli/tctl.mdx#tctl-users-add)
