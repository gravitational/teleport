...
Teleport Proxy instance. This allows Teleport Proxy instances to scale horizontally
without increasing the number of connections created by agents.
...
Agents will check the Teleport cluster's configured tunnel strategy before
attempting to create a reverse tunnel to a Teleport Proxy instance. This
allows an agent to dynamically adjust its behavior accordingly.
