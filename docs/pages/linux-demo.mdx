...
1. Visit the provided URL in order to create your Teleport user.
   ...
   >
     ...
     use [host user creation](zero-trust-access/server-access/guides/host-user-creation.mdx).
...
proxy your infrastructure. Read [Protect Infrastructure with Teleport](zero-trust-access/enroll-resources/agents/agents.mdx) to get started.
