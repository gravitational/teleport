...
- [Integrate your Single Sign-On provider](zero-trust-access/access-controls/sso/sso.mdx): Allow users
  to access infrastructure resources with IdPs like Okta.
- [Use Teleport as an identity provider](zero-trust-access/access-controls/idps/saml-guide.mdx) to
