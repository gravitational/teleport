...
into role-based access control policies within Teleport and your cloud provider.
...
- Enable [Teleport Policy
  integrations](https://goteleport.com/docs/admin-guides/teleport-policy/integrations/integrations/)
  so you can import RBAC rules from AWS, Entra ID, and other sources and
  visualize your entire RBAC configuration in on a single screen. 
