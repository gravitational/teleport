...
## Get started with Teleport Open Source Edition

- Install the open source Teleport Open Source Edition [in 5 minutes](getting-started.mdx).
...
Teleport Enterprise is built around the open-source core of the Teleport Open Source Edition
with the added benefit of easy integration with identity managers for SSO. Both editions now support Role-Based Access Control (RBAC).
...
- [SSO for SSH](enterprise/sso/ssh-sso.mdx) - Overview on how Teleport Enterprise works with external identity providers for Single Sign-On.
