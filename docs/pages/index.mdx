...
- [Issue and govern identities for automated
  systems](enroll-resources/machine-id/introduction.mdx) using Machine ID.
...
- Get started with [Teleport
  Policy](admin-guides/teleport-policy/teleport-policy.mdx).
- Define [Crown Jewels](admin-guides/teleport-policy/crown-jewels.mdx) so you
  can track changes to your most sensitive users and resources.
- Enable [Teleport Policy
  integrations](admin-guides/teleport-policy/integrations/integrations.mdx) so
  you can identify [insecure SSH key
  distributions](admin-guides/teleport-policy/integrations/ssh-keys-scan.mdx), and
