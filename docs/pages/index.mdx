...
<Integrations 
  integrations={[
    ...
    {
      title: 'Okta',
      href: 'https://goteleport.com/docs/identity-governance/okta/',
      iconColor: '#0000001A',
      iconComponent: oktaSvg,
    },
    {
      title: 'Slack',
      href: 'https://goteleport.com/docs/identity-governance/access-request-plugins/',
      iconColor: '#ECB22E1A',
    ...
    {
      title: 'Jenkins',
      href: 'https://goteleport.com/docs/machine-workload-identity/machine-id/deployment/jenkins/',
      iconColor: '#D338331A',
      iconComponent: jenkinsSvg,
    },
    {
      title: 'Snowflake',
      href: 'https://goteleport.com/docs/enroll-resources/database-access/enroll-managed-databases/snowflake/',
      iconColor: '#29B5E81A',
