...
- [Kubernetes Cluster](./try-out-teleport/kubernetes-cluster.mdx): Deploy a
  small-scale Teleport cluster on Kubernetes.
- [Digital Ocean](./try-out-teleport/digitalocean.mdx): Use our 1-Click Digital
  Ocean droplet to set up Teleport quickly.
- [Browser Labs](https://play.instruqt.com/teleport/invite/imz8g1n1xzru): Try
  Teleport using our guided interactive labs.
...
- [Teleport Cloud](./choose-an-edition/teleport-cloud/getting-started.mdx): Try our cloud-hosted version for free.
