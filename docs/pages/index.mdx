...
## Get started with Teleport Community Edition

- Install the open source Teleport Community Edition [in 5 minutes](getting-started.mdx).
...
Teleport Enterprise is built around the open-source core of the Teleport Community Edition
