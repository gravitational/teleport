...
Okta, and Teleport itself can act as an identity provider. Connectivity takes
place through short-lived credentials that Teleport components verify through
