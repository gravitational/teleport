...
You can get started right away with a production-ready Teleport cluster.
...
If you are curious to see how Teleport works, you can [spin up a demo
cluster](./get-started.mdx) on a Linux server. After seeing how your demo
