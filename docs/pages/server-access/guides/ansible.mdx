...
```code
# Set your cluster name (e.g. teleport.example.com or in the form mytenant.teleport.sh for Teleport Enterprise Cloud)
$ CLUSTER=teleport.example.com
$ tsh ls --format=json | jq --arg cluster "$CLUSTER"  '.[].spec.hostname + "." + $cluster' > hosts
```
