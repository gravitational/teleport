...
upon login.  Refer to the [Desktop Access RBAC guide](https://goteleport.com/docs/desktop-access/rbac/#automatic-user-creation)
if looking for instructions on how to create local users in Windows machines.
