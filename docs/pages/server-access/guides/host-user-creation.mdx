...
upon login.  Refer to the [Desktop Access RBAC guide](../desktop-access/rbac.mdx#automatic-user-creation)
if looking for instructions on how to automatically create local users in Windows machines.
