...
Click on it, and select "Open SSH Configuration File..."  
...
Start a Remote Development session by clicking on the Window Indicator again and selecting either "Connect to...". 
