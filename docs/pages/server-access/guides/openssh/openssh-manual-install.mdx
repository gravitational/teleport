...
>
  ...
  Teleport is able to preform many of the steps below automatically.
...
<Admonition
  type="tip"
  title="Upgrading to Teleport 14 and migrating from legacy OpenSSH nodes"
>
  ...
  the above guide to register every OpenSSH node with Teleport that you previously
