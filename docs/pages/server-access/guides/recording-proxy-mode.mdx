...
- A running Teleport cluster. For details on how to set this up, see [Getting
  Started on a Linux Server](../../getting-started/deploy-a-cluster/open-source.mdx).
...
- A running Teleport cluster. For details on setting this up, see our
  [Enterprise getting started guide](../../getting-started/deploy-a-cluster/enterprise.mdx).
