...
discover and enroll compute instances matching configured labels. It will then
...
[Guest attributes](https://cloud.google.com/compute/docs/metadata/manage-guest-attributes#enable_attributes)
