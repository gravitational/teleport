...
description: With a Restricted Session, Teleport allows administrators to specify a policy to manage access to certain resources. Learn how to set up Restricted Sessions.
