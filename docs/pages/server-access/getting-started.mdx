...
## Step 2b. Use tsh to inspect cluster
...
4. `tctl create connector.yaml` (use the `-f` flag to override an existing connector).
...
2. Connect to the cluster using `tsh` to manage and inspect resources.
