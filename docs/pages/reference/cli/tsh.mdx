...
|---|---|---|
|app|*no default* (optional)|App to print information for. Required when logged into multiple apps.|
...
|Argument|Default|Description|
|---|---|---|
|app|*no default* (required)|App name to retrieve credentials for, as shown in `tsh apps ls`. Scoped apps use their scope-qualified name ("/scope::name").|
...
|Argument|Default|Description|
|---|---|---|
|app|*no default* (optional)|App to remove credentials for.|
...
|Argument|Default|Description|
|---|---|---|
|command|*no default* (optional)|AWS command and subcommands arguments that are going to be forwarded to AWS CLI.|
...
|Flag|Default|Description|
|---|---|---|
|`--aws-sso-region`|*no default*|AWS region for SSO. Auto-detected from cluster if not specified.|
...
|Argument|Default|Description|
|---|---|---|
|command|*no default* (optional)|`az` command and subcommands arguments that are going to be forwarded to Azure CLI.|
...
|`--region`|*no default*|Region where the beam should live. If not specified, the closest region is selected.|
...
|Argument|Default|Description|
|---|---|---|
|command|*no default* (required)|Command to execute in the instance.|
|name|*no default* (required)|ID (or UUID) of the beam to target.|
...
|Argument|Default|Description|
|---|---|---|
|name|*no default* (required)|ID (or UUID) of the beam to delete.|
...
|Argument|Default|Description|
|---|---|---|
|dest|*no default* (required)|Destination path to copy, in the form `BEAM_ID:PATH` or `LOCAL_PATH`.|
|src|*no default* (required)|Source path to copy, in the form `BEAM_ID:PATH` or `LOCAL_PATH`.|
...
|Argument|Default|Description|
|---|---|---|
|name|*no default* (required)|ID (or UUID) of the beam to connect to.|
...
|Argument|Default|Description|
|---|---|---|
|db|*no default* (optional)|Print information for the specified database.|
...
|Argument|Default|Description|
|---|---|---|
|db|*no default* (optional)|Database service name to connect to.|
...
|Argument|Default|Description|
|---|---|---|
|command|*no default* (required)|Execute this command on target database services.|
...
|Argument|Default|Description|
|---|---|---|
|db|*no default* (optional)|Database to retrieve credentials for. Can be obtained from 'tsh db ls' output.|
...
|Argument|Default|Description|
|---|---|---|
|db|*no default* (optional)|Database to remove credentials for.|
...
|Flag|Default|Description|
|---|---|---|
|`--allow-app`|*no default*|Allow access to an application.|
|`--allow-db`|*no default*|Allow access to a database.|
|`--allow-git-server`|*no default*|Allow access to a Git server.|
|`--allow-kube-cluster`|*no default*|Allow access to a Kubernetes cluster.|
|`--allow-node`|*no default*|Allow access to an SSH node.|
|`--allow-windows-desktop`|*no default*|Allow access to a Windows desktop.|
|`--bot`|*no default*|Name of a bot allowed to use the delegation session. Repeat to allow multiple bots.|
...
|`--session-ttl`|*no default*|How long the delegation session should remain valid.|
...
|Argument|Default|Description|
|---|---|---|
|command|*no default* (optional)|`gcloud` command and subcommands arguments.|
...
|Argument|Default|Description|
|---|---|---|
|directory|*no default* (optional)|The name of a new directory to clone into.|
|repository|*no default* (required)|Git URL of the repository to clone.|
...
|Argument|Default|Description|
|---|---|---|
|action|*no default* (optional)|Optional action to perform. 'update' to configure the Git repo to proxy Git commands through Teleport. 'reset' to clear Teleport configuration from the Git repo.|
...
|Argument|Default|Description|
|---|---|---|
|command|*no default* (optional)|`gsutil` command and subcommands arguments.|
...
|Argument|Default|Description|
|---|---|---|
|session|*no default* (required)|The ID of the target session.|
...
|Variable|Default|Description|
|---|---|---|
|`TELEPORT_MCP_CLIENT_CONFIG`|*no default*|If specified, update the specified client config, assuming its format. "claude" for default Claude Desktop config, "cursor" for global Cursor MCP servers config, or specify a JSON file path. Can also be set with environment variable TELEPORT_MCP_CLIENT_CONFIG.|
|`TELEPORT_MCP_CONFIG_JSON_FORMAT`|`auto` (one of: `pretty`, `compact`, `auto`, `none`)|Format the JSON file (pretty, compact, auto, none). auto saves in compact if the file is already compact, otherwise pretty. Can also be set with environment variable TELEPORT_MCP_CONFIG_JSON_FORMAT. Default is auto.|

Flags:

|Flag|Default|Description|
|---|---|---|
|`--client-config`|*no default*|If specified, update the specified client config, assuming its format. "claude" for default Claude Desktop config, "cursor" for global Cursor MCP servers config, or specify a JSON file path. Can also be set with environment variable TELEPORT_MCP_CLIENT_CONFIG.|
...
|Argument|Default|Description|
|---|---|---|
|name|*no default* (optional)|Name of the MCP server.|
...
|Argument|Default|Description|
|---|---|---|
|name|*no default* (optional)|Database service name.|
...
|---|---|---|
|`--browser`|*no default*|Set to 'none' to suppress browser opening on login.|
|`--callback-port`|*no default*|Local OAuth callback port. Set this to the exact port registered with the OAuth provider.|
|`--client-id`|*no default*|OAuth client ID for a pre-registered client. When set, dynamic client registration is skipped.|
|`--[no-]client-secret`|`false`|Prompt for the OAuth client secret of a pre-registered confidential client.|
|`--oauth-scope`|*no default*|OAuth scopes to request, separated by commas or spaces. This flag can be specified multiple times.|

Arguments:

|Argument|Default|Description|
|---|---|---|
|name|*no default* (required)|Name of the MCP server.|
...
|Argument|Default|Description|
|---|---|---|
|name|*no default* (optional)|Name of the MCP server. Removes credentials for all MCP servers when omitted.|
...
|Argument|Default|Description|
|---|---|---|
|db|*no default* (optional)|The name of the database to start local proxy for.|
...
|`--labels`|*no default*|List of comma separated labels to filter by labels (e.g. key1=value1,key2=value2).|
|`-n`, `--namespace`|*no default*|Configure the default Kubernetes namespace.|
|`--[no-]all`|`false`|Proxy every Kubernetes cluster the user has access to. Mutually exclusive with --labels, --query, or kube cluster names.|
...
|Argument|Default|Description|
|---|---|---|
|kube-cluster|*no default* (optional)|Name of the Kubernetes cluster to proxy. Check 'tsh kube ls' for a list of available clusters. If not specified, all clusters previously logged in through `tsh kube login` will be used.|
...
|Argument|Default|Description|
|---|---|---|
|app|*no default* (required)|The name of the MCP application to start local proxy for.|
...
|Flag|Default|Description|
|---|---|---|
|`--encoder`|`auto` (one of: `ffmpeg`, `avi`, `auto`)|The video encoder to use.|
...
|---|---|---|
|`-f`, `--format`|`text` (one of: `text`, `json`, `yaml`)|Format output (text, json, yaml).|
|`--kind`|*no default*|Resource kind to search for (node, kube_cluster, kube_resource, db, app, windows_desktop, linux_desktop, user_group, saml_idp_service_provider, aws_ic_account, aws_ic_account_assignment, git_server).  Mutually exclusive with --roles.|
...
|Flag|Default|Description|
|---|---|---|
|`--dirs`|*no default*|Directories to scan. Defaults to /home/ on Linux, /Users/ on macOS, and C:\Users\ on Windows.|
|`--skip-paths`|*no default*|Paths to directories or files to skip. Supports for matching patterns.|
...
|---|---|---|
|`TELEPORT_NO_RESUME`|`false`|Disable SSH connection resumption.|
|`TELEPORT_REQUEST_MODE`|`resource` (one of: `off`, `resource`, `role`)|Type of automatic Access Request to make.|
...
|`-p`, `--port`|*no default*|SSH port on a remote host.|
|`--reason`|*no default*|The purpose of the session.|
|`--request-mode`|`resource` (one of: `off`, `resource`, `role`)|Type of automatic Access Request to make.|
|`--request-reason`|*no default*|Reason for requesting access.|
