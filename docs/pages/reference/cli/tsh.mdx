...
- `<cluster>` - the name of the cluster,  see [Trusted Cluster](../../zero-trust-access/management/admin/trustedclusters.mdx) for more information.
...
# --------- -------------- --------
# grav-00   192.0.2.0:3022 os:linux
# grav-01   192.0.2.2:3022 os:linux
# grav-02   192.0.2.7:3022 os:osx

$ tsh ls -v

# Node Name Node ID                              Address        Labels
# --------- ------------------------------------ -------------- --------
# grav-00   52e3e46a-372f-494b-bdd9-a1d25b9d6dec 192.0.2.0:3022 os:linux
# grav-01   73d86fc7-7c4b-42e3-9a5f-c46e177a29e8 192.0.2.2:3022 os:linux
# grav-02   24503590-e8ae-4a0a-ad7a-dd1865c04e30 192.0.2.7:3022 os:osx
