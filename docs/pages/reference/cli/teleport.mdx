...
- [App](../../zero-trust-access/enroll-resources/application-access/introduction.mdx)
- [Database](../../enroll-resources/database-access/database-access.mdx)
- [Windows Desktop](../../zero-trust-access/enroll-resources/desktop-access/introduction.mdx)
- [Kubernetes](../../zero-trust-access/enroll-resources/kubernetes-access/introduction.mdx)
...
| [App](../../zero-trust-access/enroll-resources/application-access/introduction.mdx) | `app` | Provides access to applications. |
