...
|Argument|Default|Description|
|---|---|---|
|PROFILES|none (optional)|Comma-separated profile names to be exported. Supported profiles: allocs,cmdline,mutex,trace,block,goroutine,heap,profile,threadcreate. Default: goroutine,heap,profile|
