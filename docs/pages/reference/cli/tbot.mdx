...
```code
$ tbot configure application [<flags>]
```
...
```code
$ tbot configure application-proxy [<flags>]
```
...
```code
$ tbot configure application-tunnel [<flags>]
```
...
```code
$ tbot configure database-tunnel [<flags>]
```
...
```code
$ tbot configure kubernetes [<flags>]
```
...
```code
$ tbot configure kubernetes/v2 [<flags>]
```
...
```code
$ tbot configure ssh-multiplexer [<flags>]
```
...
```code
$ tbot configure workload-identity-api [<flags>]
```
...
```code
$ tbot configure workload-identity-aws-roles-anywhere [<flags>]
```
...
```code
$ tbot configure workload-identity-jwt [<flags>]
```
...
```code
$ tbot configure workload-identity-x509 [<flags>]
```
...
```code
$ tbot start application-proxy [<flags>]
```
...
```code
$ tbot start application-tunnel [<flags>]
```
...
```code
$ tbot start database-tunnel [<flags>]
```
...
```code
$ tbot start kubernetes/v2 [<flags>]
```
...
```code
$ tbot start ssh-multiplexer [<flags>]
```
...
```code
$ tbot start workload-identity-api [<flags>]
```
...
```code
$ tbot start workload-identity-aws-roles-anywhere [<flags>]
```
...
```code
$ tbot start workload-identity-jwt [<flags>]
```
...
```code
$ tbot start workload-identity-x509 [<flags>]
```
