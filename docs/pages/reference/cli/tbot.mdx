...
[destination configuration](../machine-workload-identity/machine-id/configuration.mdx#directory).
...
See the [configuration reference](../machine-workload-identity/machine-id/configuration.mdx) for further
...
[preregistered key](../machine-workload-identity/machine-id/bound-keypair/concepts.mdx#onboarding).
