...
| `tbot tpm identify` | Output identifying information related to the TPM detected on the system. |
...
Refer to the [database guide](../../machine-id/access-guides/databases.mdx) for more information on
