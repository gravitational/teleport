...
<Admonition type="note">
  ...
  [Access Controls](../../index.mdx) and ensure that
...
[Machine ID](../../admin-guides/enroll-resources/machine-id/introduction.mdx) is a more secure alternative that
...
See the [Resources Reference](../config-references/resources.mdx) for complete docs on how to build these yaml files.
...
| `--google-legacy`  | Flag to select groups with direct membership filtered by domain (legacy behavior). <br/>Disabled by default. [More info](../../admin-guides/authentication/sso/google-workspace.mdx) |
