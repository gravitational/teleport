...
| `--expires` | never | timestamp | When the lock should automatically expire (e.g. "2025-06-26T08:04:29.904431Z"). |
...
Created a lock with name "fghij".

# Lock with TTL instead of specific expiration time
$ tctl lock --role admins --ttl 30m --message "Scheduled security review"
Created a lock with name "efghijk".
```
...
kind: lock
metadata:
  name: cc015442-efad-4414-936f-d1cbe4dee8d5
  revision: 868edc8d-47d6-437a-868a-b65aa10bf65b
spec:
  created_at: "2025-06-25T23:46:32.732350567Z"
  created_by: security.admin@foo.com
...
```code
% tctl rm locks/93e817ae-c726-4239-998a-4c7531e23e2a
lock "93e817ae-c726-4239-998a-4c7531e23e2a" has been deleted
```
