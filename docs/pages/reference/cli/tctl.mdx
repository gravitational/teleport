...
`tctl` commands execute some operation against a Teleport [dynamic
resource](../../admin-guides/infrastructure-as-code/infrastructure-as-code.mdx).
For example, the following command retrieves Teleport roles in a cluster:
