...
------------------------------------ ------------------------------- -------------------------- ------------- -------- ----------------
00c3a1f7-5f24-47f9-b866-14401fbb5685 teleport-proxy-77df88c69-sbh4b  Proxy                      (=teleport.version=)       none     none
065ab336-1ac2-4314-8b16-32fc06a172a7 server1                         Node                       (=teleport.version=)       unit     (=teleport.version=)
a24d4ad4-ead8-4b15-9ea6-357a5350369e teleport-auth-fb68b5df7-vsrsd   Auth,Discovery             (=teleport.version=)       none     none
```
...
Ping a instance. This is only available through a Auth Service for Self-Hosted.

```code
$ tctl inventory ping 6790729b-c265-4dc3-a6c1-3c206d43d38d
Successfully pinged server "6790729b-c265-4dc3-a6c1-3c206d43d38d" (~77.564473ms).
```
