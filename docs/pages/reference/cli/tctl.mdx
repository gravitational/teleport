...
```
 ...
 Note that newly added Teleport services do not show in the inventory as quickly as other listings. Those can take around 5 minutes
 under regular circumstances to show in inventory counts and around 15 minutes for heavy load.
