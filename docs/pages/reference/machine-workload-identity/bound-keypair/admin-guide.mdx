...
guides:
- [Joining an agent using Bound Keypair](../../../enroll-resources/agents/bound-keypair.mdx)
- [Joining an agent using Bound Keypair Static Keys](../../../enroll-resources/agents/bound-keypair-static-keys.mdx)
