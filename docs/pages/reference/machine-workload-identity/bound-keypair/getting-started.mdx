---
title: Deploying tbot with Bound Keypair Joining
description: "How to install and configure tbot with Bound Keypair Joining"
tags:
 - mwi
 - how-to
...
the [dedicated agent guide](../../../enroll-resources/agents/bound-keypair.mdx).
</Admonition>
