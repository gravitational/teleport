---
title: Telemetry
description: An explanation of the telemetry collected by Machine & Workload Identity
tags:
 - conceptual
 - mwi
---
...
Machine & Workload Identity is an emerging part of the Teleport product and it's
helpful for us to be able to identify the kinds of use-cases people have. This
...
the product in the wild helps us make even more informed decisions and avoid our
decisions being solely influenced by a select few users.
...
If we introduce further events to Machine & Workload Identity's anonymous
telemetry in future, we will abide by the above guidelines and ensure that
changes are explicitly included in changelogs where new information is gathered.
