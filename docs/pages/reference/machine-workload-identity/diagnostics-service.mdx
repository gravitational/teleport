...
running `tbot` process to be queried via HTTP. This page describes the
operations you can use to enable and collect data from the diagnostics service,
and the data you can collect.
