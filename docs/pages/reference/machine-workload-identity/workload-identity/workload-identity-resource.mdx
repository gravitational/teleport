...
This page lists the fields you can configure in the WorkloadIdentity resource,
and describes the predicate language you can use in WorkloadIdentity rules.
