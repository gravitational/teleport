...
- `webauthn` implements the [Web Authentication standard](https://webauthn.guide) for utilizing
  ...
  See our [Harden your Cluster Against IdP Compromises](../../zero-trust-access/access-controls/guides/webauthn.mdx) guide for detailed
...
See [GitHub OAuth 2.0](../../zero-trust-access/access-controls/sso/github-sso.mdx) for details on how to configure it.
