...
Access Requests related to the Access List.  Learn more in the [Reviewing Access
Requests](../../identity-governance/access-lists/reviewing-access-requests.mdx)
and [Access Request
Configuration](../../identity-governance/access-requests/configuration/reviewing.mdx#access-list-owners-as-suggested-reviewers)
guides.
