...
fine-grained control over Kubernetes resources. See [Kubernetes RBAC](../../zero-trust-access/enroll-resources/kubernetes-access/controls.mdx) for more details.
...
See [Kubernetes Resources](../../zero-trust-access/enroll-resources/kubernetes-access/controls.mdx#kubernetes_resources) for more details about the difference between versions.
...
|---|---|
|`app_labels`|[Applications](../../zero-trust-access/enroll-resources/application-access/controls.mdx)|
|`cluster_labels`|[Trusted Clusters](../../admin-guides/management/admin/trustedclusters.mdx)|
|`db_labels`|[Databases](../../zero-trust-access/enroll-resources/database-access/rbac.mdx)|
|`db_service_labels`|[Database Service](../../enroll-resources/database-access/database-access.mdx) instances|
|`kubernetes_labels`|[Kubernetes clusters](../../zero-trust-access/enroll-resources/kubernetes-access/controls.mdx)|
|`node_labels`|[SSH Servers](../../zero-trust-access/server-access/server-access.mdx)|
|`windows_desktop_labels`|[Windows desktops](../../zero-trust-access/server-access/server-access.mdx)|
