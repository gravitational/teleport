...
| `device_trust_mode` | Enforce authenticated device access for users assigned this role (`required`, `required-human`, `optional`, `off`). Applies only to the resources in the roles' allow field. | |
