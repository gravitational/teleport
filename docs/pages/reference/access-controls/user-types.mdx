...
Machine & Worklod Identity provides machines with an identity that can
...
See the [Machine & Workload Identity introduction](../../machine-workload-identity/machine-id/introduction.mdx) for more information.
