...
This table describes current behavior, not a fixed contract: the attributes
Teleport inspects may change in future releases.
...
- Surrounding and repeated whitespace in derived values is collapsed.
...
for roles, RBAC and audit logging - automation that keys on usernames
is unaffected.
