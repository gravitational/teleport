...
Those sub-values must be configured for the agent to connect to its cluster.
...
account](https://docs.aws.amazon.com/eks/latest/userguide/iam-roles-for-service-accounts.html) to be
