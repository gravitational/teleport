...
| Type   | Default value | Required?                                                                                                                             |
|--------|---------------|---------------------------------------------------------------------------------------------------------------------------------------|
| `list` | `See below`   | When the `discovery` chart role is used, `kubernetesDiscovery` is required. |
...
- `types` is a list of types of services to be exposed in Teleport, currently only "app" value is supported, with "db" value planned.
 Default value is "app"
- `namespaces` is a list of namespaces of the Kubernetes cluster to search in. Default value is `*`, which denotes all namespaces.
- `labels` is a list of Kubernetes labels based on which to filter out services. Labels  Default value is `*`: `*` that will match any labels.
