...
This custom resource is used to configure Prometheus to monitor workload running
in Kubernetes. This value can be used if you are using both Prometheus and
prometheus-operator to monitor workload running in the Kubernetes cluster.
