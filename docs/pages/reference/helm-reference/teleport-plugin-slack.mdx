...
The `teleport-plugin-slack` Helm chart is used to configure the Slack Teleport plugin which allows users to receive Access Requests to channels or as direct messages via Slack.
...
Check out the [Slack Helm Chart
documentation](https://github.com/gravitational/teleport-plugins/tree/master/charts/access/slack#prerequisites)
