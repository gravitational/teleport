...
This page lists the values you can configure in the `tbot` Helm chart.

This chart deploys an instance of the [Machine & Workload Identity](../../machine-workload-identity/introduction.mdx) agent,
