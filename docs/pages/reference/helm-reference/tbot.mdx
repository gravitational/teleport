...
This chart deploys an instance of the [MachineID](../../mwi/machine-id/introduction.mdx) agent,
...
- The name of a join token configured for Machine ID and your Kubernetes cluster
  as described in the [Machine ID on Kubernetes guide](../../mwi/machine-id/deployment/kubernetes.mdx)
