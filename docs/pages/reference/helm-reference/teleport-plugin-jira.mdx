...
Name of the Kubernetes secret that contains the credentials for the connection to the Auth Service.
...
Jira token of the bot user to impersonate when sending the Access Request messages. It's only recommended for testing purposes.
