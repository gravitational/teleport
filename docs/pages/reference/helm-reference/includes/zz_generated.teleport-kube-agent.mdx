...
```code
$ kubectl --namespace teleport create secret generic my-jamf-secret --from-literal=jamfClientSecret=<replace-with-actual-secret>
```

<Admonition type="note">
  The key used for the Jamf Pro API Client Secret inside the secret must be `jamfClientSecret`, as in the command above.
</Admonition>
