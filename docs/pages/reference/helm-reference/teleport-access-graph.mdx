...
See [Run Teleport Access Graph on Self-Hosted Clusters with Helm](../../management/dynamic-resources/teleport-operator-standalone.mdx)
for more details.
...
(!docs/pages/reference/helm-reference/includes/zz_generated.teleport-access-graph.mdx!)
