...
`log.watch_log_file` Enables/disables the file shared logger's watching functionality
to reopen the log file if it was renamed or removed. Must be used in conjunction with output set as a file path.
