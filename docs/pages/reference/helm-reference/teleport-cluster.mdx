...
This includes deploying proxies, auth servers, and [kubernetes-access](../../zero-trust-access/enroll-resources/kubernetes-access/introduction.mdx).
...
| `kubernetes_service` | auth `Deployment` | Provides secure access to the Kubernetes<br/>cluster where the Teleport cluster is hosted. | [Enrolling Kubernetes clusters](../../zero-trust-access/enroll-resources/kubernetes-access/introduction.mdx) |
