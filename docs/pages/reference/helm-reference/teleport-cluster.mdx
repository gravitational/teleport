...
[The SSO documentation](../../zero-trust-access/access-controls/sso/sso.mdx) explains how to create
...
[Disabling local auth is required for FedRAMP / FIPS](../../zero-trust-access/access-controls/compliance-frameworks/fedramp.mdx).
