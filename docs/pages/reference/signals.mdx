...
description: You can send following signals to a Teleport process to trigger different functionality. This guide is a reference for the signals you can send.
---
