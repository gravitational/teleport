...
Teleport's `health_check_config` API resource determines which resources will have health checks enabled and what settings will be used for those checks.
