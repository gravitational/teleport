...
h1: Teleport YAML Configuration
---

(!docs/pages/includes/backup-warning.mdx!)

## Complete Teleport YAML
...
(!docs/pages/includes/kube_config.yaml!)
...
- Check out our [Application Access Documentation](../../application-access/introduction.mdx).
- Check out our [Kubernetes Access Documentation](../../kubernetes-access/introduction.mdx).
- Check out our [Database Access Documentation](../../database-access/introduction.mdx).
