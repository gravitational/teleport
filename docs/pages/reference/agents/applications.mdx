...
See our [Azure
CLI](../../admin-guides/enroll-resources/application-access/cloud-apis/azure.mdx) guide
for more information on enabling access to Azure managed identities.

## Next steps

- View access controls [Getting Started](../../admin-guides/access-controls/access-controls-getting-started.mdx)
  and other available [guides](../../index.mdx).
- For full details on how Teleport populates the `internal` and `external`
  ...
  Controls Reference](../rbac/teleport-roles.mdx).
- View access controls [Getting Started](../../admin-guides/access-controls/access-controls-getting-started.mdx)
  and other available [guides](../../index.mdx).
- Learn about using [JWT tokens](../../admin-guides/enroll-resources/application-access/jwt/introduction.mdx) to implement access
  controls in your application.
- Integrate with your identity provider:
  - [OIDC](../../admin-guides/authentication/sso/oidc.mdx)
  - [ADFS](../../admin-guides/authentication/sso/adfs.mdx)
  - [Azure AD](../../admin-guides/authentication/sso/azuread.mdx)
  - [Google Workspace](../../admin-guides/authentication/sso/google-workspace.mdx)
  - [Onelogin](../../admin-guides/authentication/sso/one-login.mdx)
  - [Okta](../../admin-guides/authentication/sso/okta.mdx)
