...
| `dynamic` | database resources created through [dynamic registration](../../admin-guides/enroll-resources/database-access/guides/dynamic-registration.mdx) like `tcl create` command. |
...
[Configuration](../config-references/database-access.mdx) for reference.
...
Tags](../../admin-guides/access-controls/labels/ec2-tags.mdx) for more details.
