...
a local `minikube` cluster, see our [RBAC how-to guide](../../admin-guides/enroll-resources/kubernetes-access/manage-access.mdx).
...
methods](../../index.mdx) and [automatic methods](../../admin-guides/enroll-resources/auto-discovery/kubernetes/overview.mdx) for
