...
Roles not [granting Kubernetes access](../zero-trust-access/enroll-resources/kubernetes-access/introduction.mdx) are
...
see [the `kubernetes_resource` documentation](../zero-trust-access/enroll-resources/kubernetes-access/controls.mdx#kubernetes_resources)
for a complete list).
...
registration](../zero-trust-access/enroll-resources/desktop-access/dynamic-registration.mdx) using
...
See [Database Access Controls](../zero-trust-access/enroll-resources/database-access/rbac.mdx) for more details.
...
See [VNet](../zero-trust-access/enroll-resources/application-access/guides/vnet.mdx) for more details.
