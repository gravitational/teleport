...
spec:
  ...
  #
  # This condition would be satsified by an access request if the `access` role
  ...
  # request after the rule is appled. This field must be set to "reviewed" to
