...
| connector | Authentication connectors for [Single Sign-On](../zero-trust-access/access-controls/sso/sso.mdx) (SSO) for SAML, OIDC and GitHub. |
...
| [login_rule](#login-rules) | A Login Rule, see the [Login Rules guide](../zero-trust-access/access-controls/login-rules/login-rules.mdx) for more info. |
...
See [VNet](../zero-trust-access/vnet.mdx) for more details.
