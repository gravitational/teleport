...
description: This reference guide lists dynamic resources you can manage with Teleport, such as roles, local users, and cluster authentication preferences.
---
