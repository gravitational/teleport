...
the `TeleportOIDCConnector` resource, which you can apply after installing
...
|claims_to_roles|[][object](#claims_to_roles-values)|ClaimsToRoles specifies a dynamic mapping from claims to roles.|
