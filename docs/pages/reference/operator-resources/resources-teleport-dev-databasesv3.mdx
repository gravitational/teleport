...
|endpoint_type|string or integer|EndpointType is the database endpoint type to use. Can be either the string or the integer representation of each option.|
