...
|Field|Type|Description|
|---|---|---|
|cluster_id|string|ClusterID is the ID of the cluster. Required for AlloyDB databases.|
...
|region|string|Region is the GCP region. Required for AlloyDB databases.|
