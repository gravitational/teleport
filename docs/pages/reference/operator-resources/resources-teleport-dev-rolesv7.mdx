...
|claims_to_search_as_roles|[][object](#specallowrequestclaims_to_search_as_roles-items)|ClaimsToSearchAsRoles specifies a mapping from claims (traits) to teleport roles.|
...
### spec.allow.request.claims_to_search_as_roles items
...
|claims_to_search_as_roles|[][object](#specdenyrequestclaims_to_search_as_roles-items)|ClaimsToSearchAsRoles specifies a mapping from claims (traits) to teleport roles.|
...
### spec.deny.request.claims_to_search_as_roles items
