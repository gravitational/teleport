...
|bound_keypair|[object](#specbound_keypair)|BoundKeypair allows the configuration of options specific to the "bound-keypair" join method.|
...
|Field|Type|Description|
|---|---|---|
|joining|[object](#specbound_keypairjoining)|Joining contains parameters related to all join attempts.|
|onboarding|[object](#specbound_keypaironboarding)|Onboarding contains parameters related to initial joining and keypair registration.|
|rotate_on_next_renewal|boolean|RotateOnNextRenewal is a flag that indicates clients should perform a keypair rotation on the next refresh or rejoin attempt. This flag will automatically be set to `false` after a successful rotation.|

### spec.bound_keypair.joining

|Field|Type|Description|
|---|---|---|
|insecure|boolean||
|may_join_until|string||
|total_joins|integer||
|unlimited|boolean||
...
|Field|Type|Description|
|---|---|---|
|initial_join_secret|string||
|initial_public_key|string||
|must_join_before|string||
