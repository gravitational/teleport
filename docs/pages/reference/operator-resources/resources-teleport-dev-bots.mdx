---
title: TeleportBot
description: Provides a comprehensive list of fields in the TeleportBot resource available through the Teleport Kubernetes operator
tocDepth: 3
---
...
This guide is a comprehensive reference to the fields in the `TeleportBot`
