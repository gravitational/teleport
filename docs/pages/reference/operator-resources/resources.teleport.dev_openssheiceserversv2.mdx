...
|cloud_metadata|[object](#cloud_metadata)|CloudMetadata contains info about the cloud instance the server is running on, if any.|
...
|rotation|[object](#rotation)|Rotation specifies server rotation|
...
|schedule|[object](#schedule)|Schedule is a rotation schedule - used in automatic mode to switch between phases.|
...
|Field|Type|Description|
|---|---|---|
|aws|[object](#aws)|AWSInfo contains attributes to match to an EC2 instance.|
