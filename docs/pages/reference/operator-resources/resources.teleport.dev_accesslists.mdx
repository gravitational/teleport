...
|membership_kind|string or integer|membership_kind is the type of owner, either a user or an access list. Can be either the string or the integer representation of each option.|
