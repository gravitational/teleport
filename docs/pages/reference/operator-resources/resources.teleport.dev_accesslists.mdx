...
|member_of|[]string|member_of describes Access Lists that this Access List is an explicit member of.|
...
|owner_of|[]string|owner_of describes Access Lists that this Access List is an explicit owner of.|
