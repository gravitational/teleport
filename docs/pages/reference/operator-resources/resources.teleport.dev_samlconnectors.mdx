...
|assertion_key_pair|[object](#assertion_key_pair)|EncryptionKeyPair is a key pair used for decrypting SAML assertions.|
...
|client_redirect_settings|[object](#client_redirect_settings)|ClientRedirectSettings defines which client redirect URLs are allowed for non-browser SSO logins other than the standard localhost ones.|
...
|signing_key_pair|[object](#signing_key_pair)|SigningKeyPair is an x509 key pair used to sign AuthnRequest.|
