...
|Field|Type|Description|
|---|---|---|
|claims_to_preview_as_roles|[][object](#specallowreview_requestsclaims_to_preview_as_roles-items)|ClaimsToPreviewAsRoles specifies a mapping from claims (traits) to teleport roles.|
...
### spec.allow.review_requests.claims_to_preview_as_roles items
...
|Field|Type|Description|
|---|---|---|
|claims_to_preview_as_roles|[][object](#specdenyreview_requestsclaims_to_preview_as_roles-items)|ClaimsToPreviewAsRoles specifies a mapping from claims (traits) to teleport roles.|
...
### spec.deny.review_requests.claims_to_preview_as_roles items
