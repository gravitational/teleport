...
the `TeleportGithubConnector` resource, which you can apply after installing
...
|teams_to_roles|[][object](#teams_to_roles-values)|TeamsToRoles maps Github team memberships onto allowed roles.|

### `teams_to_roles` values
