...
description: Teleport exposes metrics in Prometheus format to help you monitor the health and performance of your cluster.
---
...
- [Forwarding events with Fluentd](../management/export-audit-events/fluentd.mdx)  
- [Monitor Teleport Audit Events with the Elastic Stack](../management/export-audit-events/elastic-stack.mdx)  
