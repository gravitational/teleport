...
resources. See our [Teleport Resources Reference](../config-references/resources.mdx).

For all available `tctl` commands and flags, see our [CLI Reference](../cli/tctl.mdx).

You can also configure Teleport so that users can log in using an SSO provider.
For more information, see:

- [Single Sign-On](../../admin-guides/authentication/sso/overview.mdx)
...
[CLI Reference](../cli/tctl.mdx).

You can also configure Teleport so that users can log in using GitHub. For more
information, see [GitHub SSO](../../admin-guides/authentication/sso/github-sso.mdx).
