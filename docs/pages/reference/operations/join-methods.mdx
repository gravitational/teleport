...
You must be familiar with the [Teleport Core concepts](../../get-started/core-concepts.mdx)
...
- How to [Join Services with a Secure Token](../../admin-guides/enroll-resources/agents/join-services-to-your-cluster/join-token.mdx).
- [Deploying Machine ID on Linux](../../admin-guides/enroll-resources/machine-id/deployment/linux.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Joining Services via AWS IAM Role](../../admin-guides/enroll-resources/agents/join-services-to-your-cluster/aws-iam.mdx).
- [Deploying Machine ID on AWS](../../admin-guides/enroll-resources/machine-id/deployment/aws.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
[Joining Services via AWS EC2 Identity Document](../../admin-guides/enroll-resources/agents/join-services-to-your-cluster/aws-ec2.mdx).
</Admonition>
...
<Admonition type="note" title="See Also">
- [Joining Services via Azure Managed Identity](../../admin-guides/enroll-resources/agents/join-services-to-your-cluster/azure.mdx).
- [Deploying Machine ID on Azure](../../admin-guides/enroll-resources/machine-id/deployment/azure.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- How to [Join Services with GCP](../../admin-guides/enroll-resources/agents/join-services-to-your-cluster/gcp.mdx).
- [Deploying Machine ID on GCP](../../admin-guides/enroll-resources/machine-id/deployment/gcp.mdx)
</Admonition>
...
typically used with [Machine ID](../../admin-guides/enroll-resources/machine-id/introduction.mdx) to access
Teleport-protected resources in GitHub Actions pipelines.

(!docs/pages/includes/provision-token/github-spec.mdx!)

<Admonition type="note" title="See Also">
- [Deploying Machine ID on GitHub Actions](../../admin-guides/enroll-resources/machine-id/deployment/github-actions.mdx)
</Admonition>

### CircleCI: `circleci`

This join method is typically used with [Machine ID](../../admin-guides/enroll-resources/machine-id/introduction.mdx)
to access Teleport-protected resources in Circle CI pipelines.

(!docs/pages/includes/provision-token/circleci-spec.mdx!)

<Admonition type="note" title="See Also">
- [Deploying Machine ID on Circle CI](../../admin-guides/enroll-resources/machine-id/deployment/circleci.mdx)
</Admonition>
...
This join method is typically used with [MachineID](../../admin-guides/enroll-resources/machine-id/introduction.mdx)
to access Teleport-protected resources in Gitlab CI pipelines.

(!docs/pages/includes/provision-token/gitlab-spec.mdx!)

<Admonition type="note" title="See Also">
- [Deploying Machine ID on GitLab CI](../../admin-guides/enroll-resources/machine-id/deployment/gitlab.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Joining Services via Kubernetes ServiceAccount Token](../../admin-guides/enroll-resources/agents/join-services-to-your-cluster/kubernetes.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Deploying Machine ID on Kubernetes](../../admin-guides/enroll-resources/machine-id/deployment/kubernetes.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Deploying Machine ID on Linux: TPM](../../admin-guides/enroll-resources/machine-id/deployment/linux-tpm.mdx)
</Admonition>