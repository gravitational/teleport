...
- `webauthn` implements the [Web Authentication standard](https://webauthn.guide) for utilizing
  ...
  See our [Second Factor - WebAuthn](../../admin-guides/authentication/webauthn.mdx) guide for detailed
...
See [GitHub OAuth 2.0](../../admin-guides/authentication/sso/github-sso.mdx) for details on how to configure it.
