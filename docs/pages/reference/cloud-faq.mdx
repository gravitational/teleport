...
Paste the recovery codes into a safe location, such as your organization's
password manager. You can use these codes to sign into your account if you lose
