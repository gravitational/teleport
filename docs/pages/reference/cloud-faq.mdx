...
Yes. We recommend Teleport's [event handler plugin](../zero-trust-access/management/export-audit-events/fluentd.mdx) to export Teleport Enterprise Cloud audit events.
