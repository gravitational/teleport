...
- [Custom API clients](../../admin-guides/configure-teleport/api/rbac.mdx)

To read more about managing dynamic resources, see the [Dynamic
Resources](../../admin-guides/configure-teleport/dynamic-resources/overview.mdx) guide.
...
| `record_session` |Defines the [Session recording mode](../monitoring/audit/audit.mdx).|The strictest value takes precedence.|
...
Additionally, roles with version `v5` or higher are required to use [Moderated Sessions](../../admin-guides/access-controls/moderated-sessions.mdx).
...
fine-grained control over Kubernetes resources. See [Kubernetes RBAC](../agents/controls.mdx) for more details.
...
This works by [labeling resources](../../admin-guides/access-controls/labels/labels.mdx) and
...
Check out our
[predicate language](../config-references/predicate-language.mdx)
...
Refer to the [Second Factor - WebAuthn](../../admin-guides/authentication/webauthn.mdx) guide if you
