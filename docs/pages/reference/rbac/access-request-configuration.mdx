...
- [Role requests in commercial Teleport editions](../../admin-guides/access-controls/just-in-time/access-requests/role-requests.mdx)
- [Resource requests in commercial Teleport editions](../../admin-guides/access-controls/just-in-time/access-requests/resource-requests.mdx)
- [Role requests in Teleport Community Edition](../../admin-guides/access-controls/just-in-time/access-requests/oss-role-requests.mdx)
...
Templates](../../admin-guides/access-controls/role-templates.mdx) for more
...
1. Calculate the maximum duration of elevated privileges if the Access Request
   ...
   - The `--max-duration` flag of the [`tsh request
     create`](../cli/tsh.mdx) command (if the
...
[`tsh request create`](../cli/tsh.mdx) and [`tsh request
review`](../cli/tsh.mdx) commands. The format accepted
...
1. Begin with with the base expiration of the Access Request, which a user can
   ...
   create`](../cli/tsh.mdx) command. If this is
...
language](../config-references/predicate-language.mdx).
...
If you [write your own Access Request plugin](../../admin-guides/configure-teleport/api/access-plugin.mdx), the
