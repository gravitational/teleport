...
S3 buckets can be used as storage for the recorded sessions and audit log. 
S3 cannot store the cluster state. This section covers storage of recorded sessions
and storing audit logs including S3 is covered in the [Athena](#Athena) storage backend
section.
