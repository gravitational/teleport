...
--diag-addr=0.0.0.0:3000` The
[http://0.0.0.0:3000/readyz](http://0.0.0.0:3000/readyz) endpoint will
...
port 3000 is not exposed to the public internet.  For other services, continue to use
