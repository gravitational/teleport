...
- `ignore_initiator` - Optionally configures Teleport to ignore uploads with this initiator. This is helpful
  in scenarios where software other than Teleport is initiating multipart uploads in the recordings bucket.
  This should be set to the display name of the initiator you want to ignore.
