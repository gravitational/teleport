...
- Configure all Teleport Auth Services to use DynamoDB backend in the "storage"
  section of `teleport.yaml` as shown below.
- Auth Services must be able to reach DynamoDB and DynamoDB Streams endpoints.
- Deploy up to two Auth Services connected to DynamoDB storage backend.
...
- Configure all Teleport Auth Services to use Firestore backend in the "storage"
  section of `teleport.yaml` as shown below.
- Deploy several Auth Services connected to Firestore storage backend.
- Deploy several proxy nodes.
