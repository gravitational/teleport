...
teleport:
  storage:
    ...
    # Possible values: "on_demand" and "provisioned"
    # default: "on_demand"
...
teleport:
  storage:
    ...
    # Enables either On-Demand or Provisioned billing for the DynamoDB table. Set when Teleport creates the table.
    # If billing_mode is set to "on_demand", read/write capacity and auto_scaling settings will be ignored.
    # Possible values: "on_demand" and "provisioned"
    # default: "on_demand"
    billing_mode: ["on_demand"|"provisioned"]
...
<Admonition
  type="warning"
  title="on_demand with autoscaling"
>
  If `on_demand` is set to true, the settings for read/write capacity and auto scaling will be ignored.
</Admonition>
