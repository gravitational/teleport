...
Because of Kinesis throughput limits, no more than two Auth Service instances (per region) should be used, or it's possible for throttling to occur and for Teleport to not be able to keep up with changes.
