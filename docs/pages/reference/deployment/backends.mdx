...
teleport:
  storage:
    ...
    # The ARN of the Kinesis data stream that is receiving CDC events
    # from the DSQL cluster. Required.
    kinesis_stream_arn: arn:aws:kinesis:us-west-2:123456789012:stream/change-feed-stream-name
    ...
    # The path to an AWS config file. If set, only the specified file
    # will be used as configuration for AWS credentials for DSQL
    # and Kinesis. If unset, the default configuration file is used.
