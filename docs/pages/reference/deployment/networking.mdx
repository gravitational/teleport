...
Direct auth joining is only supported for ssh, kube and windows agents. Application, database, and other discovery-based features are not supported when joining auth directly.
</Admonition>
