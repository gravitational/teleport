...
| scim.create | An upstream IdP issued a SCIM request to create a Teleport User or Access List. |
| scim.delete | An upstream IdP issued a SCIM request to delete a Teleport User or Access List. |
| scim.get | An upstream IdP issued a SCIM request for a specific Teleport User or Access List. |
| scim.list | An upstream IdP issued a SCIM request to list Teleport Users or Access Lists. |
| scim.patch | An upstream IdP issued a SCIM request to update a specific Teleport User or Access List via a patch. |
| scim.update | An upstream IdP issued a SCIM request to update a specific Teleport User or Access List. |
