...
This page lists fields in dynamic resources with equivalents in the static
Teleport configuration file, as well as origin labels that indicate the source
