...
bots, but can also be used to join standard Teleport agents as of Teleport
v18.8. Note that it offers limited benefits for traditional Teleport Agents as
they are still ultimately issued long-lived certificates.
