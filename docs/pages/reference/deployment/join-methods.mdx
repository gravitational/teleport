...
The `bound_keypair` join method can be used for both bots and nodes as of
Teleport v18.8, however it offers limited benefits for traditional Teleport
Agents as they are still ultimately issued long-lived certificates.
