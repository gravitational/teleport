...
<Admonition type="note" title="See Also">
- [Deploying Machine ID with Bound Keypair joining](../machine-workload-identity/machine-id/bound-keypair/getting-started.mdx)
- [Bound Keypair Reference](../machine-workload-identity/machine-id/bound-keypair/bound-keypair.mdx)
</Admonition>
