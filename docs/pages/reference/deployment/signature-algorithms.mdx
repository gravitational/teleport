...
kind of certificate issued by Teleport. This page describes the signature
algorithms that Teleport supports as well as configuration options, and
concludes with troubleshooting advice.
...
The procedure is documented in the [CA rotation guide](../../zero-trust-access/management/security/ca-rotation.mdx).
...
Our [YubiHSM2 guide](../../installation/self-hosted/private-keys/hsm.mdx) recommends
creating an
