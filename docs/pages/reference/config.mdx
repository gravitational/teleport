...
- [Using a CA
  Pin](../zero-trust-access/enroll-resources/agents/join-token.mdx):
...
Further reading:
- [Enhanced Session
  Recording](../zero-trust-access/server-access/guides/bpf-session-recording.mdx):
  Configuring `enhanced_recording`.
- [PAM Integration](../zero-trust-access/server-access/guides/ssh-pam.mdx):
