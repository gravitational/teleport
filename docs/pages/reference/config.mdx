...
auth_service:
    ...
    # Determines the tunnel strategy used by the cluster.
    tunnel_strategy:
      # Possible tunnel strategy types are:
      #
      # "agent_mesh":    The default behavior, where agents will connect to every
      #                  Teleport proxy instance.
      # "proxy_peering": Agents will connect to a subset of proxies and clients
      #                  will be routed between proxies for end to end connectivity
      type: proxy_peering
