...
Teleport Enterprise manages the Auth Service and Proxy Service for you. Instances of
...
<Notice type="tip">
Teleport Enterprise manages the Proxy Service for you, so you do not need
...
<Notice type="tip">
Teleport Enterprise manages the Auth Service for you, so you do not need
to specify these configuration settings.
</Notice>
