...
INFO [CLIENT]    RedirectURL set to "https://teleport.example.com:3080/webapi/github/callback"
kind: github
metadata:
  name: github
spec:
  ...
  display: ""
  redirect_url: https://teleport.example.com:3080/webapi/github/callback
  teams_to_logins:
  - logins:
    - access
    - editor
