...
| Name | Default Value(s) | Allowed Value(s) | Description |
| - | - | - | - |
| `--app` | Currently logged in<br/>Google Cloud application | The name of a Google Cloud<br/>application as listed via `tsh apps ls`. | The Google Cloud application to run<br/>the command against, if logged in<br/> to multiple Google Cloud applications. |
...
| Name | Default Value(s) | Allowed Value(s) | Description |
| - | - | - | - |
| `--app` | Currently logged in<br/>Google Cloud application | The name of a Google Cloud<br/> application as listed via `tsh apps ls`. | The Google Cloud application to run<br/>the command against, if logged in to multiple Google Cloud applications. |
