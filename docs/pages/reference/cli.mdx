...
| `--google-legacy`  | Flag to select groups with direct membership filtered by domain (legacy behavior). <br/>Disabled by default. [More info](../enterprise/sso/google-workspace.mdx#how-teleport-uses-google-workspace-apis) |
