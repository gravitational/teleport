...
|component_features|[object](#speccomponent_features)|component_features represents features supported by this server|
...
### spec.component_features

|Field|Type|Description|
|---|---|---|
|features|[]|features is a list of supported feature identifiers.|
