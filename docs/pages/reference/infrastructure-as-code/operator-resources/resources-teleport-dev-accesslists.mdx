...
|traits|[object](#specgrantstraits)|traits are the traits that are granted to users who are members of the Access List.|
...
|---|---|---|
|roles|[]string|roles are the roles that are granted to users who are members of the Access List.|
|traits|[object](#specowner_grantstraits)|traits are the traits that are granted to users who are members of the Access List.|
