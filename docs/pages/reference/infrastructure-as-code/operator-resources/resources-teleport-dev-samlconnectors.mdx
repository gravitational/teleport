...
sidebar_label: TeleportSAMLConnector
...
|Field|Type|Description|
|---|---|---|
|client_id|string|ClientID is the client ID to use for OAuth client credentials grant.|
|client_secret|string|ClientSecret is the client secret to use for OAuth client credentials grant.|
