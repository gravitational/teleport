...
sidebar_label: TeleportRetrievalModelV1
...
|metadata|object||
|spec|[object](#spec)|RetrievalModel resource definition v1 from Teleport|

### spec

|Field|Type|Description|
|---|---|---|
|bedrock|[object](#specbedrock)|Bedrock indicates that this model uses Amazon Bedrock as the embeddings provider and specifies Bedrock-specific parameters.|
...
|openai|[object](#specopenai)|Openai indicates that this model uses OpenAI as the embeddings provider and specifies OpenAI-specific parameters.|
