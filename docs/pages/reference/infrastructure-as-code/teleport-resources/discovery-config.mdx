...
Discovery Config resource, which you can manage with `tctl`.
...
|locations|GCP locations to search resources for.|[]string|
...
|types|GCP resource types to match: "gke", "gce", "cloudsql".|[]string|
...
Holds the summary of resources discovered for a specific integration.
