...
Contains the history of the discovered summary for an integration. Only the latest 5 iterations are stored in the history. The latest iteration is stored in the end of the list.
...
|Field Name|Description|Type|
|---|---|---|
|summaries|IntegrationSummaries is a list of the discovered summary for an integration.|[][Integration Discovered Summary](#integration-discovered-summary)|
...
|sync_end|Timestamp of when discovering the resources ended.||
|sync_start|Timestamp of when discovering the resources started.||

## Server Iteration History

Contains last iteration summaries for a server.


Example:

```yaml
last_sync: # See description
...
|Field Name|Description|Type|
|---|---|---|
|integration_summaries|Maps an integration to the latest discovery iteration summaries.|map[string][Integration Discovered Summary History](#integration-discovered-summary-history)|
|last_sync|Last_sync is the timestamp when the server last updated the iteration summaries.||
...
|iteration_history|Contains the latest 5 iteration summaries for a given server.|map[string][Server Iteration History](#server-iteration-history)|
