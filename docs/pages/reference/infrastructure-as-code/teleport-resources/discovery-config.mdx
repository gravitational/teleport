...
|Field Name|Description|Type|
|---|---|---|
|exclude|A list of AWS Organizational Unit IDs and children OUs to exclude. Accounts that belong to these OUs, and their children, will be excluded, even if they were included. Only exact matches or wildcard (*) are supported. Optional. If empty, no OUs are excluded.|[]string|
