...
|organization|An AWS Organization matcher for discovering resources accross multiple accounts under an Organization.|[AWSOrganization Matcher](#awsorganization-matcher)|
...
|organizational_units|Contains rules for matchings AWS accounts based on their Organizational Units.|[AWSOrganization Units Matcher](#awsorganization-units-matcher)|

## AWSOrganization Units Matcher
...
|---|---|---|
|assume_role|ARN is the AWS role to assume for database discovery.|[Assume Role](#assume-role)|
|cloud_trail_logs|Configuration settings for collecting AWS CloudTrail logs via an SQS queue.|[Access GraphAWSSync Cloud Trail Logs](#access-graphawssync-cloud-trail-logs)|
|eks_audit_logs||[Access GraphAWSSyncEKSAudit Logs](#access-graphawssynceksaudit-logs)|
...
## Access GraphAWSSync Cloud Trail Logs
...
## Access GraphAWSSyncEKSAudit Logs
...
|Field Name|Description|Type|
|---|---|---|
|aws|A configuration for AWS Access Graph service poll service.|[][Access GraphAWSSync](#access-graphawssync)|
...
|http_proxy_settings|Defines HTTP proxy settings for making HTTP requests. When set, this will set the HTTP_PROXY, HTTPS_PROXY, and NO_PROXY environment variables before running the installation.|[HTTPProxy Settings](#httpproxy-settings)|
...
|aws|A list of matchers for the supported resources in AWS.|[][AWSMatcher](#awsmatcher)|
...
|gcp|A list of matchers for the supported resources in GCP.|[][GCPMatcher](#gcpmatcher)|
