---
title: SAML IdPService Provider V1 Reference
description: Provides a reference of fields within the SAML IdPService Provider V1 resource, which you can manage with tctl.
sidebar_label: SAML IdPService Provider V1
---
...
|spec|The SAML IdP service provider spec.|[SAML IdPService Provider Spec V1](#saml-idpservice-provider-spec-v1)|
