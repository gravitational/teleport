...
{/* Automatically generated from: gen/proto/go/teleport/workloadcluster/v1/workloadcluster_protohybrid.pb.go */}
{/* DO NOT EDIT */}

This page lists the fields you can configure within the
Workload Cluster resource, which you can manage with `tctl`.
