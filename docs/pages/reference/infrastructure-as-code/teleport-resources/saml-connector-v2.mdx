...
|Field Name|Description|Type|
|---|---|---|
|Credentials|Configures authentication for the connector to authenticate against the identity provider for performing ancillary operations, e.g. for standalone Entra SAML connectors to authenticate against MS Graph API.  Types that are valid to be assigned to Credentials: 	*SAMLConnectorSpecV2_Oauth|[is SAML Connector Spec V2_Credentials](#is-saml-connector-spec-v2_credentials)|
...
## is SAML Connector Spec V2_Credentials
