...
{/* Automatically generated from: gen/proto/go/teleport/machineid/v1/bot_instance_protohybrid.pb.go */}
{/* DO NOT EDIT */}

This page lists the fields you can configure within the
Bot Instance resource, which you can manage with `tctl`.
...
|tenant|The tenant ID of the Azure account that the joining entity is a part of.|string|
...
|enterprise|The name of the enterprise that the repository belongs to, if any.|string|
|enterprise_id|The ID of the enterprise that the repository belongs to, if any.|string|
