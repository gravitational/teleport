---
title: Reference for the teleport-container-service-aws Terraform module
sidebar_label: teleport-container-service-aws
description: This page describes the teleport-container-service-aws Terraform module.
page_type: reference
tags:
...
{/*
    ...
    Instead, edit integrations/terraform-modules/teleport/container-service/aws/README.md
    Then, regenerate the docs with `make -C integrations/terraform-modules docs`.
*/}

This page lists the input fields and output values of the teleport-container-service-aws
Terraform module.

Source Code: [github.com/gravitational/teleport/tree/master/integrations/terraform-modules/teleport/container-service/aws](https://github.com/gravitational/teleport/tree/master/integrations/terraform-modules/teleport/container-service/aws)
