...
[View the teleport-agent-aws module source code on GitHub](https://github.com/gravitational/teleport/tree/master/integrations/terraform-modules/teleport/agent/aws).
