...
[View the teleport-discovery-azure module source code on GitHub](https://github.com/gravitational/teleport/tree/master/integrations/terraform-modules/teleport/discovery/azure).
