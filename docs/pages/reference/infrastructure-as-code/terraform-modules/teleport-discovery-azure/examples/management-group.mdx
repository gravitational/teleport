...
[View the management-group example source code for the teleport-discovery-azure module on GitHub](https://github.com/gravitational/teleport/tree/master/integrations/terraform-modules/teleport/discovery/azure/examples/management-group).

```hcl
################################################################################
# teleport/discovery/azure/examples/management-group/main.tf
################################################################################
...
################################################################################
# teleport/discovery/azure/examples/management-group/outputs.tf
################################################################################
...
################################################################################
# teleport/discovery/azure/examples/management-group/versions.tf
################################################################################
