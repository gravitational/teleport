...
| sftp | Remote file copy has been executed. The following fields will be logged: `{"user": "alice@example.com", "path": "/path/to/file.txt", "working_directory": "/home/ubuntu", "action": 1 }` |
