...
- [Forwarding events with Fluentd](../../zero-trust-access/management/export-audit-events/fluentd.mdx)  
- [Monitor Teleport Audit Events with the Elastic Stack](../../zero-trust-access/management/export-audit-events/elastic-stack.mdx)  
