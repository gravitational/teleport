...
You can use
[Enhanced Session Recording with BPF](../../../admin-guides/enroll-resources/server-access/guides/bpf-session-recording.mdx)
...
[Athena](../../operations/backends.mdx), [DynamoDB](../../operations/backends.mdx) or
[Firestore](../../operations/backends.mdx) chapters for information on how to
...
[Teleport Configuration Reference](../../config-references/config.mdx).
...
read [Exporting Teleport Audit Events](../../../index.mdx).
...
Teleport can store the recorded sessions in an [AWS S3 bucket](../../operations/backends.mdx)
