...
- [Deploying Machine & Workload Identity on Linux](../machine-workload-identity/machine-id/deployment/linux.mdx)
</Admonition>
...
- [Deploying Machine & Workload Identity on AWS](../machine-workload-identity/machine-id/deployment/aws.mdx)
</Admonition>
...
- [Deploying Machine & Workload Identity on Azure](../machine-workload-identity/machine-id/deployment/azure.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Deploying Machine & Workload Identity on Azure DevOps](../machine-workload-identity/machine-id/deployment/azure-devops.mdx)
</Admonition>
...
- [Deploying Machine & Workload Identity on GCP](../machine-workload-identity/machine-id/deployment/gcp.mdx)
</Admonition>
...
typically used with [Machine & Workload Identity](../machine-workload-identity/machine-id/introduction.mdx) to access
Teleport-protected resources in GitHub Actions pipelines.

(!docs/pages/includes/provision-token/github-spec.mdx!)

<Admonition type="note" title="See Also">
- [Deploying Machine & Workload Identity on GitHub Actions](../machine-workload-identity/machine-id/deployment/github-actions.mdx)
</Admonition>

### CircleCI: `circleci`

This join method is typically used with [Machine & Workload Identity](../machine-workload-identity/machine-id/introduction.mdx)
to access Teleport-protected resources in Circle CI pipelines.

(!docs/pages/includes/provision-token/circleci-spec.mdx!)

<Admonition type="note" title="See Also">
- [Deploying Machine & Workload Identity on Circle CI](../machine-workload-identity/machine-id/deployment/circleci.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Deploying Machine & Workload Identity on GitLab CI](../machine-workload-identity/machine-id/deployment/gitlab.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Deploying Machine & Workload Identity on Kubernetes](../machine-workload-identity/machine-id/deployment/kubernetes.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Deploying Machine & Workload Identity on Kubernetes with OIDC](../machine-workload-identity/machine-id/deployment/kubernetes-oidc.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Deploying Machine & Workload Identity on Linux: TPM](../machine-workload-identity/machine-id/deployment/linux-tpm.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Deploying Machine & Workload Identity on Bitbucket Pipelines](../machine-workload-identity/machine-id/deployment/bitbucket.mdx)
</Admonition>
