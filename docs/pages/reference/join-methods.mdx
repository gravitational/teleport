...
- [Deploying Machine ID on Linux](../mwi/machine-id/deployment/linux.mdx)
</Admonition>
...
- [Deploying Machine ID on AWS](../mwi/machine-id/deployment/aws.mdx)
</Admonition>
...
- [Deploying Machine ID on Azure](../mwi/machine-id/deployment/azure.mdx)
</Admonition>
...
- [Deploying Machine ID on GCP](../mwi/machine-id/deployment/gcp.mdx)
</Admonition>
...
typically used with [Machine ID](../mwi/machine-id/introduction.mdx) to access
Teleport-protected resources in GitHub Actions pipelines.

(!docs/pages/includes/provision-token/github-spec.mdx!)

<Admonition type="note" title="See Also">
- [Deploying Machine ID on GitHub Actions](../mwi/machine-id/deployment/github-actions.mdx)
</Admonition>

### CircleCI: `circleci`

This join method is typically used with [Machine ID](../mwi/machine-id/introduction.mdx)
to access Teleport-protected resources in Circle CI pipelines.

(!docs/pages/includes/provision-token/circleci-spec.mdx!)

<Admonition type="note" title="See Also">
- [Deploying Machine ID on Circle CI](../mwi/machine-id/deployment/circleci.mdx)
</Admonition>
...
This join method is typically used with [MachineID](../mwi/machine-id/introduction.mdx)
to access Teleport-protected resources in Gitlab CI pipelines.

(!docs/pages/includes/provision-token/gitlab-spec.mdx!)

<Admonition type="note" title="See Also">
- [Deploying Machine ID on GitLab CI](../mwi/machine-id/deployment/gitlab.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Deploying Machine ID on Kubernetes](../mwi/machine-id/deployment/kubernetes.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Deploying Machine ID on Linux: TPM](../mwi/machine-id/deployment/linux-tpm.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Deploying Machine ID on Bitbucket Pipelines](../mwi/machine-id/deployment/bitbucket.mdx)
</Admonition>
