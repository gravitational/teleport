...
The EC2 join method is not available in Teleport Enterprise and Teleport
Team. Teleport Enterprise and Team customers can use the [IAM join
...
can be used with any Teleport cluster, including Teleport Enterprise.
