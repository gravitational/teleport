...
- How to [Join Services with a Secure Token](../zero-trust-access/enroll-resources/agents/join-token.mdx).
...
<Admonition type="note" title="See Also">
- [Joining Services via AWS IAM Role](../zero-trust-access/enroll-resources/agents/aws-iam.mdx).
...
<Admonition type="note" title="See Also">
[Joining Services via AWS EC2 Identity Document](../zero-trust-access/enroll-resources/agents/aws-ec2.mdx).
</Admonition>
...
<Admonition type="note" title="See Also">
- [Joining Services via Azure Managed Identity](../zero-trust-access/enroll-resources/agents/azure.mdx).
...
<Admonition type="note" title="See Also">
- How to [Join Services with GCP](../zero-trust-access/enroll-resources/agents/gcp.mdx).
...
<Admonition type="note" title="See Also">
- [Joining Services via Kubernetes ServiceAccount Token](../zero-trust-access/enroll-resources/agents/kubernetes.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- How to [Join Services with Oracle Cloud](../zero-trust-access/enroll-resources/agents/oracle.mdx).
</Admonition>
