...
This includes deploying proxies, auth servers, and [kubernetes-access](../../../admin-guides/enroll-resources/kubernetes-access/introduction.mdx).
See the [Teleport HA Architecture page](../../../admin-guides/self-hosting/deploy-a-cluster/high-availability.mdx)
for more details.
...
| `kubernetes_service` | auth `Deployment` | Provides secure access to the Kubernetes<br/>cluster where the Teleport cluster is hosted. | [Kubernetes Access documentation](../../../admin-guides/enroll-resources/kubernetes-access/introduction.mdx) |
...
| - | - | - |
| `standalone` | Runs by relying only on Kubernetes resources. | [Getting Started - Kubernetes](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/kubernetes-cluster.mdx) |
| `aws` | Leverages AWS managed services to store data. | [Running an HA Teleport cluster using an AWS EKS Cluster](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/aws.mdx) |
| `gcp` | Leverages GCP managed services to store data. | [Running an HA Teleport cluster using a Google Cloud GKE cluster](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/gcp.mdx) |
| `azure` | Leverages Azure managed services to store data. | [Running an HA Teleport cluster using a Microsoft Azure AKS cluster](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/azure.mdx) |
| `scratch` (v12 and above) | Generates empty Teleport configuration. User must pass their own config. This is discouraged, use `standalone` mode with [`auth.teleportConfig`](#authteleportconfig) and [`proxy.teleportConfig`](#proxyteleportconfig) instead. | [Running a Teleport cluster with a custom config](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/custom.mdx) |

<Admonition type="note" title="Custom mode removal">
`custom` mode has been removed in Teleport version 12. See the [version 12
migration guide](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/migration-v12.mdx) for
more information.
</Admonition>
...
See the [PROXY Protocol security section](../../../admin-guides/common-operations/security/proxy-protocol.mdx) for more details.
...
[The SSO documentation](../../../admin-guides/authentication/sso/overview.mdx) explains how to create
...
- [`local`](../../operations/users.mdx) for local users
- [`passwordless`](../../../admin-guides/authentication/passwordless.mdx) to enable by
...
[Disabling local auth is required for FedRAMP / FIPS](../../operations/compliance-frameworks/fedramp.mdx).
...
See [the locking modes documentation](../../../admin-guides/access-controls/locking.mdx) for more
details.
...
[Can be used to forbid passwordless access to your cluster](../../../admin-guides/authentication/passwordless.mdx)
...
See [Second Factor - WebAuthn](../../../admin-guides/authentication/webauthn.mdx) for more details.
...
For possible values, [see the Teleport Configuration Reference](../config.mdx).
...
See our [installation guide](../../../get-started/download-install/installation.mdx) for information on
...
[PSP removal guide](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/migration-kubernetes-1-25-psp.mdx).
...
| `chartMode`  | Guide                                                                                                              |
|--------------|--------------------------------------------------------------------------------------------------------------------|
| `standalone` | [Getting Started - Kubernetes](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/kubernetes-cluster.mdx)            |
| `aws`        | [Running an HA Teleport cluster using an AWS EKS Cluster](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/aws.mdx)         |
| `gcp`        | [Running an HA Teleport cluster using a Google Cloud GKE cluster](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/gcp.mdx) |
| `azure`      | [Running an HA Teleport cluster using a Microsoft Azure AKS cluster](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/azure.mdx) |
| `scratch`    | [Running a Teleport cluster with a custom config](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/custom.mdx)              |
...
`aws` settings are described in the AWS guide: [Running an HA Teleport cluster using an AWS EKS Cluster](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/aws.mdx)
...
The requirements are described in [the Athena backend documentation](../../operations/backends.mdx)
...
`aws.accessMonitoring` configures the [Access Monitoring](../../../admin-guides/access-monitoring.mdx)
feature of the Auth Service.

Using this features requires setting up specific AWS infrastructure as described
in [the AccessMonitoring configuration section](../../../admin-guides/access-monitoring.mdx).
...
`gcp` settings are described in the GCP guide: [Running an HA Teleport cluster using a Google Cloud GKE cluster](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/gcp.mdx)

## `azure`

`azure` settings are described in the Azure guide: [Running an HA Teleport cluster using a Microsoft Azure AKS cluster](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/azure.mdx)
...
<Admonition type="note" title="Installing cert-manager">
  ...
  and the relevant sections of the [AWS](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/aws.mdx) and [GCP](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/gcp.mdx) guides for more information.
</Admonition>
...
<Admonition type="note" title="Configuring an Issuer">
  ...
  of the [AWS](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/aws.mdx) and [GCP](../../../admin-guides/self-hosting/deploy-a-cluster/helm-deployments/gcp.mdx) guides for more information.
</Admonition>
...
See the [Teleport config file reference](../config.mdx) for more details on possible values for `extra_fields`.
