...
- [Dynamic Impersonation](../../admin-guides/access-controls/impersonation.mdx)
- [RBAC for sessions](../rbac/teleport-roles.mdx)
...
See some [examples](../cli.mdx) of the different ways you can filter resources.
...
[reference page](../rbac/teleport-roles.mdx)
