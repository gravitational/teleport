...
See the [OpenSSH client](../../admin-guides/enroll-resources/server-access/openssh/openssh.mdx) guide for details on
how it's configured.
...
- See [migration guide](../../admin-guides/self-hosting/management/tls-routing.mdx) to learn how to
