...
(!docs/pages/includes/reference/code-blocks/tls-routing-conn-upgrade-test-command.mdx!)

For a successful upgrade, the server should return "101 Switching Protocols"
with an empty response:
(!docs/pages/includes/reference/code-blocks/tls-routing-conn-upgrade-test-result.mdx!)
