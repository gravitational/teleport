...
For those cases, Teleport Proxy can terminate live connections using [session and identity locking](../../admin-guides/access-controls/locking.mdx).
</Notice>
...
[short-lived tokens or cloud identity services](../../admin-guides/enroll-resources/agents/join-services-to-your-cluster/join-token.mdx).
...
Take a look at the [Certificate Rotation Guide](../../admin-guides/common-operations/ca/ca-rotation.mdx) to
...
cluster certificates, use node [session and identity locking](../../admin-guides/access-controls/locking.mdx).
</Notice>
