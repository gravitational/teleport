...
OpenSSH certificates contain metadata used to authenticate users and hosts:
...
previously-issued certificates for nodes or users regardless of expiry and issuing new ones,
