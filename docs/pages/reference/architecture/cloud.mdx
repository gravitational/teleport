...
Customers can configure [External Audit Storage](../../admin-guides/common-operations/external-audit-storage.mdx) to store audit logs and session recordings in their
