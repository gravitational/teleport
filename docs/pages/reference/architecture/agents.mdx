...
Services to your Teleport Cluster](../../zero-trust-access/enroll-resources/agents/agents.mdx)
...
Service](../../zero-trust-access/enroll-resources/agents/join-token.mdx).
...
- [Applications](../../zero-trust-access/enroll-resources/application-access/guides/guides.mdx)
- [Cloud provider APIs](../../zero-trust-access/enroll-resources/application-access/cloud-apis/cloud-apis.mdx)
- [Databases](../../zero-trust-access/enroll-resources/database-access/guides/guides.mdx)
- [Kubernetes clusters](../../zero-trust-access/enroll-resources/kubernetes-access/register-clusters/register-clusters.mdx)
- [Linux hosts with Teleport](../../zero-trust-access/server-access/getting-started.mdx)
- [OpenSSH servers](../../zero-trust-access/server-access/openssh/openssh.mdx)
- [Windows desktops](../../zero-trust-access/enroll-resources/desktop-access/getting-started.mdx)
...
|---|---|
|`tsh proxy app`|HTTP and [TCP](../../zero-trust-access/enroll-resources/application-access/guides/tcp.mdx) applications|
|`tsh proxy aws`|[AWS SDK applications](../../zero-trust-access/enroll-resources/application-access/cloud-apis/aws-console.mdx)|
|`tsh proxy azure`|[Azure SDK applications](../../zero-trust-access/enroll-resources/application-access/cloud-apis/azure.mdx)|
|`tsh proxy gcloud`|[Google Cloud SDK applications](../../zero-trust-access/enroll-resources/application-access/cloud-apis/google-cloud.mdx)|
|`tsh proxy ssh`|[OpenSSH client traffic](../../zero-trust-access/server-access/openssh/openssh-agentless.mdx)|
...
- For instructions on deploying agents, see the [Teleport Agent
  guides](../../zero-trust-access/enroll-resources/agents/agents.mdx).
