...
- **[Teleport Proxy Service](proxy.mdx):** A stateless service
  ...
  `example.teleport.sh`.
- **[Teleport Auth Service](authentication.mdx):** Serves as the
...
Services to your Teleport Cluster](../../admin-guides/enroll-resources/agents/join-services-to-your-cluster/overview.mdx)
...
- [Cloud provider APIs](../../index.mdx)
- [Databases](../../index.mdx)
- [Kubernetes clusters](../../index.mdx)
- [Linux hosts with Teleport](../../admin-guides/enroll-resources/server-access/getting-started.mdx)
- [OpenSSH servers](../../index.mdx)
- [Windows desktops](../../admin-guides/enroll-resources/desktop-access/getting-started.mdx)
...
[Issuing User Certificates](authentication.mdx) for more details
...
|---|---|
|`tsh proxy app`|HTTP and [TCP](../../admin-guides/enroll-resources/application-access/guides/tcp.mdx) applications|
|`tsh proxy aws`|[AWS SDK applications](../../admin-guides/enroll-resources/application-access/cloud-apis/aws-console.mdx)|
|`tsh proxy azure`|[Azure SDK applications](../../admin-guides/enroll-resources/application-access/cloud-apis/azure.mdx)|
|`tsh proxy gcloud`|[Google Cloud SDK applications](../../admin-guides/enroll-resources/application-access/cloud-apis/google-cloud.mdx)|
|`tsh proxy ssh`|[OpenSSH client traffic](../../admin-guides/enroll-resources/server-access/openssh/openssh.mdx)|
|`tsh proxy db`|[Native database clients](../../connect-your-client/gui-clients.mdx)|
|`tsh proxy kube`|[Kubernetes clusters behind L7 load balancers](tls-routing.mdx)|
...
Reference](../monitoring/audit/audit.mdx).

## Further reading

- For instructions on deploying agents, see the [Teleport agent
  guides](../../admin-guides/enroll-resources/agents/introduction.mdx).
