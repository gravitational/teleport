...
This page describes the architecture of Teleport Agents.
...
Services to your Teleport Cluster](../../installation/agents/agents.mdx)
...
Service](../../installation/agents/join-token.mdx).
...
[Teleport Connect](../../connect-your-client/teleport-clients/teleport-connect.mdx) runs `tshd`, a
...
- [The `tsh` CLI](../../connect-your-client/teleport-clients/tsh.mdx)
- [Teleport Connect](../../connect-your-client/teleport-clients/teleport-connect.mdx)
- [Teleport Web UI](../../connect-your-client/teleport-clients/web-ui.mdx)
...
|`tsh proxy db`|[Native database clients](../../connect-your-client/third-party/gui-clients.mdx)|
...
- For instructions on deploying agents, see the [Teleport Agent
  guides](../../installation/agents/agents.mdx).
