...
description: This chapter explains how Teleport Managed Agent Updates work.
---
...
Teleport managed agent update exist in two versions:
...
[Configure automatic updates v2](../../upgrading/automatic-agent-updates.mdx).
