...
This page describes the background of Managed Updates and provides a comparison
...
it can make more complex decisions such as gradually rolling out an update, or
...
[Configure Managed Updates v2](../../upgrading/agent-managed-updates/agent-managed-updates.mdx) in your cluster.

Consult the [Managed Updates v2 Resource Reference](../deployment/managed-updates-v2.mdx)
