...
[Enhanced Session Recording](../../zero-trust-access/server-access/guides/bpf-session-recording.mdx)
instead.
...
- [Recording Proxy Mode](../../zero-trust-access/server-access/guides/recording-proxy-mode.mdx)
