...
[trusted clusters](../../admin-guides/access-controls/trustedclusters.mdx) with their own
...
See the [reference](../monitoring/audit/audit.mdx) to learn how to
...
specified by the `audit_sessions_uri` field in the `teleport.yaml` [configuration file](../config-references/config.mdx).
...
- [SSH recording modes](../monitoring/audit/audit.mdx)
- [Desktop Access recording](../../admin-guides/enroll-resources/desktop-access/sessions.mdx)
