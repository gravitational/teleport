...
Auth Server ensures that the value within the certificate and in the database
...
Auth Server using its previous client certificate, and the Bot Instance ID is
