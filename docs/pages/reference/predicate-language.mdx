...
description: Teleport's predicate language defines conditions for filtering in dynamic configuration resources. Learn how to use Teleport's predicate language.
---
