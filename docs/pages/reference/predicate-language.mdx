...
resources](#scoping-allowdeny-rules-in-role-resources). The following objects
are always available:

| Field    | Meaning                                                     | Example                                           |
|----------|-------------------------------------------------------------|---------------------------------------------------|
| user     | User that created the session                               | `contains(user.spec.traits["teams"], "alpha")`    |
| resource | Resource that this session connects to (server or database) | `equals(resource.metadata.labels["env"], "prod")` |
