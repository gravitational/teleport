...
<Admonition type="note">
On Teleport version below v17, Teleport does not count agents and will consider
the group done after an hour. This behaviour changes in v18 with the introduction
of `autoupdate_agent_report` resources.
</Admonition>
