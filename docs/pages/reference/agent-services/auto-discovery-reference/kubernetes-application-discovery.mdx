...
contain full rewrite configuration in YAML format, same as one would use when configuring an app with dynamic registration syntax (see [documentation](../../../zero-trust-access/enroll-resources/application-access/guides/connecting-apps.mdx)).
