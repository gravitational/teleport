...
Teleport Enterprise automatically configures the Teleport Proxy Service
...
proxy_service:
  ...
  mysql_public_addr: "example.teleport.sh:3036"
  # Address advertised to PostgreSQL clients.
  postgres_public_addr: "example.teleport.sh:443"
  # Address advertised to Mongo clients. If not set, public_addr is used.
  mongo_public_addr: "mongo.teleport.example.com:443
```
