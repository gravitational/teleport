...
| `dynamic` | database resources created through [dynamic registration](../../../zero-trust-access/enroll-resources/database-access/guides/dynamic-registration.mdx) like `tcl create` command. |
