...
Lists available databases and their connection information. Displays only the
databases a user has access to (see
[RBAC](../../../enroll-resources/database-access/rbac.mdx)).
