...
app_service:
  ...
  # session information. Wildcard must be allowed for "app_labels" by your role
  # to access this MCP server.
...
<Admonition type="tip">
In most cases, you do not to craft or run `tsh mcp connect`. Instead, use
`tsh mcp config` to print sample configurations or update your AI tools
directly.
</Admonition>
