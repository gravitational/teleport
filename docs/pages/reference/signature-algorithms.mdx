...
The procedure is documented in the [CA rotation guide](../zero-trust-access/management/operations/ca-rotation.mdx).
...
Our [YubiHSM2 guide](../zero-trust-access/deploy-a-cluster/hsm.mdx) recommends
creating an
