...
The Podman, Docker and Kubernetes attestors can be extended to attest
signatures of the workload container image using the Sigstore attestor.

See the [Sigstore Workload Attestation](./sigstore-attestation.mdx) reference
