...
See the available [guides](../../index.mdx) for all supported configurations.
...
[Proxy Configuration](../config-references/database-access.mdx) for
more details.
...
[configuration file](../config-references/database-access.mdx)
...
See [labels reference](../agents/database-labels.mdx) for a full list of Teleport
