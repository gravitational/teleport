...
look at [Using OpenSSH Guide](../../admin-guides/enroll-resources/server-access/openssh/openssh.mdx).

## Can I connect to nodes behind a firewall?

Yes, Teleport supports reverse SSH tunnels out of the box. To configure
behind-firewall clusters, see [Configure Trusted Clusters](../../admin-guides/access-controls/trustedclusters.mdx).
...
[Adding Nodes to the
Cluster](../../admin-guides/enroll-resources/agents/join-services-to-your-cluster/join-token.mdx).
...
Yes, Teleport supports [Headless WebAuthn authentication](../../admin-guides/authentication/headless.mdx),
...
Please refer to our [Networking](../operations/networking.mdx) guide.

## Does Teleport support authentication via OIDC, SAML, or Active Directory?

Teleport offers this feature for the [Enterprise Cloud](../../index.mdx) and [Enterprise](../../admin-guides/self-hosting/introduction.mdx) versions of Teleport.

## Does Teleport support provisioning users via SCIM?

Teleport supports [SCIM](https://scim.cloud/) provisioning for Okta via the
hosted Okta integration, available in the [Enterprise Cloud](../../index.mdx)
and [Enterprise](../../admin-guides/self-hosting/introduction.mdx) versions
of Teleport.

Refer to the [hosted Okta integration guide](../../admin-guides/enroll-resources/application-access/okta/hosted-guide.mdx)
...
For more details, see the [Usage Reporting and Billing](../../get-started/essential-references/usage-billing.mdx)
guide.
...
If you no longer want to send usage data, see [disabling telemetry](../../connect-your-client/teleport-connect.mdx).
