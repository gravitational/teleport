...
See our documentation on [data retention](../architecture/cloud.mdx).
...
However, we do provide customers with a stable tenant DNS name backed with TLS
certificates from [letsencrypt.org](https:/letsencrypt.org) that can be utilized
to verify the integrity of any outbound connections to Teleport Enterprise
Cloud.
...
../../admin-guides/authentication/device-trust/guide.mdx) provides the best available
...
Access Controls Reference](../rbac/teleport-roles.mdx).
...
tunnels](../../admin-guides/enroll-resources/agents/join-services-to-your-cluster/overview.mdx).
...
[dynamic tokens](../../admin-guides/enroll-resources/agents/join-services-to-your-cluster/join-token.mdx):
...
Find the appropriate download at [Teleport Enterprise Cloud Downloads](../../get-started/download-install/cloud-downloads.mdx). Use the Enterprise version of `tctl`.
...
Yes. We recommend Teleport's [event handler plugin](../../admin-guides/common-operations/export-audit-events/fluentd.mdx) to export Teleport Enterprise Cloud audit events.

### Is it possible to store audit logs and session recordings in my own S3 bucket?

Yes, you can configure [External Audit Storage](../../admin-guides/common-operations/external-audit-storage.mdx).
...
described in [Teleport Upcoming Releases](../../get-started/essential-references/upcoming-releases.mdx).
...
Overview](../../get-started/download-install/upgrading/overview.mdx) for more information.
...
- [Upgrading Teleport Cloud Agents on
  Kubernetes](../../get-started/download-install/upgrading/cloud-kubernetes.mdx)
- [Upgrading Teleport Cloud Agents on
  Linux Servers](../../get-started/download-install/upgrading/cloud-linux.mdx)
...
of regions all over the world, and allow customers to [select the region](../architecture/cloud.mdx) where the data is stored.
...
Configuring [External Audit Storage](../../admin-guides/common-operations/external-audit-storage.mdx) will allow
