...
sidebar_label: Bot
---
{/* Automatically generated from: gen/proto/go/teleport/machineid/v1/bot.pb.go */}
{/* DO NOT EDIT */}
...
traits: 
  ...
  - # [...]
  - # [...]
max_session_ttl: # See description
```

|Field Name|Description|Type|
|---|---|---|
|max_session_ttl|The max session TTL value for the bot's internal role. Unless specified, bots may not request a value beyond the default maximum TTL of 12 hours. This value may not be larger than 7 days (168 hours).||
