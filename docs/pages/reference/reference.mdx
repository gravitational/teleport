...
Reference guides to audit events that you can export and track in Teleport. ([more info](reference/audit.mdx))

- [Audit Events and Records](reference/audit/audit.mdx): Reference of Teleport Audit Events and Session Records
- [Database Access Audit Events Reference](reference/audit/database-events.mdx): Audit events reference for Teleport database access.
- [Desktop Access Audit Events Reference](reference/audit/desktop-events.mdx): Audit events reference for Teleport desktop access.
