...
Please follow our [Getting started with Teleport using Docker](./setup/guides/local-docker.mdx) or with [Teleport Enterprise using Docker](enterprise/quickstart-enterprise.mdx#run-teleport-enterprise-using-docker) for install and setup instructions.
