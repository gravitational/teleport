...
Teleport core service [`teleport`](reference/cli/teleport.mdx) and admin tool [`tctl`](reference/cli/tctl.mdx) have been designed to run on **Linux** and **Mac** operating systems. The Teleport user client [`tsh`](reference/cli/tsh.mdx) and UI are available for **Linux, Mac**, and **Windows** operating systems.
...
Please follow our [Helm guides](kubernetes-access/helm/guides.mdx) for detailed install and setup instructions, including high availability setups.
