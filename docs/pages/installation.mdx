...
The easiest installation method, for Teleport versions 15.5 and above, is the
...
|`teleport-kube-agent`|Kubernetes Service<br/>Application Service<br/>Database Service<br/>Discovery Service|[Reference](reference/helm-reference/teleport-kube-agent.mdx)|
