...
<Details title="Using APT for versions prior to Teleport 10?" scopeOnly={false}>
...
Check the [Cloud Downloads](./cloud/downloads.mdx) page for the most up-to-date
information on obtaining Teleport binaries compatible with Cloud.
