...
In this guide, you will use a custom API client program to automatically enroll
Dockerized applications with your Teleport cluster. This program demonstrates
some libraries you can use to automatically register resources with Teleport.
...
short-lived credentials via Machine & Workload Identity, which reduces the risk
of these credentials becoming stolen. View our [Machine & Workload Identity
