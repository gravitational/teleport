...
- Teleport's [Proxy Peering](../proxy-peering.mdx) is used to reduce the total number of tunnel connections in the Teleport cluster.
...
- [Teleport Proxy Peering](../proxy-peering.mdx) for reducing the number of resource connections
...
In this deployment architecture, [Proxy Peering](../proxy-peering.mdx) is used to restrict the number of connections made from
