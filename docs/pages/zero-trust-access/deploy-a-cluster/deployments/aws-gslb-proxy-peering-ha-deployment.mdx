...
- [Teleport Proxy Peering](../reliability/proxy-peering.mdx) for reducing the number of resource connections
...
In this deployment architecture, [Proxy Peering](../reliability/proxy-peering.mdx) is used to restrict the number of connections made from
