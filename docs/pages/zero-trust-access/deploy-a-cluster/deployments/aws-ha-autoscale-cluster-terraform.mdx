...
ways to integrate Teleport onto your servers. We recommend looking at our [Installation guide](../../../installation/single-machine/single-machine.mdx).

To add new nodes/EC2 servers that you can "SSH into" you'll need to:

- [Install the Teleport binary on the Server](../../../installation/single-machine/single-machine.mdx)
- [Run Teleport - we recommend using systemd](../../../reference/cli/teleport.mdx#teleport-install-systemd)
- [Set the correct settings in /etc/teleport.yaml](../../../reference/deployment/config.mdx)
- [Add Nodes to the Teleport
  cluster](../../../installation/agents/agents.mdx)
...
You can also generate an SSH Service join token using `tctl tokens add --type=node` [as detailed here in our admin guide](../../../installation/agents/join-token.mdx).
...
To manually join Teleport Agents to your cluster, you will need [a join token](../../../installation/agents/join-token.mdx).
...
to a Teleport Auth Service instance. Follow the instructions in our [Trusted Clusters guide](../trustedclusters.mdx).
