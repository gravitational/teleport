...
More information about how Teleport works with DynamoDB can be found in our [Storage Backends guide](../../../reference/deployment/backends.mdx).
...
1. Use both these values to SSH into the Auth Service instance. Make sure that the AWS keypair that you specified in the
   ...
   # The authenticity of host '192.0.2.4 (192.0.2.4)' can't be established.
   # ECDSA key fingerprint is SHA256:vFPnCFliRsRQ1Dk+muIv2B1Owm96hXiihlOUsj5H3bg.
   # Are you sure you want to continue connecting (yes/no/[fingerprint])? yes
   # Warning: Permanently added '192.0.2.4' (ECDSA) to the list of known hosts.
   # The authenticity of host '192.0.2.196 (<no hostip for proxy command>)' can't be established.
   # ECDSA key fingerprint is SHA256:vFPnCFliRsRQ1Dk+muIv2B1Owm96hXiihlOUsj5H3bg.
   # Are you sure you want to continue connecting (yes/no/[fingerprint])? yes
   # Warning: Permanently added '192.0.2.196' (ECDSA) to the list of known hosts.
   # Last login: Tue Mar  3 18:57:12 2020 from 192.0.2.5
...
<Tabs>
  ...
  # -------------------------- --------------- ------
  # ip-192-0-2-69-ec2-internal 192.0.2.69:3022
...
<Tabs>
  ...
  # Mar 05 20:58:25 ip-172-31-2-109.ec2.internal /usr/bin/teleport[4514]: ERRO             read tcp 192.0.2.109:3024->192.0.2.143:1577: read: connection reset by peer
  # Mar 05 20:58:50 ip-172-31-2-109.ec2.internal /usr/bin/teleport[4514]: ERRO             read tcp 192.0.2.109:3023->192.0.2.143:38011: read: connection reset by peer
  ```
...
ways to integrate Teleport onto your servers. We recommend looking at our [Installation guide](../../../installation/installation.mdx).

To add new nodes/EC2 servers that you can "SSH into" you'll need to:

- [Install the Teleport binary on the Server](../../../installation/installation.mdx)
- [Run Teleport - we recommend using systemd](../../management/admin/daemon.mdx)
- [Set the correct settings in /etc/teleport.yaml](../../../reference/deployment/config.mdx)
...
You can also generate an SSH Service join token using `tctl tokens add --type=node` [as detailed here in our admin guide](../../../enroll-resources/agents/join-token.mdx).
...
To manually join Teleport Agents to your cluster, you will need [a join token](../../../enroll-resources/agents/join-token.mdx).
