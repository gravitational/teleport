...
If you're looking to provide AWS CLI access to your users with audit capture by going through Teleport proxy but you don't have a public cluster, or Roles Anywhere are not adopted at your organization, take a look at the guide for [agent-based AWS access](../../../enroll-resources/application-access/cloud-apis/aws-console.mdx) instead.
</Admonition>
