...
<Admonition type="tip">
If you're looking to provide AWS CLI access to your users with audit capture by going through Teleport but you don't have a public cluster, take a look at the guide for [agent-based AWS access](../../../enroll-resources/application-access/cloud-apis/aws-console.mdx) instead.
</Admonition>
...
<Admonition type="tip" title="SSO users">
  ...
  In this case you should map the AWS Role ARNs through your Identity Provider, using [role templates](../../access-controls/guides/role-templates.mdx#sso-users).
</Admonition>
