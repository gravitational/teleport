...
The AWS OIDC integration allows Teleport users to access AWS CLI and Console using AWS IAM Roles.

You can set up access using the "AWS CLI/Console Access via AWS OIDC IdP" enrollment wizard from the UI or you can follow this guide to set it up manually.
...
Whether you use the enrollment wizard or set up access manually, you need access to the `editor` role.
