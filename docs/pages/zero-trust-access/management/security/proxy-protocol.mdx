...
- A self-hosted Teleport Enterprise account. If you want to get started with
  ...
  environment](../../../get-started/deploy-community.mdx) with Teleport Community Edition.
...
- The `tctl` admin tool and `tsh` client tool.
  ...
  Visit [Installation](../../../installation/single-machine/single-machine.mdx) for instructions on downloading
  `tctl` and `tsh`.
