...
<Admonition type="danger" title="Misconfiguration can block all access">
A misconfigured allowlist can block all access to your cluster. Always include
your current network before saving changes.
</Admonition>
