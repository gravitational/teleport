...
As you learned in [Add Labels to Resources](../../rbac-get-started/labels.mdx), labels enable you to group, filter, and control access to 
...
- Follow the **principle of least privilege** in creating and assigning roles. 
  Don't give users permissive roles when a more restrictive role will do. For example, don't 
...
[Storage backends](../../../reference/deployment/backends.mdx)
