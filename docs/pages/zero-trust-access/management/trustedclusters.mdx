...
In this guide, you will configure a trust relationship between two Teleport
clusters, configure RBAC for the trusted cluster, and access a server in the
leaf cluster via the root cluster.
