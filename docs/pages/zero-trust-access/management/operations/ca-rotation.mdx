...
verification](../../../reference/machine-id/bound-keypair/concepts.mdx#join-state-verification).
...
verification](../../../reference/machine-id/bound-keypair/admin-guide.mdx#recovery-after-a-cluster-rollback).
