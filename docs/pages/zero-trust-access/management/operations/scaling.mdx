...
[`teleport-cluster` Helm chart](../../../reference/helm-reference/teleport-cluster.mdx).
See [Deploy Teleport on Kubernetes](../../../zero-trust-access/deploy-a-cluster/helm-deployments/kubernetes-cluster.mdx)
...
- The Auth Service needs a highly available backend. The default standalone mode
  ...
  See [Storage backends](../../../reference/backends.mdx) and the
  [High Availability guide](../../../zero-trust-access/deploy-a-cluster/high-availability.mdx).
