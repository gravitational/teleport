...
In this guide, you will perform common troubleshooting tasks that we recommend
when encountering unexpected behavior in your Teleport cluster.
...
stuck, since you can see which a goroutine is blocked and why. For example,
