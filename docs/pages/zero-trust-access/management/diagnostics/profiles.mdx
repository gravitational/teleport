...
Teleport leverages Go's diagnostic capabilities to collect and export profiling
data. Profiles can help identify the cause of spikes in CPU, the source of
memory leaks, or the reason for a deadlock. This page describes the tooling that
you can use to collect profiles of a Telport process.
