---
title: Monitoring your Cluster and Diagnosing Issues
sidebar_label: Diagnostics
description: Provides guidance on monitoring your Teleport deployment and diagnosing issues.
tags:
 - how-to
 - platform-wide
---
...
For a detailed description of these configuration fields, see the [configuration reference](../../../reference/deployment/config.mdx) page.
...
```yaml
  ...
  # Optional path to TLS certificates are used to enable mTLS for the exporter
  keypairs:
