...
- A running Teleport cluster. For details on how to set this up, see our
  [Getting Started](../../../zero-trust-access/deploy-a-cluster/linux-demo.mdx) guide (skip TLS certificate setup).
...
- [Configuring Teleport TLS Certs](../../../zero-trust-access/deploy-a-cluster/linux-demo.mdx#configure-teleport)
