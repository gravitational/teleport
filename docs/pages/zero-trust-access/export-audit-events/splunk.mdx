...
description: How to configure the Teleport Event Handler plugin to send audit event logs to Splunk
tags:
 - how-to
 - zero-trust
 - audit
...
audit events over a gRPC stream, sends them to a local Fluentd
...
reference](../../reference/audit-events.mdx) so you can plan
