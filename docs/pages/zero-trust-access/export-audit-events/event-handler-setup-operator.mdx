---
title: Set up the Teleport Event Handler Plugin with Teleport Kubernetes Operator
sidebar_label: Event Handler Setup (Kubernetes Operator)
sidebar_position: 2
description: Set up Teleport Event Handler plugin with credentials to access events API, using Teleport Kubernetes Operator.
tags:
 - how-to
 - zero-trust
 - audit
...
If your Teleport cluster does not have the Teleport Kubernetes Operator deployed, follow
[the guide to set up Teleport Kubernetes Operator
...
Operator, see [Set up Event Handler with tctl](event-handler-setup.mdx).
