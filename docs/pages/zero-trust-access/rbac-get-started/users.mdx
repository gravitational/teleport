...
resources. See our [Teleport Resources Reference](../../reference/infrastructure-as-code/teleport-resources/teleport-resources.mdx).
...
- [Single Sign-On](../sso/sso.mdx)

To manage role assignments across many users with required-role gates, periodic
reviews, and a clear audit trail, see [Getting Started with Access
Lists](../../identity-governance/access-lists/guide.mdx).
...
information, see [GitHub SSO](../sso/integrate-idp/github-sso.mdx).
