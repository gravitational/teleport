...
- Now that you know how to manage Teleport configuration resources with
  ...
  reference](../../../reference/api/terraform-provider/terraform-provider.mdx) so
...
- Learn how you can help achieve secure access for service accounts by sending
  [anonymous Machine ID telemetry](../../../reference/machine-workload-identity/machine-id/telemetry.mdx).
