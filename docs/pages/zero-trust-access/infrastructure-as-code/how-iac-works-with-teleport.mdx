...
description: Implement Infrastructure as Code (IaC) workflows with Teleport.
sidebar_position: 1
tags:
...
This guide explains **dynamic Teleport resources**, which allow you to configure your Teleport cluster using infrastructure as code (IaC) tools.
