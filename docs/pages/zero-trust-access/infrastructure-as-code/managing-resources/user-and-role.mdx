...
infrastructure as code (IaC). Teleport supports three ways to dynamically
...
- Allow users with the `manager` role to grant access to production servers to
  ...
  See [the AccessList documentation](../../../identity-governance/access-lists.mdx) for
...
- You can see all supported fields in the references
  of [the user resource](../../../reference/infrastructure-as-code/resources.mdx)
  and [the role resource](../../../reference/infrastructure-as-code/resources.mdx).
