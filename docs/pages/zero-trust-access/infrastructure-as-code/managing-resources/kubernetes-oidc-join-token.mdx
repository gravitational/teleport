...
This guide relies on the OIDC variant of [the Kubernetes join
method](../../../reference/deployment/join-methods.mdx#kubernetes-oidc). Most
Kubernetes clusters use an OpenID Connect (OIDC) provider to sign their Service
Account tokens.
