...
<Admonition type="tip" title="Author Terraform from the Web UI">
If you'd rather build the Access List manifest visually, the Web UI's guided Access
List flow renders the Terraform configuration live as you fill it in, and walks you
through applying it at the **Deployment** step. See
[Getting Started with Access Lists](../../../identity-governance/access-lists/guide.mdx).
</Admonition>
