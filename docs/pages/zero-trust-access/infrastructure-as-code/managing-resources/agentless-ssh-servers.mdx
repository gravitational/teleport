...
- The public server IP address with SSH port: <Var name="192.0.2.0:22" />
...
--------------------- ------------ --------------- --------------------------
<Var name="ssh-server-hostname" /> <Var name="192.0.2.0:22" /> env=test,team=engineering
