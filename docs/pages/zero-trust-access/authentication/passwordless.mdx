...
- A signed and notarized version of `tsh` is required for Touch ID. This means
  ...
  [Download the macOS tsh installer](../../installation/single-machine/macos.mdx).
...
[installation page](../../installation/single-machine/single-machine.mdx).
...
`tsh` relies on an embedded libfido2 to access hardware devices. If you are
...
standalone version of `tsh`. [Download the macOS tsh installer](../../installation/single-machine/single-machine.mdx).
