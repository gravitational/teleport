...
- A second factor that can satisfy admin actions configured on the cluster; either of the following:
...
configured second factors all satisfy admin actions — that is, OTP is not
