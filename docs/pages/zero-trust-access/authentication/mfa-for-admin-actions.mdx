...
MFA for administrative actions is automatically enforced on clusters where
WebAuthn and/or SSO MFA are the only available multi-factors, but not when
OTP is also available.
