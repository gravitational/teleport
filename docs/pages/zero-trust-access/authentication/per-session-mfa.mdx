...
<Admonition type="note">
  In addition to per-session MFA, enable
  [login MFA in your SSO provider](../sso/sso.mdx#configuring-sso-for-mfa-checks)
  and/or for all [local Teleport users](../../reference/access-controls/authentication.mdx)
  to improve security.
</Admonition>
