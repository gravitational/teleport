...
Teleport cluster automatically](../../../enroll-resources/auto-discovery/kubernetes-applications/kubernetes-applications.mdx).
...
how to deploy a [pool of Teleport Agents](../../../enroll-resources/agents/agents.mdx) to run
