...
instances](../../../infrastructure-as-code/terraform-starter/enroll-resources.mdx). And behind the scenes, the
Teleport Discovery Service uses dynamic registration to [register Kubernetes
applications](../../../../enroll-resources/auto-discovery/kubernetes-applications/kubernetes-applications.mdx).
