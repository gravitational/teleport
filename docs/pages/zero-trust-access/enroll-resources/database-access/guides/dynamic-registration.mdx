...
- [Terraform Provider](../../../infrastructure-as-code/terraform-provider/terraform-provider.mdx)
- [Kubernetes Operator](../../../infrastructure-as-code/teleport-operator/teleport-operator.mdx)
- [Teleport API](../../../../admin-guides/api/api.mdx)

See [Using Dynamic Resources](../../../infrastructure-as-code/infrastructure-as-code.mdx) to learn
