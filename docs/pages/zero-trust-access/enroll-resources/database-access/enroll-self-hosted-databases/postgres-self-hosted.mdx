...
[RBAC](../../../../enroll-resources/database-access/rbac.mdx) section for more details.
...
- Set up [automatic database user provisioning](../../../../enroll-resources/database-access/auto-user-provisioning/postgres.mdx).
