...
deploy a [pool of Teleport Agents](../../enroll-resources/agents/agents.mdx) to run multiple
agent services.
...
- [Access Controls](../../../enroll-resources/database-access/rbac.mdx): Role-based access control (RBAC) for Teleport database access.
- [Using the Teleport Database Service (section)](./guides/): Guides to possibilities for running the Teleport Database Service.

## Troubleshooting & support

- [FAQ](../../../enroll-resources/database-access/faq.mdx): Frequently asked questions about Teleport database access.
- [Troubleshooting](../../../enroll-resources/database-access/troubleshooting.mdx): Common issues and resolutions for Teleport's Database Access
