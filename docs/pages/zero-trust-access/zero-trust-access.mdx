...
<UseCasesList
  ...
  useCases={[
    ...
    },
    {
      ...
      description: "Log granular audit events when users and services interact with your cluster. View audit events in Teleport or export them to a 3rd-party tool.",
    ...
    },  
    {
      ...
      tags: [
        ...
        {
          name: "Helm Chart",
          href: "./infrastructure-as-code/teleport-operator/teleport-operator-helm/",
        },
      ]
    },
    {
