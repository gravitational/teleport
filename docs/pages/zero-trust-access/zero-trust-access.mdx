  ...
  useCases={[
    {
      ...
      tags: [
        {
          name: "Okta",
          href: "./sso/integrate-idp/okta/",
          icon: "okta",
        },
        {
          name: "GitHub",
          href: "./sso/integrate-idp/github-sso/",
          icon: "github",
        },
        {
          name: "Entra ID",
          href: "./sso/integrate-idp/entra-id-oidc/",
          icon: "entraId",
        },
       {
          name: "More IdPs",
          href: "./sso/integrate-idp/",
          arrow: true,
        },
      ]
    },
     {
      ...
      tags: [
        ...
        {
          name: "VNet guide",
          href: "../connect-your-client/teleport-clients/vnet/",
        },
      ]
    },
    {
    ...
    },
    {
      ...
      tags: [
        {
          name: "AWS KMS",
          href: "./deploy-a-cluster/private-keys/aws-kms/",
          icon: "aws",
        },
        {
          name: "Google Cloud KMS",
          href: "./deploy-a-cluster/private-keys/gcp-kms/",
          icon: "googleCloud",
        },
        {
          name: "Helm chart",
