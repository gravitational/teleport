...
addresses](../enroll-resources/application-access/guides/connecting-apps.mdx).
...
In this guide, we'll use the example app from [TCP Application Access guide](../enroll-resources/application-access/guides/tcp.mdx) and make it
...
VNet does not officially support [web apps](../enroll-resources/application-access/guides/connecting-apps.mdx) yet. However, technically any web
app is [a TCP app](../enroll-resources/application-access/guides/tcp.mdx), so they can be made available over VNet as well. You'll need to change
...
- If the application needs to be accessible over HTTPS, it must handle TLS connections and return [a valid
  cert](../enroll-resources/application-access/guides/connecting-apps.mdx) for the domain it is served on.
- [JWT Token](../enroll-resources/application-access/jwt/introduction.mdx), [redirect](../enroll-resources/application-access/guides/connecting-apps.mdx) and
  [header rewrites](../enroll-resources/application-access/guides/connecting-apps.mdx) are not available for TCP apps.
