...
- **Restricted Cipher Suite Selection**
  ...
  algorithms that are approved under FIPS 140-2 and supported by BoringCrypto.
  This means there is a lack of support for some modern algorithms with better
