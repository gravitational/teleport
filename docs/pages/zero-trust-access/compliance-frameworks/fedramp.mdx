...
Teleport provides the foundation to meet critical FedRAMP requirements for secure access to your infrastructure and workloads.
...
teleport:
  ...
  # add nodes is to use `tctl nodes add --ttl=30m` command to generate auto-expiring
  # tokens.
  #
...
auth_service:
  ...
  # This setting is required to start Teleport in FIPS mode
