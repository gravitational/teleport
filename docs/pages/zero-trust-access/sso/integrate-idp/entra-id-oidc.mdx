...
created while following this guide.
...
![Entra ID OIDC client credential](../../../../img/sso/entraid/entra-id-client-credential.png)
...
(!docs/pages/includes/sso/entraid-groups-provider.mdx type="oidc"!)
</details>
...
$ tctl sso configure oidc --name "entra-id" \
  ...
  --claims-to-roles groups,<Var name="mapping_1" /> \
  --claims-to-roles groups,<Var name="mapping_2" /> \
  --scope openid \
  --scope email \
...
<details>
<summary>Changing the callback address</summary>
...
Learn more about other [OIDC](oidc.mdx)-related configurations that Teleport
supports.
