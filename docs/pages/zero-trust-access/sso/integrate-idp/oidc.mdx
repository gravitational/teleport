...
Teleport with the information it needs to exchange OIDC messages with your IdP
...
commands](../../../reference/infrastructure-as-code/teleport-resources/teleport-resources.mdx) or the Teleport Web UI.
...
$ tctl sso configure oidc --name <CONNECTOR-NAME> \
  ...
  --claims-to-roles <Var name="mapping_2" /> > oidc-connector.yaml
```
