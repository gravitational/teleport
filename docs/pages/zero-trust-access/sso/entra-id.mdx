...
description: How to configure Teleport access with Microsoft Entra ID (formerly Azure AD) as an SAML identity provider.
labels:
 - how-to
 - zero-trust
---

This guide will cover how to configure Microsoft Entra ID as an SAML identity provider
to issue credentials to specific groups of users with a SAML Authentication Connector. 
