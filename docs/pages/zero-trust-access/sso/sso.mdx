...
as described in the [Resources Reference](../../reference/infrastructure-as-code/teleport-resources/teleport-resources.mdx).
...
In order to consume these JSON claims, an administrator must create a [login rule](../authentication/login-rules/login-rules.mdx)
