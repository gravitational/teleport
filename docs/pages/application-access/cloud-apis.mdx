...
description: "How to use Teleport to achieve secure access to managing cloud providers"
---
...
Teleport's granular audit logging means that you can easily correlate access to
