...
For more information, see the [Okta Synchronization and SCIM](./sync-scim) guide.
...
see the Okta [Architecture](./architecture/) and [Synchronization with Okta and SCIM](./sync-scim/)
guides.
...
The SAML connector created during the enrollment process is **_not_** deleted
...
synchronization process or via SCIM, will **_not_** be deleted when the hosted
...
information, see the Teleport [Local Users](../../management/admin/users/#deleting-users)
guide.
