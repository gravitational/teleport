...
an upstream Okta Organization:
 - the Okta integration [synchronization process](./architecture)
...
The integration [enrolment process](./hosted-guide/) creates an Okta SAML
Application to use as the identity provider for a new
[SAML Authentication Connector](../../access-controls/sso/okta/). The enrolment
