...
incldues permissions granted by Okta groups along with the assignment of users to individual
...
![A Synchronized Okta Access List](../../../img/application-access/okta/okta-access-list.png)
