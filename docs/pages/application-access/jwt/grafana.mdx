...
description: How to configure Teleport Application Access Grafana.
---
...
you can use the below command to to launch an instance of Grafana configured
...
If your proxy is using self-signed certificates, you will also need to add your
self-signed public key to `/etc/ssl/certs/ca-certificates.crt` within the
container.
</Admonition>

## Step 2/3. Register with Grafana in Teleport
