...
team to connect to applications within private networks as well as cloud
provider APIs with provide fine-grained RBAC and audit logging.
...
Manage access to cloud provider APIs:

- [AWS Access](./guides/aws-console.mdx): How to access AWS Management Console,
  AWS CLI, and AWS SDKs with Teleport Application Access.
- [Azure CLI Access](./guides/azure.mdx): How to access the Azure CLI with
