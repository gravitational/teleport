...
<Admonition type="note" title="Session Duration">
    If the Teleport agent is using [tempoary security credentials](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp.html),
    the maximum session duration will be limited to one hour.
</Admonition>
