...
You can optionally configure the JWT token to exclude Teleport traits
and/or roles. This may be useful if is issue connecting to an app due
to a "header too large" error.
