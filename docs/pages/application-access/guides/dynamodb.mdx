---
title: AWS DynamoDB using App Access
...
DynamoDB](../../database-access/guides/aws-dynamodb.mdx) guide. Note that using
the Database Access Service will allow you to connect with GUI clients, whereas
Application Access does not.
