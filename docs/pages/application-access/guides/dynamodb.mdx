---
title: Access AWS DynamoDB as an Application
description: How to access AWS DynamoDB as an Application with Teleport.
---
...
service, as described in our [Database Access with AWS DynamoDB](../../database-access/guides/aws-dynamodb.mdx) guide.
