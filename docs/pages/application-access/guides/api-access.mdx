...
$ curl \
  ...
  https://grafana.teleport.example.com:443
```
...
$ curl --user admin:admin \
  --cert /Users/alice/.tsh/keys/teleport.example.com/alice-app/cluster-name/grafana-x509.pem \
  --key /Users/alice/.tsh/keys/teleport.example.com/alice \
    https://grafana.teleport.example.com:443/api/users
...
# Name:      grafana
# URI:       https://grafana.teleport.example.com:443
...
# https://grafana-root.gravitational.io:443
