...
description: How to access Amazon Athena with Teleport Application Access
---

Access to Amazon Athena is provided by Teleport Application Access for [AWS CLI
and Console](../cloud-apis/aws-console.mdx).

This guide will help you to:

- Install the Teleport Application Service.
- Set up the AWS CLI and Console access.
...
(!docs/pages/includes/application-access/aws-database-create-iam-role.mdx iam-role="ExampleTeleportAthenaRole" managed-policy="AmazonAthenaFullAccess" !)
...
Connect to Athena with ODBC or JDBC driver:
