...
![Teleport Application Access Grafana Self-Hosted](../../img/application-access/grafana_tutorial.png)
...
1. Start Grafane by running the following command:
...
1. Create the configuration file for Grafance at `/etc/app_config.yaml`
...
Install the `teleport` pod running Grafana into your Kubernetes cluster
