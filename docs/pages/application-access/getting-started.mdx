...
On the host where you will run the Teleport Application Service install Teleport. See our [Installation](/docs/installation/) page for other options besides Linux servers.
