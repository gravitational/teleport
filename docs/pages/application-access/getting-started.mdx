...
Install Teleport on the host where you will run the Teleport Application Service. See our [Installation](/docs/installation/) page for options besides Linux servers.
