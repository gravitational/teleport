...
The command will output a signup link. Use it to choose a password and set up a second authentication factor. After that, it will take you to the Teleport web UI.
