...
![Teleport Application Access for Grafana](../../img/application-access/grafana-tutorial.png)
...
Install the `teleport-kube-agent` Helm chart into your Kubernetes cluster to proxy 
Grafana with a command similar to the following:
