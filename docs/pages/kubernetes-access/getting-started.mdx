...
<Tabs>
  ...
  <TabItem label="Enterprise">
    ...
    # Add the Teleport chart repository 
    $ helm repo add teleport https://charts.releases.teleport.dev
    ...
    # Download the license file from https://dashboard.goteleport.com
    # Rename license file from license.pem to license-enterprise.pem
    $ mv license.pem license-enterprise.pem
    
    # Create a secret "license" in the namespace teleport-cluster-ent
...
<Tabs>
  <TabItem label="Open Source">
    ...
    # Service is up, the load balancer is created
...
NOTE: Make sure tele.example.com:443 points at a Teleport proxy that users can access.
```
