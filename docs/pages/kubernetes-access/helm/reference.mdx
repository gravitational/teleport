...
- [Community Docker image information](../../setup/guides/local-docker.mdx#pick-your-image)
...
See [this link for information on Community Docker image versions](../../setup/guides/local-docker.mdx#pick-your-image).
