...
<Admonition type="note" title="Installing cert-manager">
  ...
  and the relevant sections of the [AWS](./guides/aws.mdx#step-4-tls-certificates-for-teleport) and [GCP](./guides/gcp.mdx#step-4-install-and-configure-cert-manager) guides for more information.
</Admonition>
...
<Admonition type="note" title="Configuring an Issuer">
  ...
  of the [AWS](./guides/aws.mdx#step-4-tls-certificates-for-teleport) and [GCP](./guides/gcp.mdx#step-4-install-and-configure-cert-manager) guides for more information.
</Admonition>
