...
<Admonition type="warning">
  ...
  One option might be to use Teleport's built-in ACME support or [cert-manager](https://cert-manager.io/docs/).
</Admonition>
...
<Admonition type="warning">
  ...
  One option might be to use Teleport's built-in [ACME support](#acme), or [cert-manager](https://cert-manager.io/docs/).
</Admonition>
