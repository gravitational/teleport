...
- [Community Docker image information](../../setup/guides/docker-compose.mdx#pick-your-image)
...
| Teleport Pro cluster | `example.teleport.sh:443` |
...
<Admonition type="tip" title="Supported values">
  You can see a list of all the supported [values which can be used in a Teleport application access configuration here](../../application-access/reference/configuration.mdx).
</Admonition>
...
See [this link for information on Community Docker image versions](../../setup/guides/docker-compose.mdx#pick-your-image).
