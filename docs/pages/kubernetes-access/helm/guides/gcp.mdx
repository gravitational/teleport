...
| `example.com` | The name of the Cloud DNS domain hosting your Teleport cluster, listed as "DNS name" on the GCP Cloud DNS page. |
...
<Admonition type="note">
Certbot TLS initialization may take several minutes. Teleport pods may not run until the initialization process is complete.
</Admonition>
