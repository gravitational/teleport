...
To check if Discovery Service is working correctly, you can check if any Kubernetes 
Cluster was already discovered. To do this, you can use the `tctl get kube_cluster` 
