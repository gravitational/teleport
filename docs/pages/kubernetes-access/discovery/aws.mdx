...
For simplicity, it is possible to map the Teleport IAM role onto an existing 
...
service means granting administrator-level permissions on the Kubernetes cluster.  **Do not use this method in production.**
  </Notice>
