...
<Tabs>
  <TabItem label="Open Source">
    GitHub's `teams_to_roles` section maps users to roles based on users' teams.
  ...
  <TabItem label="Enterprise">
    ...
    spec:
      ...
      attributes_to_roles:
      # Any user who has SAML `groups` attribute with value `okta-admin`
...
- [OIDC guide](../access-controls/sso/oidc.mdx)
- [ADFS guide](../access-controls/sso/adfs.mdx)
- [Azure AD guide](../access-controls/sso/azuread.mdx)
- [Google Workspace guide](../access-controls/sso/google-workspace.mdx)
- [Onelogin guide](../access-controls/sso/one-login.mdx)
- [Okta guide](../access-controls/sso/okta.mdx)
