...
Similarly to [EKS discovery](./aws.mdx), the EKS Discovery can automatically 
...
Teleport IAM role such as `system:masters`, but the guide to setting up the minimum 
permissions is available below.
