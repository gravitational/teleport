...
Teleport Enterprise Edition includes your favorite features from the open source Community Edition:

- [Role-Based Access Control (RBAC)](enterprise/introduction.mdx#role-based-access-control).

In additon to the following commercial features:

- Authentication via SAML and OpenID with providers such as Okta, Active
  Directory, and Auth0.
- Support for your preferred sign-on and authentication standards such as [SSO](enterprise/sso/ssh-sso.mdx).
- Premium support.
...
The open source Teleport Community Edition does not send any information to
