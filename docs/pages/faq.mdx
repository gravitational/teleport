...
in file configuration). As defined in [Adding a node located behind NAT - Teleport Node Tunneling](quickstart.mdx#adding-a-node-located-behind-nat-teleport-node-tunneling)
...
Gravitational offers this feature for the [commercial versions of Teleport](enterprise.mdx#rbac).
...
You can read more in the [Teleport Enterprise section of the docs](enterprise.mdx)
