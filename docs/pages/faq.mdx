...
behind-firewall clusters, see [Configure Trusted Clusters](zero-trust-access/management/admin/trustedclusters.mdx).
...
Yes, Teleport supports [Headless WebAuthn authentication](zero-trust-access/access-controls/guides/headless.mdx),
