...
Yes, this question comes up often and is related to the previous one. 

Take a look at [Using OpenSSH client](./server-access/guides/openssh-client.mdx) and [Using OpenSSH servers](./server-access/guides/openssh-recording.mdx) articles.
...
This was a popular customer [request](https://github.com/gravitational/teleport/issues/803) that was added several in 4.0. 
...
- Role-based access control, also known as [RBAC](enterprise/introduction.mdx#role-based-access-control).
