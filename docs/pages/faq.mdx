...
Gravitational offers this feature for the [Enterprise versions of Teleport](enterprise/index.mdx).
...
- Role-based access control, also known as [RBAC](enterprise/index.mdx#rbac).
- Authentication via SAML and OpenID with providers like Okta, Active
  Directory, Auth0, etc. (aka, [SSO](enterprise/ssh-sso.mdx)).
- Premium support.

We also offer implementation services, to help you integrate
Teleport with your existing systems and processes.

You can read more in the [Teleport Enterprise section of the docs](enterprise/index.mdx)
