...
[Adding Nodes to the
Cluster](zero-trust-access/enroll-resources/agents/join-token.mdx).
...
look at [Using OpenSSH Guide](zero-trust-access/server-access/openssh/openssh-agentless.mdx).
