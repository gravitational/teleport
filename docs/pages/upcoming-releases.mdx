...
[MCP Zero-Trust Access](./enroll-resources/mcp-access/mcp-access.mdx) users will be able to secure
and audit connections to MCP servers that use HTTP-based transport protocols in addition to stdio.
