...
| Version | Date                       |
|---------|----------------------------|
| 18.7.0  | Week of February 16, 2026  |
...
`tsh` will be able to delegate MFA checks (both on login and for per-session MFA) to the
browser, enabling the use of browser based passkeys or password managers with `tsh`.
...
| Week of            | Description                                                  |
|--------------------|--------------------------------------------------------------|
| February 16, 2026   | Teleport 18.7 will begin rollout on Cloud.                   |
| February 16, 2026   | Teleport 18.7 agents will begin rollout to eligible tenants. |
