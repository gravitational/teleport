...
Teleport web UI will be updated with a redesigned session recordings page that
includes session thumbnails and a session player with more advanced scrubbing
capabilities.
