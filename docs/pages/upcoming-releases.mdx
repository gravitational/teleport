...
Teleport will ship with a new guided flow for setting up GitHub Actions workflows that
connect to Teleport-protected Kubernetes clusters without secrets.
...
#### Inventory Listing in Web UI

Teleport's Web UI will include a new page listing the full inventory of all instances
and bots connected to the cluster. This page will show what Teleport services are running
on each instance and allow users to filter by version.
