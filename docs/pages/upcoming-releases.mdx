...
OSS Teleport will add limited support for Passwordless access for local Windows users.

#### Advanced Audit Log

Teleport's will include a new audit log backend that supports efficient
