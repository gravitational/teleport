...
#### Terraform support for AWS EKS auto-discovery

Teleport users will be able to set up AWS EKS auto-discovery using Terraform module.

#### Terraform support for Azure VM auto-discovery

Teleport users will be able to set up Azure VM auto-discovery using Terraform module.
