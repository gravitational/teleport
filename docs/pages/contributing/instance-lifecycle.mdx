---
title: Teleport Instance Lifecycle
...
Depending on what it needs to do, a service can either run briefly and exit, or 
live as long as the process overal `teleport` process. A service can also be 
