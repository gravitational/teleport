...
then click **New pull request**.
   ...
   The continuous integration (CI) pipeline automatically assigns reviewers to your pull request. 
   To ensure your pull request conforms to certain conventions and passes automated checks, it
   might require a companion—or _buddy_—pull request that includes your commits to pass CI/CD validation. 
   The companion pull request continues to identify you as the author of the changes committed.
   To ensure that your PR or its companion PR is merged, you should respond to reviewer feedback in a timely manner. 
