---
title: How to Contribute to the Teleport Documentation
...
1. Clone the `gravitational/docs` repository by running the following command:
   ...
   are documentation submodules for the 11.x, 12.x, 13.x, and 14.x versions
   of Teleport.
...
then click **New pull request**.
   ...
   The continuous integration (CI) pipeline automatically assigns reviewers to your pull request and
   generates a companion pull request with your commits for automated verification that your pull request 
