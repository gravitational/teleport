...
See our [Upgrading](../../index.mdx) guide for more information.
...
- Using the example Terraform module for deploying agents in [Deploy Agents with
  Terraform](../../admin-guides/enroll-resources/agents/deploy-agents-terraform.mdx).
...
Cluster](../../admin-guides/self-hosting/deploy-a-cluster/introduction.mdx), which provides full requirements
...
Enterprise License File](../../admin-guides/self-hosting/license.mdx)
...
1. Make sure the value of the `ID` environment variable is supported.
   ...
   Recording](../../admin-guides/enroll-resources/server-access/guides/bpf-session-recording.mdx) requires Linux
...
See the Teleport [Configuration Reference](../../reference/config-references/config.mdx) for whether a
...
Reference](../../reference/operations/networking.mdx) for the ports on your Teleport
container to expose.
...
method](../../admin-guides/enroll-resources/agents/join-services-to-your-cluster/join-token.mdx).
...
See the [AWS Single-Instance Deployment](../../admin-guides/self-hosting/deploy-a-cluster/deployments/aws-starter-cluster-terraform.mdx)
and the [Running Teleport Enterprise in High Availability mode on AWS using Terraform](../../admin-guides/self-hosting/deploy-a-cluster/deployments/aws-ha-autoscale-cluster-terraform.mdx)
...
|-|-|-|
|`teleport-cluster`|Auth Service<br/>Proxy Service<br/>Other Teleport services if using a custom configuration|[Reference](../../reference/config-references/helm-reference/teleport-cluster.mdx)
|`teleport-kube-agent`|Kubernetes Service<br/>Application Service<br/>Database Service|[Reference](../../reference/config-references/helm-reference/teleport-kube-agent.mdx)|
...
If you wish to uninstall Teleport at any time, see our documentation on [Uninstalling Teleport](../../admin-guides/common-operations/uninstall-teleport.mdx).
...
- [Server Access](../../admin-guides/enroll-resources/server-access/introduction.mdx)
- [Kubernetes Access](../../admin-guides/enroll-resources/kubernetes-access/introduction.mdx)
- [Database Access](../../index.mdx)
- [Application Access](../../admin-guides/enroll-resources/application-access/introduction.mdx)
- [Desktop Access](../../admin-guides/enroll-resources/desktop-access/introduction.mdx)
- [Machine ID](../../admin-guides/enroll-resources/machine-id/introduction.mdx)
