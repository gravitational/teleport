---
title: "Get Started Monitoring Teleport Audit Logs"
...
In this guide, you will view the recording of the SSH session you began in [Get
Started Connecting Infrastructure to Teleport](connect.mdx), and plan your next
steps as you set up Teleport.
...
Remember when you connected to your Ubuntu server via SSH in [Get Started
Connecting Infrastructure to Teleport](connect.mdx)? That entire session was
recorded.
