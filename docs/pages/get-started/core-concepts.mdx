...
Service](../admin-guides/enroll-resources/application-access/introduction.mdx).
...
Service](../admin-guides/enroll-resources/desktop-access/introduction.mdx).
...
Service](../admin-guides/enroll-resources/kubernetes-access/introduction.mdx)
...
Read more about the [Teleport SSH Service](../admin-guides/enroll-resources/server-access/introduction.mdx).
...
Read more in our [Machine ID guide](../admin-guides/enroll-resources/machine-id/introduction.mdx).
...
guide](../admin-guides/self-hosting/introduction.mdx).
...
Read more in our [resource reference](../reference/config-references/resources.mdx).
...
Read our [guide to Teleport roles](../admin-guides/access-controls/role-templates.mdx).
...
Read more about [local users](../reference/operations/authentication.mdx) and how [SSO
authentication works in Teleport](../admin-guides/authentication/sso/overview.mdx).
...
See our guide to [Authentication Options](../reference/operations/authentication.mdx).
...
see [Configure Trusted Clusters](../admin-guides/access-controls/trustedclusters.mdx). 
