...
- Docker installed on your workstation. 
  ...
  access](../admin-guides/enroll-resources/server-access/getting-started.mdx).

- The `tsh` client tool. 
  
  The `tsh` client tool is only required to access the server from a terminal.
  For installation instructions, see [Installation
  Guide](download-install/installation.mdx).  If you don't install the `tsh` client tool,
...
1. Start a Docker container on your workstation to prepare a server that you
   want to enroll as a resource in your Teleport Enterprise cluster:
...
with Terraform](../admin-guides/enroll-resources/agents/deploy-agents-terraform.mdx).
