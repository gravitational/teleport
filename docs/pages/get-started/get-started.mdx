...
This guide walks you through the steps to go from a new cluster to a production-ready deployment: enrolling resources, configuring access controls, integrating your identity provider, and enabling security visibility and logging.
