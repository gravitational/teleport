---
title: "Get Started Connecting Infrastructure to Teleport"
...
<div style={{ marginTop: 'var(--m-4)' }}>
  <Button style={{ padding: '0 var(--m-2)' }} as="link" href="../access/" variant="primary" shape="lg">Get Started with Teleport Access Controls <Icon name="arrowRight" inline size="sm"/></Button>
</div>
