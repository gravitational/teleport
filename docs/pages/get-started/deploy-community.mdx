...
At this point, you've launched your own Teleport Community Edition cluster and created a local admin user. You can now move on to the next step of enrolling your infrastructure resources.
