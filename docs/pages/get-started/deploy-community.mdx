...
Cloud](https://goteleport.com/signup/) and jumping ahead to [Step 2: Connect infrastructure](./step-2-connect.mdx).
...
[Step 2](#step-23-set-up-teleport-on-your-linux-host).
...
## Step 2/3. Set up Teleport on your Linux host
...
## Step 3/3. Create a Teleport user and set up multi-factor authentication
...
Great work! You've deployed a Teleport cluster and created a user. You can now move on to the next step of registering resources.

Great work! You've launched your own Teleport Community Edition cluster and created a user. You can now move on to the next step of connecting your infrastructure.
