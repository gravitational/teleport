...
Gravitational automatically builds and publishes Community, Enterprise, and Enterprise FIPS 140-2 AMIs when we
...
(Community Edition users can provide any valid local file path here - it isn't used by the auth server in a Teleport Community Edition install)
...
- the client is the same for both Community and Enterprise editions of Teleport.
