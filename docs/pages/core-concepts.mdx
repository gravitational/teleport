...
**Teleport Enterprise** is a managed deployment of the **Teleport Auth
...
customer account, known as a **Teleport Enterprise tenant**, has its own
subdomain of `.teleport.sh`, e.g., `example.teleport.sh`.
