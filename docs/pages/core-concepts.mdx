...
It establishes reverse tunnels to **Teleport Services** providing connections to the **Teleport Auth Service **,
which can run in private networks. This means that, in the Proxy
