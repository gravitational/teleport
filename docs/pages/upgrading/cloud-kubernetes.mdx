---
title: Manually Upgrade Cloud-Hosted Teleport Agents on Kubernetes
description: Provides instructions for upgrading cloud-hosted Teleport agents that run on Kubernetes.
---

This guide explains how to upgrade Teleport agents running on Kubernetes.
