---
title: Enable Automatic Updates for Cloud Agents on Linux
description: Provides instructions for enabling automatic updates for Teleport Cloud agents that run on Linux servers. 
---
