...
Before enabling automatic updates in your self-hosted Teleport cluster, you
must enable a **version server**. This section shows you how to enable a version
server in your cluster. Automatic updates in self-hosted Teleport clusters
require at least v14.3.7 or v15.1.3. 

### Configure a maintenance schedule

To enable automatic updates in your cluster, you must create a cluster
