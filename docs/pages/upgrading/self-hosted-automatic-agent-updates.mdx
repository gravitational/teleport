...
proxy_service:
  ...
  automatic_upgrades_channels:
    ...
    # https://<Var value="teleport.example.com:443" />/v1/webapi/automaticupgrades/channel/default/version
    default:
      static_version: v14.2.1
    # Define a new version channel with a static version reachable at
    # https://<Var value="teleport.example.com:443" />/v1/webapi/automaticupgrades/channel/m-static-channel/version
    my-static-channel:
