---
title: Upgrading in Other Scenarios
description: Provides detailed information on upgrading Teleport in various non-standard situations.
tocDepth: 3
labels:
 - conceptual
 - platform-wide
...
If your infrastructure does not fully support managed agent updates, follow this
guide to determine the best approach for keeping your Teleport cluster up-to-date.
