---
title: Manually Upgrade Cloud-Hosted Teleport Agents on Linux
description: Provides instructions for upgrading cloud-hosted Teleport agents that run on Linux servers.
---

This guide explains how to upgrade Teleport agents running on Linux servers.
...
to be responsible for keeping your Teleport agents up to date and compatible with
the Teleport Auth Service and Teleport Proxy Service.
