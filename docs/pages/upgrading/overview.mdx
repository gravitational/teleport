...
Teleport Cloud clusters are updated on a weekly basis. Major version updates are
performed every 4 months. You can monitor and subscribe to the [Teleport Cloud Status](https://status.teleport.sh/)
