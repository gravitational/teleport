...
```code
$ curl -s https://example.teleport.sh/webapi/find | jq '.server_version'
```
...
1. Back up your Teleport cluster state as a precaution against any unforeseen
   ...
   Restore](../zero-trust-access/management/backup-restore.mdx).
...
[Backup and Restore](../zero-trust-access/management/backup-restore.mdx) guidance
