...
## Upgrading a cloud-hosted Teleport cluster
...
Cloud-hosted Teleport clusters are updated on a weekly basis. Major version updates
are performed every 4 months. You can monitor and subscribe to the [Teleport Status](https://status.teleport.sh/)
page to be notified of scheduled updates.

To maintain version compatibility between your Teleport agents and the Teleport
Proxy Services, ensure that all your Teleport agents stay up to date with the Teleport
version of your Teleport Proxy Services. Failure to maintain version compatibility
for your Teleport agents may result in a degraded connection or disconnection of
those agents.
...
1. Back up your Teleport cluster state as a precaution against any unforeseen
   ...
   Restore](../management/operations/backup-restore.mdx).
