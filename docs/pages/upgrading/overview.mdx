...
1. Back up your Teleport cluster state as a precaution against any unforeseen
   ...
   Restore](../zero-trust-access/deploy-a-cluster/reliability/backup-restore.mdx).
...
[Backup and Restore](../zero-trust-access/deploy-a-cluster/reliability/backup-restore.mdx) guidance
