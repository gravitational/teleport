---
title: Managed Updates for Teleport Agents & Bots
description: Describes how to set up Managed Updates for Teleport Agents & Bots
tags:
  - conceptual
  - platform-wide
---
...
This document describes Managed Updates for Agents & Bots (v2),
...
- [How to enroll existing agents](#quick-setup-for-existing-linux-agent--bot-installations)
- [How to enroll new agents](#quick-setup-for-new-linux-agents--bot-installations)
- [How to configure Managed Updates v2](#configuring-managed-agent--tbot-updates) (
