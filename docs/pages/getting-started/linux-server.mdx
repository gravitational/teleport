...
<Tabs>
  <TabItem label="OpenSource"  scope={["oss"]}>
  <Tabs>
  ...
  The Teleport Enterprise license file, `license.pem`, is required as part of the installation.
  ...
  <Tabs>
    ...
    $ sudo cp license.pem /var/lib/teleport
    ```
    </TabItem>
    ...
    <TabItem label="ARMv7 (32-bit)">
      ```code
      $ curl -O https://get.gravitational.com/teleport-ent-v(=teleport.version=)-linux-arm-bin.tar.gz
      $ tar -xzf teleport-ent-v(=teleport.version=)-ent-linux-arm-bin.tar.gz
      $ cd teleport
      $ sudo ./install
    ...
    <TabItem label="ARMv8 (64-bit)">
      ```code
      $ curl -O https://get.gravitational.com/teleport-ent-v(=teleport.version=)-linux-arm64-bin.tar.gz
      $ tar -xzf teleport-ent-v(=teleport.version=)-linux-arm64-bin.tar.gz
      $ cd teleport
      $ sudo ./install
...
<Tabs>
  ...
  <Tabs>
    <TabItem label="Mac">
      [Download Enterprise MacOS .pkg installer](https://get.gravitational.com/teleport-ent-(=teleport.version=).pkg), double-click to run the installer.
    </TabItem>
    ...
    <TabItem label="Mac - Homebrew">
      ...
      <Admonition type="note">
        The Teleport package in Homebrew is not maintained by Teleport and we can't
        guarantee its reliability or security. We recommend the use of our [own Teleport Enterprise packages](https://get.gravitational.com/teleport-ent-(=teleport.version=).pkg).
    ...
    <TabItem label="Windows - Powershell">
      ```code
      $ curl -O teleport-ent-v(=teleport.version=)-windows-amd64-bin.zip https://get.gravitational.com/teleport-ent-v(=teleport.version=)-windows-amd64-bin.zip
      # Unzip the archive and move `tsh.exe` to your %PATH%
      ```
    </TabItem>
