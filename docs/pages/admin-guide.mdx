...
External user identities are only supported in [Teleport Enterprise](enterprise/introduction.mdx).
...
_external_ users via [Github](#github-oauth-20) or [Okta](enterprise/sso/ssh-okta.mdx) or any other
...
Follow our [Kubernetes guide](kubernetes-ssh.mdx) which contains some more specific
...
[Cluster State section](architecture/nodes.mdx#cluster-state) in the Teleport
...
<Admonition type="tip" title="Tip">
Before continuing, please make sure to take a look at the
[cluster state section](architecture/nodes.mdx#cluster-state) in Teleport
Architecture documentation.
</Admonition>
...
<Admonition type="tip" title="Tip">
Before continuing, please make sure to take a look at the
[cluster state section](architecture/nodes.mdx#cluster-state) in Teleport Architecture documentation.
</Admonition>
