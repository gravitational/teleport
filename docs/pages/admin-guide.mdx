...
auth_service:
  ...
  authentication:
    # default authentication type. possible values are 'local' and 'github' for Community Edition
...
2. `.log` file or `.events.gz` compressed file contains the copies of the event log entries that are
