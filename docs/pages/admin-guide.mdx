...
auth_service:
  ...
  # If running the auth service behind a loadbalancer it is highly recommended to have the keepalive settings
  # on your Teleport cluster match the value set on your loadbalancers
