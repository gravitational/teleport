...
||||||| parent of c0d694ca39 (update formatting)
...
Started](../try-out-teleport/introduction.mdx) guide.
...
This step is only *necessary* for Windows Server 2012 R2 Domain Controller as it
does not support secure algorithms by default. If it does not apply to you, you
can skip this step and go to the [next step](#step-57-export-your-ldap-ca-certificate).
</Admonition>
