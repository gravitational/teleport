...
1. Open **Group Policy Management** and expand Forest, Domains, your domian, and Group Policy Objects
...
1. Doubleclick **Deny log on locally**, then select **Define these policy settings**.
...
Next, you need to configure a group policy object that allows Teleport desktop sessions. 
In this step, you'll configure computers to trust the Teleport certificate authority so that
they accept the certificate-based smart card authentication, and ensure RDP is enabled.
