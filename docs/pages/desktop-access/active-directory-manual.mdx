...
Teleport Web UI and the predefined scripts described in [Configure access for 
...
- An Active Directory domain that is configured for LDAPS. Because Teleport requires an
  ...
  If you don't have Active Directory or Active Direectory Certificate Services installed, 
  ...
  use the predefined scripts to install these services.
