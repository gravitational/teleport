---
title: Configure access for Active Directory
description: Explains how to connect Teleport to an Active Directory domain.
...
- An Active Directory domain that is configured for LDAPS. Because Teleport requires an
  ...
  you can add roles and services using Server Manager.
