...
1. Doubleclick the executable you downloaded to run the Teleport Windows Auth Setup program 
...
following for the Windows Desktop Service: 
   ...
   enroll using the Teleport configuration file or use the Teleport API  
