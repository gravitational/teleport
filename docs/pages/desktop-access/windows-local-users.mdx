...
After you download the setup program so it's available on the Windows computer, 
you can run the program from the command-line instead of interactively to automate 
the process. In a Command Prompt window or PowerShell terminal, run following command 
