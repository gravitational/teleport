...
Directory Sharing is available beginning in Teleport v10.2.0.
...
<Notice type="warning">
For security reasons, the browser prevents you from sharing certain directories,
...
Directories _within_ these blocked user directories may still be shared.
...
37](https://github.com/gravitational/teleport/blob/master/rfd/0037-desktop-access-file-system-sharing.md)
