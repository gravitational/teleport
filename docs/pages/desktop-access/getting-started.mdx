---
title: Getting Started with Windows Access
...
Active Directory](./active-directory.mdx). You can also mix the Teleport Active Directory
...
to your Windows system, and prepare the it for passwordless access through Teleport.
...
you plan on running the Windows Service on the same host as an existing Teleport
service, you can skip this step):

(!docs/pages/includes/install-linux.mdx!)

Enable the Desktop Service and list the Windows systems configured for
