...
Windows login to use for the connection.
   ...
   ![Disonnect from a Windows desktop ](../../img/desktop-access/desktop-disconnect.png)

   To view the recording, select **Management** in the Teleport Web UI, then click **Session Recordings** 
   in the Activty section.
...
For more specific information about configuring role-based access controls to manage Windows desktop 
access permissions, see [Role-Based Access Control for Desktop Access](./rbac.mdx).