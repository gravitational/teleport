...
{/_ Adapted from https://www.ibm.com/docs/it/rds/5.2.1?topic=security-exporting-certificate-from-active-directory-server _/}
...
{/_ TODO: remove the "/ver/8.0/" in the link once these docs are the primary version _/}
