...
<Admonition type="note" title="Active Directory">
This guide has you download and install a custom Teleport DLL on each Windows desktop you want to enroll.

If you would like Teleport to integrate with an Active Directory environment instead, see [Configure access for Active Directory](./active-directory-manual.mdx).
</Admonition>
