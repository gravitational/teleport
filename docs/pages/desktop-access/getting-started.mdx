...
Passwordless access for local users is limited to 5 desktops in open source Teleport.

If you have more than 5 desktops configured using method below in open source Teleport
you won't be able to connect to any of them.

Enterprise users can have unlimited number of desktops.
</Admonition>
...
<Details
  ...
  min="12.0"
>
Passwordless access for local users is available starting from Teleport Enterprise `v12` and Teleport Community `v14`.
