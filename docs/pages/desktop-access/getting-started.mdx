...
6. Select a name and location for you certificate and finish out the wizard.
...
trusted repository or provide the filepath in the `der_ca_file` configuration variable.

<Figure align="left" bordered caption="Export CA Cert">
  ![Export CA Cert](../../img/desktop-access/export-ca.png)
</Figure>
