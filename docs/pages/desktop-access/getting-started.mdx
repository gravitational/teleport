...
The Teleport service installer {/*Rename as needed*/} can be run in a shell
environment with elevated privileges. You can use this to automate installation,
uninstallation, and certificate updates. For example:
...
you plan on running the Teleport Desktop Service on the same host as an existing Teleport
