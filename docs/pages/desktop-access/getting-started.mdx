...
The features documented on this page are available in Teleport `10.2.8` and higher.
...
<Details title="Compare Desktop Access to traditional RDP">

Teleport Desktop Access is desiged to be a secure access protocol for Windows
environments. Our protocol is designed with security as a priority, and may not
be as performant as RDP or Guacamole. Consider Desktop Accesss to manage access
to your most sensitive Windows environments, not as a drop-in replacement for
other tools to provide general access to Windows desktops.
