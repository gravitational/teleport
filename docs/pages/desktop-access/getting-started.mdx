...
If you would like Teleport to integrate with an Active Directory environment instead, see [Configure access for Active Directory users](./active-directory.mdx).
</Admonition>
