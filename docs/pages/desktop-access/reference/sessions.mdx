...
Be aware, Desktop Access session recordings capture the entire contents of the
screen. This means they take up significantly more disk space than SSH or Kubernetes
...
in progress. If disk space is a concern, we recommend using sync recording and
