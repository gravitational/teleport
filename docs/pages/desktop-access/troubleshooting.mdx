---
title: Desktop Access troubleshooting
description: Teleport Desktop Access troubleshooting guide.
---
...
# Desktop Access Troubleshooting
...
First, make sure that you [enable Smart Card service in Group
Policy](./getting-started.mdx#step-2c-enable-the-smart-card-service).
...
Policy](./getting-started.mdx#step-2a-import-teleport-ca). Note that if the
...
port](./getting-started.mdx#step-2d-open-firewall-rules-for-rdp) and [allow
remote RDP connections in Group
Policy](./getting-started.mdx#step-2b-allow-remote-rdp-connections).
