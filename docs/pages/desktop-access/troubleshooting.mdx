...
```code
$ curl 'https://teleport.example.com/webapi/auth/export?type=windows' > user-ca.cer
```
...
```code
$ curl 'https://mytenant.teleport.sh/webapi/auth/export?type=windows' > user-ca.cer
```
