...
<TileSet>
  <Tile icon="desktop" title="Configuration" href="./reference/configuration.mdx">
    Configure Windows Desktop Service
  </Tile>
  <Tile icon="desktop" title="RBAC" href="./rbac.mdx">
    Role-based Access Control for Teleport Desktop Access
  </Tile>
  <Tile icon="desktop" title="CLI" href="./reference/cli.mdx">
    CLI Reference
  </Tile>
  <Tile icon="desktop" title="Audit" href="./reference/audit.mdx">
    Audit Events
  </Tile>
</TileSet>
