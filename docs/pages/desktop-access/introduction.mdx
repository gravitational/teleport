...
If you're managing access for combination of both local users and domain users, youll need
...
- [Configure access for local users](./windows-local-users.mdx)
...
- [Windows-specific commnand reference](./reference/cli.mdx)
