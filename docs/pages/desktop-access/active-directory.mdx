...
<Admonition title="Azure AD" type="warning">
  Microsoft's fully managed Azure Active Directory offering does not give
  administrators the required permissions to trust your Teleport cluster's
  certificates. At this time, Teleport does support Azure AD.
</Admonition>
