...
Before closing, Teleport Connect will remember the tabs that you had open at the end of the previous
session. Next time you open it, Connect will ask you if you want to reopen those tabs. If you agree,
