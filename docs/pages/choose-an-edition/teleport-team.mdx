...
configure access from users across the globe to your infrastructure, including
private networks.
...
This section walks you through the process of registering a local server with a
...
- **Optional:** Docker installed on your workstation. In this guide, we will
  show you how to register a server with Teleport via the Teleport SSH Service.
  If your workstation is running Windows, or you prefer a containerized setup,
  we will show you how to run the Teleport SSH Service on a local Docker host.
  You can find installation instructions on [Docker's
...
### Step 1/3. Install the Teleport SSH Service
...
Select your OS. If using Windows, select "Ubuntu 14.04+" and follow the
instructions to set up a Docker container below.

<Details title="Setting up a Docker container to follow this guide">

Spin up a server on your workstation so you can register this server with your
...
Copy the script and paste it into a shell on your local workstation or the shell
you opened earlier on your Docker container.
...
### Step 2/3. Play back your session
...
### Step 3/3. Access your server from the command line
