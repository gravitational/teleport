...
### Auth Service
The Teleport [Auth Service](../../architecture/authentication.mdx) is deployed within a AWS region in 4 availability zones, and can tolerate a single zone failure. AWS guarantees [99.99%](https://aws.amazon.com/compute/sla/) of monthly uptime.
