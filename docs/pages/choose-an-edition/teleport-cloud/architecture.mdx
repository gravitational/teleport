...
### Auth Service
The Teleport [Auth Service](../../architecture/authentication.mdx) is deployed within a AWS region in 2 availability zones, and can tolerate a single zone failure. AWS guarantees [99.99%](https://aws.amazon.com/compute/sla/) of monthly uptime.
Teleport Enterprise Cloud allows selection of these AWS regions for the Teleport Auth Service and backend storage.
