...
Paste and run script on a Linux Server
...
Exit the session with `exit` and you can replay the session within Session Recordings
...
- Install and use [Teleport Connect](../connect-your-client/teleport-connect.mdx) as a Desktop Graphical Client to access your resources.
