...
Teleport Agents connected to cloud-hosted Teleport Enterprise must be allowed to connect to the following IP addresses in order to join the Teleport cluster.
