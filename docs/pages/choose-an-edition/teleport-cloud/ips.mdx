...
description: Restrict outbound network connections from your infrastructure to Teleport Enterprise Cloud.
tocDepth: 3
---
...
This list may be used to allowlist outbound network connections from Teleport Agents to Teleport Enterprise Cloud.
...
1. Notifying Teleport Enterprise Cloud customers via email.
...
<Notice type="warning">
If you are Teleport Enterprise Cloud customer and plan to employ this allowlist, please let us know by opening a support ticket.
</Notice>
