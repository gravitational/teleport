...
## If I start with Teleport Enterprise Cloud, can I move to Teleport Enterprise or Teleport Open Source?

If you plan to use S3 and DynamoDB as storage backends, we can provide data for you to import. If you use a different backend, you can reuse configurations in a new Teleport cluster. Prior to any planned migration we recommend contacting Teleport to get the best options.
