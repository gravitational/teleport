...
Teleport provides a dedicated Teleport Account site to download your license,
enterprise binaries and maintain users' access to your license. Customers
still using the legacy Teleport customer portal will be contacted for migration
to the new site. 
