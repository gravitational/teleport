...
or removed support for a feature, you must obtain your license file again and
...
they will see an error message. For example, if you attempt to use Database
Access without it being included in the license, you will get a message similar
to:
