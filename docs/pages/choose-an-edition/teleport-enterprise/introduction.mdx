...
With Teleport, users can request access roles or to a specific set of resources.
Requests can be published to tools like Slack, Jira, and PagerDuty for easy integration with your organization's workflows.
