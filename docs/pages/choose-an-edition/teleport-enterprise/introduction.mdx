...
## Dedicated Account Site

Teleport Enterprise subscriptions include a dedicated account site with their preferred
subdomain of (teleport.sh)[https://teleport.sh]. The dedicated account site provides
subscription administrators access to the License file, support links and Enterprise binary downloads.
