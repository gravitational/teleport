...
Enterprise customers can download the custom FIPS package from their [Teleport Workspace](https://teleport.sh) or
the legacy [customer portal](https://dashboard.gravitational.com/web/).
