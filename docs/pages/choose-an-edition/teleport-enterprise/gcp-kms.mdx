...
In order for the auth servers to generate new keys in GCP KMS and have them
trusted by the rest of the cluster, you will need to rotate all of your Teleport
CAs.
