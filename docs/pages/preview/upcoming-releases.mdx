...
Teleport 9.2 will include Teleport Terminal, a native application
that can be used to access Teleport Nodes and Databases.

In addition, Teleport 9.2 will add clickable label filters for the Web UI.
...
support for Database Access, Kubernetes Access, CA rotation, and ephemeral
token-based joining.
...
support for Snowflake and GA for Microsoft SQL Server and
...
Teleport 10.1, Database Access will add support for Cassandra.
