...
Teleport 9.1 will add Database and Kubernetes Access support to Machine ID and
server-side filtering and pagination to the Web UI.
...
Teleport 9.2 will include Teleport Terminal, a native application that can be
used to access Teleport Servers and Databases.

| Version     | Date            |
|-------------|-----------------|
| Release     | Late April 2022 |
...
|-------------|------------|----------------------------|
| Release     | June 2022  | Good to go for production. |
