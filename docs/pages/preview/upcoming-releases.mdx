...
- ARM64 support for container images and CentOS 7
- Auth connectors support in Kubernetes Operator
- Advanced search for Teleport Connect
- Improved Web UI performance when connecting to resources
- Ability to select roles for Resource-based Access Requests

| Version          | Date                | Description                                                 |
|------------------|---------------------|-------------------------------------------------------------|
| Release          | November 28th, 2022 | Good to go for production.                                  |
