...
Teleport 8.2 will bring support for X11 forwarding.

| Version     | Date               | Description                      |
| ----------- | ------------------ | -------------------------------- |
| Release     | February 4th, 2022 | Good to go for production.       |
...
| Version     | Date               | Description                      |
| ----------- | ------------------ | -------------------------------- |
| Release     | February 11th, 2022 | Good to go for production.      |
