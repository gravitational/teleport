...
Teleport 7.2 will focus on [HSMs](https://github.com/gravitational/teleport/issues/4225), [improving `tsh.exe` experience on Windows](https://github.com/gravitational/teleport/issues/7445), and performance and stability enhancements.
...
| Release                                                                               | September 20th, 2021 | Production release.                    |

### Teleport 7.3

Teleport 7.3 will focus on [simplified node joining](https://github.com/gravitational/teleport/issues/7145).

| Version    | Date              | Description         |
| ---------- | ----------------- | ------------------- |
| Release    | October 4th, 2021 | Production release. |

You can find the full list of fixes and features in the [Github milestone](https://github.com/gravitational/teleport/milestone/62).
