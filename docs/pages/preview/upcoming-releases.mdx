...
Teleport 9.2 will add Database Access support for Machine ID and clickable
label filters for the Web UI.
...
support for Kubernetes Access, CA rotation, and ephemeral token-based joining.
...
In addition, Teleport 10 will include preview releases of Passwordless,
Automatic Upgrades and Kubernetes Operator.
