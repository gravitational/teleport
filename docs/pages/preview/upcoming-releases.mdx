...
Database Access will add support for Elasticsearch.
...
Teleport 10 will bring Cassandra support to Database Access. Host
certificate support will be added to Machine ID.
