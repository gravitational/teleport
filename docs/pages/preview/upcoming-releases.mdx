...
Teleport 7.1 will focus on [HSM](https://github.com/gravitational/teleport/issues/4225), [session termination and user locking](https://github.com/gravitational/teleport/issues/3360), and additional FedRAMP compliance controls which were delayed from 7.0 due to timing constraints.

| Version | Date              | Description         |
| ------- | ----------------- | ------------------- |
| Release | August 23th, 2021 | Production release. |
