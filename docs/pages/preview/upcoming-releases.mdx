...
will add self-hosted Redis, auto-discovery for Redshift clusers,
auto-IAM configuration improvements, and Moderated Sessions.
...
| -------------------------------------------------------------------------------------|--------------------|----------------------------------|
| [9.0.0-beta.1](https://github.com/gravitational/teleport/releases/tag/v9.0.0-beta.1) | Febuary 21st, 2022 | Deploy on staging.               |
