...
| ----------- | ------------------- | -------------------------------- |
| Release     | December 23rd, 2021 | Good to go for production.       |
...
| Version     | Date               | Description                      |
| ----------- | ------------------ | -------------------------------- |
| Release     | January 14th, 2022 | Good to go for production.       |
...
| Version     | Date               | Description                      |
| ----------- | ------------------ | -------------------------------- |
| Release     | January 28th, 2022 | Good to go for production.       |
...
Teleport 9.0 will focus on brining Desktop Access to GA with support for session recording, per-session MFA, and clipboard support. In addition, Teleport 9 will include preview releases of Teleport Terminal and Teleport Certificate Bot.
