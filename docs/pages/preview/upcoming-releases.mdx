...
Teleport 10 will include a preview releases of Passwordless, Resource-based Access
Requests, automatic user provisioning and IP-based restrictions for Server Access.

In addition, preview support for Snowflake, audit logging support for Microsoft
SQL Server, and Elasticache/MemoryDB support for Redis will be added to Database Access.
