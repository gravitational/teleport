...
In this guide, you will allow users with the `manager` role to grant the
`support-engineer` role to users meeting specific criteria. This guide follows
the [the IaC users and roles guide](user-and-role.mdx).
