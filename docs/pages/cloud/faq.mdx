...
## If I start with Teleport Cloud, can I move to self-hosted or community, or do I need to start again?

If you also plan to use S3 and DynamoDB, we can provide data for you to import. But you should reach out to us first.
