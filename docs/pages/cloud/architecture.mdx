...
Our team routinely scrutinizes, reviews, updates, improves upon, and executes our security roadmap by working with independent security
auditors to identify any gaps. 

Teleport Cloud only gets the greenlight for use in strict compliance use-cases only when the team has full confidence that all security gaps or vulnerabilities have been identified and resolved.

## Compliance

An SOC2 audit is presently underway and should be concluded by June 2021.
