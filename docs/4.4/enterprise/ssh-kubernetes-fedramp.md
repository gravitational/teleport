...
| [AC-10 Concurrent Session Control](https://nvd.nist.gov/800-53/Rev4/control/AC-10)   | Teleport administrators can define concurrent session limits per using Teleports RBAC. |
