...
Teleport core service [`teleport`](cli-docs.mdx#teleport) and admin tool [`tctl`](cli-docs.mdx#tctl) have been designed to run on **Linux** and **Mac** operating systems.

The Teleport client [`tsh`](cli-docs.mdx#tsh) and Web UI are available for **Linux, Mac**
