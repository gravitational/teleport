...
var SideNav = function () {
  function SideNav() {
    ...
    this.$secondaryMenu = (0, _jquery2.default)('.side-nav-secondary-buttons');
...
exports.stopDisabledButtons = exports.buttonSmoothScroll = exports.buttonRipple = undefined;
...
exports.formatCodeBlocks = exports.activateCodeFormatting = undefined;
...
var formatCodeBlocks = function formatCodeBlocks() {
  // check for pretty print
  if (window.PR && window.PR.prettyPrint) {
    var $preTags = (0, _jquery2.default)('pre');

    // cycle through pre tags and add class
    $preTags.each(function (index, el) {
      var $pre = (0, _jquery2.default)(el);
...
exports.activateCodeFormatting = activateCodeFormatting;
...
exports.handleVerSelector = exports.handleNavScroll = exports.getSearchTerm = undefined;
...
_jquery2.default.fn.visible = function (partial, hidden, direction, container) {
  ...
  var $t = this.length > 1 ? this.eq(0) : this,
      ...
      $c = isContained ? (0, _jquery2.default)(container) : $w,
...
function checkVisible(elm, container) {
  return (0, _jquery2.default)(elm).visible(true, false, 'vertical', container);
}
...
var handleNavScroll = function handleNavScroll() {
  var $container = (0, _jquery2.default)(window);
  var $menus = (0, _jquery2.default)(".side-nav .side-nav-secondary-buttons");
  var $targets = (0, _jquery2.default)("#docs-content").find('[id]');
  ...
  function selectMenuItem(id) {
    ...
    var $link = (0, _jquery2.default)(linkMap[id]);
...
var handleVerSelector = function handleVerSelector() {
  ...
  var $content = (0, _jquery2.default)("#docs-content");
  ...
  var product = "Teleport";
  if ((0, _jquery2.default)("#secondary-nav h2 a").attr('href').includes("teleport")) {
    product = "Teleport";
  }
  ...
  function getVerUrl(ver, isLatest) {
	...
	//https://gravitationaldocs/ver/3.0/co/teleport/docs/
	//https://gravitational.com/teleport/docs/ver/4.1/intro/ 
	//https://gravitational.com/teleport/docs/ver/3.1/intro/ 
	// Note: this doesn't work well for older version swithching to new versions
