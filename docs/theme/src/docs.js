...
Object(_utils_mkdocs__WEBPACK_IMPORTED_MODULE_8__["handleNavScroll"])();
...
/*!*****************************************!*\
  !*** ./web-assets/docs/utils/mkdocs.js ***!
  \*****************************************/
/*! exports provided: getSearchTerm, handleNavScroll, handleVerSelector */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSearchTerm", function() { return getSearchTerm; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleNavScroll", function() { return handleNavScroll; });
...
jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn.visible = function (partial, hidden, direction, container) {
  if (this.length < 1) return; // Set direction default to 'both'.

  direction = direction || "both";
  var $t = this.length > 1 ? this.eq(0) : this,
      isContained = typeof container !== "undefined" && container !== null,
      $c = isContained ? jquery__WEBPACK_IMPORTED_MODULE_0___default()(container) : $w,
...
function checkVisible(elm, container) {
  return jquery__WEBPACK_IMPORTED_MODULE_0___default()(elm).visible(true, false, 'vertical', container);
} // debounce
...
var handleNavScroll = function handleNavScroll() {
  var $container = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window);
  var $menus = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jump-nav");
  var $targets = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#docs-content").find('[id]');
  var activeClass = 'is-active';
  var linkMap = {};
  $menus.find("a").each(function (i, value) {
    var $value = jquery__WEBPACK_IMPORTED_MODULE_0___default()(value);
  ...
  $targets.each(function (i, heading) {
    ...
    $heading.append("<a href=\"#".concat(id, "\"></a>"));
  });
  ...
  function selectMenuItem(id) {
    ...
    var $link = jquery__WEBPACK_IMPORTED_MODULE_0___default()(linkMap[id]);
