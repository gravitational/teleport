...
import (
	...
	common2 "github.com/gravitational/teleport/lib/srv/alpnproxy/common"
...
func TestALPNSNIProxyDatabaseAccess(t *testing.T) {
	...
	t.Run("mysql", func(t *testing.T) {
		lp := mustStartALPNLocalProxy(t, pack.root.cluster.GetProxyAddr(), common2.ProtocolMySQL)
	...
	t.Run("postgres", func(t *testing.T) {
		lp := mustStartALPNLocalProxy(t, pack.root.cluster.GetProxyAddr(), common2.ProtocolPostgres)
		t.Run("connect to main cluster via proxy", func(t *testing.T) {
	...
	t.Run("mongo", func(t *testing.T) {
		lp := mustStartALPNLocalProxy(t, pack.root.cluster.GetProxyAddr(), common2.ProtocolMongoDB)
		t.Run("connect to main cluster via proxy", func(t *testing.T) {
