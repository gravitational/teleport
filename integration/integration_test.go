...
func TestIntegrationSuite(t *testing.T) { suite.Run(t, &integrationSuite{}) }

func (suite *integrationSuite) SetupSuite() {
	suite.Fixture = *helpers.NewFixture(suite.T())
}

func (suite *integrationSuite) SetupTest() {
	suite.Log = utils.NewLoggerForTests()
	os.RemoveAll(profile.FullProfilePath(""))
}

func (suite *integrationSuite) CleanupTest() {
	suite.Log = nil
}

// TestAuditOff checks that when session recording has been turned off,
// sessions are not recorded.
func (suite *integrationSuite) TestAuditOff() {
	t := suite.T()
...
func (suite *integrationSuite) TestAuditOn() {
	t := suite.T()
...
func (suite *integrationSuite) TestBPFExec() {
	t := suite.T()
...
func (suite *integrationSuite) TestBPFInteractive() {
	t := suite.T()
...
func (suite *integrationSuite) TestBPFSessionDifferentiation() {
	t := suite.T()
...
func (suite *integrationSuite) TestCmdLabels() {
	t := suite.T()
...
func (suite *integrationSuite) TestControlMaster() {
	t := suite.T()
...
func (suite *integrationSuite) TestCustomReverseTunnel() {
	t := suite.T()
...
func (suite *integrationSuite) TestDataTransfer() {
	t := suite.T()
...
func (suite *integrationSuite) TestDisconnectScenarios() {
	t := suite.T()
...
func (suite *integrationSuite) TestDiscovery() {
	t := suite.T()
...
func (suite *integrationSuite) TestDiscoveryNode() {
	t := suite.T()
...
func (suite *integrationSuite) TestDiscoveryRecovers() {
	t := suite.T()
...
// TestEnvironmentVariables validates that you can't login with invalid login or
// with invalid 'site' parameter
func (suite *integrationSuite) TestEnvironmentVariables() {
	t := suite.T()
	ctx := context.Background()
	tr := utils.NewTracer(utils.ThisFunction()).Start()
	defer tr.Stop()
...
func (suite *integrationSuite) TestExecEvents() {
	t := suite.T()
...
func (suite *integrationSuite) TestExternalClient() {
	t := suite.T()
...
func (suite *integrationSuite) TestHA() {
	t := suite.T()
...
// TestInteractiveRegular covers SSH into shell and joining the same session from another client
// against a standard teleport node.
func (suite *integrationSuite) TestInteractiveRegular() {
	t := suite.T()
...
func (suite *integrationSuite) TestInteractiveReverseTunnel() {
	t := suite.T()
...
func (suite *integrationSuite) TestInteroperability() {
	t := suite.T()
...
// with invalid 'site' parameter
func (suite *integrationSuite) TestInvalidLogins() {
	t := suite.T()
...
func (suite *integrationSuite) TestJumpTrustedClusters() {
	t := suite.T()
...
// TestJumpTrustedClusters tests remote clusters scenarios
// using trusted clusters feature using jumphost connection
func (suite *integrationSuite) TestJumpTrustedClustersWithLabels() {
	t := suite.T()
...
func (suite *integrationSuite) TestMultiplexingTrustedClusters() {
	t := suite.T()
...
func (suite *integrationSuite) TestList() {
	t := suite.T()
...
func (suite *integrationSuite) TestMapRoles() {
	t := suite.T()
...
func (suite *integrationSuite) TestPAM() {
	t := suite.T()
...
func (suite *integrationSuite) TestProxyHostKeyCheck() {
	t := suite.T()
...
// is restored.
func (suite *integrationSuite) TestReverseTunnelCollapse() {
	t := suite.T()
...
func (suite *integrationSuite) TestRotateRollback() {
	t := suite.T()
...
func (suite *integrationSuite) TestRotateSuccess() {
	t := suite.T()
...
func (suite *integrationSuite) TestRotateTrustedClusters() {
	t := suite.T()
...
func (suite *integrationSuite) TestSessionStartContainsAccessRequest() {
	t := suite.T()
...
func (suite *integrationSuite) TestSessionStreaming() {
	t := suite.T()
...
func (suite *integrationSuite) TestSSHExitCode() {
	t := suite.T()
...
func (suite *integrationSuite) TestShutdown() {
	t := suite.T()
	tr := utils.NewTracer(utils.ThisFunction()).Start()
	defer tr.Stop()
...
// using trusted clusters feature
func (suite *integrationSuite) TestTrustedClusters() {
	t := suite.T()
	tr := utils.NewTracer(utils.ThisFunction()).Start()
	defer tr.Stop()
...
func (suite *integrationSuite) TestTrustedClustersWithLabels() {
	t := suite.T()
	tr := utils.NewTracer(utils.ThisFunction()).Start()
	defer tr.Stop()
...
func (suite *integrationSuite) TestTrustedTunnelNode() {
	t := suite.T()
...
func (suite *integrationSuite) TestTwoClustersProxy() {
	t := suite.T()
	tr := utils.NewTracer(utils.ThisFunction()).Start()
	defer tr.Stop()
...
func (suite *integrationSuite) TestTwoClustersTunnel() {
	t := suite.T()
...
func (suite *integrationSuite) TestUUIDBasedProxy() {
	t := suite.T()
	ctx := context.Background()
...
func (suite *integrationSuite) TestSSHTracker() {
	t := suite.T()
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
...
func (suite *integrationSuite) TestKubeAgentFiltering() {
	t := suite.T()
	ctx := context.Background()
...
func (suite *integrationSuite) TestListResourcesAcrossClusters() {
	t := suite.T()
...
func (suite *integrationSuite) TestSessionRecordingModes() {
	t := suite.T()
	tr := utils.NewTracer(utils.ThisFunction()).Start()
	defer tr.Stop()
...
func (suite *integrationSuite) TestDifferentPinnedIP() {
	t := suite.T()
...
func (suite *integrationSuite) TestJoinOverReverseTunnelOnly() {
	t := suite.T()
	lib.SetInsecureDevMode(true)
	defer lib.SetInsecureDevMode(false)
...
func (suite *integrationSuite) TestSFTP() {
	t := suite.T()
...
func (suite *integrationSuite) TestEscapeSequenceTriggers() {
	t := suite.T()
	type testCase struct {
		name                  string
...
func (suite *integrationSuite) TestAuthLocalNodeControlStream() {
	t := suite.T()
...
func (suite *integrationSuite) TestWindowChange() {
	t := suite.T()
	tr := utils.NewTracer(utils.ThisFunction()).Start()
	defer tr.Stop()
	ctx := context.Background()
...
func (suite *integrationSuite) TestPortForwarding() {
	t := suite.T()
...
func runDisconnectTest(t *testing.T, suite *integrationSuite, tc disconnectTestCase) {
	teleport := suite.NewTeleportInstance(t)
...
func (suite *integrationSuite) newTeleport(t *testing.T, logins []string, enableSSH bool) *helpers.TeleInstance {
	teleport := suite.newUnstartedTeleport(t, logins, enableSSH)
	require.NoError(t, teleport.Start())
	return teleport
}
...
// with the current user os.user.Current().
func (suite *integrationSuite) newUnstartedTeleport(t *testing.T, logins []string, enableSSH bool) *helpers.TeleInstance {
	teleport := suite.NewTeleportInstance(t)
...
func (suite *integrationSuite) defaultServiceConfig() *service.Config {
...
func (suite *integrationSuite) newNamedTeleportInstance(t *testing.T, clusterName string, opts ...InstanceConfigOption) *helpers.TeleInstance {
	cfg := helpers.InstanceConfig{
		...
		Priv:        suite.Priv,
		Pub:         suite.Pub,
		Log:         utils.WrapLogger(suite.Log.WithField("cluster", clusterName)),
	}
...
// reversetunnel node.
func (suite *integrationSuite) newTeleportIoT(t *testing.T, logins []string) *helpers.TeleInstance {
	// Create a Teleport instance with Auth/Proxy.
	...
	main := suite.NewTeleportWithConfig(t, logins, nil, mainConfig())
...
func trustedClusters(t *testing.T, suite *integrationSuite, test trustedClusterTest) {
	ctx := context.Background()
	username := suite.Me.Username
...
func (suite *integrationSuite) rotationConfig(disableWebService bool) *service.Config {
	tconf := suite.defaultServiceConfig()
	tconf.SSH.Enabled = true
...
func twoClustersTunnel(t *testing.T, suite *integrationSuite, now time.Time, proxyRecordMode string, execCountSiteA, execCountSiteB int) {
...
func createTrustedClusterPair(t *testing.T, suite *integrationSuite, extraServices func(*testing.T, *helpers.TeleInstance, *helpers.TeleInstance)) *client.TeleportClient {
	ctx := context.Background()
	username := suite.Me.Username
	name := "test"
