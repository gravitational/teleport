...
2. Install [`protoc-gen-terraform`](https://github.com/gravitational/protoc-gen-terraform) @v4.0.0-dev.2.

    ```go install github.com/gravitational/protoc-gen-terraform/v4@v4.0.0-dev.2```
