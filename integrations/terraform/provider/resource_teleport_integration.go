...
func (r resourceTeleportIntegration) ModifyPlan(ctx context.Context, req tfsdk.ModifyResourcePlanRequest, resp *tfsdk.ModifyResourcePlanResponse) {
	...
	integration := &apitypes.IntegrationV1{}
	resp.Diagnostics.Append(tfschema.CopyIntegrationV1FromTerraform(ctx, plan, integration)...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	resp.Diagnostics.Append(tfschema.CopyIntegrationV1ToTerraform(ctx, integration, &normalized)...)
	if resp.Diagnostics.HasError() {
		return
	}
