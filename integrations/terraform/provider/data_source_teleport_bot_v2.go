...
// dataSourceTeleportBotType is the data source metadata type
type dataSourceTeleportBotType struct{}

// dataSourceTeleportBot is the resource
type dataSourceTeleportBot struct {
	p Provider
}

// GetSchema returns the data source schema
func (r dataSourceTeleportBotType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return schemav1.GenSchemaBot(ctx)
}

// NewDataSource creates the empty data source
func (r dataSourceTeleportBotType) NewDataSource(_ context.Context, p tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	return dataSourceTeleportBot{
		p: *(p.(*Provider)),
	}, nil
}

// Read reads teleport Bot
func (r dataSourceTeleportBot) Read(ctx context.Context, req tfsdk.ReadDataSourceRequest, resp *tfsdk.ReadDataSourceResponse) {
	var id types.String
