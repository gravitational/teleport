...
// formatSQN formats a scoped resource Terraform ID as a scope-qualified name.
func formatSQN(scope, name string) string {
	return scopes.QualifiedName{Scope: scope, Name: name}.String()
}
