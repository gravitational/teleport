...
func (r dataSourceTeleportSAMLConnectorType) NewDataSource(_ context.Context, p tfprovider.Provider) (datasource.DataSource, diag.Diagnostics) {
...
func (r dataSourceTeleportSAMLConnector) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var id types.String
