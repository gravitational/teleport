...
func (r resourceTeleportRoleType) NewResource(_ context.Context, p tfprovider.Provider) (resource.Resource, diag.Diagnostics) {
...
func (r resourceTeleportRole) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var err error
...
func (r resourceTeleportRole) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r resourceTeleportRole) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	if !r.p.IsConfigured(resp.Diagnostics) {
		return
	}
...
func (r resourceTeleportRole) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var id types.String
	diags := req.State.GetAttribute(ctx, path.Root("metadata").AtName("name"), &id)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
...
func (r resourceTeleportRole) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
