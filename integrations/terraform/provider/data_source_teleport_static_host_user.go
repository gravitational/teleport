...
// dataSourceTeleportStaticHostUserType is the data source metadata type
type dataSourceTeleportStaticHostUserType struct{}

// dataSourceTeleportStaticHostUser is the resource
type dataSourceTeleportStaticHostUser struct {
	p Provider
}

// GetSchema returns the data source schema
func (r dataSourceTeleportStaticHostUserType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return schemav1.GenSchemaStaticHostUser(ctx)
}

// NewDataSource creates the empty data source
func (r dataSourceTeleportStaticHostUserType) NewDataSource(_ context.Context, p tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	return dataSourceTeleportStaticHostUser{
		p: *(p.(*Provider)),
	}, nil
}

// Read reads teleport StaticHostUser
func (r dataSourceTeleportStaticHostUser) Read(ctx context.Context, req tfsdk.ReadDataSourceRequest, resp *tfsdk.ReadDataSourceResponse) {
	var id types.String
