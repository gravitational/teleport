...
type dataSourceTeleportOktaImportRuleType struct{}

// dataSourceTeleportOktaImportRule is the resource
type dataSourceTeleportOktaImportRule struct {
	p Provider
}

// GetSchema returns the data source schema
func (r dataSourceTeleportOktaImportRuleType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfschema.GenSchemaOktaImportRuleV1(ctx)
}

// NewDataSource creates the empty data source
func (r dataSourceTeleportOktaImportRuleType) NewDataSource(_ context.Context, p tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	return dataSourceTeleportOktaImportRule{
		p: p.(Provider),
	}, nil
}

// Read reads teleport OktaImportRule
func (r dataSourceTeleportOktaImportRule) Read(ctx context.Context, req tfsdk.ReadDataSourceRequest, resp *tfsdk.ReadDataSourceResponse) {
	var id types.String
	...
	if err != nil {
		resp.Diagnostics.Append(tfdiag.DiagFromWrappedErr("Error reading OktaImportRule", trace.Wrap(err), "okta_import_rule"))
		return
	}
