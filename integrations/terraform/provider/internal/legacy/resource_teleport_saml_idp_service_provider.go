...
func (r resourceTeleportSAMLIdPServiceProvider) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	...
	if err != nil {
		resp.Diagnostics.Append(tfdiag.DiagFromWrappedErr("Error setting SAMLIdPServiceProvider defaults", trace.Wrap(err), "saml_idp_service_provider"))
		return
	}
	...
	if !trace.IsNotFound(err) {
		if err == nil {
			...
			resp.Diagnostics.Append(tfdiag.DiagFromErr("SAMLIdPServiceProvider exists in Teleport", trace.Errorf(existErr)))
			return
		}
	...
	if err != nil {
		resp.Diagnostics.Append(tfdiag.DiagFromWrappedErr("Error creating SAMLIdPServiceProvider", trace.Wrap(err), "saml_idp_service_provider"))
		return
	}
	...
	for {
		...
		if trace.IsNotFound(err) {
		    select {
			case <-ctx.Done():
			    resp.Diagnostics.Append(tfdiag.DiagFromWrappedErr("Error reading SAMLIdPServiceProvider", trace.Wrap(ctx.Err()), "saml_idp_service_provider"))
				return
			case <-retry.After():
			}
...
func (r resourceTeleportSAMLIdPServiceProvider) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	...
	if err := samlIdPServiceProviderResource.CheckAndSetDefaults(); err != nil {
		resp.Diagnostics.Append(tfdiag.DiagFromWrappedErr("Error updating SAMLIdPServiceProvider", err, "saml_idp_service_provider"))
		return
	}
	...
	if err != nil {
		resp.Diagnostics.Append(tfdiag.DiagFromWrappedErr("Error reading SAMLIdPServiceProvider", err, "saml_idp_service_provider"))
		return
	}
...
func (r resourceTeleportSAMLIdPServiceProvider) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	...
	if err != nil {
		resp.Diagnostics.Append(tfdiag.DiagFromWrappedErr("Error deleting SAMLIdPServiceProviderV1", trace.Wrap(err), "saml_idp_service_provider"))
		return
	}
