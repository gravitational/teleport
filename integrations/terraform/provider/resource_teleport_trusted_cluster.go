...
func (r resourceTeleportTrustedClusterType) NewResource(_ context.Context, p tfprovider.Provider) (resource.Resource, diag.Diagnostics) {
...
func (r resourceTeleportTrustedCluster) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var err error
...
func (r resourceTeleportTrustedCluster) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r resourceTeleportTrustedCluster) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	if !r.p.IsConfigured(resp.Diagnostics) {
		return
	}
...
func (r resourceTeleportTrustedCluster) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var id types.String
	diags := req.State.GetAttribute(ctx, path.Root("metadata").AtName("name"), &id)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
...
func (r resourceTeleportTrustedCluster) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
