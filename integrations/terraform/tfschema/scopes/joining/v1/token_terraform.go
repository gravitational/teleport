						...
						if !ok {
							...
							if !ok {
								if tf.Attrs["bot_name"] != nil {
									diags.Append(attrWriteUnexpectedExistingTypeDiag{"ScopedToken.spec.bot_name", "github.com/hashicorp/terraform-plugin-framework/types.String"})
								}
								i, err := t.ValueFromTerraform(ctx, github_com_hashicorp_terraform_plugin_go_tftypes.NewValue(t.TerraformType(ctx), nil))
								if err != nil {
						...
						if !ok {
							...
							if !ok {
								if tf.Attrs["bot_scope"] != nil {
									diags.Append(attrWriteUnexpectedExistingTypeDiag{"ScopedToken.spec.bot_scope", "github.com/hashicorp/terraform-plugin-framework/types.String"})
								}
								i, err := t.ValueFromTerraform(ctx, github_com_hashicorp_terraform_plugin_go_tftypes.NewValue(t.TerraformType(ctx), nil))
								if err != nil {
