				...
				"jwt": {
					Attributes: github_com_hashicorp_terraform_plugin_framework_tfsdk.SingleNestedAttributes(map[string]github_com_hashicorp_terraform_plugin_framework_tfsdk.Attribute{
						...
						"authorization_header": {
							Description: "AuthorizationHeader is the HTTP header name that will contain the token.",
							Optional:    true,
							Type:        github_com_hashicorp_terraform_plugin_framework_types.StringType,
						},
						"issuer": {
						...
						"jwks_url": {
							Description: "IssuerUrl is the JWKS URL used to fetch signing keys.",
							Optional:    true,
							Type:        github_com_hashicorp_terraform_plugin_framework_types.StringType,
						},
						"static_jwks": {
							Description: "StaticJWKS disables fetching the issuer signing keys via the JWKS endpoints, and allows them to be directly specificed.",
							Optional:    true,
							Type:        github_com_hashicorp_terraform_plugin_framework_types.StringType,
						},
						"username_claim": {
							Description: "UsernameClaim specifies which token claim name's value will be used as the username.",
							Optional:    true,
							Type:        github_com_hashicorp_terraform_plugin_framework_types.StringType,
						},
					}),
