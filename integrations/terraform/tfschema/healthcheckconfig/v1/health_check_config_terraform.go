				...
				"match": {
					Attributes: github_com_hashicorp_terraform_plugin_framework_tfsdk.SingleNestedAttributes(map[string]github_com_hashicorp_terraform_plugin_framework_tfsdk.Attribute{
						"db_labels": {
							...
							Description: "DBLabels selects the databases to match. The result is logically ANDed with DBLabelsExpression. An empty value matches all databases.",
							Optional:    true,
						},
						"db_labels_expression": {
							Description: "DBLabelsExpression is a predicate expression to match databases. The result is logically ANDed with DBLabels. An empty value matches all databases.",
							Optional:    true,
							Type:        github_com_hashicorp_terraform_plugin_framework_types.StringType,
						},
					}),
