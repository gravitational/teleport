...
func NewOIDCConnectorReconciler(client kclient.Client, accessor protectedclient.Accessor) *TeleportResourceReconciler[types.OIDCConnector, *resourcesv3.TeleportOIDCConnector] {
