...
// trustedClusterClient implements TeleportResourceClient and offers CRUD methods needed to reconcile roles
...
// NewTrustedClusterReconciler instantiates a new Kubernetes controller reconciling trusted_cluster v2 resources
