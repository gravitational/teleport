...
func (g *userTestingPrimitives) CreateKubernetesResource(ctx context.Context, name string) error {
	user := &resourcesv2.TeleportUser{
		...
		Spec: resourcesv2.TeleportUserSpec(userSpec),
	}
...
func (g *userTestingPrimitives) GetKubernetesResource(ctx context.Context, name string) (*resourcesv2.TeleportUser, error) {
	user := &resourcesv2.TeleportUser{}
...
func (g *userTestingPrimitives) CompareTeleportAndKubernetesResource(tResource types.User, kubeResource *resourcesv2.TeleportUser) (bool, string) {
...
func TestTeleportUserCreation(t *testing.T) {
	...
	testlib.ResourceCreationSynchronousTest[types.User, *resourcesv2.TeleportUser](t, resources.NewUserReconciler, test)
}

func TestTeleportUserDeletionDrift(t *testing.T) {
	test := &userTestingPrimitives{}
	testlib.ResourceDeletionDriftSynchronousTest[types.User, *resourcesv2.TeleportUser](t, resources.NewUserReconciler, test)
}

func TestTeleportUserUpdate(t *testing.T) {
	test := &userTestingPrimitives{}
	testlib.ResourceUpdateTestSynchronous[types.User, *resourcesv2.TeleportUser](t, resources.NewUserReconciler, test)
}
