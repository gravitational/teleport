...
func NewProvisionTokenReconciler(client kclient.Client, accessor protectedclient.Accessor) *TeleportResourceReconciler[types.ProvisionToken, *resourcesv2.TeleportProvisionToken] {
