...
func NewMockMSTeamsAPI(concurrency int) *MockMSTeamsAPI {
...
func (s *MockMSTeamsAPI) URL() string {
	return s.srv.URL
}

func (s *MockMSTeamsAPI) Close() {
	s.srv.Close()
	close(s.newMessages)
	close(s.updatedMessages)
}

func (s *MockMSTeamsAPI) StoreUser(user msapi.User) msapi.User {
	if user.ID == "" {
...
func (s *MockMSTeamsAPI) StoreApp(a msapi.InstalledApp) msapi.InstalledApp {
	a.TeamsApp = s.teamsApp
	s.objects.Store(fmt.Sprintf("app-%s", a.ID), a)
	return a
}

func (s *MockMSTeamsAPI) StoreChat(c msapi.Chat) msapi.Chat {
	s.objects.Store(fmt.Sprintf("chat-%s", c.ID), c)
	return c
}

func (s *MockMSTeamsAPI) GetUser(id string) (msapi.User, bool) {
...
func (s *MockMSTeamsAPI) GetUserByEmail(email string) (msapi.User, bool) {
...
func (s *MockMSTeamsAPI) GetApp(id string) (msapi.InstalledApp, bool) {
...
func (s *MockMSTeamsAPI) GetChat(id string) (msapi.Chat, bool) {
...
func (s *MockMSTeamsAPI) CheckNewMessage(ctx context.Context) (Msg, error) {
	select {
...
func (s *MockMSTeamsAPI) CheckMessageUpdate(ctx context.Context) (Msg, error) {
	select {
