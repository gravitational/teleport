...
| <a name="input_azure_role_assignable_scopes"></a> [azure\_role\_assignable\_scopes](#input\_azure\_role\_assignable\_scopes) | The scopes at which the Azure discovery role will be assignable. Defaults to the current subscription. | `list(string)` | `[]` | no |
| <a name="input_azure_role_assignment_scopes"></a> [azure\_role\_assignment\_scopes](#input\_azure\_role\_assignment\_scopes) | The scopes at which the Azure discovery role will be assigned. Must be a management group ID like /providers/Microsoft.Management/managementGroups/<name> to support wildcard ('*') Azure subscription discovery. Defaults to the subscription of the azurerm provider. | `list(string)` | `[]` | no |
...
| <a name="input_match_azure_subscriptions"></a> [match\_azure\_subscriptions](#input\_match\_azure\_subscriptions) | Azure subscriptions to scan for VMs. Defaults to ["*"] which matches all subscriptions. | `list(string)` | <pre>[<br/>  "*"<br/>]</pre> | no |
...
| Name | Description |
|------|-------------|
| <a name="output_azure_discovery_role_definition"></a> [azure\_discovery\_role\_definition](#output\_azure\_discovery\_role\_definition) | The Azure role definition for Teleport discovery service. |
| <a name="output_azure_oidc_integration_managed_identity"></a> [azure\_oidc\_integration\_managed\_identity](#output\_azure\_oidc\_integration\_managed\_identity) | Managed identity used by the Teleport Azure OIDC integration. |
